...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[$FormId,'index'])}}" class="btn singlebt">Value Card Sale History</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Card No</p></div>
                            <div class="col-lg-3 pl">
                                <select name="CardNo[]" data-hide-disabled="hide" multiple data-actions-box="true" id="CardNo"  class="form-control selectpicker" multiple data-live-search="true"  >
                                    @foreach($objCard as $bindex=>$bRow)
                                        <option value="{{$bRow->DATA_ID}}" selected>{{$bRow->DATA_CODE}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   window.fnUndoNo = function (){
    ...
    $('#btnView').on('click', function() {
        ...
        var CardNo = [];
        $("select[name='CardNo[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                CardNo.push(value3);
            }
