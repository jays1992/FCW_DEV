...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[$FormId,'index'])}}" class="btn singlebt">Accessory Sale Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_itemid">
                                <select name="ItemName[]" data-hide-disabled="hide" multiple data-actions-box="true" id="ItemName" class="form-control selectpicker" multiple data-live-search="true"  >
