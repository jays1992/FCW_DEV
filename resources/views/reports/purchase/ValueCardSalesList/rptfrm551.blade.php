...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[$FormId,'index'])}}" class="btn singlebt">Value Card Sales List</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Card Status</p></div>
                            <div class="col-lg-3 pl">
                                <select name="CardStatus[]" data-hide-disabled="hide"  data-actions-box="true" id="CardStatus"  class="form-control selectpicker" data-live-search="true"  >
                                    @foreach($objCard as $bindex=>$bRow)
                                        <!-- <option value="{{$bRow->ACTIVE}}" selected><?php //if ($bRow->ACTIVE =='0') { echo 'Active'; } else if ($bRow->INACTIVE ==NULL) {echo 'Inactive';} else { echo '';} ?> </option> -->
                                        <option value="{{$bRow->ACTIVE}}" selected><?php if ($bRow->ACTIVE =='0') { echo 'Active'; } ?></option>
                                        <option value="{{$bRow->INACTIVE}}"><?php if ($bRow->INACTIVE ==NULL) { echo 'Inactive'; } ?></option>
                                    @endforeach
                                </select>
                            </div> 
...
$(document).ready(function(e) {
   ...
   window.fnUndoNo = function (){
    ...
    $('#btnView').on('click', function() {
        ...
        var CardStatus = [];
        $("select[name='CardStatus[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                CardStatus.push(value3);
            }
        });
