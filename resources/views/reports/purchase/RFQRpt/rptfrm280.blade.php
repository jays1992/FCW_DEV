...
<!-- <form id="frm_rpt_positw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-3">
                <a href="{{route('report',[280,'index'])}}" class="btn singlebt">Request For Quotation Report</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_vid">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="GroupBy" id="GroupBy" class="form-control selectpicker"  data-live-search="true"  >
                                    <option value="Date" selected>Request for Quotation Date</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 pl">
                                <div class="col-lg-6 pl">
                                &nbsp;<input type="radio" name="chk_Detail" id="chk_Detail"   checked /> &nbsp; <label>Request for Quotation Detail</label>
                                </div>
                                <div class="col-lg-6 pl">
                                    <input type="radio" name="chk_Summary" id="chk_Summary"   /> &nbsp; <label>Request for Quotation Summary</label>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[280,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[280,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
