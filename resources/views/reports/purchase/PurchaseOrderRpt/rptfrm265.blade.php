...
@extends('layouts.app')
@section('content')
<!-- <form id="frm_rpt_pos" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->

    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[265,'index'])}}" class="btn singlebt">Purchase Order Report</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_pos"  method="POST">   
            @csrf
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="GroupBy" id="GroupBy" class="form-control selectpicker"  data-live-search="true"  >
                                    <option value="Date" selected>Purchase Order Date</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 pl">
                                ...
                                &nbsp;<input type="radio" name="chk_Detail" id="chk_Detail"   checked /> &nbsp; <label>Purchase Order Detail</label>
                                </div>
                                <div class="col-lg-6 pl">
                                    <input type="radio" name="chk_Summary" id="chk_Summary"   /> &nbsp; <label>Purchase Order Summary</label>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[265,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[265,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
