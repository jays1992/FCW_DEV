...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[$FormId,'index'])}}" class="btn singlebt">Job Card Summary Rpt</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="CustomerName[]" data-hide-disabled="hide" multiple data-actions-box="true" id="CustomerName"  class="form-control selectpicker" multiple data-live-search="true"  >
                                    @foreach($objCustomer as $bindex=>$bRow)
                                        <option value="{{$bRow->CID}}" selected>{{$bRow->CCODE}}-{{$bRow->NAME}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   window.fnUndoNo = function (){
    ...
    $('#btnView').on('click', function() {
        ...
        var CustomerName = [];
        $("select[name='CustomerName[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                CustomerName.push(value3);
            }
        });
        ...
        {
            $("#focusid").val('CustomerName');
            $("#ProceedBtn").focus();
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Customer Name.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
