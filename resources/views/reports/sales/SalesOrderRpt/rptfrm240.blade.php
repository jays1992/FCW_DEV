...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[240,'index'])}}" class="btn singlebt">Sales Order Report</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_sos"  method="POST">   
            @csrf
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="SGLID[]" id="SGLID" class="form-control selectpicker" multiple data-live-search="true"  >
                                @foreach($ObjCustomer as $cindex=>$cRow)
                                        <option value="{{$cRow->SGLID}}" selected>{{$cRow->SGLCODE}}-{{$cRow->SLNAME}}</option>
                                @endforeach
                                </select>
                            </div>                            
                            <div class="col-lg-3 pl"><p>Sales Person</p></div>
                            <div class="col-lg-3 pl" id="div_sperson">
                                <select name="EMPID[]" id="EMPID" class="form-control selectpicker" multiple data-live-search="true"  >
                                @foreach($ObjSalesPerson as $Pindex=>$PRow)
                                        <option value="{{$PRow->EMPID}}" selected>{{$PRow->FNAME}} {{$PRow->LNAME}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="ITEMGID[]" id="ITEMGID" class="form-control selectpicker" multiple data-live-search="true"  >
                            ...
                            <div class="col-lg-3 pl" id="div_itemid">
                                <select name="ITEMID[]" id="ITEMID" class="form-control selectpicker" multiple data-live-search="true"  >
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="GroupBy" id="GroupBy" class="form-control selectpicker" multiple data-live-search="true"  >
                                    <option value="Date" selected>Sales Order Date</option>
                            ...
                            <div class="col-lg-3 pl">
                                <select name="OrderBy" id="OrderBy" class="form-control selectpicker" multiple data-live-search="true"  >
                                    <option value="Date" selected>Sales Order Date</option>
                                    <option value="Customer" >Customer Name</option>
                                    <option value="Sales Person" >Sales Person</option>
                                    <option value="Item Group" >Item Group</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 pl">
                                ...
                                &nbsp;<input type="radio" name="chk_Detail" id="chk_Detail"   checked /> &nbsp; <label>Sales Order Detail</label>
                                </div>
                                <div class="col-lg-6 pl">
                                    <input type="radio" name="chk_Summary" id="chk_Summary"   /> &nbsp; <label>Sales Order Summary</label>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[240,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[240,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
