...
<!-- <form id="frm_rpt_sis" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[241,'index'])}}" class="btn singlebt">Sales Invoice Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="GroupBy" id="GroupBy" class="form-control selectpicker" multiple data-live-search="true"  >
                                    <option value="SIDT" selected>Sales Invoice Date</option>
                                    <option value="SLNAME" >Customer Name</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 pl">
                                ...
                                &nbsp;<input type="radio" name="chk_Detail" id="chk_Detail"   checked /> &nbsp; <label>Sales Invoice Detail</label>
                                </div>
                                <div class="col-lg-6 pl">
                                    <input type="radio" name="chk_Summary" id="chk_Summary"   /> &nbsp; <label>Sales Invoice Summary</label>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[241,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[241,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
