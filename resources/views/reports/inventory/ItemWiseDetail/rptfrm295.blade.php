...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[295,'index'])}}" class="btn singlebt">Item Wise Detail ReportType</a>
                </div><!--col-2-->
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[295,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[295,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
