...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[491,'index'])}}" class="btn singlebt">Item Wise Detail Purchase Report</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_stock"  method="POST">   
            @csrf
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[491,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[491,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
