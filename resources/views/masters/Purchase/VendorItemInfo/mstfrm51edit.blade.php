...
<form id="frm_trn_add" method="POST"  >
  <div class="container-fluid purchase-order-view">    
    @CSRF  
    {{isset($objMstResponse->VPLID) ? method_field('PUT') : '' }}
      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            ...
            @else
                <input type="text" name="VIINFONO" id="VIINFONO" value="{{ isset($HDR->VIINFONO)?$HDR->VIINFONO:''}}"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                <input type="hidden" name="VIINFOID" id="VIINFOID" value="{{ isset($HDR->VIINFOID)?$HDR->VIINFOID:''}}"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                @endif
          ...
          <div class="col-lg-2 pl">
              <input type="text" name="txtvendor_popup" id="txtvendor_popup" value="{{isset($HDR->SGLCODE)?$HDR->SGLCODE:''}} {{isset($HDR->SLNAME)?'-'.$HDR->SLNAME:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
              <input type="hidden" name="VID_REF" id="VID_REF"value="{{isset($HDR->VID_REF)?$HDR->VID_REF:''}}" class="form-control" autocomplete="off" />
            ...
            <div id="Material" class="tab-pane fade in active">
              <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                    <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                      ...
                      <tr>
                          <th>Item Group <input type="hidden" name="Row_Count1" id="Row_Count1" value="{{count($MAT)}}" > </th>
                          <th>Item Code</th>
                          <th>Item Name</th>
                          <th>UOM</th>
                          <th>EOQ</th>
              ...
              @foreach($MAT as $key => $row)
                <tr  class="participantRow">                   
                    ...
                    <input type="text" name="txtIG_popup_{{$key}}" id="txtRFQ_popup_{{$key}}" value="{{isset($row['GROUPCODE'])?$row['GROUPCODE']:''}} {{isset($row['GROUPNAME'])?'-'.$row['GROUPNAME']:''}}" class="form-control CLS_RFQ"  autocomplete="off"  readonly style="width:100px;" /></td>
                   
                    <td  hidden><input type="text" name="RFQID_{{$key}}" id="RFQID_{{$key}}" value="{{isset($row['ITEMGID_REF'])?$row['ITEMGID_REF']:''}}" class="form-control" autocomplete="off" /></td>
                    
                    
                    <td><input type="text" name="popupITEMID_{{$key}}" id="popupITEMID_{{$key}}" value="{{isset($row['ICODE'])?$row['ICODE']:''}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                    <td hidden><input type="text" name="ITEMID_REF_{{$key}}" id="ITEMID_REF_{{$key}}" value="{{isset($row['ITEMID_REF'])?$row['ITEMID_REF']:''}}" class="form-control" autocomplete="off" /></td>
                    
                    <td><input type="text" name="ItemName_{{$key}}" id="ItemName_{{$key}}" value="{{isset($row['NAME'])?$row['NAME']:''}}" class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                    <td><input type="text" name="ItemUom_{{$key}}" id="ItemUom_{{$key}}" value="{{isset($row['UOMCODE'])?$row['UOMCODE']:''}} {{isset($row['DESCRIPTIONS'])?'-'.$row['DESCRIPTIONS']:''}}" class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                    <td hidden><input type="text" name="ItemuomText_{{$key}}" id="ItemuomText_{{$key}}" value="{{isset($row['UOMID_REF'])?$row['UOMID_REF']:''}}" class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                    
                    
                    <td hidden><input type="text" name="UOMID_REF_{{$key}}" id="Itemspec_{{$key}}" value="{{isset($row['UOMCODE'])?$row['UOMCODE']:''}} {{isset($row['DESCRIPTIONS'])?'-'.$row['DESCRIPTIONS']:''}}" class="form-control" readonly autocomplete="off"  /></td>
                    <td @if(strpos($objCOMPANY->NAME,"ALPS") == false)  hidden @endif  ><input type="text" name="Alpspartno_{{$key}}" id="Alpspartno_{{$key}}" class="form-control"  autocomplete="off"  readonly  /></td>
                    <td @if(strpos($objCOMPANY->NAME,"ALPS") == false)  hidden @endif  ><input type="text" name="Custpartno_{{$key}}" id="Custpartno_{{$key}}" class="form-control"  autocomplete="off"  readonly  /></td>
                    <td @if(strpos($objCOMPANY->NAME,"ALPS") == false)  hidden @endif  ><input type="text" name="OEMpartno_{{$key}}" id="OEMpartno_{{$key}}" class="form-control"  autocomplete="off"  readonly /></td>
                    
              
                    <td><input type="text" name="EOQ_{{$key}}" id="EOQ_{{$key}}" value="{{isset($row['EOQ'])?$row['EOQ']:''}}" class="form-control" onkeypress="return onlyNumberKey(event)"  autocomplete="off" style="width:100px;"/></td>
                    <td hidden><input type="text" name="EOQID_{{$key}}" id="EOQID_{{$key}}" value="{{isset($row['EOQ'])?$row['EOQ']:''}}" class="form-control"  autocomplete="off" style="width:100px;"/></td>
                    
                    <td><input type="text" name="LEADDAYS_{{$key}}" id="LEADDAYS_{{$key}}" value="{{isset($row['LEADDAYS'])?$row['LEADDAYS']:''}}" class="form-control" onkeypress="return onlyNumberKey(event)" autocomplete="off"  style="width:100px;"/></td>
                    <td hidden><input type="text" name="LEADDAYSID_{{$key}}" id="LEADDAYSID_{{$key}}" value="{{isset($row['LEADDAYS'])?$row['LEADDAYS']:''}}" class="form-control" autocomplete="off"  style="width:100px;"/></td>
                    
                    <td><input type="text" name="REMARKS_{{$key}}" id="REMARKS_{{$key}}" value="{{isset($row['REMARKS'])?$row['REMARKS']:''}}" class="form-control"  autocomplete="off"  style="width:100px;"/></td>
                    <td hidden><input type="text" name="REMARKSID_{{$key}}" id="REMARKSID_{{$key}}" value="{{isset($row['REMARKS'])?$row['REMARKS']:''}}" class="form-control"  autocomplete="off"  style="width:100px;"/></td>
...
$(document).ready(function(e) {
   ...
   window.fnUndoNo = function (){
    ...
    function validateSingleElemnet(element_id){
      var validator =$("#frm_trn_add" ).validate();
...
function validateFormApp(){  
 ...
 var Deactivated       =   $("#deactive-checkbox_0").val();
 var DODEACTIVATED       =   $("#DODEACTIVATED").val();
 ...
 else if(Deactivated === "1" && DODEACTIVATED ===""){
     $("#FocusId").val("DODEACTIVATED");
     $("#YesBtn").hide();
     $("#NoBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Please select Date of Deactivation.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 }  
...
function checkDuplicateCodeApp(){
...
$.ajax({
    ...
    success:function(data) {
        if(data.exists) {
          ...
          $("#YesBtn").data("funcname","fnSaveDataApp");
          $("#YesBtn").focus();
          $("#OkBtn").hide();
