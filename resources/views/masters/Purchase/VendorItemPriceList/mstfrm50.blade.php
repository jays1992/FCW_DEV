...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[50,'index'])}}" class="btn singlebt">Vendor - Item Price List</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody> 
                ...
                @endphp
                <tr>
                  <td><input type="checkbox" id="chkId{{$val->VPLID}}" value="{{$val->VPLID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                  <td>{{isset($val->VPL_NO) && $val->VPL_NO !=''?$val->VPL_NO:''}}</td>
                  <td>{{isset($val->VPL_DT) && $val->VPL_DT !='' && $val->VPL_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->VPL_DT)):''}}</td>
                  <td>{{isset($val->PL_TITLE) && $val->PL_TITLE !=''?$val->PL_TITLE:''}}</td>
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[50,"add"])}}';
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[50,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[50,"view",":rcdId"]) }}';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[50,"attachment",":rcdId"]) }}';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[50,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[50,"cancel"])}}',
                            type:'POST',
