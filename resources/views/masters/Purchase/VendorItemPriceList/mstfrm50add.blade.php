        ...
        <div class="col-lg-1 pl">
          @if(!empty($objDD))
              @if($objDD->SYSTEM_GRSR == "1")
                  <input type="text" name="PL_NO" id="PL_NO" value="{{ $objDOCNO }}" class="form-control mandatory"  maxlength="10" tabindex="1"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              @endif
              ...
              @endif
          @endif  
          {{-- <input type="text" name="PL_NO" id="PL_NO"  class="form-control mandatory" style="text-transform:uppercase"  maxlength="15" tabindex="1" autocomplete="off" required onkeypress="return AlphaNumaric(event,this)"  > --}}
          <span class="text-danger" id="ERROR_PL_NO"></span>
        </div>			
        <div class="col-lg-1 pl"><p>PL Date</p></div>
        <div class="col-lg-1 pl">
          <input type="date" name="PL_DT" id="PL_DT" class="form-control"  placeholder="dd/mm/yyyy" format="mm/dd/yyyy" maxlength="10"  tabindex="2" required> 
        </div>	
