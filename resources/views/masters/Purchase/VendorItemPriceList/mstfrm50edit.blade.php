    ...
    {{isset($objMstResponse->VPLID) ? method_field('PUT') : '' }}
      ...
      <div class="row">
        ...
        <div class="col-lg-1 pl">
          ...
          <input type="hidden" name="PL_NO" id="PL_NO"  class="form-control mandatory" value="{{ $objMstResponse->VPL_NO }}" style="text-transform:uppercase"  maxlength="15" tabindex="1" autocomplete="off" >
          <input type="hidden" name="VPLID" id="VPLID"  value="{{ $objMstResponse->VPLID }}" />
        ...
        <div class="col-lg-1 pl">          
          <input type="text" name="PL_DT" id="PL_DT" value="{{ \Carbon\Carbon::parse($objMstResponse->VPL_DT)->format('d/m/Y') }}" class="form-control mandatory"  tabindex="2" required readonly> 
        </div>

     
      <div class="col-lg-1 pl"><p>Vendor Group</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="VGID_REF_POPUP" id="VGID_REF_POPUP" class="form-control mandatory" readonly tabindex="3" value="{{isset($objVendorGroupName->VGCODE)?$objVendorGroupName->VGCODE. ' - ':''}}  {{isset($objVendorGroupName->DESCRIPTIONS)?$objVendorGroupName->DESCRIPTIONS:''}}" />
					<input type="hidden" name="VGID_REF" id="VGID_REF" value="{{ $objMstResponse->VGID_REF }}" /> 
        </div>

        <div class="col-lg-2 pl"><p>OR</p></div>
			
			<div class="col-lg-1 pl"><p> Vendor</p></div>
			<div class="col-lg-2 pl">
      <input type="text" name="VID_REF_POPUP" id="VID_REF_POPUP" class="form-control mandatory" readonly tabindex="3" value="{{isset($objVendorName->VCODE)?$objVendorName->VCODE. ' - ':''}}  {{isset($objVendorName->NAME)?$objVendorName->NAME:''}}" />
					<input type="hidden" name="VID_REF" id="VID_REF" value="{{ $objMstResponse->VID_REF }}" /> 
			</div>
</div>
      ...
      <div class="row">
        ...
        <div class="col-lg-1 pl">
          <input type="date" name="PERIOD_FRDT"  id="PERIOD_FRDT" class="form-control"  placeholder="dd/mm/yyyy" maxlength="10" tabindex="4" value="{{ (!is_null($objMstResponse->PERIOD_FR) && $objMstResponse->PERIOD_FR!='1900-01-01')? \Carbon\Carbon::parse($objMstResponse->PERIOD_FR)->format('Y-m-d') : ''   }}" >
        </div>
        
        <div class="col-lg-1 pl"><p>To Period</p></div>
        <div class="col-lg-1 pl">
          <input type="date" name="PERIOD_TODT" id="PERIOD_TODT" class="form-control"  placeholder="dd/mm/yyyy" maxlength="10" tabindex="5" value="{{ (!is_null($objMstResponse->PERIOD_TO) && $objMstResponse->PERIOD_TO!='1900-01-01')? \Carbon\Carbon::parse($objMstResponse->PERIOD_TO)->format('Y-m-d') : ''   }}" >
        </div>
        
        <div class="col-lg-1 pl "><p>Price List Title</p></div>
        <div class="col-lg-7 pl">
          <input type="text" name="PL_TITLE" id="PL_TITLE" class="form-control" maxlength="100" autocomplete="off" tabindex="6" value="{{ $objMstResponse->PL_TITLE }}" >
        </div>        
              ...
              <table id="table3" class="display nowrap table table-striped table-bordered itemlist itemlistscroll w-200" style="height:auto !important;">
                ...
                <tbody>
                  ...
                  <tr  class="participantRow">
                    ...
                    <td>
                      <input  class="form-control CLS_LISTPRICE rightalign five-digits" type="text"  name="LISTPRICE_{{ $key }}" id="IDLISTPRICE_{{ $key }}" value="{{ $row->LP }}"  maxlength="13" autocomplete="off"   >
                    </td>
...
window.fnApproveData = function (){
    ...
    $.ajax({
        url:'{{route("master",[50,"singleapprove"])}}',
        type:'POST',
        data:formData,
...
$("#OkBtn1").click(function(){
  ...
  window.fnSaveData = function (){
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
         //reload form
         window.location.href = "{{route('master',[50,'index'])}}";
