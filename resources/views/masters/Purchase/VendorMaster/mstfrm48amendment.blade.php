...
<div class="container-fluid filter">
		...
		<div class="inner-form">
			...
			<div class="row">
				...
				<div class="col-lg-2 pl">
					<input type="text" name="VCODE" id="VCODE" class="form-control mandatory" value="{{ $objMstCust->VCODE }}"  maxlength="20" readonly required tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
          ...
          <span class="text-danger" id="ERROR_NAME"></span>
				...
				<div class="col-lg-2 pl">
				  <input type="text" name="VENDOR_LEGAL_NAME" id="VENDOR_LEGAL_NAME" class="form-control mandatory" value="{{ $objMstCust->VENDOR_LEGAL_NAME }}"    maxlength="100" tabindex="3" autocomplete="off" required>
          <span class="text-danger" id="ERROR_VENDOR_LEGAL_NAME"></span>
			...
			<div class="row">
				...
				<div class="col-lg-2 pl">
					<input type="text" name="VGID_REF_POPUP" id="VGID_REF_POPUP"  class="form-control mandatory" value="{{ $objCusGro->VGCODE }} - {{ $objCusGro->DESCRIPTIONS }}" required readonly tabindex="4" />
					<input type="hidden" name="VGID_REF" id="VGID_REF" value="{{ $objCusGro->VGID }}"/>
					<span class="text-danger" id="ERROR_VGID_REF"></span>
				</div>
			  
			  <div class="col-lg-2 pl"><p>OLD Ref Code</p></div>
			  <div class="col-lg-2 pl">
				<input type="text" name="OLD_REFCODE" id="OLD_REFCODE" value="{{ $objMstCust->OLDREF_CODE }}"  class="form-control"  maxlength="20" tabindex="5"  autocomplete="off" readonly >
			  </div>
			...
			<div class="row">
				...
				<div class="col-lg-2 pl">
					<input type="text" name="REGADDL1" id="REGADDL1" class="form-control mandatory" value="{{ $objMstCust->REGADDL1 }}"   maxlength="200" required tabindex="7"  autocomplete="off" readonly >
          <span class="text-danger" id="ERROR_REGADDL1"></span>
        </div>
				
					<div class="col-lg-2 pl"><p>Registered Address Line 2</p></div>
				<div class="col-lg-2 pl">
					<input type="text" name="REGADDL2" id="REGADDL2" class="form-control" value="{{ $objMstCust->REGADDL2 }}"   maxlength="200" tabindex="8"  autocomplete="off" readonly >
				</div>

        <div class="col-lg-2 pl"><p>CHA</p></div>
				<div class="col-lg-2 pl">
					<input type="checkbox" name="CHA" id="CHA" value="1" {{ isset($objMstCust->CHA) && $objMstCust->CHA =='1'?'checked':'' }}   autocomplete="off" onclick="return false;" >
				</div>
    ...
    <div class="row">
      ...
      <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" {{$objMstCust->DEACTIVATED == 1 ? "checked" : ""}}
       value='{{$objMstCust->DEACTIVATED == 1 ? 1 : 0}}' tabindex="7" onclick="return false;"  >
      </div>
      ...
      {{$objMstCust->DEACTIVATED == 1 ? "" : "disabled"}}
         tabindex="8" value="{{ (!is_null($objMstCust->DODEACTIVATED) && $objMstCust->DODEACTIVATED!='1900-01-01')? 
         \Carbon\Carbon::parse($objMstCust->DODEACTIVATED)->format('Y-m-d') : ''   }}" onclick="return false;" />
      </div>
      </div>
   </div>
	...
	<div class="container-fluid">
			...
			<div class="tab-content">
				<div id="material" class="tab-pane fade in active">
					<div class="table-wrapper-scroll-x">
						<div class="row" style="margin-top:10px;">
							...
							<div class="col-lg-4">
								<input type="text" name="CORPADDL1" id="CORPADDL1" class="form-control " value="{{ $objMstCust->CORPADDL1 }}"  maxlength="200"   autocomplete="off" readonly >
							</div>
							
							<div class="col-lg-2"><p>Corporate Address Line 2</p></div>
							<div class="col-lg-4">
								<input type="text" name="CORPADDL2" id="CORPADDL2" class="form-control" value="{{ $objMstCust->CORPADDL2 }}"  maxlength="200"  autocomplete="off" readonly  >
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-2">	
								<input type="text" name="CORPCTRYID_REF_POPUP" id="CORPCTRYID_REF_POPUP" class="form-control" value="@isset($objCorpCountry){{ $objCorpCountry->CTRYCODE }} - {{ $objCorpCountry->NAME }} @endisset" readonly  />
							...
							<div class="col-lg-2">		
								<input type="text" name="CORPSTID_REF_POPUP" id="CORPSTID_REF_POPUP" value="@isset($objCorpState){{ $objCorpState->STCODE }} - {{ $objCorpState->NAME }}@endisset" class="form-control" readonly  />
					...
					<div class="col-lg-2">
						<input type="text" name="CORPPIN" id="CORPPIN" class="form-control " value="{{ $objMstCust->CORPPIN }}"  maxlength="10"  autocomplete="off" readonly onclick="return false;"  >
					</div>
					
						<div class="col-lg-2"><p>Email ID</p></div>
						<div class="col-lg-2">
							<input type="text" name="EMAILID" id="EMAILID" class="form-control " value="{{ $objMstCust->EMAILID }}"  maxlength="50"  autocomplete="off" readonly onclick="return false;"  >
						</div>
						
						<div class="col-lg-2"><p>Website</p></div>
						<div class="col-lg-2">
							<input type="text" name="WEBSITE" id="WEBSITE" class="form-control " value="{{ $objMstCust->WEBSITE }}"  maxlength="50"  autocomplete="off" readonly onclick="return false;"  >
						</div>
					...
					<div class="col-lg-2 "><p>Phone No</p></div>
						<div class="col-lg-2">
							<input type="text" name="PHNO" id="PHNO" class="form-control " value="{{ $objMstCust->PHNO }}" maxlength="15"  autocomplete="off" readonly onclick="return false;"  >
						</div>
						
						<div class="col-lg-2"><p>Mobile No</p></div>
						<div class="col-lg-2">
							<input type="text" name="MONO" id="MONO" class="form-control " value="{{ $objMstCust->MONO }}" maxlength="15"  autocomplete="off" readonly onclick="return false;"  >
						</div>
						
						<div class="col-lg-2"><p>Contact Person</p></div>
						<div class="col-lg-2 ">
							<input type="text" name="CPNAME" id="CPNAME"  class="form-control" value="{{ $objMstCust->CPNAME }}" maxlength="50"   autocomplete="off" readonly onclick="return false;" >
						</div>
					...
					<div class="col-lg-2 "><p>Skype</p></div>
						<div class="col-lg-2">
							<input type="text" name="SKYPEID" id="SKYPEID" class="form-control" value="{{ $objMstCust->SKYPEID }}" maxlength="30"  autocomplete="off"  readonly onclick="return false;" >
						</div>
					</div>
				...
				<div id="statutory" class="tab-pane fade"> 
					 ...
					 <div class="table-wrapper-scroll-x" style="margin-top:10px;">
						...
						<div class="col-lg-2">
							<input type="text" name="INDSID_REF_POPUP" id="INDSID_REF_POPUP" class="form-control" value="@isset($objIndType){{ $objIndType->INDSCODE }} - {{ $objIndType->DESCRIPTIONS }}@endisset" readonly  />
						...
						<div class="col-lg-2">
							<input type="text" name="INDSVID_REF_POPUP" id="INDSVID_REF_POPUP" class="form-control"  value="@isset($objIndVer){{ $objIndVer->INDSVCODE }} - {{ $objIndVer->DESCRIPTIONS }}@endisset" readonly  />
						...
						<div class="col-lg-2">
							<input type="text" name="DEALSIN" id="DEALSIN" class="form-control  " value="{{ $objMstCust->DEALSIN }}"   maxlength="50"   autocomplete="off" readonly onclick="return false;" >
						</div>
                ...
                <option value="{{ $Currency-> CRID }}"  @if($objMstCust->DEFCRID_REF==$Currency-> CRID) selected @endif) >
                  {{ $Currency->CRCODE }} - {{ $Currency->CRDESCRIPTION }}</option>
						...
						<div class="col-lg-2">
							<input type="text" name="GSTIN" id="GSTIN" class="form-control  "  value="{{ $objMstCust->GSTIN }}"  maxlength="15"  autocomplete="off"  >
						</div>
				...
				<div class="row">
					<div class="col-lg-2"><p>Credit Limit</p></div>
						<div class="col-lg-2">
							<input type="text" name="CREDITLIMIT" id="CREDITLIMIT" class="form-control  " style="text-align: right" value="{{ $objMstCust->CREDITLIMIT }}" maxlength="18"  autocomplete="off">
						</div>
						
						<div class="col-lg-2"><p>CIN </p></div>
						<div class="col-lg-2">
							<input type="text" name="CIN" id="CIN" class="form-control  "  maxlength="30" value="{{ $objMstCust->CIN }}" autocomplete="off">
						</div>
						
						<div class="col-lg-1"><p>Credit Days </p></div>
						<div class="col-lg-1">
							<input type="text" name="CREDITDAY" id="CREDITDAY" class="form-control" style="text-align: right" value="{{ $objMstCust->CREDITDAY }}" maxlength="4"  autocomplete="off">
						</div>
				...
				<div class="row">
			    	<div class="col-lg-2"><p>PAN No </p></div>
						<div class="col-lg-2">
							<input type="text" name="PANNO" id="PANNO" class="form-control  " value="{{ $objMstCust->PANNO }}" maxlength="10"  autocomplete="off">
            </div>
            <div class="col-lg-2 "><p>Exceptional for GST</p></div>
            <div class="col-lg-2"><input type="checkbox" name="EXE_GST" id="EXE_GST" class="filter-none"  {{$objMstCust->EXE_GST == 1 ? "checked" : ""}}  value='{{$objMstCust->EXE_GST == 1 ? 1 : 0}}' > </div>
				</div>

        <div class="row">
        <div class="col-lg-2"><p>MSME No </p></div>
          <div class="col-lg-2">
            <input type="text" name="MSME_NO" id="MSME_NO" class="form-control  " value="{{ $objMstCust->MSMENO }}"  maxlength="30"  autocomplete="off" style="text-transform:uppercase" readonly onclick="return false;" >
          </div>
          <div class="col-lg-2"><p>Factory No</p></div>
          <div class="col-lg-2">
            <input type="text" name="FACTORY_ACT_NO" id="FACTORY_ACT_NO" class="form-control" value="{{ $objMstCust->FACTORY_NO }}"  maxlength="30"  autocomplete="off" style="text-transform:uppercase" readonly onclick="return false;" >
          </div>
						</div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2">
            <input type="checkbox" name="TDS_APPLICABLE" id="TDS_APPLICABLE" value="1" onChange="TdsApplicable()" {{isset($objMstCust->TDS_APPLICABLE) && $objMstCust->TDS_APPLICABLE ==1?'checked':''}} >
          </div>
        </div>
        ...
        <div class="row TDS_ACTION" style="display:none;">
          ...
          <div class="col-lg-2">
            <input type="text" name="CERTIFICATE_NO" id="CERTIFICATE_NO" value="{{ $objMstCust->CERTIFICATE_NO }}" class="form-control"  maxlength="30"  autocomplete="off">
          </div>

          <div class="col-lg-2"><p>Expiry Date</p></div>
          <div class="col-lg-2">
            <input type="date" name="EXPIRY_DT" id="EXPIRY_DT" value="{{ $objMstCust->EXPIRY_DT }}" class="form-control"   autocomplete="off">
          </div>
        </div>
          ...
          <div class="col-lg-2">
            ...
            <tbody>
              @if(!empty($objPOC))
                ...
                <tr  class="participantRow">
                  <td><input  class="form-control w-100" type="text" name="POC_NAME_{{ $key }}" id="POC_NAME_{{ $key }}" value="{{ $row->NAME }}" maxlength="100"  autocomplete="off" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_DESIG_{{ $key }}" id="POC_DESIG_{{ $key }}" value="{{ $row->DESIG }}" maxlength="50" autocomplete="off"  ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_MONO_{{ $key }}" id="POC_MONO_{{ $key }}" value="{{ $row->MONO }}"  maxlength="10"  autocomplete="off" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_EMAIL_{{ $key }}" id="POC_EMAIL_{{ $key }}" value="{{ $row->EMAIL }}"  maxlength="50"  autocomplete="off" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_LLNO_{{ $key }}" id="POC_LLNO_{{ $key }}" value="{{ $row->LLNO }}"  maxlength="20"  autocomplete="off" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_AUTHLEVEL_{{ $key }}" id="POC_AUTHLEVEL_{{ $key }}" value="{{ $row->AUTHLEVEL }}"  maxlength="30"  autocomplete="off" ></td>
                  <td style="text-align:center;" ><input type="date" placeholder="dd/mm/yyyy"  name="POC_DOB_{{ $key }}" id="POC_DOB_{{ $key }}" value="{{ (!is_null($row->DOB) && $row->DOB!='1900-01-01')? $row->DOB : '' }}" class="form-control" ></td>
                  <td align="center" >
              ...
              @else
                <tr  class="participantRow">
                  ...
                  <td><input  class="form-control w-100" type="text" name="POC_MONO_0" id="POC_MONO_0" maxlength="10"  autocomplete="off" ></td>
                  ...
                  <td style="text-align:center;" ><input type="date" name="POC_DOB_0" id="POC_DOB_0" class="form-control" ></td>
                  <td align="center" >
                    <a class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
            ...
            @if(!empty($objBANK))
             @foreach($objBANK as $key => $row)
              <tr class="participantRow">
                <td><input  class="form-control w-100" type="text" name="BANK_NAME_{{$key}}" id="BANK_NAME_{{$key}}" maxlength="100" value="{{ $row->NAME }}"  autocomplete="off" ></td>
                <td><input  class="form-control w-100" type="text" name="BANK_IFSC_{{$key}}" id="BANK_IFSC_{{$key}}" value="{{ $row->IFSC }}" maxlength="20" autocomplete="off"  ></td>
                <td><input  class="form-control w-100" type="text" name="BANK_BRANCH_{{$key}}" id="BANK_BRANCH_{{$key}}" value="{{ $row->BRANCH }}" maxlength="100"  autocomplete="off" ></td>
                <td>
                  <select name="BANK_ACTYPE_{{$key}}" id="BANK_ACTYPE_{{$key}}" class="form-control"  >
                    <option value="" >Select</option>
                ...
                <td>
                  <input  class="form-control w-100" type="text" name="BANK_ACNO_{{$key}}" id="BANK_ACNO_{{$key}}" value="{{ $row->ACNO }}" maxlength="30"  autocomplete="off" ></td>
                <td align="center" ><input type="checkbox" name="BYDEFALUT_{{$key}}" id="BYDEFALUT_{{$key}}" class="filter-none"  value="1" {{ ($row->BYDEFAULT == 1 || $row->BYDEFAULT=='on')?'checked':'' }} ></td>
                <td align="center" >
                  <a class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
                  <button class="btn remove" title="Delete" data-toggle="tooltip" type="button" @if($loop->iteration-1==0) disabled @endif><i class="fa fa-trash" @if($loop->iteration-1==0) disabled @endif ></i></button>
                </td>
            ...
            @else
              <tr class="participantRow">
                ...
                <td align="center" ><input type="checkbox" name="BYDEFALUT_0" id="BYDEFALUT_0" class="filter-none"  value="1"  autocomplete="off" ></td>
                <td align="center" >
                  <a class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
            ...
            @if(!empty($objLOC))
              ...
              <tr  class="participantRow">
                <td><input  class="form-control w-100" type="text" name="LOC_NAME_{{ $key }}" id="LOC_NAME_{{ $key }}" value="{{ $row->NAME }}"  maxlength="50"  autocomplete="off"  ></td>
                <td><input  class="form-control w-100" type="text" name="LOC_LADD_{{ $key }}" id="LOC_LADD_{{ $key }}" value="{{ $row->LADD }}" maxlength="200"  autocomplete="off"  ></td>

                <td><input  class="form-control w-100" type="text" name="LOC_CTRYID_REF_{{ $key }}" id="TXTLOC_CTRYID_REF_POPUP_{{ $key }}" value="{{ $row->COU_CTRYCODE }} - {{ $row->COU_NAME }}" maxlength="100" readonly></td>
                ...
                <td><input  class="form-control w-100" type="text" name="LOC_STID_REF_{{ $key }}" id="TXTLOC_STID_REF_POPUP_{{ $key }}" value="{{ $row->STA_STCODE }} - {{ $row->STA_NAME }}" maxlength="100" readonly></td>
                ...
                <td><input  class="form-control w-100" type="text" name="LOC_CITYID_REF_{{ $key }}" id="TXTLOC_CITYID_REF_POPUP_{{ $key }}" value="{{ $row->CIT_CITYCODE }} - {{ $row->CIT_NAME }}" maxlength="100" readonly></td>
                ...
                <td><input  class="form-control w-100" type="text" name="LOC_PIN_{{ $key }}" id="LOC_PIN_{{ $key }}" maxlength="20" value="{{ $row->PIN }}" autocomplete="off"  ></td>
                <td><input  class="form-control w-100" type="text" name="LOC_GSTIN_{{ $key }}" id="LOC_GSTIN_{{$key}}" maxlength="15" value="{{ $row->GSTIN }}"  autocomplete="off"  ></td>
                <td><input  class="form-control w-100" type="text" name="LOC_CPNAME_{{ $key }}" id="LOC_CPNAME_{{$key}}" maxlength="30" value="{{ $row->CPNAME }}"  autocomplete="off"  ></td>
                <td><input  class="form-control w-100" type="text" name="LOC_CPDESIGNATION_{{$key}}" id="LOC_CPDESIGNATION_{{$key}}" maxlength="20" value="{{ $row->CPDESIGNATION }}"  autocomplete="off" ></td>
                <td><input  class="form-control w-100" type="text" name="LOC_EMAIL_{{$key}}" id="LOC_EMAIL_{{$key}}" maxlength="50" value="{{ $row->EMAIL }}"  autocomplete="off" ></td>
                <td><input  class="form-control w-100" type="text" name="LOC_MONO_{{$key}}" id="LOC_MONO_{{$key}}" maxlength="10" value="{{ $row->MONO }}"  autocomplete="off" ></td>
                <td><input  class="form-control w-100" type="text" name="LOC_SPECIAL_INS_{{$key}}" id="LOC_SPECIAL_INS_{{$key}}" maxlength="50" value="{{ $row->SPECIAL_INS }}"   autocomplete="off" ></td>
                
                <td style="text-align:center;" ><input type="checkbox" name="LOC_BILLTO_{{$key}}" id="LOC_BILLTO_{{$key}}" class="filter-none"  value="1" {{ ($row->BILLTO == 1 || $row->BILLTO=='on')?'checked':'' }}></td>
                <td style="text-align:center;" ><input type="checkbox" name="LOC_DEFAULT_BILLTO_{{$key}}" id="LOC_DEFAULT_BILLTO_{{$key}}" class="filter-none"  value="1" {{ ($row->DEFAULT_BILLING == 1 || $row->DEFAULT_BILLING=='on')?'checked':'' }} ></td>
                <td style="text-align:center;" ><input type="checkbox" name="LOC_SHIPTO_{{$key}}" id="LOC_SHIPTO_{{$key}}" class="filter-none"  value="1" {{ ($row->SHIPTO == 1 || $row->SHIPTO=='on')?'checked':'' }} ></td>
                <td style="text-align:center;" ><input type="checkbox" name="LOC_DEFAULT_SHIPTO_{{$key}}" id="LOC_DEFAULT_SHIPTO_{{$key}}" class="filter-none"  value="1" {{ ($row->DEFAULT_SHIPPING == 1 || $row->DEFAULT_SHIPPING=='on')?'checked':'' }} ></td>
            ...
            <tr  class="participantRow">
              ...
              <td><input  class="form-control w-100" type="text" name="LOC_MONO_0" id="LOC_MONO_0" maxlength="10"  autocomplete="off" ></td>
              <td><input  class="form-control w-100" type="text" name="LOC_SPECIAL_INS_0" id="LOC_SPECIAL_INS_0" maxlength="50"  autocomplete="off" ></td>
        ...
        <div id="ALPSSpecific" class="tab-pane fade">
                    ...
                    <div class="inner-form" style="margin-top:10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_VENDOR_CODE" id="SAP_VENDOR_CODE" value="{{ $objMstCust->SAP_VENDOR_CODE }}" class="form-control" style="text-transform:uppercase">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD2) && $TabSetting->FIELD2 !=''?$TabSetting->FIELD2:'Add. Vendor Name1'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_VENDOR_NAME1" id="SAP_VENDOR_NAME1" value="{{ $objMstCust->SAP_VENDOR_NAME1 }}" class="form-control">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD3) && $TabSetting->FIELD3 !=''?$TabSetting->FIELD3:'Add. Vendor Name2'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_VENDOR_NAME2" id="SAP_VENDOR_NAME2" value="{{ $objMstCust->SAP_VENDOR_NAME2 }}" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_VENDOR_NAME3" id="SAP_VENDOR_NAME3" value="{{ $objMstCust->SAP_VENDOR_NAME3 }}" class="form-control" >
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD5) && $TabSetting->FIELD5 !=''?$TabSetting->FIELD5:'Add. Corporate Group'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CORPORATE_GROUP" id="SAP_CORPORATE_GROUP" value="{{ $objMstCust->SAP_CORPORATE_GROUP }}" class="form-control">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD6) && $TabSetting->FIELD6 !=''?$TabSetting->FIELD6:'Add. Account Group'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_ACCOUNT_GROUP" id="SAP_ACCOUNT_GROUP" value="{{ $objMstCust->SAP_ACCOUNT_GCODE }}" class="form-control" >
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD7) && $TabSetting->FIELD7 !=''?$TabSetting->FIELD7:'Add. Account Group Name'}}</p></div>
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_ACCOUNT_GROUP_NAME" id="SAP_ACCOUNT_GROUP_NAME" value="{{ $objMstCust->SAP_ACCOUNT_GNAME }}" class="form-control" >
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD8) && $TabSetting->FIELD8 !=''?$TabSetting->FIELD8:'Add. Trading Partner'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_TRADING_PARTNER" id="SAP_TRADING_PARTNER" value="{{ $objMstCust->SAP_TRADING_PARTNER_CODE }}" class="form-control">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD9) && $TabSetting->FIELD9 !=''?$TabSetting->FIELD9:'Add. Trading Partner Name'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_TRADING_PARTNER_NAME" id="SAP_TRADING_PARTNER_NAME" value="{{ $objMstCust->SAP_TRADING_PARTNER_NAME }}" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_INVOCING_PARTY" id="SAP_INVOCING_PARTY" value="{{ $objMstCust->SAP_INVOICING_PARTY }}" class="form-control" >
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD11) && $TabSetting->FIELD11 !=''?$TabSetting->FIELD11:'Our Code In Vendor Book'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="OUR_CODE_VBOOK" id="OUR_CODE_VBOOK" value="{{ $objMstCust->OUR_CODE_INVBOOK }}" class="form-control">
                        </div>
                  ...
                  <tr  class="participantRow">
                    ...
                    <td id="{{"tdinputid_".$udfkey}}">
                      ...
                      if($chkvaltype=='date'){
                        ...
                        $strinp = '<input type="date" placeholder="dd/mm/yyyy" name="'.$dynamicid.'" id="'.$dynamicid.'" class="form-control" value="'.$udfrow->VALUE.'" /> ';       

                      }else if($chkvaltype=='time'){

                          $strinp= '<input type="time" placeholder="h:i" name="'.$dynamicid.'" id="'.$dynamicid.'" class="form-control"  value="'.$udfrow->VALUE.'"/> ';

                      }else if($chkvaltype=='numeric'){
                      $strinp = '<input type="text" name="'.$dynamicid. '" id="'.$dynamicid.'" class="form-control" value="'.$udfrow->VALUE.'"/> ';
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="cg_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        <tbody>
        @foreach ($objVendorGroupList as $index=>$VgList)

        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_VGID_REF[]" id="cgidref_{{ $VgList->VGID }}" class="clscgidref" value="{{ $VgList->VGID }}" ></td>
          <td class="ROW2" style="width: 39%">{{ $VgList->VGCODE }}
          <input type="hidden" id="txtcgidref_{{ $VgList->VGID }}" data-desc="{{ $VgList->VGCODE }} - {{ $VgList->DESCRIPTIONS }}" value="{{ $VgList-> VGID }}"/>
          </td>
          <td class="ROW3" style="width: 39%">{{ $VgList->DESCRIPTIONS }}</td>
        </tr>
        @endforeach
        </tbody>
      </table>
...
//-----------------------
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("master",[48,"saveamendment"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
...
window.fnApproveData = function (){
      ...
      $.ajax({
          url:'{{route("master",[48,"singleapprove"])}}',
          type:'POST',
          data:formData,
          success:function(data) {
...
//********-----
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
         //reload form
         window.location.href = "{{route('master',[48,'index'])}}";
...
$(document).ready(function(){
  ...
  var result  = $.ajax({
                url:'{{ route("master",[48,"check_transaction"])}}',
                type:'POST',
                async: false,
                dataType: 'json',
                data: {VCODE:VCODE},
