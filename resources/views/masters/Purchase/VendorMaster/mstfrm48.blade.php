...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="{{route('master',[48,'index'])}}" class="btn singlebt">Vendor Master</a>
    </div>

    <div class="col-lg-10 topnav-pd">
      <a href="{{route('master',[48,'add'])}}" id="btnSelectedRows" class="btn topnavbt" {{$objRights->ADD != 1 ? 'disabled' : ''}}><i class="fa fa-plus"></i> Add</a>
...
function load_country_data(limit, start){
  ...
  $.ajax({
    url:'{{route("master",[48,"getListingData"])}}',
    method:"POST",
...
$(document).ready(function(){
  getListingData();
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[48,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[48,"view",":rcdId"]) }}';
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '{{route("master",[48,"amendment",":rcdId"]) }}';
                            editURL = editURL.replace(":rcdId",recordId);
                            window.location.href=editURL;
                      }else if(is_approve==2){
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[48,"attachment",":rcdId"]) }}';
    ...
    $('#btnImport').on('click', function() {
        var impURL =  '{{route("master",[48,"importdata"]) }}';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[48,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[48,"cancel"])}}',
                            type:'POST',
