...
<div class="container-fluid filter">
		...
		<div class="inner-form">
          ...
          <span class="text-danger" id="ERROR_VENDOR_LEGAL_NAME"></span>
			...
			<div class="row">
			  ...
			  <div class="col-lg-2 pl">
				<input type="text" name="OLD_REFCODE" id="OLD_REFCODE" value="{{ $objMstCust->OLDREF_CODE }}"  class="form-control"  maxlength="20" tabindex="5"  autocomplete="off" >
			  </div>
			...
			<div class="row">
				...
				<div class="col-lg-2 pl">
					<input type="text" name="REGADDL1" id="REGADDL1" class="form-control mandatory" value="{{ $objMstCust->REGADDL1 }}"   maxlength="200" required tabindex="7"  autocomplete="off" >
          <span class="text-danger" id="ERROR_REGADDL1"></span>
        </div>
				
					<div class="col-lg-2 pl"><p>Registered Address Line 2</p></div>
				<div class="col-lg-2 pl">
					<input type="text" name="REGADDL2" id="REGADDL2" class="form-control" value="{{ $objMstCust->REGADDL2 }}"   maxlength="200" tabindex="8"  autocomplete="off" >
				</div>

        <div class="col-lg-2 pl"><p>CHA</p></div>
				<div class="col-lg-2 pl">
					<input type="checkbox" name="CHA" id="CHA" value="1" {{ isset($objMstCust->CHA) && $objMstCust->CHA =='1'?'checked':'' }}   autocomplete="off">
				</div>
    ...
    <div class="row">
      ...
      <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" {{$objMstCust->DEACTIVATED == 1 ? "checked" : ""}}
       value='{{$objMstCust->DEACTIVATED == 1 ? 1 : 0}}' tabindex="7"  >
      </div>
      ...
      {{$objMstCust->DEACTIVATED == 1 ? "" : "disabled"}}
         ...
         \Carbon\Carbon::parse($objMstCust->DODEACTIVATED)->format('Y-m-d') : ''   }}" />
      </div>
      </div>
   </div>
	...
	<div class="container-fluid">
			...
			<div class="tab-content">
				<div id="material" class="tab-pane fade in active">
					<div class="table-wrapper-scroll-x">
						<div class="row" style="margin-top:10px;">
							...
							<div class="col-lg-4">
								<input type="text" name="CORPADDL1" id="CORPADDL1" class="form-control " value="{{ $objMstCust->CORPADDL1 }}"  maxlength="200"   autocomplete="off" >
							</div>
							
							<div class="col-lg-2"><p>Corporate Address Line 2</p></div>
							<div class="col-lg-4">
								<input type="text" name="CORPADDL2" id="CORPADDL2" class="form-control" value="{{ $objMstCust->CORPADDL2 }}"  maxlength="200"  autocomplete="off"  >
							</div>
					...
					<div class="col-lg-2">
						<input type="text" name="CORPPIN" id="CORPPIN" class="form-control " value="{{ $objMstCust->CORPPIN }}"  maxlength="10"  autocomplete="off"  >
					</div>
					
						<div class="col-lg-2"><p>Email ID</p></div>
						<div class="col-lg-2">
							<input type="text" name="EMAILID" id="EMAILID" class="form-control " value="{{ $objMstCust->EMAILID }}"  maxlength="50"  autocomplete="off"  >
						</div>
						
						<div class="col-lg-2"><p>Website</p></div>
						<div class="col-lg-2">
							<input type="text" name="WEBSITE" id="WEBSITE" class="form-control " value="{{ $objMstCust->WEBSITE }}"  maxlength="50"  autocomplete="off"  >
						</div>
					...
					<div class="col-lg-2 "><p>Phone No</p></div>
						<div class="col-lg-2">
							<input type="text" name="PHNO" id="PHNO" class="form-control " value="{{ $objMstCust->PHNO }}" maxlength="15"  autocomplete="off"  >
						</div>
						
						<div class="col-lg-2"><p>Mobile No</p></div>
						<div class="col-lg-2">
							<input type="text" name="MONO" id="MONO" class="form-control " value="{{ $objMstCust->MONO }}" maxlength="15"  autocomplete="off"  >
						</div>
						
						<div class="col-lg-2"><p>Contact Person</p></div>
						<div class="col-lg-2 ">
							<input type="text" name="CPNAME" id="CPNAME"  class="form-control" value="{{ $objMstCust->CPNAME }}" maxlength="50"   autocomplete="off" >
						</div>
					...
					<div class="col-lg-2 "><p>Skype</p></div>
						<div class="col-lg-2">
							<input type="text" name="SKYPEID" id="SKYPEID" class="form-control" value="{{ $objMstCust->SKYPEID }}" maxlength="30"  autocomplete="off"  >
						</div>
					</div>
				...
				<div id="statutory" class="tab-pane fade"> 
					 ...
					 <div class="table-wrapper-scroll-x" style="margin-top:10px;">
						...
						<div class="col-lg-2">
							<input type="text" name="DEALSIN" id="DEALSIN" class="form-control  " value="{{ $objMstCust->DEALSIN }}"   maxlength="50"   autocomplete="off" >
						</div>
        ...
        <div class="col-lg-2"><p>MSME No </p></div>
          <div class="col-lg-2">
            <input type="text" name="MSME_NO" id="MSME_NO" class="form-control  " value="{{ $objMstCust->MSMENO }}"  maxlength="30"  autocomplete="off" style="text-transform:uppercase">
          </div>
          <div class="col-lg-2"><p>Factory No</p></div>
          <div class="col-lg-2">
            <input type="text" name="FACTORY_ACT_NO" id="FACTORY_ACT_NO" class="form-control" value="{{ $objMstCust->FACTORY_NO }}"  maxlength="30"  autocomplete="off" style="text-transform:uppercase">
          </div>
						</div>
