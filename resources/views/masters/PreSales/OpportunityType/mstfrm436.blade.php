    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
                ...
                <th>Opportunity Type Code</th>
                <th>Opportunity Type Name</th>
                <th>De-Activated</th>  
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->ID}}" value="{{$val->ID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->OPPORTUNITY_TYPECODE) && $val->OPPORTUNITY_TYPECODE !=''?$val->OPPORTUNITY_TYPECODE:''}}</td>
                <td>{{isset($val->OPPORTUNITY_TYPENAME) && $val->OPPORTUNITY_TYPENAME !=''?$val->OPPORTUNITY_TYPENAME:''}}</td>
