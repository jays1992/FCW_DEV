          ...
          <div class="inner-form">
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <label> {{$objResponse->OPPORTUNITY_TYPECODE}} </label>
                    <input type="hidden" name="OPPORTUNITY_TYPECODE" id="OPPORTUNITY_TYPECODE" value="{{ $objResponse->ID }}" />
                    <input type="hidden" name="OPPORTUNITY_TYPECODE" id="OPPORTUNITY_TYPECODE" value="{{ $objResponse->OPPORTUNITY_TYPECODE }}" autocomplete="off"  maxlength="20"   />
                </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input {{$ActionStatus}} type="text" name="OPPORTUNITY_TYPENAME" id="OPPORTUNITY_TYPENAME" class="form-control mandatory" value="{{ old('OPPORTUNITY_TYPENAME',$objResponse->OPPORTUNITY_TYPENAME) }}" maxlength="200" tabindex="1"  />
                  </div>
                </div>
