    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
                ...
                <th>Employee Target Code</th>
                <th>Employee Target Name</th>
                <th>Employee Target Type</th>
                <th>De-Activated</th>  
            ...
            <tr>
                ...
                <td>{{isset($val->EMPLOYEE_TARGETCODE) && $val->EMPLOYEE_TARGETCODE !=''?$val->EMPLOYEE_TARGETCODE:''}}</td>
                <td>{{isset($val->EMPCODE) && $val->EMPCODE !=''?$val->EMPCODE:''}}-{{isset($val->FNAME) && $val->FNAME !=''?$val->FNAME:''}}</td>
                <td>{{isset($val->EMPLOYEE_TYPE) && $val->EMPLOYEE_TYPE !=''?$val->EMPLOYEE_TYPE:''}}</td>
