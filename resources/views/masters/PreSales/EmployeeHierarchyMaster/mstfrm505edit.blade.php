                     ...
                     <tbody>
                      ...
                      @foreach($MAT as $key => $row)
                       ...
                       <tr  class="participantRow">
                         <td><input {{$ActionStatus}} class="form-control" type="text" name="SRNo[]"            id ="SRNo_{{$row->SR_NO}}"              value="{{isset($row->SR_NO) && $row->SR_NO !=''?$row->SR_NO:''}}"  autocomplete="off" readonly></td>
