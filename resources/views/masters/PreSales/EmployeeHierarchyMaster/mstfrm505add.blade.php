          ...
          <div class="inner-form">
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    @else
                      <input type="text" name="DOC_NO" id="DOC_NO" value="{{ old('DOC_NO') }}"  class="form-control mandatory"  autocomplete="off" style="text-transform:uppercase"  >
                      @endif
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="TEAM_NAME" id="TEAM_NAME" onclick="getTeamName(this.id,'{{route('master',[$FormId,'getTeamMstName'])}}','Team Name Details')" class="form-control mandatory" readonly />
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="REPORTING_TO" id="REPORTING_TO" onclick="getTeamName(this.id,'{{route('master',[$FormId,'getReportngTo'])}}','Reporting To Details')" class="form-control mandatory" readonly />
                          ...
                          <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                            ...
                            <tbody>
                              <tr  class="participantRow">
                                ...
                                <td><input  class="form-control" type="text" name="EMPCODE[]"   id ="EMPCODE_0" onclick="getTeamName(this.id,'{{route('master',[$FormId,'getEmpCode'])}}','Employee Code Details')" autocomplete="off" readonly></td>
                                <td hidden><input   class="form-control" type="hidden" name="EMPID_REF[]" id ="HIDDEN_EMPCODE_0"   autocomplete="off" readonly></td>
                                
                                {{-- <td><input  class="form-control" type="text" name="REPORTTO[]"   id ="REPORTTO_0" onclick="getReportingTo(this.id,'{{route('master',[$FormId,'getReportToCode'])}}','Reporting To Details')" autocomplete="off" readonly></td> --}}
