    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
                ...
                <th>Opportunity Stage Code</th>
                <th>Opportunity Stage Name</th>
                <th>De-Activated</th>  
            ...
            <tr>
                ...
                <td>{{isset($val->OPPORTUNITY_STAGECODE) && $val->OPPORTUNITY_STAGECODE !=''?$val->OPPORTUNITY_STAGECODE:''}}</td>
                <td>{{isset($val->OPPORTUNITY_STAGENAME) && $val->OPPORTUNITY_STAGENAME !=''?$val->OPPORTUNITY_STAGENAME:''}}</td>
