          ...
          <div class="inner-form">
                    ...
                    <div class="col-lg-11 pl">
						@if(!empty($objDD))
                            @if($objDD->SYSTEM_GRSR == "1")
                                <input type="text" name="ACTIVITYCODE" id="ACTIVITYCODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @endif
                            @if($objDD->MANUAL_SR == "1")
                                <input type="text" name="ACTIVITYCODE" id="ACTIVITYCODE" value="{{ old('ACTIVITYCODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                            @endif
                        @endif
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="ACTIVITYNAME" id="ACTIVITYNAME" class="form-control mandatory" value="{{ old('ACTIVITYNAME') }}" maxlength="200" tabindex="2"  />
