...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->CLASSID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->CLASS_CODE}} </label>
                    <input type="hidden" name="CLASSID" id="CLASSID" value="{{ $objResponse->CLASSID }}" />
                    <input type="hidden" name="CLASS_CODE" id="CLASS_CODE" value="{{ $objResponse->CLASS_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="CLASS_DESC" id="CLASS_DESC" class="form-control mandatory" value="{{ old('CLASS_DESC',$objResponse->CLASS_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[131,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[131,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
