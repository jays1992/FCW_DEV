...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->PTID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->PTCODE}} </label>
                    <input type="hidden" name="PTID" id="PTID" value="{{ $objResponse->PTID }}" />
                    <input type="hidden" name="PTCODE" id="PTCODE" value="{{ $objResponse->PTCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="PTNAME" id="PTNAME" class="form-control mandatory" value="{{ old('PTNAME',$objResponse->PTNAME) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[77,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[77,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
