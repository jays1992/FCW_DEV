                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        {{-- <input type="text" name="STCODE" id="STCODE" value="{{ old('STCODE') }}" class="form-control mandatory" autocomplete="off" maxlength="30" tabindex="1" style="text-transform:uppercase" onkeypress="return AlphaNumaric(event,this)" /> --}}
                        @if(!empty($objDD))
                            @if($objDD->SYSTEM_GRSR == "1")
                                <input type="text" name="STCODE" id="STCODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @endif
                            @if($objDD->MANUAL_SR == "1")
                                <input type="text" name="STCODE" id="STCODE" value="{{ old('STCODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                            @endif
                        @endif  
