...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_add" method="POST"  > 
          @CSRF
          {{isset($objResponse->SPECIFICATIONID) ? method_field('PUT') : '' }}
          <div class="inner-form">            
            <div class="row">
              <div class="col-lg-2 pl"><p>Specification Code</p></div>
              <div class="col-lg-2 pl">              
                <label> {{$objResponse->SPECIFICATIONCODE}} </label>
                <input type="hidden" name="SPECIFICATIONID" id="SPECIFICATIONID" value="{{ $objResponse->SPECIFICATIONID }}" />
                <input type="hidden" name="SPECIFICATIONCODE" id="SPECIFICATIONCODE" value="{{ $objResponse->SPECIFICATIONCODE }}" autocomplete="off"  maxlength="6"   />
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="SPECIFICATIONNAME" id="SPECIFICATIONNAME" class="form-control mandatory" value="{{ old('SPECIFICATIONNAME',$objResponse->SPECIFICATIONNAME) }}" maxlength="200" tabindex="2"  />
              ...
              <div class="row">
                ...
                <div class="col-lg-5 pl">
                  <input type="text" name="SPECIFICATIONDESC" id="SPECIFICATIONDESC" class="form-control mandatory" value="{{ old('SPECIFICATIONDESC',$objResponse->SPECIFICATIONDESC) }}" maxlength="200" tabindex="1"  />
...
$.ajax({
    url:'{{route("mastermodify",[383,"singleapprove"])}}',
    type:'POST',
    data:formData,
    success:function(data) {       
        if(data.errors) {
