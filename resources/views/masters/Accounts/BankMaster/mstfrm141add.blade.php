...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <button class="btn topnavbt" id="btnSave"  tabindex="18"  ><i class="fa fa-save"></i> Save</button>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      ...
                      @if(!empty($objDD))
                          @if($objDD->SYSTEM_GRSR == "1")
                              <input type="text" name="BCODE" id="BCODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                          @endif
                          @if($objDD->MANUAL_SR == "1")
                              <input type="text" name="BCODE" id="BCODE" value="{{ old('BCODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                          @endif
                      @endif 
                      {{-- <input type="text" name="BCODE" id="BCODE" value="{{ old('BCODE') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" /> --}}
                        <span class="text-danger" id="ERROR_BCODE"></span> 
                      </div>
                    </div>
                    
                    <div class="col-lg-2 pl col-md-offset-2"><p>Name</p></div>
                    <div class="col-lg-4 pl">
                    <input type="text" name="NAME" id="NAME" class="form-control mandatory" value="{{ old('NAME') }}" maxlength="100" tabindex="2" autocomplete="off"  />
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3 pl">
                      <input type="text" name="BRANCH" id="BRANCH" class="form-control mandatory"  maxlength="100" tabindex="3" >
                      <span class="text-danger" id="ERROR_BRANCH"></span> 
                    </div>
                    
                    <div class="col-lg-2 pl col-md-offset-1"><p>IFSC</p></div>
                    <div class="col-lg-2 pl">
                      <input type="text" name="IFSC" id="IFSC" class="form-control mandatory"  maxlength="30" tabindex="4" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      <div class="col-lg-12 pl">
                      <input type="text" name="ACNO" id="ACNO" class="form-control mandatory"  maxlength="30" tabindex="6" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-1 pl">
                      <div class="col-lg-12 pl">
                      <input type="text" name="ODLIMIT" id="ODLIMIT" class="form-control "  maxlength="9" tabindex="7"  >
                    ...
                    <div class="col-lg-2 pl">
                      <input type="time" name="BRANCHTIME" id="BRANCHTIME" class="form-control "  tabindex="8"  >
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 pl">
                      <input type="text" name="ADD1" id="ADD1" class="form-control "  maxlength="200" tabindex="9" >
                      <span class="text-danger" id="ERROR_ADD1"></span> 
                    </div>
                    
                    <div class="col-lg-2 pl "><p>Address 2</p></div>
                    <div class="col-lg-4 pl">
                      <input type="text" name="ADD2" id="ADD2" class="form-control "  maxlength="200" tabindex="10"  >
                  ...
                  <div class="col-lg-2 pl"><p>Country</p></div>
                    <div class="col-lg-2 pl">
                      <input type="text" name="CTRYID_REF_POPUP" id="CTRYID_REF_POPUP" class="form-control mandatory" readonly tabindex="11" />
                    ...
                    <div class="col-lg-2 pl">
                      <input type="text" name="STID_REF_POPUP" id="STID_REF_POPUP" class="form-control mandatory"  readonly tabindex="12" />
                  ...
                  <div class="col-lg-2 pl"><p>City</p></div>
                    <div class="col-lg-2 pl">
                      <div class="col-lg-11 pl">
                      <input type="text" name="CITYID_REF_POPUP" id="CITYID_REF_POPUP" class="form-control mandatory" readonly tabindex="13" />
                    ...
                    <div class="col-lg-2 pl">
                      <div class="col-lg-11 pl">
                      <input type="text" name="PIN" id="PIN" class="form-control"  maxlength="20" tabindex="14"  >
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 pl">
                      <input type="text" name="LANDMARK" id="LANDMARK" class="form-control  "  maxlength="200" tabindex="15"   >
                    ...
                    <input type="date" name="DOO" class="form-control" id="DOO" placeholder="dd/mm/yyyy" tabindex="16" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 pl">
                      <input type="text" name="SIGNAUTH" id="SIGNAUTH" class="form-control  "  maxlength="100"  tabindex="17" >
                      <span class="text-danger" id="ERROR_SIGNAUTH"></span> 
                      </div>

                    <div class="col-lg-2 pl"><p>GL</p></div>
                    <div class="col-lg-2 pl">
                        <input type="text" name="GLID_REF_POPUP" id="GLID_REF_POPUP" class="form-control mandatory" readonly tabindex="18" />
				  ...
				  <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input type="text" name="BANK_GLID_REF_POPUP" id="BANK_GLID_REF_POPUP" class="form-control mandatory" readonly tabindex="18" />
                        <input type="hidden" name="BANK_GLID_REF" id="BANK_GLID_REF" />
...
"use strict";
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function validateSingleElemnet(element_id){
      var validator =$("#frm_mst_add" ).validate();
         if(validator.element( "#"+element_id+"" )){
          ...
          if(element_id=="BCODE" || element_id=="bcode" ) {
            checkDuplicateCode();
          }
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'{{route("master",[141,"codeduplicate"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
                if(data.exists) {
                    $(".text-danger").hide();
                    showError('ERROR_BCODE',data.msg);
                    $("#BCODE").focus();
                }                                
            },
            error:function(data){
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                if(data.errors) {
                    ...
                    if(data.errors.BCODE){
                       // showError('ERROR_BCODE',data.errors.BCODE);
                        $("#YesBtn").hide();
                        $("#NoBtn").hide();
                        $("#OkBtn1").hide();
                        $("#OkBtn").show();
                        $("#AlertMessage").text("Bank Code is "+data.errors.BCODE);
                        $("#alert").modal('show');
                        $("#OkBtn").focus();
                    }
                    if(data.errors.NAME){
                       //showError('ERROR_NAME',data.errors.NAME);
                        ...
                        $("#OkBtn1").hide();
                        $("#OkBtn").show();
                        $("#AlertMessage").text("Bank Name is "+data.errors.NAME);
                        $("#alert").modal('show');
                        $("#OkBtn").focus();
                    }
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('master',[141,'add'])}}";
