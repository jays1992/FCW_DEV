...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[164,'index'])}}" class="btn singlebt">Nature of Asseessee</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->NOAID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->NOA_CODE}} </label>
                    <input type="hidden" name="NOAID" id="NOAID" value="{{ $objResponse->NOAID }}" />
                    <input type="hidden" name="NOA_CODE" id="NOA_CODE" value="{{ $objResponse->NOA_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="NOA_NAME" id="NOA_NAME" class="form-control mandatory" value="{{ old('NOA_NAME',$objResponse->NOA_NAME) }}" maxlength="200" tabindex="1"  />
                    <span class="text-danger" id="ERROR_NOA_NAME"></span> 
                  </div>
                </div>
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[164,"add"])}}';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    $("#NOA_NAME").blur(function(){
        $(this).val($.trim( $(this).val() ));
        $("#ERROR_NOA_NAME").hide();
        validateSingleElemnet("NOA_NAME");
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[164,"update"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
                ...
                if(data.errors) {
                    ...
                    if(data.errors.NOA_NAME){
                        showError('ERROR_NOA_NAME',data.errors.NOA_NAME);
                    }
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[164,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[164,"index"]) }}';
