...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[132,'index'])}}" class="btn singlebt">Cost Centre (CC) Category</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->CCCATID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->CCCATCODE}} </label>
                    <input type="hidden" name="CCCATID" id="CCCATID" value="{{ $objResponse->CCCATID }}" />
                    <input type="hidden" name="CCCATCODE" id="CCCATCODE" value="{{ $objResponse->CCCATCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="CCCATNAME" id="CCCATNAME" class="form-control mandatory" value="{{ old('CCCATNAME',$objResponse->CCCATNAME) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[132,"add"])}}';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[132,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[132,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[132,"index"]) }}';
