...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[134,'index'])}}" class="btn singlebt">GST Type</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->GSTID) ? method_field('PUT') : '' }}
          <div class="inner-form">
          
              
              <div class="row">
                  <div class="col-lg-2 pl"><p>GST Type Code</p></div>
                  <div class="col-lg-2 pl">
                  
                    <label> {{$objResponse->GSTCODE}} </label>
                    <input type="hidden" name="GSTID" id="GSTID" value="{{ $objResponse->GSTID }}" />
                    <input type="hidden" name="GSTCODE" id="GSTCODE" value="{{ $objResponse->GSTCODE }}" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[134,"add"])}}';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[134,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[134,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[134,"index"]) }}';
