...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Budget Master</a></div>
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="BUG_NO" id="BUG_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
          <input type="text" name="BUG_NO" id="BUG_NO" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
          @else
            <input type="text" name="BUG_NO" id="BUG_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
        </div>
              
        <div class="col-lg-2 pl"><p>Budget Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="BUG_DATE" id="BUG_DATE" value="{{date('Y-m-d')}}" class="form-control BUG_DATE" autocomplete="off"  placeholder="dd/mm/yyyy" >
        </div>

        <div class="col-lg-2 pl"><p>Financial Year</p></div>
        <div class="col-lg-2 pl">
          <input type="text"    name="FYDESC"     id="FYDESC"     class="form-control" autocomplete="off" onclick="getFinancialYear()" readonly >
          <input type="hidden"  name="BUG_FYID"       id="BUG_FYID"       class="form-control" autocomplete="off" >
        </div>
      </div>
    </div>
...
function getFinancialYear(){
  ...
  $.ajax({
    url:'{{route("master",[$FormId,"getFinancialYear"])}}',
    type:'POST',
    success:function(data) {
      var html = '';
...
function bindDetails(first_month,first_year,last_month,last_year){
  ...
  $.ajax({
    url:'{{route("master",[$FormId,"getMonthsInRange"])}}',
    type:'POST',
...
function getGlMaster(id){
  ...
  $.ajax({
    url:'{{route("master",[$FormId,"getGlMaster"])}}',
    type:'POST',
    success:function(data) {
      var html = '';
...
function getCostMaster(id){
  ...
  $.ajax({
    url:'{{route("master",[$FormId,"getCostMaster"])}}',
    type:'POST',
    success:function(data) {
      var html = '';
