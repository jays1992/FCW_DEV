...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[144,'index'])}}" class="btn singlebt">HSN Master</a>
                </div><!--col-2-->

                <div class="col-lg-10 topnav-pd">
                        <a href="{{route('master',[144,'add'])}}" id="btnSelectedRows" class="btn topnavbt" {{$objRights->ADD != 1 ? 'disabled' : ''}}><i class="fa fa-plus"></i> Add</a>
                        ...
                        <button class="btn topnavbt" id="btnAmendment"><i class="fa fa-tasks"></i> Amendment</button>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody> 
              ...
              @endphp
              <tr>
                <td><input type="checkbox" id="chkId{{$val->HSNID}}" value="{{$val->HSNID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->HSNCODE) && $val->HSNCODE !=''?$val->HSNCODE:''}}</td>
                <td>{{isset($val->HSNDESCRIPTION) && $val->HSNDESCRIPTION !=''?$val->HSNDESCRIPTION:''}}</td>
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[144,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[144,"view",":rcdId"]) }}';
  ...
  $('#btnAmendment').on('click', function() {                
    ...
    if(seletedRecord==0){
      ...
      if(is_approve==1){
        ...
        var editURL = '{{route("master",[144,"amendment",":rcdId"]) }}';
            editURL = editURL.replace(":rcdId",recordId);
            window.location.href=editURL;
      }else if(is_approve==2){
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[144,"attachment",":rcdId"]) }}';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[144,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[144,"cancel"])}}',
                            type:'POST',
