...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->CRID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="CRID" id="CRID" value="{{ $objResponse->CRID }}" />
                    <input type="hidden" name="CRCODE" id="CRCODE" value="{{ $objResponse->CRCODE }}" autocomplete="off"  maxlength="10"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="CRDESCRIPTION" id="CRDESCRIPTION" class="form-control mandatory" value="{{ old('CRDESCRIPTION',$objResponse->CRDESCRIPTION) }}" maxlength="50" tabindex="1"  />
                    <span class="text-danger" id="ERROR_CRDESCRIPTION"></span> 
                  </div>
                </div>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    $("#CRDESCRIPTION").blur(function(){
        $(this).val($.trim( $(this).val() ));
        $("#ERROR_CRDESCRIPTION").hide();
        validateSingleElemnet("CRDESCRIPTION");

    });

    $( "#CRDESCRIPTION" ).rules( "add", {
        required: true,
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[133,"update"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
                ...
                if(data.errors) {
                    ...
                    if(data.errors.CRDESCRIPTION){
                        showError('ERROR_CRDESCRIPTION',data.errors.CRDESCRIPTION);
                    }
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[133,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[133,"index"]) }}';
