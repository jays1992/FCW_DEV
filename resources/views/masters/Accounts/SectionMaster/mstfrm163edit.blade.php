...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[163,'index'])}}" class="btn singlebt">Section Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  <div class="col-lg-2 pl"><p>Section Code</p></div>
                  <div class="col-lg-2 pl">
                  
                    <label> {{$objResponse->SECTION_CODE}} </label>
                    <input type="hidden" name="SECTIONID" id="SECTIONID" value="{{ $objResponse->SECTIONID }}" />
                    <input type="hidden" name="SECTION_CODE" id="SECTION_CODE" value="{{ $objResponse->SECTION_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="SECTION_NAME" id="SECTION_NAME" class="form-control mandatory" value="{{ old('SECTION_NAME',$objResponse->SECTION_NAME) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[163,"add"])}}';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    $("#SECTION_NAME").blur(function(){
        ...
        $("#ERROR_SECTION_NAME").hide();
        validateSingleElemnet("SECTION_NAME");

    });

    $( "#SECTION_NAME" ).rules( "add", {
        required: true,
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[163,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[163,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[163,"index"]) }}';
