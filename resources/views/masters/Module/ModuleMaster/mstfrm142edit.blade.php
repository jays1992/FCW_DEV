...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->MODULEID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->MODULECODE}} </label>
                    <input type="hidden" name="MODULEID" id="MODULEID" value="{{ $objResponse->MODULEID }}" />
                    <input type="hidden" name="MODULECODE" id="MODULECODE" value="{{ $objResponse->MODULECODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="MODULENAME" id="MODULENAME" class="form-control mandatory" value="{{ old('MODULENAME',$objResponse->MODULENAME) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[142,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[142,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
