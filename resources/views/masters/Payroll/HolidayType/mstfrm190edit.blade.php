...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->HOLIDAYTYPEID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->HOLIDAY_TYPE}} </label>
                    <input type="hidden" name="HOLIDAYTYPEID" id="HOLIDAYTYPEID" value="{{ $objResponse->HOLIDAYTYPEID }}" />
                    <input type="hidden" name="HOLIDAY_TYPE" id="HOLIDAY_TYPE" value="{{ $objResponse->HOLIDAY_TYPE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="TYPE_DESC" id="TYPE_DESC" class="form-control mandatory" value="{{ old('TYPE_DESC',$objResponse->TYPE_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[190,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[190,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
