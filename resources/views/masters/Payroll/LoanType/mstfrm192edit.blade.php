...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->LOANTYPEID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->LOANTYPE_CODE}} </label>
                    <input type="hidden" name="LOANTYPEID" id="LOANTYPEID" value="{{ $objResponse->LOANTYPEID }}" />
                    <input type="hidden" name="LOANTYPE_CODE" id="LOANTYPE_CODE" value="{{ $objResponse->LOANTYPE_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="LOANTYPE_DESC" id="LOANTYPE_DESC" class="form-control mandatory" value="{{ old('LOANTYPE_DESC',$objResponse->LOANTYPE_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    $("#LOANTYPE_DESC").keydown(function(){
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[192,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[192,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
