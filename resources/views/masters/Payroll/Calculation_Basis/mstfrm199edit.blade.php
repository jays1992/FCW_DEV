...
@csrf
  ...
  <div class="row">
            ...
            <input type="text" name="BASIS_DOC_NO" id="BASIS_DOC_NO"  class="form-control mandatory" value="{{$objHeader->BASIS_DOC_NO}}"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >   
            ...
            <div class="col-lg-2 pl">
            <input type="date" name="BASIS_DOC_DT" id="BASIS_DOC_DT" value="{{$objHeader->BASIS_DOC_DT}}" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy"/>
            </div>
        </div>
  ...
  <div class="row">
            ...
            <div class="col-lg-2 pl"> 
     <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" {{$objHeader->DEACTIVATED == 1 ? "checked" : ""}}
            ...
            <div class="col-lg-2 pl">
            <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" {{$objHeader->DEACTIVATED == 1 ? "" : "disabled"}} value="{{isset($objHeader->DODEACTIVATED) && $objHeader->DODEACTIVATED !="" && $objHeader->DODEACTIVATED !="1900-01-01" ? $objHeader->DODEACTIVATED:''}}" tabindex="3" placeholder="dd/mm/yyyy"  />
            </div>
        </div>
      ...
      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
        ...
        <tbody>
            ...
            @foreach($objMAT as $key => $row) 
                      ...
                      <td><input  type="text" name={{"txtEH_popup_".$key}} id={{"txtEH_popup_".$key}} value="{{$row->EARNING_HEADCODE}}" class="form-control"  autocomplete="off"  readonly/></td>
                          <td  hidden><input type="text" name={{"EHID_REF_".$key}} id={{"EHID_REF_".$key}} value="{{$row->EARNING_HEADID_REF}}"  class="form-control" autocomplete="off" /></td>                          
                          <td><input type="text"  name={{"EH_REF_".$key}} id={{"EH_REF_".$key}} value="{{$row->EARNING_HEAD_DESC}}" class="form-control"  autocomplete="off"  readonly /></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"PF_".$key}} id={{"PF_".$key}} {{$row->PF == 1 ? 'checked' : ''}}   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox"  name={{"VPF_".$key}} id={{"VPF_".$key}} {{$row->VPF == 1 ? 'checked' : ''}}   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"ESI_".$key}} id={{"ESI_".$key}} {{$row->ESI == 1 ? 'checked' : ''}}   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"Bonus_".$key}} id={{"Bonus_".$key}} {{$row->BONUS == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"OT_".$key}} id={{"OT_".$key}} {{$row->OT == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"Gratuity_".$key}} id={{"Gratuity_".$key}} {{$row->GRATUITY == 1 ? 'checked' : ''}}   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"Welfare_Fund_".$key}} id={{"Welfare_Fund_".$key}} {{$row->WELFARE_FUND == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox"  name={{"TDS_".$key}} id={{"TDS_".$key}} {{$row->TDS == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"PT_".$key}} id={{"PT_".$key}} {{$row->PT == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox"  name={{"LWP_".$key}} id={{"LWP_".$key}} {{$row->LWP == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox"  name={{"Earned_Leave_".$key}} id={{"Earned_Leave_".$key}} {{$row->EARNED_LEAVE == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"Incentive_".$key}} id={{"Incentive_".$key}} {{$row->INCENTIVE == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"Super_Anuation_".$key}} id={{"Super_Anuation_".$key}} {{$row->SUPER_ANNUATION == 1 ? 'checked' : ''}}   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"OTHER1_".$key}} id={{"OTHER1_".$key}} {{$row->OTHER1 == 1 ? 'checked' : ''}}   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"OTHER2_".$key}} id={{"OTHER2_".$key}} {{$row->OTHER2 == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"OTHER3_".$key}} id={{"OTHER3_".$key}} {{$row->OTHER3 == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" name={{"OTHER4_".$key}} id={{"OTHER4_".$key}} {{$row->OTHER4 == 1 ? 'checked' : ''}}  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox"   name={{"OTHER5_".$key}} id={{"OTHER5_".$key}} {{$row->OTHER5 == 1 ? 'checked' : ''}}  ></td>    
