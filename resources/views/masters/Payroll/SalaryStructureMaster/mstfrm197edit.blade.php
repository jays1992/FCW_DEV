    ...
    <div class="inner-form">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="SALARY_STRUC_NO" id="SALARY_STRUC_NO" value="{{ isset($HDR->SALARY_STRUC_NO)?$HDR->SALARY_STRUC_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"> 
        </div>
        
        <div class="col-lg-2 pl"><p>Description</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="SALARY_STRUC_DESC" id="SALARY_STRUC_DESC" value="{{ isset($HDR->SALARY_STRUC_DESC)?$HDR->SALARY_STRUC_DESC:''}}"  class="form-control mandatory" autocomplete="off" >
        </div>
      </div>
              ...
              <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                <thead id="thead1"  style="position: sticky;top: 0"> 
                  ...
                  <tr>
                    ...
                    <th>Amount</th>
                    <th>Remarks</th>
                    <th>Action <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="{{count($MAT)}}"></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr  class="participantRow1">
                    ...
                    <td>
                      <select name="HEAD_TYPE_{{$key}}" id="HEAD_TYPE_{{$key}}" class="form-control"  autocomplete="off" onchange="select_head_type(this.id)" >
                        <option value="">Select</option> 
                        <option {{isset($row['HEAD_TYPE']) && $row['HEAD_TYPE'] =='EARNING'?'selected="selected"':''}} value="EARNING">EARNING</option>
                        <option {{isset($row['HEAD_TYPE']) && $row['HEAD_TYPE'] =='DEDUCTION'?'selected="selected"':''}} value="DEDUCTION">DEDUCTION</option>
                      </select>
                    </td>
                  
                    <td><input  type="text" name="EARNING_HEADID_CODE_{{$key}}" id="EARNING_HEADID_CODE_{{$key}}" value="{{isset($row['HEADCODE'])?$row['HEADCODE']:''}}" class="form-control"  autocomplete="off" onclick="select_data(this.id)"  readonly  /></td>
                    ...
                    <td><input type="text" name="EARNING_HEADID_DESC_{{$key}}" id="EARNING_HEADID_DESC_{{$key}}" value="{{isset($row['HEADDESC'])?$row['HEADDESC']:''}}"  class="form-control"  autocomplete="off"  readonly /></td>

                    <td><input  type="text" name="EARNING_TYPEID_CODE_{{$key}}" id="EARNING_TYPEID_CODE_{{$key}}" value="{{isset($row['TYPECODE'])?$row['TYPECODE']:''}} {{isset($row['TYPEDESC'])?'-'.$row['TYPEDESC']:''}}" class="form-control"  autocomplete="off" readonly  /></td>
                    <td hidden><input type="text" name="EARNING_TYPEID_REF_{{$key}}" id="EARNING_TYPEID_REF_{{$key}}" value="{{isset($row['EARNING_TYPEID_REF'])?$row['EARNING_TYPEID_REF']:''}}"   class="form-control"  autocomplete="off" /></td>

                    <td><input  type="text" name="SQ_NO_{{$key}}" id="SQ_NO_{{$key}}" value="{{$key+1}}" class="form-control"  autocomplete="off" readonly style="width:50px;" /></td>

                    <td>
                      <select name="AMT_FORMULA_{{$key}}" id="FOR_TYPE_{{$key}}" class="form-control"  autocomplete="off" onchange="select_formula(this.id,this.value)" >
                        <option value="">Select</option>  
                        <option {{isset($row['AMT_FORMULA']) && $row['AMT_FORMULA'] =='FORMULA'?'selected="selected"':''}} value="FORMULA">FORMULA</option>
                        <option {{isset($row['AMT_FORMULA']) && $row['AMT_FORMULA'] =='AMOUNT'?'selected="selected"':''}} value="AMOUNT">AMOUNT</option>
                      </select>
                    </td>

                    <td><input type="text" name="FORMULA_{{$key}}" id="FORMULA_{{$key}}" value="{{isset($row['FORMULA'])?$row['FORMULA']:''}}" class="form-control"  autocomplete="off" readonly /></td>
                    <td><input type="text" name="AMOUNT_{{$key}}" id="AMOUNT_{{$key}}" value="{{isset($row['AMOUNT'])?$row['AMOUNT']:''}}" class="form-control"  autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" readonly  /></td>
                    <td><input type="text" name="REMARKS_{{$key}}" id="REMARKS_{{$key}}" value="{{isset($row['REMARKS'])?$row['REMARKS']:''}}" class="form-control"  autocomplete="off"/></td>
