          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                        {{-- <input type="text" name="PCODE" id="PCODE" onkeypress="return AlphaNumaric(event,this)" value="{{ old('PCODE') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" /> --}}
                        @if(!empty($objDD))
                            @if($objDD->SYSTEM_GRSR == "1")
                                <input type="text" name="PCODE" id="PCODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @endif
                            @if($objDD->MANUAL_SR == "1")
                                <input type="text" name="PCODE" id="PCODE" value="{{ old('PCODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                            @endif
                        @endif  
                    ...
                    <div class="col-lg-2 pl"><p>Project Start Date</p></div>
                      <div class="col-lg-2 pl">
                        <input type="date" name="PROJECT_START_DATE" id="PROJECT_START_DATE" class="form-control mandatory" value="{{ old('PROJECT_START_DATE') }}" />
                    ...
                    <div class="col-lg-2 pl"><p>Project End Date</p></div>
                      <div class="col-lg-2 pl">
                        <input type="date" name="PROJECT_END_DATE" id="PROJECT_END_DATE" class="form-control mandatory" value="{{ old('PROJECT_END_DATE') }}" />
                        <span class="text-danger" id="ERROR_PROJECT_END_DATE"></span> 
                      </div>

                    <div class="col-lg-2 pl"><p>Project location</p></div>
                      <div class="col-lg-2 pl">
                        <input type="text" name="PROJECT_LOCATION" id="PROJECT_LOCATION" class="form-control mandatory" value="{{ old('PROJECT_LOCATION') }}" />
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'{{route("master",[176,"codeduplicate"])}}',
            type:'POST',
            data:formData,
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('master',[176,'add'])}}";
