...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[176,'index'])}}" class="btn singlebt">Project Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->PID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->PCODE}} </label>
                    <input type="hidden" name="PID" id="PID" value="{{ $objResponse->PID }}" />
                    <input type="hidden" name="PCODE" id="PCODE" value="{{ $objResponse->PCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="col-lg-2 pl"><p>Project Name</p></div>
                  ...
                  <div class="col-lg-2 pl"><p>Project Start Date</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="PROJECT_START_DATE" id="PROJECT_START_DATE" class="form-control mandatory" value="{{ old('PROJECT_START_DATE',$objResponse->PROJECT_START_DATE) }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl"><p>Project End Date</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="PROJECT_END_DATE" id="PROJECT_END_DATE" class="form-control mandatory" value="{{ old('PROJECT_END_DATE',$objResponse->PROJECT_END_DATE) }}" />
                      <span class="text-danger" id="ERROR_PROJECT_END_DATE"></span> 
                    </div>

                    <div class="col-lg-2 pl"><p>Project location</p></div>
                      <div class="col-lg-2 pl">
                        <input type="text" name="PROJECT_LOCATION" id="PROJECT_LOCATION" class="form-control mandatory" value="{{ old('PROJECT_LOCATION',$objResponse->PROJECT_LOCATION) }}" />
                      ...
                      <div class="col-lg-2 pl"><p>Project Status</p></div>
                        <div class="col-lg-2 pl">
                          <select name="PROJECT_STATUS" id="PROJECT_STATUS" class="form-control"  autocomplete="off">
                            ...
                            <option value="Start" {{isset($objResponse->PROJECT_STATUS) && $objResponse->PROJECT_STATUS =="Start" ? "selected":""}}>Yet To Start</option>
                            <option value="Started" {{isset($objResponse->PROJECT_STATUS) && $objResponse->PROJECT_STATUS =="Started" ? "selected":""}}>Started</option>
                            <option value="Closed" {{isset($objResponse->PROJECT_STATUS) && $objResponse->PROJECT_STATUS =="Closed" ? "selected":""}}>Closed</option>
                          </select>
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[176,"add"])}}';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[176,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[176,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[176,"index"]) }}';
