...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[193,'index'])}}" class="btn singlebt">OT Master</a>
                </div><!--col-2-->
         ...
         <form id="frm_mst_add" method="POST"  > 
          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        {{-- <input type="text" name="OT_CODE" id="OT_CODE" onkeypress="return AlphaNumaric(event,this)" value="{{ old('OT_CODE') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" /> --}}
                        @if(!empty($objDD))
                          @if($objDD->SYSTEM_GRSR == "1")
                              <input type="text" name="OT_CODE" id="OT_CODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                          @endif
                          @if($objDD->MANUAL_SR == "1")
                              <input type="text" name="OT_CODE" id="OT_CODE" value="{{ old('OT_CODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                          @endif
                      @endif  
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="OT_DESC" id="OT_DESC" class="form-control mandatory" value="{{ old('OT_DESC') }}" maxlength="200" tabindex="2"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="OT_RATE" id="OT_RATE"  value="{{ old('OT_RATE') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" />
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="OT_FACTOR" id="OT_FACTOR"  value="{{ old('OT_FACTOR') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1"  />
...
$(document).ready(function(){
  ...
  $('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[193,"add"])}}';
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'{{route("master",[193,"codeduplicate"])}}',
            type:'POST',
            data:formData,
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                if(data.success) {                   
                  ...
                  //  window.location.href='{{ route("master",[193,"index"])}}';
                }
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('master',[193,'add'])}}";
