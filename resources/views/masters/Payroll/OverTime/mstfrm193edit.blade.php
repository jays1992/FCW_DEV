...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->OTID) ? method_field('PUT') : '' }}
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <label> {{$objResponse->OT_CODE}} </label>
                    <input type="hidden" name="OTID" id="OTID" value="{{ $objResponse->OTID }}" />
                    <input type="hidden" name="OT_CODE" id="OT_CODE" value="{{ $objResponse->OT_CODE }}" autocomplete="off"  maxlength="20"   />
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="OT_DESC" id="OT_DESC" class="form-control mandatory" value="{{ $objResponse->OT_DESC }}" maxlength="200" tabindex="2"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="OT_RATE" id="OT_RATE"  value="{{ $objResponse->OT_RATE }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" />
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="OT_FACTOR" id="OT_FACTOR"  value="{{ $objResponse->OT_FACTOR }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[193,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[193,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
