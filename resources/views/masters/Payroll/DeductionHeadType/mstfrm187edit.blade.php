...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->DEDUCTION_TYPEID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->DEDUCTION_TYPECODE}} </label>
                    <input type="hidden" name="DEDUCTION_TYPEID" id="DEDUCTION_TYPEID" value="{{ $objResponse->DEDUCTION_TYPEID }}" />
                    <input type="hidden" name="DEDUCTION_TYPECODE" id="DEDUCTION_TYPECODE" value="{{ $objResponse->DEDUCTION_TYPECODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="DEDUCTION_TYPE_DESC" id="DEDUCTION_TYPE_DESC" class="form-control mandatory" value="{{ old('DEDUCTION_TYPE_DESC',$objResponse->DEDUCTION_TYPE_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[187,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[187,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
