...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->EARNING_TYPEID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->EARNING_TYPECODE}} </label>
                    <input type="hidden" name="EARNING_TYPEID" id="EARNING_TYPEID" value="{{ $objResponse->EARNING_TYPEID }}" />
                    <input type="hidden" name="EARNING_TYPECODE" id="EARNING_TYPECODE" value="{{ $objResponse->EARNING_TYPECODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="EARNING_TYPE_DESC" id="EARNING_TYPE_DESC" class="form-control mandatory" value="{{ old('EARNING_TYPE_DESC',$objResponse->EARNING_TYPE_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    $("#EARNING_TYPE_DESC").keydown(function(){
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[185,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[185,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
