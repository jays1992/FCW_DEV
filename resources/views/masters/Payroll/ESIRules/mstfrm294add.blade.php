                          ...
                          <tr  class="participantRow">
                              ...
                              <td>
                                <select name="FR_PAYPID_REF[]" id="FR_PAYPID_REF_0" class="form-control mandatory" tabindex="4">
                                  ...
                                  <option value="{{$val->PAYPERIODID}}">{{$val->PAY_PERIOD_CODE}}-{{$val->PAY_PERIOD_DESC}}</option>
                                  @endforeach
                                </select>                           
                                {{-- <input  class="form-control" type="text" name="FR_PAYPID_REF_0" id ="FR_PAYPID_REF_0"  autocomplete="off" onkeypress="return onlyNumberKey(event)" style="width: 99%"></td> --}}
                              <td>                                
                                ...
                                {{-- <input  class="form-control" type="text" name="TO_PAYPID_REF_0" id ="TO_PAYPID_REF_0"  autocomplete="off" onkeypress="return onlyNumberKey(event)" style="width: 99%"></td> --}}
