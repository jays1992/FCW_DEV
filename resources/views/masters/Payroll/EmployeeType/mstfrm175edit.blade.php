          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->ECODE}} </label>
                    <input type="hidden" name="ETYPEID" id="ETYPEID" value="{{ $objResponse->ETYPEID }}" />
                    <input type="hidden" name="ECODE" id="ECODE" value="{{ $objResponse->ECODE }}" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[175,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[175,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
