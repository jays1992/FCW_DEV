  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
      <form id="frm_mst_edit" method="POST"  > 
        @CSRF
        {{isset($objResponse->ETYPEID) ? method_field('PUT') : '' }}
                    ...
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              ...
                              <input type="text" name="LOB_NO" id="LOB_NO" value="{{ isset($objAutoGenNo)?$objAutoGenNo:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                              <input type="text" name="LOB_NO" id="LOB_NO" value="{{ old('LOB_NO') }}" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
                          @else
                              <input type="text" name="LOB_NO" id="LOB_NO" value="{{ isset($HDR->LOB_NO)?$HDR->LOB_NO:''}}"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                              @endif
                            </div>
                            <div class="col-lg-2 pl"><p>LOB Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="LOB_DT" id="LOB_DT" value="{{ isset($HDR->LOB_DT)?$HDR->LOB_DT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                                <td hidden><input type="hidden" name="LEAVE_OPBLID" id="LEAVE_OPBLID" value="{{$HDR->LEAVE_OPBLID}}" class="form-control" autocomplete="off" /></td>
                              </div>  
                            ...
                            <div class="col-lg-2 pl">
                              <select name="FYID_REF" id="FYID_REF" class="form-control mandatory" tabindex="4">
                                <option value="" selected >Select</option>
                                  ...
                                  <option {{isset($HDR->FYID_REF) && $HDR->FYID_REF == $val-> YRID ?'selected="selected"':''}} value="{{ $val-> YRID }}">{{ $val->YRCODE }}</option>
                                  @endforeach
                              </select>
                                            ...
                                            ?>
                                              @if(isset($objMAT) && !empty($objMAT))
                                                ...
                                                <tr  class="participantRow">
                                                    <td><input type="text" name="popupEMPLYID_{{$key}}" id="popupEMPLYID_{{$key}}" value="{{$row->EMPCODE}}" class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name="EMPLY_REF_{{$key}}" id="EMPLY_REF_{{$key}}" value="{{$row->EMPID_REF}}" class="form-control" autocomplete="off" /></td>
                                                    <td hidden><input type="hidden" name="LEAVE_OPBLID_REF_{{$key}}" id="LEAVE_OPBLID_REF_{{$key}}" value="{{$row->LEAVE_OPBLID_REF}}" class="form-control" autocomplete="off" /></td>
                                                    <td hidden><input type="hidden" name="EMPID_REF_{{$key}}" id="EMPID_REF_{{$key}}" value="{{$row->EMPID_REF}}" class="form-control" autocomplete="off" /></td>
                                                    <td hidden><input type="hidden" name="LTID_REF_{{$key}}" id="LTID_REF_{{$key}}" value="{{$row->LTID_REF}}" class="form-control" autocomplete="off" /></td>
                                                    <td><input type="text" name="EMPLYSPECI_{{$key}}" id="EMPLYSPECI_{{$key}}" value="{{$row->FNAME}}" class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="EMPLYDES_{{$key}}" id="EMPLYDES_{{$key}}"  value="{{$row->DESGCODE}}" class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name="UOMID_REF_{{$key}}" id="UOMID_REF_{{$key}}" value="{{$row->EMPCODE}}" class="form-control"  autocomplete="off" /></td>
                                                    
                                                    <td><input type="text" name="EmplyName_{{$key}}" id="EmplyName_{{$key}}" value="{{$row->DCODE}}" class="form-control" maxlength="200" autocomplete="off" readonly /></td>
                                                    <td hidden><input type="hidden" name="DEPID_REF_{{$key}}" id="DEPID_REF_{{$key}}" value="{{$row->EMPCODE}}" class="form-control"  autocomplete="off" /></td>
                                                    
                                                    <td><input name="leavetypecode_popup_{{$key}}" id="leavetypecode_popup_{{$key}}" value="{{$row->LEAVETYPE_CODE}}" class="form-control" autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="text" name="hdnleavetypecode_popup_{{$key}}" id="hdnleavetypecode_popup_{{$key}}" value="{{$row->LTID}}" class="form-control" /> </td>

                                                    <td><input  class="form-control w-100" type="text" name="leavetypedesciption_{{$key}}" id="txtleavetypedesciption_{{$key}}" value="{{$row->LEAVETYPE_DESC}}"  maxlength="50" readonly></td>
                                                                                                        
                                                    <td hidden><input type="hidden" name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{$row->EMPCODE}}" class="form-control" maxlength="13"  autocomplete="off" /></td>
                                                    <td><input type="text" name="OPNGBALANCE_{{$key}}" id="OPNGBALANCE_{{$key}}" value="{{$row->LEAVE_OPBL}}" class="form-control" maxlength="13"  autocomplete="off" /></td>
...
$(document).ready(function(e) {
    ...
    //to check the label duplicacy
     $('#LOBDT').focusout(function(){
      var LOBDT   =   $.trim($(this).val());
      if(LOBDT ===""){
                $("#FocusId").val('LOBDT');
                $("#ProceedBtn").focus();
                $("#YesBtn").hide();
...
$.ajax({
    ...
    success:function(data) {
        ...
        if(data.errors) {
            $(".text-danger").hide();
            if(data.errors.LOBDT){
                showError('ERROR_LOBDT',data.errors.LOBDT);
                        $("#YesBtn").hide();
                        $("#NoBtn").hide();
                        $("#OkBtn1").show();
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[390,"Approve"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
