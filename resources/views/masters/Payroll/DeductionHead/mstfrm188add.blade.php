          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        {{-- <input type="text" name="DEDUCTION_HEADCODE" id="DEDUCTION_HEADCODE" onkeypress="return AlphaNumaric(event,this)" value="{{ old('DEDUCTION_HEADCODE') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" /> --}}
                        @if(!empty($objDD))
                            @if($objDD->SYSTEM_GRSR == "1")
                                <input type="text" name="DEDUCTION_HEADCODE" id="DEDUCTION_HEADCODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @endif
                            @if($objDD->MANUAL_SR == "1")
                                <input type="text" name="DEDUCTION_HEADCODE" id="DEDUCTION_HEADCODE" value="{{ old('DEDUCTION_HEADCODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                            @endif
                        @endif  
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="DEDUCTION_HEAD_DESC" id="DEDUCTION_HEAD_DESC" class="form-control mandatory" value="{{ old('DEDUCTION_HEAD_DESC') }}" maxlength="200" tabindex="2"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="DEDUCTION_TYPEID_REF_POPUP" id="DEDUCTION_TYPEID_REF_POPUP" readonly  value="{{ old('GLID_REF') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" />
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'{{route("master",[188,"codeduplicate"])}}',
            type:'POST',
            data:formData,
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('master',[188,'add'])}}";
