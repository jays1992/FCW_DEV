          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->BGCODE}} </label>
                    <input type="hidden" name="BGID" id="BGID" value="{{ $objResponse->BGID }}" />
                    <input type="hidden" name="BGCODE" id="BGCODE" value="{{ $objResponse->BGCODE }}" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[183,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[183,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
