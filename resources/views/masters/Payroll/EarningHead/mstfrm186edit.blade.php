...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->EARNING_HEADID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->EARNING_HEADCODE}} </label>
                    <input type="hidden" name="EARNING_HEADID" id="EARNING_HEADID" value="{{ $objResponse->EARNING_HEADID }}" />
                    <input type="hidden" name="EARNING_HEADCODE" id="EARNING_HEADCODE" value="{{ $objResponse->EARNING_HEADCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="EARNING_HEAD_DESC" id="EARNING_HEAD_DESC" class="form-control mandatory" value="{{ old('EARNING_HEAD_DESC',$objResponse->EARNING_HEAD_DESC) }}" maxlength="200" tabindex="1"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="EARNING_TYPEID_REF_POPUP" id="EARNING_TYPEID_REF_POPUP" readonly  value="{{ old('EARNING_TYPE_DESC',$objResponse->EARNING_TYPECODE.'-'.$objResponse->EARNING_TYPE_DESC) }}" class="form-control mandatory" autocomplete="off"  tabindex="1" style="text-transform:uppercase" />
                        <input type="hidden" name="EARNING_TYPEID_REF" id="EARNING_TYPEID_REF"  value="{{ old('EARNING_TYPEID_REF',$objResponse->EARNING_TYPEID_REF) }}" />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[186,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[186,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
