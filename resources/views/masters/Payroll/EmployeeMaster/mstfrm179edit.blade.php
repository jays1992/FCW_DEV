...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Employee Master</a>
        </div>
...
<div class="container-fluid purchase-order-view filter">     
  ...
  @CSRF
  {{isset($objResponse->EMPID) ? method_field('PUT') : '' }}
  <div class="inner-form">

  <div class="row">    
        <div class="col-lg-1 pl"><p>Emp Code</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="EMPCODE" id="EMPCODE" value="{{isset($objResponse->EMPCODE) && $objResponse->EMPCODE !=''?$objResponse->EMPCODE:''}}" class="form-control" required autocomplete="off" maxlength="20" style="text-transform:uppercase" onkeypress="return AlphaNumaric(event,this)" readonly />
        ...
        <div class="col-lg-2 pl">
          <select name="SAID_REF" id="SAID_REF" class="form-control" >
            ...
            @foreach ($getSalutation as $val)
            <option {{isset($objResponse->SAID_REF) && $objResponse->SAID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="FNAME" id="FNAME" value="{{isset($objResponse->FNAME) && $objResponse->FNAME !=''?$objResponse->FNAME:''}}" class="form-control" autocomplete="off" required   maxlength="50" />
          <span class="text-danger" id="ERROR_FNAME"></span> 
        </div>

        <div class="col-lg-1 pl"><p>Middle Name</p></div>
        <div class="col-lg-2 pl">
        <input type="text" name="MNAME" id="MNAME" value="{{isset($objResponse->MNAME) && $objResponse->MNAME !=''?$objResponse->MNAME:''}}" class="form-control" autocomplete="off"  maxlength="50"  />
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="LNAME" id="LNAME" value="{{isset($objResponse->LNAME) && $objResponse->LNAME !=''?$objResponse->LNAME:''}}" class="form-control" autocomplete="off" maxlength="50"  />
          <span class="text-danger" id="ERROR_LNAME"></span> 
        </div>
          	
        <div class="col-lg-1 pl"><p>Old Ref No</p></div>
        <div class="col-lg-2 pl">
        <input type="text" name="OLDREFNO" id="OLDREFNO" value="{{isset($objResponse->OLDREFNO) && $objResponse->OLDREFNO !=''?$objResponse->OLDREFNO:''}}" class="form-control" autocomplete="off" maxlength="50" onkeypress="return isNumberKey(event,this)"  />
        ...
        <div class="col-lg-2 pl">
          <select name="GID_REF" id="GID_REF" class="form-control" required >
            <option value="" selected >Select</option>
            @foreach ($getGender as $val)
            <option {{isset($objResponse->GID_REF) && $objResponse->GID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
        <input type="date" name="DOBHRD" id="DOBHRD" value="{{isset($objResponse->DOB) && $objResponse->DOB !=''?date('Y-m-d',strtotime($objResponse->DOB)):''}}" class="form-control" autocomplete="off" required />
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="DOBPLACE" id="DOBPLACE" value="{{isset($objResponse->DOBPLACE) && $objResponse->DOBPLACE !=''?$objResponse->DOBPLACE:''}}" class="form-control" autocomplete="off" maxlength="100"  />
        ...
        <div class="col-lg-2 pl">
          <select name="FATHERNAME" id="FATHERNAME" class="form-control" required >
            <option value="" selected >Select</option>
            <option {{isset($objResponse->FATHERNAME) && $objResponse->FATHERNAME == 'single'?'selected="selected"':''}} value="single">Single</option>
            <option {{isset($objResponse->FATHERNAME) && $objResponse->FATHERNAME == 'married'?'selected="selected"':''}} value="married">Married</option>
            <option {{isset($objResponse->FATHERNAME) && $objResponse->FATHERNAME == 'separated'?'selected="selected"':''}}value="separated">Separated</option>
          </select>
        ...
        <div class="col-lg-2 pl">
          <select name="BGID_REF" id="BGID_REF" class="form-control" required >
            <option value="" selected >Select</option>
            @foreach ($getBloodGroup as $val)
            <option {{isset($objResponse->BGID_REF) && $objResponse->BGID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
          <select name="DESGID_REF" id="DESGID_REF" class="form-control" required >
            <option value="" selected >Select</option>
            @foreach ($getDesignation as $val)
            <option {{isset($objResponse->DESGID_REF) && $objResponse->DESGID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
          <span class="text-danger" id="ERROR_DESGID_REF"></span> 
        </div>
        ...
        <div class="col-lg-2 pl">
          <select name="DEPID_REF" id="DEPID_REF" class="form-control" >
            ...
            <option {{isset($objResponse->DEPID_REF) && $objResponse->DEPID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
          <select name="DIVID_REF" id="DIVID_REF" class="form-control" >
            <option value="" selected >Select</option>
            @foreach ($getDivision as $val)
            <option {{isset($objResponse->DIVID_REF) && $objResponse->DIVID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
          <select name="PLID_REF" id="PLID_REF" class="form-control" >
            <option value="" selected >Select</option>
            @foreach ($getPostLevel as $val)
            <option {{isset($objResponse->PLID_REF) && $objResponse->PLID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
        <input type="date" name="DOJ" id="DOJ" value="{{isset($objResponse->DOJ) && $objResponse->DOJ !=''?date('Y-m-d',strtotime($objResponse->DOJ)):''}}" class="form-control" autocomplete="off" maxlength="200"  />
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select name="CATID_REF" id="CATID_REF" class="form-control" required >
            <option value="" selected >Select</option>
            @foreach ($getEmployeeCategory as $val)
            <option {{isset($objResponse->CATID_REF) && $objResponse->CATID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
          <select name="ETYPEID_REF" id="ETYPEID_REF" class="form-control" required >
            <option value="" selected >Select</option>
            @foreach ($getEmployeeType as $val)
            <option {{isset($objResponse->ETYPEID_REF) && $objResponse->ETYPEID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
          <select name="CCID_REF" id="CCID_REF" class="form-control" >
            <option value="" selected >Select</option>
            @foreach ($getCostCentre as $val)
            <option {{isset($objResponse->CCID_REF) && $objResponse->CCID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl">
          <select name="GRADEID_REF" id="GRADEID_REF" class="form-control" >
            <option value="" selected >Select</option>
            @foreach ($getGrade as $val)
            <option {{isset($objResponse->GRADEID_REF) && $objResponse->GRADEID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select name="BRID_REF" id="BRID_REF" class="form-control" disabled>
            <option value="" selected >Select</option>
            @foreach ($getBranch as $val)
            <option {{isset($objResponse->BRID_REF) && $objResponse->BRID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
            @endforeach
          </select>
        ...
        <div class="col-lg-2 pl"> 
          <input type="checkbox" name="SALES_PERSON" id="SALES_PERSON" {{isset($objResponse->SALES_PERSON) && $objResponse->SALES_PERSON =='1'?'checked':''}} value="1" >
        ...
        <div id="tab1" class="tab-pane fade in active">
          <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;">
            ...
            <div class="row">
              ...
              <div class="col-lg-1 ">
                <input type="checkbox" name="CRESIDENCE" id="CRESIDENCE" {{isset($objTab1->CRESIDENCE) && $objTab1->CRESIDENCE =='1'?'checked':''}} value="1" >
                <span class="text-danger" id="ERROR_CRESIDENCE"></span>
              </div>

              <div class="col-lg-2 "><p>Own / Parents Residence</p></div>
              <div class="col-lg-1 ">
                <input type="checkbox" name="CROWN" id="CROWN" {{isset($objTab1->CROWN) && $objTab1->CROWN =='1'?'checked':''}} value="1" onchange="getCParentRented('CROWN')" >
                <span class="text-danger" id="ERROR_CROWN"></span>
              </div>

              <div class="col-lg-1 "><p>Rented</p></div>
              <div class="col-lg-1 ">
                <input type="checkbox" name="CRRENTED" id="CRRENTED" {{isset($objTab1->CRRENTED) && $objTab1->CRRENTED =='1'?'checked':''}} value="1" onchange="getCParentRented('CRRENTED')" >
            ...
            <div class="row">
              ...
              <div class="col-lg-5 ">
                <textarea name="CRADD1" id="CRADD1" class="form-control" autocomplete="off" >{{isset($objTab1->CRADD1) && $objTab1->CRADD1 !=''?$objTab1->CRADD1:''}}</textarea>
                <span class="text-danger" id="ERROR_CRADD1"></span>
              </div>

              <div class="col-lg-1 "><p>Add Line 2</p></div>
              <div class="col-lg-5 ">
                <textarea name="CRADD2" id="CRADD2" class="form-control" autocomplete="off" >{{isset($objTab1->CRADD2) && $objTab1->CRADD2 !=''?$objTab1->CRADD2:''}}</textarea>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="CTRYID_REF_POPUP" id="CTRYID_REF_POPUP" value="{{isset($objCountryName->CTRYCODE)?$objCountryName->CTRYCODE. ' - ':''}}  {{isset($objCountryName->NAME)?$objCountryName->NAME:''}}" class="form-control" readonly />
                  <input type="hidden" name="CTRYID_REF" id="CTRYID_REF" value="{{isset($objTab1->CRCTRYID_REF) && $objTab1->CRCTRYID_REF !=''?$objTab1->CRCTRYID_REF:''}}" />
                  <span class="text-danger" id="ERROR_CTRYID_REF"></span>
              </div>

              <div class="col-lg-1"><p>State</p></div>
              <div class="col-lg-2">
                  <input type="text" name="STID_REF_POPUP" id="STID_REF_POPUP" value="{{isset($objStateName->STCODE)?$objStateName->STCODE. ' - ':''}}  {{isset($objStateName->NAME)?$objStateName->NAME:''}}" class="form-control"  readonly/>
                  <input type="hidden" name="STID_REF" id="STID_REF" value="{{isset($objTab1->CRSTID_REF) && $objTab1->CRSTID_REF !=''?$objTab1->CRSTID_REF:''}}" />
              ...
              <div class="col-lg-2">
                <input type="text" name="CITYID_REF_POPUP" id="CITYID_REF_POPUP" value="{{isset($objCityName->CITYCODE)?$objCityName->CITYCODE. ' - ':''}}  {{isset($objCityName->NAME)?$objCityName->NAME:''}}" class="form-control" readonly tabindex="8" />
                <input type="hidden" name="CITYID_REF" id="CITYID_REF" value="{{isset($objTab1->CRCITYID_REF) && $objTab1->CRCITYID_REF !=''?$objTab1->CRCITYID_REF:''}}" />
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                <input type="text" name="DISTID_REF_POPUP" id="DISTID_REF_POPUP" value="{{isset($objDisticName->DISTCODE) && !empty($objDisticName->DISTCODE) ?$objDisticName->DISTCODE. ' - ' :''}}  {{isset($objDisticName->NAME) && !empty($objDisticName->NAME) ?$objDisticName->NAME:''}}" class="form-control" readonly tabindex="9" />
                <input type="hidden" name="DISTID_REF" id="DISTID_REF" value="{{isset($objTab1->CRDISTID_REF) && $objTab1->CRDISTID_REF !=''?$objTab1->CRDISTID_REF:''}}" />
                <span class="text-danger" id="ERROR_DISTID_REF"></span>
              </div>

              <div class="col-lg-1"><p>Pincode</p></div>
              <div class="col-lg-2">
                  <input type="text" name="CRPIN" id="CRPIN" value="{{isset($objTab1->CRPIN) && $objTab1->CRPIN !=''?$objTab1->CRPIN:''}}" class="form-control" autocomplete="off"  maxlength="10" onkeypress="return isNumberKey(event,this)" >
              </div>

              <div class="col-lg-1"><p>Landmark</p></div>
              <div class="col-lg-4">
                <input type="text" name="CRLM" id="CRLM" value="{{isset($objTab1->CRLM) && $objTab1->CRLM !=''?$objTab1->CRLM:''}}" class="form-control" autocomplete="off"  maxlength="50" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-1 ">
                <input type="checkbox" name="PRRESIDENCE" id="PRRESIDENCE" {{isset($objTab1->PRRESIDENCE) && $objTab1->PRRESIDENCE =='1'?'checked':''}}  value="1" >
                <span class="text-danger" id="ERROR_PRRESIDENCE"></span>
              </div>

              <div class="col-lg-2 "><p>Own / Parents Residence</p></div>
              <div class="col-lg-1 ">
                <input type="checkbox" name="PROWN" id="PROWN" {{isset($objTab1->PROWN) && $objTab1->PROWN =='1'?'checked':''}} value="1" onchange="getPParentRented('PROWN')" >
                <span class="text-danger" id="ERROR_PROWN"></span>
              </div>

              <div class="col-lg-1 "><p>Rented</p></div>
              <div class="col-lg-1 ">
                <input type="checkbox" name="PRRENTED" id="PRRENTED" {{isset($objTab1->PRRENTED) && $objTab1->PRRENTED =='1'?'checked':''}} value="1" onchange="getPParentRented('PRRENTED')" >
            ...
            <div class="row">
              <div class="col-lg-1 "><p>Add Line 1</p></div>
              <div class="col-lg-5 ">
                <textarea name="PRADD1" id="PRADD1" class="form-control" autocomplete="off" maxlength="100" >{{isset($objTab1->PRADD1) && $objTab1->PRADD1 !=''?$objTab1->PRADD1:''}}</textarea>
                <span class="text-danger" id="ERROR_PRADD1"></span>
              </div>

              <div class="col-lg-1 "><p>Add Line 2</p></div>
              <div class="col-lg-5 ">
                <textarea name="PRADD2" id="PRADD2" class="form-control" autocomplete="off" maxlength="100" >{{isset($objTab1->PRADD2) && $objTab1->PRADD2 !=''?$objTab1->PRADD2:''}}</textarea>
            ...
            <div class="row">
              <div class="col-lg-1"><p>Country</p></div>
              <div class="col-lg-2">
                  <input type="text" name="CTRYID_REF_POPUP1" id="CTRYID_REF_POPUP1" value="{{isset($objCountryName->CTRYCODE)?$objCountryName->CTRYCODE. ' - ':''}}  {{isset($objCountryName->NAME)?$objCountryName->NAME:''}}" class="form-control" readonly />
                  <input type="hidden" name="CTRYID_REF1" id="CTRYID_REF1" value="{{isset($objTab1->PRCTRYID_REF) && $objTab1->PRCTRYID_REF !=''?$objTab1->PRCTRYID_REF:''}}" />
                  <span class="text-danger" id="ERROR_CTRYID_REF1"></span>
              </div>

              <div class="col-lg-1"><p>State</p></div>
              <div class="col-lg-2">
                  <input type="text" name="STID_REF_POPUP1" id="STID_REF_POPUP1" value="{{isset($objStateName->STCODE)?$objStateName->STCODE. ' - ':''}}  {{isset($objStateName->NAME)?$objStateName->NAME:''}}" class="form-control" readonly/>
                  <input type="hidden" name="STID_REF1" id="STID_REF1" value="{{isset($objTab1->PRSTID_REF) && $objTab1->PRSTID_REF !=''?$objTab1->PRSTID_REF:''}}" />
              ...
              <div class="col-lg-1"><p>City</p></div>
              <div class="col-lg-2">
                <input type="text" name="CITYID_REF_POPUP1" id="CITYID_REF_POPUP1" value="{{isset($objCityName->CITYCODE)?$objCityName->CITYCODE. ' - ':''}}  {{isset($objCityName->NAME)?$objCityName->NAME:''}}" class="form-control" readonly />
                <input type="hidden" name="CITYID_REF1" id="CITYID_REF1" value="{{isset($objTab1->PRCITYID_REF) && $objTab1->PRCITYID_REF !=''?$objTab1->PRCITYID_REF:''}}" />
            ...
            <div class="row">
              <div class="col-lg-1"><p>District</p></div>
              <div class="col-lg-2">
                <input type="text" name="DISTID_REF_POPUP1" id="DISTID_REF_POPUP1" value="{{isset($objDisticName->DISTCODE) && !empty($objDisticName->DISTCODE)  ?$objDisticName->DISTCODE. ' - ' :''}}  {{isset($objDisticName->NAME) && !empty($objDisticName->NAME)  ?$objDisticName->NAME:''}}" class="form-control" readonly  />
                <input type="hidden" name="DISTID_REF1" id="DISTID_REF1" value="{{isset($objTab1->PRDISTID_REF) && $objTab1->PRDISTID_REF !=''?$objTab1->PRDISTID_REF:''}}" />
                <span class="text-danger" id="ERROR_DISTID_REF1"></span>
              </div>

              <div class="col-lg-1"><p>Pincode</p></div>
              <div class="col-lg-2">
                  <input type="text" name="PRPIN" id="PRPIN" value="{{isset($objTab1->PRPIN) && $objTab1->PRPIN !=''?$objTab1->PRPIN:''}}" class="form-control" autocomplete="off"  maxlength="10" onkeypress="return isNumberKey(event,this)" >
              </div>

              <div class="col-lg-1"><p>Landmark</p></div>
              <div class="col-lg-4">
                <input type="text" name="PRLM" id="PRLM" value="{{isset($objTab1->PRLM) && $objTab1->PRLM !=''?$objTab1->PRLM:''}}" class="form-control" autocomplete="off"  maxlength="50" >
              </div>
            </div>
          ...
          <div class=" table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:300px;" >
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                @if(!empty($objTab2))
                @php $n2=1; @endphp
                @foreach($objTab2 as $key2=>$tab2)
                <tr  class="participantRow2">
                    <td><input type="text" name="FAMILY_NAME_{{$key2}}" id ="FAMILY_NAME_{{$key2}}" value="{{isset($tab2->NAME) && $tab2->NAME !=''?$tab2->NAME:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="date" name="FAMILY_DOB_{{$key2}}" id ="FAMILY_DOB_{{$key2}}" value="{{isset($tab2->DOB) && $tab2->DOB !=''?date('Y-m-d',strtotime($tab2->DOB)):''}}"   class="form-control w-100" autocomplete="off" ></td>
                    
                    <td>
                    <select name="FAMILY_GID_REF_{{$key2}}" id="FAMILY_GID_REF_{{$key2}}" class="form-control w-100" >
                      <option value="" >Select</option>
                      @foreach ($getGender as $val)
                      <option {{isset($tab2->GID_REF) && $tab2->GID_REF==$val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
                      @endforeach
                    </select>
                    </td>

                    <td>
                      <select name="FAMILY_RSID_REF_{{$key2}}" id="FAMILY_RSID_REF_{{$key2}}" class="form-control w-100" >
                        <option value="" >Select</option>
                        @foreach ($getRelationShip as $val)
                        <option {{isset($tab2->RSID_REF) && $tab2->RSID_REF==$val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
                        @endforeach
                      </select>
                    </td>

                    <td>
                      <select name="FAMILY_EARNING_{{$key2}}" id="FAMILY_EARNING_{{$key2}}" class="form-control w-100" >
                        <option value="">Select</option>
                        <option {{isset($tab2->EARNING) && $tab2->EARNING=='1'?'selected="selected"':''}} value="1">Yes</option>
                        <option {{isset($tab2->EARNING) && $tab2->EARNING=='0'?'selected="selected"':''}} value="0">No</option>
                      </select>
                    </td>

                    <td><input type="text" name="FAMILY_CONTACTNO_{{$key2}}" id ="FAMILY_CONTACTNO_{{$key2}}" value="{{isset($tab2->CONTACTNO) && $tab2->CONTACTNO !=''?$tab2->CONTACTNO:''}}"  maxlength="20" class="form-control w-100" autocomplete="off" onkeypress="return isNumberKey(event,this)"  ></td>
                    <td><input type="text" name="FAMILY_EMAIL_{{$key2}}" id ="FAMILY_EMAIL_{{$key2}}" value="{{isset($tab2->EMAIL) && $tab2->EMAIL !=''?$tab2->EMAIL:''}}"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" {{isset($n2) && $n2 ==1?'disabled':''}} ><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                @php $n2++; @endphp
                @endforeach
          ...
          <div class=" table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:300px;" >
            <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                @if(!empty($objTab3))
                @php $n3=1; @endphp
                @foreach($objTab3 as $key3=>$tab3)
                <tr  class="participantRow3">
                    <td><input type="text" name="EDUCATION_DEGREE_{{$key3}}" id ="EDUCATION_DEGREE_{{$key3}}" value="{{isset($tab3->DEGREE) && $tab3->DEGREE !=''?$tab3->DEGREE:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EDUCATION_YOP_{{$key3}}" id ="EDUCATION_YOP_{{$key3}}" value="{{isset($tab3->YOP) && $tab3->YOP !=''?$tab3->YOP:''}}"  maxlength="20" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EDUCATION_UNIVERSITY_{{$key3}}" id ="EDUCATION_UNIVERSITY_{{$key3}}" value="{{isset($tab3->UNIVERSITY) && $tab3->UNIVERSITY !=''?$tab3->UNIVERSITY:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EDUCATION_RESULT_{{$key3}}" id ="EDUCATION_RESULT_{{$key3}}" value="{{isset($tab3->RESULT) && $tab3->RESULT !=''?$tab3->RESULT:''}}"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EDUCATION_REMARKS_{{$key3}}" id ="EDUCATION_REMARKS_{{$key3}}" value="{{isset($tab3->REMARKS) && $tab3->REMARKS !=''?$tab3->REMARKS:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" {{isset($n3) && $n3 ==1?'disabled':''}}><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                @php $n3++; @endphp
                @endforeach
          ...
          <div class=" table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:300px;" >
            <table id="example4" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                @if(!empty($objTab4))
                @php $n4=1; @endphp
                @foreach($objTab4 as $key4=>$tab4)
                <tr  class="participantRow4">
                    <td><input type="text" name="EXPERIENCE_CNAME_{{$key4}}" id ="EXPERIENCE_CNAME_{{$key4}}" value="{{isset($tab4->CNAME) && $tab4->CNAME !=''?$tab4->CNAME:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EXPERIENCE_FROMPD_{{$key4}}" id ="EXPERIENCE_FROMPD_{{$key4}}" value="{{isset($tab4->FROMPD) && $tab4->FROMPD !=''?$tab4->FROMPD:''}}"  maxlength="30" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EXPERIENCE_TOPD_{{$key4}}" id ="EXPERIENCE_TOPD_{{$key4}}" value="{{isset($tab4->TOPD) && $tab4->TOPD !=''?$tab4->TOPD:''}}"  maxlength="30" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EXPERIENCE_LASTDESIG_{{$key4}}" id ="EXPERIENCE_LASTDESIG_{{$key4}}" value="{{isset($tab4->LASTDESIG) && $tab4->LASTDESIG !=''?$tab4->LASTDESIG:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EXPERIENCE_CTCPA_{{$key4}}" id ="EXPERIENCE_CTCPA_{{$key4}}" value="{{isset($tab4->CTCPA) && $tab4->CTCPA !=''?$tab4->CTCPA:''}}"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EXPERIENCE_REMARKS_{{$key4}}" id ="EXPERIENCE_REMARKS_{{$key4}}" value="{{isset($tab4->REMARKS) && $tab4->REMARKS !=''?$tab4->REMARKS:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" {{isset($n4) && $n4 ==1?'disabled':''}}><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                @php $n4++; @endphp
                @endforeach
          ...
          <div class=" table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:300px;" >
            <table id="example5" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                @if(!empty($objTab5))
                @php $n5=1; @endphp
                @foreach($objTab5 as $key5=>$tab5)
                <tr  class="participantRow5">
                    <td><input type="text" name="REFERENCE_RNAME_{{$key5}}" id ="REFERENCE_RNAME_{{$key5}}" value="{{isset($tab5->RNAME) && $tab5->RNAME !=''?$tab5->RNAME:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td>
                    <select name="REFERENCE_GID_REF_{{$key5}}" id="REFERENCE_GID_REF_{{$key5}}" class="form-control w-100" >
                      <option value="" selected >Select</option>
                      @foreach ($getGender as $val)
                      <option {{isset($tab5->GID_REF) && $tab5->GID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
                      @endforeach
                    </select>
                    </td>
                    <td><input type="text" name="REFERENCE_COMPANY_{{$key5}}" id ="REFERENCE_COMPANY_{{$key5}}" value="{{isset($tab5->COMPANY) && $tab5->COMPANY !=''?$tab5->COMPANY:''}}"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="REFERENCE_DESIG_{{$key5}}" id ="REFERENCE_DESIG_{{$key5}}" value="{{isset($tab5->DESIG) && $tab5->DESIG !=''?$tab5->DESIG:''}}"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="REFERENCE_MONO_{{$key5}}" id ="REFERENCE_MONO_{{$key5}}" value="{{isset($tab5->MONO) && $tab5->MONO !=''?$tab5->MONO:''}}"  maxlength="20" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="REFERENCE_EMAIL_{{$key5}}" id ="REFERENCE_EMAIL_{{$key5}}" value="{{isset($tab5->EMAIL) && $tab5->EMAIL !=''?$tab5->EMAIL:''}}"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" {{isset($n5) && $n5 ==1?'disabled':''}}><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                @php $n5++; @endphp
                @endforeach
        ...
        <div id="tab6" class="tab-pane fade">
          <div class=" table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:300px;" >
            <table id="example6" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              @if(!empty($objTab6))
              @php $n6=1; @endphp
                @foreach($objTab6 as $key6=>$tab6)
                <tr  class="participantRow6">
                    <td><input type="text" name="EXTRACUR_NAME_{{$key6}}" id ="EXTRACUR_NAME_{{$key6}}" value="{{isset($tab6->NAME) && $tab6->NAME !=''?$tab6->NAME:''}}" maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EXTRACUR_PERIOD_{{$key6}}" id ="EXTRACUR_PERIOD_{{$key6}}" value="{{isset($tab6->PERIOD) && $tab6->PERIOD !=''?$tab6->PERIOD:''}}"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EXTRACUR_LEVELS_{{$key6}}" id ="EXTRACUR_LEVELS_{{$key6}}" value="{{isset($tab6->LEVELS) && $tab6->LEVELS !=''?$tab6->LEVELS:''}}"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input type="text" name="EXTRACUR_ACHIEVEMENT_{{$key6}}" id ="EXTRACUR_ACHIEVEMENT_{{$key6}}" value="{{isset($tab6->ACHIEVEMENT) && $tab6->ACHIEVEMENT !=''?$tab6->ACHIEVEMENT:''}}" maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" {{isset($n6) && $n6 ==1?'disabled':''}}><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                @php $n6++; @endphp
                @endforeach
        ...
        <div id="tab7" class="tab-pane fade">
          <div class="table-wrapper-scroll-x" style="margin-top:10px;">
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="PANNO" id="PANNO" value="{{isset($objTab7->PANNO) && $objTab7->PANNO !=''?$objTab7->PANNO:''}}" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>AADHAAR NO</p></div>
              <div class="col-lg-2">
                <input type="text" name="AADHARNO" id="AADHARNO" value="{{isset($objTab7->AADHARNO) && $objTab7->AADHARNO !=''?$objTab7->AADHARNO:''}}" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Election I Card No</p></div>
              <div class="col-lg-2">
                <input type="text" name="ELECTIONCNO" id="ELECTIONCNO" value="{{isset($objTab7->ELECTIONCNO) && $objTab7->ELECTIONCNO !=''?$objTab7->ELECTIONCNO:''}}" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Place of Issue</p></div>
              <div class="col-lg-2">
                <input type="text" name="ELECTIONCPOI" id="ELECTIONCPOI" value="{{isset($objTab7->ELECTIONCPOI) && $objTab7->ELECTIONCPOI !=''?$objTab7->ELECTIONCPOI:''}}" class="form-control" autocomplete="off"  maxlength="50" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="DLNO" id="DLNO" value="{{isset($objTab7->DLNO) && $objTab7->DLNO !=''?$objTab7->DLNO:''}}" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Place of Issue</p></div>
              <div class="col-lg-2">
                <input type="text" name="DLPOI" id="DLPOI" value="{{isset($objTab7->DLPOI) && $objTab7->DLPOI !=''?$objTab7->DLPOI:''}}" class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-1"><p>Valid Upto</p></div>
              <div class="col-lg-2">
                <input type="date" name="DLVALIDUPTO" id="DLVALIDUPTO" value="{{isset($objTab7->DLVALIDUPTO) && $objTab7->DLVALIDUPTO !=''?date('Y-m-d',strtotime($objTab7->DLVALIDUPTO)):''}}" class="form-control"  autocomplete="off"  >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="PASSPORTNO" id="PASSPORTNO" value="{{isset($objTab7->PASSPORTNO) && $objTab7->PASSPORTNO !=''?$objTab7->PASSPORTNO:''}}" class="form-control" autocomplete="off" maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Place of Issue</p></div>
              <div class="col-lg-2"> 
                <input type="text" name="PASSPORTPOI" id="PASSPORTPOI" value="{{isset($objTab7->PASSPORTPOI) && $objTab7->PASSPORTPOI !=''?$objTab7->PASSPORTPOI:''}}" class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-1"><p>Valid Upto</p></div>
              <div class="col-lg-2">
                <input type="date" name="PASSPORTVUPTO" id="PASSPORTVUPTO" value="{{isset($objTab7->PASSPORTVUPTO) && $objTab7->PASSPORTVUPTO !=''?date('Y-m-d',strtotime($objTab7->PASSPORTVUPTO)):''}}" class="form-control"  autocomplete="off"  >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="PFNO" id="PFNO" value="{{isset($objTab7->PFNO) && $objTab7->PFNO !=''?$objTab7->PFNO:''}}" class="form-control" autocomplete="off"  maxlength="30" >
              </div>

              <div class="col-lg-1"><p>ESI NO</p></div>
              <div class="col-lg-2">
                  <input type="text" name="ESINO" id="ESINO" value="{{isset($objTab7->ESINO) && $objTab7->ESINO !=''?$objTab7->ESINO:''}}" class="form-control" autocomplete="off" maxlength="30" >
              </div>

              <div class="col-lg-1"><p>Membership Name</p></div>
              <div class="col-lg-2">
                  <input type="text" name="MSHIPNAME" id="MSHIPNAME" value="{{isset($objTab7->MSHIPNAME) && $objTab7->MSHIPNAME !=''?$objTab7->MSHIPNAME:''}}" class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-1"><p>No</p></div>
              <div class="col-lg-2">
                  <input type="text" name="MSHIPNO" id="MSHIPNO" value="{{isset($objTab7->MSHIPNO) && $objTab7->MSHIPNO !=''?$objTab7->MSHIPNO:''}}" class="form-control"  autocomplete="off" maxlength="20" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="CONTRACTRNAME" id="CONTRACTRNAME" value="{{isset($objTab7->CONTRACTRNAME) && $objTab7->CONTRACTRNAME !=''?$objTab7->CONTRACTRNAME:''}}" class="form-control" autocomplete="off" maxlength="100" >
              </div>

              <div class="col-lg-1"><p>Nominee Name</p></div>
              <div class="col-lg-2">
                  <input type="text" name="NOMINEENAME" id="NOMINEENAME" value="{{isset($objTab7->NOMINEENAME) && $objTab7->NOMINEENAME !=''?$objTab7->NOMINEENAME:''}}" class="form-control" autocomplete="off" maxlength="100" >
              </div>
              ...
              <div class="col-lg-2">
                <select name="RSID_REF" id="RSID_REF" class="form-control" >
                  <option value="" >Select</option>
                  @foreach ($getRelationShip as $val)
                  <option {{isset($objTab7->RSID_REF) && $objTab7->RSID_REF == $val-> FID?'selected="selected"':''}} value="{{ $val-> FID }}">{{ $val-> FNAME }}</option>
                  @endforeach
                </select>
              ...
              <div class="col-lg-2">
                  <input type="text" name="BANK" id="BANK" value="{{isset($objTab7->BANK) && $objTab7->BANK !=''?$objTab7->BANK:''}}" class="form-control" autocomplete="off"  maxlength="100" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="IFSC" id="IFSC" value="{{isset($objTab7->IFSC) && $objTab7->IFSC !=''?$objTab7->IFSC:''}}" class="form-control" autocomplete="off"  maxlength="30" >
              </div>

              <div class="col-lg-1"><p>Branch</p></div>
              <div class="col-lg-2">
                  <input type="text" name="BRANCH" id="BRANCH" value="{{isset($objTab7->BRANCH) && $objTab7->BRANCH !=''?$objTab7->BRANCH:''}}" class="form-control" autocomplete="off"  maxlength="50" >
              </div>
              ...
              <div class="col-lg-2">
                  ...
                  <select name="ACTYPE" id="ACTYPE" class="form-control"  >
                    <option value="" selected >Select</option>
                    <option {{isset($objTab7->ACTYPE) && $objTab7->ACTYPE == 'SAVING ACCOUNT'?'selected="selected"':''}}  value='SAVING ACCOUNT'>SAVING ACCOUNT</option>
                    <option {{isset($objTab7->ACTYPE) && $objTab7->ACTYPE == 'CURRENT ACCOUNT'?'selected="selected"':''}} value='CURRENT ACCOUNT'>CURRENT ACCOUNT</option>
                    <option {{isset($objTab7->ACTYPE) && $objTab7->ACTYPE == 'OD'?'selected="selected"':''}} value='OD'>OD</option>
                    <option {{isset($objTab7->ACTYPE) && $objTab7->ACTYPE == 'OTHERS'?'selected="selected"':''}} value='OTHERS'>OTHERS</option>
                  </select>
              </div>

              <div class="col-lg-1"><p>Account No</p></div>
              <div class="col-lg-2">
                  <input type="text" name="ACNO" id="ACNO" value="{{isset($objTab7->ACNO) && $objTab7->ACNO !=''?$objTab7->ACNO:''}}" class="form-control" autocomplete="off"  maxlength="30" onkeypress="return isNumberKey(event,this)" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="BRANCHCODE" id="BRANCHCODE" value="{{isset($objTab7->BRANCHCODE) && $objTab7->BRANCHCODE !=''?$objTab7->BRANCHCODE:''}}" class="form-control" autocomplete="off"  maxlength="30" >
              </div>
            </div>
        ...
        <div id="tab8" class="tab-pane fade">
          <div class="table-wrapper-scroll-x" style="margin-top:10px;">
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="LLNO" id="LLNO" value="{{isset($objTab8->LLNO) && $objTab8->LLNO !=''?$objTab8->LLNO:''}}" class="form-control" autocomplete="off"  maxlength="20" onkeypress="return isNumberKey(event,this)" >
              </div>

              <div class="col-lg-2"><p>Cell No 1</p></div>
              <div class="col-lg-2">
                <input type="text" name="MONO1" id="MONO1" value="{{isset($objTab8->MONO1) && $objTab8->MONO1 !=''?$objTab8->MONO1:''}}"   class="form-control" autocomplete="off"  maxlength="20" onkeypress="return isNumberKey(event,this)" >
              </div>

              <div class="col-lg-2"><p>Cell No 2</p></div>
              <div class="col-lg-2">
                <input type="text" name="MONO2" id="MONO2" value="{{isset($objTab8->MONO2) && $objTab8->MONO2 !=''?$objTab8->MONO2:''}}"  class="form-control" autocomplete="off"  maxlength="20" onkeypress="return isNumberKey(event,this)" >
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                <input type="text" name="EMAIL" id="EMAIL" value="{{isset($objTab8->EMAIL) && $objTab8->EMAIL !=''?$objTab8->EMAIL:''}}"  class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-2"><p>Personal Email ID</p></div>
              <div class="col-lg-2">
                  <input type="text" name="PEMAIL" id="PEMAIL" value="{{isset($objTab8->PEMAIL) && $objTab8->PEMAIL !=''?$objTab8->PEMAIL:''}}"  class="form-control"  autocomplete="off" maxlength="50" >
              </div>

              <div class="col-lg-2"><p>Emergency Contact Person</p></div>
              <div class="col-lg-2">
                <input type="text" name="EMERGCPNAME" id="EMERGCPNAME" value="{{isset($objTab8->EMERGCPNAME) && $objTab8->EMERGCPNAME !=''?$objTab8->EMERGCPNAME:''}}"  class="form-control" autocomplete="off" maxlength="50" >
              </div>
            ...
            <div class="col-lg-2"><p>Cell No</p></div>
              <div class="col-lg-2">
                <input type="text" name="EMERGCPMONO" id="EMERGCPMONO" value="{{isset($objTab8->EMERGCPMONO) && $objTab8->EMERGCPMONO !=''?$objTab8->EMERGCPMONO:''}}"  class="form-control" autocomplete="off" maxlength="20" onkeypress="return isNumberKey(event,this)"   >
              </div>
            </div>
        ...
        <div id="tab9" class="tab-pane fade">
          <div class="table-wrapper-scroll-x" style="margin-top:10px;">
            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                  <input type="text" name="CRDISEASE1" id="CRDISEASE1" value="{{isset($objTab9->CRDISEASE1) && $objTab9->CRDISEASE1 !=''?$objTab9->CRDISEASE1:''}}" class="form-control" autocomplete="off" maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Current Disease 2</p></div>
              <div class="col-lg-5">
                <input type="text" name="CRDISEASE2" id="CRDISEASE2" value="{{isset($objTab9->CRDISEASE2) && $objTab9->CRDISEASE2 !=''?$objTab9->CRDISEASE2:''}}" class="form-control" autocomplete="off" maxlength="20" >
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                <input type="text" name="CRDISEASE3" id="CRDISEASE3" value="{{isset($objTab9->CRDISEASE3) && $objTab9->CRDISEASE3 !=''?$objTab9->CRDISEASE3:''}}" class="form-control" autocomplete="off" maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Allergy</p></div>
              <div class="col-lg-2">
                <input type="text" name="ALLERGY" id="ALLERGY" value="{{isset($objTab9->ALLERGY) && $objTab9->ALLERGY !=''?$objTab9->ALLERGY:''}}" class="form-control" autocomplete="off" maxlength="20" >
              </div>
              ...
              <div class="col-lg-2">
                  <input type="text" name="HEIGHT" id="HEIGHT" value="{{isset($objTab9->HEIGHT) && $objTab9->HEIGHT !=''?$objTab9->HEIGHT:''}}" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Weight</p></div>
              <div class="col-lg-2">
                <input type="text" name="WEIGHT" id="WEIGHT" value="{{isset($objTab9->WEIGHT) && $objTab9->WEIGHT !=''?$objTab9->WEIGHT:''}}" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Color</p></div>
              <div class="col-lg-2">
                <input type="text" name="COLOR" id="COLOR" value="{{isset($objTab9->COLOR) && $objTab9->COLOR !=''?$objTab9->COLOR:''}}" class="form-control" autocomplete="off" maxlength="15"   >
              </div>

              <div class="col-lg-1"><p>Religion</p></div>
              <div class="col-lg-2">
                <input type="text" name="RELIGION" id="RELIGION" value="{{isset($objTab9->RELIGION) && $objTab9->RELIGION !=''?$objTab9->RELIGION:''}}" class="form-control" autocomplete="off" maxlength="15"   >
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input type="text" name="NANTIONALITY" id="NANTIONALITY"  value="{{isset($objTab9->NANTIONALITY) && $objTab9->NANTIONALITY !=''?$objTab9->NANTIONALITY:''}}"class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Hobbies</p></div>
              <div class="col-lg-2">
                <input type="text" name="HOBBIES" id="HOBBIES" value="{{isset($objTab9->HOBBIES) && $objTab9->HOBBIES !=''?$objTab9->HOBBIES:''}}" class="form-control" autocomplete="off" maxlength="30" >
              </div>

              <div class="col-lg-1"><p>Vegetarian</p></div>
              <div class="col-lg-2">
                <input type="radio" name="VEGETARIAN" {{isset($objTab9->VEGETARIAN) && $objTab9->VEGETARIAN =='1'?'checked':''}}  value="1"  >
              </div>

              <div class="col-lg-1"><p>Non-Veg</p></div>
              <div class="col-lg-2">
              <input type="radio" name="VEGETARIAN" {{isset($objTab9->VEGETARIAN) && $objTab9->VEGETARIAN =='0'?'checked':''}}    value="0"   >
              </div>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="country_tab11" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <tr>
          <td ><input type="text" id="country_codesearch1" onkeyup="searchCountryCode1()"></td>
          <td><input type="text" id="country_namesearch1" onkeyup="searchCountryName1()"></td>
        </tr>
        </tbody> --}}
        <thead>
          <thead>
      ...
      <table id="country_tab21" class="display nowrap table  table-striped table-bordered" width="100%">
        <tbody id="country_body1">
          @foreach ($objCountryList as $index=>$CountryList)
          <tr >
            <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_CTRYID1_REF[]"  id="ctryidref1_{{ $CountryList->CTRYID }}" class="cls_ctryidref1" value="{{ $CountryList->CTRYID }}" ></td>
            <td class="ROW2" style="width: 39%">{{ $CountryList->CTRYCODE }}
            <input type="hidden" id="txtctryidref1_{{ $CountryList->CTRYID }}" data-desc="{{ $CountryList->CTRYCODE }} - {{ $CountryList->NAME }}" value="{{ $CountryList-> CTRYID }}"/>
            </td>
            <td class="ROW3" style="width: 39%">{{ $CountryList->NAME }}</td>
          </tr>
          @endforeach
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="state_tab11" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <tr>
          <td ><input type="text" id="state_codesearch1" onkeyup="searchStateCode1()"></td>
          <td><input type="text" id="state_namesearch1" onkeyup="searchStateName1()"></td>
        </tr>
        </tbody> --}}
        <thead>
          <tr>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="city_tab11" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <tr>
          <td ><input type="text" id="city_codesearch1" onkeyup="searchCityCode1()"></td>
          <td><input type="text" id="city_namesearch1" onkeyup="searchCityName1()"></td>
        </tr>
        </tbody> --}}
        <thead>
          <tr>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="dist_tab11" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <tr>
          <td ><input type="text" id="dist_codesearch1" onkeyup="searchDistCode1()"></td>
          <td><input type="text" id="dist_namesearch1" onkeyup="searchDistName1()"></td>
        </tr>
        </tbody> --}}
        <thead>
          <tr>
...
function getCountryWiseState(CTRYID_REF,dataStatus){
    ...
    $.ajax({
        url:'{{route("master",[$FormId,"getCountryWiseState"])}}',
        type:'POST',
...
function getStateWiseCity(CTRYID_REF,STID_REF,dataStatus){
    ...
    $.ajax({
        url:'{{route("master",[$FormId,"getStateWiseCity"])}}',
        type:'POST',
...
function getCityWiseDist(CTRYID_REF,STID_REF,CITYID_REF,dataStatus){
    ...
    $.ajax({
        url:'{{route("master",[$FormId,"getCityWiseDist"])}}',
        type:'POST',
