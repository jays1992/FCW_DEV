...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->DESGID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->DESGCODE}} </label>
                    <input type="hidden" name="DESGID" id="DESGID" value="{{ $objResponse->DESGID }}" />
                    <input type="hidden" name="DESGCODE" id="DESGCODE" value="{{ $objResponse->DESGCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="PLID_REF_POPUP" id="PLID_REF_POPUP" readonly onkeypress="return AlphaNumaric(event,this)" value="{{ old('DESCRIPTIONS',$objResponse->PDESCRCRIPTIONS) }}" class="form-control mandatory" autocomplete="off" maxlength="120" tabindex="1" style="text-transform:uppercase" />
                        <input type="hidden" name="PLID_REF" id="PLID_REF"  value="{{ old('PLID_REF',$objResponse->PLID_REF) }}" />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[171,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[171,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
