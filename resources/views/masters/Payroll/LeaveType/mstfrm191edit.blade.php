...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->LTID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->LEAVETYPE_CODE}} </label>
                    <input type="hidden" name="LTID" id="LTID" value="{{ $objResponse->LTID }}" />
                    <input type="hidden" name="LEAVETYPE_CODE" id="LEAVETYPE_CODE" value="{{ $objResponse->LEAVETYPE_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="LEAVETYPE_DESC" id="LEAVETYPE_DESC" class="form-control mandatory" value="{{ old('LEAVETYPE_DESC',$objResponse->LEAVETYPE_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    $("#LEAVETYPE_DESC").keydown(function(){
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[191,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[191,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
