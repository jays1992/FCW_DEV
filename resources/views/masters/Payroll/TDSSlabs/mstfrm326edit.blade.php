                      ...
                      <tr>                          
                        ...
                        <tbody>
                          ...
                          <tr  class="participantRow">
                              ...
                              <td><input  class="form-control" type="text" name={{"TAX_RATE_".$key}}    id ={{"TAX_RATE_".$key}}    value="{{ $row->TAX_RATE }}" autocomplete="off" onkeypress="return onlyNumberKey(event)" ></td>
                              <td><input  class="form-control " type="text" name={{"CESS1_RATE_".$key}} id ={{"CESS1_RATE_".$key}}  value="{{ $row->CESS1_RATE }}" autocomplete="off" onkeypress="return onlyNumberKey(event)" ></td>
                              <td><input  class="form-control" type="text" name={{"CESS2_RATE_".$key}}  id ={{"CESS2_RATE_".$key}}  value="{{ $row->CESS2_RATE }}" autocomplete="off"  onkeypress="return onlyNumberKey(event)" ></td>
                              <td><input  class="form-control" type="text" name={{"REMARKS_".$key}}     id ={{"REMARKS_".$key}}     value="{{ $row->REMARKS }}" autocomplete="off" ></td>
