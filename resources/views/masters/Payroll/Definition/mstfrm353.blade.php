...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[353,'index'])}}" class="btn singlebt">Definition</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->DEFINID}}" value="{{$val->DEFINID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
              <td>{{isset($val->PARTICULAR) && $val->PARTICULAR !=''?$val->PARTICULAR:''}}</td>
        ...
        <form id="masterForm353Print" action="{{ route('mastergetlist',[353,'printdata'])}}" method="POST" >
            @csrf
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[353,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[353,"view",":rcdId"]) }}';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[353,"attachment",":rcdId"]) }}';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[353,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
                  ...
                  success:function(data) {               
                        ...
                        if(data.approve) {                   
                            ...
                            $("#alert").modal('show');
                            $("#OkBtn").focus();
                            window.location.href="{{ route('master',[353,'index']) }}";
                        }               
                    },
                    error:function(data){
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[353,"cancel"])}}',
                            type:'POST',
