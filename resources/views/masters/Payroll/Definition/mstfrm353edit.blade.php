                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                  <thead id="thead1"  style="position: sticky;top: 0">
                    ...
                    <tr  class="participantRow">
                      <td><input  class="form-control w-100" type="text" name={{"PARTICULAR_".$key}} id ={{"PARTICULAR_".$key}} value="{{ $row->PARTICULAR }}"  maxlength="100" autocomplete="off" style="text-transform:uppercase;width:100%;" ></td>
...
function checkDuplicateCode(){
    ...
    $.ajax({
        url:'{{route("master",[353,"codeduplicate"])}}',
        type:'POST',
        data:formData,
...
window.fnSaveData = function (){
    ...
    $.ajax({
        url:'{{ route("mastermodify",[353,"update"]) }}',
        type:'POST',
        data:formData,
        success:function(data) {
...
$("#btnUndo").click(function(){
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[353,"Approve"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
...
window.fnUndoYes = function (){
  ...
  //reload form
  window.location.href = "{{route('master',[353,'add'])}}";
