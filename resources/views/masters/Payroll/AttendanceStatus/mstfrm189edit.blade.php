...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->ATTENDANCE_STID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->ATTENDANCE_CODE}} </label>
                    <input type="hidden" name="ATTENDANCE_STID" id="ATTENDANCE_STID" value="{{ $objResponse->ATTENDANCE_STID }}" />
                    <input type="hidden" name="ATTENDANCE_CODE" id="ATTENDANCE_CODE" value="{{ $objResponse->ATTENDANCE_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="ATTENDANCE_NAME_POPUP" id="ATTENDANCE_NAME_POPUP" readonly  value="{{ $objResponse->ATTENDANCE_CODES.'-'.$objResponse->ATTENDANCE_CODE_DESC }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" />
                        <input type="hidden" name="ATTENDANCE_NAME" id="ATTENDANCE_NAME" value="{{$objResponse->ATTENDANCE_STID}}" />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[189,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[189,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
