    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
                ...
                <th>Company Working Code</th>
                <th>Company Working Date</th>
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->CP_WORKINGID}}" value="{{$val->CP_WORKINGID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->COMPANY_WORKING_CODE) && $val->COMPANY_WORKING_CODE !=''?$val->COMPANY_WORKING_CODE:''}}</td>
                <td>{{isset($val->COMPANY_WORKING_DATE) && $val->COMPANY_WORKING_DATE !=''?$val->COMPANY_WORKING_DATE:''}}</td>
