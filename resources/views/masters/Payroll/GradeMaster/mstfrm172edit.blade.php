...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->GRADEID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->GRADE_CODE}} </label>
                    <input type="hidden" name="GRADEID" id="GRADEID" value="{{ $objResponse->GRADEID }}" />
                    <input type="hidden" name="GRADE_CODE" id="GRADE_CODE" value="{{ $objResponse->GRADE_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="GRADE_DESC" id="GRADE_DESC" class="form-control mandatory" value="{{ old('GRADE_DESC',$objResponse->GRADE_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[172,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[172,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
