...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->CCOMPONENTID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->CCOMPONENT_CODE}} </label>
                    <input type="hidden" name="CCOMPONENTID" id="CCOMPONENTID" value="{{ $objResponse->CCOMPONENTID }}" />
                    <input type="hidden" name="CCOMPONENT_CODE" id="CCOMPONENT_CODE" value="{{ $objResponse->CCOMPONENT_CODE }}" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[138,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[138,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
