...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->PSTAGEID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->PSTAGE_CODE}} </label>
                    <input type="hidden" name="PSTAGEID" id="PSTAGEID" value="{{ $objResponse->PSTAGEID }}" />
                    <input type="hidden" name="PSTAGE_CODE" id="PSTAGE_CODE" value="{{ $objResponse->PSTAGE_CODE }}" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[137,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[137,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
