...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->BGID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="BGID" id="BGID" value="{{ $objResponse->BGID }}" />
                    <input type="hidden" name="BG_CODE" id="BG_CODE" value="{{ $objResponse->BG_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="BG_DESC" id="BG_DESC" class="form-control mandatory" value="{{ old('BG_DESC',$objResponse->BG_DESC) }}" maxlength="200" tabindex="1"  />
                ...
                <div class="row" id="alps_sap" style="display:none;">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="SAP_CODE" id="SAP_CODE"  value="{{ old('SAP_CODE',$objResponse->SAP_CODE) }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" />
                ...
                <div class="row" id="alps_ref" style="display:none;">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="ALPS_REF" id="ALPS_REF" value="{{ old('ALPS_REF',$objResponse->ALPS_REFNO) }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[120,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[120,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
