...
<div class="container-fluid topnav">
  <div class="row">
      <div class="col-lg-2">
      <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Customer Coding Definition</a>
      </div>
...
<div class="container-fluid purchase-order-view filter">     
  <form id="frm_mst_edit" method="POST"  > 
    @CSRF
    {{isset($objResponse->DOCNODEFIID) ? method_field('PUT') : '' }}
    <div class="inner-form">
          
      <input type="hidden" name="CCODEDEFIID" id="CCODEDEFIID" value="{{isset($objResponse->CCODEDEFIID) && $objResponse->CCODEDEFIID !=''?$objResponse->CCODEDEFIID:''}}" />
      ...
      <div class="row">
          <div class="col-lg-2 pl"><p>Customer Code max digit</p></div>
          ...
          <div class="col-lg-2 pl"><p>Customer Code (Prefix)</p></div>
          <div class="col-lg-1 pl">
