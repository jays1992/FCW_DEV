...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->YRID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-3 pl">
                    ...
                    <label> {{$objResponse->YRCODE}} </label>
                    <input type="hidden" name="YRID" id="YRID" value="{{ $objResponse->YRID }}" />
                    <input type="hidden" name="YRCODE" id="YRCODE" value="{{ $objResponse->YRCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 pl">
                    <input type="text" name="YRDESCRIPTION" id="YRDESCRIPTION" class="form-control mandatory" value="{{ old('YRDESCRIPTION',$objResponse->YRDESCRIPTION) }}" maxlength="100" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[122,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[122,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
