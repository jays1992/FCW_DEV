         ...
         <form id="frm_mst_state" method="POST"  > 
          ...
          <div class="inner-form">
                  ...
                  <div class="col-lg-3 pl">
                    @if(!empty($objDD))
                        @if($objDD->SYSTEM_GRSR == "1")
                            <input type="text" name="STCODE" id="STCODE" value="{{ $objDOCNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                        @endif
                        @if($objDD->MANUAL_SR == "1")
                            <input type="text" name="STCODE" id="STCODE" value="{{ old('STCODE') }}" class="form-control mandatory" minlength="3" maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase"  >
                        @endif
                    @endif  
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl col-md-offset-1"><p>Main Language</p></div>
                <div class="col-lg-3 pl ">
