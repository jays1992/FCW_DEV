    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <button class="btn topnavbt" id="btnAdd" disabled="disabled" ><i class="fa fa-plus"></i> Add</button>
                        ...
                        <button id="btnSaveCountry"   class="btn topnavbt" tabindex="10"><i class="fa fa-save"></i> Save</button>
                        ...
                        <button class="btn topnavbt" id="btnApproved"{{($objRights->APPROVAL1 || $objRights->APPROVAL2 || $objRights->APPROVAL3 || $objRights->APPROVAL4 || $objRights->APPROVAL5) == 1 ? '' : 'disabled'}}><i class="fa fa-lock"></i> Approved</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_state" method="POST"  > 
          ...
          <div class="inner-form">
				...
				<div class="row">
					...
					<div class="col-lg-3 pl">
						<select name="CTRYID_REF" id="CTRYID_REF" class="form-control mandatory" onchange="getCountryName(this.value)" tabindex="1"  >
							...
							<option {{isset($objCountry->CTRYID_REF) && $objCountry->CTRYID_REF ==$countryList->CTRYID?"selected='selected'":""}}  value="{{$countryList->CTRYID}}">{{$countryList->CTRYCODE.' - '.$countryList->NAME}}</option>
							@endforeach
						</select>
					</div>
              ...
              <div class="row">
                <div class="col-lg-2 pl"><p>STD Code</p></div>
                <div class="col-lg-3 pl">
              ...
              <div class="row">
				<div class="col-lg-2 pl"><p>NEWSC India</p></div>
                <div class="col-lg-3 pl">
			  ...
			  <div class="row">
					<div class="col-lg-2 pl"><p>State / UT</p></div>
					<div class="col-lg-3 pl">
              ...
              <div class="row">
                ...
                <div class="col-lg-3 pl">
                  <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" {{$objCountry->DEACTIVATED == 1 ? "" : "disabled"}} value="{{isset($objCountry->DODEACTIVATED) && $objCountry->DODEACTIVATED !="" && $objCountry->DODEACTIVATED !="1900-01-01" ? $objCountry->DODEACTIVATED:''}}" tabindex="9" placeholder="dd/mm/yyyy"  />
                </div>
            ...
            success:function(data) {
                ...
                if(data.errors) {
                    ...
                    if(data.errors.STATE_NAME){
                        showError('ERROR_COUNTRY_NAME',"State Name is required.");
                    }
