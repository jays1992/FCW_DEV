         ...
         <form id="frm_mst_add" method="POST" enctype="multipart/form-data" > 
          ...
          <div class="row">
              ...
              <div class="row">
                ...
                <textarea name="ADDL1" id="ADDL1" class="form-control mandatory"  maxlength="200" tabindex="6" style='height:33px;' ></textarea>
                ...
                <div class="col-lg-2 pl">
                <textarea name="ADDL2" id="ADDL2" class="form-control"  maxlength="200" tabindex="6" style='height:33px;' ></textarea>
