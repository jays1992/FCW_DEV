...
@section('content')
         ...
         <form id="frm_mst_edit" method="POST"  enctype="multipart/form-data" > 
          ...
          <div class="inner-form">
              ...
              <div class="row">
                ...
                <textarea name="ADDL1" id="ADDL1" class="form-control mandatory"  maxlength="200" tabindex="6" style='height:33px;' >{{isset($objResponse->ADDL1) && $objResponse->ADDL1 !=""?$objResponse->ADDL1:''}}</textarea>
                ...
                <div class="col-lg-2 pl">
                <textarea name="ADDL2" id="ADDL2" class="form-control"  maxlength="200" tabindex="6" style='height:33px;' >{{isset($objResponse->ADDL2) && $objResponse->ADDL2 !=""?$objResponse->ADDL2:''}}</textarea>
    ...
    <div class="col-lg-1 pl"><p>Website</p></div>
        ...
        <span class="text-danger" id="ERROR_SKYPEID"></span>
			...
			<div class="col-lg-1 pl"><p>Authorised Person Name</p></div>
			<div class="col-lg-2 pl">
		...
		<div class="row">
          ...
          <span class="text-danger" id="ERROR_INDSID_REF"></span>
			...
			<div class="col-lg-1 pl"><p>Industry Vertical</p></div>
			<div class="col-lg-2 pl">
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[147,"update"])}}',
            type:'POST',
