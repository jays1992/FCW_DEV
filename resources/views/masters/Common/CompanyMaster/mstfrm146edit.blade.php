...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  enctype="multipart/form-data" > 
          @CSRF
          {{isset($objResponse->CYID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="CYID" id="CYID" value="{{ $objResponse->CYID }}" />
                    <input type="hidden" name="CYCODE" id="CYCODE" value="{{ $objResponse->CYCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="col-lg-2 pl">
                <input type="text" name="NAME" id="NAME" class="form-control mandatory" value="{{ old('NAME',$objResponse->NAME) }}" maxlength="200" tabindex="2"  />
                ...
                <div class="col-lg-1 pl ">
                  <input type="text" name="PANNO" id="PANNO" class="form-control" value="{{ old('PANNO',$objResponse->PANNO) }}"  maxlength="20" tabindex="5" >
              ...
              <div class="row">
                ...
                <input type="text" name="REGADDL1" id="REGADDL1" class="form-control mandatory" value="{{ old('REGADDL1',$objResponse->REGADDL1) }}"  maxlength="200" tabindex="6" >
                ...
                <div class="col-lg-3 pl">
                <input type="text" name="REGADDL2" id="REGADDL2" class="form-control" value="{{ old('REGADDL2',$objResponse->REGADDL2) }}" maxlength="200" tabindex="7" >
                ...
                <div class="col-lg-1 pl"><p>Pincode</p></div>
                  <div class="col-lg-1 pl">
                    <input type="text" name="REGPINCODE" id="REGPINCODE" class="form-control" value="{{ old('REGPINCODE',$objResponse->REGPINCODE) }}"  maxlength="9" tabindex="8"  >
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="REGCTRYID_REF_POPUP" id="REGCTRYID_REF_POPUP" class="form-control mandatory"  readonly tabindex="9" value="{{isset($objRegCountryName->CTRYCODE)?$objRegCountryName->CTRYCODE. ' - ':''}}  {{isset($objRegCountryName->NAME)?$objRegCountryName->NAME:''}}" />
                <input type="hidden" name="REGCTRYID_REF" id="REGCTRYID_REF" value="{{ old('REGCTRYID_REF',$objResponse->REGCTRYID_REF) }}" />
                <span class="text-danger" id="ERROR_REGCTRYID_REF"></span>
                </div>
                
                <div class="col-lg-1 pl"><p>State</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="REGSTID_REF_POPUP" id="REGSTID_REF_POPUP" class="form-control mandatory"  readonly tabindex="10" value="{{isset($objRegStateName->STCODE)?$objRegStateName->STCODE. ' - ':''}}  {{isset($objRegStateName->NAME)?$objRegStateName->NAME:''}}" />
                <input type="hidden" name="REGSTID_REF" id="REGSTID_REF" value="{{ old('REGSTID_REF',$objResponse->REGSTID_REF) }}" />
                <span class="text-danger" id="ERROR_REGSTID_REF"></span>
                </div>
                
                <div class="col-lg-1 pl"><p>City</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="REGCITYID_REF_POPUP" id="REGCITYID_REF_POPUP" class="form-control mandatory"  readonly tabindex="11" value="{{isset($objRegCityName->CITYCODE)?$objRegCityName->CITYCODE. ' - ':''}}  {{isset($objRegCityName->NAME)?$objRegCityName->NAME:''}}" />
                <input type="hidden" name="REGCITYID_REF" id="REGCITYID_REF" value="{{ old('REGCITYID_REF',$objResponse->REGCITYID_REF) }}" />
                <span class="text-danger" id="ERROR_REGCITYID_REF"></span>
                </div>
                
                <div class="col-lg-1 pl"><p>Landmark</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="REGLM" id="REGLM" class="form-control" value="{{ old('REGLM',$objResponse->REGLM) }}" maxlength="200" tabindex="12">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 pl">
              <input type="text" name="CORPADDL1" id="CORPADDL1" class="form-control" value="{{ old('CORPADDL1',$objResponse->CORPADDL1) }}" maxlength="200" tabindex="13">
              ...
              <div class="col-lg-3 pl">
              <input type="text" name="CORPADDL2" id="CORPADDL2" class="form-control" value="{{ old('CORPADDL2',$objResponse->CORPADDL2) }}" maxlength="200" tabindex="14">
              <span class="text-danger" id="ERROR_CORPADDL2"></span>
              </div>
              
              <div class="col-lg-1 pl"><p>Pincode</p></div>
                <div class="col-lg-1 pl">
                  <input type="text" name="CORPPINCODE" id="CORPPINCODE"  class="form-control" value="{{ old('CORPPINCODE',$objResponse->CORPPINCODE) }}"  maxlength="10" tabindex="15"  >
		...
		<div class="row">
			...
			<div class="col-lg-1 pl"><p>Country</p></div>
			<div class="col-lg-2 pl">
          <input type="text" name="CORPCTRYID_REF_POPUP" id="CORPCTRYID_REF_POPUP" class="form-control" readonly value="{{isset($objCorCountryName->CTRYCODE)?$objCorCountryName->CTRYCODE. ' - ':''}}  {{isset($objCorCountryName->NAME)?$objCorCountryName->NAME:''}}"  />
          <input type="hidden" name="CORPCTRYID_REF" id="CORPCTRYID_REF" value="{{ old('CORPCTRYID_REF',$objResponse->CORPCTRYID_REF) }}" />
          <span class="text-danger" id="ERROR_CORPCTRYID_REF"></span>
			</div>
			
			<div class="col-lg-1 pl"><p>State</p></div>
			<div class="col-lg-2 pl">
          <input type="text" name="CORPSTID_REF_POPUP" id="CORPSTID_REF_POPUP" class="form-control" readonly value="{{isset($objCorStateName->STCODE)?$objCorStateName->STCODE. ' - ':''}}  {{isset($objCorStateName->NAME)?$objCorStateName->NAME:''}}"  />
          <input type="hidden" name="CORPSTID_REF" id="CORPSTID_REF" value="{{ old('CORPSTID_REF',$objResponse->CORPSTID_REF) }}" />
          <span class="text-danger" id="ERROR_CORPSTID_REF"></span>
			</div>
			
			<div class="col-lg-1 pl"><p>City</p></div>
			<div class="col-lg-2 pl">
          <input type="text" name="CORPCITYID_REF_POPUP" id="CORPCITYID_REF_POPUP" class="form-control" readonly value="{{isset($objCorCityName->CITYCODE)?$objCorCityName->CITYCODE. ' - ':''}}  {{isset($objCorCityName->NAME)?$objCorCityName->NAME:''}}"  />
          <input type="hidden" name="CORPCITYID_REF" id="CORPCITYID_REF" value="{{ old('CORPCITYID_REF',$objResponse->CORPCITYID_REF) }}" />
          <span class="text-danger" id="ERROR_CORPCITYID_REF"></span>
			</div>
			
			<div class="col-lg-1 pl"><p>Landmark</p></div>
			<div class="col-lg-2 pl">
				<input type="text" name="CORPLM" id="CORPLM" class="form-control " value="{{ old('CORPLM',$objResponse->CORPLM) }}" maxlength="200" tabindex="19" >
		...
		<div class="row">
          ...
          <option value="" selected >Select</option>
								...
								<option {{isset($objResponse->CRID_REF) && $objResponse->CRID_REF == $Currency->CRID?'selected="selected"':'' }}  value="{{ $Currency-> CRID }}">{{ $Currency->CRCODE }} - {{ $Currency->CRDESCRIPTION }}</option>
								@endforeach
				</select>
...
<div id="ALPSSpecific" class="tab-pane fade in active">                    
	...
	<div id="tab2" class="tab-pane fade">
        ...
        @if($objResponse->LOGO !="")
          ...
          <input type="hidden" name="HID_LOGO" id="HID_LOGO" value="{{$objResponse->LOGO}}" >
        @endif  
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[146,"update"])}}',
            type:'POST',
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[146,"singleapprove"])}}',
            type:'POST',
            enctype: 'multipart/form-data',
            contentType: false,     
            cache: false,           
