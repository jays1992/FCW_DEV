...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[124,'index'])}}" class="btn singlebt">Voucher Type Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->VTID) ? method_field('PUT') : '' }}
          <div class="inner-form">
          
              
              <div class="row">
                  <div class="col-lg-2 pl"><p>Voucher Type Code</p></div>
                  <div class="col-lg-2 pl">
                  
                    <label> {{$objResponse->VCODE}} </label>
                    <input type="hidden" name="VTID" id="VTID" value="{{ $objResponse->VTID }}" />
                    <input type="hidden" name="VCODE" id="VCODE" value="{{ $objResponse->VCODE }}" autocomplete="off"  maxlength="6"   />
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[124,"add"])}}';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[124,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[124,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[124,"index"]) }}';
