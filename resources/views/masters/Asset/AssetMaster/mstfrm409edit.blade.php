       ...
       <div class="inner-form">
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Asset Code*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCODE" id="ASSETCODE" value="{{ $HDR->ASSETCODE }}" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTDESCRIPTIONS" id="ASTDESCRIPTIONS" value="{{ $HDR->ASTDESCRIPTIONS }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Asset Category</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="CATEGORY" id="ASSETCAT" value="{{ $HDR->CATEGORY }}" class="form-control mandatory"  autocomplete="off" readonly/>
                   <input type="hidden" name="ASCATID_REF" id="ASCATID_REF" value="{{ $HDR->ASCATID }}" class="form-control" autocomplete="off" />
                 </div>
             </div> 
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Category Description</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="CATDESCRIPTIONS" id="CATADESCRIPTIONS" value="{{ $HDR->CATDESCRIPTIONS }}"  class="form-control" readonly  maxlength="100" >  
                 </div>
                 ...
                 <div class="col-lg-2 pl">
                   ...
                   <input type="hidden" name="ASGID_REF" id="ASGID_REF" value="{{ $HDR->ASGID }}" class="form-control" readonly  maxlength="100" > 
                 </div>
                 ...
                 <div class="col-lg-2 pl">
                   ...
                   <input type="hidden" name="ASTID_REF" id="ASTID_REF" value="{{ $HDR->ASTID }}" class="form-control" readonly  maxlength="100" > 
                 </div>
             </div>
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Company Act</p></div>
                 <div class="col-lg-2 pl">
                   <input type="radio" NAME="DMETHOD_INCOMETAX" {{isset($HDR) && $HDR->DMETHOD_INCOMETAX =='1'?'checked':'' }} value="1" class="enable_tb">
                 </div>

               <div class="col-lg-2 pl"><p>Salvage Rate</p></div>
                 <div class="col-lg-2 pl">
                   <input name="SALAVERATE" id="SALAVERATE" value="{{ $HDR->SALAVERATE }}" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" type="text"> 
                 </div>

                 <div class="col-lg-2 pl"><p>Life of Asset (in Years)</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="LOASSET" id="LOASSET" value="{{ $HDR->LOASSET }}" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>                   
             </div>
             <div class="row">
               <div class="col-lg-2 pl"><p>WDV Method</p></div>
                 <div class="col-lg-2 pl">
                   <input type="radio" NAME="DMETHOD_INCOMETAX" {{isset($HDR) && $HDR->DMETHOD_INCOMETAX =='2'?'checked':'' }} value="1" class="enable_tbwdv"> 
                 </div>

               <div class="col-lg-2 pl"><p>WDV Rate</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="WDVRATE" id="WDVRATE" value="{{ $HDR->WDVRATE }}" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>
             </div>
             <br>
             <div class="row">
                   ...
                   <tbody>
                    ...
                    @foreach($MAT as $key => $row)
                      <tr  class="participantRow">
                        <td hidden><input type="hidden" name="ASSETID_REF[]"        id="ASSETID_REF" value="{{ $row->ASSETID_REF }}" /></td>
                        <td><input type="text"          name="popupITEMID[]"        id={{"popupITEMID_".$key}} value="{{ $row->ICODE }}" class="form-control"  autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="ITEMID_REF[]"         id={{"ITEMID_REF_".$key}} class="form-control"  value="{{ $row->ITEMID_REF }}" autocomplete="off" /></td>
                        <td><input type="text"          name="ItemName[]"           id={{"ItemName_".$key}} class="form-control" value="{{ $row->NAME }}"  autocomplete="off"   readonly/></td>
                        <td><input type="text"          name="Itemspec[]"           id={{"Itemspec_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ITEM_SPECI }}" readonly  /></td>
                        <td><input type="text"          name="popupMUOM[]"          id={{"popupMUOM_".$key}} class="form-control" value="{{ $row->UOMCODE }} {{ $row->DESCRIPTIONS }}"   autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="UOMID_REF[]"          id={{"UOMID_REF_".$key}}  class="form-control" value="{{ $row->UOMID_REF }}"   autocomplete="off" /></td>
                        <td hidden><input type="hidden" name="MAIN_UOMID_REF[]"     id={{"MAIN_UOMID_REF_".$key}} class="form-control"  autocomplete="off" /></td>
                        <td hidden><input type="hidden" name="SE_QTY[]"             id={{"SE_QTY_".$key}} class="form-control three-digits" maxlength="13" autocomplete="off"  /></td>
                        <td hidden><input type="hidden" name="SO_FQTY[]"            id={{"SO_FQTY_".$key}} class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="PRIORITYID[]"         id={{"PRIORITYID_".$key}} class="form-control"  autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="PTID_REF[]"           id={{"PTID_REF_".$key}} class="form-control"  autocomplete="off" readonly/></td>
                        <td hidden><input type="hidden" name="EDD[]"                id={{"EDD_".$key}}         class="form-control w-100" placeholder="dd/mm/yyyy" ></td>
...
$.ajax({
    url:'{{ route("mastermodify",[409,"Approve"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
