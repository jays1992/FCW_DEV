...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Asset No Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
      <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  >       
        @CSRF
        {{isset($objResponse->ASSETNOID) ? method_field('PUT') : '' }}
       <div class="inner-form">
       
             <div class="row">
               <div class="col-lg-2 pl"><p>Asset Code No*</p></div>
               <div class="col-lg-2 pl">
                <input type="text" name="ASTCODENO" id="ASTCODENO" value="{{ $HDR->ASSETNOCODE }}" class="form-control" maxlength="100">
               </div>

               <div class="col-lg-2 pl"><p>Asset Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTDATES" id="ASTDATES" value="{{ $HDR->ASSETNODATE }}" class="form-control" maxlength="100">
                 </div>

               <div class="col-lg-2 pl"><p>Asset Code*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCODE" id="ASSETCODE" value="{{ $HDR->ASSETCODE }}" class="form-control mandatory"  autocomplete="off" readonly/>
                   <input type="hidden" name="ASSETID_REF" id="ASCATID" value="{{ $HDR->ASSETID }}" class="form-control" autocomplete="off" />
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTDESCRIPTIONS" id="DESCRIPTIONS" value="{{ $HDR->ASTDES }}" class="form-control" readonly="" maxlength="100">
                 </div>

                 <div class="col-lg-2 pl"><p>Asset Group</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASGCODE" id="ASGCODE" value="{{ $HDR->ASGCODE }}" class="form-control" readonly="" maxlength="100">
               ...
               <div class="col-lg-2 pl"><p>Asset Type</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETTYPE" id="ASSETTYPE" value="{{ $HDR->ASSETTYPE }}" class="form-control" readonly="" maxlength="100">
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCATEGRY" id="ASSETCATEGRY" value="{{ $HDR->CATEGORY }}" class="form-control mandatory" autocomplete="off" readonly="">
               ...
               <br>
                 ...
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTDATEPURCH" id="ASTDATEPURCH" value="{{ $HDR->DOP }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Party Name (Supplier)</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTPARTYNAME" id="ASTPARTYNAME" value="{{ $HDR->PARTYNAME }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Asset Basic Cost</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTBCOST" id="ASTBCOST" value="{{ $HDR->BASICCOST }}" class="form-control amt"  onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTPINWARD" id="ASTPINWARD" value="{{ $HDR->FREIGHTINWARD }}" class="form-control amt"  onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Loading & unloading</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTLOADUNLOAD" id="ASTLOADUNLOAD" value="{{ $HDR->LOADUNLOAD }}" class="form-control amt"  onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Custom Duty</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTCUSTDUTY" id="ASTCUSTDUTY" value="{{ $HDR->CUSTOMDUTY }}" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTCFCHARGE" id="ASTCFCHARGE" value="{{ $HDR->CFCHARGES }}" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Taxes (GST)</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTTAXGST" id="ASTTAXGST" value="{{ $HDR->GST }}" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Other 1</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHER1" id="ASTOTHER1" value="{{ $HDR->OTH1 }}" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHER2" id="ASTOTHER2" value="{{ $HDR->OTH2 }}" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTQTY" id="ASTQTY" value="{{ $HDR->QTY }}" class="form-control" onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHERSPEF1" id="ASTOTHERSPEF1" value="{{ $HDR->OTH_SPEC1 }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Other Specification 2</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHERSPEF2" id="ASTOTHERSPEF2" value="{{ $HDR->OTH_SPEC2 }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Other Specification 3</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHERSPEF3" id="ASTOTHERSPEF3" value="{{ $HDR->OTH_SPEC3 }}" class="form-control"  maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTDATEOFMANF" id="ASTDATEOFMANF" value="{{ $HDR->DOM }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Expiry Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTEXPDATE" id="ASTEXPDATE" value="{{ $HDR->EXPIRYDATE }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>GRN No (if any) & Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTGRNNODATE" id="ASTGRNNODATE" value="{{ $HDR->GRNDATE }}" class="form-control"  maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTPURVOUCHNO" id="ASTPURVOUCHNO" value="{{ $HDR->PVOUCHERNO }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTDATE" id="ASTDATE" value="{{ $HDR->VDATE }}" class="form-control"  maxlength="100" > 
                 </div>                    
               </div>
             </div>
     </form>
...
$.ajax({
    url:'{{ route("mastermodify",[410,"Approve"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
...
$.ajax({
   url:'{{route("master",[410,"getemplCode"])}}',
   type:'POST',
   success:function(data) {
