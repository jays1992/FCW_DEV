...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->ASSETNOID}}" value="{{$val->ASSETNOID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
              <td>{{isset($val->ASSETNOCODE) && $val->ASSETNOCODE !=''?$val->ASSETNOCODE:''}}</td>
        ...
        <form id="masterForm2855Print" action="{{ route('mastergetlist',[$FormId,'printdata'])}}" method="POST" >
            @csrf
