...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Asset Location & Sub Location</a>
                </div><!--col-2-->
          ...
          <div class="inner-form">
                ...
                <div class="row">            
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="ASSTLCODE" id="ASSTLCODE" value="{{ $HDR->ALCODE }}" class="form-control"  maxlength="100" > 
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="ASSTLDES" id="ASSTLDES" value="{{ $HDR->DESCRIPTIONS }}" class="form-control"  maxlength="100" > 
                  </div>                                
                </div>
             ...
             <div class="row">
              <div id="Material" class="tab-pane fade in active">
                    <div class=" table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:300px;" >
                      ...
                      <tr>   
                        <th rowspan="2" width="3%">Sub Location Code</th> 
                        <th rowspan="2" width="3%">Sub Location Description</th>                      
                        ...
                        <tbody>
                          ...
                          <tr  class="participantRow">
                            <td hidden><input type="hidden" name="ASLID" id="ASLID" value="{{ $row->ASLID }}" /></td>
                              <td><input  class="form-control" type="text" name="SUBLCODE[]"   id ={{"SUBLCODE_".$key}}  value="{{ $row->ASLCODE }}" autocomplete="off"></td>
                              <td><input  class="form-control" type="text" name="SUBLDES[]"   id ={{"SUBLDES_".$key}}    value="{{ $row->DESCRIPTIONS }}" autocomplete="off"></td>
                              <td><select  name="INACTIVE[]" id ={{"INACTIVE_".$key}} class="form-control mandatory" tabindex="4">
                                <option value="" selected >Select</option>
                                <option {{isset($row->ACTIVE) && $row->ACTIVE == '0'?'selected="selected"':''}} value="0">Yes</option>
                                <option {{isset($row->ACTIVE) && $row->ACTIVE == '1'?'selected="selected"':''}} value="1">No</option>                              
                              </select>
                              <td>
                              <input  class="form-control" type="date" name="INACTIVEDATE[]" id ={{"INACTIVEDATE_".$key}}  value="{{ $row->ACTIVEDATE }}" autocomplete="off">
                              <td align="center" >
