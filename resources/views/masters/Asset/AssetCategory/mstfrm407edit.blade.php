          ...
          <div class="inner-form">
                ...
                <div class="row">            
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input  class="form-control" type="hidden" name="ASCATID" name="ASCATID"  value="{{ $objResponse->ASCATID }}" autocomplete="off">
                      ...
                      <tr>   
                        ...
                        <tbody>
                          ...
                          <tr  class="participantRow">
                              ...
                              <td><input  class="form-control" type="text" name="SUBLCODE[]"   id ={{"SUBLCODE_0"}}  value="{{ $HDRR->CATEGORY }}" autocomplete="off" style="width: 98%"></td>
                              <td><input  class="form-control" type="text" name="SUBLDES[]"   id ={{"SUBLDES_0"}}    value="{{ $HDRR->DESCRIPTIONS }}" autocomplete="off" style="width: 98%"></td>
                              <td><select  name="INACTIVE[]" id ={{"INACTIVE_0"}} class="form-control mandatory" tabindex="4">
                                <option value="" selected >Select</option>
                              ...
                              <td>
                              <input  class="form-control" type="date" name="INACTIVEDATE[]" id ={{"INACTIVEDATE_0"}}  value="{{ $HDRR->ACTIVEDATE }}" autocomplete="off">
                              <td align="center" >
