...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_priority" method="POST"  > 
          @CSRF
          {{isset($objResponse->PRIORITYID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->PRIORITYCODE}} </label>
                    <input type="hidden" name="PRIORITYID" id="PRIORITYID" value="{{ $objResponse->PRIORITYID }}" />
                    <input type="hidden" name="PRIORITYCODE" id="PRIORITYCODE" value="{{ $objResponse->PRIORITYCODE }}" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_priority" );
    ...
    function validateSingleElemnet(element_id){
      var validator =$("#frm_mst_priority" ).validate();
    ...
    window.fnSaveData = function (){
        ...
        var getDataForm = $("#frm_mst_priority");
        ...
        $.ajax({
            url:'{{route("mastermodify",[16,"update"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
                ...
                if(data.success) {                   
                    ...
                    $(".text-danger").hide();
                    $("#frm_mst_priority").trigger("reset");
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[16,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
