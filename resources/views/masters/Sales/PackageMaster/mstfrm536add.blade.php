  ...
  <div class="container-fluid filter"> 
    ...
    <div class="inner-form"> 
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text"   name="BUNAME" id="BUNAME"  class="form-control"  autocomplete="off"  onclick="getBusinessUnitMaster()" readonly/>
          <input type="hidden" name="BUID_REF" id="BUID_REF"      class="form-control"  autocomplete="off" />  
        </div>

        <div class="col-lg-1 pl"><p>Package Name*</p></div>
        <div class="col-lg-2 pl">
          <input type="text"   name="PACKAGE_NAME" id="PACKAGE_NAME"  class="form-control"  autocomplete="off" />
        </div>
      </div>
      ...
      <div class="row">	
        ...
        <div class="col-lg-11 pl">
          <textarea name="PACKAGE_DESC" id="PACKAGE_DESC" cols="118" rows="10" tabindex="3" ></textarea>
        </div>
      </div>  
      <br/>
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text"   name="HSN_DESC" id="HSN_DESC"  class="form-control"  autocomplete="off"  onclick="getSacMaster()" readonly/>
      ...
      <div class="row">
        ...
        <div class="tab-content">
          ...
          <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input type="text" name="popupMUOM[]" id="popupMUOM_0" onclick="getUomMaster(this.id)" class="form-control"  autocomplete="off"  readonly /></td>
