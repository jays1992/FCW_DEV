...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Message Template</a>
    </div>
...
<div class="container-fluid purchase-order-view">
  <div class="multiple table-responsive">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      <thead id="thead1">
        <tr>
          <th id="all-check" style="width:50px;"><input type="checkbox" class="js-selectall" data-target=".js-selectall1"  />Select / Deselct</th>
          <th>Template Code</th>
          <th>Template Name</th>
          <th>Is Active ?</th>
          <th>Created Date</th>
      ...
      <tbody> 
        ...
        @endphp
        <tr>
          <td><input type="checkbox" id="chkId{{$val->TEMPLATE_ID}}" value="{{$val->TEMPLATE_ID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
          <td>{{isset($val->TEMPLATE_CODE) && $val->TEMPLATE_CODE !=''?$val->TEMPLATE_CODE:''}}</td>
          <td>{{isset($val->TEMPLATE_NAME) && $val->TEMPLATE_NAME !=''?$val->TEMPLATE_NAME:''}}</td> 
