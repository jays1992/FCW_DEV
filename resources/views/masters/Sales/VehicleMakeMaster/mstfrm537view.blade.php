    ...
    <div class="container-fluid filter">
      <div class="inner-form">         
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="DOC_DATE" id="DOC_DATE" value="{{isset($HDR->VM_DATE)?$HDR->VM_DATE:''}}"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
          </div>

          <div class="col-lg-2 pl"><p>Vehicle Name*</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text"   name="VEHICLE_NAME" id="VEHICLE_NAME" value="{{isset($HDR->VM_NAME)?$HDR->VM_NAME:''}}"  class="form-control"  autocomplete="off"  readonly/>
          </div>
        </div>
