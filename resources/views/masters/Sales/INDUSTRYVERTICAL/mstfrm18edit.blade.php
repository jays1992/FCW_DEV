...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_industry_vertical" method="POST"  > 
          @CSRF
          {{isset($objResponse->INDSVID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->INDSVCODE}} </label>
                    <input type="hidden" name="INDSVID" id="INDSVID" value="{{ $objResponse->INDSVID }}" />
                    <input type="hidden" name="INDSVCODE" id="INDSVCODE" value="{{ $objResponse->INDSVCODE }}" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_industry_vertical" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[18,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[18,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
