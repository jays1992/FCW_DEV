                  ...
                  <div class="col-lg-2 pl">
                    @if(!empty($objDD))
                        @if($objDD->SYSTEM_GRSR == "1")
                            <input type="text" name="INDSVCODE" id="INDSVCODE" value="{{ $objDOCNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                        @endif
                        @if($objDD->MANUAL_SR == "1")
                            <input type="text" name="INDSVCODE" id="INDSVCODE" value="{{ old('INDSVCODE') }}" class="form-control mandatory" minlength="3" maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                        @endif
                    @endif  
                    {{-- <input type="text" name="INDSVCODE" id="INDSVCODE" value="{{ old('INDSVCODE') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" /> --}}
