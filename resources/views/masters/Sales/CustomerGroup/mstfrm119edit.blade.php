...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->CGID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->CGROUP}} </label>
                    <input type="hidden" name="CGID" id="CGID" value="{{ $objResponse->CGID }}" />
                    <input type="hidden" name="CGROUP" id="CGROUP" value="{{ $objResponse->CGROUP }}" autocomplete="off"  maxlength="30"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[119,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[119,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
