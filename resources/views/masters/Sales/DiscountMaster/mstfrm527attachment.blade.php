...
@section('content')
    ...
    <div class="container-fluid topnav">
            ...
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Discount Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='{{$objMstVoucherType[0]->VTID}}' />
			...
			<div class="col-lg-2 pl">
         <label> {{$objResponse->DISCODE}} </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objResponse->DISID}}" class="form-control" maxlength="50" >
			</div>
