  ...
  <div class="container-fluid purchase-order-view">    
    ...
    <div class="container-fluid filter">
      <div class="inner-form"> 
        ...
        <div class="row">
          <div class="col-lg-2 pl"><p>Discount Code*</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="DISCODE" id="DISCODE" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <select name="DIS_OPT" id="DIS_OPT" class="form-control" autocomplete="off" >
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="DIS_AMT" id="DIS_AMT" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" >                                                       
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="VALID_SALES_INVOICE_AMT" id="VALID_SALES_INVOICE_AMT" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" >                                                       
          </div>

          <div class="col-lg-2 pl"><p>Valid From*</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="VALID_FROM" id="VALID_FROM" class="form-control" autocomplete="off" value="{{date('Y-m-d')}}" >
          </div>

          <div class="col-lg-2 pl"><p>Valid To*</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="VALID_TO" id="VALID_TO" class="form-control" autocomplete="off" value="{{date('Y-m-d')}}" >
          </div>
        </div>
