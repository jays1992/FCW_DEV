...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_attachment" method="post" enctype="multipart/form-data" action='{{route("mastermodify",[526,"docuploads"])}}' > 
          @CSRF
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='{{$objMstVoucherType[0]->VTID}}' />
			...
			<div class="col-lg-2 pl">
         <label> {{$objMst->PLCODE}} </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objMst->PLID}}" class="form-control" maxlength="50" >
			</div>
