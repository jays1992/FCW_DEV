...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->COUPONTID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->COUPONTCODE}} </label>
                    <input type="hidden" name="COUPONTID" id="COUPONTID" value="{{ $objResponse->COUPONTID }}" />
                    <input type="hidden" name="COUPONTCODE" id="COUPONTCODE" value="{{ $objResponse->COUPONTCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="CTDESCRIPTIONS" id="CTDESCRIPTIONS" class="form-control mandatory" value="{{ old('CTDESCRIPTIONS',$objResponse->CTDESCRIPTIONS) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[23,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[23,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
