...
<div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="PROSPECT_ACTION">
          ...
          <span class="text-danger" id="ERROR_CUSTOMER_LEGAL_NAME"></span>
			...
			<div class="row">
			  ...
			  <div class="col-lg-2 pl">
				<input type="text" name="OLD_REFCODE" id="OLD_REFCODE" value="{{ $objMstCust->OLD_REFCODE }}"  class="form-control"  maxlength="20" tabindex="5" readonly >
			  </div>
			...
			<div class="row">
				...
				<div class="col-lg-4 pl">
					<input type="text" name="REGADDL1" id="REGADDL1" class="form-control mandatory" value="{{ $objMstCust->REGADDL1 }}"   maxlength="200" required tabindex="7" readonly >
          <span class="text-danger" id="ERROR_REGADDL1"></span>
        </div>
				
					<div class="col-lg-2 pl"><p>Registered Address Line 2</p></div>
				<div class="col-lg-4 pl">
					<input type="text" name="REGADDL2" id="REGADDL2" class="form-control" value="{{ $objMstCust->REGADDL2 }}"   maxlength="200" tabindex="8" readonly >
				</div>
		...
		<div class="row">
			...
			<div class="col-lg-1 pl">
				<input type="text" name="REGPIN" id="REGPIN" class="form-control " value="{{ $objMstCust->REGPIN }}"   maxlength="10" tabindex="12"  autocomplete="off" readonly >
			</div>
    ...
    <div class="row">
      ...
      <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" {{$objMstCust->DEACTIVATED == 1 ? "checked" : ""}}
       value='{{$objMstCust->DEACTIVATED == 1 ? 1 : 0}}' tabindex="13" onclick="return false;"  >
      </div>
      ...
      {{$objMstCust->DEACTIVATED == 1 ? "" : "disabled"}}
         tabindex="14" value="{{ (!is_null($objMstCust->DODEACTIVATED) && $objMstCust->DODEACTIVATED!='1900-01-01')? \Carbon\Carbon::parse($objMstCust->DODEACTIVATED)->format('Y-m-d') : ''   }}" onclick="return false;" />
      </div>
	...
	<div class="container-fluid">
			...
			<div class="tab-content">
				<div id="material" class="tab-pane fade in active">
					<div class="table-wrapper-scroll-x">
						<div class="row" style="margin-top:10px;">
							...
							<div class="col-lg-4">
								<input type="text" name="CORPADDL1" id="CORPADDL1" class="form-control " value="{{ $objMstCust->CORPADDL1 }}" tabindex="15"  maxlength="200" readonly  >
							</div>
							
							<div class="col-lg-2"><p>Corporate Address Line 2</p></div>
							<div class="col-lg-4">
								<input type="text" tabindex="16" name="CORPADDL2" id="CORPADDL2" class="form-control" value="{{ $objMstCust->CORPADDL2 }}"  maxlength="200" readonly >
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-2">	
								<input type="text" tabindex="17" name="CORPCTRYID_REF_POPUP" id="CORPCTRYID_REF_POPUP" class="form-control" value="@isset($objCorpCountry){{ $objCorpCountry->CTRYCODE }} - {{ $objCorpCountry->NAME }} @endisset" readonly   />
							...
							<div class="col-lg-2">		
								<input type="text" tabindex="18" name="CORPSTID_REF_POPUP" id="CORPSTID_REF_POPUP" value="@isset($objCorpState){{ $objCorpState->STCODE }} - {{ $objCorpState->NAME }}@endisset" class="form-control" readonly  />
							...
							<div class="col-lg-2">
								<input type="text" tabindex="19" name="CORPCITYID_REF_POPUP" id="CORPCITYID_REF_POPUP" value="@isset($objCorpCity){{ $objCorpCity->CITYCODE }} - {{ $objCorpCity->NAME }}@endisset" class="form-control" readonly  />
					...
					<div class="col-lg-2">
						<input type="text" tabindex="20" name="CORPPIN" id="CORPPIN" class="form-control " value="{{ $objMstCust->CORPPIN }}"  maxlength="10" readonly  >
					</div>
					
						<div class="col-lg-2"><p>Email ID</p></div>
						<div class="col-lg-2">
							<input type="text" tabindex="21" name="EMAILID" id="EMAILID" class="form-control " value="{{ $objMstCust->EMAILID }}"  maxlength="50" readonly  >
						</div>
						
						<div class="col-lg-2"><p>Website</p></div>
						<div class="col-lg-2">
							<input type="text" tabindex="22" name="WEBSITE" id="WEBSITE" class="form-control " value="{{ $objMstCust->WEBSITE }}"  maxlength="50" readonly  >
						</div>
					...
					<div class="col-lg-2 "><p>Phone No</p></div>
						<div class="col-lg-2">
							<input type="text" tabindex="23" name="PHNO" id="PHNO" class="form-control " value="{{ $objMstCust->PHNO }}" maxlength="15" readonly  >
						</div>
						
						<div class="col-lg-2"><p>Mobile No</p></div>
						<div class="col-lg-2">
							<input type="text" tabindex="24" name="MONO" id="MONO" class="form-control " value="{{ $objMstCust->MONO }}" maxlength="15" readonly  >
						</div>
						
						<div class="col-lg-2"><p>Contact Person</p></div>
						<div class="col-lg-2 ">
							<input type="text" tabindex="25" name="CPNAME" id="CPNAME"  class="form-control" value="{{ $objMstCust->CPNAME }}" maxlength="50" readonly  >
						</div>
					...
					<div class="col-lg-2 "><p>Skype</p></div>
						<div class="col-lg-2">
							<input type="text" tabindex="26" name="SKYPEID" id="SKYPEID" class="form-control" value="{{ $objMstCust->SKYPEID }}" maxlength="30" readonly  >
						</div>
					</div>
				...
				<div id="statutory" class="tab-pane fade"> 				
					 <div class="table-wrapper-scroll-x" style="margin-top:10px;">					
						...
						<div class="col-lg-2">
							<input type="text" tabindex="27" name="INDSID_REF_POPUP" id="INDSID_REF_POPUP" class="form-control" value="@isset($objIndType){{ $objIndType->INDSCODE }} - {{ $objIndType->DESCRIPTIONS }}@endisset" readonly  />
						...
						<div class="col-lg-2">
							<input type="text" tabindex="28" name="INDSVID_REF_POPUP" id="INDSVID_REF_POPUP" class="form-control"  value="@isset($objIndVer){{ $objIndVer->INDSVCODE }} - {{ $objIndVer->DESCRIPTIONS }}@endisset" readonly  />
						...
						<div class="col-lg-2">
							<input type="text" tabindex="29" name="DEALSIN" id="DEALSIN" class="form-control  " value="{{ $objMstCust->DEALSIN }}"   maxlength="50"  readonly >
						</div>
                ...
                <option value="{{ $Currency-> CRID }}"  @if($objMstCust->DEFCRID_REF==$Currency-> CRID) selected @endif) >
                  {{ $Currency->CRCODE }} - {{ $Currency->CRDESCRIPTION }}</option>
						...
						<div class="col-lg-2">
							<input type="text" tabindex="32" name="GSTIN" id="GSTIN" class="form-control  "  value="{{ $objMstCust->GSTIN }}"  maxlength="15"  >
						</div>
				...
				<div class="row">
					<div class="col-lg-2"><p>Credit Limit</p></div>
						<div class="col-lg-2">
							<input type="text" tabindex="33" name="CREDITLIMIT" id="CREDITLIMIT" class="form-control  " style="text-align: right" value="{{ $objMstCust->CREDITLIMIT }}" maxlength="18"  autocomplete="off">
						</div>
						
						<div class="col-lg-2"><p>CIN </p></div>
						<div class="col-lg-2">
							<input type="text" tabindex="34" name="CIN" id="CIN" class="form-control  "  maxlength="30" value="{{ $objMstCust->CIN }}" autocomplete="off" >
						</div>
						
						<div class="col-lg-1"><p>Credit Days </p></div>
						<div class="col-lg-1">
							<input type="text" tabindex="35" name="CREDITDAY" id="CREDITDAY" class="form-control" style="text-align: right" value="{{ $objMstCust->CREDITDAY }}" maxlength="4"  autocomplete="off">
						</div>
				...
				<div class="col-lg-2"><p>PAN No </p></div>
						<div class="col-lg-2">
							<input type="text" tabindex="36" name="PANNO" id="PANNO" class="form-control  " value="{{ $objMstCust->PANNO }}" maxlength="10"  autocomplete="off">
						</div>
            <div class="col-lg-2"><p>MSME No </p></div>
          <div class="col-lg-2">
            <input type="text" tabindex="37" name="MSME_NO" id="MSME_NO" value="{{ $objMstCust->MSMENO }}" class="form-control  "  maxlength="30"  autocomplete="off" style="text-transform:uppercase" readonly >
          </div>
          <div class="col-lg-1"><p>Factory No</p></div>
          <div class="col-lg-2">
            <input type="text" tabindex="38" name="FACTORY_ACT_NO" id="FACTORY_ACT_NO" value="{{ $objMstCust->FACTORY_NO }}" class="form-control  "  maxlength="30"  autocomplete="off" style="text-transform:uppercase" readonly >
          </div>
				</div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2">
            <input type="checkbox" tabindex="39" name="TDS_APPLICABLE" id="TDS_APPLICABLE" value="1" onChange="TdsApplicable()" {{isset($objMstCust->TDS_APPLICABLE) && $objMstCust->TDS_APPLICABLE ==1?'checked':''}} >
          </div>

          <div class="col-lg-2"><p>Exceptional for GST</p></div>
          <div class="col-lg-2">
            <input type="checkbox" tabindex="40" name="EXEGST" id="EXEGST" class="filter-none" value="1"   {{ isset($objMstCust->EXE_GST) && $objMstCust->EXE_GST =='1'?'checked':'' }} > 
          </div>
        ...
        <div class="row TDS_ACTION" style="display:none;">
          ...
          <div class="col-lg-2">
            <input type="text" tabindex="41" name="CERTIFICATE_NO" id="CERTIFICATE_NO" value="{{ $objMstCust->CERTIFICATE_NO }}" class="form-control"  maxlength="30"  autocomplete="off">
          </div>

          <div class="col-lg-2"><p>Expiry Date</p></div>
          <div class="col-lg-2">
            <input type="date" tabindex="42" name="EXPIRY_DT" id="EXPIRY_DT" value="{{ $objMstCust->EXPIRY_DT }}" class="form-control"   autocomplete="off">
          </div>
        </div>
        ...
        <div class="row TDS_ACTION" style="display:none;">
          ...
          <div hidden class="col-lg-2"><input type="checkbox" tabindex="45" name="EXE_GST" id="EXE_GST" class="filter-none"  value="1" {{ isset($objMstCust->EXE_GST) && $objMstCust->EXE_GST =='1'?'checked':'' }} > </div> 
            ...
            <tbody>
              @if(!empty($objPOC))
                ...
                <tr  class="participantRow">
                  <td><input  class="form-control w-100" tabindex="46" type="text" name="POC_NAME_{{ $key }}" id="POC_NAME_{{ $key }}" value="{{ $row->NAME }}" maxlength="100" ></td>
                  <td><input  class="form-control w-100" tabindex="47" type="text" name="POC_DESIG_{{ $key }}" id="POC_DESIG_{{ $key }}" value="{{ $row->DESIG }}" maxlength="50" ></td>
                  <td><input  class="form-control w-100" tabindex="48" type="text" name="POC_MONO_{{ $key }}" id="POC_MONO_{{ $key }}" value="{{ $row->MONO }}"  maxlength="15" ></td>
                  <td><input  class="form-control w-100" tabindex="49" type="text" name="POC_EMAIL_{{ $key }}" id="POC_EMAIL_{{ $key }}" value="{{ $row->EMAIL }}"  maxlength="50" ></td>
                  <td><input  class="form-control w-100" tabindex="50" type="text" name="POC_LLNO_{{ $key }}" id="POC_LLNO_{{ $key }}" value="{{ $row->LLNO }}"  maxlength="20" ></td>
                  <td><input  class="form-control w-100" tabindex="51" type="text" name="POC_AUTHLEVEL_{{ $key }}" id="POC_AUTHLEVEL_{{ $key }}" value="{{ $row->AUTHLEVEL }}"  maxlength="30" ></td>
                  <td style="text-align:center;" ><input type="date" tabindex="52" placeholder="dd/mm/yyyy"  name="POC_DOB_{{ $key }}" id="POC_DOB_{{ $key }}" value="{{ (!is_null($row->DOB) && $row->DOB!='1900-01-01')? $row->DOB : '' }}" class="form-control" ></td>
                  <td align="center" >
            ...
            @if(!empty($objBANK))
             @foreach($objBANK as $key => $row)
              <tr class="participantRow">
                ...
                <td>
                  <input  class="form-control w-100" type="text" tabindex="64" name="BANK_ACNO_{{$key}}" id="BANK_ACNO_{{$key}}" value="{{ $row->ACNO }}" maxlength="30" ></td>
                <td align="center" >
                  <a class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
                  <button class="btn remove" title="Delete" data-toggle="tooltip" type="button" @if($loop->iteration-1==0) disabled @endif><i class="fa fa-trash" @if($loop->iteration-1==0) disabled @endif ></i></button>
                </td>
            ...
            @if(!empty($objLOC))
              ...
              <tr  class="participantRow">
                <td><input  class="form-control w-100" type="text" tabindex="59" name="LOC_NAME_{{ $key }}" id="LOC_NAME_{{ $key }}" value="{{ $row->NAME }}"  maxlength="50" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="60" name="LOC_CADD_{{ $key }}" id="LOC_CADD_{{ $key }}" value="{{ $row->CADD }}" maxlength="200" ></td>

                <td><input  class="form-control w-100" type="text" tabindex="61" name="LOC_CTRYID_REF_{{ $key }}" id="TXTLOC_CTRYID_REF_POPUP_{{ $key }}" value="{{ $row->COU_CTRYCODE }} - {{ $row->COU_NAME }}" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" name="HDNLOC_CTRYID_REF_{{ $key }}" id="HDNLOC_CTRYID_REF_POPUP_{{ $key }}" value="{{ $row->COU_CTRYID }}" maxlength="100" ></td>

                <td><input  class="form-control w-100" type="text" tabindex="62" name="LOC_STID_REF_{{ $key }}" id="TXTLOC_STID_REF_POPUP_{{ $key }}" value="{{ $row->STA_STCODE }} - {{ $row->STA_NAME }}" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" name="HDNLOC_STID_REF_{{ $key }}" id="HDNLOC_STID_REF_POPUP_{{ $key }}" value="{{ $row->STA_STID }}" maxlength="100" readonly></td>

                <td><input  class="form-control w-100" type="text" tabindex="63" name="LOC_CITYID_REF_{{ $key }}" id="TXTLOC_CITYID_REF_POPUP_{{ $key }}" value="{{ $row->CIT_CITYCODE }} - {{ $row->CIT_NAME }}" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" name="HDNLOC_CITYID_REF_{{ $key }}" value="{{ $row->CIT_CITYID }}" id="HDNLOC_CITYID_REF_POPUP_{{ $key }}" maxlength="100" readonly></td>


                <td><input  class="form-control w-100" type="text" tabindex="64" name="LOC_PIN_{{ $key }}" id="LOC_PIN_{{ $key }}" maxlength="20" value="{{ $row->PIN }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="65" name="LOC_GSTIN_{{ $key }}" id="LOC_GSTIN_{{$key}}" maxlength="30" value="{{ $row->GSTIN }}"  ></td>
                <td><input  class="form-control w-100" type="text" tabindex="66" name="LOC_CPNAME_{{ $key }}" id="LOC_CPNAME_{{$key}}" maxlength="30" value="{{ $row->CPNAME }}"  ></td>
                <td><input  class="form-control w-100" type="text" tabindex="67" name="LOC_CPDESIGNATION_{{$key}}" id="LOC_CPDESIGNATION_{{$key}}" maxlength="20" value="{{ $row->CPDESIGNATION }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="68" name="LOC_EMAIL_{{$key}}" id="LOC_EMAIL_{{$key}}" maxlength="50" value="{{ $row->EMAIL }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="69" name="LOC_MONO_{{$key}}" id="LOC_MONO_{{$key}}" maxlength="15" value="{{ $row->MONO }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="70" name="LOC_SPINSTRACTION_{{$key}}" id="LOC_SPINSTRACTION_{{$key}}" maxlength="50" value="{{ $row->SPINSTRACTION }}"  ></td>
                
                <td style="text-align:center;" ><input type="checkbox" tabindex="71" name="LOC_BILLTO_{{$key}}" id="LOC_BILLTO_{{$key}}" class="filter-none"  value="1" {{ ($row->BILLTO == 1 || $row->BILLTO=='on')?'checked':'' }}></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="72" name="LOC_DEFAULT_BILLTO_{{$key}}" id="LOC_DEFAULT_BILLTO_{{$key}}" class="filter-none"  value="1" {{ ($row->DEFAULT_BILLTO == 1 || $row->DEFAULT_BILLTO=='on')?'checked':'' }} ></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="73" name="LOC_SHIPTO_{{$key}}" id="LOC_SHIPTO_{{$key}}" class="filter-none"  value="1" {{ ($row->SHIPTO == 1 || $row->SHIPTO=='on')?'checked':'' }} ></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="74" name="LOC_DEFAULT_SHIPTO_{{$key}}" id="LOC_DEFAULT_SHIPTO_{{$key}}" class="filter-none"  value="1" {{ ($row->DEFAULT_SHIPTO == 1 || $row->DEFAULT_SHIPTO=='on')?'checked':'' }} ></td>
                
                <td align="center" >
                  <a class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
                  <button class="btn remove location-delete" title="Delete" data-toggle="tooltip" type="button"  @if($loop->iteration-1==0) disabled @endif><i class="fa fa-trash"  @if($loop->iteration-1==0) disabled @endif ></i></button>
                </td>
              </tr>
              @endforeach
        ...
        <div id="ALPSSpecific" class="tab-pane fade">
                    ...
                    <div class="inner-form" style="margin-top:10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_CUSTOMER_CODE" tabindex="94" id="SAP_CUSTOMER_CODE" value="{{ $objMstCust->SAP_CUSTOMER_CODE }}"  class="form-control" style="text-transform:uppercase">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD2) && $TabSetting->FIELD2 !=''?$TabSetting->FIELD2:'Add. Customer Name'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUSTOMER_NAME"  tabindex="95" id="SAP_CUSTOMER_NAME" value="{{ $objMstCust->SAP_CUSTOMER_NAME }}" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD3) && $TabSetting->FIELD3 !=''?$TabSetting->FIELD3:'Add. Account Group'}}</p></div>
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_ACCOUNT_GROUP" tabindex="96" id="SAP_ACCOUNT_GROUP" value="{{ $objMstCust->SAP_ACCOUNT_GROUP }}" class="form-control" style="text-transform:uppercase">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD4) && $TabSetting->FIELD4 !=''?$TabSetting->FIELD4:'Add. Customer Group Code'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUSTOMER_GROUP_CODE" tabindex="97" id="SAP_CUSTOMER_GROUP_CODE" value="{{ $objMstCust->SAP_CUSTOMER_GCODE }}" class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD5) && $TabSetting->FIELD5 !=''?$TabSetting->FIELD5:'Add. Customer Group Name'}}</p></div>
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_CUSTOMER_GROUP_NAME" tabindex="98" id="SAP_CUSTOMER_GROUP_NAME" value="{{ $objMstCust->SAP_CUSTOMER_GNAME }}" class="form-control" >
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD6) && $TabSetting->FIELD6 !=''?$TabSetting->FIELD6:'Add. Global Group Account Code'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_GLOBAL_GROUP_CODE" tabindex="99" id="SAP_GLOBAL_GROUP_CODE" value="{{ $objMstCust->SAP_GLOBAL_GACODE }}"class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD7) && $TabSetting->FIELD7 !=''?$TabSetting->FIELD7:'Add. Global Group Account Name'}}</p></div>
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_GLOBAL_GRUOUP_NAME" tabindex="100" id="SAP_GLOBAL_GRUOUP_NAME" value="{{ $objMstCust->SAP_GLOBAL_GANAME }}" class="form-control">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD8) && $TabSetting->FIELD8 !=''?$TabSetting->FIELD8:'Add. Our Code in Customer book'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="OUR_CODE" id="OUR_CODE" tabindex="101" value="{{ $objMstCust->OUR_CODE_INCBOOK }}" class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
			...
			<div id="udf" class="tab-pane fade">
              <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
                <table id="udffietable" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                  ...
                  <tr  class="participantRow">
                    <td>
                      <input name={{"udffie_popup_".$udfkey}} id={{"txtudffie_popup_".$udfkey}} value="{{$udfrow->LABEL}}" class="form-control @if ($udfrow->ISMANDATORY==1) mandatory @endif" autocomplete="off" maxlength="100" tabindex="102" disabled/>
                    </td>

                    <td hidden>
                      <input type="text" name='{{"udffie_".$udfkey}}' id='{{"hdnudffie_popup_".$udfkey}}' value="{{$udfrow->UDFCMID}}" class="form-control" maxlength="100" />
                    </td>

                    <td hidden>
                      <input type="text" tabindex="103" name={{"udffieismandatory_".$udfkey}} id={{"udffieismandatory_".$udfkey}} class="form-control" maxlength="100" value="{{$udfrow->ISMANDATORY}}" />
                    </td>
...
//-----------------------
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("master",[5,"saveamendment"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
...
$(document).ready(function(){
  ...
  var result  = $.ajax({
                url:'{{ route("master",[5,"check_transaction"])}}',
                type:'POST',
                async: false,
                dataType: 'json',
                data: {CCODE:CCODE},
