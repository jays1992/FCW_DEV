...
<div class="container-fluid topnav">
	<div class="row">
      ...
      <button id="btnSaveItem"   class="btn topnavbt" tabindex="123"><i class="fa fa-save"></i> Save</button>
...
<div class="container-fluid filter">
    ...
    {{isset($objMstCust->CID) ? method_field('PUT') : '' }}
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"><p>Prospect</p></div>
				<div class="col-lg-2 pl">
          <input type="checkbox"   name="PROSPECT"  id="PROSPECT" {{$objMstCust->PROSPECT == 1 ? "checked" : ""}} value='{{$objMstCust->PROSPECT == 1 ? 1 : 0}}' onChange="showprospect()"  >
        </div>

        <div class="PROSPECT_ACTION">
          <div class="col-lg-2 pl">
          <input type="text" name="PROSPECT_NAME" id="PROSPECT_NAME" class="form-control" value="{{isset($objMstCust->PCODE) && $objMstCust->PCODE !=''?$objMstCust->PCODE:''}} {{isset($objMstCust->PSCTNAME) && $objMstCust->PSCTNAME !=''?'-'.$objMstCust->PSCTNAME:''}}"  onclick="getProspect()" readonly/>
          <input type="hidden" name="PROSPID_REF" id="PROSPID_REF" value="{{isset($objMstCust->PROSPECTID_REF) && $objMstCust->PROSPECTID_REF !=''?$objMstCust->PROSPECTID_REF:''}}" class="form-control" readonly>
        </div>
      </div>
			...
			<div class="row">
				...
				<div class="col-lg-2 pl">
					<input type="text" name="CCODE" id="CCODE" class="form-control mandatory" value="{{ $objMstCust->CCODE }}"  maxlength="20" readonly required tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
          <input type="hidden" name="CID_REF" id="CID_REF" value="{{isset($objMstCust->CID) && $objMstCust->CID !=''?$objMstCust->CID:''}}" class="form-control" readonly>
					<span class="text-danger" id="ERROR_CCODE"></span>
				</div>
			  
				<div class="col-lg-2 pl"><p>Name*</p></div>
				<div class="col-lg-2 pl">
				  <input type="text" name="NAME" id="NAME" class="form-control mandatory" value="{{ $objMstCust->NAME }}" maxlength="100" required tabindex="2" autocomplete="off">
          <span class="text-danger" id="ERROR_NAME"></span>
        </div>
				
				<div class="col-lg-2 pl"><p>Customer Legal Name*</p></div>
				<div class="col-lg-2 pl">
				  <input type="text" name="CUSTOMER_LEGAL_NAME" id="CUSTOMER_LEGAL_NAME" class="form-control mandatory" value="{{ $objMstCust->CUSTOMER_LEGAL_NAME }}"    maxlength="100" tabindex="3" autocomplete="off" required>
          <span class="text-danger" id="ERROR_CUSTOMER_LEGAL_NAME"></span>
			...
			<div class="row">
				...
				<div class="col-lg-2 pl">
					<input type="text" name="CGID_REF_POPUP" id="CGID_REF_POPUP"  class="form-control mandatory" value="{{ $objCusGro->CGROUP }} - {{ $objCusGro->DESCRIPTIONS }}" required readonly tabindex="4" />
					<input type="hidden" name="CGID_REF" id="CGID_REF" value="{{ $objCusGro->CGID }}"/>
					<span class="text-danger" id="ERROR_CGID_REF"></span>
				</div>
			  
			  <div class="col-lg-2 pl"><p>OLD Ref Code</p></div>
			  <div class="col-lg-2 pl">
				<input type="text" name="OLD_REFCODE" id="OLD_REFCODE" value="{{ $objMstCust->OLD_REFCODE }}"  class="form-control"  maxlength="20" tabindex="5" >
			  </div>
			  
			  <div class="col-lg-2 pl"><p>GL*</p></div>
			  <div class="col-lg-2 pl">
				<input type="text" name="GLID_REF_POPUP" id="GLID_REF_POPUP" class="form-control mandatory" value="{{ $objOldGlList->GLCODE }} - {{ $objOldGlList->GLNAME }}" required readonly tabindex="6" />
                <input type="hidden" name="GLID_REF" id="GLID_REF"  value="{{ $objOldGlList->GLID }}"/>
			...
			<div class="row">
				...
				<div class="col-lg-4 pl">
					<input type="text" name="REGADDL1" id="REGADDL1" class="form-control mandatory" value="{{ $objMstCust->REGADDL1 }}"   maxlength="200" required tabindex="7" >
          <span class="text-danger" id="ERROR_REGADDL1"></span>
        </div>
				
					<div class="col-lg-2 pl"><p>Registered Address Line 2</p></div>
				<div class="col-lg-4 pl">
					<input type="text" name="REGADDL2" id="REGADDL2" class="form-control" value="{{ $objMstCust->REGADDL2 }}"   maxlength="200" tabindex="8" >
				</div>
		...
		<div class="row">
			...
			<div class="col-lg-2 pl">
				<input type="text" name="REGCTRYID_REF_POPUP" id="REGCTRYID_REF_POPUP" class="form-control mandatory" value="{{ $objRegCountry->CTRYCODE }} - {{ $objRegCountry->NAME }}" required readonly tabindex="9" />
                <input type="hidden" name="REGCTRYID_REF" id="REGCTRYID_REF" value="{{ $objRegCountry->CTRYID }}" />
			...
			<div class="col-lg-2 pl">
                ...
                <input type="hidden" name="REGSTID_REF" id="REGSTID_REF" value="{{ $objRegState->STID }}"/>
			...
			<div class="col-lg-2 pl">
                ...
                <input type="hidden" name="REGCITYID_REF" id="REGCITYID_REF" value="{{ $objRegCity->CITYID }}" />
			...
			<div class="col-lg-1 pl">
				<input type="text" name="REGPIN" id="REGPIN" class="form-control " value="{{ $objMstCust->REGPIN }}"   maxlength="10" tabindex="12"  autocomplete="off" >
			</div>
    ...
    <div class="row">
      ...
      <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" {{$objMstCust->DEACTIVATED == 1 ? "checked" : ""}}
       value='{{$objMstCust->DEACTIVATED == 1 ? 1 : 0}}' tabindex="13"  >
      </div>
      
      <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
      <div class="col-lg-2 pl">
      <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" placeholder="dd/mm/yyyy" 
      {{$objMstCust->DEACTIVATED == 1 ? "" : "disabled"}}
         tabindex="14" value="{{ (!is_null($objMstCust->DODEACTIVATED) && $objMstCust->DODEACTIVATED!='1900-01-01')? \Carbon\Carbon::parse($objMstCust->DODEACTIVATED)->format('Y-m-d') : ''   }}" />
      </div>
	...
	<div class="container-fluid">
			...
			<div class="tab-content">
				<div id="material" class="tab-pane fade in active">
					<div class="table-wrapper-scroll-x">
						<div class="row" style="margin-top:10px;">
							...
							<div class="col-lg-4">
								<input type="text" name="CORPADDL1" id="CORPADDL1" class="form-control " tabindex="15" value="{{ $objMstCust->CORPADDL1 }}"  maxlength="200"  >
							</div>
							
							<div class="col-lg-2"><p>Corporate Address Line 2</p></div>
							<div class="col-lg-4">
								<input type="text" name="CORPADDL2" id="CORPADDL2" class="form-control" tabindex="16" value="{{ $objMstCust->CORPADDL2 }}"  maxlength="200" >
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-2">	
								<input type="text" name="CORPCTRYID_REF_POPUP" id="CORPCTRYID_REF_POPUP" tabindex="17" class="form-control" value="@isset($objCorpCountry){{ $objCorpCountry->CTRYCODE }} - {{ $objCorpCountry->NAME }} @endisset" readonly  />
							...
							<div class="col-lg-2">		
								<input type="text" name="CORPSTID_REF_POPUP" id="CORPSTID_REF_POPUP" tabindex="18" value="@isset($objCorpState){{ $objCorpState->STCODE }} - {{ $objCorpState->NAME }}@endisset" class="form-control" readonly  />
							...
							<div class="col-lg-2">
								<input type="text" name="CORPCITYID_REF_POPUP" id="CORPCITYID_REF_POPUP" tabindex="19" value="@isset($objCorpCity){{ $objCorpCity->CITYCODE }} - {{ $objCorpCity->NAME }}@endisset" class="form-control" readonly  />
					...
					<div class="col-lg-2">
						<input type="text" name="CORPPIN" id="CORPPIN" class="form-control " tabindex="20" value="{{ $objMstCust->CORPPIN }}"  maxlength="10"  >
					</div>
					
						<div class="col-lg-2"><p>Email ID</p></div>
						<div class="col-lg-2">
							<input type="text" name="EMAILID" id="EMAILID" class="form-control " tabindex="21" value="{{ $objMstCust->EMAILID }}"  maxlength="50"  >
						</div>
						
						<div class="col-lg-2"><p>Website</p></div>
						<div class="col-lg-2">
							<input type="text" name="WEBSITE" id="WEBSITE" class="form-control " tabindex="22" value="{{ $objMstCust->WEBSITE }}"  maxlength="50"  >
						</div>
					...
					<div class="col-lg-2 "><p>Phone No</p></div>
						<div class="col-lg-2">
							<input type="text" name="PHNO" id="PHNO" class="form-control " tabindex="23" value="{{ $objMstCust->PHNO }}" maxlength="15"  >
						</div>
						
						<div class="col-lg-2"><p>Mobile No</p></div>
						<div class="col-lg-2">
							<input type="text" name="MONO" id="MONO" class="form-control " tabindex="24" value="{{ $objMstCust->MONO }}" maxlength="15"  >
						</div>
						
						<div class="col-lg-2"><p>Contact Person</p></div>
						<div class="col-lg-2 ">
							<input type="text" name="CPNAME" id="CPNAME"  class="form-control" tabindex="25" value="{{ $objMstCust->CPNAME }}" maxlength="50"  >
						</div>
					...
					<div class="col-lg-2 "><p>Skype</p></div>
						<div class="col-lg-2">
							<input type="text" name="SKYPEID" id="SKYPEID" class="form-control" tabindex="26" value="{{ $objMstCust->SKYPEID }}" maxlength="30"  >
						</div>
					</div>
				...
				<div id="statutory" class="tab-pane fade"> 
					 ...
					 <div class="table-wrapper-scroll-x" style="margin-top:10px;">
						...
						<div class="col-lg-2">
							<input type="text" name="INDSID_REF_POPUP" id="INDSID_REF_POPUP" tabindex="27" class="form-control" value="@isset($objIndType){{ $objIndType->INDSCODE }} - {{ $objIndType->DESCRIPTIONS }}@endisset" readonly  />
							<input type="hidden" name="INDSID_REF" id="INDSID_REF" value="@isset($objIndType){{ $objIndType->INDSID }}@endisset" />
							<span class="text-danger" id="ERROR_INDSID_REF"></span>
						</div>
						
						<div class="col-lg-2"><p>Industry Vertical</p></div>
						<div class="col-lg-2">
							<input type="text" name="INDSVID_REF_POPUP" id="INDSVID_REF_POPUP" tabindex="28" class="form-control"  value="@isset($objIndVer){{ $objIndVer->INDSVCODE }} - {{ $objIndVer->DESCRIPTIONS }}@endisset" readonly  />
							<input type="hidden" name="INDSVID_REF" id="INDSVID_REF" value="@isset($objIndVer){{ $objIndVer->INDSVID }}@endisset"  />
							<span class="text-danger" id="ERROR_INDSVID_REF"></span>
						</div>
						
						<div class="col-lg-1"><p>Deals In</p></div>
						<div class="col-lg-2">
							<input type="text" name="DEALSIN" id="DEALSIN" class="form-control  " tabindex="29" value="{{ $objMstCust->DEALSIN }}"   maxlength="50"  >
						</div>
					...
					<div class="row">
						...
						<div class="col-lg-2">
							<select name="GSTTYPE" id="GSTTYPE" class="form-control mandatory" tabindex="30" required >
						...
						<div class="col-lg-2">
							<select name="DEFCRID_REF" id="DEFCRID_REF"  class="form-control mandatory" tabindex="31" required  >
								<option value="" selected >Select</option>
                ...
                <option value="{{ $Currency-> CRID }}"  @if($objMstCust->DEFCRID_REF==$Currency-> CRID) selected @endif) >
                  {{ $Currency->CRCODE }} - {{ $Currency->CRDESCRIPTION }}</option>
						...
						<div class="col-lg-2">
							<input type="text" name="GSTIN" id="GSTIN" class="form-control  " tabindex="32"  value="{{ $objMstCust->GSTIN }}"  maxlength="15"  >
						</div>
				...
				<div class="row">
					<div class="col-lg-2"><p>Credit Limit</p></div>
						<div class="col-lg-2">
							<input type="text" name="CREDITLIMIT" id="CREDITLIMIT" class="form-control  " tabindex="33" style="text-align: right" value="{{ $objMstCust->CREDITLIMIT }}" maxlength="18"  autocomplete="off">
						</div>
						
						<div class="col-lg-2"><p>CIN </p></div>
						<div class="col-lg-2">
							<input type="text" name="CIN" id="CIN" class="form-control  "  maxlength="30"  tabindex="34" value="{{ $objMstCust->CIN }}" autocomplete="off">
						</div>
						
						<div class="col-lg-1"><p>Credit Days </p></div>
						<div class="col-lg-1">
							<input type="text" name="CREDITDAY" id="CREDITDAY" class="form-control" tabindex="35" style="text-align: right" value="{{ $objMstCust->CREDITDAY }}" maxlength="4"  autocomplete="off">
						</div>
				...
				<div class="col-lg-2"><p>PAN No </p></div>
						<div class="col-lg-2">
							<input type="text" name="PANNO" id="PANNO" class="form-control  " tabindex="36" value="{{ $objMstCust->PANNO }}" maxlength="10"  autocomplete="off">
						</div>
            <div class="col-lg-2"><p>MSME No </p></div>
          <div class="col-lg-2">
            <input type="text" name="MSME_NO" id="MSME_NO" value="{{ $objMstCust->MSMENO }}" tabindex="37" class="form-control  "  maxlength="30"  autocomplete="off" style="text-transform:uppercase">
          </div>
          <div class="col-lg-1"><p>Factory No</p></div>
          <div class="col-lg-2">
            <input type="text" name="FACTORY_ACT_NO" id="FACTORY_ACT_NO" value="{{ $objMstCust->FACTORY_NO }}" tabindex="38" class="form-control  "  maxlength="30"  autocomplete="off" style="text-transform:uppercase">
          </div>
				</div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2">
            <input type="checkbox" name="TDS_APPLICABLE" id="TDS_APPLICABLE" value="1" tabindex="39" onChange="TdsApplicable()" {{isset($objMstCust->TDS_APPLICABLE) && $objMstCust->TDS_APPLICABLE ==1?'checked':''}} >
          </div>

          <div class="col-lg-2"><p>Exceptional for GST</p></div>
          <div class="col-lg-2"> 
            <input type="checkbox" name="EXEGST" id="EXEGST" class="filter-none" value="1"  tabindex="40"  {{ isset($objMstCust->EXE_GST) && $objMstCust->EXE_GST =='1'?'checked':'' }} > 
          </div>
        ...
        <div class="row TDS_ACTION" style="display:none;">
          ...
          <div class="col-lg-2">
            <input type="text" name="CERTIFICATE_NO" id="CERTIFICATE_NO" tabindex="41" value="{{ $objMstCust->CERTIFICATE_NO }}" class="form-control"  maxlength="30"  autocomplete="off">
          </div>

          <div class="col-lg-2"><p>Expiry Date</p></div>
          <div class="col-lg-2">
            <input type="date" name="EXPIRY_DT" id="EXPIRY_DT" tabindex="42" value="{{ $objMstCust->EXPIRY_DT }}" class="form-control"   autocomplete="off">
          </div>
        </div>
        ...
        <div class="row TDS_ACTION" style="display:none;">
          ...
          <div class="col-lg-2">
            <select  name="ASSESSEEID_REF" id="ASSESSEEID_REF" tabindex="43" class="form-control mandatory" autocomplete="off" onChange="getTdsCode(this.value)" >
            <option value="">Select</option>
          ...
          <div class="col-lg-2">
            <input type="text" name="HOLDINGID_REF_POPUP" id="HOLDINGID_REF_POPUP" tabindex="44" class="form-control mandatory" readonly  />
          ...
          <div class="col-lg-2 "><p>Exceptional for GST</p></div>
          <div class="col-lg-2"><input type="checkbox" name="EXE_GST" id="EXE_GST" tabindex="45" class="filter-none"  value="1" {{ isset($objMstCust->EXE_GST) && $objMstCust->EXE_GST =='1'?'checked':'' }} > </div> 
            ...
            <tbody>
              @if(!empty($objPOC))
                ...
                <tr  class="participantRow">
                  <td><input  class="form-control w-100" type="text" name="POC_NAME_{{ $key }}" tabindex="46" id="POC_NAME_{{ $key }}" value="{{ $row->NAME }}" maxlength="100" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_DESIG_{{ $key }}" tabindex="47" id="POC_DESIG_{{ $key }}" value="{{ $row->DESIG }}" maxlength="50" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_MONO_{{ $key }}" tabindex="48" id="POC_MONO_{{ $key }}" value="{{ $row->MONO }}"  maxlength="15" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_EMAIL_{{ $key }}" tabindex="49" id="POC_EMAIL_{{ $key }}" value="{{ $row->EMAIL }}"  maxlength="50" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_LLNO_{{ $key }}" tabindex="50" id="POC_LLNO_{{ $key }}" value="{{ $row->LLNO }}"  maxlength="20" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_AUTHLEVEL_{{ $key }}" tabindex="51" id="POC_AUTHLEVEL_{{ $key }}" value="{{ $row->AUTHLEVEL }}"  maxlength="30" ></td>
                  <td style="text-align:center;" ><input type="date" placeholder="dd/mm/yyyy" tabindex="52"  name="POC_DOB_{{ $key }}" id="POC_DOB_{{ $key }}" value="{{ (!is_null($row->DOB) && $row->DOB!='1900-01-01')? $row->DOB : '' }}" class="form-control" ></td>
                  <td align="center" >
            ...
            @if(!empty($objBANK))
             @foreach($objBANK as $key => $row)
              <tr class="participantRow">
                <td><input  class="form-control w-100" type="text" tabindex="60" name="BANK_NAME_{{$key}}" id="BANK_NAME_{{$key}}" maxlength="100" value="{{ $row->NAME }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="61" name="BANK_IFSC_{{$key}}" id="BANK_IFSC_{{$key}}" value="{{ $row->IFSC }}" maxlength="20" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="62" name="BANK_BRANCH_{{$key}}" id="BANK_BRANCH_{{$key}}" value="{{ $row->BRANCH }}" maxlength="100" ></td>
                <td>
                  <select name="BANK_ACTYPE_{{$key}}" id="BANK_ACTYPE_{{$key}}" tabindex="63" class="form-control"  >
                    <option value="" >Select</option>
                ...
                <td>
                  <input  class="form-control w-100" type="text" name="BANK_ACNO_{{$key}}" tabindex="64" id="BANK_ACNO_{{$key}}" value="{{ $row->ACNO }}" maxlength="30" ></td>
                <td align="center" >
                  <a class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
                  <button class="btn remove" title="Delete" data-toggle="tooltip" type="button" @if($loop->iteration-1==0) disabled @endif><i class="fa fa-trash" @if($loop->iteration-1==0) disabled @endif ></i></button>
                </td>
            ...
            @else
              <tr class="participantRow">
                ...
                <td><input  class="form-control w-100" type="text" name="BANK_ACNO_0" tabindex="68" id="BANK_ACNO_0" maxlength="30" ></td>
                <td align="center" >
                  <a class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
            ...
            @if(!empty($objLOC))
              ...
              <tr  class="participantRow">
                <td><input  class="form-control w-100" type="text" tabindex="69" name="LOC_NAME_{{ $key }}" id="LOC_NAME_{{ $key }}" value="{{ $row->NAME }}"  maxlength="50" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="70" name="LOC_CADD_{{ $key }}" id="LOC_CADD_{{ $key }}" value="{{ $row->CADD }}" maxlength="200" ></td>

                <td><input  class="form-control w-100" type="text" tabindex="71" name="LOC_CTRYID_REF_{{ $key }}" id="TXTLOC_CTRYID_REF_POPUP_{{ $key }}" value="{{ $row->COU_CTRYCODE }} - {{ $row->COU_NAME }}" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" tabindex="72" name="HDNLOC_CTRYID_REF_{{ $key }}" id="HDNLOC_CTRYID_REF_POPUP_{{ $key }}" value="{{ $row->COU_CTRYID }}" maxlength="100" ></td>

                <td><input  class="form-control w-100" type="text" tabindex="73" name="LOC_STID_REF_{{ $key }}" id="TXTLOC_STID_REF_POPUP_{{ $key }}" value="{{ $row->STA_STCODE }} - {{ $row->STA_NAME }}" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" tabindex="74" name="HDNLOC_STID_REF_{{ $key }}" id="HDNLOC_STID_REF_POPUP_{{ $key }}" value="{{ $row->STA_STID }}" maxlength="100" readonly></td>

                <td><input  class="form-control w-100" type="text" tabindex="75" name="LOC_CITYID_REF_{{ $key }}" id="TXTLOC_CITYID_REF_POPUP_{{ $key }}" value="{{ $row->CIT_CITYCODE }} - {{ $row->CIT_NAME }}" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" tabindex="76" name="HDNLOC_CITYID_REF_{{ $key }}" value="{{ $row->CIT_CITYID }}" id="HDNLOC_CITYID_REF_POPUP_{{ $key }}" maxlength="100" readonly></td>


                <td><input  class="form-control w-100" type="text" tabindex="77" name="LOC_PIN_{{ $key }}" id="LOC_PIN_{{ $key }}" maxlength="20" value="{{ $row->PIN }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="78" name="LOC_GSTIN_{{ $key }}" id="LOC_GSTIN_{{$key}}" maxlength="30" value="{{ $row->GSTIN }}"  ></td>
                <td><input  class="form-control w-100" type="text" tabindex="79" name="LOC_CPNAME_{{ $key }}" id="LOC_CPNAME_{{$key}}" maxlength="30" value="{{ $row->CPNAME }}"  ></td>
                <td><input  class="form-control w-100" type="text" tabindex="80" name="LOC_CPDESIGNATION_{{$key}}" id="LOC_CPDESIGNATION_{{$key}}" maxlength="20" value="{{ $row->CPDESIGNATION }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="81" name="LOC_EMAIL_{{$key}}" id="LOC_EMAIL_{{$key}}" maxlength="50" value="{{ $row->EMAIL }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="82" name="LOC_MONO_{{$key}}" id="LOC_MONO_{{$key}}" maxlength="15" value="{{ $row->MONO }}" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="83" name="LOC_SPINSTRACTION_{{$key}}" id="LOC_SPINSTRACTION_{{$key}}" maxlength="50" value="{{ $row->SPINSTRACTION }}"  ></td>
                
                <td style="text-align:center;" ><input type="checkbox" name="LOC_BILLTO_{{$key}}" tabindex="84" id="LOC_BILLTO_{{$key}}" class="filter-none"  value="1" {{ ($row->BILLTO == 1 || $row->BILLTO=='on')?'checked':'' }}></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="85" name="LOC_DEFAULT_BILLTO_{{$key}}" id="LOC_DEFAULT_BILLTO_{{$key}}" class="filter-none"  value="1" {{ ($row->DEFAULT_BILLTO == 1 || $row->DEFAULT_BILLTO=='on')?'checked':'' }} ></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="86" name="LOC_SHIPTO_{{$key}}" id="LOC_SHIPTO_{{$key}}" class="filter-none"  value="1" {{ ($row->SHIPTO == 1 || $row->SHIPTO=='on')?'checked':'' }} ></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="87" name="LOC_DEFAULT_SHIPTO_{{$key}}" id="LOC_DEFAULT_SHIPTO_{{$key}}" class="filter-none"  value="1" {{ ($row->DEFAULT_SHIPTO == 1 || $row->DEFAULT_SHIPTO=='on')?'checked':'' }} ></td>
            ...
            @else 
            <tr  class="participantRow">
              <td><input  class="form-control w-100" type="text" name="LOC_NAME_0" tabindex="88" id="LOC_NAME_0" maxlength="50" ></td>
              <td><input  class="form-control w-100" type="text" name="LOC_CADD_0" id="LOC_CADD_0" tabindex="89" maxlength="200" ></td>

              <td><input  class="form-control w-100" type="text" name="LOC_CTRYID_REF_0" id="TXTLOC_CTRYID_REF_POPUP_0" tabindex="90" maxlength="100" readonly></td>
              <td hidden><input  class="form-control w-100" type="text" name="HDNLOC_CTRYID_REF_0" id="HDNLOC_CTRYID_REF_POPUP_0" tabindex="91" maxlength="100" ></td>

              <td><input  class="form-control w-100" type="text" name="LOC_STID_REF_0" id="TXTLOC_STID_REF_POPUP_0" tabindex="92" maxlength="100" readonly></td>
              <td hidden><input  class="form-control w-100" type="text" name="HDNLOC_STID_REF_0" id="HDNLOC_STID_REF_POPUP_0" tabindex="93" maxlength="100" readonly></td>

              <td><input  class="form-control w-100" type="text" tabindex="94" name="LOC_CITYID_REF_0" id="TXTLOC_CITYID_REF_POPUP_0" maxlength="100" readonly></td>
              <td hidden><input  class="form-control w-100" type="text" tabindex="95" name="HDNLOC_CITYID_REF_0" id="HDNLOC_CITYID_REF_POPUP_0" maxlength="100" readonly></td>


              <td><input  class="form-control w-100" type="text" tabindex="96" name="LOC_PIN_0" id="LOC_PIN_0" maxlength="20" ></td>
              <td><input  class="form-control w-100" type="text" tabindex="97" name="LOC_GSTIN_0" id="LOC_GSTIN_0" maxlength="30" ></td>
              <td><input  class="form-control w-100" type="text" tabindex="98" name="LOC_CPNAME_0" id="LOC_CPNAME_0" maxlength="30" ></td>
              <td><input  class="form-control w-100" type="text" tabindex="99" name="LOC_CPDESIGNATION_0" id="LOC_CPDESIGNATION_0" maxlength="20" ></td>
              <td><input  class="form-control w-100" type="text" tabindex="100" name="LOC_EMAIL_0" id="LOC_EMAIL_0" maxlength="50" ></td>
              <td><input  class="form-control w-100" type="text" tabindex="101" name="LOC_MONO_0" id="LOC_MONO_0" maxlength="15" ></td>
              <td><input  class="form-control w-100" type="text" tabindex="102" name="LOC_SPINSTRACTION_0" id="LOC_SPINSTRACTION_0" maxlength="50" ></td>
              
              <td style="text-align:center;" ><input type="checkbox" tabindex="103" name="LOC_BILLTO_0" id="LOC_BILLTO_0" class="filter-none"  value="1" ></td>
              <td style="text-align:center;" ><input type="checkbox" tabindex="104" name="LOC_DEFAULT_BILLTO_0" id="LOC_DEFAULT_BILLTO_0" class="filter-none"  value="1" ></td>
              <td style="text-align:center;" ><input type="checkbox" tabindex="105" name="LOC_SHIPTO_0" id="LOC_SHIPTO_0" class="filter-none"  value="1" ></td>
              <td style="text-align:center;" ><input type="checkbox" tabindex="106" name="LOC_DEFAULT_SHIPTO_0" id="LOC_DEFAULT_SHIPTO_0" class="filter-none"  value="1" ></td>
        ...
        <div id="ALPSSpecific" class="tab-pane fade">
                    ...
                    <div class="inner-form" style="margin-top:10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_CUSTOMER_CODE" id="SAP_CUSTOMER_CODE" tabindex="107" value="{{ $objMstCust->SAP_CUSTOMER_CODE }}"  class="form-control" style="text-transform:uppercase">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD2) && $TabSetting->FIELD2 !=''?$TabSetting->FIELD2:'Add. Customer Name'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUSTOMER_NAME" id="SAP_CUSTOMER_NAME" tabindex="108" value="{{ $objMstCust->SAP_CUSTOMER_NAME }}" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD3) && $TabSetting->FIELD3 !=''?$TabSetting->FIELD3:'Add. Account Group'}}</p></div>
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_ACCOUNT_GROUP" id="SAP_ACCOUNT_GROUP" tabindex="109" value="{{ $objMstCust->SAP_ACCOUNT_GROUP }}" class="form-control" style="text-transform:uppercase">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD4) && $TabSetting->FIELD4 !=''?$TabSetting->FIELD4:'Add. Customer Group Code'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUSTOMER_GROUP_CODE" id="SAP_CUSTOMER_GROUP_CODE" tabindex="110" value="{{ $objMstCust->SAP_CUSTOMER_GCODE }}" class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD5) && $TabSetting->FIELD5 !=''?$TabSetting->FIELD5:'Add. Customer Group Name'}}</p></div>
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_CUSTOMER_GROUP_NAME" id="SAP_CUSTOMER_GROUP_NAME" tabindex="111" value="{{ $objMstCust->SAP_CUSTOMER_GNAME }}" class="form-control" >
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD6) && $TabSetting->FIELD6 !=''?$TabSetting->FIELD6:'Add. Global Group Account Code'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_GLOBAL_GROUP_CODE" id="SAP_GLOBAL_GROUP_CODE" tabindex="112" value="{{ $objMstCust->SAP_GLOBAL_GACODE }}"class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD7) && $TabSetting->FIELD7 !=''?$TabSetting->FIELD7:'Add. Global Group Account Name'}}</p></div>
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_GLOBAL_GRUOUP_NAME" id="SAP_GLOBAL_GRUOUP_NAME" tabindex="113" value="{{ $objMstCust->SAP_GLOBAL_GANAME }}" class="form-control">
                        </div>
                        <div class="col-lg-2 pl"><p>{{isset($TabSetting->FIELD8) && $TabSetting->FIELD8 !=''?$TabSetting->FIELD8:'Add. Our Code in Customer book'}}</p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="OUR_CODE" id="OUR_CODE" tabindex="114" value="{{ $objMstCust->OUR_CODE_INCBOOK }}" class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
			...
			<div id="udf" class="tab-pane fade">
              <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
                <table id="udffietable" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                  ...
                  <tr  class="participantRow">
                    <td>
                      <input name={{"udffie_popup_".$udfkey}} id={{"txtudffie_popup_".$udfkey}} value="{{$udfrow->LABEL}}" tabindex="115" class="form-control @if ($udfrow->ISMANDATORY==1) mandatory @endif" autocomplete="off" maxlength="100" disabled/>
                    </td>

                    <td hidden>
                      <input type="text" name='{{"udffie_".$udfkey}}' id='{{"hdnudffie_popup_".$udfkey}}' tabindex="116" value="{{$udfrow->UDFCMID}}" class="form-control" maxlength="100" />
                    </td>
                    ...
                    <td id="{{"tdinputid_".$udfkey}}">
                      ...
                      if($chkvaltype=='date'){
                        ...
                        $strinp = '<input type="date" placeholder="dd/mm/yyyy" name="'.$dynamicid.'" id="'.$dynamicid.'" tabindex="117" class="form-control" value="'.$udfrow->VALUE.'" /> ';       

                      }else if($chkvaltype=='time'){

                          $strinp= '<input type="time" placeholder="h:i" name="'.$dynamicid.'" id="'.$dynamicid.'" tabindex="118" class="form-control"  value="'.$udfrow->VALUE.'"/> ';

                      }else if($chkvaltype=='numeric'){
                      $strinp = '<input type="text" name="'.$dynamicid. '" id="'.$dynamicid.'" class="form-control" tabindex="119" value="'.$udfrow->VALUE.'"/> ';

                      }else if($chkvaltype=='text'){

                      $strinp = '<input type="text" name="'.$dynamicid. '" id="'.$dynamicid.'" class="form-control" tabindex="120" value="'.$udfrow->VALUE.'"/> ';
                          ...
                          $strinp = '<input type="checkbox" name="'.$dynamicid. '" id="'.$dynamicid.'" tabindex="121" class=""  '.$boolval.' /> ';
                        ...
                        $strinp = '<select name="'.$dynamicid.'" id="'.$dynamicid.'" tabindex="122" class="form-control" >'.$opts.'</select>' ;
                      }
                      echo $strinp;
                      @endphp
                    </td>                   
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="cg_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_CGID_REF[]" id="cgidref_{{ $CgList->CGID }}" class="clscgidref" value="{{ $CgList->CGID }}" ></td>
          <td class="ROW2" style="width: 39%">{{ $CgList->CGROUP }}
          <input type="hidden" id="txtcgidref_{{ $CgList->CGID }}" data-desc="{{ $CgList->CGROUP }} - {{ $CgList->DESCRIPTIONS }}" value="{{ $CgList-> CGID }}"/>
          </td>
          <td class="ROW3" style="width: 39%">{{ $CgList->DESCRIPTIONS }}</td>
        </tr>
        @endforeach
        </tbody>
      </table>
...
function getCountryWiseState(CTRYID_REF){
    ...
    $.ajax({
        url:'{{route("master",[5,"getCountryWiseState"])}}',
        type:'POST',
...
function getStateWiseCity(CTRYID_REF,STID_REF){
    ...
    $.ajax({
        url:'{{route("master",[5,"getStateWiseCity"])}}',
        type:'POST',
...
function getCorCountryWiseState(CTRYID_REF){
    ...
    $.ajax({
        url:'{{route("master",[5,"getCorCountryWiseState"])}}',
        type:'POST',
        data:{CTRYID_REF:CTRYID_REF},
        success:function(data) {
...
function getCorStateWiseCity(CTRYID_REF,STID_REF){
    ...
    $.ajax({
        url:'{{route("master",[5,"getCorStateWiseCity"])}}',
        type:'POST',
        data:{CTRYID_REF:CTRYID_REF,STID_REF:STID_REF},
        success:function(data) {
...
function checkDuplicateCode(){
	...
	$.ajax({
		url:'{{route("master",[5,"codeduplicate"])}}',
		type:'POST',
		data:{'CCODE': codedata},
		success:function(data) {
			if(data.exists) {
...
window.fnApproveData = function (){
      ...
      $.ajax({
          url:'{{route("master",[5,"singleapprove"])}}',
          type:'POST',
          data:formData,
          success:function(data) {
...
//********-----
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
         //reload form
         window.location.href = "{{route('master',[5,'index'])}}";
...
$("#modalclosePopup").on("click",function(event){ 
  ...
  function getProspect(){
      ...
      $.ajax({
        url:'{{route("master",[5,"getProspectCode"])}}',
        type:'POST',
        success:function(data) {
