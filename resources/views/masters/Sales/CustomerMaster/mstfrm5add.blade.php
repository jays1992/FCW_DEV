        ...
        <div class="PROSPECT_ACTION" style="display:none;">
          ...
          <input type="hidden" name="PROSPID_REF" id="PROSPID_REF" class="form-control" readonly>
			...
			<div class="row">
				...
				<div class="col-lg-2 pl">
					{{-- <input type="text" name="CCODE" id="CCODE" class="form-control mandatory"  maxlength="20" required tabindex="2" autocomplete="off" style="text-transform:uppercase" autofocus > --}}
          @if(!empty($objDD))
              @if($objDD->SYSTEM_GRSR == "1")
                  <input type="text" name="CCODE" id="CCODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="2" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              @endif
              @if($objDD->MANUAL_SR == "1")
                  <input type="text" name="CCODE" id="CCODE" value="{{ old('CCODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="2" autocomplete="off" style="text-transform:uppercase" autofocus >
              @endif
          @endif  
          ...
          <span class="text-danger" id="ERROR_REGADDL1"></span>
			...
			<div class="col-lg-1 pl">
				<input type="text" name="REGPIN" id="REGPIN" class="form-control "  maxlength="10" tabindex="13"  autocomplete="off" >
			</div>
			...
			<div id="udf" class="tab-pane fade">
              <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
                <table id="udffietable" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                  ...
                  <tbody>
                  @foreach($objUdfForCustomer as $udfkey => $udfrow)
                  <tr  class="participantRow">
                    <td>
                      <input name={{"udffie_popup_".$udfkey}} id={{"txtudffie_popup_".$udfkey}} tabindex="81" value="{{$udfrow->LABEL}}" tabindex="73" class="form-control @if ($udfrow->ISMANDATORY==1) mandatory @endif" autocomplete="off" maxlength="100" disabled/>
                    </td>

                    <td hidden>
                      <input type="text" tabindex="74" name='{{"udffie_".$udfkey}}'  id='{{"hdnudffie_popup_".$udfkey}}' value="{{$udfrow->UDFCMID}}" class="form-control" maxlength="100" />
                    </td>

                    <td hidden>
                      <input type="text" tabindex="82" name={{"udffieismandatory_".$udfkey}} id={{"udffieismandatory_".$udfkey}} class="form-control" maxlength="100" value="{{$udfrow->ISMANDATORY}}" />
                    </td>
...
//----------------------------
  ...
  window.fnSaveData = function (){
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
         //reload form
         window.location.href = "{{route('master',[5,'add'])}}";
