...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->PCID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->PCCODE}} </label>
                    <input type="hidden" name="PCID" id="PCID" value="{{ $objResponse->PCID }}" />
                    <input type="hidden" name="PCCODE" id="PCCODE" value="{{ $objResponse->PCCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="PCDESCRIPTIONS" id="PCDESCRIPTIONS" class="form-control mandatory" value="{{ old('PCDESCRIPTIONS',$objResponse->PCDESCRIPTIONS) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    $("#PCDESCRIPTIONS").keydown(function(){       
        $("#ERROR_PCDESCRIPTIONS").hide();
        validateSingleElemnet("PCDESCRIPTIONS");
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[33,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[33,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
