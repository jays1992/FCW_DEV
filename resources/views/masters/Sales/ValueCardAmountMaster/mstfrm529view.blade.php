    ...
    <div class="container-fluid filter">
      <div class="inner-form">         
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="VALUE_CARD_AMOUNT" id="VALUE_CARD_AMOUNT" value="{{isset($HDR->VCA_AMT)?$HDR->VCA_AMT:''}}" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" >                                                       
          </div>   
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="DIS_PER_AMT" id="DIS_PER_AMT" value="{{isset($HDR->PERCENTAGE_AMT)?$HDR->PERCENTAGE_AMT:''}}" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" >                                                       
          </div>

          <div class="col-lg-2 pl"><p>Total Amount*</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="TOTAL_AMOUNT" id="TOTAL_AMOUNT" value="{{isset($HDR->TOTAL_AMT)?$HDR->TOTAL_AMT:''}}" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" >                                                       
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <select {{$ActionStatus}} name="CARD_VALIDITY" id="CARD_VALIDITY" class="form-control" autocomplete="off" >
              <option value="">Select</option>
              @for($i=1;$i<=12;$i++)
              <option {{isset($HDR->CARDVALIDITY_MON) && $HDR->CARDVALIDITY_MON ==$i?'selected="selected"':''}} value="{{$i}}">{{$i}}</option>
              @endfor
            </select>
          </div>
        </div>
