...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->BUID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->BUCODE}} </label>
                    <input type="hidden" name="BUID" id="BUID" value="{{ $objResponse->BUID }}" />
                    <input type="hidden" name="BUCODE" id="BUCODE" value="{{ $objResponse->BUCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="BUNAME" id="BUNAME" class="form-control mandatory" value="{{ old('BUNAME',$objResponse->BUNAME) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[8,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[8,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
