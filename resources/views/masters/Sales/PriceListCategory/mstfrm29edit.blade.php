...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->PLCID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->PLCCODE}} </label>
                    <input type="hidden" name="PLCID" id="PLCID" value="{{ $objResponse->PLCID }}" />
                    <input type="hidden" name="PLCCODE" id="PLCCODE" value="{{ $objResponse->PLCCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="PLCDESCRIPTIONS" id="PLCDESCRIPTIONS" class="form-control mandatory" value="{{ old('PLCDESCRIPTIONS',$objResponse->PLCDESCRIPTIONS) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[29,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[29,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
