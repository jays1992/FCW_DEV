...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Customer-Branch Mapping</a>
        </div>
...
<div class="container-fluid purchase-order-view filter">     
  ...
  @CSRF
  {{isset($objResponse->CBRMID) ? method_field('PUT') : '' }}
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr class="participantRow">
                    <td><input type="checkbox" name="CID_REF[{{$key}}]" {{$row->CID ==$row->CID_REF?'checked':''}} value="{{$row->CID}}" class="checkbox" ></td>
