...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_enquiry_media" method="POST"  > 
          @CSRF
          {{isset($objResponse->EMID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->EMCODE}} </label>
                    <input type="hidden" name="EMID" id="EMID" value="{{ $objResponse->EMID }}" />
                    <input type="hidden" name="EMCODE" id="EMCODE" value="{{ $objResponse->EMCODE }}" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_enquiry_media" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[15,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[15,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
