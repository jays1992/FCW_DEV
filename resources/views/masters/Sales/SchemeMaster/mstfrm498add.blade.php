...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Scheme Master</a></div>
...
<form id="master_form" onsubmit="return validateForm()"  method="POST" class="needs-validation" >  
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="SCHEME_NO" id="SCHEME_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
          <input type="text" name="SCHEME_NO" id="SCHEME_NO" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
          @else
            <input type="text" name="SCHEME_NO" id="SCHEME_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
        </div>
              
        <div class="col-lg-1 pl"><p>Scheme Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="SCHEME_DATE" id="SCHEME_DATE" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" >
        </div>

        <div class="col-lg-1 pl"><p>Scheme Name</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="SCHEME_NAME" id="SCHEME_NAME" class="form-control" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>Scheme Type</p></div>
        <div class="col-lg-2 pl">
          <select name="SCHEME_TYPE" id="SCHEME_TYPE" class="form-control" autocomplete="off" >
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="EFF_FROM_DATE" id="EFF_FROM_DATE" class="form-control" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>Effective To Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="EFF_TO_DATE" id="EFF_TO_DATE" class="form-control" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>Item Code</p></div>
        <div class="col-lg-2 pl">
          <input type="text"    name="MAIN_ITEMID_NAME"   id="MAIN_ITEMID_NAME"   class="form-control" autocomplete="off" onclick="getMainItem()" readonly >
          <input type="hidden"  name="MAIN_ITEMID_REF"    id="MAIN_ITEMID_REF"    class="form-control" autocomplete="off" >
          <input type="hidden"  name="HIDDEN_ITEM_FIELD"  id="HIDDEN_ITEM_FIELD"  class="form-control" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>Item Name</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="ITEM_NAME" id="ITEM_NAME" class="form-control" autocomplete="off" readonly >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="MAIN_UOM" id="MAIN_UOM" class="form-control" autocomplete="off" readonly >
          <input type="hidden" name="MAIN_UOM_REF" id="MAIN_UOM_REF" class="form-control" autocomplete="off" readonly >
        </div>

        <div class="col-lg-1 pl"><p>Qty</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="MAIN_QTY" id="MAIN_QTY" value="1" class="form-control" autocomplete="off" onkeypress="return isNumberKey(event,this)" >
        </div>
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
				  ...
				  <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input  type="text" name="popupITEMID[]" id="popupITEMID_0" onclick="getItem(this.id)" class="form-control"  autocomplete="off"  readonly/></td>
                    ...
                    <td><input type="text"   name="QTY[]" id="QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"   /></td>
                    
                    <td>
                      <select name="COST[]" id="COST_0" class="form-control" autocomplete="off" onchange="getCost(this)" >
                        <option value="FREE">FREE</option>
                        <option value="DISC">DISC</option>
                      </select>
                    </td>

                    <td><input type="text" name="PER[]" id="PER_0" value="0" class="form-control"  autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)"  readonly  /></td>
                    
                    <td>
                      <select name="PERCENTAGE_BASED_ON[]" id="PERCENTAGE_BASED_ON_0" class="form-control" autocomplete="off">
...
$(document).ready(function(e){
  ...
  var lastdt = <?php echo json_encode($objlastdt[0]->SCHEME_DATE); ?>;
  var today = new Date(); 
