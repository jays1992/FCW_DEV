              ...
              <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                <thead id="thead1"  style="position: sticky;top: 0">
                  <tr>
                    ...
                    <td><input type="text" name="PRODUCT_CODE[]" id="PRODUCT_CODE_0"        class="form-control"  autocomplete="off" onclick="getProduct(this.id)"  readonly/></td>
                    <td hidden><input type="text" name="ITEM_REF[]" id="ITEM_REF_0"     class="form-control"  autocomplete="off" /></td>
                    <td><input type="text" name="PRODUCT_NAME[]" id="PRODUCT_NAME_0"      class="form-control"  autocomplete="off"  readonly/></td>
                    <td><input type="text" name="SALES_PRICE[]" id="SALES_PRICE_0"      onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                    <td><input type="text" name="PURCHASE_PRICE[]"  id="PURCHASE_PRICE_0"   onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                    <td align="center">
