                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      <td><input  {{$ActionStatus}} class="form-control" type="text" name="SRNo[]" id ="SRNo_{{$srno}}"         value="{{$srno}}" autocomplete="off" readonly></td>
                      <td><input {{$ActionStatus}} type="text" name="PRODUCT_CODE[]" id="PRODUCT_CODE_{{$key}}"         value="{{isset($row->ICODE)?$row->ICODE:''}}"   class="form-control"  autocomplete="off" onclick="getProduct(this.id)"  readonly/></td>
                      ...
                      <td><input {{$ActionStatus}} type="text" name="PRODUCT_NAME[]" id="PRODUCT_NAME_{{$key}}"         value="{{isset($row->NAME)?$row->NAME:''}}"   class="form-control"  autocomplete="off"  readonly/></td>
                      <td><input {{$ActionStatus}} type="text" name="SALES_PRICE[]" id="SALES_PRICE_{{$key}}"           value="{{isset($row->SALE_PRICE)?$row->SALE_PRICE:''}}"         onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                      <td><input {{$ActionStatus}} type="text" name="PURCHASE_PRICE[]"  id="PURCHASE_PRICE_{{$key}}"    value="{{isset($row->PURCHASE_PRICE)?$row->PURCHASE_PRICE:''}}"    onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                      <td align="center">
                      <button {{$ActionStatus}} class="btn add" title="add" data-toggle="tooltip" id ="SRLNo_{{$sr_no}}" onclick="SrNo(this.id)"><i class="fa fa-plus"></i></button>
