...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->COUPONCID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->COUPONCCODE}} </label>
                    <input type="hidden" name="COUPONCID" id="COUPONCID" value="{{ $objResponse->COUPONCID }}" />
                    <input type="hidden" name="COUPONCCODE" id="COUPONCCODE" value="{{ $objResponse->COUPONCCODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="CCDESCRIPTIONS" id="CCDESCRIPTIONS" class="form-control mandatory" value="{{ old('CCDESCRIPTIONS',$objResponse->CCDESCRIPTIONS) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[22,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[22,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
