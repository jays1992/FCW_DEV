...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->QCPID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->QCP_CODE}} </label>
                    <input type="hidden" name="QCPID" id="QCPID" value="{{ $objResponse->QCPID }}" />
                    <input type="hidden" name="QCP_CODE" id="QCP_CODE" value="{{ $objResponse->QCP_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="QCP_DESC" id="QCP_DESC" class="form-control mandatory" value="{{ old('QCP_DESC',$objResponse->QCP_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[135,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[135,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
