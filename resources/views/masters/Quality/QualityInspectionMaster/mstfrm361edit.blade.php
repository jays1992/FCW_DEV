  ...
  <form id="frm_mst_edit" method="POST"  > 
    ...
    <div class="inner-form">
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="QICDT" id="QICDT" value="{{ isset($HDR->QICDT)?$HDR->QICDT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
        
        <div class="col-lg-1 pl"><p>Item</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="popupITEMID" id="popupITEMID" value="{{ isset($HDR->ICODE)?$HDR->ICODE:''}} {{ isset($HDR->ITEM_NAME)? ' - '.$HDR->ITEM_NAME:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
...
function checkDuplicateCode(){
    ...
    $.ajax({
        url:'{{route("master",[361,"checkduplicate"])}}',
        type:'POST',
        data:formData,
        success:function(data) {
