...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->RRID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->RR_CODE}} </label>
                    <input type="hidden" name="RRID" id="RRID" value="{{ $objResponse->RRID }}" />
                    <input type="hidden" name="RR_CODE" id="RR_CODE" value="{{ $objResponse->RR_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="RR_DESC" id="RR_DESC" class="form-control mandatory" value="{{ old('RR_DESC',$objResponse->RR_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[136,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[136,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
