          ...
          <div class="inner-form">
            <div class="row">
                ...
                <div class="col-lg-11 pl">
                    @if(!empty($objDD))
                        @if($objDD->SYSTEM_GRSR == "1")
                            <input type="text" name="INSTRUMENT_METHOD_CODE" id="INSTRUMENT_METHOD_CODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                        @endif
                        @if($objDD->MANUAL_SR == "1")
                            <input type="text" name="INSTRUMENT_METHOD_CODE" id="INSTRUMENT_METHOD_CODE" value="{{ old('INSTRUMENT_METHOD_CODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                        @endif
                    @endif 
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="INSTRUMENT_METHOD_NAME" id="INSTRUMENT_METHOD_NAME" class="form-control mandatory" value="{{ old('INSTRUMENT_METHOD_NAME') }}" maxlength="200" tabindex="2"  />
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnUndoYes = function (){      
      //reload form
      window.location.href = "{{route('master',[385,'add'])}}";
   }//fnUndoYes
