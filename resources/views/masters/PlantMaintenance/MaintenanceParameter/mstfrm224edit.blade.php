...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->MPID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->MP_CODE}} </label>
                    <input type="hidden" name="MPID" id="MPID" value="{{ $objResponse->MPID }}" />
                    <input type="hidden" name="MP_CODE" id="MP_CODE" value="{{ $objResponse->MP_CODE }}"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="MP_DESC" id="MP_DESC" class="form-control mandatory" value="{{ old('MP_DESC',$objResponse->MP_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[224,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[224,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
