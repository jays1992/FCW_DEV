...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="{{route('master',[222,'index'])}}" class="btn singlebt">Machine</a>
                </div><!--col-2-->
         ...
         <form id="frm_mst_edit" method="POST"  > 
          ...
          <div class="inner-form">
              ...
              <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      <div class="col-lg-7 pl">
                        <label> {{$objResponse->MACHINE_NO}} </label>
                        <input type="hidden" name="MACHINEID" id="MACHINEID" value="{{ $objResponse->MACHINEID }}" />
                        <input type="hidden" name="MACHINE_NO" id="MACHINE_NO" value="{{ $objResponse->MACHINE_NO }}"   />
                    ...
                    <div class="col-lg-3 pl">
                      <input type="text" name="MACHINE_DESC" id="MACHINE_DESC" class="form-control mandatory" value="{{ old('MACHINE_DESC',$objResponse->MACHINE_DESC) }}" maxlength="200"  />
                ...
                <div class="col-lg-4 pl">
                  <div class="col-lg-10 pl">
                    <label class="radio-inline" style="margin-right: 30px">
                        <input   type="radio" name="MACHINE_TYPE" id="RADIO_MACHINE_TYPE_MACHINE" value="Machine" @if($is_machine) checked @endif />    Machine
                    </label>
                    <label class="radio-inline">
                        <input   type="radio" name="MACHINE_TYPE" id="RADIO_MACHINE_TYPE_GENSET" value="Genset"  @if($is_genset) checked @endif />   Genset
                    </label>
                  </div> 
                </div>
              </div>

              <div id="divmachine" style="display:@if($is_machine) block @else none @endif ;">
              <div class="row">
                  <div class="col-lg-2 pl"><p>Asset Code</p></div>
                  <div class="col-lg-2 pl">                 
                        <input type="text" name="txtLISTPOP1_popup_0" id="txtLISTPOP1_popup_0" class="form-control CLSMACH" value="{{ $strAssetCode }}"  autocomplete="off"  readonly />
                        <input type="hidden" name="LISTPOP1ID_0" id="hdnLISTPOP1ID_0" class="form-control CLSMACH" value="{{ $strAssetID }}"   />
                  </div>
                  <div class="col-lg-2 pl"><p>Asset Description</p></div>
                  <div class="col-lg-3 pl">
                      <input type="text" name="ASSET_DESC" id="ASSET_DESC" class="form-control CLSMACH" value="{{ $strAssetDesc }}"  autocomplete="off" readonly />
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                        <input type="text" name="ASSETCAT_DESC" id="ASSETCAT_DESC" class="form-control CLSMACH" value="{{ $strAssetCatCode }}" autocomplete="off" readonly/>                 
                        <input type="hidden" name="ASCATID_REF" id="ASCATID_REF" class="form-control CLSMACH" value="{{ $strAssetCatID }}" autocomplete="off" readonly/>                 
                  </div>
                  <div class="col-lg-2 pl"><p>Asset Type</p></div>
                  <div class="col-lg-3 pl">
                      <input type="text" name="ASSET_TYPE_DESC" id="ASSET_TYPE_DESC" class="form-control CLSMACH"  value="{{ $strAssetTypeCode }}"  autocomplete="off" readonly/>
                      <input type="hidden" name="ASTID_REF" id="ASTID_REF" class="form-control CLSMACH"  value="{{ $strAssetTypeID }}"  autocomplete="off" readonly/>
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4 pl">                 
                        <input type="text" name="VENDOR" id="VENDOR" class="form-control CLSMACH" value="{{ old('VENDOR',$objResponse->VENDOR) }}" autocomplete="off" maxlength="100"/>                 
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="COMPANY_NAME" id="COMPANY_NAME" class="form-control CLSMACH" value="{{ old('COMPANY_NAME',$objResponse->COMPANY_NAME) }}"  autocomplete="off" maxlength="100" />                 
                  </div>
                  <div class="col-lg-2 pl"><p>Brand</p></div>
                  <div class="col-lg-3 pl">
                    <input type="text" name="BRAND" id="BRAND" class="form-control CLSMACH"  value="{{ old('BRAND',$objResponse->BRAND) }}"   autocomplete="off" maxlength="100" />
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="MODEL_NO" id="MODEL_NO" class="form-control CLSMACH" value="{{ old('MODEL_NO',$objResponse->MODEL_NO) }}"  autocomplete="off" maxlength="100" />                 
                  </div>
                  <div class="col-lg-2 pl"><p>Serial No</p></div>
                  <div class="col-lg-3 pl">
                    <input type="text" name="SERIAL_NO" id="SERIAL_NO" class="form-control CLSMACH"  value="{{ old('SERIAL_NO',$objResponse->SERIAL_NO) }}"   autocomplete="off" maxlength="100" />
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="CAPACITY" id="CAPACITY" class="form-control CLSMACH" value="{{ old('CAPACITY',$objResponse->CAPACITY) }}"  autocomplete="off" maxlength="100" />                 
                  </div>
                  <div class="col-lg-2 pl"><p>Technical Specification 1</p></div>
                  <div class="col-lg-3 pl">
                    <input type="text" name="TECH_SPECI1" id="TECH_SPECI1" class="form-control CLSMACH" value="{{ old('TECH_SPECI1',$objResponse->TECH_SPECI1) }}" autocomplete="off" maxlength="200" />
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="TECH_SPECI2" id="TECH_SPECI2" class="form-control CLSMACH"  value="{{ old('TECH_SPECI2',$objResponse->TECH_SPECI2) }}"  autocomplete="off" maxlength="200" />                 
                  </div>
                  <div class="col-lg-2 pl"><p>Technical Specification 3</p></div>
                  <div class="col-lg-3 pl">
                    <input type="text" name="TECH_SPECI3" id="TECH_SPECI3" class="form-control CLSMACH"  value="{{ old('TECH_SPECI3',$objResponse->TECH_SPECI3) }}"  autocomplete="off" maxlength="200" />
                  </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="date" name="DOPURCHASE" class="form-control CLSMACH" id="DOPURCHASE"  value="{{isset($objResponse->DOPURCHASE) && $objResponse->DOPURCHASE !="" && $objResponse->DOPURCHASE !="1900-01-01" ? $objResponse->DOPURCHASE:''}}"    placeholder="dd/mm/yyyy"  />
                </div>
                
                <div class="col-lg-2 pl"><p>Date of Installation</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="DOINSTALLATION" class="form-control CLSMACH" id="DOINSTALLATION" value="{{isset($objResponse->DOINSTALLATION) && $objResponse->DOINSTALLATION !="" && $objResponse->DOINSTALLATION !="1900-01-01" ? $objResponse->DOINSTALLATION:''}}"   placeholder="dd/mm/yyyy"  />
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="date" name="WARRANTY_UPTO" class="form-control CLSMACH" id="WARRANTY_UPTO"  value="{{isset($objResponse->WARRANTY_UPTO) && $objResponse->WARRANTY_UPTO !="" && $objResponse->WARRANTY_UPTO !="1900-01-01" ? $objResponse->WARRANTY_UPTO:''}}"   placeholder="dd/mm/yyyy"  />
                </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-8 pl">
                <div class="col-lg-10 pl">
                  <label class="radio-inline" style="margin-right: 30px;">
                      <input   type="radio" name="SERVICE_STATUS" id="RADIO_SERVICE_STATUS_MACHINE" value="Warranty" @if(strtolower($objResponse->SERVICE_STATUS)=="warranty") checked @endif />    Warranty
                  </label>
                  <label class="radio-inline" style="margin-right: 30px">
                      <input   type="radio" name="SERVICE_STATUS" id="RADIO_SERVICE_STATUS_AMC" value="AMC" @if(strtolower($objResponse->SERVICE_STATUS)=="amc") checked @endif  />   AMC
                  </label>
                  <label class="radio-inline" style="margin-right: 30px">
                      <input   type="radio" name="SERVICE_STATUS" id="RADIO_SERVICE_STATUS_INTERNAL" value="Internal"  @if(strtolower($objResponse->SERVICE_STATUS)=="internal") checked @endif   />   Internal
                  </label>
                  <label class="radio-inline">
                      <input   type="radio" name="SERVICE_STATUS" id="RADIO_SERVICE_STATUS_OUT" value="Out-of-Warranty"  @if(strtolower($objResponse->SERVICE_STATUS)=="out-of-warranty") checked @endif  />   Out-of-Warranty / AMC
                  </label>
                </div> 
              </div>           
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 pl">                 
                    <input type="text" name="INSTRUCTIONS1" id="INSTRUCTIONS1" class="form-control  CLSMACH" value="{{ old('INSTRUCTIONS1',$objResponse->INSTRUCTIONS1) }}"  autocomplete="off" maxlength="200"/>                 
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 pl">                 
                    <input type="text" name="INSTRUCTIONS2" id="INSTRUCTIONS2" class="form-control  CLSMACH" value="{{ old('INSTRUCTIONS2',$objResponse->INSTRUCTIONS2) }}" autocomplete="off" maxlength="200"/>                 
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 pl">                 
                    <input type="text" name="REMARKS" id="REMARKS" class="form-control  CLSMACH" value="{{ old('REMARKS',$objResponse->REMARKS) }}"  autocomplete="off" maxlength="200"/>                 
              </div>
            </div>

          </div>
          <div id="divgenset" style="display:@if($is_genset) block @else none @endif ;">
            <div class="row">
              <div class="col-lg-8">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 pl">                 
                  <select name="FUELID_REF" id="FUELID_REF" class="form-control ">
                    ...
                    @foreach ($ObjFuelType as $index1=>$row1)
                      <option value="{{ $row1->FUELID }}"  @if($row1->FUELID==$objResponse->FUELID_REF) selected="selected" @endif >{{ $row1->FUEL_CODE }} - {{ $row1->FUEL_DESC }} </option>
                    @endforeach                  
                  </select>                 
                </div>
                <div class="col-lg-2 pl"><p>Standard Consumption (Per Hour)</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="CONSUMPTION" id="CONSUMPTION" class="form-control" value="{{ old('CONSUMPTION',$objResponse->CONSUMPTION) }}"  autocomplete="off" maxlength="200" />
                </div>
                <div class="col-lg-1 pl"><p>UoM</p></div>
                <div class="col-lg-1 pl">                 
                  <select name="UOMID_REF" id="UOMID_REF" class="form-control ">
                    <option value="" selected="selected">--Please select--</option>                  
                    @foreach ($ObjMainUOM as $index2=>$row2)
                    <option value="{{ $row2->UOMID }}"  @if($row2->UOMID==$objResponse->UOMID_REF) selected="selected" @endif >{{ $row2->UOMCODE }} - {{ $row2->DESCRIPTIONS }} </option>
                  @endforeach   
                  </select>                 
                </div>
            </div>
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[222,"add"])}}';
 ...
 var formDataMst = $( "#frm_mst_edit" );
     ...
     $("#MACHINE_DESC").blur(function(){
        ...
        $("#ERROR_MACHINE_DESC").hide();
        validateSingleElemnet("MACHINE_DESC");
    });

     $("#MACHINE_DESC").keydown(function(){
        $("#ERROR_MACHINE_DESC").hide();
        validateSingleElemnet("MACHINE_DESC");
    });
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[222,"update"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
                ...
                if(data.errors) {
                    ...
                    if(data.errors.MACHINE_DESC){
                        showError('ERROR_MACHINE_DESC',data.errors.MACHINE_DESC);
                    }
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[222,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn1").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[222,"index"]) }}';
