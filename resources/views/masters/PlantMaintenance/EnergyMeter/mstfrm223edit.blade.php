...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->ENERGYID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      <div class="col-lg-7 pl">
                        <label> {{$objResponse->METER_CODE}} </label>
                        <input type="hidden" name="ENERGYID" id="ENERGYID" value="{{ $objResponse->ENERGYID }}" />
                        <input type="hidden" name="METER_CODE" id="METER_CODE" value="{{ $objResponse->METER_CODE }}"   />
                    ...
                    <div class="col-lg-3 pl">
                      <input type="text" name="METER_DESC" id="METER_DESC" class="form-control mandatory" value="{{ old('METER_DESC',$objResponse->METER_DESC) }}" maxlength="200"  />
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">                 
                      <input type="text" name="KWH" id="KWH" class="form-control mandatory" value="{{ old('KWH',$objResponse->KWH) }}"  autocomplete="off" maxlength="50"/>                 
                </div>
                  <div class="col-lg-2 pl"><p>Starting Meter Reading (KVARH)</p></div>
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="KVARH" id="KVARH" class="form-control " value="{{ old('KVARH',$objResponse->KVARH) }}"  autocomplete="off" maxlength="50" />                 
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="KVAH" id="KVAH" class="form-control " value="{{ old('KVAH',$objResponse->KVAH) }}"  autocomplete="off" maxlength="50" />                 
                  </div>
                  <div class="col-lg-2 pl"><p>Starting Meter Reading (MD)</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="MD" id="MD" class="form-control " value="{{ old('MD',$objResponse->MD) }}"  autocomplete="off" maxlength="50" />
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="POWER_FACTOR" id="POWER_FACTOR" class="form-control " value="{{ old('POWER_FACTOR',$objResponse->POWER_FACTOR) }}"   autocomplete="off" maxlength="100" />                 
                  </div>
                  <div class="col-lg-2 pl"><p>Date of Commissioning</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="DOCOMMISSION" class="form-control " id="DOCOMMISSION" value="{{isset($objResponse->DOCOMMISSION) && $objResponse->DOCOMMISSION !="" && $objResponse->DOCOMMISSION !="1900-01-01" ? $objResponse->DOCOMMISSION:''}}"  placeholder="dd/mm/yyyy"  />
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">                 
                  <input type="text" name="METER_COMPANY" id="METER_COMPANY" class="form-control " value="{{ old('METER_COMPANY',$objResponse->METER_COMPANY) }}"   autocomplete="off" maxlength="100" />                 
                </div>
                <div class="col-lg-2 pl"><p>Brand</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="BRAND" id="BRAND" class="form-control " value="{{ old('BRAND',$objResponse->BRAND) }}"  autocomplete="off" maxlength="100" />
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="MODEL" id="MODEL" class="form-control " value="{{ old('MODEL',$objResponse->MODEL) }}"  autocomplete="off" maxlength="100" />
              </div>
              <div class="col-lg-2 pl"><p>Serial No</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="SERIAL_NO" id="SERIAL_NO" class="form-control "  value="{{ old('SERIAL_NO',$objResponse->SERIAL_NO) }}"   autocomplete="off" maxlength="20" />
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="SANCTION_LOAD" id="SANCTION_LOAD" class="form-control "  value="{{ old('SANCTION_LOAD',$objResponse->SANCTION_LOAD) }}"  autocomplete="off" maxlength="50" />
              </div>
              <div class="col-lg-2 pl"><p>Power Supply By</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="SUPPLY_BY" id="SUPPLY_BY" class="form-control " value="{{ old('SUPPLY_BY',$objResponse->SUPPLY_BY) }}"  autocomplete="off" maxlength="100" />
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 pl">
                <input type="text" name="REMARKS" id="REMARKS" class="form-control "  value="{{ old('REMARKS',$objResponse->REMARKS) }}"  autocomplete="off" maxlength="100" />
              </div>
            </div>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[223,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[223,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
