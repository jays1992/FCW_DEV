...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          @CSRF
          {{isset($objMstHeader->CKLISTID) ? method_field('PUT') : '' }}
              ...
              <div class="inner-form">
                <div class="inner-form">
                  ...
                  @endphp
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="CHECKLIST_DT" id="CHECKLIST_DT" class="form-control mandatory" value="{{ old('CHECKLIST_DT', $chklist_date ) }}"  placeholder="dd/mm/yyyy"/>
              ...
              <div class="row">
                    ...
                    <div class="col-lg-3 pl">
                      <input type="text" name="CHECKLIST_DESC" id="CHECKLIST_DESC" class="form-control " value="{{ old('CHECKLIST_DESC',  $objMstHeader->CHECKLIST_DESC) }}" maxlength="200"  />
                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        @foreach($objResponse as $key => $row)
                          ...
                          <tr  class="participantRow">
                              ...
                              <td><input type="text" name={{"txtFORM_popup_".$key}} id={{"txtFORM_popup_".$key}} class="form-control" value="{{ $row->MP_CODE }}"  autocomplete="off"  readonly style="width:100px;"  /></td>
                              <td hidden ><input type="text" name={{"FORMID_".$key}} id={{"hdnFORMID_".$key}} class="form-control" value="{{ $row->MPID_REF }}"  autocomplete="off" /></td>
                              <td><input  class="form-control" style="width: 100%" type="text" name={{"FORMNAME_".$key}} id ={{"FORMNAME_".$key}} value="{{ $row->MP_DESC }}"  style="width:200px;" autocomplete="off" readonly></td>
                              ...
                              <td><input type="text" name={{"txtLISTPOP1_popup_".$key}} id={{"txtLISTPOP1_popup_".$key}}  value="{{ $row->MSP_CODE }}" class="form-control "  autocomplete="off"  readonly style="width:100px;" /></td>
