          ...
          @CSRF
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                        <div class="col-lg-7 pl">
                          {{-- <input type="text" name="CHECKLIST_NO" id="CHECKLIST_NO" onkeypress="return AlphaNumaric(event,this)"  value="{{ old('CHECKLIST_NO') }}" class="form-control mandatory" autocomplete="off" maxlength="50" style="text-transform:uppercase"  /> --}}
                          @if(!empty($objDD))
                            @if($objDD->SYSTEM_GRSR == "1")
                                <input type="text" name="CHECKLIST_NO" id="CHECKLIST_NO" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @endif
                            @if($objDD->MANUAL_SR == "1")
                                <input type="text" name="CHECKLIST_NO" id="CHECKLIST_NO" value="{{ old('CHECKLIST_NO') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                            @endif
                        @endif  
                      ...
                      <div class="col-lg-2 pl">
                        <input type="date" name="CHECKLIST_DT" id="CHECKLIST_DT" class="form-control mandatory" value="{{ old('CHECKLIST_DT') }}" min="{{ Date('Y-m-d') }}" placeholder="dd/mm/yyyy"/>
                ...
                <div class="row">
                      ...
                      <div class="col-lg-3 pl">
                        <input type="text" name="CHECKLIST_DESC" id="CHECKLIST_DESC" class="form-control " value="{{ old('CHECKLIST_DESC') }}" maxlength="200"  />
...
function validateSingleElemnet(element_id){
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'{{route("master",[227,"codeduplicate"])}}',
            type:'POST',
            data:formData,
