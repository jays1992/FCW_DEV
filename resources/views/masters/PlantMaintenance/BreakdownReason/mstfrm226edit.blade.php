...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="{{route('master',[226,'index'])}}" class="btn singlebt">Breakdown Reason</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->BD_REASONID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->BD_REASON_CODE}} </label>
                    <input type="hidden" name="BD_REASONID" id="BD_REASONID" value="{{ $objResponse->BD_REASONID }}" />
                    <input type="hidden" name="BD_REASON_CODE" id="BD_REASON_CODE" value="{{ $objResponse->BD_REASON_CODE }}" autocomplete="off"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="BD_REASON_DESC" id="BD_REASON_DESC" class="form-control mandatory" value="{{ old('BD_REASON_DESC',$objResponse->BD_REASON_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[226,"add"])}}';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[226,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[226,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '{{route("master",[226,"index"]) }}';
