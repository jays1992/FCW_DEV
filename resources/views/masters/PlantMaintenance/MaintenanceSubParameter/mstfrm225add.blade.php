...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="{{route('master',[225,'index'])}}" class="btn singlebt">Maintenance Sub Parameter</a>
                </div><!--col-2-->
          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        {{-- <input type="text" name="MSP_CODE" id="MSP_CODE" onkeypress="return AlphaNumaric(event,this)" value="{{ old('MSP_CODE') }}" class="form-control mandatory" autocomplete="off" maxlength="50" tabindex="1" style="text-transform:uppercase" /> --}}
                        @if(!empty($objDD))
                            @if($objDD->SYSTEM_GRSR == "1")
                                <input type="text" name="MSP_CODE" id="MSP_CODE" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @endif
                            @if($objDD->MANUAL_SR == "1")
                                <input type="text" name="MSP_CODE" id="MSP_CODE" value="{{ old('MSP_CODE') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                            @endif
                        @endif  
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="MSP_DESC" id="MSP_DESC" class="form-control mandatory" value="{{ old('MSP_DESC') }}" maxlength="200" tabindex="2"  />
...
<script>
  ...
  $('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[225,"add"])}}';
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'{{route("master",[225,"codeduplicate"])}}',
            type:'POST',
            data:formData,
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                if(data.success) {                   
                  ...
                  //  window.location.href='{{ route("master",[225,"index"])}}';
                }
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('master',[225,'add'])}}";
