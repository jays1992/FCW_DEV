...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          @CSRF
          {{isset($objResponse->FUELID) ? method_field('PUT') : '' }}
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> {{$objResponse->FUEL_CODE}} </label>
                    <input type="hidden" name="FUELID" id="FUELID" value="{{ $objResponse->FUELID }}" />
                    <input type="hidden" name="FUEL_CODE" id="FUEL_CODE" value="{{ $objResponse->FUEL_CODE }}" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="FUEL_DESC" id="FUEL_DESC" class="form-control mandatory" value="{{ old('FUEL_DESC',$objResponse->FUEL_DESC) }}" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[162,"update"])}}',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'{{route("mastermodify",[162,"singleapprove"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
