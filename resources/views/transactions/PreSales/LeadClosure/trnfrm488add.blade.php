          ...
          @endif
            ...
            <div id="LeadClosure" class="tab-pane fade in active" style="margin-left: 16px; margin-top: 10px; width: 97%;">
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <select name="LEADCLOSURE" id="LCLOSUR" class="form-control">
                  ...
                  <div class="col-lg-2 pl">
                    <textarea name="REMARKSNAME" id="REMARKS" style="width: 357px; height: 40px;" class="form-control mandatory">{{isset($objResponse->REMARKS) && $objResponse->REMARKS !=''?$objResponse->REMARKS:''}}</textarea>
                  </div>
                </div>
