          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl"><p>Additonal Member Visit*</p></div>
                <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="text" name="ADDMEMBER_VISIT" id="ADDMEMBER_VISIT" onclick="getData('{{route('transaction',[$FormId,'getAddMemberVisitCode'])}}','Activity Type Details','ADDMEMBER_VISIT_REF')" class="form-control mandatory" autocomplete="off" readonly>
                  <input {{$ActionStatus}} type="hidden" name="ADDMEMBERVISIT_REF" id="ADDMEMBER_VISIT_REF" class="form-control mandatory">                              
                </div>
        ...
        <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
         ...
         <tbody>
          ...
          <tr  class="participantRow">   
            ...
            <td><a disabled  {{$key ==0?'':'disabled'}}  class="btn add" title="Edit" id="editrow_{{$key}}" data-toggle="tooltip" style="color: rgb(43, 41, 41);"><i class="fa fa-edit" onclick="getDataVal('{{$key}}')" style="cursor: pointer;"></i></a></td>
          </tr>
          @php $n++; @endphp
        @endforeach 
      @endif
