...
@inject('helper', 'App\Helpers\Helper')  
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Receipt Entry</a>
                </div><!--col-2-->
  ...
  <form id="frm_trn_rcpt"  method="POST"> 
      @csrf
      {{isset($objRCPTHDR->RECEIPTID) ? method_field('PUT') : '' }}
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="RECEIPT_NO" id="RECEIPT_NO" value="{{ isset($objRCPTHDR->RECEIPT_NO)?$objRCPTHDR->RECEIPT_NO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
        <div class="col-lg-1 pl"><p>Receipt Date*</p></div>
        <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="date" name="RECEIPT_DT" id="RECEIPT_DT" value="{{isset($objRCPTHDR->RECEIPT_DT)?$objRCPTHDR->RECEIPT_DT:''}}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-1 pl"><p>Receipt For*</p></div>
        <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="checkbox" name="chk_Customer" id="chk_Customer" {{ isset($objRCPTHDR->RECEIPT_FOR) && $objRCPTHDR->RECEIPT_FOR == 'Customer' ? 'checked' : ''}} />&nbsp;&nbsp;<label>   Customer </label>
        </div>
        <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="checkbox" name="chk_Vendor" id="chk_Vendor" {{ isset($objRCPTHDR->RECEIPT_FOR) && $objRCPTHDR->RECEIPT_FOR == 'Vendor' ? 'checked' : ''}} /> &nbsp;&nbsp;<label>   Vendor </label>
        </div>
        <div class="col-lg-1 pl">
              <input {{$ActionStatus}} type="checkbox" name="chk_Account" id="chk_Account" {{isset($objRCPTHDR->RECEIPT_FOR) && $objRCPTHDR->RECEIPT_FOR == 'Account' ? 'checked' : ''}} />&nbsp;&nbsp;<label>   Account </label> 
              <input type="hidden" name="hdnreceiptfor" id="hdnreceiptfor" value="{{ isset($objRCPTHDR->RECEIPT_FOR)?$objRCPTHDR->RECEIPT_FOR:'' }}" />
    ...
    <div class="row" id="divcust1" style="display:none;">
        ...
        <div class="col-lg-2 pl">
            @if(isset($objRCPTHDR->CUSTMER_VENDOR_ID) && $objRCPTHDR->CUSTMER_VENDOR_ID != '')
               <input {{$ActionStatus}} type="text" name="txtcustomer" id="txtcustomer" class="form-control" value="{{isset($objRCPTCUSTVNDR->CODE)?$objRCPTCUSTVNDR->CODE:''}} {{isset($objRCPTCUSTVNDR->NAME)?$objRCPTCUSTVNDR->NAME:''}}" readonly  />
            @else
               <input {{$ActionStatus}} type="text" name="txtcustomer" id="txtcustomer" class="form-control" readonly  />
            @endif
                <input type="hidden" name="CUSTMER_VENDOR_ID" id="CUSTMER_VENDOR_ID"  class="form-control " value="{{isset($objRCPTHDR->CUSTMER_VENDOR_ID)?$objRCPTHDR->CUSTMER_VENDOR_ID:''}}" />
        </div>
        <div class="col-lg-1 pl"><p>Receipt On Account*</p></div>        
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="checkbox" name="chk_RcptAccount" id="chk_RcptAccount" {{isset($objRCPTHDR->RECEIPT_ON_ACCOUNT) && $objRCPTHDR->RECEIPT_ON_ACCOUNT == 1 ? 'checked' : ''}} />
        </div>
        ...
        <div class="col-lg-2 pl" id="div_account_amt2" style="display:none;">
            <input {{$ActionStatus}} type="text" name="AMOUNT" id="AMOUNT" class="form-control two-digits" value="{{isset($objRCPTHDR->AMOUNT)?$objRCPTHDR->AMOUNT:''}}"  autocomplete="off" />
        </div>
    </div>
    ...
    <div class="col-lg-1 pl"><p>Type</p></div>        
        <div class="col-lg-2 pl">
        <select name="PDC_ECH_TYPE" {{$ActionStatus}} id="PDC_ECH_TYPE" class="form-control">                
                <option value="" >Type</option>
                <option value="PDC" {{isset($objRCPTHDR->RECORD_TYPE) && $objRCPTHDR->RECORD_TYPE == 'PDC' ? 'selected' : ''}} >PDC</option>
                <option value="ECH" {{isset($objRCPTHDR->RECORD_TYPE) && $objRCPTHDR->RECORD_TYPE == 'ECH' ? 'selected' : ''}} >ECH</option>
            </select>  
        </div>
        <div class="col-lg-1 pl"><p>PDC/ECH (Y/N)</p></div>        
        <div class="col-lg-2 pl">
            <input type="checkbox" {{$ActionStatus}} name="PDC_STATUS" id="PDC_STATUS" {{ isset($objRCPTHDR->PDC_STATUS) && $objRCPTHDR->PDC_STATUS == 1 ? 'checked' : ''}} />
        </div>
        <div class="col-lg-1 pl"><p>PDC/ECH Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" {{$ActionStatus}} name="PDC_DT" id="PDC_DT"  value="{{isset($objRCPTHDR->PDC_DT)?$objRCPTHDR->PDC_DT:''}}"  class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>

        <div class="col-lg-1 pl"><p>Clear/ECH PDC (Y/N)</p></div>        
        <div class="col-lg-2 pl">
            <input type="checkbox" {{$ActionStatus}} name="CLEAR_PDC_STATUS" id="CLEAR_PDC_STATUS" {{ isset($objRCPTHDR->CLEAR_PDC_STATUS) && $objRCPTHDR->CLEAR_PDC_STATUS == 1 ? 'checked' : ''}} />
        </div>
        </div>
        <div class="row" >
        <div class="col-lg-1 pl"><p>Clear/ECH PDC Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" {{$ActionStatus}} name="CLEAR_PDC_DT" id="CLEAR_PDC_DT"  value="{{isset($objRCPTHDR->CLEAR_PDC_DT)?$objRCPTHDR->CLEAR_PDC_DT:''}}"  class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
    </div>
    ...
    <div class="row">
		<div id="divcust2" style="display:none;">
			...
			<div class="col-lg-2 pl">
					<input {{$ActionStatus}} type="text" name="txtcashbk" id="txtcashbk" class="form-control" value="{{isset($objRCPTCASHBANK->BCODE)?$objRCPTCASHBANK->BCODE:''}} {{isset($objRCPTCASHBANK->NAME)?$objRCPTCASHBANK->NAME:''}}" readonly  />
					<input type="hidden" name="CASH_BANK_ID" id="CASH_BANK_ID"  class="form-control " value="{{isset($objRCPTHDR->CASH_BANK_ID)?$objRCPTHDR->CASH_BANK_ID:''}}" />
					<input type="hidden" name="RECEIPT_TYPE" id="RECEIPT_TYPE"  class="form-control " value="{{isset($objRCPTHDR->RECEIPT_TYPE)?$objRCPTHDR->RECEIPT_TYPE:''}}" />
					<label id="BALANCE_SHOW"> 
					{{isset($objRCPTCASHBANK->BCODE) && $objRCPTCASHBANK->BCODE!=''? 'Balance '.$helper->getBalance_Show($objRCPTCASHBANK->GLID_REF):''}}
				  </label>
			</div>
		</div>
        <div class="col-lg-1 pl"><p>Transaction Date*</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="TRANSACTION_DT" id="TRANSACTION_DT" class="form-control"  placeholder="dd/mm/yyyy" value="{{isset($objRCPTHDR->TRANSACTION_DT)?$objRCPTHDR->TRANSACTION_DT:''}}"  />
        </div>
        <div class="col-lg-1 pl"><p>Instrument Type*</p></div>
        <div class="col-lg-2 pl">
            <select {{$ActionStatus}} name="INSTRUMENT_TYPE" id="INSTRUMENT_TYPE" class="form-control">
                <option value="Cheque" {{isset($objRCPTHDR->INSTRUMENT_TYPE) && $objRCPTHDR->INSTRUMENT_TYPE == 'Cheque' ? 'selected' : ''}} >Cheque</option>
                <option value="NEFT" {{isset($objRCPTHDR->INSTRUMENT_TYPE) && $objRCPTHDR->INSTRUMENT_TYPE == 'NEFT' ? 'selected' : ''}} >NEFT</option>
                <option value="RTGS" {{isset($objRCPTHDR->INSTRUMENT_TYPE) && $objRCPTHDR->INSTRUMENT_TYPE == 'RTGS' ? 'selected' : ''}} >RTGS</option>
            </select>                        
        </div>
        <div class="col-lg-1 pl"><p>Instrument No*</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="INSTRUMENT_NO" id="INSTRUMENT_NO" class="form-control"  autocomplete="off" value="{{isset($objRCPTHDR->INSTRUMENT_NO)?$objRCPTHDR->INSTRUMENT_NO:''}}"  />                        
        </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input type="checkbox" {{$ActionStatus}} name="FC" id="FC" class="form-checkbox" {{isset($objRCPTHDR->FC) && $objRCPTHDR->FC == 1 ? 'checked' : ''}} >
      </div>
      
      <div class="col-lg-1 pl"><p>Currency</p></div>
      <div class="col-lg-2 pl" id="divcurrency" >      
          <input type="text" {{$ActionStatus}} name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="{{ isset($objRCPTHDR->CRDESCRIPTION) && $objRCPTHDR->CRDESCRIPTION !=''? $objRCPTHDR->CRCODE.'-'.$objRCPTHDR->CRDESCRIPTION:'' }}"/>
      
          <input type="hidden"  name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="{{ isset($objRCPTHDR->CRID_REF)?$objRCPTHDR->CRID_REF:'' }}" />
          
      </div>
      
      <div class="col-lg-1 pl"><p>Conversion Factor</p></div>
      <div class="col-lg-2 pl">
          <input type="text" {{$ActionStatus}} name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('tot_amt1')" maxlength="100" autocomplete="off" value="{{ isset($objRCPTHDR->CONVFACT)?$objRCPTHDR->CONVFACT:'' }}"  />
      </div>
  </div>
    ...
    <div class="row"  id="divcust3"  style="display:none;">	
        ...
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="BANK_CHARGE" id="BANK_CHARGE" class="form-control two-digits"  autocomplete="off" value="{{isset($objRCPTHDR->BANK_CHARGE)?$objRCPTHDR->BANK_CHARGE:''}}" />
        </div>                          
        <div class="col-lg-1 pl"><p>Amount*</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="tot_amt1" id="tot_amt1" class="form-control"  autocomplete="off" readonly  />
        </div>
        <div class="col-lg-1 pl"><p>Common Narration</p></div>
        <div class="col-lg-5 pl">
            <input {{$ActionStatus}} type="text" name="NARRATION" id="NARRATION" class="form-control"  autocomplete="off" value="{{isset($objRCPTHDR->NARRATION)?$objRCPTHDR->NARRATION:''}}" />                        
        </div>
    </div>
    ...
    <div class="row"  id=""  >	
        ...
        <div class="col-lg-2 pl">
        <input type="text"  {{$ActionStatus}} name="GLpopup" id="txtGLpopup" class="form-control mandatory" value="{{isset($objGl->GLCODE)?$objGl->GLCODE.'-'.$objGl->GLNAME:''}}"  autocomplete="off"  readonly/>
        <input type="hidden" name="GLID_REF_ROUNDOFF" id="GLID_REF_ROUNDOFF" class="form-control" value="{{isset($objRCPTHDR->ROUNDOFF_GLID)?$objRCPTHDR->ROUNDOFF_GLID:''}}" autocomplete="off" />
        <label id="BALANCE_ROUNDGL_SHOW"> 
                {{isset($objGl->GLCODE) && $objGl->GLCODE!=''? 'Balance '.$helper->getBalance_show($objRCPTHDR->ROUNDOFF_GLID):''}}
              </label>
        </div>                          
        <div class="col-lg-1 pl"><p>Round of GL Amount</p></div>
        <div class="col-lg-2 pl">
            <input type="text"  {{$ActionStatus}} name="ROUNDOFF_AMT" id="ROUNDOFF_AMT" class="form-control" value="{{isset($objRCPTHDR->ROUNDOFF_AMT)?$objRCPTHDR->ROUNDOFF_AMT:''}}" autocomplete="off"  onkeyup="calculateBankAmount()"  />
        </div>
        <div class="col-lg-1 pl"><p>Round of Mode</p></div>
        <div class="col-lg-2 pl">
        <select name="ROUNDOFF_MODE"  {{$ActionStatus}}  id="ROUNDOFF_MODE" class="form-control" onchange="calculateBankAmount()" >
                <option value="Positive" {{ isset($objRCPTHDR->ROUNDOFF_MODE) && $objRCPTHDR->ROUNDOFF_MODE == 'Positive' ? 'selected' : ''}}>Debit</option>
                <option value="Negative" {{ isset($objRCPTHDR->ROUNDOFF_MODE) && $objRCPTHDR->ROUNDOFF_MODE == 'Negative' ? 'selected' : ''}}>Credit</option>
              </select>                                  
        </div>
    ...
    <div class="row"  id="divcust4"  style="display:none;">	
        ...
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="checkbox" name="CENTERLIZED_RECEIPT" id="CENTERLIZED_RECEIPT" {{isset($objRCPTHDR->CENTERLIZED_RECEIPT) && $objRCPTHDR->CENTERLIZED_RECEIPT == 1 ? 'checked' : ''}}   />
        </div> 
    </div>
	</div>
      ...
      <div class="tab-content">
        <div id="Invoice" class="tab-pane fade in ">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tbody>
                    @if(!empty($objRCPTINV))
                      @foreach($objRCPTINV as $key => $row)
                          <tr  class="participantRow2">
                              <td><input {{$ActionStatus}} type="text" name={{"txtDoc_NO_".$key}} id={{"txtDoc_NO_".$key}} class="form-control"  autocomplete="off" value="{{$row->DOCNO}}" readonly/></td>
                              <td hidden><input type="hidden" name={{"DOCNO_ID_".$key}} id={{"DOCNO_ID_".$key}} class="form-control" value="{{$row->DOCNO_ID}}" autocomplete="off" />
                              <input type="hidden" name="rowcount1[]" id="rowcount1[]" class="form-control" autocomplete="off" /></td>
                 
                              <td><input {{$ActionStatus}} type="text" name={{"Doc_Type_".$key}} id={{"Doc_Type_".$key}} class="form-control"  autocomplete="off" value="{{$row->DOC_TYPE}}" readonly/></td>
                              <td><input {{$ActionStatus}} type="text" name={{"DocDate_".$key}} id={{"DocDate_".$key}} class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" value="{{$row->DOCDT}}" readonly /></td>
                              <td><input {{$ActionStatus}} type="text" name={{"DocAmount_".$key}} id={{"DocAmount_".$key}} class="form-control two-digits"  autocomplete="off" value="{{$row->DOCAMT}}" readonly/></td>
                      @php
                          $BALANCE_DUE=number_format(($row->BALANCE_DUE+$row->RECEIPT_AMT),2, '.', '');
                      @endphp
                              <td><input {{$ActionStatus}} type="text" name={{"BALANCE_DUE_".$key}} id={{"BALANCE_DUE_".$key}} class="form-control two-digits" maxlength="15" value="{{$BALANCE_DUE}}" autocomplete="off"  readonly/></td>
                              <td><input {{$ActionStatus}} type="text" name={{"RECEIPT_AMT_".$key}} id={{"RECEIPT_AMT_".$key}} class="form-control two-digits" maxlength="15" value="{{$row->RECEIPT_AMT}}" autocomplete="off" /></td>
                              <td><input {{$ActionStatus}} type="text" name={{"REMARKS_".$key}} id={{"REMARKS_".$key}} class="form-control" maxlength="200" autocomplete="off" value="{{$row->REMARKS}}" /></td>
                              <td><input {{$ActionStatus}} type="text" name={{"TxtBranch_".$key}} id={{"TxtBranch_".$key}} class="form-control" value="{{$row->BRANCH}}" readonly  /></td>
                              ...
                              <td align="center" >
                                <button {{$ActionStatus}} class="btn add ainvoice" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                                <button {{$ActionStatus}} class="btn remove dinvoice" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button>
                              </td>
                          </tr>
                          <tr></tr>
                      @endforeach 
                    @else
                          <tr  class="participantRow2">
                              <td><input {{$ActionStatus}} type="text" name="txtDoc_NO_0" id="txtDoc_NO_0" class="form-control"  autocomplete="off"  readonly/></td>
                              ...
                              <td><input {{$ActionStatus}} type="text" name="Doc_Type_0" id="Doc_Type_0" class="form-control"  autocomplete="off"  readonly/></td>
                              <td><input {{$ActionStatus}} type="text" name="DocDate_0" id="DocDate_0" class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly /></td>
                              <td><input {{$ActionStatus}} type="text" name="DocAmount_0" id="DocAmount_0" class="form-control two-digits"  autocomplete="off"  readonly/></td>
                              <td><input {{$ActionStatus}} type="text" name="BALANCE_DUE_0" id="BALANCE_DUE_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                              <td><input {{$ActionStatus}} type="text" name="RECEIPT_AMT_0" id="RECEIPT_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                              <td><input {{$ActionStatus}} type="text" name="REMARKS_0" id="REMARKS_0" class="form-control" maxlength="200" autocomplete="off"  /></td>
                              <td><input {{$ActionStatus}} type="text" name="TxtBranch_0" id="TxtBranch_0" class="form-control" readonly  /></td>
        ...
        <div id="Account" class="tab-pane fade in">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                    <input {{$ActionStatus}} type="text" name="txtbnkcsh" id="txtbnkcsh" class="form-control" value="{{isset($objRCPTCASHBANK->BCODE)?$objRCPTCASHBANK->BCODE:''}} {{isset($objRCPTCASHBANK->NAME)?'-'.$objRCPTCASHBANK->NAME:''}}" readonly  />
                    <input type="hidden" name="BANK_CASH_ID" id="BANK_CASH_ID"  class="form-control" value="{{isset($objRCPTHDR->CASH_BANK_ID)?$objRCPTHDR->CASH_BANK_ID:'' }}" />
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="BANK_AMOUNT" id="BANK_AMOUNT" value="{{isset($objRCPTHDR->BANK_AMOUNT)?$objRCPTHDR->BANK_AMOUNT:'' }}" class="form-control"  readonly autocomplete="off"  />
                </div>

                <div class="col-lg-1 pl"><p>Common Narration</p></div>
                <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="text" name="BANK_REMARKS" id="BANK_REMARKS" value="{{isset($objRCPTHDR->BANK_REMARKS)?$objRCPTHDR->BANK_REMARKS:'' }}" class="form-control" autocomplete="off" />
                </div>
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:240px;" >
                <table id="example3" class="display nowrap table table-striped table-bordered itemlist " width="100%" style="height:auto !important;">
                  ...
                  @if(!empty($objRCPTACCOUNT))
                    @foreach($objRCPTACCOUNT as $gkey => $grow)
                      <tr  class="participantRow3">
                          <td><input {{$ActionStatus}} type="text" name={{"popupAccount_".$gkey}} id={{"popupAccount_".$gkey}} class="form-control" value="{{$grow->GLCODE}}" autocomplete="off" readonly/></td>
                          ...
                          <td><input {{$ActionStatus}} type="text" name={{"AccountName_".$gkey}} id={{"AccountName_".$gkey}} class="form-control"  autocomplete="off" value="{{$grow->GLNAME}}" readonly/></td>
                          <td><input {{$ActionStatus}} type="text" name={{"ACCOUNT_BALANCE_".$gkey}} id={{"ACCOUNT_BALANCE_".$gkey}} class="form-control"  autocomplete="off" value="{{$helper->getBalance_show($grow->GLID_REF)}}" readonly/></td>
                          <td><input {{$ActionStatus}} type="text" name={{"AMOUNT_".$gkey}} id={{"AMOUNT_".$gkey}} class="form-control two-digits right" maxlength="15" value="{{$grow->AMOUNT}}" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name={{"calIGST_".$gkey}} id={{"calIGST_".$gkey}} class="form-control four-digits right" maxlength="8" value="{{$grow->IGST}}" autocomplete="off"  /></td>
                      @php
                          $AmtIGST=number_format((($grow->AMOUNT*$grow->IGST)/100),2, '.', '');
                      @endphp
                          <td><input {{$ActionStatus}} type="text" name={{"AMTIGST_".$gkey}} id={{"AMTIGST_".$gkey}} class="form-control two-digits right" maxlength="15" value="{{$AmtIGST}}" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name={{"calCGST_".$gkey}} id={{"calCGST_".$gkey}} class="form-control four-digits right" maxlength="8" value="{{$grow->CGST}}" autocomplete="off"  /></td>
                      @php
                          $AmtCGST=number_format((($grow->AMOUNT*$grow->CGST)/100),2, '.', '');
                      @endphp
                          <td><input {{$ActionStatus}} type="text" name={{"AMTCGST_".$gkey}} id={{"AMTCGST_".$gkey}} class="form-control two-digits right" maxlength="15" value="{{$AmtCGST}}" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name={{"calSGST_".$gkey}} id={{"calSGST_".$gkey}} class="form-control four-digits right" maxlength="8" value="{{$grow->SGST}}" autocomplete="off"  /></td>
                      @php
                          $AmtSGST=number_format((($grow->AMOUNT*$grow->SGST)/100),2, '.', '');
                      @endphp
                          <td><input {{$ActionStatus}} type="text" name={{"AMTSGST_".$gkey}} id={{"AMTSGST_".$gkey}} class="form-control two-digits right" maxlength="15" value="{{$AmtSGST}}" autocomplete="off"  /></td>
                          <td align="center" ><button {{$ActionStatus}} class="btn" id={{"BtnCCID_".$gkey}} name={{"BtnCCID_".$gkey}} type="button"><i class="fa fa-clone"></i></button></td>
                          <td hidden><input {{$ActionStatus}} type="text" name={{"CCID_REF_".$gkey}} id={{"CCID_REF_".$gkey}} class="form-control"  autocomplete="off" value="{{$grow->CCID_REF}}"  readonly/></td>
                          <td>
                          <select {{$ActionStatus}} name={{"TYPE_".$gkey}} id={{"TYPE_".$gkey}}   class="form-control" style="width: 85px;">
                          <option value="Advance" {{isset($grow->TYPE) && $grow->TYPE =="Advance" ? "selected":""}} >Advance</option>
                          <option value="Loan" {{isset($grow->TYPE) && $grow->TYPE =="Loan" ? "selected":""}}>Loan</option>                            
                          <option value="Medical" {{isset($grow->TYPE) && $grow->TYPE =="Medical" ? "selected":""}}>Medical</option>
                          <option value="Conveyance" {{isset($grow->TYPE) && $grow->TYPE =="Conveyance" ? "selected":""}}>Conveyance</option>
                          <option value="Others" {{isset($grow->TYPE) && $grow->TYPE =="Others" ? "selected":""}}>Others</option>
                          </select></td>
                      @php
                          $AmtIGST=number_format((($grow->AMOUNT*$grow->IGST)/100),2, '.', '');
                          $AmtCGST=number_format((($grow->AMOUNT*$grow->CGST)/100),2, '.', '');
                      ...
                      @endphp
                          <td><input {{$ActionStatus}} type="text" name={{"TOTAMT_".$gkey}} id={{"TOTAMT_".$gkey}} class="form-control two-digits right"  maxlength="15" autocomplete="off" value="{{$TotAmt}}"  readonly/></td>
                          <td align="center" >
                            <button {{$ActionStatus}} class="btn add aaccount" title="add" data-toggle="tooltip" type="button" ><i class="fa fa-plus"></i></button>
                            <button {{$ActionStatus}} class="btn remove daccount" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button>
                          </td>
                      </tr>
                      <tr></tr>
                    @endforeach
                  @else
                      <tr  class="participantRow3">
                          <td><input {{$ActionStatus}} type="text" name="popupAccount_0" id="popupAccount_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td hidden><input type="hidden" name="GLID_REF_0" id="GLID_REF_0" class="form-control" autocomplete="off" /></td>
                          <td><input {{$ActionStatus}} type="text" name="AccountName_0" id="AccountName_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td><input {{$ActionStatus}} type="text" name="ACCOUNT_BALANCE_0" id="ACCOUNT_BALANCE_0" class="form-control"  autocomplete="off" value="" readonly/></td>
                          <td><input {{$ActionStatus}} type="text" name="AMOUNT_0" id="AMOUNT_0" class="form-control two-digits right" maxlength="15" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name="calIGST_0" id="calIGST_0" class="form-control four-digits right" maxlength="8" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name="AMTIGST_0" id="AMTIGST_0" class="form-control two-digits right" maxlength="15" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name="calCGST_0" id="calCGST_0" class="form-control four-digits right" maxlength="8" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name="AMTCGST_0" id="AMTCGST_0" class="form-control two-digits right" maxlength="15" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name="calSGST_0" id="calSGST_0" class="form-control four-digits right" maxlength="8" autocomplete="off"  /></td>
                          <td><input {{$ActionStatus}} type="text" name="AMTSGST_0" id="AMTSGST_0" class="form-control two-digits right" maxlength="15" autocomplete="off"  /></td>
                          <td align="center" ><button {{$ActionStatus}} class="btn" id="BtnCCID_0" name="BtnCCID_0" type="button"><i class="fa fa-clone"></i></button></td>
                          <td hidden><input {{$ActionStatus}} type="text" name="CCID_REF_0" id="CCID_REF_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td><input {{$ActionStatus}} type="text" name="TOTAMT_0" id="TOTAMT_0" class="form-control two-digits right"  maxlength="15" autocomplete="off"  readonly/></td>
                          <td align="center" >
                            <button {{$ActionStatus}} class="btn add aaccount" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button>
                            <button {{$ActionStatus}} class="btn remove daccount" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button>
                          </td>
                      </tr>
                      <tr></tr>
            ...
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                  <select {{$ActionStatus}} name="drpTDS" id="drpTDS" class="form-control">
                      <option value=""></option>    
                      <option {{ isset($objRCPTHDR->TDS) && $objRCPTHDR->TDS =='1'?'selected="selected"':'' }} value="Yes">Yes</option>
                      <option {{ isset($objRCPTHDR->TDS) && $objRCPTHDR->TDS =='0'?'selected="selected"':'' }} value="No">No</option>
                  </select>
                </div>
            </div>
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example7" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tbody id="tbody_tds">
                    @if(!empty($objRECEIPTTDS))
                      @foreach($objRECEIPTTDS as $tkey => $trow)
        ...
        <div id="CostCenter" class="tab-pane fade" >
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
                <table id="example5" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    ...
                    <tbody>
                    @if(!empty($objRCPTCCD))
                      @foreach($objRCPTCCD as $ckey => $crow)
                        <tr  class="participantRow5">
                            <td><input {{$ActionStatus}} type="text" name={{"GLID_".$ckey}} id={{"GLID_".$ckey}} class="form-control"  autocomplete="off" value="{{$crow->GLID_REF}}" readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name={{"CCID_".$ckey}} id={"CCID_".$ckey}} class="form-control" autocomplete="off" value="{{$crow->CCID_REF}}"  readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name={{"GL_AMT_".$ckey}} id={{"GL_AMT_".$ckey}} class="form-control two-digits" value="{{$crow->AMT}}"  autocomplete="off" readonly/></td>                        
                        </tr>
                        <tr></tr>
                      @endforeach
                    @else
                      <tr  class="participantRow5">
                          ...
                          <td><input {{$ActionStatus}} type="text" name="GL_AMT_0" id="GL_AMT_0" class="form-control two-digits"   autocomplete="off" readonly/></td>                        
                      </tr>
                      <tr></tr>
                    @endif
                    </tbody>
    ...
    <tr>
      ...
      <table id="BankCodeTable2" class="display nowrap table  table-striped table-bordered" style="width:100%;" >
        ...
        @foreach ($objBank as $index=>$bkRow)
          <tr >
              <td style="width:10%; text-align: center;"><input type="checkbox" id="bkidcode_{{ $index }}" name="BANKPOPUP1[]"  value="{{ $bkRow-> BID }}" class="js-selectall1 clsbkid"  ></td>
              <td style="width:20%;">{{ $bkRow-> BCODE }}
                <input type="hidden" id="txtbkidcode_{{ $index }}" data-desc="{{ $bkRow-> BCODE }}" data-desc2="{{ $bkRow-> NAME }}"  data-glid_ref="{{ $bkRow->GLID_REF }}"  data-desc3="{{ $bkRow-> BANK_CASH }}" value="{{ $bkRow-> BID }}"/>
              </td>
...
<div id="bank2_popup" class="modal" role="dialog"  data-backdrop="static">
 <div class="modal-dialog modal-md" style="width:90%;">
    ...
    <tr>
            <th style="width:7%; text-align:center;" id="all-check">Select</th>
            <th style="width:13%;">Code</th>
            <th style="width:13%;">Name</th>
            <th style="width:13%;">Branch</th>
            <th style="width:13%;">IFSC</th>
    ...
    <tbody>
    <tr>
      <td style="width:7%;text-align:center;"><input type="checkbox" class="js-selectall" data-target=".js-selectall1" disabled /></td>
      <td style="width:13%;">
      ...
      <table id="Bank2CodeTable2" class="display nowrap table  table-striped table-bordered" style="width:100%;">
        ...
        @foreach ($objBank as $index=>$bkRow)
            <tr>
              <td style="width:7%; text-align: center;"><input type="checkbox" id="bkidcode2_{{ $index }}" name="CASHBANKPOPUP2[]" value="{{ $bkRow-> BID }}" class="js-selectall1 clsbkid2"  ></td>

              
              <td style="width:13%;">{{ $bkRow-> BCODE }}
                <input type="hidden" id="txtbkidcode2_{{ $index }}" data-desc="{{ $bkRow-> BCODE }}"  data-glid_ref="{{ $bkRow->GLID_REF }}" data-desc2="{{ $bkRow-> NAME }}"  value="{{ $bkRow-> BID }}"/>
              </td>
              <td style="width:13%;">{{ $bkRow-> NAME }}</td>
              <td style="width:13%;">{{ $bkRow-> BRANCH }}</td>
              <td style="width:13%;">{{ $bkRow-> IFSC }}</td>
              <td style="width:13%;">{{ $bkRow-> ACTYPE }}</td>
              <td style="width:13%;">{{ $bkRow-> ACNO }}</td>
              <td style="width:15%;">{{ $bkRow-> ADD1 }} {{ $bkRow-> ADD2 }} {{ $bkRow-> CITY }} {{ $bkRow-> STATE }} {{ $bkRow-> COUNTRY }} {{ $bkRow-> PIN }}</td>
          </tr>
        @endforeach
        </tbody>
      </table>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Receipt Voucher Print</p></div>
        <div class="row">
    ...
    $(".clscustid").click(function(){
          ...
          if (txtval != oldCUSTMER_VENDOR_ID)
          {
              ...
              $.ajaxSetup({
                  ...
                  $.ajax({
                      url:'{{route("transaction",[302,"getTDSApplicability"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data){
                        if(data == 1){
                          ...
                          $('#drpTDS').val('Yes');
                              ...
                              $.ajax({
                                  url:'{{route("transaction",[302,"getTDSDetails"])}}',
                                  type:'POST',
                                  data:{'id':customid},
                                  success:function(data) {
                                    $("#tbody_tds").html('');
          ...
          $.ajaxSetup({
                  ...
                  $.ajax({
                      url:'{{route("transaction",[302,"getTDSApplicability_customer"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data){
                        if(data == 1){
                          ...
                          $('#drpTDS').val('Yes');
                              ...
                              $.ajax({
                                  url:'{{route("transaction",[302,"getTDSDetails_customer"])}}',
                                  type:'POST',
                                  data:{'id':customid},
                                  success:function(data) {
                                    $("#tbody_tds").html('');
 ...
 else if($('#chk_Account').is(':checked') == true && BANK_CASH_ID ==="")
 {
    ...
    var allblank12 = [];
        ...
        if(jQuery.inArray("false", allblank) !== -1){
          ...
          else if(checkPeriodClosing('{{$FormId}}',$("#RECEIPT_DT").val(),0) ==0){
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
...
let GL = "#GeneralLedgerTable2";
  ...
  $('#txtGLpopup').on('click',function(event){     
                $("#GLresult").html('');
                  ...
                  $("#item_seach").show();
                  $.ajax({
                      url:'{{route("transaction",[302,"get_gl_detail"])}}',
                      type:'POST',
                      data:{},
                      success:function(data) {                                
                        $("#item_seach").hide();
...
var TaxStatus = $.ajax({type: 'POST',url:'{{route("transaction",[302,"getTaxStatus_customer"])}}',async: false,dataType: 'json',data: {id:customid},done: function(response) {return response;}}).responseText;
...
var TaxStatus = $.ajax({type: 'POST',url:'{{route("transaction",[302,"getTaxStatus"])}}',async: false,dataType: 'json',data: {id:customid},done: function(response) {return response;}}).responseText;
...
function getBalance(bankid,fieldid,fieldidshow){
  ...
  url:'{{route("transaction",[302,"getBalance"])}}',
  async: false,
  dataType: 'json',
  data: {id:bankid},
...
$('#btnPrint').on('click', function() {
            var DOCID    ='{{$objRCPTHDR->RECEIPTID}}';     
            var Flag    = 'H';
            var formData = 'SO='+ DOCID + '&RECEIPTID='+ DOCID + '&Flag='+ Flag ;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                url:'{{route("transaction",[302,"ViewReport"])}}',
                type:'POST',
                data:formData,
                success:function(data) {
  ...
  $('#btnExcel').on('click', function() {
            ...
            var Flag = 'E';
            var formData = 'SO='+ DOCID + '&RECEIPTID='+ DOCID + '&Flag='+ Flag ;
            var consultURL = '{{route("transaction",[302,"ViewReport",":rcdId"]) }}';
