  ...
  <form id="frm_trn_pay"  method="POST"> 
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="PAYMENT_NO" id="PAYMENT_NO" value="{{isset($objPAYHDR->PAYMENT_NO)?$objPAYHDR->PAYMENT_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
        </div>
        <div class="col-lg-1 pl"><p>Payment Date*</p></div>
        <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="date" name="PAYMENT_DT" id="PAYMENT_DT" value="{{isset($objPAYHDR->PAYMENT_DT)?$objPAYHDR->PAYMENT_DT:''}}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-1 pl"><p>Payment For*</p></div>
        <div class="col-lg-1 pl">
              <input {{$ActionStatus}} type="checkbox" name="chk_Vendor" id="chk_Vendor" {{isset($objPAYHDR->PAYMENT_FOR) && $objPAYHDR->PAYMENT_FOR == 'Vendor' ? 'checked' : ''}} /> &nbsp;&nbsp;<label>   Vendor </label>
        </div>
        
        <div class="col-lg-1 pl">
              <input {{$ActionStatus}} type="checkbox" name="chk_Customer" id="chk_Customer" {{isset($objPAYHDR->PAYMENT_FOR) && $objPAYHDR->PAYMENT_FOR == 'Customer' ? 'checked' : ''}} />&nbsp;&nbsp;<label>   Customer </label>
        </div>

        <div class="col-lg-1 pl">
          <input {{$ActionStatus}} type="checkbox" name="chk_Employee" id="chk_Employee" {{isset($objPAYHDR->PAYMENT_FOR) && $objPAYHDR->PAYMENT_FOR == 'Employee' ? 'checked' : ''}} />&nbsp;&nbsp;<label>   Employee </label>
        </div>

        <div class="col-lg-1 pl">
              <input {{$ActionStatus}} type="checkbox" name="chk_Account" id="chk_Account" {{isset($objPAYHDR->PAYMENT_FOR) && $objPAYHDR->PAYMENT_FOR == 'Account' ? 'checked' : ''}} />&nbsp;&nbsp;<label>   Account </label> 
              <input type="hidden" name="hdnpaymentfor" id="hdnpaymentfor" value="{{isset($objPAYHDR->PAYMENT_FOR)?$objPAYHDR->PAYMENT_FOR:''}}" />
              ...
              <input type="hidden" name="hdntds" id="hdntds" />
    ...
    <div class="row" id="divcust1"  style="display:none">
        ...
        <div class="col-lg-2 pl">
            @if(isset($objPAYHDR->CUSTMER_VENDOR_ID) && $objPAYHDR->CUSTMER_VENDOR_ID != '')
               <input {{$ActionStatus}} type="text" name="txtcustomer" id="txtcustomer" class="form-control" value="{{isset($objPAYCUSTVNDR->CODE)?$objPAYCUSTVNDR->CODE:''}} {{isset($objPAYCUSTVNDR->NAME)?$objPAYCUSTVNDR->NAME:''}}" readonly  />
            @else
               <input {{$ActionStatus}} type="text" name="txtcustomer" id="txtcustomer" class="form-control" readonly  />
            @endif
                <input type="hidden" name="CUSTMER_VENDOR_ID" id="CUSTMER_VENDOR_ID"  class="form-control " value="{{isset($objPAYHDR->CUSTMER_VENDOR_ID)?$objPAYHDR->CUSTMER_VENDOR_ID:''}}" />
        </div>
        <div class="col-lg-1 pl"><p>Payment On Account</p></div>        
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="checkbox" name="chk_PayAccount" id="chk_PayAccount" {{isset($objPAYHDR->PAYMENT_ON_ACCOUNT) && $objPAYHDR->PAYMENT_ON_ACCOUNT == 1 ? 'checked' : ''}} />
        </div>
        ...
        <div class="col-lg-2 pl" id="div_account_amt2" style="display:none;">
            <input {{$ActionStatus}} type="text" name="AMOUNT" id="AMOUNT" class="form-control two-digits"  autocomplete="off" value="{{isset($objPAYHDR->AMOUNT)?$objPAYHDR->AMOUNT:''}}" />
        </div>
    </div>
	<div class="row"  id="po_section"  >	
        <div class="col-lg-1 pl"><p>PO No</p></div>
        <div class="col-lg-2 pl">
        <input type="text" name="POpopup" id="txtPOpopup" class="form-control mandatory"  autocomplete="off" value="{{isset($objPAYHDR->PO_NO)?$objPAYHDR->PO_NO:''}}"  readonly/>
        <input type="hidden" name="POID_REF" id="POID_REF" class="form-control" value="{{isset($objPAYHDR->POID_REF)?$objPAYHDR->POID_REF:''}}" autocomplete="off" />
        </div>
        <div class="col-lg-1 pl"><p>PO Date</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="PODT" id="PODT" class="form-control" value="{{isset($objPAYHDR->PO_DT)?$objPAYHDR->PO_DT:''}}"  autocomplete="off"  readonly  />
        </div>
    </div>
    <div class="row">
		<div id="divcust2" style="display:none;">
			...
			<div class="col-lg-2 pl">
					<input {{$ActionStatus}} type="text" name="txtcashbk" id="txtcashbk" class="form-control" value="{{isset($objPAYCASHBANK->BCODE)?$objPAYCASHBANK->BCODE:''}} {{isset($objPAYCASHBANK->NAME)?$objPAYCASHBANK->NAME:''}}" readonly  />
					<input type="hidden" name="CASH_BANK_ID" id="CASH_BANK_ID"  class="form-control " value="{{isset($objPAYHDR->CASH_BANK_ID)?$objPAYHDR->CASH_BANK_ID:''}}" />
					<input type="hidden" name="PAYMENT_TYPE" id="PAYMENT_TYPE"  class="form-control " value="{{isset($objPAYHDR->PAYMENT_TYPE)?$objPAYHDR->PAYMENT_TYPE:''}}" />
					<input type="hidden" name="ODLIMIT" id="ODLIMIT"  class="form-control " value="{{isset($objPAYHDR->ODLIMIT)?$objPAYHDR->ODLIMIT:'0.00'}}" />
					<label style="display:none" id="BALANCE"> 
					{{isset($objPAYCASHBANK->BCODE) && $objPAYCASHBANK->BCODE!=''? 'Balance '.$helper->getBalance($objPAYCASHBANK->GLID_REF):''}}
				  </label>
					<label id="BALANCE_SHOW"> 
					{{isset($objPAYCASHBANK->BCODE) && $objPAYCASHBANK->BCODE!=''? 'Balance '.$helper->getBalance_Show($objPAYCASHBANK->GLID_REF):''}}
				  </label>
			</div>
		</div>
        <div class="col-lg-1 pl"><p>Transaction Date*</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="TRANSACTION_DT" id="TRANSACTION_DT" class="form-control"  placeholder="dd/mm/yyyy" value="{{isset($objPAYHDR->TRANSACTION_DT)?$objPAYHDR->TRANSACTION_DT:''}}"  />
        </div>
        ...
        <div class="col-lg-2 pl">
            <select {{$ActionStatus}} name="INSTRUMENT_TYPE" id="INSTRUMENT_TYPE" class="form-control">
                <option value="Cheque" {{ isset($objPAYHDR->INSTRUMENT_TYPE) && $objPAYHDR->INSTRUMENT_TYPE == 'Cheque' ? 'selected' : ''}} >Cheque</option>
                <option value="NEFT" {{ isset($objPAYHDR->INSTRUMENT_TYPE) && $objPAYHDR->INSTRUMENT_TYPE == 'NEFT' ? 'selected' : ''}} >NEFT</option>
                <option value="RTGS" {{ isset($objPAYHDR->INSTRUMENT_TYPE) && $objPAYHDR->INSTRUMENT_TYPE == 'RTGS' ? 'selected' : ''}} >RTGS</option>
            </select>                        
        </div>
        <div class="col-lg-1 pl"><p>Instrument No*</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="INSTRUMENT_NO" id="INSTRUMENT_NO" class="form-control"  autocomplete="off" value="{{isset($objPAYHDR->INSTRUMENT_NO)?$objPAYHDR->INSTRUMENT_NO:''}}" />                        
        </div>
    </div>
	<div class="row">
      <div class="col-lg-1 pl"><p>FC</p></div>
      <div class="col-lg-2 pl">
          <input type="checkbox" {{$ActionStatus}} name="FC" id="FC" class="form-checkbox" {{isset($objPAYHDR->FC) && $objPAYHDR->FC == 1 ? 'checked' : ''}} >
      </div>
      ...
      <div class="col-lg-2 pl" id="divcurrency" >
          ...
          <input type="text" {{$ActionStatus}} name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="{{ isset($objPAYHDR->CRDESCRIPTION) && $objPAYHDR->CRDESCRIPTION !=''? $objPAYHDR->CRCODE.'-'.$objPAYHDR->CRDESCRIPTION:'' }}"/>
      
          <input type="hidden"  name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="{{ isset($objPAYHDR->CRID_REF)?$objPAYHDR->CRID_REF:'' }}" />
          
      </div>
      
      <div class="col-lg-1 pl"><p>Conversion Factor</p></div>
      <div class="col-lg-2 pl">
          <input type="text" {{$ActionStatus}} name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('tot_amt1')" maxlength="100" autocomplete="off" value="{{ isset($objPAYHDR->CONVFACT)?$objPAYHDR->CONVFACT:'' }}"  />
      </div>
  </div>
    <div class="row"  id="divcust3"  style="display:none;">	
        <div class="col-lg-1 pl"><p>Bank Charge</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="BANK_CHARGE" id="BANK_CHARGE" class="form-control two-digits"  autocomplete="off" value="{{isset($objPAYHDR->BANK_CHARGE)?$objPAYHDR->BANK_CHARGE:''}}" />
        </div>                          
        ...
        <div class="col-lg-5 pl">
            <input {{$ActionStatus}} type="text" name="NARRATION" id="NARRATION" class="form-control"  autocomplete="off" value="{{isset($objPAYHDR->NARRATION)?$objPAYHDR->NARRATION:''}}" />                        
        </div>
    </div>
    ...
    <div class="row"  id=""  >	
        ...
        <input type="hidden" name="GLID_REF_ROUNDOFF" id="GLID_REF_ROUNDOFF" class="form-control" value="{{isset($objPAYHDR->ROUNDOFF_GLID)?$objPAYHDR->ROUNDOFF_GLID:''}}" autocomplete="off" />
        <label style="display:none" id="BALANCE_ROUNDGL"> 
                {{isset($objGl->GLCODE) && $objGl->GLCODE!=''? 'Balance '.$helper->getBalance($objPAYHDR->ROUNDOFF_GLID):''}}
              </label>
        <label id="BALANCE_ROUNDGL_SHOW"> 
                {{isset($objGl->GLCODE) && $objGl->GLCODE!=''? 'Balance '.$helper->getBalance_show($objPAYHDR->ROUNDOFF_GLID):''}}
              </label>
      </div>                          
        <div class="col-lg-1 pl"><p>Round of GL Amount</p></div>
        <div class="col-lg-2 pl">
            <input type="text"  {{$ActionStatus}} name="ROUNDOFF_AMT" id="ROUNDOFF_AMT" class="form-control" value="{{isset($objPAYHDR->ROUNDOFF_AMT)?$objPAYHDR->ROUNDOFF_AMT:''}}" autocomplete="off" onkeyup="calculateBankAmount()"   />
        </div>
        ...
        <select name="ROUNDOFF_MODE"  {{$ActionStatus}}  id="ROUNDOFF_MODE" class="form-control" onchange="calculateBankAmount()" >
                <option value="Positive" {{ isset($objPAYHDR->ROUNDOFF_MODE) && $objPAYHDR->ROUNDOFF_MODE == 'Positive' ? 'selected' : ''}}>Debit</option>
                <option value="Negative" {{ isset($objPAYHDR->ROUNDOFF_MODE) && $objPAYHDR->ROUNDOFF_MODE == 'Negative' ? 'selected' : ''}}>Credit</option>
              </select>                                  
        </div>
    </div>
    ...
    <div class="row"  id="divcust4"  style="display:none;">	
        ...
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="checkbox" name="CENTERLIZED_PAYMENT" id="CENTERLIZED_PAYMENT" {{ isset($objPAYHDR->CENTERLIZED_PAYMENT) && $objPAYHDR->CENTERLIZED_PAYMENT == 1 ? 'checked' : ''}}   />
        </div> 
    </div>
	</div>
	...
	<div class="container-fluid">
		<div class="row" id="tabs">
			<ul class="nav nav-tabs">
				<li class="active" id="div_invoice" style="display:none"><a data-toggle="tab" href="#Invoice" id="Invoice_Tab" >Invoice Details</a></li> 
      ...
      <div class="tab-content">
        <div id="Invoice" class="tab-pane fade in ">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:650px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    @if(!empty($objPAYINV))
                      @foreach($objPAYINV as $key => $row)
                          <tr  class="participantRow2">
                              ...
                              <td hidden><input type="hidden" name={{"DOCNO_ID_".$key}} id={{"DOCNO_ID_".$key}} class="form-control" value="{{$row->DOCNO_ID}}" autocomplete="off" /> <input type="hidden" name="rowcount1[]" id="rowcount1[]" class="form-control" autocomplete="off" /></td>
                      ...
                      @endphp
                              ...
                              <td><input {{$ActionStatus}} type="text" name={{"PAYMENT_AMT_".$key}} id={{"PAYMENT_AMT_".$key}} class="form-control two-digits" maxlength="15" value="{{$row->PAYMENT_AMT}}" autocomplete="off" /></td>
                    ...
                    @else
                          <tr  class="participantRow2">
                              ...
                              <td><input {{$ActionStatus}} type="text" name="PAYMENT_AMT_0" id="PAYMENT_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
        ...
        <div id="Account" class="tab-pane fade in">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                    <input type="text" {{$ActionStatus}} name="txtbnkcsh" id="txtbnkcsh" class="form-control" value="{{isset($objPAYCASHBANK->BCODE)?$objPAYCASHBANK->BCODE:''}} {{isset($objPAYCASHBANK->NAME)?'-'.$objPAYCASHBANK->NAME:''}}" readonly  />
                    <input type="hidden" name="BANK_CASH_ID" id="BANK_CASH_ID"  class="form-control" value="{{isset($objPAYHDR->CASH_BANK_ID)?$objPAYHDR->CASH_BANK_ID:'' }}" />
                    <input type="hidden" name="ODLIMIT_ACCOUNT" id="ODLIMIT_ACCOUNT"  class="form-control " value="{{isset($objPAYCASHBANK->ODLIMIT)?$objPAYCASHBANK->ODLIMIT:'0.00'}}" />
                    <label style="display:none" id="BALANCE_ACCOUNT"> 
                {{isset($objPAYCASHBANK->BCODE) && $objPAYCASHBANK->BCODE!=''? 'Balance '.$helper->getBalance($objPAYCASHBANK->GLID_REF):''}}
              </label>
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="BANK_AMOUNT" id="BANK_AMOUNT" value="{{isset($objPAYHDR->BANK_AMOUNT)?$objPAYHDR->BANK_AMOUNT:'' }}" class="form-control"  readonly autocomplete="off"  />
                </div>

                <div class="col-lg-1 pl"><p>Common Narration</p></div>
                <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="text" name="BANK_REMARKS" id="BANK_REMARKS" value="{{isset($objPAYHDR->BANK_REMARKS)?$objPAYHDR->BANK_REMARKS:'' }}" class="form-control" autocomplete="off" />
                </div>
                  ...
                  @if(!empty($objPAYACCOUNT))
                    @foreach($objPAYACCOUNT as $gkey => $grow)
                      <tr  class="participantRow3">
                          ...
                          <td><input {{$ActionStatus}} type="text" name={{"ASSESSABLE_VALUE_".$gkey}} id={{"ASSESSABLE_VALUE_".$gkey}} class="form-control two-digits right" maxlength="15" value="{{$grow->ASSESSABLE_VALUE}}" autocomplete="off"  /></td>
                      ...
                      @php
                          $AmtIGST=number_format((($grow->ASSESSABLE_VALUE*$grow->IGST)/100),2, '.', '');
                      @endphp
                      ...
                      @php
                          $AmtCGST=number_format((($grow->ASSESSABLE_VALUE*$grow->CGST)/100),2, '.', '');
                      @endphp
                      ...
                      @php
                          $AmtSGST=number_format((($grow->ASSESSABLE_VALUE*$grow->SGST)/100),2, '.', '');
                      @endphp
                          ...
                          <td>
                          <select name={{"TYPE_".$gkey}} id={{"TYPE_".$gkey}}   class="form-control" style="width: 85px;">
                      ...
                      @endphp
                          ...
                          <td align="center" ><button {{$ActionStatus}} class="btn add aaccount" title="add" data-toggle="tooltip" type="button" ><i class="fa fa-plus"></i></button><button {{$ActionStatus}} class="btn remove daccount" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                      </tr>
                      <tr></tr>
                    @endforeach
                  @else
                      <tr  class="participantRow3">
                          ...
                          <td><input {{$ActionStatus}} type="text" name="ASSESSABLE_VALUE_0" id="ASSESSABLE_VALUE_0" class="form-control two-digits right" maxlength="15" autocomplete="off"  /></td>
        ...
        <div id="TDS" class="tab-pane fade in">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                  <select {{$ActionStatus}} name="drpTDS" id="drpTDS" class="form-control">
                      <option value=""></option>    
                      <option {{ isset($objPAYHDR->TDS) && $objPAYHDR->TDS =='1'?'selected="selected"':'' }} value="Yes">Yes</option>
                      <option {{ isset($objPAYHDR->TDS) && $objPAYHDR->TDS =='0'?'selected="selected"':'' }} value="No">No</option>
                  </select>
                </div>
            </div>
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example7" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tbody id="tbody_tds">
                    @if(!empty($objPAYMENTTDS))
                      @foreach($objPAYMENTTDS as $tkey => $trow)
 ...
 <div class="modal-dialog modal-md" style="width:90%;">
    ...
    <th style="text-align:center; width:6%;">&#10004;</th>
      ...
      <table id="Bank2CodeTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        @foreach ($objBank as $index=>$bkRow)
          <tr>
          <td style="text-align:center; width:6%"> <input type="checkbox"    id="bkidcode2_{{$index}}" class="clsbk2id" value="{{ $bkRow->BID }}" name="cashbank2[]" ></td>
              <td style="width:10%;">{{ $bkRow-> BCODE }}
                <input type="hidden" id="txtbkidcode2_{{ $index }}" data-desc="{{ $bkRow-> BCODE }}" data-desc2="{{ $bkRow-> NAME }}" data-glid_ref="{{ $bkRow->GLID_REF }}" data-odlimit="{{ $bkRow->ODLIMIT !=''? $bkRow->ODLIMIT:'0.00' }}"  value="{{ $bkRow-> BID }}"/>
              </td>
              <td style="width:14%;">{{ $bkRow-> NAME }}</td>
              <td style="width:14%;">{{ $bkRow-> BRANCH }}</td>
              <td style="width:14%;">{{ $bkRow-> IFSC }}</td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"  id="report_title"><p></p></div>
	  ...
	  <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar" style="height:650px;">
          <div class="inner-form">
              <div class="row">
...
//var objlastdt = <?php echo json_encode(isset($objPAYHDR->PAYMENT_DT)?$objPAYHDR->PAYMENT_DT:''); ?>;
//var today = new Date(); 
...
else if(objPayHDR.PAYMENT_FOR == 'Employee')
{
  $('#chk_Vendor').prop('checked', false);
  $('#chk_Account').prop('checked', false);
  $('#chk_Customer').prop('checked', false);
...
// else if(objPayHDR.PAYMENT_FOR != 'Account' && objPayHDR.PAYMENT_ON_ACCOUNT == "0")
// {
...
var BalId2=$.trim($("#BALANCE_ACCOUNT").text()); 
 ...
 else if($('#chk_Account').is(':checked') == true && BANK_CASH_ID !="" && parseFloat(TotalAmount_account) > parseFloat(BALANCE_ACCOUNT) )
 {
    ...
    var allblank12 = [];
        ...
        else if(checkPeriodClosing('{{$FormId}}',PAYMENT_DT,0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
$(document).ready(function(){
  var lastdt = <?php echo json_encode($objlastdt[0]->PAYMENT_DT); ?>;
  var pe = <?php echo json_encode($objPAYHDR); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < pe.PAYMENT_DT)
  {
	$('#PAYMENT_DT').attr('min',lastdt);
  }
  else
  {
	  $('#PAYMENT_DT').attr('min',pe.PAYMENT_DT);
  }
  $('#PAYMENT_DT').attr('max',sodate);
});
...
$('#btnPrint').on('click', function() {
            var DOCID    ='{{$objPAYHDR->PAYMENTID}}';     
            var Flag    = 'H';
            var formData = 'SO='+ DOCID + '&PAYMENTID='+ DOCID + '&Flag='+ Flag ;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                url:'{{route("transaction",[301,"ViewReport"])}}',
                type:'POST',
                data:formData,
                success:function(data) {
                    $("#report_title").html('Payment Voucher Print');
                    $('#ReportView').show();
                    var localS = data;
  ...
  $('#btnExcel').on('click', function() {
            ...
            var Flag = 'E';
            var formData = 'SO='+ DOCID + '&PAYMENTID='+ DOCID + '&Flag='+ Flag ;
            var consultURL = '{{route("transaction",[301,"ViewReport",":rcdId"]) }}';
