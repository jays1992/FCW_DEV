...
<div class="container-fluid filter">
  <form id="frm_trn_pay"  method="POST"> 
    ...
    <div class="row" id="divcust1"  style="display:none">
        <div class="col-lg-1 pl"><p id="titalName"> Customer / Vendor*</p></div> 
        <div class="col-lg-2 pl">
                    ...
                    @if(!empty($objPAYINV))
                      @foreach($objPAYINV as $key => $row)
                          <tr  class="participantRow2">
                              ...
                              <td hidden><input type="hidden" name={{"DOCNO_ID_".$key}} id={{"DOCNO_ID_".$key}} class="form-control" value="{{$row->DOCNO_ID}}" autocomplete="off" /> <input type="hidden" name="rowcount1[]"   class="form-control" autocomplete="off" /></td>
                  ...
                  @if(!empty($objPAYACCOUNT))
                    @foreach($objPAYACCOUNT as $gkey => $grow)
                      ...
                      @endphp
                          ...
                          <td align="center" ><button class="btn add aaccount" title="add" data-toggle="tooltip" type="button" ><i class="fa fa-plus"></i></button><button class="btn remove daccount" title="Delete" data-toggle="tooltip" type="button" ><i class="fa fa-trash" ></i></button></td>
                      </tr>
                      <tr></tr>
                    @endforeach
                  @else
                      <tr  class="participantRow3">
                          ...
                          <td align="center" >
                            <button class="btn add aaccount" title="add" data-toggle="tooltip" type="button" ><i class="fa fa-plus"></i></button>
                            <button class="btn remove daccount" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button>
                          </td>
                      </tr>
                      <tr></tr>
                  @endif
