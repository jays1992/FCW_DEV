...
@endphp
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Import Purchase Order(IPO)</a>
                </div><!--col-2-->
    ...
    <form id="frm_trn_edit"  method="POST"> 
      @csrf
      {{isset($objHDR->IPO_ID[0]) ? method_field('PUT') : '' }}
	<div class="inner-form">
	
		<div class="row">
        <div class="col-lg-2 pl"><p>IPO No</p></div>
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="IPO_NO" id="IPO_NO" value="{{ $objHDR->IPO_NO}}" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
        </div>
        <div class="col-lg-2 pl"><p>IPO Date</p></div>
        <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="date" name="IPO_DT" id="IPO_DT" value="{{ $objHDR->IPO_DT}}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>

        <div class="col-lg-2 pl"><p>Vendor</p></div>
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="txtvendor" id="txtvendor" class="form-control" value="{{$objPBVID->VCODE}}-{{$objPBVID->NAME}}" readonly  />
                <input type="hidden" name="VID_REF" id="VID_REF"  class="form-control" value="{{ $objHDR->VID_REF}}" />
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="checkbox" {{$ActionStatus}} name="FC" id="FC" class="form-checkbox" {{isset($objHDR->FC) && $objHDR->FC == 1 ? 'checked' : ''}} >
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="divcurrency" >
                                ...
                                <input type="text" {{$ActionStatus}} name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="{{ isset($objHDR->CRDESCRIPTION) && $objHDR->CRDESCRIPTION !=''? $objHDR->CRCODE.'-'.$objHDR->CRDESCRIPTION:'' }}"/>
                           
                                <input type="hidden"  name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="{{ isset($objHDR->CRID_REF)?$objHDR->CRID_REF:'' }}" />
                                
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" {{$ActionStatus}} name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('tot_amt')" maxlength="100" autocomplete="off" value="{{ isset($objHDR->CONV_FACTOR)?$objHDR->CONV_FACTOR:'' }}"  />
                            </div>
                        </div>
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="SALE_ORDER_NO" id="SALE_ORDER_NO" value="{{ $objHDR->SALE_ORDER_NO}}"  maxlength="30" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p> Document Type</p></div>
        <div class="col-lg-2 pl">
          <select {{$ActionStatus}} name="DOC_TYPE" id="DOC_TYPE" class="form-control" >
            <option value="">Select</option>
            <option {{isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAF2"?'selected="selected"':''}} value="ZAF2">ZAF2</option>
            <option {{isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAP0"?'selected="selected"':''}} value="ZAP0">ZAP0</option>
            <option {{isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAP2"?'selected="selected"':''}} value="ZAP2">ZAP2</option>
            <option {{isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAS0"?'selected="selected"':''}} value="ZAS0">ZAS0</option>
            <option {{isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAS6"?'selected="selected"':''}} value="ZAS6">ZAS6</option>
          </select>
        </div>
        ...
        <div class="col-lg-2 pl" id="div_billto">
            <input {{$ActionStatus}} type="text" name="txtBILLTO" id="txtBILLTO" class="form-control"  autocomplete="off" value="{{$objBillAddress[0]}}" readonly  />
            <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="{{ $objHDR->BILL_TO}}" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl" id="div_shipto">
            <input {{$ActionStatus}} type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="{{$objShpAddress[0]}}"  readonly  />
            <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="{{ $objHDR->SHIP_TO}}" />
            <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" value="{{$TAXSTATE[0]}}" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Remarks</p></div>
        <div class="col-lg-6 pl">
            <input {{$ActionStatus}} type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" value="{{ $objHDR->REMARKS}}" maxlength="200"  >
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <select {{$ActionStatus}} name="FOB" id="FOB" class="form-control" autocomplete="off" >
          <option {{isset($objHDR) && $objHDR->FOB == "NO"?'selected="selected"':''}} value="NO">NO</option>
          <option {{isset($objHDR) && $objHDR->FOB == "YES"?'selected="selected"':''}} value="YES">YES</option>
        </select>
      </div>

      <div class="col-lg-2 pl"><p>Customer</p></div>
      <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="SubGl_popup" id="txtsubgl_popup" value="{{isset($objsubglcode->SGLCODE)?$objsubglcode->SGLCODE:''}} {{isset($objsubglcode->SLNAME)?'-'.$objsubglcode->SLNAME:''}}" class="form-control mandatory"   autocomplete="off" readonly/>
          <input type="hidden" name="SLID_REF" id="SLID_REF" value="{{ $objHDR->SLID_REF}}" class="form-control" autocomplete="off" />
      ...
      <div class="col-lg-2 pl">
        <input {{$ActionStatus}} type="date" name="REQ_DELIVERY_DATE" id="REQ_DELIVERY_DATE" value="{{ $objHDR->REQ_DELIVERY_DATE}}" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy" >
      </div>
  ...
  <div class="row">	
		...
		<div class="col-lg-2 pl">
			<select {{$ActionStatus}}  name="IMPORT_DUTYID_REF" id="IMPORT_DUTYID_REF" class="form-control" autocomplete="off" >
				<option value="">Select</option>
				@if(isset($objImportDuty) && !empty($objImportDuty))
				@foreach($objImportDuty as $val)
				<option {{isset($objHDR) && $objHDR->IMPORT_DUTYID_REF == $val->IMPORT_DUTYID?'selected="selected"':''}}  value="{{$val->IMPORT_DUTYID}}">{{$val->IMPORT_DUTY_CODE}}</option>
				@endforeach
				@endif
			</select>  
		</div>
		...
		<div class="col-lg-2 pl">
			<input {{$ActionStatus}} type="text" name="REF_NO" id="REF_NO" value="{{ $objHDR->REF_NO}}" class="form-control" maxlength="100" autocomplete="off" >
		</div>
		
        <div class="col-lg-2 pl"><p>Credit Days</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="Credit_days" id="Credit_days" value="{{ $objHDR->CREDIT_DAYS}}" onkeyup="getDueDate()" maxlength="200" class="form-control"  autocomplete="off"   />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="DUE_DATE" id="DUE_DATE" class="form-control" value="{{ $objHDR->DUE_DATE}}"  placeholder="dd/mm/yyyy"  />                        
        </div>
        ...
        <div hidden class="col-lg-2 pl">
            <input  {{$ActionStatus}} type="checkbox" name="GST_Reverse" id="GST_Reverse"    />                          
        </div>

        <div hidden class="col-lg-1 pl"><p>GST Input Not Avail</p></div>
        <div hidden class="col-lg-2 pl">
            <input {{$ActionStatus}} type="checkbox" name="GST_N_Avail" id="GST_N_Avail"    />
        </div>  
      ...
      <div class="tab-content">
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                  <thead id="thead1"  style="position: sticky;top: 0">           
                    <tr>
                      ...
                      <th rowspan="2">Item Code <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="{{$objCount1}}" > </th>
                      <th rowspan="2">Item Name</th>
                      <th rowspan="2">Item Specification</th>

                      <th rowspan="2" {{$hidden}}>{{isset($TabSetting->FIELD8) && $TabSetting->FIELD8 !=''?$TabSetting->FIELD8:'Add. Info Part No'}}</th>
                      <th rowspan="2" {{$hidden}}>{{isset($TabSetting->FIELD9) && $TabSetting->FIELD9 !=''?$TabSetting->FIELD9:'Add. Info Customer Part No'}}</th>
                      <th rowspan="2" {{$hidden}}>{{isset($TabSetting->FIELD10) && $TabSetting->FIELD10 !=''?$TabSetting->FIELD10:'Add. Info OEM Part No.'}}</th>
                    ...
                    <tbody>
                    @if(!empty($objPBMAT))
                      @foreach($objPBMAT as $key => $row)
                      <tr  class="participantRow">
                        <td hidden><input type="text" name="txtSQ_popup_{{$key}}" id="txtSQ_popup_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                        <td hidden><input type="hidden" name="SQA_{{$key}}" id="SQA_{{$key}}" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td hidden><input type="hidden" name="SEQID_REF_{{$key}}" id="SEQID_REF_{{$key}}" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        ...
                        <td hidden><input type="hidden" name="ITEMID_REF_{{$key}}" id="ITEMID_REF_{{$key}}" value="{{$row->ITEMID_REF}}" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        ...
                        <td><input {{$ActionStatus}} type="text" name="Itemspec_{{$key}}" id="Itemspec_{{$key}}" value="{{$row->ITEM_SPECI}}" class="form-control"  autocomplete="off" style="width:130px;"  /></td>
                        
                        <td {{$hidden}}><input type="text" name="Alpspartno_{{$key}}" id="Alpspartno_{{$key}}" value="{{$row->ALPS_PART_NO}}" class="form-control"  autocomplete="off" style="width:130px;text-align:right;" readonly  /></td>
                        <td {{$hidden}}><input type="text" name="Custpartno_{{$key}}" id="Custpartno_{{$key}}" value="{{$row->CUSTOMER_PART_NO}}" class="form-control"  autocomplete="off" style="width:130px;text-align:right;" readonly  /></td>
                        <td {{$hidden}}><input type="text" name="OEMpartno_{{$key}}" id="OEMpartno_{{$key}}" value="{{$row->OEM_PART_NO}}" class="form-control"  autocomplete="off" style="width:130px;text-align:right;" readonly  /></td>
                        
                        <td><input {{$ActionStatus}} type="text" name="popupMUOM_{{$key}}" id="popupMUOM_{{$key}}" value="{{$row->MAIN_UOM_CODE}}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td hidden><input type="hidden" name="MAIN_UOMID_REF_{{$key}}" id="MAIN_UOMID_REF_{{$key}}" value="{{$row->MAIN_UOMID_REF}}" class="form-control"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="SO_QTY_{{$key}}" id="SO_QTY_{{$key}}" value="{{floatval($row->IPO_MAIN_QTY) > 0 ?floatval($row->IPO_MAIN_QTY):'0.00'}}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'3')" class="form-control three-digits" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                        ...
                        <td><input {{$ActionStatus}} type="text" name="popupAUOM_{{$key}}" id="popupAUOM_{{$key}}" value="{{$row->AULT_UOM_CODE}}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td hidden><input type="hidden" name="ALT_UOMID_REF_{{$key}}" id="ALT_UOMID_REF_{{$key}}" value="{{$row->ALT_UOMID_REF}}" class="form-control"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="ALT_UOMID_QTY_{{$key}}" id="ALT_UOMID_QTY_{{$key}}"  class="form-control three-digits" maxlength="13" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{$row->RATE_ASP_MU}}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'5')" class="form-control" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                        <td><input {{$ActionStatus}} {{$disabled}} type="text" name="DISC_PER_{{$key}}" id="DISC_PER_{{$key}}" value="{{ intval($row->DISC_PER) > 0 ? $row->DISC_PER:'0.00' }}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} {{$disabled}} type="text" name="DISC_AMT_{{$key}}" id="DISC_AMT_{{$key}}" value="{{ intval($row->DISC_AMT) > 0 ? $row->DISC_AMT:'0.00' }}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control two-digits" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                        ...
                        <td><input {{$ActionStatus}} type="text" name="FREIGHT_AMT_{{$key}}"           id="FREIGHT_AMT_{{$key}}"            value="{{ intval($row->FREIGHT_AMT) > 0 ? $row->FREIGHT_AMT:'0.00' }}"      onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="INSURANCE_AMT_{{$key}}"         id="INSURANCE_AMT_{{$key}}"          value="{{ intval($row->INSURANCE_AMT) > 0 ? $row->INSURANCE_AMT:'0.00' }}"  onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="ASSESSABLE_VALUE_{{$key}}"      id="ASSESSABLE_VALUE_{{$key}}"       value="{{$row->ASSESSABLE_VALUE}}"  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="CUSTOME_DUTY_RATE_PER_{{$key}}" id="CUSTOME_DUTY_RATE_PER_{{$key}}"  value="{{$row->CUSTOME_DUTY_RATE}}"  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="CUSTOME_DUTY_RATE_AMT_{{$key}}" id="CUSTOME_DUTY_RATE_AMT_{{$key}}"  value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="SWS_RATE_PER_{{$key}}"          id="SWS_RATE_PER_{{$key}}"           value="{{$row->SWS_RATE}}"  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="SWS_RATE_AMT_{{$key}}"          id="SWS_RATE_AMT_{{$key}}"           value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="TOTAL_CUSTOME_DUTY_{{$key}}"    id="TOTAL_CUSTOME_DUTY_{{$key}}"     value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="TAXABLE_VALUE_{{$key}}"         id="TAXABLE_VALUE_{{$key}}"          value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="IGST_RATE_PER_{{$key}}"         id="IGST_RATE_PER_{{$key}}"          value="{{$row->IGST}}"  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="IGST_RATE_AMT_{{$key}}"         id="IGST_RATE_AMT_{{$key}}"          value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="VALUE_AFTER_GST_{{$key}}"       id="VALUE_AFTER_GST_{{$key}}"        value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>

                        <td align="center" ><button {{$ActionStatus}} class="btn add material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button> <button {{$ActionStatus}} class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
        ...
        <div id="TC" class="tab-pane fade">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                @if(!empty($objPBTNC))
                    <input type="hidden" name="TNCID_REF" id="TNCID_REF" class="form-control" value="{{$objPBTNC[0]->TNCID_REF}}" autocomplete="off" />
                @else
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:240px;width:50%;">
                <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                    <tr >
                        <th>Terms & Conditions Description<input class="form-control" type="hidden" name="Row_Count2" id ="Row_Count2"  value="{{$objCount3}}" /></th>
                        <th>Value / Comment</th>
                        <th>Action</th>
                    </tr>
                    </thead>
        ...
        <div id="CT" class="tab-pane fade">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                @if(!empty($objPBCAL))
                  <input type="hidden" name="CTID_REF" id="CTID_REF" class="form-control" value="{{$objPBCAL[0]->CTID_REF}}" autocomplete="off" />
                @else
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:240px;" >
                <table id="example5" class="display nowrap table table-striped table-bordered itemlist " width="100%" style="height:auto !important;">
                  <thead id="thead1"  style="position: sticky;top: 0">
                      <tr>
                          <th>Calculation Component<input class="form-control" type="hidden" name="Row_Count3" id ="Row_Count3" value="{{$objCount4}}" /></th>
                          <th>Rate</th>
                          <th>Value</th>
                  ...
                  @if(!empty($objPBCAL))
                    @foreach($objPBCAL as $Ckey => $Crow)
                      ...
                      @endphp        
                            <td><input {{$ActionStatus}} type="text" name={{"AMTIGST_".$Ckey}} id={{"AMTIGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$IGSTAMT}}"  readonly/></td>
                      ...
                      @endphp       
                            <td><input {{$ActionStatus}} type="text" name={{"AMTCGST_".$Ckey}} id={{"AMTCGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$CGSTAMT}}" readonly/></td>
                      ...
                      @endphp
                            <td><input {{$ActionStatus}} type="text" name={{"AMTSGST_".$Ckey}} id={{"AMTSGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$SGSTAMT}}" readonly/></td>
                      @php
                          $TOTGSTAMT=number_format(($IGSTAMT+$CGSTAMT+$SGSTAMT),2, '.', '');
                      @endphp      
                            <td><input {{$ActionStatus}} type="text" name={{"TOTGSTAMT_".$Ckey}} id={{"TOTGSTAMT_".$Ckey}} class="form-control two-digits"  maxlength="15" autocomplete="off" value="{{$TOTGSTAMT}}" readonly/></td>
                            <td style="text-align:center;"><input {{$ActionStatus}} type="checkbox" class="filter-none" name={{"calACTUAL_".$Ckey}} id={{"calACTUAL_".$Ckey}}  {{$Crow->ACTUAL == 1 ? 'checked' : ''}} /></td>
        ...
        <div id="PaymentSlabs" class="tab-pane fade">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:55%;">
                <table id="example6" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                      <tr >
                          <th>Day(s)<input class="form-control" type="hidden" name="Row_Count5" id ="Row_Count5" value="{{$objCount5}}" /></th>
                          <th>Due %</th>
                          <th>Remarks</th>
                          <th>Due Date</th>
                          <th>Action</th>
                    ...
                    <tbody>
                    @if(!empty($objPBPSLB))
                      @foreach($objPBPSLB as $Pkey => $Prow)
                          <tr  class="participantRow6">
                              ...
                              <td> <input {{$ActionStatus}} type="text" class="form-control" id={{"DUE_DATE_".$Pkey}} name={{"DUE_DATE_".$Pkey}} value="{{$Prow->DUE_DATE}}" autocomplete="off"  /> </td>
                              
                              <td align="center" style="min-width: 100px;" ><button {{$ActionStatus}} class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button {{$ActionStatus}} class="btn remove" title="Delete" data-toggle="tooltip" type="button" ><i class="fa fa-trash" ></i></button></td>
                          </tr>
                          <tr></tr>
                      @endforeach 
                      @else
            ...
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                  <select {{$ActionStatus}} name="drpTDS" id="drpTDS" class="form-control">
                      <option value=""></option>    
                      <option {{ isset($objHDR->TDS) && $objHDR->TDS =='1'?'selected="selected"':'' }} value="Yes">Yes</option>
                      <option {{ isset($objHDR->TDS) && $objHDR->TDS =='0'?'selected="selected"':'' }} value="No">No</option>
                  </select>
                </div>
            </div>
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example7" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    @if(!empty($objPBTDS))
                      @foreach($objPBTDS as $tkey => $trow)
                        <tr  class="participantRow7">
                            ...
                            <td  align="center" style="text-align:center;" ><input type="checkbox" name={{"TDSApplicable_".$tkey}} id={{"TDSApplicable_".$tkey}} {{isset($trow->TDS_APPLICABLE) && $trow->TDS_APPLICABLE == 1?'checked' : ''}}/></td>
                  ...
                  @endphp
                            ...
                            <td style="min-width: 100px;" ><button {{$ActionStatus}} class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
        ...
        <div id="udf" class="tab-pane fade">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
                <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                    <tr >
                        <th>UDF Fields<input class="form-control" type="hidden" name="Row_Count6" id ="Row_Count6"  value="{{$objCount2}}" /></th>
                    ...
                    <tbody>
                    @if(!empty($objPBUDF))
                      @foreach($objPBUDF as $Ukey => $Urow)
                          <tr  class="participantRow4">
                              <td><input {{$ActionStatus}} type="text" name={{"popupUDFPBID_".$Ukey}} id={{"popupUDFPBID_".$Ukey}}  class="form-control"  autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name={{"UDFPBID_REF_".$Ukey}}  id={{"UDFPBID_REF_".$Ukey}} class="form-control" value="{{$Urow->IPO_UDFID}}" autocomplete="off" /></td>
                      ...
                      @if($objUdfPBData)
                        @foreach($objUdfPBData as $uindex=>$uRow)
                          <tr  class="participantRow4">
                              <td><input {{$ActionStatus}} type="text" name={{"popupUDFPBID_".$uindex}} id={{"popupUDFPBID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name={{"UDFPBID_REF_".$uindex}} id={{"UDFPBID_REF_".$uindex}} class="form-control" value="{{$uRow->UDFIPOID}}" autocomplete="off"   /></td>
                        ...
                        @else
                          <tr  class="participantRow4">
                              <td><input {{$ActionStatus}} type="text" name="popupUDFPBID_0" id="popupUDFPBID_0" class="form-control" value="" autocomplete="off"  readonly/></td>
  ...
  <div class="modal-dialog modal-md" style="width:90%">
    ...
    <thead>
      ...
      <tr>
            ...
            <th {{$hidden}} style="width:8%;">{{isset($TabSetting->FIELD8) && $TabSetting->FIELD8 !=''?$TabSetting->FIELD8:'Add. Info Part No'}}</th>
            <th {{$hidden}} style="width:8%;">{{isset($TabSetting->FIELD9) && $TabSetting->FIELD9 !=''?$TabSetting->FIELD9:'Add. Info Customer Part No'}}</th>
            <th {{$hidden}} style="width:8%;">{{isset($TabSetting->FIELD10) && $TabSetting->FIELD10 !=''?$TabSetting->FIELD10:'Add. Info OEM Part No.'}}</th>
    ...
    <td {{$hidden}} style="width:8%;"><input type="text" id="ItemAPNsearch" class="form-control" onkeyup="ItemAPNFunction()"></td>
    <td {{$hidden}} style="width:8%;"><input type="text" id="ItemCPNsearch" class="form-control" onkeyup="ItemCPNFunction()"></td>
    <td {{$hidden}} style="width:8%;"><input type="text" id="ItemOEMPNsearch" class="form-control" onkeyup="ItemOEMPNFunction()"></td>
...
<div id="cridpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <div class="modal-body">
	  ...
	  <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar">
    <table id="CurrencyTable" class="display nowrap table  table-striped table-bordered">
    <thead>
    ...
    <tr>
      ...
      <table id="CurrencyTable2" class="display nowrap table  table-striped table-bordered">
        <thead id="thead2">
          <!-- <tr>
            <th>GLCode</th>
            <th>GLName</th>
...
$(function() { 
  <?php if(isset($objPBMAT) && !empty($objPBMAT)){ foreach($objPBMAT as $key => $row){?>
    onChangeAmount('SO_QTY_<?php echo $key ?>','<?php echo $row->IPO_MAIN_QTY;?>');
    editAltUomQty('ALT_UOMID_QTY_<?php echo $key ?>','<?php echo $row->ALT_UOMID_REF;?>','<?php echo $row->ITEMID_REF;?>','<?php echo $row->IPO_MAIN_QTY;?>');
  <?php }} ?> 

  <?php if(isset($objHDR->VID_REF) && $objHDR->VID_REF !=""){ ?>

    getBillAddress('<?php echo $objHDR->VID_REF;?>')
    getShipAddress('<?php echo $objHDR->VID_REF;?>')
  <?php } ?>
...
$.each( pbudf, function( pbukey, pbuvalue ) {
        $.each( udfforpb, function( upbkey, upbvalue ) { 
            if(pbuvalue.UDFIPOID_REF == upbvalue.UDFIPOID)
            {
...
$("#btnSave").click(function() {
  var formPurchaseBill = $("#frm_trn_edit");
 ...
 var IPO_NO          	=   $.trim($("#IPO_NO").val());
  ...
  var required_status = @json($required_status);
  ...
  if(IPO_NO ===""){
    ...
    if(jQuery.inArray("false", allblank1) !== -1){
        ...
        else if(checkPeriodClosing('{{$FormId}}',$("#IPO_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
  ...
  $('#txtCRID_popup').focus(function(event){
    ...
    showSelectedCheck($("#CRID_REF").val(),"SELECT_CRID_REF");
      ...
      $(".clscrid").click(function(){
        ...
        getConversionFactor('CONVFACT',txtval);
...
function editAltUomQty(txt_id4,altuomid,itemid,mqty){
...
function getBillAddress(customid){
...
function getShipAddress(customid){
