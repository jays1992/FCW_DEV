...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="AP_DOC_NO" id="AP_DOC_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
            <script>docMissing(@json($docarray['FY_FLAG']));</script>
        </div>
        <div class="col-lg-2 pl"><p>Debit/Credit Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="AP_DOC_DT" id="AP_DOC_DT" value="{{ old('AP_DOC_DT') }}" onchange='checkPeriodClosing(235,this.value,1),getDocNoByEvent("AP_DOC_NO",this,@json($doc_req))' class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
