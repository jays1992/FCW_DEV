  ...
  <div class="row">
    <div class="col-lg-2"><a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Fixed Deposit</a></div>
      <div class="col-lg-10 topnav-pd">
        ...
        <button class="btn topnavbt" id="btnSaveFormData" onclick="saveAction('mature')" ><i class="fa fa-floppy-o"></i> Save</button>
        ...
        <button class="btn topnavbt" id="btnApprove" disabled="disabled" onclick="saveAction('approve')" {{ (isset($objRights->APPROVAL1) || isset($objRights->APPROVAL2) || isset($objRights->APPROVAL3) || isset($objRights->APPROVAL4) || isset($objRights->APPROVAL5)) &&  ($objRights->APPROVAL1||$objRights->APPROVAL2||$objRights->APPROVAL3||$objRights->APPROVAL4||$objRights->APPROVAL5) == 1 ? '' : 'disabled'}} ><i class="fa fa-thumbs-o-up"></i> Approved</button>
    ...
    <div class="inner-form">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="FD_CODE" id="FD_CODE" value="{{isset($HDR->FD_CODE)?$HDR->FD_CODE:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
                          
        <div class="col-lg-2 pl"><p>FD Date*</p></div>
        <div class="col-lg-2 pl">
          <input  type="date" name="FD_DATE" id="FD_DATE" value="{{isset($HDR->FD_DATE)?$HDR->FD_DATE:''}}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
      </div>
      ...
      <div class="row">               
        ...
        <div class="col-lg-2 pl">
          <input  type="text"   name="BANK_AC_TEXT" id="BANK_AC_TEXT" value="{{isset($HDR->BANK_CODE)?$HDR->BANK_CODE:''}} - {{isset($HDR->BANK_NAME)?$HDR->BANK_NAME:''}}"  class="form-control" autocomplete="off" onclick="getAccountMaster('')" readonly/>
          <input type="hidden" name="BANK_AC" id="BANK_AC" value="{{isset($HDR->BANK_AC)?$HDR->BANK_AC:''}}"           class="form-control" autocomplete="off" />  
        </div>
        
        <div class="col-lg-2 pl"><p>Account Number</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="BANK_AC_NO" id="BANK_AC_NO" value="{{isset($HDR->BANK_AC_NO)?$HDR->BANK_AC_NO:''}}" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
      ...
      <div class="row">               
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="FD_BANK_AC_TEXT" id="FD_BANK_AC_TEXT"  value="{{isset($HDR->FD_BANK_CODE)?$HDR->FD_BANK_CODE:''}} - {{isset($HDR->FD_BANK_NAME)?$HDR->FD_BANK_NAME:''}}" class="form-control "  autocomplete="off" onclick="getAccountMaster('FD')" readonly/>
          <input type="hidden" name="FD_BANK_AC" id="FD_BANK_AC" value="{{isset($HDR->FD_BANK_AC)?$HDR->FD_BANK_AC:''}}" class="form-control" autocomplete="off" />  
        </div>
        
        <div class="col-lg-2 pl"><p>Account Number</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="FD_BANK_AC_NO" id="FD_BANK_AC_NO" value="{{isset($HDR->FD_BANK_AC_NO)?$HDR->FD_BANK_AC_NO:''}}" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input  type="date" name="MATURITY_DATE" id="MATURITY_DATE" value="{{isset($HDR->MATURITY_DATE)?$HDR->MATURITY_DATE:''}}" class="form-control" autocomplete="off" />
        </div>
        
        <div class="col-lg-2 pl"><p>In-Favour</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="IN_FAVOUR" id="IN_FAVOUR" value="{{isset($HDR->IN_FAVOUR)?$HDR->IN_FAVOUR:''}}" class="form-control" autocomplete="off" />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select   name="BG_NO_APPLICABLE" id="BG_NO_APPLICABLE" class="form-control" autocomplete="off" onchange="getBgAppl(this.value)" >
            ...
            <option {{isset($HDR->BG_NO_APPLICABLE) && $HDR->BG_NO_APPLICABLE ==='YES'?'selected="selected"':''}}  value="YES">YES</option>
            <option {{isset($HDR->BG_NO_APPLICABLE) && $HDR->BG_NO_APPLICABLE ==='NO'?'selected="selected"':''}} value="NO">NO</option>
          </select>
        </div>

        <div class="col-lg-2 pl"><p>BG Number</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="BG_NO" id="BG_NO" value="{{isset($HDR->BG_NO)?$HDR->BG_NO:''}}" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Principal Amount</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="PRINCIPLE_AMOUNT" id="PRINCIPLE_AMOUNT" value="{{isset($HDR->PRINCIPLE_AMOUNT)?$HDR->PRINCIPLE_AMOUNT:''}}" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" />
        </div>
      </div>  
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select   name="RATE_OF_INTEREST_BASE" id="RATE_OF_INTEREST_BASE" class="form-control" autocomplete="off" >
            <option value="">Select</option>
            <option {{isset($HDR->RATE_OF_INTEREST_BASE) && $HDR->RATE_OF_INTEREST_BASE ==='Quarterly'?'selected="selected"':''}} value="Quarterly">Quarterly</option>
            <option {{isset($HDR->RATE_OF_INTEREST_BASE) && $HDR->RATE_OF_INTEREST_BASE ==='Monthly'?'selected="selected"':''}} value="Monthly">Monthly</option>
            <option {{isset($HDR->RATE_OF_INTEREST_BASE) && $HDR->RATE_OF_INTEREST_BASE ==='Yearly'?'selected="selected"':''}} value="Yearly">Yearly</option>
            <option {{isset($HDR->RATE_OF_INTEREST_BASE) && $HDR->RATE_OF_INTEREST_BASE ==='On-Maturity'?'selected="selected"':''}} value="On-Maturity">On-Maturity</option>
          </select>
        </div>

        <div class="col-lg-2 pl"><p>Rate of Interest</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="RATE_OF_INTEREST" id="RATE_OF_INTEREST" value="{{isset($HDR->RATE_OF_INTEREST)?$HDR->RATE_OF_INTEREST:''}}" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" />
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="MATURE_TYPE" id="MATURE_TYPE" value="{{isset($HDR->MATURE_TYPE)?$HDR->MATURE_TYPE:''}}" class="form-control" autocomplete="off" readonly  />
        </div>
      </div> 
      ...
      <div class="row">
        <div class="col-lg-2 pl"><p>Maturity Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="PRE_MATURITY_DATE" id="PRE_MATURITY_DATE" value="{{isset($HDR->PRE_MATURITY_DATE)?$HDR->PRE_MATURITY_DATE:''}}" class="form-control" autocomplete="off" onchange="getMatureType()" />
        </div>

        <div class="col-lg-2 pl"><p>Interest calculator</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="INTEREST_CALCULATOR" id="INTEREST_CALCULATOR" value="{{isset($HDR->INTEREST_CALCULATOR)?$HDR->INTEREST_CALCULATOR:''}}" class="form-control" autocomplete="off" onkeyup="getGrossFdValue()" />
        </div>

        <div class="col-lg-2 pl"><p>Gross FD Value</div>
        <div class="col-lg-2 pl">
          <input type="text" name="GROSS_FD_VALUE" id="GROSS_FD_VALUE" value="{{isset($HDR->GROSS_FD_VALUE)?$HDR->GROSS_FD_VALUE:''}}" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
...
$("#YesBtn").click(function(){
  ...
  if(action ==="save"){
    ...
    window[customFnName]('{{route("transaction",[$FormId,"updateMature"])}}');
  }
...
function getGrossFdValue(){
  var PRINCIPLE_AMOUNT    = $.trim($("#PRINCIPLE_AMOUNT").val());
  var INTEREST_CALCULATOR = $.trim($("#INTEREST_CALCULATOR").val());
  var PRINCIPLE_AMOUNT    = PRINCIPLE_AMOUNT !=''?parseFloat(PRINCIPLE_AMOUNT):0;
  var INTEREST_CALCULATOR = INTEREST_CALCULATOR !=''?parseFloat(INTEREST_CALCULATOR):0;
  var GROSS_FD_VALUE      = INTEREST_CALCULATOR+PRINCIPLE_AMOUNT;
  $("#GROSS_FD_VALUE").val(GROSS_FD_VALUE);
}

$(function(){

  var MATURE_TYPE=@json(isset($HDR->MATURE_TYPE)?$HDR->MATURE_TYPE:'');

  if(MATURE_TYPE !='PRE MATURITY'){
    var PRINCIPLE_AMOUNT  = $.trim($("#PRINCIPLE_AMOUNT").val());
    var RATE_OF_INTEREST  = $.trim($("#RATE_OF_INTEREST").val());
    var PRINCIPLE_AMOUNT  = PRINCIPLE_AMOUNT !=''?parseFloat(PRINCIPLE_AMOUNT):0;
    var RATE_OF_INTEREST  = RATE_OF_INTEREST !=''?parseFloat(RATE_OF_INTEREST):0;

    var INTEREST_AMOUNT   = (PRINCIPLE_AMOUNT*RATE_OF_INTEREST)/100;
    var GROSS_FD_VALUE    = INTEREST_AMOUNT+PRINCIPLE_AMOUNT;

    $("#INTEREST_CALCULATOR").val(INTEREST_AMOUNT);
    $("#GROSS_FD_VALUE").val(GROSS_FD_VALUE);
  }

});

function getMatureType(){
  var MATURITY_DATE     = $("#MATURITY_DATE").val();
  var PRE_MATURITY_DATE = $("#PRE_MATURITY_DATE").val();

  var date1 = new Date(MATURITY_DATE);
  var date2 = new Date(PRE_MATURITY_DATE);

  if(date1 > date2){
    $("#MATURE_TYPE").val('PRE MATURITY');
  }
  else{
    $("#MATURE_TYPE").val('ON MATURITY');
  } 
}
</script>
@endpush