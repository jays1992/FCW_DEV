  ...
  <div class="col-sm-12">
    ...
    <div class="col-sm-12">
      <div class="row min-h">
        ...
        <div class="col-sm-2">         
          <input type="text" name="Appoint_Date" id="Appoint_Date" value="{{isset($objResponse->DATE) && $objResponse->DATE !=''?date('M/d/Y',strtotime($objResponse->DATE)):''}}"  class="form-control left-border mrgnbtm" placeholder="MM/DD/YYYY" />
        </div>

        <div class="col-sm-2">         
          <input type="text" name="Appoint_Time" id="Appoint_Time" value="{{isset($objResponse->TIME) && $objResponse->TIME !=''?date('H:i A',strtotime($objResponse->TIME)):''}}"  class="form-control left-border mrgnbtm" />
        </div>
        ...
        <div class="col-sm-2">
          <select id="drpEndtime" name="drpEndtime" class="form-control left-border mrgnbtm" tabindex="10">
    ...
    <div class="col-sm-12">
      <div class="row min-h">
        ...
        <div class="col-sm-4">
          <textarea id="REASON" name="REASON" class="form-control left-border" tabindex="16" maxlength="200" lines="3" >{{isset($objResponse->REASON) && $objResponse->REASON !=""?$objResponse->REASON:''}}</textarea>
        </div>
        <div class="col-sm-2">
          <label>Notes</label>
        </div>
    ...
    <div class="col-sm-12">
      <div class="row min-h">
        ...
        <div class="col-sm-4">
          <input type="text" id="TOTAL_AMT" name="TOTAL_AMT" class="form-control left-border" tabindex="18" value="{{isset($objResponse->TOTAL_AMT) ? $objResponse->TOTAL_AMT: 0.00}}" readonly />
        </div>        
      </div>
    </div>
...
if(formCreateAppointment.valid()){
  ...
  // }
        ...
        $.ajax({
            url:'{{ route("transaction",[545,"update"])}}',
            type:'POST',
            dataType: 'json',
            data: formData,
            success:function(data) {
  ...
  var AppointDate   =   date.toISOString().slice(0,10);
    ...
    $.ajax({
        ...
        success:function(data) {
          ...
          // if(data == 'Test'){
          //   $('#Visit_TYPE_4').prop('checked',true);
          // }
          // else if(data == 'Follow-Up'){
          //   $('#Visit_TYPE_3').prop('checked',true);
          // }
          // else if(data == 'Re-Entry'){
          //   $('#Visit_TYPE_2').prop('checked',true);
          // }
          // else{
          //   $('#Visit_TYPE_1').prop('checked',true);
          // }
