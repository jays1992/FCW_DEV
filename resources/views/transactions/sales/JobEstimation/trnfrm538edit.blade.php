    ...
    <div class="container-fluid filter">
      <div class="inner-form">         
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input {{$ActionStatus}} type="text" id="SEARCH_CUSTOMER" onclick="searchCustomerMaster()" class="form-control" autocomplete="off"  onkeypress="return isNumberKey(event,this)" readonly>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input {{$ActionStatus}} type="date" name="DOB" id="DOB" value="{{isset($HDR->DOB)?$HDR->DOB:''}}" max="{{date('Y-m-d')}}" class="form-control" autocomplete="off" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input {{$ActionStatus}} type="text" name="MOBILE_NO" id="MOBILE_NO" value="{{isset($HDR->MOBILE_NO)?$HDR->MOBILE_NO:''}}" class="form-control" autocomplete="off" placeholder='Mobile No' maxlength="12"  onkeypress="return isNumberKey(event,this)" onkeyup="validate_mobile_no()" >
          </div>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" style="height:auto !important;width:50%">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      ...
                      <td><input {{$ActionStatus}} type="text" name="AMOUNT[]" id="AMOUNT_{{$key}}" readonly value="{{isset($row->AMOUNT)?$row->AMOUNT:''}}" onkeypress="return isNumberDecimalKey(event,this)" onkeyup="get_total_amount()" class="form-control"  autocomplete="off" readonly /></td>
                      <td align="center" >
