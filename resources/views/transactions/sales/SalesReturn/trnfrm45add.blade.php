    ...
    <div class="container-fluid filter">
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input type="date" name="SODT" id="SODT" onchange='checkPeriodClosing(45,this.value,1),getDocNoByEvent("SONO",this,@json($doc_req))'  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
