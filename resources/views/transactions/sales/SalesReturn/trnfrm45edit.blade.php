...
<!-- <form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Sales Return - SR</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_edit"  method="POST">   
            @csrf
            {{isset($objSO->SRID[0]) ? method_field('PUT') : '' }}
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="text" name="SONO" id="SONO" value="{{ isset($objSO->SRNO)?$objSO->SRNO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(45,this.value,1)" value="{{ isset($objSO->SRDT)?$objSO->SRDT :''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="CONVFACT" id="CONVFACT" autocomplete="off" class="form-control" maxlength="100" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input {{$InputStatus}}  type="text" name="REASONOFSR" id="REASONOFSR" value="{{ isset($objSO->REASONOFSR)?$objSO->REASONOFSR:'' }}" autocomplete="off" class="form-control mandatory" maxlength="200"  >
                            </div>
                            ...
                            <div class="col-lg-1 pl col-md-offset-1"><p>Due Date </p></div>
                            <div class="col-lg-2 pl">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                  <input type="checkbox" name="DirectSO" id="DirectSO" class="form-checkbox" >
                            </div>
                            -->
                            ...
                            <div class="col-lg-2 pl">
                              <input  {{$InputStatus}} type="text" name="COMMONNRT" id="COMMONNRT" value="{{ isset($objSO->COMMONNRT)?$objSO->COMMONNRT:'' }}" autocomplete="off" class="form-control" maxlength="200"  >
                            </div>

                           
                             <div class="col-lg-2 pl"><p>Purchase</p></div>        
                            <div class="col-lg-2 pl">
                                <input type="checkbox" {{$InputStatus}} name="chk_Purchase" id="chk_Purchase" {{isset($objSO->chk_Purchase) && $objSO->chk_Purchase == 1 ? 'checked' : ''}} />
                            </div>
                        ...
                        <div class="row" id="purchase_section" style="display:none">
                          ...
                          <div class="col-lg-2 pl">
                            <input type="text" {{$InputStatus}} name="BILL_NO" id="BILL_NO" autocomplete="off" class="form-control" maxlength="200" value="{{ isset($objSO->BILL_NO)?$objSO->BILL_NO:'' }}"  >
                          </div>

                          <div class="col-lg-2 pl"><p>Bill Date</p></div>
                          <div class="col-lg-2 pl">
                              <input type="date" {{$InputStatus}} name="BILL_DT" id="BILL_DT" class="form-control"  autocomplete="off"  value="{{ isset($objSO->BILL_DT)?$objSO->BILL_DT:'' }}" />
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
                                    ...
                                    <?php  
                                    $desc6  =   $row->SIID_REF.'-'.$row->ITEMID_REF.'-'.$row->SEID_REF.'-'.$row->SQID_REF.'-'.$row->SOID.'-'.$row->SCID_REF;  
                                    ...
                                    <tr  class="participantRow">
                                      ...
                                      <td><input {{$InputStatus}} type="text" name={{"txtSQ_popup_".$key}} id={{"txtSQ_popup_".$key}} class="form-control" value="{{ $row->SINO }}" autocomplete="off"   readonly style="width:100px;" /></td>
                                      <td hidden><input type="hidden" name={{"SQA_".$key}} id={{"SQA_".$key}} class="form-control" value="{{ $row->SIID_REF }}" autocomplete="off" /></td>
                                      <td hidden><input type="hidden" name={{"SEQID_REF_".$key}} id={{"SEQID_REF_".$key}} class="form-control" value="{{ $row->SIID_REF }}" autocomplete="off" /></td>
                                      
                                      <td><input {{$InputStatus}} type="text" name={{"popupITEMID_".$key}} id={{"popupITEMID_".$key}} class="form-control" value="{{ $row->ICODE }}"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      ...
                                      <td><input {{$InputStatus}} type="text" name={{"ItemName_".$key}} id={{"ItemName_".$key}} class="form-control" value="{{ $row->NAME }}"  autocomplete="off"  readonly style="width:200px;" /></td>
                                      ...
                                      <td><input {{$InputStatus}} type="text" name="SQMUOM_{{$key}}" id="SQMUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      <td><input {{$InputStatus}} type="text" name="SQMUOMQTY_{{$key}}" id="SQMUOMQTY_{{$key}}" value="{{ $row->SIMAIN_QTY }}" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
                                      <td><input {{$InputStatus}} type="text" name="SQAUOM_{{$key}}" id="SQAUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      <td><input {{$InputStatus}} type="text" name="SQAUOMQTY_{{$key}}" id="SQAUOMQTY_{{$key}}" class="form-control" autocomplete="off"  readonly/></td>

                                      <td><input  {{$InputStatus}} type="text" name="popupMUOM_{{$key}}" id="popupMUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      <td hidden><input type="hidden" name="MAIN_UOMID_REF_{{$key}}" id="MAIN_UOMID_REF_{{$key}}" value="{{ $row->MAIN_SRUOMID_REF }}" class="form-control"  autocomplete="off" style="width:75px;" /></td>
                                      <td><input {{$InputStatus}} type="text" name="SO_QTY_{{$key}}" id="SO_QTY_{{$key}}" value="{{ $row->SRQTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off" readonly  style="width:75px;" {{isset($objSO->chk_Purchase) && $objSO->chk_Purchase == 1 ? '' : 'readonly'}} /></td>
                                      <td hidden><input type="hidden" name="SO_FQTY_{{$key}}" id="SO_FQTY_{{$key}}" value="{{ $row->SRQTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>
                                      <td><input {{$InputStatus}} type="text" name="popupAUOM_{{$key}}" id="popupAUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      <td hidden><input type="hidden" name="ALT_UOMID_REF_{{$key}}" id="ALT_UOMID_REF_{{$key}}" value="{{ $row->ALT_SRUOMID_REF }}" class="form-control"  autocomplete="off"  readonly  style="width:75px;"  /></td>
                                      <td><input {{$InputStatus}} type="text" name="ALT_UOMID_QTY_{{$key}}" id="ALT_UOMID_QTY_{{$key}}" class="form-control three-digits"  autocomplete="off"   style="width:75px;" readonly /></td>
                                      

                                      <td style="text-align:center;" ><a {{$InputStatus}} class="btn checkstore" id="store_{{$key}}" ><i class="fa fa-clone"></i></a></td>
                                      <td  hidden><input type="hidden" name="TotalHiddenQty_{{$key}}" id="TotalHiddenQty_{{$key}}" value="{{ $row->SRQTY }}" ></td>
                                      <td  hidden><input type="hidden" name="HiddenRowId_{{$key}}" id="HiddenRowId_{{$key}}" value="{{ $row->BATCH_QTY_REF }}" ></td>
                                                              
                                      <td hidden><input type="hidden" name="DISCPER_{{$key}}" id="DISCPER_{{$key}}" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width: 50px;"   style="width:75px;" /></td>
                                      <td hidden><input type="hidden" name="DISCOUNT_AMT_{{$key}}" id="DISCOUNT_AMT_{{$key}}" class="form-control two-digits" maxlength="15"  autocomplete="off"   style="width:75px;" /></td>
                                              
                                      <td><input {{$InputStatus}} type="text" name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{ $row->SRRATE }}"  class="form-control five-digits blurRate" maxlength="13"  autocomplete="off" readonly  style="width:75px;" /></td>
                                      <td><input {{$InputStatus}} type="text" name="DISAFTT_AMT_{{$key}}" id="DISAFTT_AMT_{{$key}}" value="{{ $row->SRAMT }}"  class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
                                              
                                      <td style="text-align:center;" ><input {{$InputStatus}} type="checkbox" value="{{$row->GST}}" name='flagtype_0' id="flagtype_0" {{$GST_FLAGE_CHECKED}}  value="1" ></td>

                                      <td><input {{$InputStatus}} type="text" name={{"IGST_".$key}} id={{"IGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->IGST }}" autocomplete="off"  readonly/></td>
                                      <td><input {{$InputStatus}} type="text" name={{"IGSTAMT_".$key}} id={{"IGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                      <td><input {{$InputStatus}} type="text" name={{"CGST_".$key}} id={{"CGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->CGST }}" autocomplete="off"  readonly/></td>
                                      <td><input {{$InputStatus}} type="text" name={{"CGSTAMT_".$key}} id={{"CGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                      <td><input {{$InputStatus}} type="text" name={{"SGST_".$key}} id={{"SGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->SGST }}" autocomplete="off"  readonly/></td>
                                      <td><input {{$InputStatus}} type="text" name={{"SGSTAMT_".$key}} id={{"SGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                      <td><input {{$InputStatus}} type="text" name={{"TGST_AMT_".$key}} id={{"TGST_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                      <td><input {{$InputStatus}} type="text" name={{"TOT_AMT_".$key}} id={{"TOT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                        ...
                                        @if(!empty($objSOUDF))
                                            @foreach($objSOUDF as $Ukey => $Urow)
                                                <tr  class="participantRow4">
                                                    ...
                                                    <td hidden><input type="hidden" name={{"UDFSOID_REF_".$Ukey}}  id={{"UDFSOID_REF_".$Ukey}} class="form-control" value="{{$Urow->UDF_SRID_REF}}" autocomplete="off" /></td>
                                            ...
                                            @foreach($objUdfSOData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td hidden><input type="hidden" name={{"UDFSOID_REF_".$uindex}} id={{"UDFSOID_REF_".$uindex}} class="form-control" value="{{$uRow->UDF_SRID}}" autocomplete="off"   /></td>
                                            ...
                                            @if(!empty($objSOCAL))
                                                @foreach($objSOCAL as $Ckey => $Crow)
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td style="text-align:center;"><input type="checkbox" class="filter-none" name={{"calACTUAL_".$Ckey}} id={{"calACTUAL_".$Ckey}}  ></td>
    ...
    <input type="text" id="UDFSOIDnamesearch" onkeyup="UDFSOIDNameFunction()">
      ...
      <table id="UDFSOIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="udfsoid_{{ $udfindex }}" class="clsudfsoid">
          ...
          <input type="hidden" id="txtudfsoid_{{ $udfindex }}" data-desc="{{ $udfRow->LABEL }}"  value="{{ $udfRow->UDF_SRID }}"/>
          </td>
      ...
      $(".clstncid").dblclick(function(){
        ...
        if(customid!=''){
          ...
          // $('#tncbody').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'{{route("transaction",[45,"gettncdetails2"])}}',
                type:'POST',
                data:{'id':customid},
            ...
            $.ajax({
                url:'{{route("transaction",[45,"gettncdetails3"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                    $('#Row_Count2').val(data);
            ...
            $.ajax({
                url:'{{route("transaction",[45,"gettncdetails"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
      ...
      $(".clsctid").click(function(){
        ...
        if(customid!=''){
          ...
          $('#tbody_ctid').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'{{route("transaction",[45,"getcalculationdetails2"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
            ...
            $.ajax({
                url:'{{route("transaction",[45,"getcalculationdetails3"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $('#Row_Count4').val(data);
            ...
            $.ajax({
                url:'{{route("transaction",[45,"getcalculationdetails"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
            ...
            var customid = txtval;
              if(customid!=''){
                $("#CREDITDAYS").val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[45,"getcreditdays"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#CREDITDAYS").val(data);                        
                ...
                $("#BILLTO1").val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[45,"getBillTo"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#txtBILLTO1").hide();
                ...
                $("#SHIPTO1").val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[45,"getShipTo"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#txtSHIPTO1").hide();
                  ...
                  $("#tbody_BillTo").html('');
                  $.ajax({
                      url:'{{route("transaction",[45,"getBillAddress"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                  ...
                  $("#tbody_ShipTo").html('');
                  $.ajax({
                      url:'{{route("transaction",[45,"getShipAddress"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                  ...
                  $.ajax({
                      url:'{{route("transaction",[45,"getCodeNo"])}}',
                      type:'POST',
  ...
  $('#Material').on('click','[id*="popupITEMID"]',function(event){
        ...
        //if(SalesQuotationID!=''){
                $("#tbody_ItemID").html('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[45,"getItemList"])}}',
                      type:'POST',
        ...
        //           });
        //           $.ajax({
        //               url:'{{route("transaction",[45,"getItemDetailswithoutQuotation"])}}',
        //               type:'POST',
              ...
              /*if(salesenquiry.indexOf(desc5) != -1 && itemids.indexOf(txtval) != -1){
                  ...
                  if($('#hdn_ItemID').val() == "" && txtval != '')
                  {
                    ...
                    $clone.find('td').each(function(){
                      ...
                      if(($clone.find('[id*="IGSTAMT"]').val() > 0) || ($clone.find('[id*="CGSTAMT"]').val() > 0) || ($clone.find('[id*="SGSTAMT"]').val() > 0)){
                  ...
                  else
                  {
                      ...
                      if(($('#'+txtid).parent().parent().find('[id*="IGSTAMT"]').val() > 0) || ($('#'+txtid).parent().parent().find('[id*="CGSTAMT"]').val() > 0) || ($('#'+txtid).parent().parent().find('[id*="SGSTAMT"]').val() > 0)){
      ...
      $('[id*="chkId"]').change(function(){
        ...
        var enquiryids =  $('#hdn_ItemID20').val();
            ...
            if($(this).is(":checked") == true){
              ...
              /*if(salesenquiry.indexOf(desc5) != -1){
  ...
  $('#Material').on('keydown','[id*="popupAUOM"]',function(event){
        ...
        if(ItemID !=''){
                $("#tbody_altuom").html('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[45,"getAltUOM"])}}',
                      type:'POST',
                      data:{'id':ItemID},
                      success:function(data) {
      ...
      $(".clsaltuom").dblclick(function(){
        ...
        if(altuomid!=''){
              $('#'+txt_id4).val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[45,"getaltuomqty"])}}',
                      type:'POST',
...
$(document).ready(function(e) {
  ...
  var Material = $("#Material").html(); 
    ...
    var sqitem = <?php echo json_encode($objSOMAT); ?>;
    ...
    $.each( soudf, function( soukey, souvalue ) {
        $.each( udfforso, function( usokey, usovalue ) { 
            if(souvalue.UDF_SRID_REF == usovalue.UDF_SRID)
            {
    ...
    $.each( obj, function( key, value ) {
        ...
        var amtbeforedis = parseFloat(value.SRRATE*value.SRQTY).toFixed(2);
        ...
        $.each( uom2, function( um2key, um2value ) {
                if(value.MAIN_SRUOMID_REF == um2value.UOMID)
                {
                    $('#popupMUOM_'+key).val(um2value.UOMCODE+'-'+um2value.DESCRIPTIONS);
                }
                if(value.ALT_SRUOMID_REF == um2value.UOMID)
                {
        ...
        */
        ...
        $.each( sqitem, function( sqmkey, sqmvalue ) {
          if(itemid == sqmvalue.ITEMID_REF && sqid == sqmvalue.SIID_REF  /*&& enqid == sqmvalue.SEQID_REF*/){
           ...
           // $('#SQMUOMQTY_'+key).val(sqmvalue.SIMAIN_QTY);
            ...
            $.each( uomconv, function( umckey, umcvalue ) {
                if(itemid == umcvalue. ITEMID_REF  && sqmvalue.MAIN_UOMID_REF == umcvalue.FROM_UOMID_REF && sqmvalue.ALT_UOMID_REF == umcvalue.TO_UOMID_REF){   
                    var altqty = (sqmvalue.SIMAIN_QTY*umcvalue.TO_QTY)/umcvalue.FROM_QTY;
        ...
        $.each( uomconv2, function( umc2key, umc2value ) {
                if(itemid == umc2value. ITEMID_REF  &&  value.ALT_SRUOMID_REF == umc2value.TO_UOMID_REF)
                {   
                    var altqty2 = (value.SRQTY*umc2value.TO_QTY)/umc2value.FROM_QTY;
...
$(document).ready(function() {
  ...
  if($("#chk_Purchase").is(':checked') == true)
  {
...
var lastdt = <?php echo json_encode($lastdt[0]->SRDT); ?>;
  var sr = <?php echo json_encode($objSO); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < sr.SRDT)
  {
...
function validateForm(saveAction){
  ...
  var attachcount    =   "{{$objCountAttachment}}";
  var PURCHASE       =   $("#chk_Purchase").is(':checked');
  var BILL_NO        =   $.trim($("#BILL_NO").val());
  var BILL_DT        =   $.trim($("#BILL_DT").val());

  if(saveAction ==="fnApproveData" && attachcount ==="0"){
    $("#FocusId").val($("#SONO"));
    $("#ProceedBtn").focus();
    $("#YesBtn").hide();
    $("#NoBtn").hide();
    $("#OkBtn1").show();
    $("#AlertMessage").text('Please attach the Customer Document before approve the Sales Return.');
    $("#alert").modal('show');
    $("#OkBtn1").focus();
    return false;
  }
...
//       $.ajax({
//           url:'{{route("transaction",[45,"getTax"])}}',
//           type:'POST',
//           data:{ITEMID_REF:ITEMID_REF,Tax_State:Tax_State},
//           success:function(data) {
//               var myObj = JSON.parse(data);
...
function getStoreDetails(ITEMID_REF,ROW_ID,SIID_REF){
  ...
  $.ajax({
      url:'{{route("transaction",[45,"getStoreDetails"])}}',
      type:'POST',
...
function checkStoreQty(ROW_ID,stockQty,userQty,key,itemid,altumid){
    ...
    $.ajax({
        url:'{{route("transaction",[45,"changeAltUm"])}}',
        type:'POST',
...
function getSL(){
  ...
  $.ajax({
      url:'{{route("transaction",[45,"getsubledger"])}}',
      type:'POST',
