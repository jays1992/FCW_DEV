...
<form id="form_data" method="POST" >
  ...
  <div class="inner-form"> 
      ...
      <div class="col-lg-2 pl">      
        <input type="text" name="CARD_NAME" id="CARD_NAME" onclick="searchCardMaster()" class="form-control" autocomplete="off" readonly>
        <input type="hidden" name="CARD_ID" id="CARD_ID" class="form-control" autocomplete="off" >
      </div>

      <div class="col-lg-2 pl"><p>Validity Month</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="VALIDITY_MONTH" id="VALIDITY_MONTH" value="" class="form-control" style="text-transform:uppercase">
    </div>
    ...
    <div class="col-lg-2 pl">
    <input type="text" name="TOTAL_CARD_AMOUNT" id="TOTAL_CARD_AMOUNT" readonly value="" class="form-control">
    </div>

      <div class="col-lg-2 pl"><p>Validity From</p></div>
      <div class="col-lg-2 pl">
      <input type="date" name="VALIDITY_START_FROM" id="VALIDITY_START_FROM" value="" class="form-control" >
      </div>

      <div class="col-lg-2 pl"><p>Validity Till</p></div>
      <div class="col-lg-2 pl">
      <input type="date" name="VALIDITY_START_TO" id="VALIDITY_START_TO" value="" class="form-control">
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TOTAL_TAX_AMOUNT" id="TOTAL_TAX_AMOUNT" readonly value="" class="form-control" style="text-transform:uppercase">
        </div>

      <div class="col-lg-9 pl"></div>
        <div class="col-lg-1 pl"><p>Discount</p></div>
        <div class="col-lg-2 pl">
        <input type="text" name="TOTAL_DISCOUONT_AMOUNT" id="TOTAL_DISCOUONT_AMOUNT" readonly value="" class="form-control" style="text-transform:uppercase">
        </div>
        </div>
        <div class="row">
        <div class="col-lg-9 pl"></div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TOTAL_NET_AMOUNT" id="TOTAL_NET_AMOUNT"  readonly value="" class="form-control">
        </div>
        </div>
        <div class="row">
        <div class="col-lg-9 pl"></div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TOTAL_PAID_AMOUNT" id="TOTAL_PAID_AMOUNT"  readonly value="" class="form-control">
        </div>
      </div>
