                                            ...
                                            @if(!empty($objSOMAT))
                                                @foreach($objSOMAT as $key => $row)
                                                    <tr  class="participantRow">
                                                        ...
                                                        <td><input {{$InputStatus}} type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->RATE_PRUOM }}"  autocomplete="off" style="width:130px;text-align:right;" /></td>
