...
<!-- <form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_edit"  method="POST">   
            @csrf
            {{isset($objSO->SSIID[0]) ? method_field('PUT') : '' }}
                    ...
                    <div class="inner-form">
                      ...
                      <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="text" name="SONO" id="SONO" value="{{ isset($objSO->SSI_NO)?$objSO->SSI_NO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>SSI Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(156,this.value,1)" value="{{ isset($objSO->SSI_DT)?$objSO->SSI_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                            
                          <div class="col-lg-2 pl"><p>Customer*</p></div>
                          <div class="col-lg-2 pl">
                            <input {{$InputStatus}} type="text" name="SubGl_popup" id="txtgl_popup" value="{{ isset($objSO->SGLCODE)?$objSO->SGLCODE:'' }}   {{ isset($objSO->SLNAME)?$objSO->SLNAME:'' }}" class="form-control mandatory"  autocomplete="off" readonly/>
                            <input type="hidden" name="GLID_REF" id="GLID_REF" value="{{ isset($objSO->GLID_REF)?$objSO->GLID_REF:'' }}" class="form-control" autocomplete="off" />
                            <input type="hidden" name="SLID_REF" id="SLID_REF" value="{{ isset($objSO->SGLID_REF)?$objSO->SGLID_REF:'' }}" class="form-control" autocomplete="off" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                ...
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="{{ isset($objSO->BILLTO_REF)?$objSO->BILLTO_REF:'' }}" />
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                ...
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="{{ isset($objSO->SHIPTO_REF)?$objSO->SHIPTO_REF:'' }}" />
                            ...
                            <div class="col-lg-2 pl">
                                <input  {{$InputStatus}} type="text" name="CREDITDAYS" id="CREDITDAYS" value="{{ isset($objSO->CREDIT_DAYS)?$objSO->CREDIT_DAYS:'' }}" class="form-control" autocomplete="off"/>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="checkbox" {{$InputStatus}} name="FC" id="FC" class="form-checkbox" {{isset($objSO->FC) && $objSO->FC == 1 ? 'checked' : ''}} >
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="divcurrency" >
                                ...
                                <input type="text" {{$InputStatus}} name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="{{ isset($objSO->CRDESCRIPTION) && $objSO->CRDESCRIPTION !=''? $objSO->CRCODE.'-'.$objSO->CRDESCRIPTION:'' }}"/>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" {{$InputStatus}} name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('TotalValue')" maxlength="100" autocomplete="off" value="{{ isset($objSO->CONVFACT)?$objSO->CONVFACT:'' }}"  />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="CUSTOMERDT" id="CUSTOMERDT" value="{{ isset($objSO->DUE_DT)?$objSO->DUE_DT:'' }}" class="form-control " autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                           
                            <div class="col-lg-2 pl"><p>Total Value</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="text" name="TotalValue" id="TotalValue" class="form-control"  autocomplete="off" readonly  />
                            </div>
                        ...
                        <div class="col-lg-2 pl">
                            <input type="checkbox" {{$InputStatus}} name="GST_Reverse" id="GST_Reverse" {{isset($objSO->REVERSE_GST) && $objSO->REVERSE_GST == 1 ? 'checked' : ''}}    />                          
                        </div>
                        <div class="col-lg-2 pl"><p>GST Input Not Avail</p></div>
                        <div class="col-lg-2 pl">
                            <input type="checkbox" {{$InputStatus}} name="GST_N_Avail" id="GST_N_Avail"  {{isset($objSO->GST_INPUT) && $objSO->GST_INPUT == 1 ? 'checked' : ''}}    />
                        </div>      
                                            ...
                                            @if(!empty($objSOMAT))
                                                @foreach($objSOMAT as $key => $row)
                                                    <tr  class="participantRow">
                                                        ...
                                                        <td hidden>
                                                        <input  class="form-control" type="hidden" name={{"SOMATID_".$key}} id ={{"SOMATID_".$key}} maxlength="100" value="{{ $row->SSI_MATID }}" autocomplete="off"   >
                                                        </td>
                                                        <td>
                                                        <input {{$InputStatus}} type="text" name={{"txtSQ_popup_".$key}} id={{"txtSQ_popup_".$key}} class="form-control" value="{{ $row->SSO_NO }}" autocomplete="off"   readonly style="width:130px;" /></td>
                                                        <td hidden><input type="text" name={{"SQA_".$key}} id={{"SQA_".$key}} class="form-control" value="{{ $row->SSOID_REF }}" autocomplete="off" /></td>
                                                        <td hidden><input type="text" name={{"SEQID_REF_".$key}} id={{"SEQID_REF_".$key}} class="form-control" value="{{ $row->SSOID_REF }}" autocomplete="off" /></td>
                                                        <td><input {{$InputStatus}} type="text" name="SSO_DATE_{{$key}}" id="SSO_DATE_{{$key}}" value="{{ $row->SSO_DT }}" autocomplete="off" class="form-control" readonly style="width:130px;" ></td>
                                                        ...
                                                        <td><input {{$InputStatus}} type="text" name={{"ItemName_".$key}} id={{"ItemName_".$key}} class="form-control" value="{{ $row->NAME }}"  autocomplete="off"  readonly style="width:130px;" /></td>
                                                        
                                                        <td {{$AlpsStatus['hidden']}}><input {{$InputStatus}} type="text" name="Alpspartno_{{$key}}" id="Alpspartno_{{$key}}" class="form-control"  autocomplete="off" value="{{ isset($row->ALPS_PART_NO)?$row->ALPS_PART_NO:''}}" readonly style="width:130px;"/></td>
                                                        <td {{$AlpsStatus['hidden']}}><input {{$InputStatus}} type="text" name="Custpartno_{{$key}}" id="Custpartno_{{$key}}" class="form-control"  autocomplete="off" value="{{ isset($row->CUSTOMER_PART_NO)?$row->CUSTOMER_PART_NO:''}}" readonly style="width:130px;"/></td>
                                                        <td {{$AlpsStatus['hidden']}}><input {{$InputStatus}} type="text" name="OEMpartno_{{$key}}"  id="OEMpartno_{{$key}}" class="form-control"  autocomplete="off"  value="{{ isset($row->OEM_PART_NO)?$row->OEM_PART_NO:'' }}" readonly style="width:130px;"/></td>

                                                        <td hidden><input type="hidden" name={{"Itemspec_".$key}} id={{"Itemspec_".$key}} class="form-control"  autocomplete="off" /></td>
                                                        <td hidden><input type="hidden" name={{"SQMUOM_".$key}} id={{"SQMUOM_".$key}} class="form-control"  autocomplete="off"  readonly/></td>
                                                        <td hidden><input type="hidden" name={{"SQMUOMQTY_".$key}} id={{"SQMUOMQTY_".$key}} class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
                                                        <td hidden><input type="hidden" name={{"SQAUOM_".$key}} id={{"SQAUOM_".$key}} class="form-control"  autocomplete="off"  readonly/></td>
                                                        <td hidden><input type="hidden" name={{"SQAUOMQTY_".$key}} id={{"SQAUOMQTY_".$key}} class="form-control" maxlength="13" autocomplete="off"  readonly/></td>
                                                        
                                                        <td><input {{$InputStatus}} type="text" name={{"popupMUOM_".$key}} id={{"popupMUOM_".$key}} class="form-control"  autocomplete="off" value="{{ $row->UOMCODE }}-{{ $row->DESCRIPTIONS }}" readonly style="width:130px;" /></td>
                                                        <td hidden><input type="hidden" name={{"MAIN_UOMID_REF_".$key}} id={{"MAIN_UOMID_REF_".$key}} class="form-control" value="{{ $row->UOMID_REF }}" autocomplete="off" readonly style="width:130px;" /></td>
                                                        <td><input {{$InputStatus}} type="text" name="REMARKS_{{$key}}" id="REMARKS_{{$key}}" class="form-control three-digits" maxlength="13"  value="{{ $row->REMARKS }}"  autocomplete="off"  style="width:130px;"   /></td>
                                                        <td><input {{$InputStatus}} type="text" name={{"SO_QTY_".$key}} id={{"SO_QTY_".$key}} class="form-control three-digits" maxlength="13"  value="{{ $row->SSI_QTY }}"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        
                                                       
                                                        <td hidden><input type="hidden" name="HID_SO_QTY_{{$key}}" id="HID_SO_QTY_{{$key}}" class="form-control three-digits" maxlength="13"  value="{{ $row->SSI_QTY }}"  autocomplete="off"  style="width:130px;text-align:right;" /></td>

                                                        <td hidden><input type="hidden" name={{"SO_FQTY_".$key}} id={{"SO_FQTY_".$key}} class="form-control three-digits" maxlength="13"  autocomplete="off"   readonly style="width:130px;text-align:right;"/></td>
                                                        <td hidden><input type="hidden" name={{"popupAUOM_".$key}} id={{"popupAUOM_".$key}} class="form-control"  autocomplete="off"  readonly/></td>
                                                        <td hidden><input type="hidden" name={{"ALT_UOMID_REF_".$key}} id={{"ALT_UOMID_REF_".$key}} class="form-control"  autocomplete="off"   readonly/></td>
                                                        <td hidden><input type="hidden" name={{"ALT_UOMID_QTY_".$key}} id={{"ALT_UOMID_QTY_".$key}} class="form-control three-digits" maxlength="13" autocomplete="off"  readonly/></td>
                                                        
                                                        <td><input {{$InputStatus}} type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} class="form-control five-digits" maxlength="18" value="{{ $row->RATE_PRUOM }}"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$InputStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCPER_".$key}} id={{"DISCPER_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->DISCOUNT_PER }}"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        ...
                                                        <td><input {{$InputStatus}} type="text" name={{"DISAFTT_AMT_".$key}} id={{"DISAFTT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        ...
                                                        <td><input {{$InputStatus}} type="text" name={{"IGSTAMT_".$key}} id={{"IGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        ...
                                                        <td><input {{$InputStatus}} type="text" name={{"CGSTAMT_".$key}} id={{"CGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        ...
                                                        <td><input {{$InputStatus}} type="text" name={{"SGSTAMT_".$key}} id={{"SGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input {{$InputStatus}} type="text" name={{"TGST_AMT_".$key}} id={{"TGST_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input {{$InputStatus}} type="text" name={{"TOT_AMT_".$key}} id={{"TOT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td align="center"><button {{$InputStatus}} class="btn add material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button {{$InputStatus}} class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                                                    </tr>
                                                    <tr></tr>
                                                @endforeach 
                                            @endif 
                                        ...
                                        <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            @if(!empty($objSOTNC))
                                                @foreach($objSOTNC as $Tkey => $Trow)
                                                    ...
                                                    <td hidden><input type="hidden" name="SSI_TNCID_{{$Tkey}}" id="SSI_TNCID_{{$Tkey}}" value="{{ $Trow->SSI_TNCID }}" class="form-control" autocomplete="off" /></td>
                                                ...
                                                @else
                                                <tr  class="participantRow3">
                                                    <td hidden><input type="hidden" name="SSI_TNCID_0" id="SSI_TNCID_0"  class="form-control" autocomplete="off" /></td>
                                        ...
                                        @if(!empty($objSOUDF))
                                            @foreach($objSOUDF as $Ukey => $Urow)
                                                <tr  class="participantRow4">
                                                    <td hidden><input type="hidden" name="SSI_UDFID_{{$Ukey}}" id="SSI_UDFID_{{$Ukey}}" value="{{ $Urow->SSI_UDFID }}" class="form-control" autocomplete="off" /></td>
                                                    <td><input {{$InputStatus}} type="text" name={{"popupUDFSOID_".$Ukey}} id={{"popupUDFSOID_".$Ukey}}  class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name={{"UDFSOID_REF_".$Ukey}}  id={{"UDFSOID_REF_".$Ukey}} class="form-control" value="{{$Urow->UDFSSIID_REF}}" autocomplete="off" /></td>
                                            ...
                                            @foreach($objUdfSOData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td><input {{$InputStatus}} type="text" name={{"popupUDFSOID_".$uindex}} id={{"popupUDFSOID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
                                            ...
                                            @if(!empty($objSOCAL))
                                                @foreach($objSOCAL as $Ckey => $Crow)
                                                    <tr  class="participantRow5">
                                                        <td hidden><input type="hidden" name="SSI_CALID_{{$Ckey}}" id="SSI_CALID_{{$Ckey}}" value="{{ $Crow->SSI_CALID }}" class="form-control" autocomplete="off" /></td>
                                                        ...
                                                        <td hidden style="text-align:center;"><input {{$InputStatus}} type="checkbox" class="filter-none" name={{"calACTUAL_".$Ckey}} id={{"calACTUAL_".$Ckey}}  ></td>
                                                ...
                                                <tr  class="participantRow5">
                                                    ...
                                                    <td style="text-align:center;" ><input {{$InputStatus}} type="checkbox" class="filter-none" name="calGST_0" id="calGST_0" value="" ></td>
                                                    ...
                                                    <td hidden style="text-align:center;"><input {{$InputStatus}} type="checkbox" class="filter-none" name="calACTUAL_0" id="calACTUAL_0" value=""   ></td>
                                                    <td align="center" ><button class="btn add" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                </tr>
                                                <tr></tr>
                                            @endif 
                                            ...
                                            @if(!empty($objSOPSLB))
                                                @foreach($objSOPSLB as $Pkey => $Prow)
                                                    <tr  class="participantRow6">
                                                        <td hidden><input type="hidden" name="SSI_PSLBID_{{$Pkey}}" id="SSI_PSLBID_{{$Pkey}}" value="{{ $Prow->SSI_PSLBID }}" class="form-control" autocomplete="off" /></td>
                                                        ...
                                                        <td> <input {{$InputStatus}} type="text" class="form-control four-digits" id={{"DUE_".$Pkey}} name={{"DUE_".$Pkey}} value="{{$Prow->DUE}}" maxlength="8" autocomplete="off" /> </td>
                                                        <td> <input {{$InputStatus}} type="text" class="form-control" id={{"PSREMARKS_".$Pkey}} name={{"PSREMARKS_".$Pkey}} value="{{$Prow->REMARKS}}" autocomplete="off"  /> </td>
                                                        <td align="center" >
                                                ...
                                                @else
                                                <tr  class="participantRow6">
                                                        <td hidden><input type="hidden" name="SSI_PSLBID_0" id="SSI_PSLBID_0" class="form-control" autocomplete="off" /></td>
                                                        <td> <input {{$InputStatus}} type="text" class="form-control" id="PAY_DAYS_0" name="PAY_DAYS_0"  autocomplete="off" /> </td>
                                                        <td> <input {{$InputStatus}} type="text" class="form-control four-digits" id="DUE_0" name="DUE_0"  maxlength="8" autocomplete="off" /> </td>
                                                        <td> <input {{$InputStatus}} type="text" class="form-control" id="PSREMARKS_0" name="PSREMARKS_0" autocomplete="off"  /> </td>
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example7" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tbody id="tbody_tds">
                    @if(!empty($objSSITDS))
                      @foreach($objSSITDS as $tkey => $trow)
...
<div id="customer_popus" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
        <td class="ROW1"><span class="check_th">&#10004;</span></td>
        <td class="ROW2"><input type="text" id="customercodesearch" class="form-control" onkeyup="CustomerCodeFunction('156')"></td>
        <td class="ROW3"><input type="text" id="customernamesearch" class="form-control" onkeyup="CustomerNameFunction('156')"></td>
    </tr>
    </tbody>
    </table>
...
<style>
/*
#custom_dropdown, #frm_trn_edit_filter {
  ...
  function CustomerNameFunction(FORMID) {
    ...
    function loadCustomer(CODE,NAME,FORMID){
      //var url	=	'<?php echo asset('');?>transaction/'+FORMID+'/getsubledger';
        ...
        $.ajax({
          url:'{{route("transaction",[156,"getsubledger"])}}',
          type:'POST',
  ...
  var Material = $("#Material").html(); 
    ...
    $.each( soudf, function( soukey, souvalue ) {
        $.each( udfforso, function( usokey, usovalue ) { 
            if(souvalue.UDFSSIID_REF == usovalue.UDFSSIID)
            {
    ...
    $.each( obj, function( key, value ) {
        var sqid = value.SSOID_REF;
        var itemid = value.ITEMID_REF;
        var enqid = value.SSOID_REF;
        var amtbeforedis = parseFloat(value.RATE_PRUOM*value.SSI_QTY).toFixed(2);
        ...
        */
        ...
        if(itemid == sqmvalue.ITEMID_REF && sqid == sqmvalue.SQID_REF && enqid == sqmvalue.SEQID_REF)
        {
            ...
            $.each( uom, function( umkey, umvalue ) {
                if(sqmvalue.UOMID_REF == umvalue.UOMID)
                {
            ...
            $.each( uomconv, function( umckey, umcvalue ) {
                if(itemid == umcvalue. ITEMID_REF  && sqmvalue.UOMID_REF == umcvalue.FROM_UOMID_REF 
...
var lastdt = <?php echo json_encode($lastdt[0]->SSI_DT); ?>;
  var ssi = <?php echo json_encode($objSO); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < ssi.SSI_DT)
  {
	$('#SODT').attr('min',lastdt);
  }
  else
  {
	  $('#SODT').attr('min',ssi.SSI_DT);
  }
...
$.ajax({
    url:'{{ route("transactionmodify",[156,"update"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$.ajax({
    url:'{{ route("transactionmodify",[156,"Approve"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
