      ...
      <div class="inner-form">            
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input type="text" name="SSO_NO" id="SSO_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
          ...
          <div class="col-lg-2 pl">
              <input type="date" name="SSO_DT" id="SSO_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("SSO_NO",this,@json($doc_req))'  class="form-control mandatory" autocomplete="off" >
          </div>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    ...
                                                    <td><input type="text" name="RATEPUOM_0" id="RATEPUOM_0" class="form-control five-digits" maxlength="18"  autocomplete="off"  style="width:130px;text-align:right;" /></td>
