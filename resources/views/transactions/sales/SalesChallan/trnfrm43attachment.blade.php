...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <button class="btn topnavbt" id="btnSaveSCAttachment" ><i class="fa fa-floppy-o"></i> Save</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_sc_attachment" method="post" enctype="multipart/form-data" action='{{route("transactionmodify",[43,"docuploads"])}}' > 
          @CSRF
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='{{$objMstVoucherType[0]->VTID}}' />
			...
			<div class="col-lg-2 pl">
         <label style="text-transform:uppercase"> {{$objSalesChallan->SCNO}} </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objSalesChallan->SCID}}" class="form-control" maxlength="50" >
			</div>
			
			<div class="col-lg-1 pl"><p>Document Date</p></div>
			<div class="col-lg-2 pl">
      <label> {{ date("d/m/Y", strtotime($objSalesChallan->INDATE) )}} </label> 
        <input type="hidden" name="ATTACH_DOCDT" id="ATTACH_DOCDT" value='{{date("Y-m-d", strtotime($objSalesChallan->INDATE))}}'   />
					...
					<table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
						...
						<tbody>
							<tr  class="participantRow">
								...
								<td><input style="width: 100%"  type="text" name="REMARKS[]" id="REMARKS_0" 	class="form-control w-100"  maxlength="200" autocomplete="off" ></td>
...
<script>  
 ...
 var formSOMst = $( "#frm_sc_attachment" );
     formSOMst.validate({
    ...
    //validate
    $( "#btnSaveSCAttachment" ).click(function() {
