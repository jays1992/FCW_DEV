            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input type="text" name="SCNO" id="SCNO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
                              <script>docMissing(@json($docarray['FY_FLAG']));</script>
                            </div>
                            <div class="col-lg-2 pl"><p>Sales Challan Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="SCDT" id="SCDT" onchange='checkPeriodClosing(43,this.value,1),getDocNoByEvent("SCNO",this,@json($doc_req))'  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                           
