...
<form id="form_data" method="POST"  >
  ...
  <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" {{$ActionStatus}} name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('TOTAL_NET_AMOUNT')" maxlength="100" autocomplete="off" value="{{ isset($HDR->CONVFACT)?$HDR->CONVFACT:'' }}"  />
                            </div>
                        </div>
