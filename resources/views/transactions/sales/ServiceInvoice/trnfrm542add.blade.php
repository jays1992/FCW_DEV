...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Service Invoice</a></div>
  ...
  <div class="container-fluid filter"> 
    ...
    <div class="inner-form"> 
      <div class="row">
        ...
        <div class="col-lg-2 pl"> 
          <input type="text"    name="JOB_NO"   id="JOB_NO"   class="form-control" autocomplete="off" onclick="getJobCard()" readonly >
          <input type="hidden"  name="JEID_REF" id="JEID_REF" class="form-control" autocomplete="off" >
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="JOB_DATE" id="JOB_DATE" class="form-control" autocomplete="off" readonly>
        </div>
        ...
        <div class="col-lg-2 pl"> 
          ...
          <input type="hidden"  name="HSNID_REF"      id="HSNID_REF"      class="form-control"  autocomplete="off" >
        </div>

        <div class="col-lg-2 pl"><p>Mobile No</p></div>
        <div class="col-lg-2 pl"> 
          <input type="text" name="MOBILE_NO" id="MOBILE_NO" class="form-control" autocomplete="off" placeholder='Mobile No' maxlength="12"  readonly >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"> 
          <input type="text" name="LANDLINE_NO" id="LANDLINE_NO" class="form-control" autocomplete="off" readonly >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"> 
          <input type="text" name="TOTAL_PACKAGE_AMOUNT" id="TOTAL_PACKAGE_AMOUNT" class="form-control" autocomplete="off" readonly >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"> 
          <input type="text" name="TOTAL_DISCOUONT_AMOUNT" id="TOTAL_DISCOUONT_AMOUNT" class="form-control" autocomplete="off" readonly >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"> 
          <input type="text" name="TOTAL_TAX_AMOUNT" id="TOTAL_TAX_AMOUNT" class="form-control" autocomplete="off" readonly >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"> 
          <input type="text" name="TOTAL_PAID_AMOUNT" id="TOTAL_PAID_AMOUNT" class="form-control" autocomplete="off" readonly >
        </div>
      </div>
              ...
              <table class="display nowrap table table-striped table-bordered itemlist w-200" style="height:auto !important;width:80%">
                <thead>
                  ...
                  <tr class="discountRow">
                    <td><input        type="text" name="DISCOUNT_NAME[]"  id="DISCOUNT_NAME_0"  class="form-control"  autocomplete="off"  onclick="getDiscountMaster(this.id)" readonly  /></td>
                    <td hidden><input type="text" name="DISID_REF[]"      id="DISID_REF_0"      class="form-control"  autocomplete="off" readonly /></td>
                    <td><input        type="text" name="DISCOUNT_TYPE[]"  id="DISCOUNT_TYPE_0"  class="form-control"  autocomplete="off" readonly /></td>
                    <td><input        type="text" name="DISCOUNT_VALUE[]" id="DISCOUNT_VALUE_0" class="form-control"  autocomplete="off" readonly /></td>
                    <td><input        type="text" name="DISCOUNT_AMOUNT[]" id="DISCOUNT_AMOUNT_0" class="form-control"  autocomplete="off" readonly /></td>
                    <td align="center">
              ...
              <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <tbody>
                  <tr class="participantRow2">
                    <td>
                      <select name="PAYMENT_TYPE[]" id="PAYMENT_TYPE_0" class="form-control" onchange="getDocType(this.id);">
                    ...
                    <td><input type="text" name="DESCRIPTION[]" id="DESCRIPTION_0"   class="form-control"  autocomplete="off"  onclick="getValueCardMaster(this.id)" /></td>
                    <td hidden><input type="hidden" name="VALUEID_REF[]" id="VALUEID_REF_0"      class="form-control"  autocomplete="off" /></td>

                    <td><input type="text" name="PAID_AMT[]" id="PAID_AMT_0" onkeyup="getPaymentAmount(this.id,this.value)" onkeypress="return isNumberDecimalKey(event,this)"  onfocusout="dataDec(this,'2')" class="form-control two-digits"  autocomplete="off"  /></td>
