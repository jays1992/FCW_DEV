...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_data_attachment" method="post" enctype="multipart/form-data" action='{{route("transactionmodify",[$FormId,"docuploads"])}}' > 
          @CSRF
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='{{$objMstVoucherType[0]->VTID}}' />
			...
			<div class="col-lg-2 pl">
         <label> {{$objResponse->DOC_NO}} </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objResponse->ACCID}}" class="form-control" maxlength="50" >
			</div>
					...
					<table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
						...
						<tbody>
							<tr  class="participantRow">
								...
								<td><input  style="width: 100%" type="text" name="REMARKS[]" id="REMARKS_0" autocomplete="off" 	class="form-control w-100"  maxlength="200" ></td>
								<td align="center" >
