  ...
  <div class="container-fluid filter">    
    ...
    <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="hidden"  name="DOC_ID"     id="DOC_ID" value="{{isset($HDR->ACCID)?$HDR->ACCID:''}}" >
        ...
        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" {{$ActionStatus}} name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('TotalValue')" maxlength="100" autocomplete="off" value="{{ isset($HDR->CONVFACT)?$HDR->CONVFACT:'' }}"  />
                            </div>
                        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
          <input type="text" name="VEHICLE_REG_NO" id="VEHICLE_REG_NO" {{$ActionStatus}} value="{{isset($HDR->VEHICLE_REG_NO)?$HDR->VEHICLE_REG_NO:''}}" class="form-control" autocomplete="off">
          </div>
        
          <div class="col-lg-2 pl"><p>Vehicle Make</p></div>
          <div class="col-lg-2 pl"> 
            <input type="text" name="VEHICLE_MAKE_NAME" id="VEHICLE_MAKE_NAME" {{$ActionStatus}} value="{{isset($HDR->VEHICLE_MAKE_NAME)?$HDR->VEHICLE_MAKE_NAME:''}}" class="form-control" autocomplete="off" onclick="getVehicleMakeMaster()" readonly >
            <input type="hidden" name="VEHICLE_MAKE_ID" id="VEHICLE_MAKE_ID" value="{{isset($HDR->VEHICLE_MAKE_ID)?$HDR->VEHICLE_MAKE_ID:''}}" class="form-control" autocomplete="off">
          </div>
        </div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TotalValue_tax" id="TotalValue_tax" class="form-control" value="{{isset($HDR->TAX_AMT)?$HDR->TAX_AMT:''}}" autocomplete="off" readonly  />
        </div>
      </div>
        <div class="row">
        <div class="col-lg-9 pl"></div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TotalValue" id="TotalValue" class="form-control" value="{{isset($HDR->NET_AMT)?$HDR->NET_AMT:''}}" autocomplete="off" readonly  />
        </div>
      </div>
      ...
      <div id="multi_currency_section" style="display:none">
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TotalValue_paid" id="TotalValue_paid" class="form-control" value="{{isset($HDR->PAID_AMT)?$HDR->PAID_AMT:''}}" autocomplete="off" readonly  />
        </div>
      </div>
          ...
          <div id="Material" class="tab-pane fade in active">
              ...
              <thead id="thead1"  style="position: sticky;top: 0">
                ...
                @if(isset($MAT) && !empty($MAT))
                    ...
                    <td><input  type="text" {{$ActionStatus}} style="width:130px;text-align:left;" name="popupITEMID[]" id="popupITEMID_{{$key}}" value="{{isset($row->ITEM_CODE)?$row->ITEM_CODE:''}}" onclick="getItem(this.id)" class="form-control"  autocomplete="off"  readonly/></td>

                    <td hidden><input type="hidden" name="ITEMID_REF[]" id="ITEMID_REF_{{$key}}"  value="{{isset($row->ITEMID_REF)?$row->ITEMID_REF:''}}" class="form-control" autocomplete="off" /></td>

                    <td><input type="text" {{$ActionStatus}} style="width:130px;text-align:left;" name="ItemName[]" id="ItemName_{{$key}}" value="{{isset($row->ITEM_NAME)?$row->ITEM_NAME:''}}" class="form-control"  autocomplete="off"  readonly  /></td>

                    <td><input type="text" {{$ActionStatus}} style="width:130px;text-align:left;" name="popupMUOM[]" id="popupMUOM_{{$key}}" value="{{isset($row->UOM_DESC)?$row->UOM_DESC:''}}" onclick="getUomMaster(this.id)" class="form-control"  autocomplete="off"  readonly /></td>

                    <td hidden><input type="hidden" name="MAIN_UOMID_REF[]" id="MAIN_UOMID_REF_{{$key}}" value="{{isset($row->UOMID_REF)?$row->UOMID_REF:''}}" class="form-control"  autocomplete="off" /></td>

                    <td><input type="text" {{$ActionStatus}} style="width:130px;text-align:right;" onkeypress="return isNumberDecimalKey(event,this)"   name="QTY[]" id="QTY_{{$key}}" value="{{isset($row->QTY)?$row->QTY:''}}" class="form-control three-digits"     onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" maxlength="13"  autocomplete="off"   /></td>

                    <td><input type="text" {{$ActionStatus}} onkeypress="return isNumberDecimalKey(event,this)"  name="RATEPUOM[]" id="RATEPUOM_{{$key}}" value="{{isset($row->RATEPUOM)?$row->RATEPUOM:''}}" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'5')" /></td>

                    <td><input  type="text" {{$ActionStatus}} name="DISCPER[]" onkeypress="return isNumberDecimalKey(event,this)"  id="DISCPER_{{$key}}" value="{{isset($row->DISCPER)?$row->DISCPER:''}}" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" /></td>

                    <td><input  type="text" {{$ActionStatus}} name="DISCOUNT_AMT[]" onkeypress="return isNumberDecimalKey(event,this)"  id="DISCOUNT_AMT_{{$key}}" value="{{isset($row->DISCOUNT_AMT)?$row->DISCOUNT_AMT:''}}" class="form-control two-digits" maxlength="15"  autocomplete="off"  style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" /></td>

                    <td><input type="text" {{$ActionStatus}} name="DISAFTT_AMT[]" id="DISAFTT_AMT_{{$key}}"  value="{{isset($row->GROSS_TOTAL)?$row->GROSS_TOTAL:''}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>

                    <td><input type="text" {{$ActionStatus}} name="IGST[]" id="IGST_{{$key}}" value="{{isset($row->IGST)?$row->IGST:''}}"  class="form-control four-digits" maxlength="8"  autocomplete="off"  readonly onkeyup="dataCalculation(this.id)"/></td>

                    <td><input type="text" name="IGSTAMT[]" id="IGSTAMT_{{$key}}"  value="{{isset($row->IGSTAMT)?$row->IGSTAMT:''}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>

                    <td><input type="text" {{$ActionStatus}} name="CGST[]" id="CGST_{{$key}}" value="{{isset($row->CGST)?$row->CGST:''}}" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:130px;text-align:right;"  onkeyup="dataCalculation(this.id)" /></td>

                    <td><input type="text" {{$ActionStatus}} name="CGSTAMT[]" id="CGSTAMT_{{$key}}" value="{{isset($row->CGSTAMT)?$row->CGSTAMT:''}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>

                    <td><input type="text" {{$ActionStatus}} name="SGST[]" id="SGST_{{$key}}" value="{{isset($row->SGST)?$row->SGST:''}}" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly  style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" /></td>

                   <td><input type="text" {{$ActionStatus}} name="SGSTAMT[]" id="SGSTAMT_{{$key}}" value="{{isset($row->SGSTAMT)?$row->SGSTAMT:''}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>

                   <td><input type="text" {{$ActionStatus}} name="TGST_AMT[]" id="TGST_AMT_{{$key}}" value="{{isset($row->TGST_AMT)?$row->TGST_AMT:''}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>

                   <td><input type="text" {{$ActionStatus}} name="TOT_AMT[]" id="TOT_AMT_{{$key}}"  value="{{isset($row->TOT_AMT)?$row->TOT_AMT:''}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                    
                  <td align="center" >
                    <button class="btn add material" title="add" {{$ActionStatus}} data-toggle="tooltip" type="button" ><i class="fa fa-plus"></i></button>
                    <button class="btn remove dmaterial" title="Delete" {{$ActionStatus}} data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button>
                  </td>
                ...
                <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    @foreach($PAYMENT as $key=>$row)
                          <tr  class="participantRow2">
                              <td><select {{$ActionStatus}} name="PAYMENT_TYPE[]" id="PAYMENT_TYPE_0" class="form-control" onchange="getDocType(this.id);">
                              <option value="">Select</option>
                              <option value="Cash" {{isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="Cash" ? 'selected':''}} >Cash</option>
                             <!-- <option value="Value Card" {{isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="Value Card" ? 'selected':''}}>Value Card</option>-->
                              <option value="Credit Card" {{isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="Credit Card" ? 'selected':''}}>Credit Card</option> 
                              <option value="FOC" {{isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="FOC" ? 'selected':''}}>FOC</option>
                              <option {{isset($row->PAYMENT_TYPE) && $row->PAYMENT_TYPE =='UPI'?'selected="selected"':''}} value="UPI">UPI</option>

                              </select></td>      
                              <td>
                              <input type="text" {{$ActionStatus}}  name="DESCRIPTION[]" id="DESCRIPTION_0" value="{{isset($row->DESCRIPTION)?$row->DESCRIPTION:''}}" {{isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="Value Card" ? 'readonly':''}}   class="form-control"  autocomplete="off"  onclick="getValueCardMaster(this.id)" />
                              </td>
                              <td hidden>
                              <input type="hidden" {{$ActionStatus}} name="VALUEID_REF[]" id="VALUEID_REF_0" value="{{isset($row->VCID_REF)?$row->VCID_REF:''}}"      class="form-control"  autocomplete="off" />  

                              </td>

                     
                              <td><input type="text" {{$ActionStatus}} name="PAID_AMT[]" id="PAID_AMT_0" value="{{isset($row->AMOUNT)?$row->AMOUNT:''}}" onkeyup="getPaymentAmount(this.id,this.value)"  onfocusout="dataDec(this,'2')" class="form-control two-digits"  autocomplete="off"  /></td>
                             
                              <td align="center" ><button class="btn add ainvoice" {{$ActionStatus}} title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                              <button class="btn remove dinvoice" {{$ActionStatus}} title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                          </tr>
                          <tr></tr>
                          @endforeach
                          @endif
...
//   $.ajax({
//     url:'{{route("transaction",[$FormId,"getSacMaster"])}}',
//     type:'POST',
//     success:function(data) {
//       var html = '';
