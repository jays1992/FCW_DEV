...
class TrnFrm541Controller extends Controller{
    ...
    public function add(){
        ...
        return view($this->view.'add', compact(['FormId','doc_req','docarray','objUdf','objGstTypeList','country_state_city','objlastdt','objothcurrency']));       
    }
    ...
    public function view($id=NULL){
        ...
        if(!is_null($id)){
            ...
            $HDR            =   DB::select("SELECT 
                                ...
                                CURRENCY.CRCODE,CURRENCY.CRDESCRIPTION
                                FROM TBL_TRN_ACCESSORY_INVOICE_HDR T1
                                ...
                                LEFT JOIN TBL_MST_CURRENCY CURRENCY ON CURRENCY.CRID=T1.CRID_REF
                                WHERE T1.ACCID='$id'"
                            );
           ...
           $objothcurrency = $this->GetCurrencyMaster(); 
            ...
            return view($this->view.'view',compact(['FormId','objRights','ActionStatus','HDR','MAT','PAYMENT','objGstTypeList','objothcurrency']));      
        }
    ...
    public function edit($id=NULL){
        ...
        if(!is_null($id)){
           ...
           $objothcurrency = $this->GetCurrencyMaster(); 
            ...
            return view($this->view.'edit',compact(['FormId','objRights','ActionStatus','HDR','MAT','PAYMENT','objGstTypeList','objlastdt','objothcurrency']));      
        }
