            ...
            <div class="container-fluid filter">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 pl">
                            ...
                            <input type="hidden" name="CUSTOMER_PROSPECT" id="CUSTOMER_PROSPECT"  class="form-control" value="{{ isset($objSQ->GLID_REF)?$objSQ->GLID_REF:'' }}" autocomplete="off" />
                            ...
                            <input type="hidden" name="CUSTOMER_PROSPECT_TYPE" id="CUSTOMER_PROSPECT_TYPE" class="form-control"   value="{{ isset($objSQ->CUSTOMER_PROSPECT_TYPE)?$objSQ->CUSTOMER_PROSPECT_TYPE:'' }}" autocomplete="off" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" {{$ActionStatus}} name="SubGl_popup" id="txtgl_popup" value="{{$objSQ->QUOTATTION_TYPE =="PROSPECT" ?   $objSQ->PCODE. '-'.$objSQ->NAME: '' }}" class="form-control mandatory"  autocomplete="off" readonly/>
                                <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" value="{{ isset($objSQ->GLID_REF)?$objSQ->GLID_REF:'' }}" />
                                <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off" value="{{ isset($objSQ->SLID_REF)?$objSQ->SLID_REF:'' }}" />
                                <input type="hidden" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE" value="{{isset($objsubglcode->BELONGS_TO)?strtoupper($objsubglcode->BELONGS_TO):''}}" class="form-control" autocomplete="off" />
                                <input type="hidden" name="hdnmaterial" id="hdnmaterial" class="form-control" autocomplete="off" />
