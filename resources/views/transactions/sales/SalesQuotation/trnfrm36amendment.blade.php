        ...
        <form id="frm_trn_sq"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            <input type="radio" onclick='return false'  name="LEAD" id="WITH_LEAD" {{$objSQ->QUOTATTION_TYPE =="PROSPECT" || $objSQ->QUOTATTION_TYPE =="CUSTOMER" ? "checked":""}} value="WITH_LEAD" class="form-radio" style="display: none;">
                            <input type="radio" name="LEAD" onclick='return false' {{$objSQ->QUOTATTION_TYPE =="DIRECT" ? "checked":""}} id="WITHOUT_LEAD" value="WITHOUT_LEAD" class="form-radio" style="display: none;">

                            <div class="col-lg-2 pl"><p>Customer / Prospect</p></div>
                            <div class="col-lg-2 pl">
                              <select {{$ActionStatus}} name="CUSTOMER" id="CUSTOMER" onchange="getCustomer(this.value)" class="form-control mandatory" disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="date" name="SQDT" id="SQDT" value="{{ isset($objSQ->SQDT)?$objSQ->SQDT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
                            </div>
