...
<form id="form_data" method="POST" >
  <div class="container-fluid filter"> 
    ...
    <div class="inner-form"> 
      ...
      <div class="row">
        <div class="col-lg-2 pl"><p>Franchise</p></div>
        <div class="col-lg-6 pl">
          <input type="text"   value="{{$Franchise_Name}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px; width: 1400px"  >
              <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <tbody>
                  ...
                  <td>
                      <select name="DOCUMENT_TYPE[]" id="DOCUMENT_TYPE_0" class="form-control" onchange="getDocType(this.id);">
                        <option value="">Select</option>
                        <option value="SI">Sales Invoice</option>
                        <option value="RGP">Returnable Gate Pass</option>
                        <option value="NRGP">Non Returnable Gate Pass</option> 
                      </select>
                    </td>

                  <td><input type="text" name="DOCUMENT_NO[]" id="DOCUMENT_NO_0"   class="form-control" readonly  autocomplete="off"  onclick="getDocument(this.id)" /></td>
                    <td hidden><input type="hidden" name="DOCUMENTID_REF[]" id="DOCUMENTID_REF_0"      class="form-control"  autocomplete="off" /></td>

                    <td> <input type="text" readonly name="DOCUMENT_DT[]" id="DOCUMENT_DT_0" class="form-control" ></td>

                    <td><input type="text" name="TRANSPORTER_NAME[]" id="TRANSPORTER_NAME_0"   class="form-control" readonly  autocomplete="off"  onclick="getTransporterMaster(this.id)" /></td>
                    <td hidden><input type="hidden" name="TRANSPORTERID_REF[]" id="TRANSPORTERID_REF_0"      class="form-control"  autocomplete="off" /></td>
                   
                    <td> <input type="text" style="text-transform: uppercase" name="DOCKET_NO[]" id="DOCKET_NO_0" class="form-control"></td>
                    <td> <input type="date" name="DISPATCH_DT[]" id="DISPATCH_DT_0" class="form-control"></td>
                    
                    <td>
                      <select name="MODE[]" id="MODE_0" class="form-control" >
                        <option value="">Select</option>
                        <option value="By Air">By Air</option>
                        <option value="By Hand">By Hand</option>
                        <option value="By Surfance">By Surfance</option> 
                        <option value="By Truck">By Truck</option>
                        <option value="Self">Self</option>
                      </select>
                    </td>

                    <td> <input type="text" name="REMARKS[]" id="REMARKS_0" class="form-control"></td>
