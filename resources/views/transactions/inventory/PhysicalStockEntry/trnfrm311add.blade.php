            ...
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                            <div class="col-lg-2 pl">
                              <input type="text" name="DOCNO" id="DOCNO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
             ...
             <div class="col-lg-2 pl"><p>Date</p></div>
                <div class="col-lg-2 pl">
                    ...
                    <input type="date" name="PSEDT" id="PSEDT" onchange='checkPeriodClosing(311,this.value,1),getDocNoByEvent("DOCNO",this,@json($doc_req))' value="{{ old('PSEDT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
           </div>
