...
<form id="transaction_data_form" method="POST"  >
  <div class="container-fluid purchase-order-view"> 
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="date" name="KNOCKOFF_DT" id="KNOCKOFF_DT" value="{{isset($HDR->KNOCKOFF_DT) && $HDR->KNOCKOFF_DT !=''?$HDR->KNOCKOFF_DT:''}}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>
