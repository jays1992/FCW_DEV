...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Quality Inspection (QI)</a>
        </div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="QIGNO" id="QIGNO" VALUE="{{isset($HDR->QIGNO)?$HDR->QIGNO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>Quality Inspection Date</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="QIGDT" id="QIGDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" VALUE="{{isset($HDR->QIGDT)?$HDR->QIGDT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
            <input type="text" name="TEXT_GRNID_REF_DATA" id="TEXT_GRNID_REF_DATA" VALUE="{{isset($HDR->GRN_NO)?$HDR->GRN_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="GRN_REC_QTY" id="GRN_REC_QTY" VALUE="{{isset($HDR->GRN_REC_QTY)?$HDR->GRN_REC_QTY:''}}" class="form-control"  autocomplete="off" readonly />
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <select name="QC_ACCEPTED_AS" id="QC_ACCEPTED_AS" class="form-control"  autocomplete="off">
                <option {{isset($HDR->QC_ACCEPTED_AS) && $HDR->QC_ACCEPTED_AS == 'Normal'?'selected="selected"':''}} value="Normal">Normal</option>
                <option {{isset($HDR->QC_ACCEPTED_AS) && $HDR->QC_ACCEPTED_AS == 'Deviation'?'selected="selected"':''}} value="Deviation">Deviation</option>
                <option {{isset($HDR->QC_ACCEPTED_AS) && $HDR->QC_ACCEPTED_AS == 'Segregation'?'selected="selected"':''}}value="Segregation">Segregation</option>
              </select>              
            </div>
                      ...
                      if(isset($MAT) && !empty($MAT)){
                        foreach ($MAT as $index=>$dataRow){
                            ...
                            echo '<tr  class="participantRow">
                                ...
                                <td><input type="text" name="txtUOMID_popup_'.$index.'"   id="txtUOMID_popup_'.$index.'" value="'.$UOM_CODE_DES.'" class="form-control" autocomplete="off" readonly/></td>
                                ...
                                <td><input type="text" name="txtINTMNTID_popup_'.$index.'"   id="txtINTMNTID_popup_'.$index.'" value="'.$INTMNT_CODE_DES.'" class="form-control" autocomplete="off" readonly/></td>
...
$(document).ready(function(e) {
  ...
  var lastQIGDT = <?php echo json_encode($objlastdt[0]->QIGDT); ?>;
  var today = new Date(); 
...
function validateForm(saveAction){
  ...
  if(parseFloat(QI_PICK_QTY) > parseFloat(GRN_REC_QTY)){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#QIGDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
