...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-2 pl">
          <input type="date" name="DPPDT" id="DPPDT" onchange="checkPeriodClosing(230,this.value,1)" value="{{ $objDPP->DPP_DT }}" class="form-control mandatory DPPDT"  placeholder="dd/mm/yyyy" >         
    </div>
