...
<form id="frm_trn_edit"  method="POST">   
    @csrf
    {{isset($objResponse->MISRID) ? method_field('PUT') : '' }}
	...
	<div class="inner-form">
        ...
        <input type="hidden" name="MISRID" id="MISRID" value="{{isset($objResponse->MISRID) && $objResponse->MISRID !=''?$objResponse->MISRID:''}}" class="form-control"  >
          <input type="text" name="MISRNO" id="MISRNO" value="{{isset($objResponse->MISRNO) && $objResponse->MISRNO !=''?$objResponse->MISRNO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      </div>
			
			<div class="col-lg-1 pl"><p>MISR Date*</p></div>
			<div class="col-lg-2 pl">
			    <input type="date" name="MISRDT" id="MISRDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($objResponse->MISRDT) && $objResponse->MISRDT !=''?$objResponse->MISRDT:''}}" class="form-control mandatory" >
      </div>

      <div class="col-lg-2 pl"><p>RPR No*</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="rpr_popup" id="txtrpr_popup" value="{{isset($objRPRDtl->RPR_NO) && $objRPRDtl->RPR_NO !=''?$objRPRDtl->RPR_NO:''}}"  class="form-control mandatory"  autocomplete="off" readonly disabled/>
        <input type="hidden" name="RPRID_REF" id="RPRID_REF" value="{{isset($objResponse->RPRID_REF) && $objResponse->RPRID_REF !=''?$objResponse->RPRID_REF:''}}" class="form-control" autocomplete="off" />           
      </div>  
    ...
    <div class="row">          
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="store_popup" value="{{isset($objStoreDtl->STCODE) && $objStoreDtl->STCODE !=''?$objStoreDtl->STCODE.'-'.$objStoreDtl->NAME:''}}" id="txtstore_popup" class="form-control mandatory"  autocomplete="off" readonly/>
        <input type="hidden" name="STID_REF" value="{{isset($objResponse->FROM_STID_REF) && $objResponse->FROM_STID_REF !=''?$objResponse->FROM_STID_REF:''}}" id="STID_REF" class="form-control"  />           
      </div>       
      <div class="col-lg-2 pl"><p>To Production Stage*</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="stage_popup" value="{{isset($objPStageDtl->PSTAGE_CODE) && $objPStageDtl->PSTAGE_CODE !=''?$objPStageDtl->PSTAGE_CODE.'-'.$objPStageDtl->DESCRIPTIONS:''}}" id="txtpstage_popup" class="form-control mandatory"  autocomplete="off" readonly/>
        <input type="hidden" name="PSTAGEID_REF" value="{{isset($objResponse->STAGEID_REF) && $objResponse->STAGEID_REF !=''?$objResponse->STAGEID_REF:''}}" id="PSTAGEID_REF" class="form-control"  />           
      </div>   
      <div class="col-lg-2 pl"><p>Issued By*</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="employee_popup" value="{{isset($objEmployeeDtl->EMPCODE) && $objEmployeeDtl->EMPCODE !=''?$objEmployeeDtl->EMPCODE.'-'.$objEmployeeDtl->FNAME.' '.$objEmployeeDtl->LNAME:''}}" id="txtemployee_popup" class="form-control mandatory"  autocomplete="off" readonly/>
        <input type="hidden" name="EMPID_REF" value="{{isset($objResponse->ISSUED_BY) && $objResponse->ISSUED_BY !=''?$objResponse->ISSUED_BY:''}}"  id="EMPID_REF" class="form-control"  />           
      </div>       
    </div> 
		...
		<div class="row">
			...
			<div class="tab-content">
              ...
              @foreach($objMAT as $key => $row)
                ...
                <td><input  type="text" name="popupFGI_{{$key}}" id="popupFGI_{{$key}}" value="{{ $row->MAINITEMID_CODE }}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                ...
                <td><input type="text" name="FGIName_{{$key}}" id="FGIName_{{$key}}" value="{{ $row->MAINITEMID_NAME }}"  class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                <td  hidden ><input type="text" name="popupMAINITEMUOM_{{$key}}"  id="popupMAINITEMUOM_{{$key}}" value="{{ $row->MAINITEMID_UOMCODE }}-{{ $row->MAINITEMID_UOMDESC}}" class="form-control"  autocomplete="off"  readonly style="width:100px;"/></td>
                ...
                <td    hidden  ><input type="text" name="SOID_REF_{{$key}}"  id="SOID_REF_{{$key}}"  value="{{ $row->SOID_REF }}" class="form-control"  /></td>
                <td    hidden  ><input type="text" name="SQID_REF_{{$key}}"  id="SQID_REF_{{$key}}"  value="{{ $row->SQID_REF }}"  class="form-control"  /></td>
                <td    hidden  ><input type="text" name="SEID_REF_{{$key}}"  id="SEID_REF_{{$key}}"  value="{{ $row->SEID_REF }}" class="form-control"  /></td>
                <td    hidden  ><input type="text" name="RPRID_REF_{{$key}}" id="RPRID_REF_{{$key}}" value="{{ $row->RPRID_REF }}" class="form-control"  /></td>
                <td    hidden  ><input type="text" name="PROID_REF_{{$key}}" id="PROID_REF_{{$key}}" value="{{ $row->PROID_REF }}" class="form-control"  /></td>
                ...
                <td  hidden   ><input type="text" name={{"OLDITEM_ID_REF_".$key}} id={{"OLDITEM_ID_REF_".$key}} value="{{ $row->OLDITEMID_REF }}" class="form-control" autocomplete="off" /></td>
                <td  hidden   ><input type="text" name={{"RPR_REQ_QTY_".$key}} id={{"RPR_REQ_QTY_".$key}} value="{{ $row->ISSUED_QTY }}" class="form-control" /></td>
                
                <td><input style="width:200px;" type="text" name={{"ItemName_".$key}} id={{"ItemName_".$key}} class="form-control" value="{{ $row->ITEM_NAME }}"  autocomplete="off"   readonly/></td>
                ...
                <td><input type="text" name={{"popupMUOM_".$key}} id={{"popupMUOM_".$key}} class="form-control"  value="{{ $row->MAIN_UOM_CODE }}" autocomplete="off" style="width: 100px;" readonly/></td>
                <td hidden ><input type="text" name={{"MAIN_UOMID_REF_".$key}} id={{"MAIN_UOMID_REF_".$key}} class="form-control" value="{{ $row->UOMID_REF }}"   autocomplete="off" /></td>
                    
                <td align="center"><a class="btn checkstore"  id="{{$key}}" ><i class="fa fa-clone"></i></a></td>
                <td    hidden ><input type="text" name="TotalHiddenQty_{{$key}}" id="TotalHiddenQty_{{$key}}" value="{{ $row->ISSUED_QTY}}" ></td>
                <td    hidden ><input type="text" name="HiddenRowId_{{$key}}" id="HiddenRowId_{{$key}}" value="{{ $row->BATCH_QTY}}" ></td>
                  

                <td ><input type="text" name="PENDING_QTY_{{$key}}" id="PENDING_QTY_{{$key}}" class="form-control three-digits" value="{{ $row->TOTAL_PENDING }}"  autocomplete="off" readonly  /></td>
                         
                  
                  <td><input type="text" name="STOCK_INHAND_{{$key}}" id="STOCK_INHAND_{{$key}}" value="{{ $row->TOTAL_STOCK }}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly  autocomplete="off"   /></td>
                  <td><input type="text" name="RECEIVED_QTY_MU_{{$key}}" id="RECEIVED_QTY_MU_{{$key}}" value="{{ $row->ISSUED_QTY }}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                  
                  <td><input type="text" name="popupALTUOM_{{$key}}" id="popupALTUOM_{{$key}}" class="form-control" value="{{ $row->AULT_UOM_CODE }}"  autocomplete="off"  readonly/></td>
                  <td hidden  ><input type="text" name="ALT_UOMID_REF_{{$key}}" id="ALT_UOMID_REF_{{$key}}" value="{{ $row->ALT_UOMID_REF }}" class="form-control"  autocomplete="off" /></td>
                  ...
                  <td hidden  ><input type="text" name="SHORT_QTY_{{$key}}" id="SHORT_QTY_{{$key}}" value="{{ $row->SHORT_QTY }}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"  readonly  /></td>
                
                  <td><input type="text" name="REASON_SHORT_QTY_{{$key}}" id="REASON_SHORT_QTY_{{$key}}" value="{{ $row->REASON_SHORT_QTY }}" class="form-control"   autocomplete="off"   /></td>
                  <td><input style="width:200px;" type="text" name="REMARKS_{{$key}}" id="REMARKS_{{$key}}" value="{{ $row->REMARKS }}" class="form-control w-100" autocomplete="off" ></td>
              ...
              @foreach($objUDF as $uindex=>$uRow)
                <tr  class="participantRow3">
                    <td><input type="text" name={{"popupSEID_".$uindex}} id={{"popupSEID_".$uindex}} class="form-control" value="{{$uRow->UDFMISRID_REF}}" autocomplete="off"  readonly/></td>
                    <td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->UDFMISRID_REF}}" autocomplete="off"   /></td>
                    <td hidden><input type="hidden" name={{"UDFismandatory_".$uindex}} id={{"UDFismandatory_".$uindex}} value="{{$uRow->UDFMISRID_REF}}" class="form-control"   autocomplete="off" /></td>
...
var lastdt = <?php echo json_encode($objResponse->MISRDT); ?>;
  var misr = <?php echo json_encode($objResponse); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < misr.MISRDT)
  {
	$('#MISRDT').attr('min',lastdt);
  }
  else
  {
	  $('#MISRDT').attr('min',misr.MISRDT);
  }
  $('#MISRDT').attr('max',sodate);
    ...
    $('#example2').find('.participantRow').each(function(){
      ...
      if($.trim($(this).find("[id*=ITEMID_REF]").val())!=""){
          ...
          item_array[i]={
            ...
            itemDetails[i]={
              'DOCID':$("#MISRID").val(),
              'ITEMID':$(this).find('[id*="ITEMID_REF"]').val(),
              'ISSUED_QTY':$(this).find('[id*="RECEIVED_QTY_MU"]').val(),
              'ITEMCODE':$(this).find('[id*="popupITEMID"]').val()
            };
      ...
      var checkIssue = checkIssueQty(itemDetails);
      ...
      $("#alert").modal('show');
      $("#AlertMessage").text('Item '+checkIssue+' Issue Quantity Not Equal To Serial No Out Quantity In material tab.');
      $("#YesBtn").hide(); 
      $("#NoBtn").hide();  
      $("#OkBtn1").show();
      $("#OkBtn1").focus();
...
function checkIssueQty(itemDetails){
  ...
  var posts = $.ajax({
                url:'{{route("transaction",[$FormId,"checkIssueQty"])}}',
                type:'POST',
                async: false,
                dataType: 'json',
