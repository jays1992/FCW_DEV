	...
	<div class="container-fluid filter">
		<div class="inner-form">
          ...
          <input type="hidden" name="PROID" id="PROID" value="{{ isset($objResponse)?$objResponse->PROID:'' }}" class="form-control" readonly  autocomplete="off"   >
					<input {{$ActionStatus}} type="text" name="PRO_NO" id="PRO_NO" value="{{ isset($objResponse)?$objResponse->PRO_NO:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
					<span class="text-danger" id="ERROR_PRO_NO"></span>
				</div>
					  
				<div class="col-lg-1 pl"><p>PRO Date*</p></div>
				<div class="col-lg-2 pl">
					<input {{$ActionStatus}} type="date" name="PRO_DT" id="PRO_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ isset($objResponse)?$objResponse->PRO_DT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
					<span class="text-danger" id="ERROR_PRO_DT"></span>
				</div>

				<div class="col-lg-1 pl"><p>Title</p></div>
				<div class="col-lg-3 pl">
					<input {{$ActionStatus}} type="text" name="PRO_TITLE" id="PRO_TITLE" value="{{ isset($objResponse)?$objResponse->PRO_TITLE:'' }}"  class="form-control" maxlength="100" autocomplete="off">
					<span class="text-danger" id="ERROR_PRO_TITLE"></span>
				</div>

        <div class="col-lg-1 pl"><p>Direct</p></div>
        <div class="col-lg-1 pl">
          <input {{$ActionStatus}} type="checkbox" name="Direct" id="Direct" value="1" autocomplete="off" onChange="direct()" {{ isset($objResponse->DIRECTPO) && $objResponse->DIRECTPO =='1'?'checked':'' }}  >
          <span class="text-danger" id="ERROR_PRO_TITLE"></span>
        </div>

        <input type="hidden" name="AllStatus" id="AllStatus" value="{{ isset($objResponse)?$objResponse->SELECTIONPARAM:'' }}" >
			...
			<div class="row">
				...
				<div class="tab-content">
                  ...
                  @endphp
                    ...
                    <td hidden><input type="text" name="PRO_MATID_{{$key}}" id="PRO_MATID_{{$key}}" value="{{$row->PRO_MATID}}" class="form-control" autocomplete="off" /></td>
										<td><input {{$ActionStatus}}  type="text" name="txtSL_popup_{{$key}}" id="txtSL_popup_{{$key}}"   value="{{$row->SGLCODE}} {{$row->SLNAME !=''?'-'.$row->SLNAME:''}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
										<td  hidden><input type="text" name="SLID_REF_{{$key}}" id="SLID_REF_{{$key}}" value="{{$row->SLID_REF}}" class="form-control" autocomplete="off" /></td>

										<td><input {{$ActionStatus}}  type="text" name="txtSO_popup_{{$key}}" id="txtSO_popup_{{$key}}"  value="{{$row->SONO}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                    ...
                    <td hidden><input type="text"   name="BOMID_REF_{{$key}}" id="BOMID_REF_{{$key}}" value="{{isset($row->BOMID_REF)?$row->BOMID_REF:''}}" class="form-control" /></td>
                    <td><input {{$ActionStatus}} type="text"   name="BOMDATA_{{$key}}" id="BOMDATA_{{$key}}" value="{{$CONSUME_QTY_REF}}" class="form-control three-digits"  readonly  style="width:100px;"  /></td>

										<td><input {{$ActionStatus}} type="text"   name="QTY_{{$key}}" 		id="QTY_{{$key}}" 		value="{{$SOQTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input {{$ActionStatus}} type="text"   name="BL_SOQTY_{{$key}}" 	id="BL_SOQTY_{{$key}}" 	value="{{$BL_SOQTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input {{$ActionStatus}} type="text"   name="PD_OR_QTY_{{$key}}" 	id="PD_OR_QTY_{{$key}}" value="{{$row->PD_OR_QTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" data-mainitem="{{$mitem_id}}" onKeyup="change_production_order(this.id,this.value)" {{$readonly_wise}} /></td>
										...
										<td align="center" ><span id="tempid_{{$key}}" style="display: none;">{{$mitem_id}}</span>
										  <button {{$ActionStatus}} class="btn add material" title="add" data-toggle="tooltip" type="button" disabled ><i class="fa fa-plus"></i></button>
										  <button {{$ActionStatus}} class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button>
										</td>
					...
					<div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
						<table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
							...
							<tr  class="participantRow3">
								<td><input {{$ActionStatus}} type="text" name={{"popupSEID_".$uindex}} id={{"popupSEID_".$uindex}} class="form-control" value="{{$uRow->UDFPROID_REF}}" autocomplete="off"  readonly/></td>
          ...
          <table id="ItemIDTable2" class="display nowrap table  table-striped table-bordered" style="width:100%" >
            ...
            <tbody>
              <tr>
                ...
                <td style="width:8%;" {{$AlpsStatus['hidden']}} ><input type="text" id="ItemAPNsearch2" class="form-control" autocomplete="off" onkeyup="ItemAPNFunction2()"></td>
                <td style="width:8%;" {{$AlpsStatus['hidden']}} ><input type="text" id="ItemCPNsearch2" class="form-control" autocomplete="off" onkeyup="ItemCPNFunction2()"></td>
                <td style="width:8%;" {{$AlpsStatus['hidden']}} ><input type="text" id="ItemOEMPNsearch2" class="form-control" autocomplete="off" onkeyup="ItemOEMPNFunction2()"></td>
...
function validateForm(actionType,actionMsg){
  ...
  if(PRO_NO ===""){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#PRO_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
function get_materital_item(){
  ...
  $.ajax({
      ...
      data:{
        ...
        subitem_array:subitem_array,AllStatus:AllStatus,'ActionStatus':'{{$ActionStatus}}'
        },
      success:function(data) {
...
function getItemDetailsLevel2(ITEMID_REF){
  ...
  $.ajax({
    url:'{{route("transaction",[$FormId,"getItemDetailsLevel2"])}}',
    type:'POST',
