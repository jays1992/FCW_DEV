...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Preventive Maintenance <br/> Schedule</a>
        </div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="PMSL_NO" id="PMSL_NO" VALUE="{{isset($HDR->PMSL_NO)?$HDR->PMSL_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>Schedule Date</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="PMSL_DATE" id="PMSL_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" VALUE="{{isset($HDR->PMSL_DATE)?$HDR->PMSL_DATE:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>

            <div class="col-lg-2 pl"><p>Machine Code</p></div>
			      <div class="col-lg-2 pl">
              <input type="text" name="MACHINEID_REF_popup" id="txtMACHINEID_REF_popup" VALUE="{{isset($HDR->MACHINE_NO)?$HDR->MACHINE_NO:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
              <input type="hidden" name="MACHINEID_REF" id="MACHINEID_REF" VALUE="{{isset($HDR->MACHINEID_REF)?$HDR->MACHINEID_REF:''}}" class="form-control" autocomplete="off" />
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl"><p>Machine Description</p></div>
			      <div class="col-lg-2 pl">
              <input type="text" name="MACHINEID_DESC" id="MACHINEID_DESC" VALUE="{{isset($HDR->MACHINE_DESC)?$HDR->MACHINE_DESC:''}}" class="form-control"  autocomplete="off" readonly />
			      </div>
            ...
            <div class="col-lg-2 pl">
                <select name="FLEXIBLE_SCHEDULE" id="FLEXIBLE_SCHEDULE"  class="form-control" autocomplete="off"  > 
                  ...
                  <option {{isset($HDR->FLEXIBLE_SCHEDULE) && $HDR->FLEXIBLE_SCHEDULE =="1"?"selected='selected'":""}} value="1">Yes</option>
                  <option {{isset($HDR->FLEXIBLE_SCHEDULE) && $HDR->FLEXIBLE_SCHEDULE =="0"?"selected='selected'":""}} value="0">No</option>
                </select>  
            </div>  
        </div>
                  ...
                  <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="50%" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                      ...
                      <tr>
                        ...
                        <th>Action <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="{{count($SCH)}}"></th>
                      </tr>
                    </thead>

                    <tbody>
                      @if(isset($SCH) && !empty($SCH))
                      @foreach($SCH as $key => $row)
                      <tr  class="participantRow">

                        <td><input type="date"   name="PMSL_FROM_DATE_{{$key}}" id="PMSL_FROM_DATE_{{$key}}" value="{{isset($row->PMSL_FROM_DATE)?$row->PMSL_FROM_DATE:''}}"  class="form-control"   autocomplete="off" style="width:200px;"  /></td>
                        <td><input type="date"   name="PMSL_TO_DATE_{{$key}}" id="PMSL_TO_DATE_{{$key}}"     value="{{isset($row->PMSL_TO_DATE)?$row->PMSL_TO_DATE:''}}" class="form-control"   autocomplete="off" style="width:200px;"  /></td>
                        <td><input type="text"   name="SPECIAL_INST_{{$key}}" id="SPECIAL_INST_{{$key}}"     value="{{isset($row->SPECIAL_INST)?$row->SPECIAL_INST:''}}" class="form-control"   autocomplete="off" style="width:200px;"   /></td>
                  ...
                  <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="50%" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                      ...
                      <tr>
                        ...
                        <th>Action <input class="form-control" type="hidden" name="Row_Count2" id ="Row_Count2" value="{{count($CON)}}"></th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      ...
                      <tr  class="participantRow2">
                        ...
                        <td><input type="text"   name="PMSL_ID_REF_{{$key}}" id="PMSL_ID_REF_{{$key}}" value="{{$key+1}}" class="form-control"   autocomplete="off" style="width:200px;" readonly  /></td>
                        <td><input type="text"   name="SPARE_PART_NAME_{{$key}}" id="SPARE_PART_NAME_{{$key}}" value="{{isset($row->SPARE_PART_NAME)?$row->SPARE_PART_NAME:''}}"   class="form-control"   autocomplete="off" style="width:200px;"  /></td>
