...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Preventive Maintenance <br/>Actual</a>
        </div>
 ...
 <div class="container-fluid purchase-order-view">
   ...
   <div class="container-fluid filter">
     ...
     <div class="row">
            ...
            <input type="text" name="PMAL_NO" id="PMAL_NO" value="{{ isset($objResponse->PMAL_NO)?$objResponse->PMAL_NO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            </div>

            <div class="col-lg-2 pl"><p>Doc Date</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="PMAL_DATE" id="PMAL_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ isset($objResponse->PMAL_DATE)?$objResponse->PMAL_DATE:'' }}"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
            
            <div class="col-lg-2 pl"><p>Machine Code</p></div>
			      <div class="col-lg-2 pl">
              <input type="text" name="MACHINEID_REF_popup" id="txtMACHINEID_REF_popup" value="{{ isset($objResponse->MACHINE_NO)?$objResponse->MACHINE_NO:'' }}" class="form-control mandatory"  autocomplete="off"  readonly/>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl"><p>Machine Description</p></div>
			      <div class="col-lg-2 pl">
              <input type="text" name="MACHINEID_DESC" id="MACHINEID_DESC" value="{{ isset($objResponse->MACHINE_DESC)?$objResponse->MACHINE_DESC:'' }}" class="form-control"  autocomplete="off" readonly />
			      </div>

            <div class="col-lg-2 pl"><p>Maintenance Schedule From Date</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="TEXT_PMSL_FROM_DATE_DATA" id="TEXT_PMSL_FROM_DATE_DATA" value="{{ isset($objResponse->PMSL_FROM_DATE)?$objResponse->PMSL_FROM_DATE:'' }}" class="form-control mandatory"  autocomplete="off" placeholder="dd/mm/yyyy" readonly/>
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="PMSL_TO_DATE" id="PMSL_TO_DATE" value="{{ isset($objResponse->PMSL_TO_DATE)?$objResponse->PMSL_TO_DATE:'' }}"  class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" readonly>
            </div> 
        ...
        <div class="row">
            ...
            <div class="col-lg-10 pl">
                <input type="text" name="SPECIAL_INST" id="SPECIAL_INST" value="{{ isset($objResponse->SPECIAL_INST)?$objResponse->SPECIAL_INST:'' }}"  class="form-control mandatory" autocomplete="off" readonly >
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="ACTUAL_FROM_DATE" id="ACTUAL_FROM_DATE"  value="{{ isset($objResponse->ACTUAL_FROM_DATE)?$objResponse->ACTUAL_FROM_DATE:'' }}" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" >
            </div>
            <div class="col-lg-2 pl"><p>Actual To Date of Maintenance</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="ACTUAL_TO_DATE" id="ACTUAL_TO_DATE"  value="{{ isset($objResponse->ACTUAL_TO_DATE)?$objResponse->ACTUAL_TO_DATE:'' }}"  class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" onchange="getTotalDays()" >
            </div>
            <div class="col-lg-2 pl"><p>Total No. of Days</p></div>
            <div class="col-lg-2 pl">
                <input type="text" name="TOTAL_NO_DAYS" id="TOTAL_NO_DAYS"  value="{{ isset($objResponse->TOTAL_NO_DAYS)?$objResponse->TOTAL_NO_DAYS:'' }}"  class="form-control mandatory" autocomplete="off" readonly>
            </div>
        </div>
       ...
       <div class="row">
           ...
           <div class="col-lg-2 pl">
            <input type="text" name="EMP_REF2" id="EMP_REF2_popup" class="form-control mandatory" value="{{isset($objResponse) && $objResponse->MAINTENANCE_EMPID_REF2!=''?  $objResponse->EMP2_CODE.'-'.$objResponse->EMP2_NAME :''}}" onclick="get_employee('EMP_REF2');" autocomplete="off" readonly/>
       ...
       <div class="row"> 
          <div class="col-lg-2 pl"><p>Status</p></div>
           ...
           <div class="col-lg-2 pl"><p>Remarks</p></div>
            <div class="col-lg-6 pl">
                <input type="text" name="HDR_REMARKS" id="HDR_REMARKS"  value="{{ isset($objResponse->REMARKS)?$objResponse->REMARKS:'' }}" class="form-control mandatory"  autocomplete="off"  />  
            </div>   
       </div>
     </div>
                      ...
                      <tbody>
                        ...
                        @foreach($CONSUMELIST as $key => $row)
                         ...
                         <tr class="participantRow3">
                           ...
                           <td><input type="text" name="SPARE_PARTS_CONSUMED_0" id="SPARE_PARTS_CONSUMED_0" value="{{$row->SPARE_PART_NAME}}" class="form-control" autocomplete="off" ></td>
                           <td align="center" style="width: 100;">
                               <button type="button" class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                               <button type="button" class="btn remove" title="Delete" id="btnremove" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
                           </td>
                    ...
                    @foreach($RETURNLIST as $key => $row)
                      <tr class="participantRow4">
                         ...
                         <td><input type="text" name="SL_NO2_0" id="SL_NO2_0" class="form-control" autocomplete="off" readonly value="1" readonly ></td>
                           <td><input type="text" name="SPARE_PART_NAME_0" id="SPARE_PART_NAME_0" value="{{$row->SPARE_PART_NAME}}" class="form-control" autocomplete="off" ></td>
                           <td><input type="text" name="SPARE_RETURN_TO_0" id="SPARE_RETURN_TO_0" class="form-control" value="{{$row->SPARE_RETURN_TO}}" autocomplete="off" ></td>
                           <td align="center" style="width: 100;">
                               <button type="button" class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                               <button type="button" class="btn remove" title="Delete" id="btnremove" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
                           </td>
...
$("#TIME").val(time); 
  ...
  var pmal = <?php echo json_encode($objResponse); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < pmal.PMAL_DATE)
  {
	$('#PMAL_DATE').attr('min',lastdt);
  }
  else
  {
	  $('#PMAL_DATE').attr('min',pmal.PMAL_DATE);
  }
...
function validateForm(saveAction){
  ...
  if(PMAL_NO ===""){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#PMAL_DATE").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
