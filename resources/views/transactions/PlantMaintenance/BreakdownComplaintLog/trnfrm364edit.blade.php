  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="BDCL_DOCNO" id="BDCL_DOCNO"  value="{{isset($objResponse->BDCL_NO) && $objResponse->BDCL_NO !=''?$objResponse->BDCL_NO:''}}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="BDCL_DATE" id="BDCL_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($objResponse->BDCL_DATE) && $objResponse->BDCL_DATE !=''?$objResponse->BDCL_DATE:''}}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
          <span class="text-danger" id="ERROR_BDCL_DATE"></span>
        </div>

        <div class="col-lg-2 pl"><p>Time</p></div>
        <div class="col-lg-2 pl">
          <input type="time" name="TIME" id="TIME" value="{{isset($TIME) && $TIME !=''?$TIME:''}}" class="form-control mandatory"  placeholder="" >
      ...
      <div class="row">
               ...
               <div class="col-lg-2 pl"><p>Complaint By</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="COMPLAINT_BY" id="COMPLAINT_BY" maxlength="50" value="{{isset($objResponse->COMPLAINT_BY) && $objResponse->COMPLAINT_BY !=''?$objResponse->COMPLAINT_BY:''}}" class="form-control mandatory"  placeholder="" >
               <span class="text-danger" id="ERROR_COMPLAINT_BY"></span>
                </div>  

                <div class="col-lg-2 pl"><p>Department</p></div>
                <div class="col-lg-2 pl">
                    <input type="text" name="Department_popup" id="txtDepartment_popup" value="{{isset($objResponse->DEPARTMENT_CODE) && $objResponse->DEPARTMENT_CODE !=''?$objResponse->DEPARTMENT_CODE.'-'.$objResponse->DEPARTMENT_NAME:''}}"  class="form-control mandatory"  autocomplete="off"  readonly/>
                ...
                <div class="col-lg-2 pl">
                    <input type="text" name="Priority_popup" id="txtPriority_popup" value="{{isset($objResponse->PRIORITYCODE) && $objResponse->PRIORITYCODE !=''?$objResponse->PRIORITYCODE.'-'.$objResponse->PRIORITY_DESC:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
               ...
               <div class="col-lg-2 pl"><p>Complaint To</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="COMPLAINT_TO" id="COMPLAINT_TO" value="{{isset($objResponse->COMPLAINT_TO) && $objResponse->COMPLAINT_TO !=''?$objResponse->COMPLAINT_TO:''}}" maxlength="50"  class="form-control mandatory"  placeholder="" >
              ...
              <input type="checkbox" name="COMPLAINT_FOR"  id="chk_Machine"  {{isset($objResponse) && $objResponse->MACHINE=='1'?'checked':''}} value="Machine"  />&nbsp;&nbsp;<label>   Machine </label>
              </div>
              <div class="col-lg-2 pl">
                    <input type="checkbox" name="COMPLAINT_FOR" id="chk_Generator" value="Genset" {{isset($objResponse) && $objResponse->GENERATOR=='1'?'checked':''}}      /> &nbsp;&nbsp;<label>   Generator </label>
              </div>    
        ...
        <div class="row">
               <div class="col-lg-2 pl"><p>Machine / Genset  Code</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="Machinepopup" id="txtMachinepopup" value="{{isset($objResponse->MACHINE_NO) && $objResponse->MACHINE_NO !=''?$objResponse->MACHINE_NO.'-'.$objResponse->MACHINE_DESC:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
                ...
                <input type="text" name="PROBLEM_LOG_DET" id="PROBLEM_LOG_DET" maxlength="50" value="{{isset($objResponse->PLOG_DETAILS) && $objResponse->PLOG_DETAILS !=''?$objResponse->PLOG_DETAILS:''}}" class="form-control mandatory"  placeholder="" >
        ...
        <div class="row">
                ...
                <div class="col-lg-2 pl">
                    <input type="text" name="Reasoncode1_popup" id="txtReasoncode1_popup" value="{{isset($objResponse->REASON1_CODE) && $objResponse->REASON1_CODE !=''?$objResponse->REASON1_CODE:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
                ...
                <div class="col-lg-6 pl">
                    <input type="text" name="BREAKDOWN1_REASON_DESC" id="BREAKDOWN1_REASON_DESC" value="{{isset($objResponse->REASON1_DESC) && $objResponse->REASON1_DESC !=''?$objResponse->REASON1_DESC:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
        ...
        <div class="col-lg-2 pl"><p>Breakdown Reason Code 2</p></div>
                <div class="col-lg-2 pl">
                    <input type="text" name="Reasoncode2_popup" id="txtReasoncode2_popup" value="{{isset($objResponse->REASON2_CODE) && $objResponse->REASON2_CODE !=''?$objResponse->REASON2_CODE:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
                ...
                <div class="col-lg-6 pl">
                    <input type="text" name="BREAKDOWN2_REASON_DESC" value="{{isset($objResponse->REASON2_DESC) && $objResponse->REASON2_DESC !=''?$objResponse->REASON2_DESC:''}}" id="BREAKDOWN2_REASON_DESC" class="form-control mandatory"  autocomplete="off"  readonly/>
                ...
                <div class="col-lg-4 pl">
                    <input type="text" name="REMARKS1" id="REMARKS1" class="form-control mandatory" value="{{isset($objResponse->REMARKS_1) && $objResponse->REMARKS_1 !=''?$objResponse->REMARKS_1:''}}" autocomplete="off"  />
                ...
                <div class="col-lg-4 pl">
                    <input type="text" name="REMARKS2" id="REMARKS2" class="form-control mandatory" value="{{isset($objResponse->REMARKS_2) && $objResponse->REMARKS_2 !=''?$objResponse->REMARKS_2:''}}" autocomplete="off"  />
...
$(document).ready(function(e) {
  ...
  var lastdt = <?php echo json_encode($objlastdt[0]->BDCL_DATE); ?>;
  var bdcl = <?php echo json_encode($objResponse); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < bdcl.BDCL_DATE)
  {
	$('#BDCL_DATE').attr('min',lastdt);
  }
  else
  {
	  $('#BDCL_DATE').attr('min',bdcl.BDCL_DATE);
  }
  $('#BDCL_DATE').attr('max',sodate);
