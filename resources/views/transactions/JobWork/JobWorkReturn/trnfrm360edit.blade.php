...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Job Work Return (JWR)</a>
    </div>
      ...
      <div class="inner-form" id="Header_Form" >
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input type="text" name="JWRNO" id="JWRNO" value="{{isset($DATA_HDR->JWRNO)?$DATA_HDR->JWRNO:NULL}}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
          </div>
            
          <div class="col-lg-2 pl"><p>JWR Date</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="JWRDT" id="JWRDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($DATA_HDR->JWRDT)?$DATA_HDR->JWRDT:NULL}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>

          <div class="col-lg-2 pl"><p>Vendor</p></div>
          <div class="col-lg-2 pl">
              <input type="text" name="txtVID_popup" id="txtVID_popup"  value="{{isset($objsubglcode->VCODE)?$objsubglcode->VCODE:''}} - {{isset($objsubglcode->NAME)?$objsubglcode->NAME:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
              <input type="hidden" name="VID_REF" id="VID_REF" value="{{isset($DATA_HDR->VID_REF)?$DATA_HDR->VID_REF:NULL}}" class="form-control" autocomplete="off" />
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="VENDOR_INVOICE_NO" id="VENDOR_INVOICE_NO" value="{{isset($DATA_HDR->Vendor_Invoice_No)?$DATA_HDR->Vendor_Invoice_No:NULL}}" autocomplete="off" class="form-control" maxlength="200"  >
          </div>
          ...
          <div class="col-lg-2 pl">
            <select  name="TRANSPORT_MODE" id="TRANSPORT_MODE" class="form-control" autocomplete="off" >
              ...
              <option {{isset($DATA_HDR->TRANSPORT_MODE) && $DATA_HDR->TRANSPORT_MODE =='By Road'?'selected="selected"':''}} value="By Road">By Road</option>
              <option {{isset($DATA_HDR->TRANSPORT_MODE) && $DATA_HDR->TRANSPORT_MODE =='By Sea'?'selected="selected"':''}} value="By Sea">By Sea</option>
              <option {{isset($DATA_HDR->TRANSPORT_MODE) && $DATA_HDR->TRANSPORT_MODE =='By Air'?'selected="selected"':''}} value="By Air">By Air</option>
            </select>
          </div>

          <div class="col-lg-2 pl"><p>Vehicle No</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="VCL_NO" id="VCL_NO" value="{{isset($DATA_HDR->VECHILE_NO)?$DATA_HDR->VECHILE_NO:NULL}}" autocomplete="off" class="form-control mandatory" maxlength="200"  >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="txt_TRASPORTER_popup" id="txt_TRASPORTER_popup" value="{{ isset($DATA_HDR->TRANSPORTER_CODE)?$DATA_HDR->TRANSPORTER_CODE:NULL }} - {{ isset($DATA_HDR->TRANSPORTER_NAME)?$DATA_HDR->TRANSPORTER_NAME:NULL }}" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="TRASPORTER_NAME" id="TRASPORTER_NAME" value="{{isset($DATA_HDR->TRANSPORTERID_REF)?$DATA_HDR->TRANSPORTERID_REF:NULL}}" class="form-control" autocomplete="off" />                                                              
          </div>

          <div class="col-lg-2 pl"><p>Driver Name</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="DRIVER_NAME" id="DRIVER_NAME" value="{{isset($DATA_HDR->DRIVER_NAME)?$DATA_HDR->DRIVER_NAME:NULL}}" autocomplete="off" class="form-control" maxlength="200"  >
          </div>

          <div class="col-lg-2 pl"><p>Purpose</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="PURPOSE" id="PURPOSE" value="{{isset($DATA_HDR->PURPOSE)?$DATA_HDR->PURPOSE:NULL}}"  autocomplete="off" class="form-control mandatory" maxlength="200"  >
          </div>
        </div>
...
<tbody>
@if(!empty($DATA_MAT))
@foreach($DATA_MAT as $key => $row)

<?php  
$item_unique_row_id =   $row->JWIID_REF."_".$row->GEJWOID_REF."_".$row->GRJID_REF."_".$row->JWCID_REF."_".$row->JWOID_REF."_".$row->PROID_REF."_".$row->SOID_REF."_".$row->SQID_REF."_".$row->SEID_REF."_".$row->ITEMID_REF;
...
$TaxAmt     =   number_format((($row->RETURN_QTY*$row->RATE_PUOM) - 0),2, '.', '');
...
<td hidden><input type="hidden" id="exist_{{$key}}" name="exist_{{$key}}" value="{{$item_unique_row_id}}" > </td>
...
<td><input type="text" name="txtJWID_popup_{{$key}}" id="txtJWID_popup_{{$key}}" value="{{ $row->JWINO }}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td hidden><input type="hidden" name="JWID_REF_{{$key}}" id="JWID_REF_{{$key}}"  value="{{ $row->JWIID_REF }}" class="form-control" autocomplete="off" /></td>

<td hidden><input type="text" name="GEJID_REF_{{$key}}" id="GEJID_REF_{{$key}}" value="{{ $row->GEJID_REF }}" class="form-control" autocomplete="off" /></td>      
<td hidden><input type="text" name="GRJID_REF_{{$key}}" id="GRJID_REF_{{$key}}" value="{{ $row->GRJID_REF }}" class="form-control" autocomplete="off" /></td>      
...
<td hidden><input type="hidden" name="SSO_DATE_{{$key}}" id="SSO_DATE_{{$key}}" class="form-control" ></td>
<td hidden><input type="hidden" name="Itemspec_{{$key}}" id="Itemspec_{{$key}}" class="form-control" ></td>
<td hidden><input type="hidden" name="REMARKS_{{$key}}" id="REMARKS_{{$key}}"   class="form-control" ></td>

<td hidden><input type="text" name="SQMUOM_{{$key}}" id="SQMUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td><input type="text" name="SQMUOMQTY_{{$key}}" id="SQMUOMQTY_{{$key}}" value="{{ $row->RECV_QTY }}" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
...
<td><input type="text" name="popupMUOM_{{$key}}" id="popupMUOM_{{$key}}" value="{{ $row->MAIN_UOM_CODE }}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input type="text"   name="GRNNO_{{$key}}" id="GRNNO_{{$key}}" value="{{ $row->GRNNO }}" class="form-control"   autocomplete="off" style="width:150px;" readonly /></td>  

<td align="center"><a class="btn checkstore" onclick="getStore(this.id)"  id="{{$key}}" ><i class="fa fa-clone"></i></a></td>
<td hidden ><input type="hidden" name="TotalHiddenQty_{{$key}}" id="TotalHiddenQty_{{$key}}" value="{{ $row->RETURN_QTY }}" ></td>
<td hidden ><input type="hidden" name="HiddenRowId_{{$key}}" id="HiddenRowId_{{$key}}" value="{{ $row->BATCH_QTY_REF }}" ></td>

      
<td><input type="text" name="SO_QTY_{{$key}}" id="SO_QTY_{{$key}}" value="{{ $row->RETURN_QTY }}" class="form-control" maxlength="13" onkeypress="return isNumberDecimalKey(event,this)"  autocomplete="off" readonly  style="width:75px;" /></td>
<td><input type="text"   name="STORE_NAME_{{$key}}" id="STORE_NAME_{{$key}}" value="{{ $row->STORE_NAME }}" class="form-control"   autocomplete="off" style="width:200px;" readonly /></td>  
<td hidden><input type="hidden" name="SO_FQTY_{{$key}}" id="SO_FQTY_{{$key}}" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>
...
<td><input type="text" name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{ $row->RATE_PUOM }}" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
<td><input type="text" name="DISAFTT_AMT_{{$key}}" id="DISAFTT_AMT_{{$key}}" value="{{ $TaxAmt }}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>

<td style="text-align:center;" ><input type="checkbox" value="{{$row->GST}}" name='flagtype_{{$key}}' id="flagtype_{{$key}}" {{$GST_FLAGE_CHECKED}} ></td>

<td><input type="text" name="IGST_{{$key}}" id="IGST_{{$key}}" value="{{ $row->IGST }}" class="form-control four-digits" maxlength="8"  autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="IGSTAMT_{{$key}}" id="IGSTAMT_{{$key}}"  value="{{ $IGSTAMT }}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="CGST_{{$key}}" id="CGST_{{$key}}" value="{{ $row->CGST }}" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="CGSTAMT_{{$key}}" id="CGSTAMT_{{$key}}"  value="{{ $CGSTAMT }}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="SGST_{{$key}}" id="SGST_{{$key}}" value="{{ $row->SGST }}" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="SGSTAMT_{{$key}}" id="SGSTAMT_{{$key}}"  value="{{ $SGSTAMT }}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="TGST_AMT_{{$key}}" id="TGST_AMT_{{$key}}" value="{{ $TOTGST }}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="TOT_AMT_{{$key}}" id="TOT_AMT_{{$key}}" value="{{ $TOTAL }}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
                                        ...
                                        @if(!empty($objSOUDF))
                                            @foreach($objSOUDF as $Ukey => $Urow)
                                                <tr  class="participantRow4">
                                                    ...
                                                    <td hidden><input type="hidden" name={{"UDFSOID_REF_".$Ukey}}  id={{"UDFSOID_REF_".$Ukey}} class="form-control" value="{{$Urow->UDFJWRID_REF}}" autocomplete="off" /></td>
                                            ...
                                            @foreach($objUdfSOData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td hidden><input type="hidden" name={{"UDFSOID_REF_".$uindex}} id={{"UDFSOID_REF_".$uindex}} class="form-control" value="{{$uRow->UDFJWRID}}" autocomplete="off"   /></td>
...
$(document).ready(function(e) {
  ...
  var Material = $("#Material").html(); 
    ...
    var obj = <?php echo json_encode($DATA_MAT); ?>;
    ...
    $.each( soudf, function( soukey, souvalue ) {
        $.each( udfforso, function( usokey, usovalue ) { 
            if(souvalue.UDFJWRID_REF == usovalue.UDFJWRID)
            {
    ...
    $.each( obj, function( key, value ) {
        ...
        if(parseFloat(value.RETURN_QTY) > 0){

          var amtbeforedis = parseFloat(value.RATE_PUOM*value.RETURN_QTY).toFixed(2);

        }
        else{

          var amtbeforedis = parseFloat(value.RATE_PUOM).toFixed(2);
...
function validateForm(saveAction,saveMsg){
  ...
  if(JWRNO ===""){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#JWRDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
$(document).ready(function(){
  var lastdt = <?php echo json_encode($DATA_HDR->JWRDT); ?>;
  var jwr = <?php echo json_encode($DATA_HDR); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < jwr.JWRDT)
  {
	$('#JWRDT').attr('min',lastdt);
  }
  else
  {
	  $('#JWRDT').attr('min',jwr.JWRDT);
  }
  $('#JWRDT').attr('max',sodate);
});
