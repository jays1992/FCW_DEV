...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->EMP_VAID}}" value="{{$val->EMP_VAID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->EMPVA_DOCDT) && $val->EMPVA_DOCDT !=''?$val->EMPVA_DOCDT:''}}" ></td>
              <td>{{isset($val->EMPVA_DOCNO) && $val->EMPVA_DOCNO !=''?$val->EMPVA_DOCNO:''}}</td>
