...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <button class="btn topnavbt" id="btnCancel" {{$objRights->CANCEL != 1 ? '' : ''}}><i class="fa fa-times"></i> Cancel</button>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->PGBID }}" value="{{$val->PGBID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->PROVISION_DT) && $val->PROVISION_DT !=''?$val->PROVISION_DT:''}}" ></td>
              <td>{{isset($val->PGB_CODE) && $val->PGB_CODE !=''?$val->PGB_CODE:''}}</td>
