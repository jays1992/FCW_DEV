       ...
       <div class="inner-form">              
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 ...
                 <div class="col-lg-2 pl">
                   <input type="date" name="REMB_DT" id="REMB_DT" onchange="checkPeriodClosing(413,this.value,1)" value="{{ $HDR->REIMBURSE_DOCDT }}" class="form-control"  maxlength="100" > 
                 </div>
 ...
 if(CLAIM_DOC_NO ===""){
   ...
   return false;
     ...
     if(jQuery.inArray("false", allblank1) !== -1){
       ...
       else if(checkPeriodClosing(413,$("#REMB_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
var formResponseMst = $( "#frm_mst_edit" );
 ...
 $( "#btnSave" ).click(function() {
  ...
  $("#btnApprove").click(function() {        
    if(formResponseMst.valid()){
      if(checkPeriodClosing(413,$("#REMB_DT").val(),0) ==0){
        $("#YesBtn").hide();
        $("#NoBtn").hide();
        $("#OkBtn").hide();
        $("#OkBtn1").show();
