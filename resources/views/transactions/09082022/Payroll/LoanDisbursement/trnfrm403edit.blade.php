        ...
        <div class="inner-form">
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="LOAN_DISB_DOCNO" id="LOAN_DISB_DOCNO" VALUE="{{isset($objResponse->LOAN_DISB_DOCNO)?$objResponse->LOAN_DISB_DOCNO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
                  <span class="text-danger" id="ERROR_LEAVE_APP_NO"></span> 
                </div>

                <div class="col-lg-2 pl"><p>LD Date*</p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="LOAN_DISB_DOCDT" id="LOAN_DISB_DOCDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ $objResponse->LOAN_DISB_DOCDT }}" class="form-control"  maxlength="100" > 
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl"><p>Description*</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" id="LOANTYPE_DESC" value="{{ $objLoanTyName->LOANTYPE_DESC }}" class="form-control" readonly  maxlength="100" >
                <input type="hidden" id="focusid" >
                <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
              </div>
              ...
              <div class="col-lg-2 pl"><p>Disbursed Loan Amount</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="LOAN_DISB_AMT" id="LOAN_DISB_AMT" value="{{ $objResponse->LOAN_DISB_AMT }}" class="form-control" onkeyup="disLAount(this.id)" onkeypress="return onlyNumberKey(event)"  maxlength="100">
                </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="NO_OF_INSTALL" id="NO_OF_INSTALL" value="{{ $objResponse->NO_OF_INSTALL }}" class="form-control" onkeyup="disLAount(this.id)" onkeypress="return onlyNumberKey(event)"  maxlength="100" >   
              </div>
            
              <div class="col-lg-2 pl"><p>EMI Amount*</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="EMI_AMT" id="EMI_AMT" value="{{ $objResponse->EMI_AMT }}" class="form-control" readonly  maxlength="100"> 
              <input type="hidden" id="focusid" >
              <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="REMARKS" id="REMARKS" value="{{ $objResponse->REMARKS }}" class="form-control"  maxlength="100" > 
              </div>
            </div>
        </div>
      </form>
...
function validateForm(){
  ...
  var LOAN_DISB_DOCNO             =   $.trim($("[id*=LOAN_DISB_DOCNO]").val());
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#LOAN_DISB_DOCDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
$("#btnApprove").click(function() {
        ...
        if(formResponseMst.valid()){
          ...
          if(checkPeriodClosing('{{$FormId}}',$("#LOAN_DISB_DOCDT").val(),0) ==0){
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
