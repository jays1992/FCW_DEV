          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    @if(!empty($objDDNO))
                        @if($objDDNO->SYSTEM_GRSR == "1")
                            <input type="text" name="LOAN_DISB_DOCNO" id="LOAN_DISB_DOCNO" value="{{ $objDPDOCNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus required>
                        @endif
                        @if($objDDNO->MANUAL_SR == "1")
                            <input type="text" name="LOAN_DISB_DOCNO" id="LOAN_DISB_DOCNO" value="{{ old('LOAN_DISB_DOCNO') }}" class="form-control mandatory" maxlength="{{$objDDNO->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus required>
                        @endif
                    @endif    
                  ...
                  <div class="col-lg-2 pl"><p>LD Date*</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="LOAN_DISB_DOCDT" id="LOAN_DISB_DOCDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control"  maxlength="100" > 
                    </div>
                ...
                <div class="row">
                  <div class="col-lg-2 pl"><p>Loan Type Code*</p></div>
                    <div class="col-lg-2 pl">
                      <select name="LOANTYPEID_REF" id="LOANTYPEID_REF" class="form-control mandatory" onchange="getLtypeCode(this.value)" tabindex="4">
                        ...
                        <option value="{{$val->LOANTYPEID}}">{{$val->LOANTYPE_CODE}}</option>
                        @endforeach
                      </select>
                      <span class="text-danger" id="ERROR_PAYPERIODID_REF"></span>                             
                    </div>
                  ...
                  <div class="col-lg-2 pl"><p>Description</p></div>
                    <div class="col-lg-2 pl">
                      <input type="text" id="LOANTYPE_DESC" class="form-control" readonly  maxlength="100" > 
                    </div>
                
                <div class="col-lg-2 pl"><p>Disbursed Loan Amount*</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="LOAN_DISB_AMT" id="LOAN_DISB_AMT" class="form-control" onkeyup="disLAount(this.id)" onkeypress="return onlyNumberKey(event)"  maxlength="100"> 
                  </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="NO_OF_INSTALL" id="NO_OF_INSTALL" class="form-control" onkeyup="disLAount(this.id)" onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                </div>
              
                <div class="col-lg-2 pl"><p>EMI Amount  *</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="EMI_AMT" id="EMI_AMT" class="form-control" readonly  maxlength="100"> 
                <input type="hidden" id="focusid" >
                <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
              </div>
...
function validateForm(){
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("transaction",[403,"save"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
