...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Full & Final Settlement</a>
                </div><!--col-2-->
      ...
      <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  >       
       ...
       <div class="inner-form">              
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="CLAIM_DOC_NO" id="CLAIM_DOC_NO" value="{{ $HDR->REIMBURSE_DOCNO }}" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                 <span class="text-danger" id="ERROR_CLAIM_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="REMB_DT" id="REMB_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ $HDR->REIMBURSE_DOCDT }}" class="form-control"  maxlength="100" > 
                 </div>
               ...
               <div class="col-lg-2 pl"><p>Name</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="FNAME" id="FNAME" value="{{ $HDR->FNAME }}" class="form-control" readonly  maxlength="100" > 
                 </div>
             </div>
             ...
             <div class="col-lg-2 pl"><p>Earning Head Code *</p></div>
                 <div class="col-lg-2 pl">
                 <select name="EARNING_HEADID_REF" id="EARNING_HEADID_REF" class="form-control mandatory" onchange="getEearHeadName(this.value)" tabindex="4">
                   <option value="" selected="">Select</option>
               ...
               <div class="col-lg-2 pl"><p>Name</p></div>
               <div class="col-lg-2 pl">
                 <input type="text" name="EARNING_HEAD_DESC" id="EARNING_HEAD_DESC" value="{{ $HDR->EARNING_HEAD_DESC }}" class="form-control" readonly  maxlength="100" > 
               </div>

               <div class="col-lg-2 pl"><p>Amount</p></div>
               <div class="col-lg-2 pl">
                 <input type="text" name="REMAMOUNT" id="REMAMOUNT" value="{{ $HDR->AMOUNT }}" class="form-control" onkeypress="return onlyNumberKey(event)" maxlength="100" > 
               </div>
             </div> 
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Bill Submitted </p></div>
                   <div class="col-lg-2 pl">
                   <input type="checkbox" name="BILLSUB" id="BILLSUB" value="1" {{isset($HDR->BILL_SUBMITTED) && $HDR->BILL_SUBMITTED =='1'?'checked':''}} > 
                 </div>

                 <div class="col-lg-2 pl"><p>Vendor Name</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="VNAME" id="VNAME" value="{{ isset($HDR->VENDOR_NAME)?$HDR->VENDOR_NAME:'' }}" class="form-control" maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Remarks</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="REMARKS" id="REMARKS" value="{{ $HDR->REMARKS }}" class="form-control" maxlength="100" > 
                 </div>
               </div> 
                     ...
                     <tbody>
                      ...
                      @foreach($MAT as $key => $row)
                       <tr  class="participantRow">
                         <td><input  class="form-control" type="text" name="BILLNO[]" id={{"BILLNO_".$key}} value="{{ $row->BILL_NO }}"  autocomplete="off" style="width: 99%"></td>
                         <td><input  class="form-control" type="date" name="BILL_DT[]" id={{"BILL_DT_".$key}} value="{{ $row->BILL_DT }}"  autocomplete="off" style="width: 99%"></td>
