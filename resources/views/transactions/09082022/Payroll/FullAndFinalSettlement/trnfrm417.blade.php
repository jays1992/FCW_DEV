...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->PGBID}}" value="{{$val->PGBID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->REIMBURSE_DOCDT) && $val->REIMBURSE_DOCDT !=''?$val->REIMBURSE_DOCDT:''}}" ></td>
        ...
        <form id="transactionForm399Print" action="{{ route('transactiongetlist',[$FormId,'printdata'])}}" method="POST" >
            @csrf
