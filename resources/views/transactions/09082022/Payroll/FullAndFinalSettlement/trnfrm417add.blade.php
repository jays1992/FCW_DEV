                  ...
                  <div class="col-lg-2 pl"><p>Doc No*</p></div>
                    <div class="col-lg-2 pl">
                      ...
                      @if($objDD->SYSTEM_GRSR == "1")
                          <input type="text" name="CLAIMFINALSETLMT_DOC_NO" id="CLAIMFINALSETLMT_DOC_NO" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                      @endif
                      @if($objDD->MANUAL_SR == "1")
                          <input type="text" name="CLAIMFINALSETLMT_DOC_NO" id="CLAIMFINALSETLMT_DOC_NO" value="{{ old('CLAIMFINALSETLMT_DOC_NO') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                      @endif
                    @endif 
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="CLAIMFINALSETLMT_DT" id="CLAIMFINALSETLMT_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control"  maxlength="100" > 
                    </div>
                            ...
                            <table id="example4" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                              ...
                              <tr  class="participantRow">
                                <td><select name="DEDHEAD_REF[]" id="DEDHEAD_REF_0" onchange="getDedHeadName(this.id,this.value)" class="form-control mandatory" tabindex="4">
                                    ...
                                    <option value="{{$val->DEDUCTION_HEADID}}">{{$val->DEDUCTION_HEADCODE}}</option>
                                    @endforeach
                                  </select>
                                </td>
