          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl"><p>LA Date*</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="LEAVE_APP_DT" id="LEAVE_APP_DT" onchange="checkPeriodClosing(402,this.value,1)" class="form-control"  maxlength="100" > 
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="date" name="LEAVE_APP_FRDT" id="LEAVE_APP_FRDT" onchange="leaveFromDate(this.id)" class="form-control"  maxlength="100" > 
                  </div>
                
                  <div class="col-lg-2 pl"><p>LA To Date *</p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="LEAVE_APP_TODT" id="LEAVE_APP_TODT" onchange="leaveFromDate(this.id)" class="form-control"  maxlength="100" >
                  <input type="hidden" id="focusid" >
                  <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="REASON_LEAVE" id="REASON_LEAVE" class="form-control"  maxlength="100" > 
                </div>
              
                <div class="col-lg-2 pl"><p>Address During the leave </p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="ADDRESS_LEAVE" id="ADDRESS_LEAVE" class="form-control"  maxlength="100"> 
                <input type="hidden" id="focusid" >
                <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
              </div>
              ...
              <div class="col-lg-2 pl"><p>Contact no During the leave 1 </p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="MONO_INLEAVE1" id="MONO_INLEAVE1" onkeypress="return onlyNumberKey(event)" class="form-control"  maxlength="100" > 
                </div>
              </div>
              <div class="row">
                <div class="col-lg-2 pl"><p>Contact no During the leave 2 </p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="MONO_INLEAVE2" id="MONO_INLEAVE2" onkeypress="return onlyNumberKey(event)" class="form-control"  maxlength="100" > 
                </div>
              </div>
          </div>
        </form>
...
function leaveFromDate(id){
  var LEAVE_APP_FRDT    =   $('#LEAVE_APP_FRDT').val();
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("transaction",[402,"save"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
