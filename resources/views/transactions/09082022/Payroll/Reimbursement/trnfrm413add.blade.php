         ...
         <form id="frm_mst_add" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          ...
          <div class="inner-form">              
                  ...
                  <div class="col-lg-2 pl"><p>Doc No*</p></div>
                    <div class="col-lg-2 pl">
                      ...
                      @if($objDD->SYSTEM_GRSR == "1")
                          <input type="text" name="CLAIM_DOC_NO" id="CLAIM_DOC_NO" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                      @endif
                      @if($objDD->MANUAL_SR == "1")
                          <input type="text" name="CLAIM_DOC_NO" id="CLAIM_DOC_NO" value="{{ old('CLAIM_DOC_NO') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                      @endif
                  @endif 
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="REMB_DT" id="REMB_DT" onchange="checkPeriodClosing(413,this.value,1)" class="form-control"  maxlength="100" > 
                    </div>
                ...
                <div class="col-lg-2 pl"><p>Earning Head Code *</p></div>
                  ...
                  <div class="col-lg-2 pl"><p>Name</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="EARNING_HEAD_DESC" id="EARNING_HEAD_DESC" class="form-control" readonly  maxlength="100" > 
                  </div>

                  <div class="col-lg-2 pl"><p>Amount</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="REMAMOUNT" id="REMAMOUNT" class="form-control" onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                  </div>
                </div> 
                ...
                <div class="row">
                  <div class="col-lg-2 pl"><p>Bill Submitted </p></div>
                      <div class="col-lg-2 pl">
                      <input type="checkbox" name="BILLSUB" id="BILLSUB" value="1"> 
                    </div>
  
                    <div class="col-lg-2 pl"><p>Vendor Name</p></div>
                    <div class="col-lg-2 pl">
                      <input type="text" name="VNAME" id="VNAME" class="form-control" maxlength="100" > 
                    </div>
                      ...
                      <div class="table-responsive table-wrapper-scroll-y" style="height:500px;margin-top:10px;" >
                        ...
                        <tbody>
                          <tr  class="participantRow">
                            <td><input  class="form-control" type="text" name="BILLNO[]" id ="BILLNO_0"  autocomplete="off" style="width: 99%"></td>
                            <td><input  class="form-control" type="date" name="BILL_DT[]" id ="BILL_DT_0"  autocomplete="off" style="width: 99%"></td>
...
function validateForm(){
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'{{route("transaction",[413,"save"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
