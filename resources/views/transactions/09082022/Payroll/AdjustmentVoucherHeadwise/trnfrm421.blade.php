...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->HEAD_VAID}}" value="{{$val->HEAD_VAID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->REMB_DT) && $val->REMB_DT !=''?$val->REMB_DT:''}}" ></td>
              <td>{{isset($val->HEADVA_DOCNO) && $val->HEADVA_DOCNO !=''?$val->HEADVA_DOCNO:''}}</td>
