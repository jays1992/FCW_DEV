...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
      <form id="frm_mst_edit" method="POST" onsubmit="return validateForm(actionType)" class="needs-validation"  > 
        @CSRF
        {{isset($objResponse->EMP_DECLAREID) ? method_field('PUT') : '' }}

        <div class="inner-form">              
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="DOC_NO" id="DOC_NO" value="{{ isset($HDR->DOCNO)?$HDR->DOCNO:'' }}" class="form-control mandatory" readonly>
                 <span class="text-danger" id="ERROR_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="REMB_DT" id="REMB_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ isset($HDR->DOCDT)?$HDR->DOCDT:'' }}" class="form-control"  maxlength="100" > 
                 </div>
               ...
               <div class="col-lg-2 pl"><p>Financial Year*</p></div>
                 <div class="col-lg-2 pl">
                   <select name="FYID_REF" id="FYID_REF" class="form-control mandatory" onchange="getFYearName(this.value)" tabindex="4">
                    ...
                    @if(isset($objFYear) && !empty($objFYear))
                     @foreach($objFYear as $val)
                     <option {{isset($HDR->FYID_REF) && $HDR->FYID_REF == $val-> FYID ?'selected="selected"':''}} value="{{ $val-> FYID }}">{{ $val->FYCODE }}</option>
                     @endforeach
                     @endif
                   </select>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" id="FYDESCRIPTION" value="{{ isset($HDR->FYDESCRIPTION)?$HDR->FYDESCRIPTION:'' }}" class="form-control" readonly  maxlength="100" > 
                 </div>
               ...
               <div class="col-lg-2 pl"><p>Name</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="FNAME" id="FNAME" value="{{ isset($HDR->FNAME)?$HDR->FNAME:'' }}" class="form-control" readonly  maxlength="100" > 
                 </div>
             </div>
             ...
             <div class="col-lg-2 pl"><p>Own Flat</p></div>
                 <div class="col-lg-2 pl">
                   <input type="checkbox" name="FLAT" id="FLAT" value="OWNFLAT" {{isset($HDR->FLAT) && $HDR->FLAT == 'OWNFLAT' ? 'checked' : ''}} />
                 <input type="hidden" id="focusid" >
               </div>

               <div class="col-lg-2 pl"><p>Rented Flat</p></div>
               <div class="col-lg-2 pl">
                 <input type="checkbox" name="FLAT" id="FLAT" value="RENTEDFLAT" {{isset($HDR->FLAT) && $HDR->FLAT == 'RENTEDFLAT' ? 'checked' : ''}} >  
               </div>

               <div class="col-lg-2 pl"><p>Residence at Metropolitian City</p></div>
               <div class="col-lg-2 pl">
                 <input type="checkbox" name="RESIDENCE" id="RESIDENCE" value="RESIDENCEMETROP" {{isset($HDR->RESIDENCE) && $HDR->RESIDENCE == 'RESIDENCEMETROP' ? 'checked' : ''}} >  
               </div>
             </div> 
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Residence at Non-Metropolitian City </p></div>
                   <div class="col-lg-2 pl">
                     <input type="checkbox" name="RESIDENCE" id="RESIDENCE" value="RESIDENCENONMETROP" {{isset($HDR->RESIDENCE) && $HDR->RESIDENCE == 'RESIDENCENONMETROP' ? 'checked' : ''}} > 
                 </div>

                 <div class="col-lg-2 pl"><p>Senior Citizen </p></div>
                   <div class="col-lg-2 pl">
                     <input type="checkbox" name="SENIORCITIZEN" id="SENEXHAND" value="1" {{isset($HDR->SENIOR_CITIZEN) && $HDR->SENIOR_CITIZEN == 1 ? 'checked' : ''}} > 
                 </div>

                 <div class="col-lg-2 pl"><p>Ex-Defence Personnel </p></div>
                   <div class="col-lg-2 pl">
                     <input type="checkbox" name="EXDEFENCEPER" id="SENEXHAND" value="1" {{isset($HDR->EX_DEFENCE) && $HDR->EX_DEFENCE == 1 ? 'checked' : ''}} > 
                 </div>
               </div>
               ...
               <div class="row">
                 <div class="col-lg-2 pl"><p>Handicapped </p></div>
                   <div class="col-lg-2 pl">
                     <input type="checkbox" name="HANDICAPPED" id="SENEXHAND" value="1" {{isset($HDR->HANDICAPPED) && $HDR->HANDICAPPED == 1 ? 'checked' : ''}} > 
                 </div>

                 <div class="col-lg-2 pl"><p>SC / ST </p></div>
                   <div class="col-lg-2 pl">
                     <input type="checkbox" name="CAST_CATEGORY" id="SCSTGEN" value="1" {{isset($HDR->CAST_CATEGORY) && $HDR->CAST_CATEGORY == 1 ? 'checked' : ''}} > 
                 </div>
               ...
               <div class="row">
                 <div class="col-lg-2 pl"><p>Married </p></div>
                   <div class="col-lg-2 pl">
                     <input type="checkbox" name="MARITAL_STATUS" id="MARUNMAROTHER" value="MARRIED" {{isset($HDR->MARITAL_STATUS) && $HDR->MARITAL_STATUS == 'MARRIED' ? 'checked' : ''}} > 
                 </div>

                 <div class="col-lg-2 pl"><p>Unmarried </p></div>
                   <div class="col-lg-2 pl">
                     <input type="checkbox" name="MARITAL_STATUS" id="MARUNMAROTHER" value="UNMARRIED" {{isset($HDR->MARITAL_STATUS) && $HDR->MARITAL_STATUS == 'UNMARRIED' ? 'checked' : ''}} > 
                 </div>
                 
                 <div class="col-lg-2 pl"><p>Others </p></div>
                   <div class="col-lg-2 pl">
                     <input type="checkbox" name="MARITAL_STATUS" id="MARUNMAROTHER" value="OTHERS" {{isset($HDR->MARITAL_STATUS) && $HDR->MARITAL_STATUS == 'OTHERS' ? 'checked' : ''}} > 
                 </div>
               </div>
               ...
               <div class="row">
                 <div class="col-lg-2 pl"><p>No of Kids </p></div>
                   <div class="col-lg-2 pl">
                     <input type="text" name="KIDSNO" id="KIDSNO" value="{{ isset($HDR->KIDS_NO)?$HDR->KIDS_NO:'' }}" class="form-control" maxlength="100" onkeypress="return onlyNumberKey(event)"> 
                 </div>

                 <div class="col-lg-2 pl"><p>Other than Salary Income </p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="OTHER_INCOME" id="OTHER_INCOME" value="{{ isset($HDR->OTHER_INCOME)?$HDR->OTHER_INCOME:'' }}" class="form-control" maxlength="100" onkeypress="return onlyNumberKey(event)"> 
               </div>

                 <div class="col-lg-2 pl"><p>Name of Flat Owner</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="NAMEOFLATOWNER" id="NAMEOFLATOWNER" value="{{ isset($HDR->FLAT_OWNERNAME)?$HDR->FLAT_OWNERNAME:'' }}" class="form-control" maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <select name="GENDER_REF" id="GENDER_REF" class="form-control mandatory" tabindex="4">
                     <option value="" selected="">Select</option>
                     @if(isset($objGnder) && !empty($objGnder))
                     @foreach($objGnder as $val)
                     <option {{isset($HDR->GENDER) && $HDR->GENDER == $val-> GID ?'selected="selected"':''}} value="{{ $val-> GID }}">{{ $val->DESCRIPTIONS }}</option>
                     @endforeach
                     @endif
                   </select> 
                 </div>
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="PANNO" id="PANNO" value="{{ isset($HDR->PANNO)?$HDR->PANNO:'' }}" class="form-control" maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Father Name</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="FLAT_FATHERNAME" id="FLAT_FATHERNAME" value="{{ isset($HDR->FLAT_FATHERNAME)?$HDR->FLAT_FATHERNAME:'' }}" class="form-control" maxlength="100" > 
                 </div>
               </div> 
                         ...
                         <tbody>
                          ...
                          @foreach($MAT as $key => $row)
                           <tr  class="participantRow">
                             <td>
                               <select name="PAYPERIOD_REF[]" id={{"PAYPERIOD_REF_".$key}} class="form-control mandatory" tabindex="4">
                               <option value="" selected="">Select</option>
                               @if(isset($objList) && !empty($objList))
                               @foreach($objList as $val)
                               <option {{isset($row->PAYPID_REF) && $row->PAYPID_REF == $val-> PAYPERIODID ?'selected="selected"':''}} value="{{ $val-> PAYPERIODID }}">{{ $val->PAY_PERIOD_CODE }}</option>
                               @endforeach
                               @endif
                             </select>
                           </td>
                               <td><input  class="form-control" type="text" name="AMOUNT[]" id={{"AMOUNT_".$key}} value="{{ $row->AMOUNT }}" onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                   ...
                   <div id="Savings" class="tab-pane fade in ">
                       <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                         <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                           ...
                           <tbody>
                            @if(!empty($MAT1))
                            @foreach($MAT1 as $key => $row1)
                             <tr  class="participantRow">
                               <td>
                                 <select name="SECTION_REF[]" id={{"SECTION_REF_".$key}} class="form-control mandatory" tabindex="4">
                                 <option value="" selected="">Select</option>
                                 @if(isset($objSection) && !empty($objSection))
                                 @foreach($objSection as $val)
                                 <option {{isset($row1->SECTIONID_REF) && $row1->SECTIONID_REF == $val-> SECTIONID ?'selected="selected"':''}} value="{{ $val-> SECTIONID }}">{{ $val->SECTION_CODE }}</option>
                                 @endforeach
                                 @endif
                               </select>
                             </td>
                                 <td><input  class="form-control" type="text" name="AMOUNT[]"    id={{"AMOUNT_".$key}} value="{{ $row1->AMOUNT }}"   onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                                 <td><input  class="form-control" type="text" name="REMARKS[]"   id={{"REMARKS_".$key}} value="{{ $row1->REMARKS }}"  autocomplete="off" style="width: 99%"></td>
...
var formResponseMst = $( "#frm_mst_edit" );
 ...
 $( "#btnSave" ).click(function() {
    ...
    $("#btnApprove").click(function() {
      if(formResponseMst.valid()){
        if(checkPeriodClosing('{{$FormId}}',$("#REMB_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
