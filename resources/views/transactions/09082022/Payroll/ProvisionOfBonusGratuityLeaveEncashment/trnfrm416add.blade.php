                ...
                <div class="row">
                  <div class="col-lg-2 pl"><p>Doc No*</p></div>
                    <div class="col-lg-2 pl">
                      ...
                      @if($objDD->SYSTEM_GRSR == "1")
                          <input type="text" name="PROVISION_DOC_NO" id="PROVISION_DOC_NO" value="{{ $objDOCNO }}" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                      @endif
                      @if($objDD->MANUAL_SR == "1")
                          <input type="text" name="PROVISION_DOC_NO" id="PROVISION_DOC_NO" value="{{ old('PROVISION_DOC_NO') }}" class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                      @endif
                  @endif 
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="PROVISION_DT" id="PROVISION_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control"  maxlength="100" > 
                    </div>

                    <div class="col-lg-2 pl"><p>Bonus </p></div>
                      <div class="col-lg-2 pl">
                      <input type="checkbox" name="BONUS" id="BNSGRTYLE" value="{{ $objBonus->BONUSID }}" onchange="getBonusName(this.value)"> 
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-2 pl"><p>Gratuity </p></div>
                      <div class="col-lg-2 pl">
                      <input type="checkbox" name="GRTUITY" id="BNSGRTYLE" value="{{ $objGraty->GRATUITYID }}" onchange="getGratuityName(this.value)"> 
                    </div>

                    <div class="col-lg-2 pl"><p>Leave Encashment </p></div>
                      <div class="col-lg-2 pl">
                      <input type="checkbox" name="LEAVE_ENCASH" id="BNSGRTYLE" value="{{ $objLeaveEnt->LEPID }}" onchange="getLeaveEntName(this.value)"> 
                    </div>
                  ...
                  <div class="col-lg-2 pl"><p>Generate </p></div>
                      <div class="col-lg-2 pl">
                      <input type="radio" name="GENERATE" id="GENERATE" value="1"> 
                    </div>

                    <div class="col-lg-2 pl"><p>Head </p></div>
                      <div class="col-lg-2 pl">
                      <input type="text" name="HEAD" id="HEAD" class="form-control" readonly> 
                      ...
                      <div class="table-responsive table-wrapper-scroll-y" style="height:500px;margin-top:10px;" >
                        ...
                        <tbody>
                          <tr  class="participantRow">
                            <td>
                              <select name="EMPCODE_REF[]" id="EMPCODE_REF_0" onchange="getEmpCodeName(this.id,this.value)" class="form-control mandatory" tabindex="4">
                              <option value="" selected="">Select</option>
                            ...
                            <td><input type="text" id="EMPCODE_NAME_0" class="form-control" readonly  maxlength="100" ></td>
