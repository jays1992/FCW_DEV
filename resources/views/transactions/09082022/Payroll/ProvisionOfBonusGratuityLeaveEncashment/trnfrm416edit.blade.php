             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="PROVISION_DOC_NO" id="PROVISION_DOC_NO" value="{{ $HDR->PGB_CODE }}" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                 <span class="text-danger" id="ERROR_PROVISION_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="PROVISION_DT" id="PROVISION_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  value="{{ $HDR->PGB_DATE }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Bonus </p></div>
                   <div class="col-lg-2 pl">
                   <input type="checkbox" name="BONUS" id="BNSGRTYLE" value="1" {{isset($HDR->BONUS) && $HDR->BONUS =='1'?'checked':''}} onchange="getBonusName(this.value)"> 
                 </div>
               </div>
               ...
               <div class="row">
                 <div class="col-lg-2 pl"><p>Gratuity </p></div>
                   <div class="col-lg-2 pl">
                   <input type="checkbox" name="GRTUITY" id="BNSGRTYLE" value="1" {{isset($HDR->GRTUITY) && $HDR->GRTUITY =='1'?'checked':''}} onchange="getGratuityName(this.value)"> 
                 </div>

                 <div class="col-lg-2 pl"><p>Leave Encashment </p></div>
                   <div class="col-lg-2 pl">
                   <input type="checkbox" name="LEAVE_ENCASH" id="BNSGRTYLE" value="1" {{isset($HDR->LEAVE_ENCASH) && $HDR->LEAVE_ENCASH =='1'?'checked':''}} onchange="getLeaveEntName(this.value)"> 
                 </div>
               ...
               <div class="col-lg-2 pl"><p>Generate </p></div>
                   <div class="col-lg-2 pl">
                   <input type="radio" name="GENERATE" id="GENERATE" value="1" {{isset($HDR->GENERATE) && $HDR->GENERATE =='1'?'checked':''}}> 
                 </div>

                 <div class="col-lg-2 pl"><p>Head </p></div>
                   <div class="col-lg-2 pl">
                   <input type="text" name="HEAD" id="HEAD" value="{{ $HDR->HEADID_REF }}" class="form-control" readonly> 
                     ...
                     <tbody>
                      ...
                      @foreach($MAT as $key => $row)
                       <tr  class="participantRow">
                         <td>
                           <select name="EMPCODE_REF[]" id ={{"EMPCODE_REF_".$key}} onchange="getEmpCodeName(this.id,this.value)" class="form-control mandatory" tabindex="4">
                           <option value="" selected="">Select</option>
                         ...
                         <td><input type="text" id ={{"EMPCODE_NAME_".$key}} value="{{ $row->FNAME }}" class="form-control" readonly  maxlength="100" ></td>
 ...
 if(PROVISION_DOC_NO ===""){
   ...
   return false;
     ...
     if(jQuery.inArray("false", allblank1) !== -1){
       ...
       else if(checkPeriodClosing('{{$FormId}}',$("#PROVISION_DT").val(),0) ==0){
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
...
$("#btnApprove").click(function() {
    ...
    if(formResponseMst.valid()){
        ...
        if(checkPeriodClosing('{{$FormId}}',$("#PROVISION_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
