       ...
       <div class="inner-form">
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="CLAIM_DOC_NO" id="CLAIM_DOC_NO" value="{{ $objResponse->CLAIM_DOC_NO }}" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                 <span class="text-danger" id="ERROR_CLAIM_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="CLAIM_DOC_DT" id="CLAIM_DOC_DT" onchange="checkPeriodClosing(412,this.value,1)" value="{{ $objResponse->CLAIM_DOC_DT }}" class="form-control" maxlength="100">
                 </div>
               ...
               <div class="col-lg-2 pl"><p>Name</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="FNAME" id="FNAME" value="{{ $objLvDesList->FNAME }}" class="form-control" readonly  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Period From Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="PERIOD_FR_DT" id="PERIOD_FR_DT" value="{{ $objResponse->PERIOD_FR_DT }}" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>To Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="PERIOD_TO_DT" id="PERIOD_TO_DT" value="{{ $objResponse->PERIOD_TO_DT }}" class="form-control"  maxlength="100" > 
                 </div>
             </div>
             ...
             <div class="col-lg-2 pl"><p>Department*</p></div>
               ...
               <div class="col-lg-2 pl"><p>Designation</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="DESGID_REF" id="DESGID_REF" value="{{ $objDptList->NAME }}" class="form-control" readonly  maxlength="100" > 
                 </div>
             </div>
                     ...
                     <tbody>
                      ...
                      ?>
                       <tr  class="participantRow">
                           <td><select  name={{"GLID_REF_".$key}} id ={{"GLID_REF_".$key}}  onchange="getGlCodeName(this.id,this.value)" class="form-control mandatory" style="width: 150px;" >
                             <option value="" selected="">Select</option>
                           ...
                           <td><input  class="form-control" type="text" name={{"GLCODE_DESC_".$key}}    id ={{"GLCODE_DESC_".$key}}   value="{{ $row->GLNAME }}"     readonly  maxlength="100" > </td>
                           ...
                           <td><input  class="form-control" type="text" name={{"CLAIM_AMT_".$key}}      id ={{"CLAIM_AMT_".$key}}     value="{{ $row->CLAIM_AMT }}"           onkeypress="return onlyNumberKey(event)"  autocomplete="off" style="width: 99%"></td>
                           <td><input  class="form-control" type="text" name={{"SANCTION_AMT_".$key}}   id ={{"SANCTION_AMT_".$key}}  value="{{ $row->SANCTION_AMT }}"  onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                           <td><select name={{"ANY_ATTACHMENT_".$key}}  id ={{"ANY_ATTACHMENT_".$key}} onchange="getAttDocType(this)" class="form-control" >
                            ...
                            <td><input  class="form-control" type="file" name="FILENAME[]" id ={{"ATTDOCFILE_".$key}} value="{{ $row->FILE_NAMES }}" ></td>
                           <td align="center">
...
$.ajax({
    url:'{{ route("transactionmodify",[412,"Approve"])}}',
    type:'POST',
