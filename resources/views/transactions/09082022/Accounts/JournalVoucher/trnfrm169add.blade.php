	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              @if(isset($objJV->SYSTEM_GRSR) && $objJV->SYSTEM_GRSR == "1")
                  <input type="text" name="JV_NO" id="JV_NO" value="{{ isset($objJVNO)?$objJVNO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              
              @elseif(isset($objJV->MANUAL_SR) && $objJV->MANUAL_SR == "1")
                  <input type="text" name="JV_NO" id="JV_NO" value="{{ old('JV_NO') }}" class="form-control mandatory" maxlength="{{isset($objJV->MANUAL_MAXLENGTH)?$objJV->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
              @else
                <input type="text" name="JV_NO" id="JV_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              @endif
        </div>
        <div class="col-lg-1 pl"><p>JV Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="JV_DT" id="JV_DT" value="{{ old('JV_DT') }}" onchange="checkPeriodClosing(169,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
