...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              @if(isset($objAPDOCNO->SYSTEM_GRSR) && $objAPDOCNO->SYSTEM_GRSR == "1")
                  <input type="text" name="AP_DOC_NO" id="AP_DOC_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              @elseif(isset($objAPDOCNO->MANUAL_SR) && $objAPDOCNO->MANUAL_SR == "1")
                  <input type="text" name="AP_DOC_NO" id="AP_DOC_NO" value="{{ old('AP_DOC_NO') }}" class="form-control mandatory" maxlength="{{ isset($objAPDOCNO->MANUAL_MAXLENGTH)?$objAPDOCNO->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
            @else
                <input type="text" name="AP_DOC_NO" id="AP_DOC_NO" value="{{ old('AP_DOC_NO') }}" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  >
            @endif
        </div>
        <div class="col-lg-2 pl"><p>Debit/Credit Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="AP_DOC_DT" id="AP_DOC_DT" value="{{ old('AP_DOC_DT') }}" onchange="checkPeriodClosing(235,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                <input type="text" name="REF_NO" id="REF_NO" value="{{ old('REF_NO') }}" maxlength="30" class="form-control" autocomplete="off" />
        </div>
        <div class="col-lg-2 pl"><p>Reference Date</p></div>
        <div class="col-lg-2 pl">
                <input type="date" name="REF_DT" id="REF_DT" value="{{ old('REF_DT') }}" class="form-control"  placeholder="dd/mm/yyyy"  />
        </div>
    </div>
    <div class="row">		
                ...
                <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    ...
                    @foreach($objUdfAPData as $uindex=>$uRow)
                      <tr  class="participantRow4">
                          <td><input type="text" name={{"popupUDF_APID_".$uindex}} id={{"popupUDF_APID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
                          <td hidden><input type="hidden" name={{"UDF_APID_REF_".$uindex}} id={{"UDF_APID_REF_".$uindex}} class="form-control" value="{{$uRow->UDF_APID}}" autocomplete="off"   /></td>
...
$.ajax({
    url:'{{ route("transaction",[235,"save"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
