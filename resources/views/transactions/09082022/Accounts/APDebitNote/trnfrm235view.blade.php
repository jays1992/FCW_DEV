...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="date" name="AP_DOC_DT" id="AP_DOC_DT" value="{{ isset($objAPDRCR->AP_DOC_DT)?$objAPDRCR->AP_DOC_DT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
