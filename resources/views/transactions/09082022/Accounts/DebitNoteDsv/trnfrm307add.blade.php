  ...
  <div class="container-fluid purchase-order-view">
    ...
    <div class="container-fluid filter">
      <div class="inner-form">
        ...
        <div class="row">
          ...
          @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
              <input type="text" name="DSV_NO" id="DSV_NO" value="{{ isset($objSONO)?$objSONO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
              <input type="text" name="DSV_NO" id="DSV_NO" value="{{ old('DSV_NO') }}" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
          @else
            <input type="text" name="DSV_NO" id="DSV_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
          </div>
                              
          <div class="col-lg-2 pl"><p>DSV Date*</p></div>
          <div class="col-lg-2 pl">
              <input type="date" name="DSV_DT" id="DSV_DT" value="{{ old('DSV_DT') }}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="col-lg-2 pl"><p>Reason of Debit Note</p></div>
        <div class="col-lg-2 pl">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="checkbox" name="Direct" id="Direct" autocomplete="off" onchange="direct()" value="1"  />
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select name="TRANSACTION_TYPE" id="TRANSACTION_TYPE" autocomplete="off" class="form-control" onchange="getTransactionType()" >
              ...
              <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <tbody>
                  <tr  class="participantRow">
                    ...
                    <td hidden><input type="hidden" name="GEID_REF_0" id="GEID_REF_0" class="form-control" autocomplete="off" /></td>
                    <td hidden><input type="hidden" name="GRN_NO_0" id="GRN_NO_0" class="form-control" autocomplete="off" /></td>
                    ...
                    <td><input type="text" name="SI_RATE_0" id="SI_RATE_0" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                    ...
                    <td><input type="text" name="SO_QTY_0" id="SO_QTY_0" class="form-control" maxlength="13" onkeypress="return isNumberDecimalKey(event,this)"  autocomplete="off"  style="width:75px;" /></td>
...
$(document).ready(function(e) {
    ...
    //to check the label duplicacy
     $('#DSV_NO').focusout(function(){
      var DSV_NO   =   $.trim($(this).val());
      if(DSV_NO ===""){
                $("#FocusId").val('DSV_NO');
                // $("[id*=txtlabel]").blur(); 
                $("#ProceedBtn").focus();
                ...
                $("#NoBtn").hide();
                $("#OkBtn1").show();
                $("#AlertMessage").text('Please enter value in DSV_NO.');
                $("#alert").modal('show');
                $("#OkBtn1").focus();
                highlighFocusBtn('activeOk1');
                // return false;
...
function getStoreDetails(ITEMID_REF,MAIN_UOMID_REF,ROW_ID,SIID_REF){
  ...
  $.ajax({
      ...
      type:'POST',
      data:{TRANSACTION_TYPE:TRANSACTION_TYPE,ITEMID_REF:ITEMID_REF,MAIN_UOMID_REF:MAIN_UOMID_REF,ROW_ID:ROW_ID,ITEMROWID:ITEMROWID,ACTION_TYPE:'ADD',SIID_REF:SIID_REF,WhereId:WhereId},
      success:function(data) {
