  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <span class="text-danger" id="ERROR_DOC_NO"></span>
			  ...
			  <div class="col-lg-2 pl">
				  <input {{$ActionStatus}} type="date" name="DOC_DT" id="DOC_DT"  value="{{isset($objResponse->BANK_RECONCILE_DATE) && $objResponse->BANK_RECONCILE_DATE !=''?$objResponse->BANK_RECONCILE_DATE:''}}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control"  placeholder="dd/mm/yyyy" >
        </div>
