...
@endphp
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="checkbox" name="SOFC" id="SOFC" class="form-checkbox" {{$objHDR->FC == 1 ? 'checked' : ''}} >
      </div>
      
      <div class="col-lg-2 pl"><p>Currency</p></div>
      <div class="col-lg-2 pl" id="divcurrency" >
          @if (count($objsocurrency) > 0)
          <input {{$ActionStatus}} type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="{{ $objsocurrency[0] }}" readonly   />
          @else
          <input {{$ActionStatus}} type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
          @endif
          <input type="hidden" name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="{{ $objHDR->CRID_REF }}" />
          
      </div>
      
      <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
      <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="{{ $objHDR->CONV_FACTOR }}" />
      </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="SubGl_popup" id="txtsubgl_popup" value="{{$objsubglcode->SGLCODE}}-{{$objsubglcode->SLNAME}}" class="form-control mandatory"   autocomplete="off" readonly/>
