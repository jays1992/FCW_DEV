...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="date" name="MJV_DT" id="MJV_DT" onchange="checkPeriodClosing(415,this.value,1)" value="{{ isset($objJV->MJV_DT)?$objJV->MJV_DT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" readonly />
        </div>
