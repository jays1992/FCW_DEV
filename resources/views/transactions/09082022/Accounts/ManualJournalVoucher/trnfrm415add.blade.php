...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              @if(isset($objJV->SYSTEM_GRSR) && $objJV->SYSTEM_GRSR == "1")
                  <input type="text" name="MJV_NO" id="MJV_NO" value="{{ isset($objJVNO)?$objJVNO:'' }}"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              
              @elseif(isset($objJV->MANUAL_SR) && $objJV->MANUAL_SR == "1")
                  <input type="text" name="MJV_NO" id="MJV_NO" value="{{ old('MJV_NO') }}" class="form-control mandatory" maxlength="{{isset($objJV->MANUAL_MAXLENGTH)?$objJV->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
              @else
                <input type="text" name="MJV_NO" id="MJV_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              @endif
        </div>
        <div class="col-lg-1 pl"><p>MJV Date </p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="MJV_DT" id="MJV_DT" value="{{ old('MJV_DT') }}" onchange="checkPeriodClosing(415,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" <?php if(isset($DOC_TYPE) && $DOC_TYPE !=''){?> onchange='getDocNoByEvent("MJV_NO",this,<?php echo json_encode($doc_req);?>)' <?php } ?> />
        </div>
        ...
        <div class="col-lg-2 pl">
                  <input type="date" name="REVERSE_DT" id="REVERSE_DT" value="{{ old('MJV_DT') }}" class="form-control"  placeholder="dd/mm/yyyy" disabled >
        </div>
		</div>
    <div class="row">
 ...
 if(MJV_NO ===""){
  ...
  $("#FocusId").val($("#REVERSE_DT"));
    ...
    var glcode = '';
        ...
        else if(checkPeriodClosing(415,$("#MJV_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
$.ajax({
    url:'{{ route("transaction",[415,"save"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
