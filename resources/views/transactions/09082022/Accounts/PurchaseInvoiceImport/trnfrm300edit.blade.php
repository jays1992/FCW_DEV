...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="PII_NO" id="PII_NO" value="{{ isset($objHDR->PII_NO)?$objHDR->PII_NO:'' }}" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  readonly >
        </div>
        <div class="col-lg-2 pl"><p>IPO Date</p></div>
        <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="date" name="PII_DT" id="PII_DT" value="{{ isset($objHDR->PII_DT)?$objHDR->PII_DT:'' }}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>

        <div class="col-lg-2 pl"><p>Vendor</p></div>
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="txtvendor" id="txtvendor" class="form-control" value="{{ isset($objPBVID->VCODE)?$objPBVID->VCODE:'' }} {{ isset($objPBVID->NAME)?'-'.$objPBVID->NAME:'' }}" readonly  />
                <input type="hidden" name="VID_REF" id="VID_REF"  class="form-control" value="{{ isset($objHDR->VID_REF)?$objHDR->VID_REF:'' }}" />
        </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="checkbox" name="SOFC" id="SOFC" class="form-checkbox" {{ isset($objHDR->FC) && $objHDR->FC == 1 ? 'checked' : ''}} >
      </div>
      
      <div class="col-lg-2 pl"><p>Currency</p></div>
      <div class="col-lg-2 pl" id="divcurrency" >
          @if ( isset($objsocurrency) && count($objsocurrency) > 0)
          <input {{$ActionStatus}} type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="{{ isset($objsocurrency[0])?$objsocurrency[0]:'' }}" readonly   />
          @else
      ...
      <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="{{ isset($objHDR->CONV_FACTOR)?$objHDR->CONV_FACTOR:'' }}" />
      </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="VENDOR_INNO" id="VENDOR_INNO" value="{{ isset($objHDR->VENDOR_INVOICE_NO)?$objHDR->VENDOR_INVOICE_NO:'' }}" maxlength="30" class="form-control" autocomplete="off" readonly />
        </div>
        <div class="col-lg-2 pl"><p>Vendor Invoice Date</p></div>
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="date" name="VENDOR_INDT" id="VENDOR_INDT" value="{{ isset($objHDR->VENDOR_INVOICE_DT)?$objHDR->VENDOR_INVOICE_DT:'' }}" class="form-control"  placeholder="dd/mm/yyyy" readonly  />
        </div>
        ...
        <div class="col-lg-2 pl" id="div_billto">
            ...
            <input  type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="{{ isset($objHDR->BILL_TO)?$objHDR->BILL_TO:'' }}" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl" id="div_shipto">
            ...
            <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="{{ isset($objHDR->SHIP_TO)?$objHDR->SHIP_TO:'' }}" />
            <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" value="{{ isset($TAXSTATE[0])?$TAXSTATE[0]:'' }}" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Remarks</p></div>
        <div class="col-lg-6 pl">
            <input {{$ActionStatus}} type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" value="{{ isset($objHDR->REMARKS)?$objHDR->REMARKS:'' }}" maxlength="200"  >
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input {{$ActionStatus}} type="text" name="BOE_NO" id="BOE_NO" value="{{ isset($objHDR->BOE_NO)?$objHDR->BOE_NO:'' }}" class="form-control" autocomplete="off" readonly >
      </div>

      <div class="col-lg-2 pl"><p>BOE Date</p></div>
      <div class="col-lg-2 pl">
        <input {{$ActionStatus}} type="date" name="BOE_DT" id="BOE_DT" value="{{ isset($objHDR->BOE_DT)?$objHDR->BOE_DT:'' }}" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy" readonly >
      </div>
	</div>
  ...
  <div class="row">	
		...
		<div class="col-lg-2 pl">
			<select {{$ActionStatus}}  name="IMPORT_DUTYID_REF" id="IMPORT_DUTYID_REF" class="form-control" autocomplete="off" onchange="changeDuty()" >
		...
		<div class="col-lg-2 pl">
			<input {{$ActionStatus}} type="text" name="REF_NO" id="REF_NO" value="{{ isset($objHDR->REF_NO)?$objHDR->REF_NO:'' }}" class="form-control" maxlength="100" autocomplete="off" >
		</div>
		
        <div class="col-lg-2 pl"><p>Credit Days</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="Credit_days" id="Credit_days" value="{{ isset($objHDR->CREDIT_DAYS)?$objHDR->CREDIT_DAYS:'' }}" onkeyup="getDueDate()" maxlength="200" class="form-control"  autocomplete="off"   />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="DUE_DATE" id="DUE_DATE" class="form-control" value="{{ isset($objHDR->DUE_DATE)?$objHDR->DUE_DATE:'' }}"  placeholder="dd/mm/yyyy"  />                        
        </div>
        ...
        <div  class="col-lg-1 pl">
            <input {{$ActionStatus}} type="checkbox" name="GST_Reverse" id="GST_Reverse"  {{ isset($objHDR->REVERSE_GST) && $objHDR->REVERSE_GST == 1 ? 'checked' : ''}}    />                          
        </div>
    ...
    <div class="row">
        ...
        <div  class="col-lg-1 pl">
            <input {{$ActionStatus}} type="checkbox" name="GST_N_Avail" id="GST_N_Avail"  {{ isset($objHDR->GST_INPUT_NOT_AVAIL) && $objHDR->GST_INPUT_NOT_AVAIL == 1 ? 'checked' : ''}}   />
        </div> 

        <div class="col-lg-2 col-md-offset-1 pl"><p>CHA</p></div>
        <div class="col-lg-2 pl">
          <input  {{$ActionStatus}} type="text" name="txtvendor2" id="txtvendor2" class="form-control" value="{{ isset($CHA_VENDOR_NAME)?$CHA_VENDOR_NAME:'' }}"  readonly  />
          <input type="hidden" name="VID2_REF" id="VID2_REF"  class="form-control " value="{{ isset($CHA_VENDOR_ID)?$CHA_VENDOR_ID:'' }}"  />
        </div>
        ...
        <div id="Material" class="tab-pane fade in active">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:400px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                  ...
                  <tr>
                    <th rowspan="2">GRN No <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="{{$objCount1}}" ></th>
                  ...
                  <tr>
                    ...
                    @if(!empty($objPBMAT))
                      @foreach($objPBMAT as $key => $row)
                        ...
                        <td><input {{$ActionStatus}} type="text" name="txtGRN_NO_{{$key}}" id="txtGRN_NO_{{$key}}" value="{{$row->GRN_NO}}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td  hidden><input type="text" name="GRNID_REF_{{$key}}" id="GRNID_REF_{{$key}}" value="{{$row->GRNID_REF}}" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td  hidden><input type="text" name="IPO_ID_REF_{{$key}}" id="IPO_ID_REF_{{$key}}" value="{{$row->IPO_ID_REF}}" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        ...
                        <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name="Alpspartno_{{$key}}" id="Alpspartno_{{$key}}" value="{{ $row->ALPS_PART_NO }}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name="Custpartno_{{$key}}" id="Custpartno_{{$key}}" value="{{ $row->CUSTOMER_PART_NO }}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name="OEMpartno_{{$key}}" id="OEMpartno_{{$key}}"   value="{{ $row->OEM_PART_NO }}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        ...
                        <td><input {{$ActionStatus}} type="text" name="SO_QTY_{{$key}}" id="SO_QTY_{{$key}}" value="{{$row->RECEIVED_MAIN_QTY}}"  onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control three-digits" maxlength="13"  autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                        ...
                        <td><input {{$ActionStatus}} type="text" name="BILL_QTY_{{$key}}" id="BILL_QTY_{{$key}}" value="{{$row->BILL_QTY}}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control " maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text" name="UOM_OF_BILL_QTY_{{$key}}" id="UOM_OF_BILL_QTY_{{$key}}"  value="{{$row->MAIN_UOM_CODE}}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control" maxlength="13"  autocomplete="off" readonly style="width:130px;" /></td>

                        <td><input {{$ActionStatus}} type="text"                      name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{$row->RATE_ASP_MU}}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'5')" class="form-control four-digits" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text"  {{$AlpsStatus['disabled']}}  name="DISC_PER_{{$key}}" id="DISC_PER_{{$key}}" value="{{ intval($row->DISC_PER) > 0 ? $row->DISC_PER:'0.00' }}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input {{$ActionStatus}} type="text"  {{$AlpsStatus['disabled']}}  name="DISC_AMT_{{$key}}" id="DISC_AMT_{{$key}}" value="{{ intval($row->DISC_AMT) > 0 ? $row->DISC_AMT:'0.00' }}" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control two-digits" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                  ...
                  @if(!empty($objPBCAL))
                    ...
                    <tr  class="participantRow5">
                        ...
                        <td style="text-align:center;">
                          <input {{$ActionStatus}} type="checkbox" class="filter-none" name="calACTUAL_0" id="calACTUAL_0" value=""   ></td>
                        <td align="center" ><button class="btn add" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                    </tr>
                    <tr></tr>
                  @endif
                  </tbody>
                    ...
                    @if(!empty($objPBUDF))
                      @foreach($objPBUDF as $Ukey => $Urow)
                          <tr  class="participantRow4">
                              ...
                              <td hidden><input type="hidden" name={{"UDFPBID_REF_".$Ukey}}  id={{"UDFPBID_REF_".$Ukey}} class="form-control" value="{{$Urow->PII_UDFID}}" autocomplete="off" /></td>
...
<div id="cridpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tbody>
      ...
      <tr>
        <th class="ROW1"><span class="check_th">&#10004;</span></th>
        <td class="ROW2"><input type="text" id="currencycodesearch" class="form-control" autocomplete="off" onkeyup="CurrencyCodeFunction()"></td>
        <td class="ROW3"><input type="text" id="currencynamesearch" class="form-control" autocomplete="off" onkeyup="CurrencyNameFunction()"></td>
      </tr>
...
$(function() {
  ...
  <?php if(isset($objPBMAT) && !empty($objPBMAT)){ foreach($objPBMAT as $key => $row){?>
    onChangeAmount('BILL_QTY_<?php echo $key ?>','<?php echo $row->BILL_QTY;?>');
    editAltUomQty('ALT_UOMID_QTY_<?php echo $key ?>','<?php echo $row->ALT_UOMID_REF;?>','<?php echo $row->ITEMID_REF;?>','<?php echo $row->BILL_QTY;?>');
  <?php }} ?> 
...
$.each( pbudf, function( pbukey, pbuvalue ) {
        $.each( udfforpb, function( upbkey, upbvalue ) { 
            if(pbuvalue.UDFPIIID_REF == upbvalue.UDFPIIID)
            {
