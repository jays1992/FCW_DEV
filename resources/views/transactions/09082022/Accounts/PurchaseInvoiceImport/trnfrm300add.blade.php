	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              @if(isset($objPBDOCNO->SYSTEM_GRSR) && $objPBDOCNO->SYSTEM_GRSR == "1")
                  <input type="text" name="PII_NO" id="PII_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
             
              @elseif(isset($objPBDOCNO->MANUAL_SR) && $objPBDOCNO->MANUAL_SR == "1")
                  <input type="text" name="PII_NO" id="PII_NO" value="{{ old('PII_NO') }}" class="form-control mandatory" maxlength="{{ isset($objPBDOCNO->MANUAL_MAXLENGTH)?$objPBDOCNO->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
            @else
                <input type="text" name="PII_NO" id="PII_NO" value="{{ old('PII_NO') }}" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  >
            @endif
        </div>
        <div class="col-lg-2 pl"><p>PII Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PII_DT" id="PII_DT" value="{{ old('PII_DT') }}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
