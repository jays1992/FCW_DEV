...
<div class="container-fluid filter">
  <form id="frm_trn_rcpt"  method="POST"> 
    ...
    <div class="row" >
        <div class="col-lg-1 pl"><p>PDC (Y/N)</p></div>        
        <div class="col-lg-2 pl">
        ...
        <div class="col-lg-1 pl"><p>PDC Date</p></div>
        <div class="col-lg-2 pl">
        ...
        <div class="col-lg-1 pl"><p>Clear PDC (Y/N)</p></div>        
        <div class="col-lg-2 pl">
        ...
        <div class="col-lg-1 pl"><p>Clear PDC Date</p></div>
        <div class="col-lg-2 pl">
