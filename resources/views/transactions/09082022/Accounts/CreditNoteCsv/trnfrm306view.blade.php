...
<!-- <form id="frm_trn_so" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Credit Note (Stock & Value)<br/> CSV</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_edit"  method="POST">   
            @csrf
            {{isset($objSO->CSVID[0]) ? method_field('PUT') : '' }}
            <div class="container-fluid filter">

                    <div class="inner-form">
                    
                        <div class="row">
                            <div class="col-lg-2 pl"><p>CSV No</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="CSV_NO" id="CSV_NO" value="{{ isset($objSO->CSV_NO)?$objSO->CSV_NO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>CSV Date</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="CSV_DT" id="CSV_DT" value="{{ isset($objSO->CSV_DT)?$objSO->CSV_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>

                            <div class="col-lg-2 pl"><p>Customer</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="SubGl_popup" id="txtgl_popup" value="{{isset($objsubglcode->CCODE)?$objsubglcode->CCODE:''}}{{isset($objsubglcode->NAME)?'-'.$objsubglcode->NAME:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input {{$ActionStatus}} type="text" name="REASONOFSR" id="REASONOFSR" value="{{ isset($objSO->REASON_CR_NOTE)?$objSO->REASON_CR_NOTE:'' }}" autocomplete="off" class="form-control mandatory" maxlength="200"  >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input {{$ActionStatus}} type="text" name="COMMONNRT" id="COMMONNRT" value="{{ isset($objSO->NARRATION)?$objSO->NARRATION:'' }}" autocomplete="off" class="form-control" maxlength="200"  >
                            </div>
                            ...
                            <div class="col-lg-2 pl">
                              <input {{$ActionStatus}} type="checkbox" name="Direct" id="Direct" autocomplete="off" onchange="direct()" value="1" {{isset($objSO->DIRECTCSV) && $objSO->DIRECTCSV =='1'?'checked':''}}  />
                            </div>
                        ...
                        <div class="col-lg-2 pl">
                          <select {{$ActionStatus}} name="TRANSACTION_TYPE" id="TRANSACTION_TYPE" autocomplete="off" class="form-control" onchange="getTransactionType()" >
                            <option {{isset($objSO->TRANSACTION_TYPE) && $objSO->TRANSACTION_TYPE =='CREDIT'?'selected="selected"':''}} value="CREDIT">CREDIT</option>
                            <option {{isset($objSO->TRANSACTION_TYPE) && $objSO->TRANSACTION_TYPE =='DEBIT'?'selected="selected"':''}} value="DEBIT">DEBIT</option>
                          </select>
                        </div>
                      </div>
...
<tr>
  ...
  <th rowspan="2">SI Qty (Main UOM)</th>
  <th rowspan="2">SI Rate</th>
  ...
  <th rowspan="2">Credit Note Rate</th>
  <th rowspan="2">Credit Note Amount</th>
...
<tr  class="participantRow">
  ...
  <td ><input {{$ActionStatus}} type="text" name={{"txtSQ_popup_".$key}} id={{"txtSQ_popup_".$key}} class="form-control" value="{{ $row->SINO }}" autocomplete="off"   readonly style="width:100px;" /></td>
  ...
  <td><input {{$ActionStatus}} type="text" name={{"popupITEMID_".$key}} id={{"popupITEMID_".$key}} class="form-control" value="{{ $row->ICODE }}"  autocomplete="off"  readonly style="width:100px;" /></td>
  ...
  <td><input {{$ActionStatus}} type="text" name={{"ItemName_".$key}} id={{"ItemName_".$key}} class="form-control" value="{{ $row->ITEM_NAME }}"  autocomplete="off"  readonly style="width:200px;" /></td>
  
  <td {{$AlpsStatus['hidden']}} ><input type="text" name="Alpspartno_{{$key}}" id="Alpspartno_{{$key}}" value="{{ $row->ALPS_PART_NO }}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
  <td {{$AlpsStatus['hidden']}} ><input type="text" name="Custpartno_{{$key}}" id="Custpartno_{{$key}}" value="{{ $row->CUSTOMER_PART_NO }}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
  <td {{$AlpsStatus['hidden']}} ><input type="text" name="OEMpartno_{{$key}}"  id="OEMpartno_{{$key}}"  value="{{ $row->OEM_PART_NO }}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
  ...
  <td><input {{$ActionStatus}} type="text" name="SQMUOM_{{$key}}" id="SQMUOM_{{$key}}" value="{{ $row->UOMCODE }}-{{ $row->DESCRIPTIONS }}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
  <td><input {{$ActionStatus}} type="text" name="SQMUOMQTY_{{$key}}" id="SQMUOMQTY_{{$key}}" value="{{ $row->SI_QTY }}" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
  <td><input {{$ActionStatus}} type="text" name="SI_RATE_{{$key}}" id="SI_RATE_{{$key}}" value="{{ $row->SI_RATE }}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
  <td hidden><input type="text" name="SQAUOM_{{$key}}" id="SQAUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
  <td hidden><input type="text" name="SQAUOMQTY_{{$key}}" id="SQAUOMQTY_{{$key}}" class="form-control" autocomplete="off"  readonly/></td>
  ...
  <td hidden><input type="hidden" name="MAIN_UOMID_REF_{{$key}}" id="MAIN_UOMID_REF_{{$key}}" value="{{ $row->UOMID_REF }}" class="form-control"  autocomplete="off" style="width:75px;" /></td>
  <td><input {{$ActionStatus}} type="text" name="SO_QTY_{{$key}}" id="SO_QTY_{{$key}}" value="{{ isset($row->CR_NOTE_QTY) && $row->CR_NOTE_QTY !=''?$row->CR_NOTE_QTY:'0.00' }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  style="width:75px;"  /></td>
  <td hidden><input type="hidden" name="SO_FQTY_{{$key}}" id="SO_FQTY_{{$key}}" value="{{ $row->CR_NOTE_QTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>
  
  <td hidden><input type="text" name="popupAUOM_{{$key}}" id="popupAUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
  <td hidden><input type="hidden" name="ALT_UOMID_REF_{{$key}}" id="ALT_UOMID_REF_{{$key}}"  class="form-control"  autocomplete="off"  readonly  style="width:75px;"  /></td>
  <td hidden><input type="text" name="ALT_UOMID_QTY_{{$key}}" id="ALT_UOMID_QTY_{{$key}}" class="form-control three-digits"  autocomplete="off"   style="width:75px;" readonly /></td>
  

  <td style="text-align:center;" ><a {{$ActionStatus}} class="btn checkstore" id="store_{{$key}}" ><i class="fa fa-clone"></i></a></td>
  <td  hidden><input type="hidden" name="TotalHiddenQty_{{$key}}" id="TotalHiddenQty_{{$key}}" value="{{ $row->CR_NOTE_QTY }}" ></td>
  ...
  <td><input {{$ActionStatus}} type="text" name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{ $row->CR_NOTE_RATE }}"  class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
  ...
  <td style="text-align:center;" ><input {{$ActionStatus}} type="checkbox" value="{{$row->GST}}" name='flagtype_{{$key}}' id="flagtype_{{$key}}" {{$GST_FLAGE_CHECKED}}  value="1" ></td>

  <td><input {{$ActionStatus}} type="text" name={{"IGST_".$key}} id={{"IGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->IGST }}" autocomplete="off"  readonly/></td>
  <td><input {{$ActionStatus}} type="text" name={{"IGSTAMT_".$key}} id={{"IGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
  <td><input {{$ActionStatus}} type="text" name={{"CGST_".$key}} id={{"CGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->CGST }}" autocomplete="off"  readonly/></td>
  <td><input {{$ActionStatus}} type="text" name={{"CGSTAMT_".$key}} id={{"CGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
  <td><input {{$ActionStatus}} type="text" name={{"SGST_".$key}} id={{"SGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->SGST }}" autocomplete="off"  readonly/></td>
  <td><input {{$ActionStatus}} type="text" name={{"SGSTAMT_".$key}} id={{"SGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
  <td><input {{$ActionStatus}} type="text" name={{"TGST_AMT_".$key}} id={{"TGST_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
  <td><input {{$ActionStatus}} type="text" name={{"TOT_AMT_".$key}} id={{"TOT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
  <td align="center">
                                        ...
                                        @if(!empty($objSOUDF))
                                            @foreach($objSOUDF as $Ukey => $Urow)
                                                <tr  class="participantRow4">
                                                    ...
                                                    <td hidden><input type="hidden" name={{"UDFSOID_REF_".$Ukey}}  id={{"UDFSOID_REF_".$Ukey}} class="form-control" value="{{$Urow->UDFCRVID_REF}}" autocomplete="off" /></td>
                                            ...
                                            @foreach($objUdfSOData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td hidden><input type="hidden" name={{"UDFSOID_REF_".$uindex}} id={{"UDFSOID_REF_".$uindex}} class="form-control" value="{{$uRow->UDFCRVID}}" autocomplete="off"   /></td>
                                            ...
                                            @if(!empty($objSOCAL))
                                                @foreach($objSOCAL as $Ckey => $Crow)
                                                    <tr  class="participantRow5">
                                                        ...
                                                        @if($Crow->RATE == '.0000')
                                                        <td><input {{$ActionStatus}} type="text" name={{"VALUE_".$Ckey}} id={{"VALUE_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$Crow->VALUE}}" onkeyup="bindGSTCalTemplate()" /></td>
                                                        @else
                                                        <td><input {{$ActionStatus}} type="text" name={{"VALUE_".$Ckey}} id={{"VALUE_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$Crow->VALUE}}" onkeyup="bindGSTCalTemplate()" readonly/></td>
                                                        @endif
                                                ...
                                                <tr  class="participantRow5">
                                                    ...
                                                    <td style="text-align:center;" hidden><input {{$ActionStatus}} type="checkbox" class="filter-none" name="calACTUAL_0" id="calACTUAL_0" value=""   ></td>
                                                    <td align="center" ><button class="btn add" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                </tr>
                                                <tr></tr>
                                            @endif 
      ...
      $("#tbody_ItemID").html('');
        ...
        */
        ...
        if($("#SLID_REF").val() ===""){
          ...
          showAlert('Please select Sales Invoice in Material Tab.');
        }
        else{
  ...
  var Material = $("#Material").html(); 
    ...
    $.each( soudf, function( soukey, souvalue ) {
        $.each( udfforso, function( usokey, usovalue ) { 
            if(souvalue.UDFCRVID_REF == usovalue.UDFCRVID)
            {
    ...
    $.each( obj, function( key, value ) {
        ...
        if(parseFloat(value.CR_NOTE_QTY) > 0){

          var amtbeforedis = parseFloat(value.CR_NOTE_RATE*value.CR_NOTE_QTY).toFixed(2);

        }
        else{

          var amtbeforedis = parseFloat(value.CR_NOTE_RATE).toFixed(2);
        ...
        $.each( sqitem, function( sqmkey, sqmvalue ) {
          if(itemid == sqmvalue.ITEMID_REF && sqid == sqmvalue.SIID_REF  ){
            ...
            $('#SQMUOMQTY_'+key).val(sqmvalue.SI_QTY);
            ...
            $.each( uomconv, function( umckey, umcvalue ) {
                if(itemid == umcvalue. ITEMID_REF  && sqmvalue.MAIN_UOMID_REF == umcvalue.FROM_UOMID_REF && sqmvalue.ALT_UOMID_REF == umcvalue.TO_UOMID_REF){   
                    var altqty = (sqmvalue.SI_QTY*umcvalue.TO_QTY)/umcvalue.FROM_QTY;
    ...
    success:function(data) {
      ...
      $("#btnApprove").prop("disabled", false);
        ...
        if(data.errors) {
            ...
            if(data.errors.CSV_NO){
                showError('ERROR_CSV_NO',data.errors.CSV_NO);
                        $("#YesBtn").hide();
                        $("#NoBtn").hide();
                        $("#OkBtn1").show();
...
function validateForm(saveAction){
  ...
  var CSV_NO            = $.trim($("#CSV_NO").val());
  var CSV_DT            = $.trim($("#CSV_DT").val());
  var SLID_REF          = $.trim($("#SLID_REF").val());
  var REASONOFSR        = $.trim($("#REASONOFSR").val());
  var TRANSACTION_TYPE  = $.trim($("#TRANSACTION_TYPE").val());

  if(CSV_NO ===""){
    showAlert('Please enter CSV NO.','CSV_NO');
  }
  else if(CSV_DT ===""){
    showAlert('Please select CSV Date.','CSV_DT');
  } 
  else if(SLID_REF ===""){
    showAlert('Please select Customer.','txtsubgl_popup');
  }
  else if(REASONOFSR ===""){
    showAlert('Please enter Reason of Credit Note.','REASONOFSR');
  }
...
$.ajax({
    ...
    type:'POST',
    data:{TRANSACTION_TYPE:TRANSACTION_TYPE,ITEMID_REF:ITEMID_REF,MAIN_UOMID_REF:MAIN_UOMID_REF,ROW_ID:ROW_ID,ITEMROWID:ITEMROWID,ACTION_TYPE:'VIEW',SIID_REF:SIID_REF,WhereId:WhereId},
    success:function(data) {
...
$(document).ready(function(){
  var lastdt = <?php echo json_encode($objSO->CSV_DT); ?>;
  var csv = <?php echo json_encode($objSO); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < csv.CSV_DT)
  {
	$('#CSV_DT').attr('min',lastdt);
  }
  else
  {
	  $('#CSV_DT').attr('min',csv.CSV_DT);
  }
  $('#CSV_DT').attr('max',sodate);
});
