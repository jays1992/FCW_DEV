            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="CSV_DT" id="CSV_DT" value="{{ isset($objSO->CSV_DT)?$objSO->CSV_DT:'' }}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
...
function validateForm(saveAction){
  ...
  if(CSV_NO ===""){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#CSV_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
