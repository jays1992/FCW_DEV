      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
            <input type="text" name="CSV_NO" id="CSV_NO" value="{{ isset($objSONO)?$objSONO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
            <input type="text" name="CSV_NO" id="CSV_NO" value="{{ old('SONO') }}" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase" >
          @else
            <input type="text" name="CSV_NO" id="CSV_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
          </div>
                              
          <div class="col-lg-2 pl"><p>CSV Date</p></div>
          <div class="col-lg-2 pl">
              <input type="date" name="CSV_DT" id="CSV_DT" value="{{ old('CSV_DT') }}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
...
$(document).ready(function(e) {
    ...
    //to check the label duplicacy
     $('#CSV_NO').focusout(function(){
      var CSV_NO   =   $.trim($(this).val());
      if(CSV_NO ===""){
                $("#FocusId").val('CSV_NO');
                // $("[id*=txtlabel]").blur(); 
                $("#ProceedBtn").focus();
                ...
                $("#NoBtn").hide();
                $("#OkBtn1").show();
                $("#AlertMessage").text('Please enter value in CSV_NO.');
                $("#alert").modal('show');
                $("#OkBtn1").focus();
                highlighFocusBtn('activeOk1');
                // return false;
