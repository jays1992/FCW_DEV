...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="date" name="AR_DOC_DT" id="AR_DOC_DT" value="{{ isset($objARDRCR->AR_DOC_DT)?$objARDRCR->AR_DOC_DT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
