...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              @if(isset($objARDOCNO->SYSTEM_GRSR) && $objARDOCNO->SYSTEM_GRSR == "1")
                  <input type="text" name="AR_DOC_NO" id="AR_DOC_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              @elseif(isset($objARDOCNO->MANUAL_SR) && $objARDOCNO->MANUAL_SR == "1")
                  <input type="text" name="AR_DOC_NO" id="AR_DOC_NO" value="{{ old('AR_DOC_NO') }}" class="form-control mandatory" maxlength="{{ isset($objARDOCNO->MANUAL_MAXLENGTH)?$objARDOCNO->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
            @else
                <input type="text" name="AR_DOC_NO" id="AR_DOC_NO" value="{{ old('AR_DOC_NO') }}" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  >
            @endif
        </div>
        <div class="col-lg-2 pl"><p>Debit/Credit Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="AR_DOC_DT" id="AR_DOC_DT" value="{{ old('AR_DOC_DT') }}" onchange="checkPeriodClosing(233,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-2 pl"><p>Customer</p></div>
        <div class="col-lg-2 pl">
                <input type="text" name="txtcustomer" id="txtcustomer" class="form-control"  readonly  />
                <input type="hidden" name="CID_REF" id="CID_REF"  class="form-control " />
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                  <select name="AR_TYPE" id="AR_TYPE"  class="form-control mandatory">
                ...
                <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    ...
                    @foreach($objUdfARData as $uindex=>$uRow)
                      <tr  class="participantRow4">
                          <td><input type="text" name={{"popupUDF_ARID_".$uindex}} id={{"popupUDF_ARID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
                    ...
                    @else
                      <tr  class="participantRow4">
                          <td><input type="text" name="popupUDF_ARID_0" id="popupUDF_ARID_0" class="form-control" value="" autocomplete="off"  readonly/></td>
...
$.ajax({
    url:'{{ route("transaction",[233,"save"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
