      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
            <input type="text" name="FD_CODE" id="FD_CODE" value="{{ isset($objAutoGenNo)?$objAutoGenNo:'' }}" class="form-control"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
            <input type="text" name="FD_CODE" id="FD_CODE"  class="form-control" maxlength="{{ isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
          @else
            <input type="text" name="FD_CODE" id="FD_CODE"  class="form-control"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
        </div>
                          
        <div class="col-lg-2 pl"><p>FD Date*</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="FD_DATE" id="FD_DATE" value="{{date('Y-m-d')}}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
      </div>
