    ...
    <div class="inner-form">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="FD_CODE" id="FD_CODE" value="{{isset($HDR->FD_CODE)?$HDR->FD_CODE:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
                          
        <div class="col-lg-2 pl"><p>FD Date*</p></div>
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="date" name="FD_DATE" id="FD_DATE" value="{{isset($HDR->FD_DATE)?$HDR->FD_DATE:''}}" class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
      </div>
      ...
      <div class="row">               
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text"   name="BANK_AC_TEXT" id="BANK_AC_TEXT" value="{{isset($HDR->BANK_CODE)?$HDR->BANK_CODE:''}} - {{isset($HDR->BANK_NAME)?$HDR->BANK_NAME:''}}"  class="form-control" autocomplete="off" onclick="getAccountMaster('')" readonly/>
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="BANK_AC_NO" id="BANK_AC_NO" value="{{isset($HDR->BANK_AC_NO)?$HDR->BANK_AC_NO:''}}" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
      ...
      <div class="row">               
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="FD_BANK_AC_TEXT" id="FD_BANK_AC_TEXT"  value="{{isset($HDR->FD_BANK_CODE)?$HDR->FD_BANK_CODE:''}} - {{isset($HDR->FD_BANK_NAME)?$HDR->FD_BANK_NAME:''}}" class="form-control "  autocomplete="off" onclick="getAccountMaster('FD')" readonly/>
        ...
        <div class="col-lg-2 pl"><p>Account Number</p></div>
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="FD_BANK_AC_NO" id="FD_BANK_AC_NO" value="{{isset($HDR->FD_BANK_AC_NO)?$HDR->FD_BANK_AC_NO:''}}" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="date" name="MATURITY_DATE" id="MATURITY_DATE" value="{{isset($HDR->MATURITY_DATE)?$HDR->MATURITY_DATE:''}}" class="form-control" autocomplete="off" />
        </div>
        
        <div class="col-lg-2 pl"><p>In-Favour</p></div>
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="IN_FAVOUR" id="IN_FAVOUR" value="{{isset($HDR->IN_FAVOUR)?$HDR->IN_FAVOUR:''}}" class="form-control" autocomplete="off" />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select {{$ActionStatus}}  name="BG_NO_APPLICABLE" id="BG_NO_APPLICABLE" class="form-control" autocomplete="off" onchange="getBgAppl(this.value)" >
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="BG_NO" id="BG_NO" value="{{isset($HDR->BG_NO)?$HDR->BG_NO:''}}" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Principal Amount</p></div>
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="PRINCIPLE_AMOUNT" id="PRINCIPLE_AMOUNT" value="{{isset($HDR->PRINCIPLE_AMOUNT)?$HDR->PRINCIPLE_AMOUNT:''}}" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" />
        </div>
      </div>  
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select {{$ActionStatus}}  name="RATE_OF_INTEREST_BASE" id="RATE_OF_INTEREST_BASE" class="form-control" autocomplete="off" >
            <option value="">Select</option>
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="RATE_OF_INTEREST" id="RATE_OF_INTEREST" value="{{isset($HDR->RATE_OF_INTEREST)?$HDR->RATE_OF_INTEREST:''}}" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" />
        </div>
