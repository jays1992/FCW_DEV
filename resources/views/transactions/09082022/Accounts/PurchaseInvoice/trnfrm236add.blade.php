...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              @if(isset($objPBDOCNO->SYSTEM_GRSR) && $objPBDOCNO->SYSTEM_GRSR == "1")
                  <input type="text" name="PB_DOCNO" id="PB_DOCNO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
           
              @elseif(isset($objPBDOCNO->MANUAL_SR) && $objPBDOCNO->MANUAL_SR == "1")
                  <input type="text" name="PB_DOCNO" id="PB_DOCNO" value="{{ old('PB_DOCNO') }}" class="form-control mandatory" maxlength="{{ isset($objPBDOCNO->MANUAL_MAXLENGTH)?$objPBDOCNO->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
             
              @else
                <input type="text" name="PB_DOCNO" id="PB_DOCNO" value="{{ old('PB_DOCNO') }}" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  >
              @endif
        </div>
        <div class="col-lg-1 pl"><p>PB Doc Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PB_DOCDT" id="PB_DOCDT" value="{{ old('PB_DOCDT') }}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tbody>
                          <tr  class="participantRow">
                              ...
                              <td><input {{$AlpsStatus['readonly']}} type="text" name="BILL_QTY_0" id="BILL_QTY_0" class="form-control three-digits" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                              ...
                              <td><input {{$AlpsStatus['readonly']}} type="text" name="BILL_RATEPUOM_0" id="BILL_RATEPUOM_0" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                              <td><input {{$AlpsStatus['disabled']}} type="text" name="DISC_PER_0" id="DISC_PER_0" class="form-control four-digits" maxlength="12"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                              <td><input {{$AlpsStatus['disabled']}} type="text" name="DISC_AMT_0" id="DISC_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  style="width:130px;text-align:right;" /></td>
                              ...
                              <td><input type="text" name="IGST_0" id="IGST_0" class="form-control four-digits" maxlength="12"  autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                              ...
                              <td><input type="text" name="CGST_0" id="CGST_0" class="form-control four-digits" maxlength="12"  autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                              ...
                              <td><input type="text" name="SGST_0" id="SGST_0" class="form-control four-digits" maxlength="12"  autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
