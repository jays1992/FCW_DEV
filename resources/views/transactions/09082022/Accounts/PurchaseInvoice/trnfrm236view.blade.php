...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="date" name="PB_DOCDT" id="PB_DOCDT" value="{{ isset($objPBHDR->PB_DOCDT)?$objPBHDR->PB_DOCDT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
