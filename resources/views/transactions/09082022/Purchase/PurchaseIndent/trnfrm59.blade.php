...
@section('content')    
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->PIID}}" value="{{$val->PIID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->PI_DT) && $val->PI_DT !='' && $val->PI_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PI_DT)):''}}" ></td>
                <td>{{isset($val->PI_NO) && $val->PI_NO !=''?$val->PI_NO:''}}</td>
