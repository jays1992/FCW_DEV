	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
              <input type="text" name="PI_NO" id="PI_NO" value="{{ isset($objPI_NO)?$objPI_NO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  required>
            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
              <input type="text" name="PI_NO" id="PI_NO" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase"  required>
            @else
              <input type="text" name="PI_NO" id="PI_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @endif
			...
			<div class="col-lg-2 pl">
				    <input type="date" name="PI_DT" id="PI_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control mandatory"  placeholder="dd-mm-yyyy" >
      </div>
			...
			<div class="tab-content">
				...
				<div id="Material" class="tab-pane fade in active">
                  ...
                  <th {{$AlpsStatus['hidden']}} >{{isset($TabSetting->FIELD10) && $TabSetting->FIELD10 !=''?$TabSetting->FIELD10:'Add. Info OEM Part No.'}}</th>
                    ...
                    <td {{$AlpsStatus['hidden']}}  ><input type="text" name="Alpspartno_0" id="Alpspartno_0" class="form-control"  autocomplete="off" value="{{$objCOMPANY->NAME}}"  readonly  /></td>
  ...
  if(formItemMst.valid()){
          ...
          var today = new Date(); 
              ...
              if(jQuery.inArray("true", allblank1) !== -1){
                ...
                else if(checkPeriodClosing('{{$FormId}}',$("#PI_DT").val(),0) ==0){
                  $("#YesBtn").hide();
                  $("#NoBtn").hide();
                  $("#OkBtn").hide();
                  $("#OkBtn1").show();
