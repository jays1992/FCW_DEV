                                            ...
                                            @if(!empty($objPOMAT))
                                                @foreach($objPOMAT as $key => $row)
                                                    ...
                                                    <tr  class="participantRow">
                                                        ...
                                                        <input {{$ActionStatus}} type="text" name={{"txtPIVQ_popup_".$key}} id={{"txtPIVQ_popup_".$key}} class="form-control"   autocomplete="off"   readonly style="width:130px;" /></td>
                                                        ...
                                                        <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name={{"Alpspartno_".$key}} id={{"Alpspartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ALPS_PART_NO }}" readonly style="width:130px;" /></td>
                                                        <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name={{"Custpartno_".$key}} id={{"Custpartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->CUSTOMER_PART_NO }}" readonly style="width:130px;" /></td>
                                                        <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name={{"OEMpartno_".$key}} id={{"OEMpartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->OEM_PART_NO }}" readonly style="width:130px;" /></td>
                                                        
                                                        <td><input {{$ActionStatus}} type="text" name={{"PI_VQMUOM_".$key}} id={{"PI_VQMUOM_".$key}} class="form-control"  autocomplete="off"  value="{{ $row->MUOM_DESC }}" readonly style="width:130px;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"PI_VQMUOMQTY_".$key}} id={{"PI_VQMUOMQTY_".$key}} class="form-control" maxlength="13" value="{{ $row->MUOM_QTY }}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"PI_VQAUOM_".$key}} id={{"PI_VQAUOM_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ALTUOM_DESC }}" readonly style="width:130px;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"PI_VQAUOMQTY_".$key}} id={{"PI_VQAUOMQTY_".$key}} class="form-control" maxlength="13" autocomplete="off" value="{{ $row->ALTUOM_QTY }}"  readonly style="width:130px;text-align:right;" /></td>
                                                        ...
                                                        <td><input {{$ActionStatus}} type="text" name={{"PO_QTY_".$key}} id={{"PO_QTY_".$key}} class="form-control three-digits" maxlength="13" value="@php echo number_format(floatVal($row->PO_QTY),3,'.','');  @endphp"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                                                        ...
                                                        <td><input {{$ActionStatus}} type="text" name={{"LASTPRICE_".$key}} id={{"LASTPRICE_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->RATEP_UOM1 }}"  autocomplete="off" style="width:130px;text-align:right;" readonly/></td>


                                                        <td><input {{$ActionStatus}} type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->RATEP_UOM }}"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCPER_".$key}} id={{"DISCPER_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->DISCOUNT_PER }}"  autocomplete="off"  @if(strpos($objCOMPANY->NAME,"ALPS")!== false)  disabled @endif style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCOUNT_AMT_".$key}} id={{"DISCOUNT_AMT_".$key}} class="form-control two-digits" value="{{ $row->DIS_AMT }}" maxlength="15"  autocomplete="off" @if(strpos($objCOMPANY->NAME,"ALPS")!== false)  disabled @endif style="width:130px;text-align:right;" /></td>
