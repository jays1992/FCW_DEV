                    ...
                    <div class="inner-form">
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="PODT" id="PODT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ isset($objPO->PO_DT)?$objPO->PO_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy"  readonly>
                            </div>
                                            ...
                                            @if(!empty($objPOMAT))
                                                @foreach($objPOMAT as $key => $row)
                                                    <tr  class="participantRow">
                                                        <td hidden>
                                                        <input  class="form-control" type="hidden" name={{"SOMATID_".$key}} id ={{"SOMATID_".$key}} maxlength="100" value="{{ $row->POMATID }}" autocomplete="off" style="width:130px;"   >
                                                        </td>
                                                        <td style="text-align:center;" >
                                                        <input type="text" name={{"txtPIVQ_popup_".$key}} id={{"txtPIVQ_popup_".$key}} class="form-control"   autocomplete="off"   readonly style="width:130px;" /></td>
                                                        ...
                                                        <td  hidden><input type="text" name="PIID_REF_0" id="PIID_REF_0" class="form-control" value="{{  $row->PIID_REF }}" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name="MRSID_REF_0" id="MRSID_REF_0" class="form-control" value="{{  $row->MRSID_REF }}" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name="RFQID_REF_0" id="RFQID_REF_0" class="form-control" value="{{  $row->RFQID_REF }}" autocomplete="off" style="width:130px;" /></td>
                                                    
                                                       
                                                        <td><input type="text" name={{"popupITEMID_".$key}} id={{"popupITEMID_".$key}} class="form-control" value="{{ $row->ICODE }}"  autocomplete="off"  readonly style="width:130px;"/></td>
                                                        ...
                                                        <td><input type="text" name={{"ItemName_".$key}} id={{"ItemName_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ITEM_NAME }}"  readonly style="width:130px;"/></td>
                                                        <td><input type="text" name={{"Itemspec_".$key}} id={{"Itemspec_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ITEMSPECI }}" style="width:130px;" /></td>
                                                        <td {{$AlpsStatus['hidden']}} ><input type="text" name={{"Alpspartno_".$key}} id={{"Alpspartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ALPS_PART_NO }}" readonly style="width:130px;"/></td>
                                                        <td {{$AlpsStatus['hidden']}} ><input type="text" name={{"Custpartno_".$key}} id={{"Custpartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->CUSTOMER_PART_NO }}" readonly style="width:130px;"/></td>
                                                        <td {{$AlpsStatus['hidden']}} ><input type="text" name={{"OEMpartno_".$key}} id={{"OEMpartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->OEM_PART_NO }}" readonly style="width:130px;"/></td>
                                                        
                                                        <td><input type="text" name={{"PI_VQMUOM_".$key}} id={{"PI_VQMUOM_".$key}} class="form-control"  autocomplete="off"  value="{{ $row->MUOM_DESC }}" readonly style="width:130px;"/></td>
                                                        <td><input type="text" name={{"PI_VQMUOMQTY_".$key}} id={{"PI_VQMUOMQTY_".$key}} class="form-control" maxlength="13" value="{{ $row->MUOM_QTY }}" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name={{"PI_VQAUOM_".$key}} id={{"PI_VQAUOM_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ALTUOM_DESC }}" readonly style="width:130px;"/></td>
                                                        <td><input type="text" name={{"PI_VQAUOMQTY_".$key}} id={{"PI_VQAUOMQTY_".$key}} class="form-control" maxlength="13" autocomplete="off" value="{{ $row->ALTUOM_QTY }}"  readonly style="width:130px;text-align:right;"/></td>
                                                       
                                                        <td><input type="text" name={{"popupMUOM_".$key}} id={{"popupMUOM_".$key}} class="form-control"  autocomplete="off" value="{{ $row->MAIN_UOM_CODE }}"  readonly style="width:130px;"/></td>
                                                        ...
                                                        <td ><input type="text" name={{"PENDING_QTY_".$key }} id={{ "PENDING_QTY_".$key}} class="form-control three-digits" maxlength="13" value="{{ $row->CAL_PENDING_QTY }}" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name={{"PO_QTY_".$key}} id={{"PO_QTY_".$key}} class="form-control three-digits" maxlength="13" value="@php echo number_format(floatVal($row->PO_QTY),3,'.','');  @endphp"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                                                        ...
                                                        <td><input type="text" name={{"popupAUOM_".$key}} id={{"popupAUOM_".$key}} class="form-control"  autocomplete="off" value="{{ $row->AULT_UOM_CODE }}"  readonly style="width:130px;"/></td>
                                                        ...
                                                        <td><input type="text" name={{"ALT_UOMID_QTY_".$key}} id={{"ALT_UOMID_QTY_".$key}} class="form-control three-digits" maxlength="13" value="{{ ($row->PO_QTY*$row->TO_QTY)/$row->FROM_QTY }}"  autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name={{"LASTPRICE_".$key}} id={{"LASTPRICE_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->RATEP_UOM1 }}"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        <td><input type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->RATEP_UOM }}"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$AlpsStatus['disabled']}} type="text" name={{"DISCPER_".$key}} id={{"DISCPER_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->DISCOUNT_PER }}"  autocomplete="off" style="width:130px;text-align:right;"  {{$AlpsStatus['disabled']}}  /></td>
                                                        <td><input {{$AlpsStatus['disabled']}} type="text" name={{"DISCOUNT_AMT_".$key}} id={{"DISCOUNT_AMT_".$key}} class="form-control two-digits" value="{{ $row->DIS_AMT }}" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;" {{$AlpsStatus['disabled']}}  /></td>
                                                        <td><input type="text" name={{"DISAFTT_AMT_".$key}} id={{"DISAFTT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name={{"IGST_".$key}} id={{"IGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->IGST }}" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                        <td><input type="text" name={{"IGSTAMT_".$key}} id={{"IGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name={{"CGST_".$key}} id={{"CGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->CGST }}" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                        <td><input type="text" name={{"CGSTAMT_".$key}} id={{"CGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name={{"SGST_".$key}} id={{"SGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->SGST }}" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                        <td><input type="text" name={{"SGSTAMT_".$key}} id={{"SGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name={{"TGST_AMT_".$key}} id={{"TGST_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name={{"TOT_AMT_".$key}} id={{"TOT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
