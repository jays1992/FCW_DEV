            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            @if(isset($objDOCN->SYSTEM_GRSR) && $objDOCN->SYSTEM_GRSR == "1")
                                <input type="text" name="PONO" id="PONO" value="{{ $objDOCNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                           
                            @elseif(isset($objDOCN->MANUAL_SR) && $objDOCN->MANUAL_SR == "1")
                                <input type="text" name="PONO" id="PONO" value="{{ old('PONO') }}" class="form-control mandatory" maxlength="{{$objDOCN->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase"  >
                            @else
                              <input type="text" name="PONO" id="PONO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            @endif
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="PODT" id="PODT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('PODT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
