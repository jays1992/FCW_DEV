                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                                <input type="text" name="VQ_NO" id="VQ_NO"  class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
                            @else
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="VQ_DT" id="VQ_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                                ...
                                                <tr>
                                                    <th rowspan="2">RFQ No<input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="1"></th>
                                                    ...
                                                    <th rowspan="2">UoM</th>
                                                    <th rowspan="2">Pending RFQ Qty</th>
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    ...
                                                    <td><input {{$AlpsStatus['disabled']}} type="text" name="DISCPER_0" id="DISCPER_0" class="form-control four-digits blurDISCPER" maxlength="8"  autocomplete="off" style="width: 50px;"  onkeypress="return isNumberDecimalKey(event,this)" {{$AlpsStatus['disabled']}} /></td>
                                                    <td><input {{$AlpsStatus['disabled']}} type="text" name="DISCOUNT_AMT_0" id="DISCOUNT_AMT_0" class="form-control two-digits blurDISCOUNT_AMT" maxlength="15"  autocomplete="off"  onkeypress="return isNumberDecimalKey(event,this)"  {{$AlpsStatus['disabled']}}  /></td>
    ...
    function bindItemEvents(){
      ...
      $('.js-selectall').change(function(){
        ...
        $('#ItemIDTable2').find('.clsitemid').each(function(){
          ...
          var rfqqty =  $("#txt"+fieldid+"").data("quoqty");
