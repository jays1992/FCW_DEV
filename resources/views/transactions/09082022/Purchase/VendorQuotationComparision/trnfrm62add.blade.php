            ...
            <div class="container-fluid filter">
                    ...
                    <div class="row">
                            ...
                            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                                <input type="text" name="VQC_NO" id="VQC_NO" value="{{ isset($objAutoGenNo)?$objAutoGenNo:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                                <input type="text" name="VQC_NO" id="VQC_NO"  class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase"  >
                            @else
                              <input type="text" name="VQC_NO" id="VQC_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            @endif
                            ...
                            <div class="col-lg-2 pl">
                              <input type="date" name="VQC_DT" id="VQC_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
