            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        <div class="row">
                            ...
                            @if(isset($objSOSN->SYSTEM_GRSR) && $objSOSN->SYSTEM_GRSR == "1")
                                <input type="text" name="SOSNO" id="SOSNO" value="{{ isset($objSOSNO)?$objSOSNO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                          
                            @elseif(isset($objSOSN->MANUAL_SR) && $objSOSN->MANUAL_SR == "1")
                                <input type="text" name="SOSNO" id="SOSNO" value="{{ old('SOSNO') }}" class="form-control mandatory" maxlength="{{ isset($objSOSN->MANUAL_MAXLENGTH)?$objSOSN->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
                            @else
                                <input type="text" name="SOSNO" id="SOSNO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                              @endif
                            </div>
                            <div class="col-lg-2 pl"><p>SBP Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="SOSDT" id="SOSDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('SOSDT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
                        ...
                        <div class="row">
                            {{-- <div class="col-lg-2 pl"><p>SL</p></div>
                            <div class="col-lg-2 pl">
                    ...
                    <div class="container-fluid purchase-order-view">
                        ...
                        <div class="row">
                            <ul class="nav nav-tabs">
                                ...
                                {{-- <li hidden><a data-toggle="tab" href="#udf" >UDF</a></li> --}}
                            </ul>
                            <div class="tab-content">
                                ...
                                {{-- udf begin --}}
                                {{-- <div id="udf" class="tab-pane fade" style="display:none">
                                      ...
                                      <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                          ...
                                          <tbody>
                                            ...
                                            <tr  class="participantRow4">
                                              ...
                                              <td hidden>
                                                <input type="text" name='{{"udffie_".$udfkey}}' id='{{"hdnudffie_popup_".$udfkey}}' value="{{$udfrow->SCHBLPOID}}" class="form-control" maxlength="100" />
                                              </td>
    ...
    var manualsr = <?php echo json_encode($objSOSN->MANUAL_SR); ?>;
     $('#SOSNO').focusout(function(){
      ...
      if(manualsr == "1")      
      {
        ...
        $.ajax({
            url:'{{route("transaction",[68,"checkspbno"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
                if(data.exists) {
...
$('#SOSDT').attr('max',current_date);
    ...
    window.fnUndoYes = function (){
      //reload form
      window.location.href = "{{route('transaction',[68,'add'])}}";
   }//fnUndoYes
    ...
    if(SOSNO ===""){
        ...
        var totalquantity = '0.000';
            ...
            if(jQuery.inArray("false", allblank) !== -1){
                ...
                else if(checkPeriodClosing('{{$FormId}}',$("#SOSDT").val(),0) ==0){
                  $("#YesBtn").hide();
                  $("#NoBtn").hide();
                  $("#OkBtn").hide();
                  $("#OkBtn1").show();
...
window.onload = function(){
  var docno = <?php echo json_encode(isset($objSOSNO)?$objSOSNO:''); ?>;
  if(docno==""){     
    $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
      $("#AlertMessage").text('Please create Document Number Defination for SBP No.');
      $("#alert").modal('show');
      $("#OkBtn1").focus();
      highlighFocusBtn('activeOk1');
  } 
