	...
	<div class="inner-form">
        ...
        @if(!empty($objSON))
            @if($objSON->SYSTEM_GRSR == "1")
                <input type="text" name="AFSNO" id="AFSNO" value="{{ $objAFSNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            @endif
            @if($objSON->MANUAL_SR == "1")
                <input type="text" name="AFSNO" id="AFSNO" value="{{ old('AFSNO') }}" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
        @endif    
			</div>
      ...
      <input type="hidden" name="ASFDT" id="ASFDT" class="form-control" autocomplete="off" />
            ...
            <input type="date" name="AFSDT" id="AFSDT" onchange="checkPeriodClosing(220,this.value,1)" value="{{ old('AFSDT') }}" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
      ...
      <div class="tab-content">
                           ...
                           <input type="text" name="rowscount[]"  /></td>
                                                  ...
                                                  <td style="text-align:center;">            
                                                    ...
                                                    {{-- <td><input type="text" name="SEPTEMBER_QTY_0" id="SEPTEMBER_QTY_0" class="form-control three-digits" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
                                                    <td><input type="text" name="SEPTEMBER_VALUE_0" id="SEPTEMBER_VALUE_0" class="form-control three-digits" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
                                                    <td><input type="text" name="OCTOBER_QTY_0" id="OCTOBER_QTY_0" class="form-control three-digits" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "{{route('transaction',[220,'add'])}}";
}//fnUndoYes
...
$.ajax({
    url:'{{ route("transaction",[220,"save"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnSaveSE").hide(); 
...
window.onload = function(){
  var docno = <?php echo json_encode($objAFSNO); ?>;
  if(docno==""){     
    $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
