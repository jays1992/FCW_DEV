...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Purchase Return (PRR)</a></div>
      ...
      <div class="inner-form" id="Header_Form">
        ...
        <div class="row">
          ...
          @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
              <input type="text" name="PRR_NO" id="PRR_NO" value="{{ isset($objSONO)?$objSONO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          
          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
              <input type="text" name="PRR_NO" id="PRR_NO" value="{{ old('PRR_NO') }}" class="form-control mandatory" maxlength="{{ isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
              @else
            <input type="text" name="PRR_NO" id="PRR_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
          </div>
                              
          <div class="col-lg-2 pl"><p>PRR Date</p></div>
          <div class="col-lg-2 pl">
              <input type="date" name="PRR_DT" id="PRR_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('PRR_DT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
...
<div id="glidpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    ...
    <tr>
    <td>
    <input type="text" id="glcodesearch" autocomplete="off" onkeyup="GLCodeFunction()">
    </td>
    <td>
    <input type="text" id="glnamesearch" autocomplete="off" onkeyup="GLNameFunction()">
    </td>
    </tr>
    </tbody>
    </table>
...
$('#PRR_DT').attr('max',current_date);
    ...
    //to check the label duplicacy
     $('#PRR_NO').focusout(function(){
      var PRR_NO   =   $.trim($(this).val());
      if(PRR_NO ===""){
                $("#FocusId").val('PRR_NO');
                // $("[id*=txtlabel]").blur(); 
                $("#ProceedBtn").focus();
                ...
                $("#NoBtn").hide();
                $("#OkBtn1").show();
                $("#AlertMessage").text('Please enter value in PRR No.');
                $("#alert").modal('show');
                $("#OkBtn1").focus();
                highlighFocusBtn('activeOk1');
                // return false;
