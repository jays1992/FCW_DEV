            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                                <input type="text" name="SONO" id="SONO" value="{{ isset($objSONO)?$objSONO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                          
                              @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                                <input type="text" name="SONO" id="SONO" value="{{ old('SONO') }}" class="form-control mandatory" maxlength="{{ isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
                              @else
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(69,this.value,1)" value="{{ old('SODT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" value="" class="form-control " autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-1 pl" hidden><p>Direct </p></div>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    <td style="text-align:center;"  hidden><input type="text" name="txtSQ_popup_0" id="txtSQ_popup_0" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                                                    <td hidden><input type="text" name="SQA_0" id="SQA_0" class="form-control" autocomplete="off" style="width:130px;" /></td>
                                                    <td hidden><input type="text" name="SEQID_REF_0" id="SEQID_REF_0" class="form-control" autocomplete="off" style="width:130px;" /></td>
                                                    ...
                                                    <td><input type="text" name="SERVICE_SPECIFICATION_0" id="SERVICE_SPECIFICATION_0" class="form-control"  autocomplete="off" style="width:130px;"/></td>
                                                    <td   hidden><input type="text" name="Itemspec_0" id="Itemspec_0" class="form-control"  autocomplete="off" style="width:130px;"  /></td>
                                                    ...
                                                    <td   hidden><input type="text" name="SQMUOMQTY_0" id="SQMUOMQTY_0" class="form-control" maxlength="13"  autocomplete="off"  readonly style="width:130px;"/></td>
                                                    <td   hidden><input type="text" name="SQAUOM_0" id="SQAUOM_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"/></td>
                                                    <td   hidden><input type="text" name="SQAUOMQTY_0" id="SQAUOMQTY_0" class="form-control" maxlength="13" autocomplete="off"  readonly style="width:130px;"/></td>
                                                    ...
                                                    <td hidden><input type="text" name="SO_FQTY_0" id="SO_FQTY_0" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;"/></td>
                                                    <td hidden><input type="text" name="PENDING_QTY_0" id="PENDING_QTY_0" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;"/></td>
                                                    ...
                                                    <td hidden><input type="text" name="popupAUOM_0" id="popupAUOM_0" class="form-control"  autocomplete="off"  readonly  disabled style="width:130px;text-align:right;"/></td>
                                                    ...
                                                    <td hidden><input type="text" name="ALT_UOMID_QTY_0" id="ALT_UOMID_QTY_0" class="form-control three-digits" maxlength="13" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                    ...
                                                    <td><input {{$AlpsStatus['disabled']}} type="text" name="DISCPER_0" id="DISCPER_0" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" {{$AlpsStatus['disabled']}}  /></td>
                                                    <td><input {{$AlpsStatus['disabled']}} type="text" name="DISCOUNT_AMT_0" id="DISCOUNT_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;" {{$AlpsStatus['disabled']}}  /></td>
    ...
    //to check the label duplicacy
     $('#SONO').focusout(function(){
      ...
      if(SONO ===""){
        ...
        $.ajax({
            url:'{{route("transaction",[69,"checkso"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
               if(data.exists) {
...
//SO Date Check
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('transaction',[69,'add'])}}";
...
window.onload = function(){
  var docno = <?php echo json_encode($objSONO); ?>;
  if(docno==""){     
    $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
      $("#AlertMessage").text('Please create Document Number Defination for SPO No.');
      $("#alert").modal('show');
      $("#OkBtn1").focus();
      highlighFocusBtn('activeOk1');
  } 
