            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="SODT" id="SODT" value="{{ isset($objSO->SPO_DT)?$objSO->SPO_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                                            ...
                                            @if(!empty($objSOMAT))
                                                @foreach($objSOMAT as $key => $row)
                                                    <tr  class="participantRow">
                                                        ...
                                                        <td><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCPER_".$key}} id={{"DISCPER_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->DISCOUNT_PER }}"  autocomplete="off" style="width:130px;text-align:right;"  @if(strpos($objCOMPANY->NAME,"ALPS")!== false)  disabled @endif /></td>
                                                        <td><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCOUNT_AMT_".$key}} id={{"DISCOUNT_AMT_".$key}} class="form-control two-digits" value="{{ $row->DIS_AMT }}" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;" @if(strpos($objCOMPANY->NAME,"ALPS")!== false)  disabled @endif /></td>
...
$("#btnApprove").click(function(){
  ...
  if(formPurchaseOrder.valid()){
    ...
    if(parseFloat(checkAttachment) > 0){
      ...
      $("#NoBtn").hide();
      $("#OkBtn1").show();
      $("#AlertMessage").text('Attachment is required before approve record.');
      $("#alert").modal('show');
      $("#OkBtn1").focus();
      return false;
    }
