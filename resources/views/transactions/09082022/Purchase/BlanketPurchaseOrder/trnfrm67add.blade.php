                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                                <input type="text" name="VQ_NO" id="VQ_NO" value="{{ isset($objAutoGenNo)?$objAutoGenNo:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                          
                            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                                <input type="text" name="VQ_NO" id="VQ_NO" value="{{ old('VQ_NO') }}" class="form-control mandatory" maxlength="{{ isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
                            @else
                              <input type="text" name="VQ_NO" id="VQ_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            @endif
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="VQ_DT" id="VQ_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('BPO_DT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl">
                              <input type="date" name="VFRDT" id="VFRDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy"  >
                          </div>
                          
                          <div class="col-lg-2 pl"><p>BPO Validity To*</p></div>
                          <div class="col-lg-2 pl">
                              <input type="date" name="VTODT" id="VTODT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy"  >
                          </div>
                      ...
                      <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control mandatory" autocomplete="off" value="0"/>
                            </div>
                        ...
                        <div class="row" hidden>                            
                            ...
                            <div class="col-lg-2 pl">
                                  <input type="checkbox" name="DIRECT_VQ" id="DIRECT_VQ" class="form-checkbox" value="1" checked >
                            </div>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                  <tr  class="participantRow">
                                                    ...
                                                    <td hidden><input type="text" name="RMK_0" id="RMK_0" class="form-control" maxlength="200" autocomplete="off"  /></td>
                                        ...
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody>
                                              ...
                                              <tr  class="participantRow4">
                                                ...
                                                <td hidden>
                                                  <input type="text" name='{{"udffie_".$udfkey}}' id='{{"hdnudffie_popup_".$udfkey}}' value="{{$udfrow->BLPOID}}" class="form-control" maxlength="100" />
                                                </td>
     ...
     return false;
        ...
        $("[id*=txtudffie_popup]").each(function(){
          if($.trim($(this).val())!="")
          {
            ...
            else if(checkPeriodClosing('{{$FormId}}',$("#VQ_DT").val(),0) ==0){
              $("#YesBtn").hide();
              $("#NoBtn").hide();
              $("#OkBtn").hide();
              $("#OkBtn1").show();
...
$(document).ready(function(){
    var lastdt = <?php echo json_encode($objlastVQ_DT[0]->BPO_DT); ?>;
    var today = new Date(); 
