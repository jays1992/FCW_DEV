                    ...
                    <div class="inner-form">
                        <div class="row">
                            ...
                            @elseif(isset($objSOSN->MANUAL_SR) && $objSOSN->MANUAL_SR == "1")
                                <input type="text" name="SOSNO" id="SOSNO"  class="form-control mandatory" maxlength="{{ isset($objSOSN->MANUAL_MAXLENGTH)?$objSOSN->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
                            @else
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="SOSDT" id="SOSDT" onchange="checkPeriodClosing(41,this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>  
    ...
    var manualsr = <?php echo isset($objSOSN->MANUAL_SR)?json_encode($objSOSN->MANUAL_SR):''; ?>;
     $('#SOSNO').focusout(function(){
      ...
      if(manualsr == "1")      
      {
        ...
        $.ajax({
            url:'{{route("transaction",[41,"checksos"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
                if(data.exists) {
...
$('#SOSDT').attr('max',sosdate);
    ...
    window.fnUndoYes = function (){
      //reload form
      window.location.href = "{{route('transaction',[41,'add'])}}";
   }//fnUndoYes
