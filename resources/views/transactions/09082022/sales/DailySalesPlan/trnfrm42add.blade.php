	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                <input type="text" name="DSPNO" id="DSPNO" value="{{ isset($objDSPNO)?$objDSPNO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  required>
            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                <input type="text" name="DSPNO" id="DSPNO"  class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  required>
            @else
              <input type="text" name="DSPNO" id="DSPNO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @endif
			</div>
			
			<div class="col-lg-2 pl "><p>Daily Sales Plan Date*</p></div>
			<div class="col-lg-2 pl">
				    <input type="date" name="DSPDT" id="DSPDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control mandatory"  placeholder="dd-mm-yyyy" >
            </div>
	...
	<div class="container-fluid">
        ...
        <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
              ...
              <tr  class="participantRow2">
                ...
                <td hidden>
                  <input type="text" name='{{"udffie_".$udfkey}}' id='{{"hdnudffie_popup_".$udfkey}}' value="{{$udfrow->UDF_DSPID}}" class="form-control" maxlength="100" />
                </td>
  ...
  if(formItemMst.valid()){
          ...
          var today = new Date(); 
              ...
              if(jQuery.inArray("true", allblank1) !== -1){
                  ...
                  else if(checkPeriodClosing('{{$FormId}}',$("#DSPDT").val(),0) ==0){
                    $("#YesBtn").hide();
                    $("#NoBtn").hide();
                    $("#OkBtn").hide();
                    $("#OkBtn1").show();
