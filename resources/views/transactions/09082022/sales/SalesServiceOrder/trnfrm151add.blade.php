  ...
  <div class="container-fluid purchase-order-view"> 
    ...
    <div class="container-fluid filter">
      <div class="inner-form">            
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              ...
              <input type="text" name="SSO_NO" id="SSO_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly   autocomplete="off"  style="text-transform:uppercase" autofocus >
              @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
              <input type="text" name="SSO_NO" id="SSO_NO"  class="form-control mandatory" maxlength="{{ isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase" autofocus >
              @else
                <input type="text" name="SSO_NO" id="SSO_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              @endif

              <span class="text-danger" id="ERROR_SSO_NO"></span>
          </div>
                            
          <div class="col-lg-1 pl"><p>SSO Date*</p></div>
          <div class="col-lg-2 pl">
              <input type="date" name="SSO_DT" id="SSO_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control mandatory" autocomplete="off" >
          </div>
      ...
      <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input type="text" name="CONV_FACT" id="CONV_FACT" autocomplete="off" class="form-control" maxlength="100" />
          </div>
      </div>
      ...
      <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input type="date" name="OVF_DT" id="OVF_DT" class="form-control mandatory" autocomplete="off"   >
          </div>
          
          <div class="col-lg-1 pl"><p>To </p></div>
          <div class="col-lg-2 pl">
              <input type="date" name="OVT_DT" id="OVT_DT" class="form-control mandatory" autocomplete="off"  >
          </div>
          
          <div class="col-lg-2 pl"><p>Customer Order No</p></div>
          <div class="col-lg-2 pl">
              <input type="text" name="CUSTOMER_ONO" id="CUSTOMER_ONO" class="form-control" autocomplete="off" style="text-transform:uppercase" >
          </div>
      </div>
      ...
      <div class="row">	
        ...
        <div class="col-lg-2 pl">
            <input type="date" name="CUSTOMER_ODT" id="CUSTOMER_ODT" class="form-control " autocomplete="off"  >
        </div>
        ...
        <div class="col-lg-1 pl">
            <input type="text" name="CR_DAYS" id="CR_DAYS" class="form-control" autocomplete="off"/>
        </div>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    <!--Remove -->
                                                    <td hidden ><input type="hidden" name="txtSQ_popup_0" id="txtSQ_popup_0" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                                                    ...
                                                    <td><input type="date" name="EDD_0" id="EDD_0" autocomplete="off" class="form-control" style="width:130px;"  ></td>
                                            ...
                                            <tr  class="participantRow3">
                                             ...
                                             <td id="tdinputid_0">
                                              {{-- dynamic input --}} 
                                                ...
                                                <td align="center" >
                                                  <button class="btn add TNC" title="add" data-toggle="tooltip"  type="button" disabled><i class="fa fa-plus"></i></button>
                                                  <button class="btn remove DTNC" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button>
                                                </td>
                                            </tr>
                                        <tr></tr>
                                            </tbody>
                                        ...
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            @foreach($objUdfSOData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td align="center" >
                                                    <button class="btn add UDF" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button>
                                                    <button class="btn remove DUDF" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button>
                                                  </td>
...
//------------------------
  ...
  $('#div_shipto').on('click','#txtSHIPTO',function(event){
         $("#ShipTopopup").show();
         showSelectedCheck($("#SPID_REF").val(),"SELECT_SHIPTO"); 
         event.preventDefault();
      });
      ...
      function BindShipAddress(){
        $(".clsshipto").click(function(){
          var fieldid = $(this).attr('id');
          var txtval =    $("#txt"+fieldid+"").val();
         // var texdesc =   $(this).parent().children('[id*="txtshipadd"]').text();
...
$(document).ready(function(e) {
    ...
    $('#udf').find('.participantRow4').each(function(){
      ...
      var udfid = $(this).find('[id*="UDFSSOID_REF"]').val();
      $.each( soudf, function( soukey, souvalue ) {
        if(souvalue.UDFSSOID == udfid)
        {
    ...
    //to check the label duplicacy
     $('#SSO_NO').focusout(function(){
      var SSO_NO   =   $.trim($(this).val());
      if(SSO_NO ===""){
                $("#FocusId").val('SSO_NO');
                // $("[id*=txtlabel]").blur(); 
                $("#ProceedBtn").focus();
                ...
                $("#NoBtn").hide();
                $("#OkBtn1").show();
                $("#AlertMessage").text('Please enter value in SSO NO.');
                $("#alert").modal('show');
                $("#OkBtn1").focus();
                highlighFocusBtn('activeOk1');
                // return false;
...
function validateForm(){
 ...
 if(SSO_NO ===""){
     ...
     $("#NoBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Please select SSO Date.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 } 
     ...
     $("#NoBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Please select order validity from date.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 } 
     ...
     $("#NoBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Please select order validity to date.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 } 
     ...
     $("#NoBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Please select date for customer order no.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 } 
    ...
    var allblank14 = [];
        ...
        if(jQuery.inArray("false", allblank) !== -1){
            ...
            $("#alert").modal('show');
            $("#AlertMessage").text('Expected date of service delivery date cannot be blank in material tab.');
            $("#YesBtn").hide(); 
            $("#NoBtn").hide();  
            $("#OkBtn1").show();
            $("#OkBtn1").focus();
            ...
            $("#alert").modal('show');
            $("#AlertMessage").text('Expected date of service delivery date should not less then current date in material tab.');
            $("#YesBtn").hide(); 
            $("#NoBtn").hide();  
            $("#OkBtn1").show();
            $("#OkBtn1").focus();
        ...
        if(data.errors) {
            ...
            if(data.errors.SSO_NO){
                showError('ERROR_SSO_NO',data.errors.SSO_NO);
                        ...
                        $("#NoBtn").hide();
                        $("#OkBtn1").show();
                        $("#AlertMessage").text('Please enter correct value in SSO NO.');
                        $("#alert").modal('show');
                        $("#OkBtn1").focus();
            }
