            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="SSO_DT" id="SSO_DT" value="{{ isset($objSO->SSO_DT)?$objSO->SSO_DT:'' }}" class="form-control mandatory" autocomplete="off" >
                            </div>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:90%; height:90%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Sales Service Order Print</p></div>
        <div class="row">
...
$('#btnPdf').on('click', function() {
  var SONO = objSSO.SSOID;
  var Flag = 'P';
  var formData = 'SO='+ SONO + '&SSO_NO='+ SONO + '&Flag='+ Flag ;
  var consultURL = '{{route("transaction",[151,"ViewReport",":rcdId"]) }}';
...
$('#btnPrint').on('click', function() {
    ...
    $.ajax({
        url:'{{route("transaction",[151,"ViewReport"])}}',
        type:'POST',
        data:formData,
        success:function(data) {
            $('#ReportView').show();
