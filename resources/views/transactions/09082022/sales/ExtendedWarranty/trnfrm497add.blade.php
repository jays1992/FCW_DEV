...
<form id="trn_form" onsubmit="return validateForm(actionType)" method="POST"  class="needs-validation"> 
  <div class="container-fluid filter">
      ...
      <div class="row">
        <div class="col-lg-2 pl"><p>Doc No*</p></div>
          ...
          <input type="text" name="DOC_NO" id="DOC_NO" value="{{ $objDOCNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @elseif(isset($objDD->MANUAL_SR) && $objDD->MANUAL_SR == "1")
          <input type="text" name="DOC_NO" id="DOC_NO" value="{{ old('DOC_NO') }}" class="form-control mandatory" maxlength="{{isset($objDD->MANUAL_MAXLENGTH)?$objDD->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
            @else
          <input type="text" name="DOC_NO" id="DOC_NO" value="{{ old('BGCODE') }}"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
         @endif
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="DOC_DT" id="DOC_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('DOC_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
          <span class="text-danger" id="ERROR_DOC_DT"></span>
        </div> 
        
        <div class="col-lg-2 pl"><p>Customer*</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="cust_popup" id="txtcust_popup" class="form-control mandatory"  autocomplete="off" readonly/>
          <input type="hidden" name="CUSTID_REF" id="CUSTID_REF" class="form-control" autocomplete="off" />           
        </div>
      </div>    
    </div>
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
				  <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input  type="text" name="popupInvNo[]" id="popupInvNo_0" class="form-control"  autocomplete="off"  readonly style="width: 120px"/></td>
                    <td hidden><input type="hidden" name="INVNOID_REF[]" id="INVNOID_REF_0" class="form-control" autocomplete="off" /></td>
                    
                    <td><input type="date" name="INVDATE[]" id="INVDATE_0" class="form-control"  autocomplete="off"  readonly style="width: 120px"/></td>
                    
                    <td hidden><input type="text" name="INVIDNO[]" id="INVIDNO_0" class="form-control" autocomplete="off" /></td>
                    <td hidden><input type="text" name="SEID_REF[]" id="SEID_REF_0" class="form-control" autocomplete="off" /></td>
                    
                    <td><input  type="text" name="popupITEMID[]" id="popupITEMID_0" class="form-control"  autocomplete="off"  readonly style="width: 120px"/></td>
                    <td hidden><input type="text" name="ITEMID_REF[]" id="ITEMID_REF_0" class="form-control" autocomplete="off" /></td>
                    <td><input type="text" name="ItemName[]" id="ItemName_0" class="form-control"  autocomplete="off"  readonly style="width: 150px"/></td>
                    
                    <td><input type="text" name="EXTENDEDWNTMONTH[]" id="EXTENDEDWNTMONTH_0" onkeyup="getExtnFromDate(this.id,this.value)" class="form-control"  onkeypress="return onlyNumberKey(event)" autocomplete="off" /></td>
                    
                    <td hidden><input type="hidden" name="popupMUOM[]" id="popupMUOM_0" class="form-control"  autocomplete="off"  readonly/></td>
                    <td hidden><input type="text" name="MAIN_UOMID_REF[]" id="MAIN_UOMID_REF_0" class="form-control"  autocomplete="off" /></td>
                    
                    <td><input type="date"   name="STARTFROM[]" id="STARTFROM_0" class="form-control" autocomplete="off"   /></td>
                    <td><input type="date"   name="STARTTO[]" id="STARTTO_0" class="form-control" autocomplete="off" /></td>
                    <td><input type="text"   name="WARRANTYAMT[]" id="WARRANTYAMT_0" class="form-control" maxlength="200" onkeyup="getWatnTaxDetails(this.id,this.value)"  onkeypress="return onlyNumberKey(event)" autocomplete="off" /></td>
                    
                    <td><input type="text"   name="TOTALTAX[]" id="TOTALTAX_0" class="form-control" onkeyup="getWatnTaxDetails(this.id,this.value)" autocomplete="off" readonly style="width: 120px"/></td>
                    <td><input type="text"   name="TAXAMT[]" id="TAXAMT_0" class="form-control" autocomplete="off"  style="width: 120px" readonly/></td>
                    <td><input type="text"   name="TOTALAMT[]" id="TOTALAMT_0" class="form-control" maxlength="200"  autocomplete="off" readonly style="width: 100px" /></td>
