            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(156,this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    ...
                                                    <td><input type="text" name="RATEPUOM_0" id="RATEPUOM_0" class="form-control five-digits" maxlength="13"  autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" style="width:130px;text-align:right;" /></td>
