            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                      ...
                      <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="SODT" id="SODT" value="{{ isset($objSO->SSI_DT)?$objSO->SSI_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
...
var objSSO = <?php echo json_encode($objSO); ?>;

$('#btnPdf').on('click', function() {
  var SONO = objSSO.SSIID;
  var Flag = 'P';
