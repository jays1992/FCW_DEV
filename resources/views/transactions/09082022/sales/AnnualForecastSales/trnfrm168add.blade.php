	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                <input type="text" name="AFSNO" id="AFSNO" value="{{ isset($objAFSNO)?$objAFSNO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @elseif($objSON->MANUAL_SR == "1")
                <input type="text" name="AFSNO" id="AFSNO" value="{{ old('AFSNO') }}" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase"  >
            @else
              <input type="text" name="AFSNO" id="AFSNO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @endif
			</div>
      ...
      <input type="hidden" name="ASFDT" id="ASFDT" class="form-control" autocomplete="off" />
            ...
            <input type="date" name="AFSDT" id="AFSDT" onchange="checkPeriodClosing(168,this.value,1)" value="{{ old('AFSDT') }}" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
