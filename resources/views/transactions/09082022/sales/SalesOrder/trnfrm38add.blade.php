    ...
    <div class="container-fluid purchase-order-view">
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                              <input type="text" name="SONO" id="SONO" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
                            @else
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(38,this.value,1)" value="{{ old('SODT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
              ...
              <tr  class="participantRow">
                  ...
                  <td {{$AlpsStatus['hidden']}} style=" width:4%;"><input type="text" name="Alpspartno_0" id="Alpspartno_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"/></td>
                  <td {{$AlpsStatus['hidden']}} style=" width:4%;"><input type="text" name="Custpartno_0" id="Custpartno_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"/></td>
                  <td {{$AlpsStatus['hidden']}} style=" width:4%;"><input type="text" name="OEMpartno_0" id="OEMpartno_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"/></td>
                  ...
                  <td><input type="text" name="RATEPUOM_0" id="RATEPUOM_0" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCal(this.id)" onfocusout="dataDec(this,'5')" /></td>
      ...
      if(customid!=''){
        ...
        $("#SHIPTO1").val('');
          ...
          $.ajax({
            ...
            $.ajax({
                  url:'{{route("transaction",[38,"getTDSApplicability"])}}',
                  type:'POST',
                  data:{'id':customid},
                  success:function(data) {
                  if(data == 1)
                  {
                    ...
                    $.ajax({
                      url:'{{route("transaction",[38,"getTDSDetails"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {                        
                      $("#tbody_tds").html('');
    ...
    //to check the label duplicacy
     $('#SONO').focusout(function(){
      ...
      if(SONO ===""){
        ...
        $.ajax({
            url:'{{route("transaction",[38,"checkso"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
               if(data.exists) {
...
//SO Date Check
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('transaction',[38,'add'])}}";
