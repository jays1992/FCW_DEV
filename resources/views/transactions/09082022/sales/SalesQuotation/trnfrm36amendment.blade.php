    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <button class="btn topnavbt" id="btnSaveSQ" ><i class="fa fa-floppy-o"></i> Save</button>                        
                        ...
                        <button class="btn topnavbt" id="btnApprove" disabled ><i class="fa fa-thumbs-o-up"></i> Approved</button>
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl"><p>SQA No *</p></div>
                          <div class="col-lg-2 pl">
                            <input type="hidden" name="SQID_REF" id="SQID_REF" value="{{ isset($objSQ->SQID)?$objSQ->SQID:'' }}" class="form-control" maxlength="15"  readonly >
                            <input type="text" name="SQANO" id="SQANO" value="{{ isset($MAXSQANO)?$MAXSQANO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" readonly >
                          </div>
                          
                          <div class="col-lg-2 pl"><p>SQA Date *</p></div>
                          <div class="col-lg-2 pl">
                              <input type="date" name="SQADT" id="SQADT" value="{{date('Y-m-d')}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                          </div>

                          <div class="col-lg-2 pl"><p>Reason to amend  SQ</p></div>
                          <div class="col-lg-2 pl">
                              <input type="text" name="REASONTOSQA" id="REASONTOSQA" value="{{ isset($objSQ->REASONTOSQA)?$objSQ->REASONTOSQA:'' }}" class="form-control mandatory" autocomplete="off" maxlength="200"  >
                          </div>

                        </div>

                        <div class="row">
                            <div class="col-lg-2 pl"><p>With Lead</p></div>
                            <div class="col-lg-2 pl">
                                <input type="radio" onclick='return false'  name="LEAD" id="WITH_LEAD" {{$objSQ->QUOTATTION_TYPE =="PROSPECT" || $objSQ->QUOTATTION_TYPE =="CUSTOMER" ? "checked":""}} value="WITH_LEAD" class="form-radio" >
                            </div>                            
                            
                            <div class="col-lg-2 pl"><p>Without Lead</p></div>
                            <div class="col-lg-2 pl">
                            <input type="radio" name="LEAD" onclick='return false' {{$objSQ->QUOTATTION_TYPE =="DIRECT" ? "checked":""}} id="WITHOUT_LEAD" value="WITHOUT_LEAD" class="form-radio" >
                            </div>
                            <div class="col-lg-2 pl "><p>Lead No</p></div>
                            <div class="col-lg-2 pl"  >
                            <input type="text" onclick='return false' name="Leadpopup" id="txtLeadpopup" value="{{ isset($objSQ->LEAD_NO)?$objSQ->LEAD_NO:'' }}"  class="form-control mandatory"    readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="SQNO" id="SQNO" value="{{ isset($objSQ->SQNO)?$objSQ->SQNO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Quotation Date *</p></div>
                            <div class="col-lg-2 pl">
                                <input type="hidden" id="LASTSQDT" value="{{ isset($objSQ->SQDT)?$objSQ->SQDT:'' }}">
                                <input type="date" name="SQDT" id="SQDT" onchange="checkPeriodClosing(36,this.value,1)"  value="{{ isset($objSQ->SQDT)?$objSQ->SQDT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
                            </div>


                            <div class="col-lg-2 pl"><p id="customer_prospect"> {{$objSQ->QUOTATTION_TYPE =="PROSPECT" ? "Prospect *":"Customer *"}}</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" disabled name="SubGl_popup" id="txtgl_popup" value="{{$objSQ->QUOTATTION_TYPE =="PROSPECT" ?   $objSQ->PCODE. '-'.$objSQ->NAME: $objsubglcode->SGLCODE .'-'.$objsubglcode->SLNAME }}" class="form-control mandatory"  autocomplete="off" readonly/>
                        ...
                        <div class="row">                               
                            ...
                            <div class="col-lg-2 pl"  >
                            <input type="text"    name="Dealerpopup" id="txtDealerpopup" class="form-control mandatory"  autocomplete="off" value="{{ isset($objSQ->CUSTOMER_NAME)?$objSQ->CUSTOMER_NAME:'' }}"  readonly/>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text"  value="{{ isset($objSQ->DEALER_COMMISSION_AMT)?$objSQ->DEALER_COMMISSION_AMT:'' }}"  name="DEALER_COMMISSION_AMT" id="DEALER_COMMISSION_AMT" readonly autocomplete="off" class="form-control" maxlength="100"  />
                            </div>
                            <div class="col-lg-2 pl "><p>Project</p></div>
                            <div class="col-lg-2 pl"  >
                            <input type="text"  value="{{ isset($objSQ->PROJECT_NAME)?$objSQ->PROJECT_NAME:'' }}"  name="Projectpopup" id="txtProjectpopup" class="form-control mandatory"  autocomplete="off"  readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input disabled type="checkbox" name="FC" id="FC" class="form-checkbox" {{  isset($objSQ->FC) && $objSQ->FC == 1 ? 'checked' : ''}} >
                            </div>
                            
                            <div class="col-lg-2 pl "><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                @if($objSQcurrency)
                                <input disabled type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="{{ $objSQcurrency }}"   />
                                @else
                            ...
                            <div class="col-lg-2 pl">
                                <input disabled type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="{{ isset($objSQ->CONVFACT)?$objSQ->CONVFACT:'' }}" {{ isset($objSQ->FC) && $objSQ->FC == 1 ? 'readonly' : 'disabled'}} />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="QVFDT" id="QVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="{{ isset($objSQ->QVFDT)?$objSQ->QVFDT:'' }}" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Quotation Validity To </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="QVTDT" id="QVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="{{ isset($objSQ->QVTDT)?$objSQ->QVTDT:'' }}" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="{{ isset($objSQ->REFNO)?$objSQ->REFNO:'' }}" autocomplete="off" style="text-transform:uppercase">
                            </div>
                            <div class="col-lg-2 pl"><p>Bill To </p></div>
                            <div class="col-lg-2 pl" id="div_billto">
                                <input disabled type="text"  name="txtBILLTO" id="txtBILLTO" class="form-control"  autocomplete="off" value="{{isset($objBillAddress[0])?$objBillAddress[0]:''}}"   />
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input disabled type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="{{isset($objBillAddress[0])?$objBillAddress[0]:''}}" readonly  />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="{{ isset($objSQ->REMARKS)?$objSQ->REMARKS:'' }}"  >
                            </div>
                            <div class="col-lg-2 pl"><p>Direct Quotation </p></div>
                            <div class="col-lg-2 pl">
                                  <input  type="checkbox" name="DirectSQ" id="DirectSQ" class="form-checkbox"  disabled/>
                            </div>
                                            ...
                                            @if(!empty($objSQMAT))
                                                @foreach($objSQMAT as $key => $row)
                                                    <tr  class="participantRow">
                                                        ...
                                                        <input style="width:100px;" type="text" name={{"txtSE_popup_".$key}} id={{"txtSE_popup_".$key}} class="form-control"   autocomplete="off" value="{{$row->ENQNO}}"   readonly/></td>
                                                        ...
                                                        <td><input style="width:100px;" type="text" name={{"popupITEMID_".$key}} id={{"popupITEMID_".$key}} class="form-control" value="{{$row->ICODE}}" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input style="width:100px;" type="text" name={{"ItemName_".$key}} id={{"ItemName_".$key}} class="form-control"  autocomplete="off" value="{{$row->ItemName}}" readonly/></td>
                                                        <td><input type="text" name={{"SEMUOM_".$key}} id={{"SEMUOM_".$key}} class="form-control"  autocomplete="off" value="{{$row->SEMUOM}}" readonly/></td>
                                                        <td><input type="text" name={{"SEMUOMQTY_".$key}} id={{"SEMUOMQTY_".$key}} class="form-control" maxlength="13" value="{{$row->SEMUOMQTY}}" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name={{"SEAUOM_".$key}} id={{"SEAUOM_".$key}} class="form-control"  autocomplete="off"  value="{{$row->SEAUOM}}" readonly/></td>
                                                        <td><input type="text" name={{"SEAUOMQTY_".$key}} id={{"SEAUOMQTY_".$key}} class="form-control" maxlength="13" value="{{$row->SEAUOMQTY}}" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input type="text" name={{"SQ_QTY_".$key}} id={{"SQ_QTY_".$key}} class="form-control three-digits" maxlength="13" value="{{ $row->SQ_QTY }}"  autocomplete="off"  /></td>
                                                        ...
                                                        <td><input type="text" name={{"ALT_UOMID_QTY_".$key}} id={{"ALT_UOMID_QTY_".$key}} class="form-control three-digits" maxlength="13" value="{{$row->ALT_UOMID_QTY}}" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} class="form-control five-digits blurRate" maxlength="13" value="{{ $row->RATEPUOM }}"  autocomplete="off" /></td>
                                                        <td><input {{$AlpsStatus['disabled']}} type="text" name={{"DISCPER_".$key}} id={{"DISCPER_".$key}} class="form-control four-digits " maxlength="8" value="{{ $row->DISCPER }}"  autocomplete="off" style="width: 50px;" /></td>
                                                        <td><input {{$AlpsStatus['disabled']}} type="text" name={{"DISCOUNT_AMT_".$key}} id={{"DISCOUNT_AMT_".$key}} class="form-control two-digits" value="{{ $row->DISCOUNT_AMT }}" maxlength="15"  autocomplete="off"  /></td>
                                                        @php
                                                            $TaxAmt=number_format((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT),2, '.', '');
                                                        @endphp
                                                        <td><input type="text" name={{"DISAFTT_AMT_".$key}} id={{"DISAFTT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$TaxAmt}}" readonly/></td>
                                                        ...
                                                        @endphp
                                                        <td><input type="text" name={{"IGSTAMT_".$key}} id={{"IGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$IGSTAMT}}"  readonly/></td>
                                                        ...
                                                        @endphp
                                                        <td><input type="text" name={{"CGSTAMT_".$key}} id={{"CGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$CGSTAMT}}"  readonly/></td>
                                                        ...
                                                        @endphp
                                                        <td><input type="text" name={{"SGSTAMT_".$key}} id={{"SGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$SGSTAMT}}"  readonly/></td>
                                                        @php
                                                            $IGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->IGST)/100),2, '.', '');
                                                            $CGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->CGST)/100),2, '.', '');
                                                            $SGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->SGST)/100),2, '.', '');
                                                        ...
                                                        @endphp
                                                        <td><input type="text" name={{"TGST_AMT_".$key}} id={{"TGST_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$TOTGST}}"   readonly/></td>
                                                        @php
                                                            $TaxAmt=number_format((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT),2, '.', '');
                                                            $IGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->IGST)/100),2, '.', '');
                                                            $CGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->CGST)/100),2, '.', '');
                                                        ...
                                                        @endphp
                                                        <td><input type="text" name={{"TOT_AMT_".$key}} id={{"TOT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off" value="{{$TOTAMT}}" readonly/></td>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:500px;width:50%;">
                                        ...
                                        @if(!empty($objSQUDF))
                                            @foreach($objSQUDF as $Ukey => $Urow)
                                                <tr  class="participantRow4">
                                                    <td><input type="text" name={{"popupUDFSQID_".$Ukey}} id={{"popupUDFSQID_".$Ukey}}  class="form-control"  autocomplete="off"  readonly/></td>
                                        ...
                                        @else
                                            @foreach($objUdfSQData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  <td><input type="text" name={{"popupUDFSQID_".$uindex}} id={{"popupUDFSQID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
  ...
  function ShipToNameFunction() {
      ...
      function BindShipAddress(){
        $(".clsshipto").click(function(){
          var fieldid = $(this).attr('id');
          var txtval =    $("#txt"+fieldid+"").val();
          var texdesc =   $("#txt"+fieldid+"").data("desc2");
...
//------------------------
  ...
  $('#Material').on('click','[id*="popupITEMID"]',function(event){
        ...
        if(SalesEnquiryID!='' && QUOTATIONTYPE=="WITHOUT_LEAD"){
                $("#tbody_ItemID").html('');
                  $.ajaxSetup({
                      headers: {
                          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        else
        {
          ...
          if($("#DirectSQ").is(":checked") == true &&  QUOTATIONTYPE=="WITHOUT_LEAD") {
          ...
          else if(QUOTATIONTYPE=="WITHOUT_LEAD"){
        ...
        if(QUOTATIONTYPE=="WITH_LEAD")
        {
            ...
            if(LEADID_REF==''){ 
              ...
              $("#NoBtn").hide();
              $("#OkBtn1").show();
              $("#AlertMessage").text('Please Select Lead No First.');
              $("#alert").modal('show');
              $("#OkBtn1").focus();
              return false;
            }
            ...
            $.ajax({
                ...
                type:'POST',
                data:{'taxstate':taxstate,'CODE':CODE,'NAME':NAME,'MUOM':MUOM,'GROUP':GROUP,'CTGRY':CTGRY,'BUNIT':BUNIT,'APART':APART,'CPART':CPART,'OPART':OPART,'LEADID_REF':LEADID_REF},
                success:function(data) {
                  $('.js-selectall').prop("disabled", true);  
                  $("#tbody_ItemID").html(data);                   
                  bindItemEvents();  
  ...
  if(QUOTATIONTYPE=="PROSPECT"){
                ...
                $("#SHIPTO1").val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[36,"getShipTo"])}}',
                      type:'POST',
                      data:{'id':"",'type':"PROSPECT",'leadid_ref':$("#LEAD_REF").val()},
                      success:function(data) {                        
                        $("#div_shipto").html(data);
                        $("#txtSHIPTO").prop("disabled",true)
   ...
   //code code and more code
    ...
    $.each( soudf, function( soukey, souvalue ) {
        $.each( udfforso, function( usokey, usovalue ) { 
            if(souvalue.UDFSQID_REF == usovalue.UDFSQID)
            {
                $('#popupUDFSQID_'+soukey).val(usovalue.LABEL);
            }
            ...
            {        
                    ...
                    $('#'+dynamicid2).val(souvalue.SQUVALUE);
    ...
    $.each(SOCal, function( sockey, socvalue ) {
        ...
        if(taxstate =="OutofState")
            ...
            else
            {
              ...
              var tvalue = 0.00;
              tvalue = parseFloat(tvalue) + parseFloat(socvalue.VALUE);
              tvalue = parseFloat(parseFloat(tvalue) + parseFloat(totgst2)).toFixed(2);
            }
    ...
    $('#Material').on('focusout',"[id*='SQ_QTY']",function()
    {
        var totalvalue = 0.00;
        var itemid = $(this).parent().parent().find('[id*="ITEMID_REF"]').val();
        var mqty = $(this).val();
    ...
    {
        var mqty = $(this).parent().parent().find('[id*="SQ_QTY"]').val();
        var irate = $(this).val();
...
//SO Date Check
var lastsqdts = <?php echo json_encode($objlastSQDT[0]->SQDT); ?>;

var lastsqdt=moment(lastsqdts).format('MM/DD/YYYY');  


var today = new Date(); 
var sqdate =   ("0" + (today.getMonth() + 1)).slice(-2) + "/" +('0' + today.getDate()).slice(-2)  + "/" +  today.getFullYear()  ;
    ...
    var focustext12= "";
        ...
        if(jQuery.inArray("false", allblank) !== -1){
          $("#FocusId").val(focustext1);
            ...
            else if(checkPeriodClosing(36,$("#SQDT").val(),0) ==0){
                $("#YesBtn").hide();
                $("#NoBtn").hide();
                $("#OkBtn").hide();
                $("#OkBtn1").show();
...
$.ajax({
    url:'{{ route("transactionmodify",[36,"saveamendment"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
