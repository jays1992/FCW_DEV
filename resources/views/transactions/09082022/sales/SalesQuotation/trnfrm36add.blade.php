            ...
            <div class="container-fluid filter">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="radio" name="LEAD" id="WITH_LEAD" value="WITH_LEAD" class="form-radio" >
                            </div>                            
                            
                            <div class="col-lg-2 pl"><p>Without Lead</p></div>
                            <div class="col-lg-2 pl">
                            <input type="radio" name="LEAD" checked id="WITHOUT_LEAD" value="WITHOUT_LEAD" class="form-radio" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="LASTSQDT" value="{{ isset($objlastSQDT[0]->SQDT)?$objlastSQDT[0]->SQDT:'' }}">
                                <input type="date" name="SQDT" id="SQDT" onchange="checkPeriodClosing(36,this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                                             
                            <div class="col-lg-2 pl" ><p id="customer_prospect">Customer *</p></div>
                            <div class="col-lg-2 pl">
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    ...
                                                    <td><input type="text" name="SQ_QTY_0" id="SQ_QTY_0" class="form-control three-digits" maxlength="13"  autocomplete="off"  /></td>
                                                    ...
                                                    <td ><input type="text" name="RATEPUOM_0" class="form-control five-digits blurRate"       id="RATEPUOM_0" maxlength="13"   /></td>

                                                    <td><input {{$AlpsStatus['disabled']}} type="text" name="DISCPER_0" id="DISCPER_0" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width: 50px;" /></td>
                                                    <td><input {{$AlpsStatus['disabled']}} type="text" name="DISCOUNT_AMT_0" id="DISCOUNT_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
...
let Lead = "#LeadOrderTable2";
  ...
  $('#txtLeadpopup').on('click',function(event){   
            ...
            if(QUOTATIONTYPE != "WITH_LEAD")
            {
              $("#FocusId").val('WITH_LEAD');
              $("#ProceedBtn").focus();
              $("#YesBtn").hide();
              $("#NoBtn").hide();
              $("#OkBtn1").show();
              $("#AlertMessage").text('Please Select With Lead First.');
              $("#alert").modal('show');
              $("#OkBtn1").focus();
              return false;
