            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="SODT" id="SODT" value="{{ isset($objSO->SRDT)?$objSO->SRDT :''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
                                  ...
                                  <tr  class="participantRow">
                                    ...
                                    <td><input {{$InputStatus}} type="text" name="SO_QTY_{{$key}}" id="SO_QTY_{{$key}}" value="{{ $row->SRQTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  style="width:75px;"  /></td>
                                    ...
                                    <td><input {{$InputStatus}} type="text" name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{ $row->SRRATE }}"  class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:90%; height:90%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Sales Return Print</p></div>
        <div class="row">
...
$('#btnPdf').on('click', function() {
  var SONO = objSO.SRID;
  var Flag = 'P';
  var formData = 'SO='+ SONO + '&SRNO='+ SONO + '&Flag='+ Flag ;
  var consultURL = '{{route("transaction",[45,"ViewReport",":rcdId"]) }}';
...
$('#btnPrint').on('click', function() {
    ...
    $.ajax({
        url:'{{route("transaction",[45,"ViewReport"])}}',
        type:'POST',
        data:formData,
        success:function(data) {
            $('#ReportView').show();
