...
@section('content')
  ...
  <div class="container-fluid topnav">
    ...
    <div class="container-fluid purchase-order-view filter">     
      <form id="frm_mst_add" onsubmit="return validateForm(actionType)" method="POST"  class="needs-validation"> 
        @CSRF
      ...
      <div class="row">
        ...
        @else
          <input type="text" name="DOC_NO" id="DOC_NO" value="{{ old('DOC_NO') }}"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
        </div>
        <div class="col-lg-2 pl"><p>Doc Date*</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="DOC_DT" id="DOC_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory" >
        </div> 
          
        <div class="col-lg-2 pl"><p>From Date</p></div>
          <div class="col-lg-2 pl">
          <input type="date" name="FROM_DATE" id="FROM_DATE" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy">
        </div>
        </div>
        <div class="row">
          <div class="col-lg-2 pl"><p>To Date*</p></div>
          <div class="col-lg-2 pl">
          <input type="date" name="TO_DATE" id="TO_DATE" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy">                            
          </div>
        </div> 
              ...
              <table id="example1" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <tbody>
                  <tr  class="participantRow">
                    <td><input type="text" name="SALESINVOICENO[]"          id ="SALESINVOICENO_0"  onclick="getSaleInvNo(this.id,this.value)"  class="form-control mandatory"  autocomplete="off" readonly/></td>
                    <td hidden><input type="hidden" name="SALESINVID_REF[]" id="SALESINVID_REF_0"   class="form-control" autocomplete="off" /></td>
                    
                    <td><input type="date" name="SALESINVOICEDATE"          id="SALESINVOICEDATE_0" class="form-control" readonly></td>                    
                    <td><input type="text" name="CUSTOMERNAME[]"            id="CUSTOMERNAME_0"     class="form-control" readonly></td>
                    <td><input type="text" name="SALESINVOICEAMT[]"         id="SALESINVOICEAMT_0"  class="form-control" readonly></td>
                    
                    <td><input type="text" name="EMPLOYEENAME[]"            id="EMPLOYEENAME_0"     onclick="getEmplyName(this.id,this.value)" class="form-control mandatory" autocomplete="off" readonly></td>
                    <td hidden><input type="hidden" name="EMPID_REF[]"      id="EMPID_REF_0"        class="form-control" autocomplete="off" /></td>

                    <td><input type="text" name="BIFURCATEAMOUNT[]"         id="BIFURCATEAMOUNT_0"  class="form-control" onkeypress="return isNumberKey(this, event);"></td>
