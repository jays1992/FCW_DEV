    ...
    <div class="container-fluid purchase-order-view filter">     
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"><p>Doc Date*</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="DOC_DT" id="DOC_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($HRD->SALINVAL_DATE) && $HRD->SALINVAL_DATE !=''?$HRD->SALINVAL_DATE:''}}" class="form-control mandatory"  autocomplete="off" >
        </div> 
...
function submitData(type){
  var formResponseMst = $("#frm_mst_edit");
  if(formResponseMst.valid()){
    if(checkPeriodClosing('{{$FormId}}',$("#DOC_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
