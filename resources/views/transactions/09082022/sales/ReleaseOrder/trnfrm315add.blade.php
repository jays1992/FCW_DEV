    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <button class="btn topnavbt" id="btnSaveRO" ><i class="fa fa-floppy-o"></i> Save</button>
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            @if(isset($objRON->SYSTEM_GRSR) && $objRON->SYSTEM_GRSR == "1")
                                <input type="text" name="RONO" id="RONO" value="{{ isset($objRONO)?$objRONO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @elseif(isset($objRON->MANUAL_SR) && $objRON->MANUAL_SR == "1")
                                <input type="text" name="RONO" id="RONO"  class="form-control mandatory" maxlength="150" autocomplete="off" style="text-transform:uppercase" autofocus >
                            @else
                              <input type="text" name="RONO" id="RONO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @endif
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="RODT" id="RODT" onchange="checkPeriodClosing(315,this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="SONO_txt" id="SONO_txt" class="form-control mandatory" autocomplete="off" style="text-transform:uppercase" readonly/>
                                <input type="hidden" name="SOID_REF" id="SOID_REF" class="form-control mandatory" autocomplete="off"  />
                            </div>  
                            <div class="col-lg-2 pl"><p>Order Validity From </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVFRM_DT" id="OVFRM_DT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" readonly>
                            </div>                            
                            <div class="col-lg-2 pl"><p>Order Validity To </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVTOM_DT" id="OVTOM_DT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" readonly>
                            </div>                            
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="CUSTOMERPONO" id="CUSTOMERPONO" class="form-control" autocomplete="off" style="text-transform:uppercase" readonly>
                            </div>
                            <div class="col-lg-2 pl"><p>Customer PO Date </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="CUSTOMERDT" id="CUSTOMERDT" class="form-control " autocomplete="off" placeholder="dd/mm/yyyy" readonly />
                            </div>
                            <div class="col-lg-2 pl"><p>Foreign Currency</p></div>
                            <div class="col-lg-1 pl">
                                <input type="checkbox" name="FC" id="FC" class="form-checkbox" disabled/>
                                <input type="hidden" name="hdn_FC" id="hdn_FC" class="form-control mandatory" autocomplete="off"  />
                            </div> 
                        </div>                  
                        <div class="row">	
                            <div class="col-lg-2 pl"><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                <input type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"  readonly/>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="CONVERSION_FACT" id="CONVERSION_FACT" autocomplete="off" class="form-control" maxlength="100" readonly/>
                            </div>
                        ...
                        <div class="col-lg-2 pl "><p>Deliver Date</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="DELIVER_DATE" id="DELIVER_DATE"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist"  style="width:100%;height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                                <tr>
                                                    <th colspan="3"><input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1"></th>
                                        ...
                                        <table id="example6" class="display nowrap table table-striped table-bordered itemlist"  style="width:100%;height:auto !important;">
                                            ...
                                            <tbody id="tbody_spec">
                                                <tr  class="participantRow6">
                                                    <td><input type="text" name="IITEMID_REF_0" id="IITEMID_REF_0" class="form-control" autocomplete="off" /></td>
                                                    <td><input type="text" name="ISEID_REF_0" id="ISEID_REF_0" class="form-control" autocomplete="off" /></td>
                                                    <td><input type="text" name="ISQID_REF_0" id="ISQID_REF_0" class="form-control" autocomplete="off" /></td>
                                                    <td><input type="text" name="ISOID_REF_0" id="ISOID_REF_0" class="form-control" autocomplete="off" /></td>
...
let udftid = "#UDFROIDTable2";
      let udftid2 = "#UDFROIDTable";
      ...
      function UDFROIDCodeFunction() {
        var input, filter, table, tr, td, i, txtValue;
        input = document.getElementById("UDFROIDcodesearch");
        filter = input.value.toUpperCase();
        table = document.getElementById("UDFROIDTable2");
  ...
  function UDFROIDNameFunction() {
        var input, filter, table, tr, td, i, txtValue;
        input = document.getElementById("UDFROIDnamesearch");
        filter = input.value.toUpperCase();
        table = document.getElementById("UDFROIDTable2");
        tr = table.getElementsByTagName("tr");
        for (i = 0; i < tr.length; i++) {
...
$("#udfroid_closePopup").on("click",function(event){ 
     $("#udfroidpopup").hide();
});

$('.clsudfroid').dblclick(function(){
        ...
        var txtcol = $('#hdn_UDFROID').val();
        $("#"+txtcol).val(txtname);
        $("#"+txtcol).parent().parent().find("[id*='UDFROID_REF']").val(txtid);
        ...
        $("#udfroidpopup").hide();
        $("#UDFROIDcodesearch").val(''); 
        $("#UDFROIDnamesearch").val(''); 
...
var lastenqdt = <?php echo json_encode($lastdt[0]->RODT); ?>;
var today = new Date(); 
var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2) ;
$('#RODT').attr('min',lastenqdt);
$('#RODT').attr('max',sodate);




  $("#btnSaveRO").on("submit", function( event ) {
    if ($("#frm_trn_ro").valid()) {
        // Do something
...
$("#btnSaveRO" ).click(function() {
    var formReqData = $("#frm_trn_ro");
...
$.ajax({
    url:'{{ route("transaction",[315,"save"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
