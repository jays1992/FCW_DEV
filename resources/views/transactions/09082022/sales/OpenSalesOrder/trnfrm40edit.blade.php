...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_oso"  method="POST">   
            @csrf
            {{isset($objOSO->OSOID[0]) ? method_field('PUT') : '' }}
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="text" name="OSONO" id="OSONO" value="{{ isset($objOSO->OSONO)?$objOSO->OSONO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" readonly >
                            ...
                            <div class="col-lg-2 pl"><p>SO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="OSODT" id="OSODT" onchange="checkPeriodClosing(40,this.value,1)" value="{{ isset($objOSO->OSODT)?$objOSO->OSODT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off"  value="{{ isset($objOSO->SLID_REF)?$objOSO->SLID_REF:'' }}"/>
                                <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" value="{{ isset($objOSO->GLID_REF)?$objOSO->GLID_REF:'' }}" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="{{ isset($objOSO->OVFDT)?$objOSO->OVFDT:'' }}" >
                            </div>                            
                            <div class="col-lg-2 pl"><p>To </p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="{{ isset($objOSO->OVTDT)?$objOSO->OVTDT:'' }}" >
                            </div>
                            <div class="col-lg-2 pl"><p>Customer PO No*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="text" name="CUSTOMERPONO" id="CUSTOMERPONO" value="{{ isset($objOSO->CUSTOMERPONO)?$objOSO->CUSTOMERPONO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  >
                            </div>                            
                        </div>                        
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Customer PO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="CUSTOMERPODT" id="CUSTOMERPODT" value="{{ isset($objOSO->CUSTOMERPODT)?$objOSO->CUSTOMERPODT:'' }}"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="hidden" name="SPID_REF" id="SPID_REF" class="form-control" autocomplete="off" value="{{ isset($objOSO->SPID_REF)?$objOSO->SPID_REF:'' }}" />
                            </div>
                            <div class="col-lg-2 pl"><p>Ref No </p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="{{ isset($objOSO->REFNO)?$objOSO->REFNO:'' }}" autocomplete="off" style="text-transform:uppercase">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="checkbox" name="OSOFC" id="OSOFC" class="form-checkbox" {{isset($objOSO->OSOFC) && $objOSO->OSOFC == 1 ? 'checked' : ''}} >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                @if ($objOSOcurrency)
                                <input {{$InputStatus}} type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="{{ isset($objOSOcurrency)?$objOSOcurrency:'' }}"   />
                                @else
                                <input {{$InputStatus}} type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
                                @endif
                                <input type="hidden" name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="{{ isset($objOSO->CRID_REF)?$objOSO->CRID_REF:'' }}" />
                            </div>
                            <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
                            <div class="col-lg-2 pl">
                                @if ($objOSOcurrency)
                                <input {{$InputStatus}} type="text" name="CONVFACT" id="CONVFACT" class="form-control"  autocomplete="off" value="{{ isset($objOSO->CONVFACT)?$objOSO->CONVFACT:'' }}"   />
                                @else
                                <input type="text" name="CONVFACT" id="CONVFACT" class="form-control"  autocomplete="off"   disabled/>
                                @endif
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4 pl">
                                <input {{$InputStatus}} type="text" name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="{{ isset($objOSO->REMARKS)?$objOSO->REMARKS:'' }}"  >
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
                                    <div class="table-responsive table-wrapper-scroll-y" style="height:280px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                            @if(!empty($objOSOMAT))
                                                @foreach($objOSOMAT as $key => $row)
                                                    <tr  class="participantRow">
                                                        <td hidden>
                                                        <input {{$InputStatus}}  class="form-control" type="hidden" name={{"OSOMATID_".$key}} id ={{"OSOMATID_".$key}} maxlength="100" value="{{ $row->OSOMATID }}" autocomplete="off"   >
                                                        </td>
                                                        ...
                                                        <td><input  {{$InputStatus}} type="text" name={{"popupUOM_".$key}} id={{"popupUOM_".$key}} class="form-control"  autocomplete="off" value="{{ $row->popupUOM }}" readonly/></td>
                                                        <td hidden><input type="hidden" name={{"UOMID_REF_".$key}} id={{"UOMID_REF_".$key}} class="form-control" value="{{ $row->UOMID_REF }}" autocomplete="off" /></td>
                                                        <td><input {{$InputStatus}} type="text" name={{"ITEMSPECI_".$key}} id={{"ITEMSPECI_".$key}} class="form-control" maxlength="200"  autocomplete="off"  value="{{ $row->ITEMSPECI }}"/></td>
                                                        <td><input {{$InputStatus}} type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->RATEPUOM }}"  autocomplete="off" /></td>
                                                        <td><input {{$InputStatus}} type="text" name={{"RMK_".$key}} id={{"RMK_".$key}} class="form-control" maxlength="200" autocomplete="off"  value="{{ $row->REMARKS }}"/></td>
                                                        <td align="center">
                                ...
                                <div id="TC" class="tab-pane fade">
                                    ...
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        @if(!empty($objOSOTNC))
                                         <input type="hidden" name="TNCID_REF" id="TNCID_REF" class="form-control" value="{{$objOSOTNC[0]->TNCID_REF}}" autocomplete="off" />
                                         @else
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:240px;width:50%;">
                                        ...
                                        <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody id="tncbody">
                                            @if(!empty($objOSOTNC))
                                                @foreach($objOSOTNC as $Tkey => $Trow)
                                ...
                                <div id="udf" class="tab-pane fade">
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody>
                                        @if(!empty($objOSOUDF))
                                            @foreach($objOSOUDF as $Ukey => $Urow)
                                                <tr  class="participantRow4">
                                                    <td><input {{$InputStatus}} type="text" name={{"popupUDFID_".$Ukey}} id={{"popupUDFID_".$Ukey}}  class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name={{"UDFID_REF_".$Ukey}}  id={{"UDFID_REF_".$Ukey}} class="form-control" value="{{$Urow->SOUDFID_REF}}" autocomplete="off" /></td>
                                            ...
                                            @foreach($objUdfOSOData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  <td><input {{$InputStatus}} type="text" name={{"popupUDFID_".$uindex}} id={{"popupUDFID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
...
var lastdt = <?php echo json_encode($objlastOSODT[0]->OSODT); ?>;
  var oso = <?php echo json_encode($objOSO); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < oso.OSODT)
  {
	$('#OSODT').attr('min',lastdt);
  }
  else
  {
	  $('#OSODT').attr('min',oso.OSODT);
  }
  $('#OSODT').attr('max',sodate);
    ...
    var objtnc = <?php echo json_encode($objOSOTNC); ?>;
    ...
    var objOSO = <?php echo json_encode($objOSO); ?>;

    if(objOSO.CUSTOMERPONO != null)
    {
      $('#CUSTOMERPODT').val(objOSO.CUSTOMERPODT);
    ...
    $.each( soudf, function( soukey, souvalue ) {
        $.each( udfforso, function( usokey, usovalue ) { 
            ...
            {
                $('#popupUDFID_'+soukey).val(usovalue.LABEL);
            }
            ...
            {        
                    ...
                    $('#'+dynamicid2).val(souvalue.OSOUVALUE);
...
var objhdr = <?php echo json_encode($objOSO); ?>;
//SO Date Check
// $('#OSODT').change(function( event ) {
//             var today = new Date(objhdr.OSODT);     
...
//                 $(this).val(osodate);
//                 $("#alert").modal('show');
//                 $("#AlertMessage").text('OSO Date cannot be less than '+ objhdr.OSODT);
//                 $("#YesBtn").hide(); 
//                 $("#NoBtn").hide();  
//                 $("#OkBtn1").show();
//                 $("#OkBtn1").focus();
...
$( "#btnSaveOSO" ).click(function() {
  var formSalesOrder = $("#frm_trn_oso");
    ...
    var focustext12= "";
        ...
        if(jQuery.inArray("false", allblank) !== -1){
          ...
          $("#FocusId").val(focustext1);
            ...
            else if(checkPeriodClosing(40,$("#OSODT").val(),0) ==0){
              $("#YesBtn").hide();
              $("#NoBtn").hide();
              $("#OkBtn").hide();
              $("#OkBtn1").show();
...
var attachcount    =   $.trim($("#hdnattachment").val());
    ...
    if(attachcount ==="0"){
        ...
        $("#NoBtn").hide();
        $("#OkBtn1").show();
        $("#AlertMessage").text('Please attach the Customer Document before approve the Open Sales Order.');
        $("#alert").modal('show');
        $("#OkBtn1").focus();
        return false;
    }
...
$.ajax({
    url:'{{ route("transactionmodify",[40,"update"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
...
$("#btnSaveOSO").prop("disabled", true);
$.ajax({
    url:'{{ route("transactionmodify",[40,"Approve"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
      $(".buttonload_approve").hide();  
      $("#btnSaveOSO").prop("disabled", false);
