            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="OSODT" id="OSODT" onchange="checkPeriodClosing(40,this.value,1)" value="{{ old('OSODT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
