...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Sales Challan (SC)</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            @if(isset($objSCN->SYSTEM_GRSR) && $objSCN->SYSTEM_GRSR == "1")
                                <input type="text" name="SCNO" id="SCNO" value="{{ isset($objSCNO)?$objSCNO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @elseif(isset($objSCN->MANUAL_SR) && $objSCN->MANUAL_SR == "1")
                                <input type="text" name="SCNO" id="SCNO"  class="form-control mandatory" maxlength="{{ isset($objSCN->MANUAL_MAXLENGTH)?$objSCN->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase" autofocus >
                            @else
                              <input type="text" name="SCNO" id="SCNO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            @endif
                            </div>
                            <div class="col-lg-2 pl"><p>Sales Challan Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="SCDT" id="SCDT" onchange="checkPeriodClosing(43,this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                           
                                        ...
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            @foreach($objUdfSCData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  <td><input type="text" name={{"popupUDFSCID_".$uindex}} id={{"popupUDFSCID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
    ...
    //to check the label duplicacy
     $('#SCNO').focusout(function(){
      ...
      if(SCNO ===""){
        ...
        $.ajax({
            url:'{{route("transaction",[$FormId,"checksc"])}}',
            type:'POST',
            data:formData,
            success:function(data) {
               if(data.exists) {
