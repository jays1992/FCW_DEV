            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="SCDT" id="SCDT" onchange="checkPeriodClosing(43,this.value,1)" value="{{ isset($objSC->SCDT)?$objSC->SCDT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                           
