...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[35,'index'])}}" class="btn singlebt">Sales Enquiry</a>
                </div><!--col-2-->
	...
	<div class="inner-form">
		<div class="row">
            ...
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                <input type="text" name="ENQNO" id="ENQNO" value="{{ isset($objENQNO)?$objENQNO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
              <input type="text" name="ENQNO" id="ENQNO"  class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
            @else
              <input type="text" name="ENQNO" id="ENQNO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @endif
			</div>
			<div class="col-lg-2 pl"><p>Sales Enquiry Date *</p></div>
			<div class="col-lg-2 pl">
				    <input type="date" name="ENQDT" id="ENQDT" onchange="checkPeriodClosing(35,this.value,1)" value="{{ old('ENQDT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>			
		...
		<div class="row">
			...
			<div class="col-lg-2 pl">
                <input type="text" name="EMID_popup" id="EMID_popup" class="form-control mandatory"  autocomplete="off" readonly/>
                <input type="hidden" name="EMID_REF" id="EMID_REF" class="form-control" autocomplete="off" />
			</div>
			
			<div class="col-lg-2 pl"><p>Enquired By *</p></div>
			<div class="col-lg-2 pl">
				<input type="text" name="ENQBY" id="ENQBY" class="form-control mandatory" maxlength="100" autocomplete="off"  >
			</div>
			
			<div class="col-lg-2 pl"><p>Priority *</p></div>
			<div class="col-lg-2 pl">
                <input type="text" name="PRIORITYID_popup" id="PRIORITYID_popup" class="form-control mandatory"  autocomplete="off" readonly/>
		...
		<div class="row">			
			...
			<div class="col-lg-2 pl">
				<input type="text" name="PROSPECTREFNO" id="PROSPECTREFNO" class="form-control" autocomplete="off" maxlength="20" >
			</div>			
			<div class="col-lg-2 pl"><p>Convertion Probability</p></div>
			<div class="col-lg-2 pl">
				<input type="text" name="CONV_PROLTY" id="CONV_PROLTY" class="form-control four-digits" autocomplete="off"  maxlength="8" >
			</div>
    </div>
		<div class="row">	
			<div class="col-lg-2 pl"><p>Approx Value</p></div>
			<div class="col-lg-2 pl">
				<input type="text" name="APPROXV" id="APPROXV" class="form-control two-digits" autocomplete="off"  maxlength="15"  >
			</div>
		...
		<div class="row">
          ...
          <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
                  ...
                  <th {{$AlpsStatus['hidden']}} >{{isset($TabSetting->FIELD10) && $TabSetting->FIELD10 !=''?$TabSetting->FIELD10:'Add. Info OEM Part No.'}}</th>
                          ...
                          <td><input  name="TARGETPRICE_0" id="TARGETPRICE_0" type="text" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
                          <td><input type="text" name="PACKSIZE_0" id="PACKSIZE_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td hidden><input type="hidden" name="PTID_REF_0" id="PTID_REF_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td><input type="text" name="PACKUOM_0" id="PACKUOM_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td hidden><input type="text" name="PACKUOMID_REF_0" id="PACKUOMID_REF_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td><input type="text" name="PACK_QTY_0" id="PACK_QTY_0" class="form-control three-digits"  autocomplete="off" readonly /></td>
				...
				<div id="udf" class="tab-pane fade">
					<div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:500px;width:50%;">
						<table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
							...
							<tbody>
              @foreach($objUdfSEData as $uindex=>$uRow)
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name={{"SEID_REF_".$uindex}} id={{"SEID_REF_".$uindex}} class="form-control" value="{{$uRow->UDFSEID}}" autocomplete="off"   /></td>
...
<div id="emidpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md" style="width:60%">
    ...
    <th style="text-align:center; width:10%;">&#10004;</th>
    <td style="width:30%;">
    <input type="text" id="emcodesearch" class="form-control" onkeyup="EMCodeFunction()">
    </td>
    <td style="width:60%;">
    <input type="text" id="emnamesearch" class="form-control" onkeyup="EMNameFunction()">
    </td>
    </tr>
    </tbody>
    </table>
      <table id="EMCodeTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        @foreach ($objenquirymedia as $emindex=>$emRow)
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="enquirymedia[]" id="emidcode_{{ $emindex }}" class="clsemid" value="{{ $emRow-> EMID }}" ></td>


 
          <td style="width:30%">{{ $emRow-> EMCODE }}
          <input type="hidden" id="txtemidcode_{{ $emindex }}" data-desc="{{ $emRow-> EMCODE }}-{{ $emRow-> DESCRIPTIONS }}"  value="{{ $emRow-> EMID }}"/>
          </td>
          <td style="width:60%">{{ $emRow-> DESCRIPTIONS }}</td>
        </tr>
        @endforeach
        </tbody>
      </table>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="Prioritynamesearch" class="form-control" onkeyup="PriorityNameFunction()">
      ...
      <table id="PriorityTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <td style="text-align:center; width:10%"> <input type="checkbox" name="prioritycheck[]" id="pridcode_{{ $prindex }}" class="clsprid"  value="{{ $prRow-> PRIORITYID }}" ></td>

 
          <td style="width:30%">{{ $prRow-> PRIORITYCODE }}
          <input type="hidden" id="txtpridcode_{{ $prindex }}" data-desc="{{ $prRow-> PRIORITYCODE }}-{{ $prRow-> DESCRIPTIONS }}"  value="{{ $prRow-> PRIORITYID }}"/>
          </td>
          <td style="width:60%">{{ $prRow-> DESCRIPTIONS }}</td>
        </tr>
        @endforeach
        </tbody>
      </table>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="Packagingnamesearch" class="form-control" autocomplete="off" onkeyup="PackagingNameFunction()">
      ...
      <table id="PackagingTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tbody>
        @foreach ($objPackingType as $ptindex=>$ptRow)
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="packingtype[]" id="ptidcode_{{ $ptindex }}" class="clsptid" value="{{ $ptRow-> PTID }}" ></td>



          <td style="width:30%">{{ $ptRow-> PTCODE }}
          <input type="hidden" id="txtptidcode_{{ $ptindex }}" data-desc="{{ $ptRow-> PTCODE }} - {{$ptRow-> PTNAME}}"  value="{{ $ptRow-> PTID }}"/>
          </td>
          <td style="width:60%">{{ $ptRow-> PTNAME }}</td>
        </tr>
        @endforeach
        </tbody>
      </table>
  ...
  $('#Material').on('click','[id*="popupAUOM"]',function(event){
        ...
        if(ItemID !=''){
                $("#tbody_altuom").html('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[35,"getAltUOM"])}}',
                      type:'POST',
      ...
      $(".clsaltuom").click(function(){
        ...
        if(altuomid!=''){
              $('#'+txt_id4).val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[35,"getaltuomqty"])}}',
                      type:'POST',
...
$('#btnAdd').on('click', function() {
  var viewURL = '{{route("transaction",[35,"add"])}}';
...
$('#Material').on('change','[id*="PTID_REF"]',function() {
  if($(this).val()=='')
  {
    $(this).parent().parent().find('[id*="PACKUOM"]').prop('disabled',true);
    $(this).parent().parent().find('[id*="PACK_QTY"]').prop('disabled',true);
  }
  else
  {
    $(this).parent().parent().find('[id*="PACKUOM"]').removeAttr('disabled');
    $(this).parent().parent().find('[id*="PACK_QTY"]').removeAttr('disabled');
  }
});
//delete row
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "{{route('transaction',[35,'add'])}}";
}//fnUndoYes
 ...
 if(ENQNO ===""){
    ...
    var focustext12= "";
        ...
        if(jQuery.inArray("false", allblank) !== -1){
          ...
          else if(checkPeriodClosing(35,$("#ENQDT").val(),0) ==0){
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '{{route("transaction",[35,"index"]) }}';
});
