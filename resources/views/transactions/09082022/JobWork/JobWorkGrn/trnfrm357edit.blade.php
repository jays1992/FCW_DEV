    ...
    <div class="container-fluid filter">
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="GRNDT" id="GRNDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ $objMstResponse->GRNDT }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
