...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
    <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Job Work GRN</a>
    </div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            @if($objSON->SYSTEM_GRSR == "1")
              <input type="text" name="GRNNO" id="GRNNO" value="{{ $objAutoGenNo }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              @endif
            @if($objSON->MANUAL_SR == "1")
              <input type="text" name="GRNNO" id="GRNNO" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
          </div>
            
          <div class="col-lg-2 pl"><p>GRN Date</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="GRNDT" id="GRNDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>

          <div class="col-lg-2 pl"><p>GE No</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="TEXT_GEJWOID_REF_DATA" id="TEXT_GEJWOID_REF_DATA" class="form-control mandatory"  autocomplete="off" readonly/>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="VENDOR_CHALLAN_NO" id="VENDOR_CHALLAN_NO" class="form-control"  autocomplete="off" readonly  />
          </div>

          <div class="col-lg-2 pl"><p>Vendor Bill No</p></div>
          <div class="col-lg-2 pl">
              <input type="text" name="VENDOR_BILL_NO" id="VENDOR_BILL_NO" class="form-control"  autocomplete="off" readonly  />
          </div>
                    ...
                    <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                      ...
                      <tbody>
                        <tr  class="participantRow">
                          ...
                          <td><input type="text" name="txtJWCID_popup_0"   id="txtJWCID_popup_0" class="form-control" autocomplete="off" readonly style="width:130px;" /></td>
                          ...
                          <td><input type="text"   name="VENDOR_BATCHNO_0" id="VENDOR_BATCHNO_0" class="form-control"   autocomplete="off" style="width:130px;"   /></td>
                          <td><input type="text"   name="OURLOT_NO_0" id="OURLOT_NO_0" class="form-control"   autocomplete="off" style="width:130px;"   /></td>
                          ...
                          <td><input type="text"   name="PD_OR_QTY_0" id="PD_OR_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  onKeyup="get_materital_item()" readonly style="width:130px;text-align:right;"  /></td>
                          <td><input type="text"   name="BL_SOQTY_0" id="BL_SOQTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly style="width:130px;text-align:right;"   /></td>
                          <td ><input type="text"   name="ITEMRATE_0" id="ITEMRATE_0" class="form-control five-digits" value="0.00000" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"   /></td>
                          <td ><input type="text"   name="ITEMAMT_0" id="ITEMAMT_0" class="form-control two-digits"   value="0.00" readonly maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"   /></td>
                          <td><input type="text"   name="STORE_NAME_0" id="STORE_NAME_0" class="form-control"   autocomplete="off" style="width:200px;" readonly /></td>
                          <td ><input type="text"   name="JWRATE_0" id="JWRATE_0" class="form-control five-digits" value="0.00000" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"   /></td>
                          <td ><input type="text"   name="JWAMT_0" id="JWAMT_0" class="form-control two-digits"   value="0.00" readonly maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                          <td><input type="text"   name="REMARKS_0" id="REMARKS_0" class="form-control"   autocomplete="off" style="width:130px;"   /></td>
                          <td ><input type="text"   name="TOT_AMT_0" id="TOT_AMT_0" class="form-control three-digits"   value="0.00" readonly maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                        
                          <td hidden><input type="text"   name="MAINTROWID_0" id="MAINTROWID_0" class="form-control " style="width:130px;"  /></td>
...
function validateForm(){
  ...
  if(GRNNO ===""){
    ...
    $('#Material').find('.participantRow').each(function(){
      ...
      // else if(parseFloat($.trim($(this).find("[id*=PD_OR_QTY]").val())) > parseFloat($.trim($(this).find("[id*=QTY]").val())*25/100+$(this).find("[id*=QTY]").val())  && checkCompany !='' ){
      //   allblank6.push('false');
      //   focustext6 = $(this).find("[id*=PD_OR_QTY]").attr('id');
      //   return false;
      // }
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#GRNDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
function getStoreDetails(ROW_ID){
  ...
  $.ajax({
      ...
      type:'POST',
      data:{ITEMID_REF:ITEMID_REF,ROW_ID:ROW_ID,ITEMROWID:ITEMROWID,ACTION_TYPE:'ADD',UOMID_REF:UOMID_REF,CHALLAN_QTY:CHALLAN_QTY},
      success:function(data) {
