...
<form id="frm_trn_add" method="POST" >
  ...
  <div class="container-fluid purchase-order-view">@csrf
      ...
      <div class="inner-form" id="Header_Form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            ...
            <input type="text" name="JWRNO" id="JWRNO" value="{{ $objSONO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            @endif

            @if($objSON->MANUAL_SR == "1")
            <input type="text" name="JWRNO" id="JWRNO"  class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
          </div>
                              
          <div class="col-lg-2 pl"><p>JWR Date</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="JWRDT" id="JWRDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
