	  ...
	  <div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                  <input type="text" name="GE_NO" id="GE_NO" value="{{ $objDataNo }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
              @endif

              @if(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                  <input type="text" name="GE_NO" id="GE_NO" value="{{ old('GE_NO') }}" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
              @endif
        ...
        <div class="col-lg-2 pl">
              <input type="date" name="GE_DT" id="GE_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('GE_DT') }}" class="form-control mandatory" autocomplete="off" >
        </div>
