...
<form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >
  @csrf
  {{isset($objResponse->GEJWOID[0]) ? method_field('PUT') : '' }}  
  <div class="container-fluid filter">
	  <div class="inner-form">
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="GE_NO" id="GE_NO" value="{{isset($objResponse->GENO) && $objResponse->GENO !=''?$objResponse->GENO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
        </div>
			
        <div class="col-lg-2 pl"><p>GE Date</p></div>
        <div class="col-lg-2 pl">
              <input type="date" name="GE_DT" id="GE_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($objResponse->GEDT) && $objResponse->GEDT !=''?$objResponse->GEDT:''}}" class="form-control mandatory" autocomplete="off" >
        </div>

        <div class="col-lg-2 pl"><p>GE Time</p></div>
        <div class="col-lg-2 pl">
              <input type="time" name="GE_TM" id="GE_TM" value="{{isset($objResponse->GETM) && $objResponse->GETM !=''?date('H:i:s',strtotime($objResponse->GETM)):''}}" class="form-control mandatory"  autocomplete="off"  >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="SECURITY_SUP" id="SECURITY_SUP" value="{{isset($objResponse->SEC_SUPERVISOR) && $objResponse->SEC_SUPERVISOR !=''?$objResponse->SEC_SUPERVISOR:''}}" maxlength="100" class="form-control" autocomplete="off"   >
        </div>

        <div class="col-lg-2 pl"><p>Security Guard</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="SECURITY_GUARD" id="SECURITY_GUARD" value="{{isset($objResponse->SEC_GUARD) && $objResponse->SEC_GUARD !=''?$objResponse->SEC_GUARD:''}}" maxlength="100" class="form-control" autocomplete="off"   >
        </div>

        <div class="col-lg-2 pl"><p>Vendor Name</p></div>
        <div class="col-lg-2 pl">
          <input type="text"    name="VID_REF_Details" id="VID_REF_Details" value="{{isset($objVendorName->VCODE) && $objVendorName->VCODE !=''?$objVendorName->VCODE.' - '.$objVendorName->NAME:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="JWO_NO_Details" id="JWO_NO_Details" value="{{isset($objJwoName) && $objJwoName!=''?$objJwoName:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="JWO_NO" id="JWO_NO" value="{{isset($objResponse->JWOID_REF) && $objResponse->JWOID_REF !=''?$objResponse->JWOID_REF:''}}" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Vendor Bill No</p></div>
        <div class="col-lg-2 pl">
              <input type="text" name="VENDOR_BILLNO" id="VENDOR_BILLNO" onkeyup="deleteDate('VENDOR_BILLDT',this.value);" value="{{isset($objResponse->VENDOR_BILLNO) && $objResponse->VENDOR_BILLNO !=''?$objResponse->VENDOR_BILLNO:''}}" maxlength="20"  class="form-control" autocomplete="off"   >
        </div>

        <div class="col-lg-2 pl"><p>Bill Date</p></div>
        <div class="col-lg-2 pl">
            <input type="date" name="VENDOR_BILLDT" id="VENDOR_BILLDT" value="{{isset($objResponse->VENDOR_BILLDT) && $objResponse->VENDOR_BILLDT !=''?$objResponse->VENDOR_BILLDT:''}}"  class="form-control" autocomplete="off"   >
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl"><p>Vendor Challan No</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="VENDOR_CHNO" id="VENDOR_CHNO" onkeyup="deleteDate('VENDOR_CHDT',this.value);" value="{{isset($objResponse->VENDOR_CHALLANNO) && $objResponse->VENDOR_CHALLANNO !=''?$objResponse->VENDOR_CHALLANNO:''}}" maxlength="20"  class="form-control" autocomplete="off"   >
        </div>

      <div class="col-lg-2 pl"><p>Challan Date</p></div>
			<div class="col-lg-2 pl">
				<input type="date" name="VENDOR_CHDT" id="VENDOR_CHDT" value="{{isset($objResponse->VENDOR_CHALLANDT) && $objResponse->VENDOR_CHALLANDT !=''?$objResponse->VENDOR_CHALLANDT:''}}"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Gate No</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="GATE_NO" id="GATE_NO" value="{{isset($objResponse->GATENO) && $objResponse->GATENO !=''?$objResponse->GATENO:''}}" maxlength="15"  class="form-control" autocomplete="off"   >
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="GATE_RGNO" id="GATE_RGNO"  onkeyup="deleteDate('DATE',this.value);"  value="{{isset($objResponse->GATE_REGNO) && $objResponse->GATE_REGNO !=''?$objResponse->GATE_REGNO:''}}" maxlength="15"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Date</p></div>
			<div class="col-lg-2 pl">
				  <input type="date" name="DATE" id="DATE" value="{{isset($objResponse->GATE_REGDT) && $objResponse->GATE_REGDT !=''?$objResponse->GATE_REGDT:''}}"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Remarks</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="REMARKS" id="REMARKS" value="{{isset($objResponse->REMARKS) && $objResponse->REMARKS !=''?$objResponse->REMARKS:''}}" maxlength="200"  class="form-control" autocomplete="off"   >
      </div>
    </div>
        ...
        <li><a data-toggle="tab" href="#Unloading" id="UnloadingTab">Unloading</a></li>
          ...
          <div class="inner-form">
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="LR_NO" id="LR_NO" onkeyup="deleteDate('LR_DT',this.value);" value="{{isset($objResponse->LRNO) && $objResponse->LRNO !=''?$objResponse->LRNO:''}}" maxlength="30" class="form-control" autocomplete="off" >
              </div>
          
              <div class="col-lg-2 pl"><p>LR Date</p></div>
              <div class="col-lg-2 pl">
                    <input type="date" name="LR_DT" id="LR_DT" value="{{isset($objResponse->LRDT) && $objResponse->LRDT !=''?$objResponse->LRDT:''}}" class="form-control" autocomplete="off" >
              </div>
              ...
              <div class="col-lg-2 pl">
                <select  name="TRANSPORT_MODE" id="TRANSPORT_MODE" class="form-control" autocomplete="off" >
                  ...
                  <option {{isset($objResponse->TRANSPORT_MODE) && $objResponse->TRANSPORT_MODE =='By Road'?'selected="selected"':''}} value="By Road">By Road</option>
                  <option {{isset($objResponse->TRANSPORT_MODE) && $objResponse->TRANSPORT_MODE =='By Sea'?'selected="selected"':''}} value="By Sea">By Sea</option>
                  <option {{isset($objResponse->TRANSPORT_MODE) && $objResponse->TRANSPORT_MODE =='By Air'?'selected="selected"':''}} value="By Air">By Air</option>
                </select>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="VEHICLE_NO" id="VEHICLE_NO" value="{{isset($objResponse->VECHICLE_NO) && $objResponse->VECHICLE_NO !=''?$objResponse->VECHICLE_NO:''}}" maxlength="30" class="form-control" autocomplete="off" >
              </div>
          
              <div class="col-lg-2 pl"><p>Vehicle Category</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="VEHICLE_CAT" id="VEHICLE_CAT" value="{{isset($objResponse->VECHICLE_CAT) && $objResponse->VECHICLE_CAT !=''?$objResponse->VECHICLE_CAT:''}}" maxlength="100" class="form-control" autocomplete="off" >
              </div>

              <div class="col-lg-2 pl"><p>Transporter</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="TRANSPORTER_Details" id="TRANSPORTER_Details" value="{{isset($objTransporterName->TRANSPORTER_CODE) && $objTransporterName->TRANSPORTER_CODE !=''?$objTransporterName->TRANSPORTER_CODE.' - '.$objTransporterName->TRANSPORTER_NAME:''}}"  class="form-control"  autocomplete="off" readonly/>
                <input type="hidden" name="TRANSPORTER" id="TRANSPORTER" value="{{isset($objResponse->TRANSPORTER) && $objResponse->TRANSPORTER !=''?$objResponse->TRANSPORTER:''}}" class="form-control" autocomplete="off" />
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="DRIVER_NAME" id="DRIVER_NAME" value="{{isset($objResponse->DRIVER_NAME) && $objResponse->DRIVER_NAME !=''?$objResponse->DRIVER_NAME:''}}" maxlength="100" class="form-control" autocomplete="off" >
              </div>
          
              <div class="col-lg-2 pl"><p>Weighment Machine</p></div>
              <div class="col-lg-2 pl">
                    <input type="text" name="WEIGHMENT_MACHINE" id="WEIGHMENT_MACHINE" value="{{isset($objResponse->WEIGHMENT_MACHINE) && $objResponse->WEIGHMENT_MACHINE !=''?$objResponse->WEIGHMENT_MACHINE:''}}" class="form-control" autocomplete="off" >
              </div>

              <div class="col-lg-2 pl"><p>Weighment Slip No</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="WEIGHMENT_SLIP" id="WEIGHMENT_SLIP" value="{{isset($objResponse->WEIGHMENT_SLIPNO) && $objResponse->WEIGHMENT_SLIPNO !=''?$objResponse->WEIGHMENT_SLIPNO:''}}"  maxlength="10"  class="form-control"  autocomplete="off"/>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="GROSS_WEIGHT" id="GROSS_WEIGHT" onkeyup="weightCalculation();" value="{{isset($objResponse->GROSS_WEIGHT) && $objResponse->GROSS_WEIGHT !=''?$objResponse->GROSS_WEIGHT:''}}" maxlength="50" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" autocomplete="off" >
              </div>
          
              <div class="col-lg-2 pl"><p>Tare Weight (KGS)</p></div>
              <div class="col-lg-2 pl">
                    <input type="text" name="TARE_WEIGHT" id="TARE_WEIGHT" onkeyup="weightCalculation();" value="{{isset($objResponse->TARE_WEIGHT) && $objResponse->TARE_WEIGHT !=''?$objResponse->TARE_WEIGHT:''}}" maxlength="50" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" autocomplete="off" >
              </div>

              <div class="col-lg-2 pl"><p>Net Weight (KGS)</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="NET_WEIGHT" id="NET_WEIGHT" value="{{isset($objResponse->NET_WEIGHT) && $objResponse->NET_WEIGHT !=''?$objResponse->NET_WEIGHT:''}}" maxlength="50" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" autocomplete="off" readonly  >
              </div>
            </div>
        ...
        <div id="Unloading" class="tab-pane fade">	
          <div class="inner-form">
            <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="UNL_BAYNO" id="UNL_BAYNO" value="{{isset($objResponse->UNLOAD_BAYNO) && $objResponse->UNLOAD_BAYNO !=''?$objResponse->UNLOAD_BAYNO:''}}" maxlength="30" class="form-control" autocomplete="off" >
                </div>
            
                <div class="col-lg-2 pl"><p>Stock Custodian</p></div>
                <div class="col-lg-2 pl">
                      <input type="text" name="ST_CUSTODIAN" id="ST_CUSTODIAN" value="{{isset($objResponse->STOCK_CUSTODIAN) && $objResponse->STOCK_CUSTODIAN !=''?$objResponse->STOCK_CUSTODIAN:''}}" class="form-control" autocomplete="off" >
                </div>

                <div class="col-lg-2 pl"><p>Unload Method</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="UNL_METHOD" id="UNL_METHOD" value="{{isset($objResponse->UNLOAD_METHOD) && $objResponse->UNLOAD_METHOD !=''?$objResponse->UNLOAD_METHOD:''}}" maxlength="100"  class="form-control"  autocomplete="off"/>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  ...
                  <input type="text" name="PTID_REF_Details" id="PTID_REF_Details" value="{{isset($objPackingName->PTCODE) && $objPackingName->PTCODE !=''?$objPackingName->PTCODE.' - '.$objPackingName->PTNAME:''}}" class="form-control"   autocomplete="off" readonly/>
                    <input type="hidden" name="PTID_REF" id="PTID_REF" value="{{isset($objResponse->PTID_REF) && $objResponse->PTID_REF !=''?$objResponse->PTID_REF:''}}" class="form-control" autocomplete="off" />
                </div>
            
                <div class="col-lg-2 pl"><p>No of Packing</p></div>
                <div class="col-lg-2 pl">
                      <input type="text" name="PACKING_NO" id="PACKING_NO" value="{{isset($objResponse->PACKING_NO) && $objResponse->PACKING_NO !=''?$objResponse->PACKING_NO:''}}" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" autocomplete="off" >
                </div>

                <div class="col-lg-2 pl"><p>Primary Packaging Condition</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="PACKING_CONDITION" id="PACKING_CONDITION"  value="{{isset($objResponse->PRIMARY_PACKING_CONDITION) && $objResponse->PRIMARY_PACKING_CONDITION !=''?$objResponse->PRIMARY_PACKING_CONDITION:''}}" maxlength="200"  class="form-control"  autocomplete="off"/>
                </div>
              </div>
          </div>
				</div>
              ...
              @foreach($objUDF as $uindex=>$uRow)
                ...
                <tr  class="participantRow3">
                    <td><input type="text" name={{"popupSEID_".$uindex}} id={{"popupSEID_".$uindex}} class="form-control" value="{{$uRow->UDFGEJIID_REF}}" autocomplete="off"  readonly/></td>
                    <td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->UDFGEJIID_REF}}" autocomplete="off"   /></td>
                    <td hidden><input type="hidden" name={{"UDFismandatory_".$uindex}} id={{"UDFismandatory_".$uindex}} value="{{$uRow->UDFGEJIID_REF}}" class="form-control"   autocomplete="off" /></td>
...
function getJwoNo(Type,VID_REF){
    ...
    $.ajax({
        ...
        type:'POST',
        data:{Type:Type,VID_REF:VID_REF,value:'{{isset($objResponse->JWOID_REF) && $objResponse->JWOID_REF !=''?$objResponse->JWOID_REF:''}}'},
        success:function(data) {
...
// var lastdt = <?php echo json_encode($objResponse->GEDT); ?>;
// var today = new Date(); 
// var sodate = <?php echo json_encode($objResponse->GEDT); ?>;
...
$.each( soudf, function( soukey, souvalue ) {
    ...
    $.each( udfforse, function( usokey, usovalue ) { 
        if(souvalue.UDFGEJIID_REF == usovalue.UDFGEJID)
        {
...
$(function() { 
  getJwoNo("JWO","{{isset($objResponse->VID_REF) && $objResponse->VID_REF !=''?$objResponse->VID_REF:''}}")
});
