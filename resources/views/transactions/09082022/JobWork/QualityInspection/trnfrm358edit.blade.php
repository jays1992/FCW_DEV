...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Quality Inspection against </br/> GRJ (QIJ)</a>
        </div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="QIJNO" id="QIJNO" VALUE="{{isset($HDR->QIJNO)?$HDR->QIJNO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>QIJ Date</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="QIJDT" id="QIJDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" VALUE="{{isset($HDR->QIJDT)?$HDR->QIJDT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>

            <div class="col-lg-2 pl"><p>QC Process By</p></div>
			      <div class="col-lg-2 pl">
              <input type="text" name="QC_PROCESS_BY_popup" id="txtQC_PROCESS_BY_popup" VALUE="{{isset($HDR->EMP_CODE_DES)?$HDR->EMP_CODE_DES:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl"><p>External Lab Name</p></div>
			      <div class="col-lg-2 pl">
              <input type="text" name="EXT_LABNAME" id="EXT_LABNAME" VALUE="{{isset($HDR->EXT_LABNAME)?$HDR->EXT_LABNAME:''}}" class="form-control"  autocomplete="off"/>
			      </div>

            <div class="col-lg-2 pl"><p>Ref Doc No</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="REF_DOCNO" id="REF_DOCNO" VALUE="{{isset($HDR->REF_DOCNO)?$HDR->REF_DOCNO:''}}" class="form-control"  autocomplete="off"/>
			      </div>

            <div class="col-lg-2 pl"><p>GRJ No</p></div>
            <div class="col-lg-2 pl">
            <input type="text" name="TEXT_GRJID_REF_DATA" id="TEXT_GRJID_REF_DATA" VALUE="{{isset($HDR->GRNNO)?$HDR->GRNNO:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="GRJID_REF" id="GRJID_REF" VALUE="{{isset($HDR->GRJID_REF)?$HDR->GRJID_REF:''}}" class="form-control" autocomplete="off" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="popupITEMID" id="popupITEMID" VALUE="{{isset($HDR->ITEM_CODE_NAME)?$HDR->ITEM_CODE_NAME:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
              ...
              <input type="hidden"  name="GEJWOID_REF"  id="GEJWOID_REF" VALUE="{{isset($HDR->GEJWOID_REF)?$HDR->GEJWOID_REF:''}}"  class="form-control" autocomplete="off" />
              <input type="hidden"  name="JWCID_REF"    id="JWCID_REF"   VALUE="{{isset($HDR->JWCID_REF)?$HDR->JWCID_REF:''}}"   class="form-control" autocomplete="off" />
              <input type="hidden"  name="JWOID_REF"    id="JWOID_REF"   VALUE="{{isset($HDR->JWOID_REF)?$HDR->JWOID_REF:''}}"  class="form-control" autocomplete="off" />
              <input type="hidden"  name="PROID_REF"    id="PROID_REF"   VALUE="{{isset($HDR->PROID_REF)?$HDR->PROID_REF:''}}"  class="form-control" autocomplete="off" />
              <input type="hidden"  name="SOID_REF"     id="SOID_REF"    VALUE="{{isset($HDR->SOID_REF)?$HDR->SOID_REF:''}}"  class="form-control" autocomplete="off" />   
              <input type="hidden"  name="SQID_REF"     id="SQID_REF"    VALUE="{{isset($HDR->SQID_REF)?$HDR->SQID_REF:''}}"  class="form-control" autocomplete="off" />
              <input type="hidden"  name="SEID_REF"     id="SEID_REF"    VALUE="{{isset($HDR->SEID_REF)?$HDR->SEID_REF:''}}"  class="form-control" autocomplete="off" />
                          
            </div>

          <div class="col-lg-2 pl"><p>GRN Received Qty</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="GRJ_REC_QTY" id="GRJ_REC_QTY" VALUE="{{isset($HDR->GRJ_REC_QTY)?$HDR->GRJ_REC_QTY:''}}" class="form-control"  autocomplete="off" readonly />
          </div>

          <div class="col-lg-2 pl"><p>UOM</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="TEXT_UOMID_REF_DATA" id="TEXT_UOMID_REF_DATA" VALUE="{{isset($HDR->UOM_CODE_DES)?$HDR->UOM_CODE_DES:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="QI_PICK_QTY" id="QI_PICK_QTY" VALUE="{{isset($HDR->QI_PICK_QTY)?$HDR->QI_PICK_QTY:''}}" class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Rejected Qty</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="REJECTED_QTY" id="REJECTED_QTY" VALUE="{{isset($HDR->REJECTED_QTY)?$HDR->REJECTED_QTY:''}}" class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="REJECTED_STID_REF_popup" id="REJECTED_STID_REF_popup" VALUE="{{isset($HDR->REJECTED_STORE)?$HDR->REJECTED_STORE:''}}" class="form-control mandatory"  autocomplete="off" readonly onclick="store('REJECTED_STID_REF');" />
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="QC_OK_QTY" id="QC_OK_QTY" VALUE="{{isset($HDR->QC_OK_QTY)?$HDR->QC_OK_QTY:''}}"  class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="QC_OK_STID_REF_popup" id="QC_OK_STID_REF_popup" VALUE="{{isset($HDR->QC_OK_STORE)?$HDR->QC_OK_STORE:''}}"  class="form-control mandatory"  autocomplete="off" readonly onclick="store('QC_OK_STID_REF');" />
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="PENDING_QC_QTY" id="PENDING_QC_QTY" VALUE="{{isset($HDR->PENDING_QC_QTY)?$HDR->PENDING_QC_QTY:''}}"  class="form-control"  autocomplete="off" readonly />
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="PENDING_QC_STID_REF_popup" id="PENDING_QC_STID_REF_popup" VALUE="{{isset($HDR->PENDING_QC_STORE)?$HDR->PENDING_QC_STORE:''}}"  class="form-control mandatory"  autocomplete="off" readonly onclick="store('PENDING_QC_STID_REF');" />
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="REMARKS" id="REMARKS" VALUE="{{isset($HDR->REMARKS)?$HDR->REMARKS:''}}"  class="form-control"  autocomplete="off"/>
            </div>
                      ...
                      if(isset($MAT) && !empty($MAT)){
                        foreach ($MAT as $index=>$dataRow){
                            ...
                            echo '<tr  class="participantRow">
                                <td><input type="checkbox" name="SELECT_QCP[]"  id="SELECT_QCP_'.$index.'" class="clssQCPID" value="'.$index.'" checked ></td>
                                ...
                                <td><input type="text" name="STD_VALUE_'.$index.'" id="STD_VALUE_'.$index.'" value="'.$dataRow->STD_VALUE.'" class="form-control"  autocomplete="off" readonly style="width:100px;"  /> <div style="width:170px !important;"> <span style="margin-left:2px">'.$STANDARD_TYPE.' </span></div> </td>
            
                                <td><input type="text" name="OBS_VALUE1_'.$index.'" id="OBS_VALUE1_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE1.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE2_'.$index.'" id="OBS_VALUE2_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE2.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE3_'.$index.'" id="OBS_VALUE3_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE3.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE4_'.$index.'" id="OBS_VALUE4_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE4.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE5_'.$index.'" id="OBS_VALUE5_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE5.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE6_'.$index.'" id="OBS_VALUE6_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE6.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE7_'.$index.'" id="OBS_VALUE7_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE7.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE8_'.$index.'" id="OBS_VALUE8_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE8.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE9_'.$index.'" id="OBS_VALUE9_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE9.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
                                <td><input type="text" name="OBS_VALUE10_'.$index.'" id="OBS_VALUE10_'.$index.'" '.$OBS_VALUE_READONLY.' value="'.$OBS_VALUE10.'" class="form-control"  autocomplete="off" style="width:50px;" onkeyup="AverageTotal(this.id)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
            
                                <td><input type="text" name="AVG_OBS_VALUE_'.$index.'" id="AVG_OBS_VALUE_'.$index.'" '.$AVG_OBS_VALUE_READONLY.' value="'.$dataRow->AVG_OBS_VALUE.'" class="form-control"  autocomplete="off" onkeyup="AverageTotal(this.id)" /></td>
                                <td><input type="text" name="REJECTED_'.$index.'" id="REJECTED_'.$index.'" value="'.$REJECTED.'" class="form-control"  autocomplete="off" readonly ></td>
            
                                <td><input type="text" name="txtRRID_popup_'.$index.'"   id="txtRRID_popup_'.$index.'" value="'.$RR_CODE_DES.'" class="form-control" autocomplete="off" readonly/></td>
                                ...
                                <td><input type="text" name="REJECTION_REMARKS_'.$index.'" id="REJECTION_REMARKS_'.$index.'" value="'.$dataRow->REJECTION_REMARKS.'" class="form-control"  autocomplete="off" /></td>
                            </tr>';
                      ...
                      <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                          ...
                          <tbody>
                            ...
                            <tr  class="participantRow4">
                              ...
                              <td hidden>
                                <input type="text" name='{{"udffie_".$udfkey}}' id='{{"hdnudffie_popup_".$udfkey}}' value="{{$udfrow->UDFQIJID}}" class="form-control" maxlength="100" />
                              </td>
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
      ...
      <table id="SECOND_GRJID_REF_TABLE" class="display nowrap table  table-striped table-bordered" >
        ...
        <tr >
          <td class="ROW1"> <input type="checkbox" name="SELECT_GRJID_REF[]" id="ROW_GRJID_REF_ID_{{ $key }}" class="CLASS_GRJID_REF_ID" value="{{ $val->DOC_ID }}" ></td>   
          <td class="ROW2">{{ $val-> DOC_CODE }} <input type="hidden" id="txtROW_GRJID_REF_ID_{{ $key }}" data-desc="{{ $val->DOC_CODE }}"  value="{{ $val->DOC_ID }}"/></td>
...
$(document).ready(function(e) {
  ...
  // var lastQIJDT = <?php echo json_encode($HDR->QIJDT); ?>;
  // var today = new Date(); 
  // var mrsdate = <?php echo json_encode($HDR->QIJDT); ?>;
  // $('#QIJDT').attr('min',lastQIJDT);
  // $('#QIJDT').attr('max',mrsdate);

  var lastdt = <?php echo json_encode($HDR->QIJDT); ?>;
  var qij = <?php echo json_encode($HDR); ?>;
  var today = new Date(); 
  ...
  {
	  $('#QIJDT').attr('min',qij.QIJDT);
  }
  $('#QIJDT').attr('max',sodate);
...
function validateForm(saveAction){
  ...
  if(parseFloat(QI_PICK_QTY) > parseFloat(GRJ_REC_QTY)){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#QIJDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
