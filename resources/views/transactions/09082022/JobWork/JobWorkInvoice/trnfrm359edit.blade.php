...
<div class="container-fluid filter">
    <form id="edit_trn_form"  method="POST"> 
      @csrf
      {{isset($OBJ_HDR->JWIID[0]) ? method_field('PUT') : '' }}
	<div class="inner-form">
	
		<div class="row">
        <div class="col-lg-2 pl"><p>JWI Doc No</p></div>
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="JWINO" id="JWINO" value="{{ $OBJ_HDR->JWINO}}" class="form-control mandatory" maxlength="30" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
        </div>
        <div class="col-lg-2 pl"><p>JWI Doc Date</p></div>
        <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="date" name="JWIDT" id="JWIDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ $OBJ_HDR->JWIDT}}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-2 pl"><p>Department</p></div>
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="txtdepartment" id="txtdepartment" class="form-control" value="{{$OBJ_HDR_DEP->DCODE}}-{{$OBJ_HDR_DEP->NAME}}"  readonly  />
                <input type="hidden" name="DEPID_REF" id="DEPID_REF" value="{{ $OBJ_HDR->DEPARTMENTID_REF}}"  class="form-control " />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="txtvendor" id="txtvendor" class="form-control" value="{{$OBJ_HDR_VID->VCODE}}-{{$OBJ_HDR_VID->NAME}}" readonly  />
                <input type="hidden" name="VID_REF" id="VID_REF"  class="form-control" value="{{ $OBJ_HDR->VID_REF}}" />
        </div>

        <div class="col-lg-2 pl"><p> Vendor Invoice No</p></div> 
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="text" name="VENDOR_INNO" id="VENDOR_INNO" value="{{ $OBJ_HDR->VENDOR_INVOICENO}}" maxlength="30" class="form-control" autocomplete="off" />
        </div>
        <div class="col-lg-2 pl"><p> Date</p></div>
        <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="date" name="VENDOR_INDT" id="VENDOR_INDT" value="{{ $OBJ_HDR->VENDOR_INVOICEDT}}" class="form-control"  placeholder="dd/mm/yyyy"  />
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl" id="div_billto">
            ...
            <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="{{ $OBJ_HDR->BILL_TO}}" />
        </div>
        ...
        <div class="col-lg-2 pl" id="div_shipto">
            ...
            <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="{{ $OBJ_HDR->SHIP_TO}}" />
            <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" value="{{$TAXSTATE[0]}}" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Remarks</p></div>
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" value="{{ $OBJ_HDR->REMARKS}}" maxlength="200"  >
        </div>
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:320px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                          <tr>
                              <th>GRN No<input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="{{$objCount1}}" /></th>
                              <th>Item Code</th>
                              <th>Item Name</th>
                              <th>Main UOM</th>
                              <th>Received Qty</th>
                    ...
                    @if(!empty($objPBMAT))
                      @foreach($objPBMAT as $key => $row)
                              ...
                              @php
                              $TaxAmt=number_format((($row->BILL_QTY*$row->BILL_RATE) - $row->DISC_AMT),2, '.', '');
                              $IGSTAMT = number_format((($TaxAmt*$row->IGST)/100),2, '.', '');
                              $CGSTAMT = number_format((($TaxAmt*$row->CGST)/100),2, '.', '');
                              $SGSTAMT = number_format((($TaxAmt*$row->SGST)/100),2, '.', '');
                          ...
                          <tr  class="participantRow">
                              ...
                              <input {{$ActionStatus}} type="text" name="txtGRN_NO_{{$key}}" id="txtGRN_NO_{{$key}}" value="{{isset($row->GRNNO)?$row->GRNNO:''}}" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                              <td hidden><input type="hidden" name="GRJID_REF_{{$key}}" id="GRJID_REF_{{$key}}"  value="{{isset($row->GRJID_REF)?$row->GRJID_REF:''}}" class="form-control" autocomplete="off" /></td>
                              
                              <td hidden><input type="text" name="JWCID_REF_{{$key}}" id="JWCID_REF_{{$key}}" value="{{isset($row->JWCID_REF)?$row->JWCID_REF:''}}" class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="JWOID_REF_{{$key}}" id="JWOID_REF_{{$key}}" value="{{isset($row->JWOID_REF)?$row->JWOID_REF:''}}" class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="PROID_REF_{{$key}}" id="PROID_REF_{{$key}}" value="{{isset($row->PROID_REF)?$row->PROID_REF:''}}" class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="SOID_REF_{{$key}}"  id="SOID_REF_{{$key}}"  value="{{isset($row->SOID_REF)?$row->SOID_REF:''}}"  class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="SQID_REF_{{$key}}"  id="SQID_REF_{{$key}}"  value="{{isset($row->SQID_REF)?$row->SQID_REF:''}}"  class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="SEID_REF_{{$key}}"  id="SEID_REF_{{$key}}"  value="{{isset($row->SEID_REF)?$row->SEID_REF:''}}"  class="form-control" autocomplete="off" /></td>
                              ...
                              <td hidden><input type="hidden" name={{"ITEMID_REF_".$key}} id={{"ITEMID_REF_".$key}} class="form-control" value="{{$row->ITEMID_REF}}" autocomplete="off" style="width:100px;"  /></td>
                              ...
                              <td><input {{$ActionStatus}} type="text" name={{"txtUOM_".$key}} id={{"txtUOM_".$key}} class="form-control" maxlength="15" value="{{$row->MAIN_UOM_CODE}}" autocomplete="off"  readonly style="width:130px;"  /></td>
                              <td hidden><input type="hidden" name={{"UOMID_REF_".$key}} id={{"UOMID_REF_".$key}} class="form-control" value="{{$row->UOMID_REF}}" autocomplete="off" style="width:100px;"  /></td>
                              <td><input {{$ActionStatus}} type="text" name={{"RECEIVED_QTY_".$key}} id={{"RECEIVED_QTY_".$key}} class="form-control three-digits" value="{{$row->RECV_QTY}}" maxlength="15"  autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                              
                              <td hidden><input type="text" name={{"txtALTUOM_".$key}} id={{"txtALTUOM_".$key}} class="form-control" maxlength="15"  autocomplete="off"  readonly style="width:100px;"  /></td>
                              <td hidden><input type="hidden" name={{"ALT_UOMID_REF_".$key}} id={{"ALT_UOMID_REF_".$key}} class="form-control"  autocomplete="off" /></td>
                              <td hidden><input type="text" name={{"RECEIVED_ALT_QTY_".$key}} id={{"RECEIVED_ALT_QTY_".$key}} class="form-control three-digits"  maxlength="15"  autocomplete="off" readonly style="width:100px;"  /></td>
                              
                              <td><input {{$ActionStatus}} type="text" name={{"BILL_QTY_".$key}} id={{"BILL_QTY_".$key}} class="form-control three-digits" maxlength="15" value="{{$row->BILL_QTY}}"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                              
                              <td hidden><input type="text" name={{"txtBILLUOM_".$key}} id={{"txtBILLUOM_".$key}} class="form-control" maxlength="15"  autocomplete="off"  readonly style="width:100px;"  /></td>
                              <td hidden><input type="hidden" name={{"BILL_UOMID_REF_".$key}} id={{"BILL_UOMID_REF_".$key}} class="form-control"  autocomplete="off" style="width:100px;"  /></td>
                              
                              <td><input {{$ActionStatus}} type="text" name={{"ItemDesc_".$key}} id={{"ItemDesc_".$key}} class="form-control" value="{{$row->ITEM_SPECI}}" autocomplete="off"  style="width:150px;"  /></td>
                              <td><input {{$ActionStatus}} type="text" name={{"BILL_RATEPUOM_".$key}} id={{"BILL_RATEPUOM_".$key}} class="form-control five-digits blurRate" value="{{$row->BILL_RATE}}" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;"   /></td>
                              <td><input {{$ActionStatus}} type="text" name={{"DISC_PER_".$key}} id={{"DISC_PER_".$key}} class="form-control four-digits" maxlength="12" value="{{$row->DISC_PER}}" autocomplete="off"  style="width:130px;text-align:right;"  /></td>
                              <td><input {{$ActionStatus}} type="text" name={{"DISC_AMT_".$key}} id={{"DISC_AMT_".$key}} class="form-control two-digits" maxlength="15" value="{{$row->DISC_AMT}}" autocomplete="off" style="width:130px;text-align:right;"   /></td>
                              ...
                              <td><input {{$ActionStatus}} type="text" name={{"IGST_AMT_".$key}} id={{"IGST_AMT_".$key}} class="form-control two-digits" maxlength="15" value="{{$IGSTAMT}}" autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                              ...
                              <td><input {{$ActionStatus}} type="text" name={{"CGST_AMT_".$key}} id={{"CGST_AMT_".$key}} class="form-control two-digits" maxlength="15" value="{{$CGSTAMT}}" autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                              ...
                              <td><input {{$ActionStatus}} type="text" name={{"SGST_AMT_".$key}} id={{"SGST_AMT_".$key}} class="form-control two-digits" maxlength="15" value="{{$SGSTAMT}}" autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                  ...
                  @if(!empty($objPBCAL))
                    @foreach($objPBCAL as $Ckey => $Crow)
                      ...
                      @endphp      
                            ...
                            <td style="text-align:center;"><input type="checkbox" class="filter-none" name={{"calACTUAL_".$Ckey}} id={{"calACTUAL_".$Ckey}}  {{$Crow->ACTUAL == 1 ? 'checked' : ''}} /></td>
                    ...
                    @if(!empty($objPBUDF))
                      @foreach($objPBUDF as $Ukey => $Urow)
                          <tr  class="participantRow4">
                              <td><input {{$ActionStatus}} type="text" name={{"popupUDFJWIID_".$Ukey}} id={{"popupUDFJWIID_".$Ukey}}  class="form-control"  autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name={{"UDFJWIID_REF_".$Ukey}}  id={{"UDFJWIID_REF_".$Ukey}} class="form-control" value="{{$Urow->UDFJWIID_REF}}" autocomplete="off" /></td>
                      ...
                      @if($objUdfPBData)
                        @foreach($objUdfPBData as $uindex=>$uRow)
                          <tr  class="participantRow4">
                              <td><input {{$ActionStatus}} type="text" name={{"popupUDFJWIID_".$uindex}} id={{"popupUDFJWIID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
                        ...
                        @else
                          <tr  class="participantRow4">
                              <td><input {{$ActionStatus}} type="text" name="popupUDFJWIID_0" id="popupUDFJWIID_0" class="form-control" value="" autocomplete="off"  readonly/></td>
...
var PBHDR = <?php echo json_encode($OBJ_HDR); ?>;
...
$.each( pbudf, function( pbukey, pbuvalue ) {
        $.each( udfforpb, function( upbkey, upbvalue ) { 
            ...
            if(pbuvalue.UDFJWIID_REF == upbvalue.UDFJWIID)
            {
                $('#popupUDFJWIID_'+pbukey).val(upbvalue.LABEL);
...
$('#udf').find('.participantRow4').each(function(){
  ...
  $.each( apudf, function( apukey, apuvalue ) {
    if(apuvalue.UDFJWIID_REF == udfid)
    {
...
$('#edit_trn_form').on('change','#GST_Reverse', function() 
{
    // bindTotalValue();
    if($('#CTID_REF').val()!='')
    {
...
$(document).ready(function() {
    ...
    $('#edit_trn_form1').bootstrapValidator({       
        fields: {
            txtlabel: {
                validators: {
                    notEmpty: {
...
$("#btnSave").click(function() {
  var formPurchaseBill = $("#edit_trn_form");
...
$(document).ready(function(){
  var lastdt = <?php echo json_encode($objlastdt[0]->JWIDT); ?>;
  var jwi = <?php echo json_encode($OBJ_HDR); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < jwi.JWIDT)
  {
	$('#JWIDT').attr('min',lastdt);
  }
  else
  {
	  $('#JWIDT').attr('min',jwi.JWIDT);
  }
  $('#JWIDT').attr('max',sodate);
});
