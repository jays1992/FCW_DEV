        ...
        <div class="col-lg-2 pl">
            @if($objPBDOCNO)
              @if($objPBDOCNO->SYSTEM_GRSR == "1")
                  <input type="text" name="JWINO" id="JWINO" value="{{ $objDataNo }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
              @endif
              @if($objPBDOCNO->MANUAL_SR == "1")
                  <input type="text" name="JWINO" id="JWINO" value="{{ old('JWINO') }}" class="form-control mandatory" maxlength="{{$objPBDOCNO->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase"  >
              @endif
            @else
                <input type="text" name="JWINO" id="JWINO" value="{{ old('JWINO') }}" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" >
            @endif
        </div>
        <div class="col-lg-2 pl"><p>JWI Doc Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="JWIDT" id="JWIDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('JWIDT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
