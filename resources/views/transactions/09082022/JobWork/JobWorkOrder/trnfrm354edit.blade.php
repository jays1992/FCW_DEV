...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Job Work Order</a>
        </div>
      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="JWONO" id="JWONO" value="{{ $objMstResponse->JWONO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            <input type="hidden" name="JWOID" id="JWOID" value="{{ $objMstResponse->JWOID }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
          </div>
              
          <div class="col-lg-2 pl"><p>JWO Date</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="JWODT" id="JWODT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ $objMstResponse->JWODT }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
                <input type="checkbox" name="DirectJWO" id="DirectJWO" class="form-checkbox" {{isset($objMstResponse->DIRECTJWO) && $objMstResponse->DIRECTJWO == 1 ? 'checked' : ''}}  />
                <input type="hidden" name="hiddenDirect" id="hiddenDirect" value="{{ $objMstResponse->DIRECTJWO }}" />
          </div>
        ...
        <div class="row">
            ...
            <div class="tab-content">
                ...
                <div id="Material" class="tab-pane fade in active">
                    ...
                    <td>       <input type="text"  name="txtPRO_popup_{{$key}}"  id="txtPRO_popup_{{$key}}"  value="{{$row->PRO_NO}}"    class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                    <td hidden><input type="text"  name="PROID_REF_{{$key}}"     id="PROID_REF_{{$key}}"     value="{{$row->PROID_REF}}" class="form-control"  autocomplete="off" /></td>
										...
										<td><input type="text"   name="QTY_{{$key}}" 		id="QTY_{{$key}}" 		value="{{$row->PROD_QTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td hidden><input type="text"   name="BL_SOQTY_{{$key}}" 	id="BL_SOQTY_{{$key}}"  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input type="text"   name="PD_OR_QTY_{{$key}}" 	id="PD_OR_QTY_{{$key}}" value="{{$row->JWO_QTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" data-mainitem="{{$mitem_id}}" onKeyup="rate_amount(this.id),get_materital_item()"  /></td>
										
                    <td><input type="date"   name="EDA_{{$key}}"      id="EDA_{{$key}}"       class="form-control"                value="{{$row->EDA}}" autocomplete="off"    /></td>
                    <td><input type="text"   name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}"  class="form-control three-digits"   value="{{$row->RATE_PUOM}}" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" onKeyup="rate_amount(this.id)"  /></td>
                    <td><input type="text"   name="TOT_AMT_{{$key}}"  id="TOT_AMT_{{$key}}"   class="form-control three-digits"   value="{{$TOT_AMT}}" readonly maxlength="13"  autocomplete="off" style="width:100px;" onKeyup="rate_amount(this.id)"  /></td>
                  ...
                  <div id="material_item">
                        ...
                        $mitem_id2 = $PROID2."_".$SOID2."_".$SQID2."_".$SEID2."_".$ITEMID2; 
												...
												echo '<td><input type="text" id="txtMAINITEM_popup_'.$index.'" value="'.$row_data['SOITEMID_CODE'].'"  class="form-control" readonly style="width:100px;" /></td>';
                        ...
                        <button class="btn subr" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button>
                                ...
                                <div id="TC" class="tab-pane fade">
                                    ...
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        <div class="col-lg-2 pl">
                                        @if(!empty($objSavedTNCHeader))
                                          <input type="text" name="txtTNCID_popup" id="txtTNCID_popup" value="{{ $objSavedTNCHeader[0]->TNC_CODE }} - {{ $objSavedTNCHeader[0]->TNC_DESC }}" class="form-control"  autocomplete="off"  readonly/>
                                          <input type="hidden" name="TNCID_REF" id="TNCID_REF" value="{{ $objSavedTNCHeader[0]->TNCID }}" class="form-control" autocomplete="off" />
                                        @else
                                        ...
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody>
                                              ...
                                              <tr  class="participantRow4">
                                                ...
                                                <td hidden>
                                                  <input type="text" name='{{"udffie_".$udfkey}}' id='{{"hdnudffie_popup_".$udfkey}}' value="{{$udfrow->UDFJWOID}}" class="form-control" maxlength="100" />
                                                </td>
                                ...
                                <div id="CT" class="tab-pane fade">
                                  <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                      ...
                                      <div class="col-lg-2 pl">
                                       ...
                                       @if(!empty($objVQCAL))
                                         <input type="hidden" name="CTID_REF" id="CTID_REF" class="form-control" value="{{$objVQCAL[0]->CTID_REF}}" autocomplete="off" />
                                         @else
                                          ...
                                          <tbody id="tbody_ctid">
                                              ...
                                              @foreach($objVQCAL as $Ckey => $Crow)
                                                  ...
                                                  <tr  class="participantRow5">
                                                      ...
                                                      <td hidden style="text-align:center;" ><input type="checkbox" class="filter-none" name={{"calGST_".$Ckey}} id={{"calGST_".$Ckey}}   ></td>
                                                      
                                                      <td hidden><input type="text" name={{"calIGST_".$Ckey}} id={{"calIGST_".$Ckey}} class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                      <td hidden><input type="text" name={{"AMTIGST_".$Ckey}} id={{"AMTIGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                      <td hidden><input type="text" name={{"calCGST_".$Ckey}} id={{"calCGST_".$Ckey}} class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                      <td hidden><input type="text" name={{"AMTCGST_".$Ckey}} id={{"AMTCGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                      <td hidden><input type="text" name={{"calSGST_".$Ckey}} id={{"calSGST_".$Ckey}} class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                      <td hidden><input type="text" name={{"AMTSGST_".$Ckey}} id={{"AMTSGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                      <td hidden><input type="text" name={{"TOTGSTAMT_".$Ckey}} id={{"TOTGSTAMT_".$Ckey}} class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
                                                      <td hidden style="text-align:center;"><input type="checkbox" class="filter-none" name={{"calACTUAL_".$Ckey}} id={{"calACTUAL_".$Ckey}}  ></td>
...
$("#Material").on('click','.add', function() {
    ...
    $("#material_item").on('click', '.subs', function() {
    ...
    if(JWONO ===""){
        ...
        return false;
          ...
          $('#Material').find('.participantRow').each(function(){
            ...
            else if(checkPeriodClosing('{{$FormId}}',$("#JWODT").val(),0) ==0){
              $("#YesBtn").hide();
              $("#NoBtn").hide();
              $("#OkBtn").hide();
              $("#OkBtn1").show();
...
$('#material_item').on('click','[id*="txtMAINITEM_popup"]',function(event){
  ...
  $.ajax({
      url:'{{route("transaction",[$FormId,"get_main_item"])}}',
      type:'POST',
...
$('#material_item').on('click','[id*="txtSUBITEM_popup"]',function(event){
  ...
  $.ajax({
      url:'{{route("transaction",[$FormId,"get_sub_item"])}}',
      type:'POST',
      data:{'ITEMID':ITEMID},
      success:function(data) {
...
$(document).ready(function(){
  var lastdt = <?php echo json_encode($objMstResponse->JWODT); ?>;
  var jwo = <?php echo json_encode($objMstResponse); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < jwo.JWODT)
  {
  ...
  {
	  $('#JWODT').attr('min',jwo.JWODT);
  }
  $('#JWODT').attr('max',sodate);
});
