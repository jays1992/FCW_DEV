...
<div class="container-fluid topnav">
	<div class="row">
		<div class="col-lg-2"><a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Production Order (PRO)</a></div>
...
<form id="production_order_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
	<div class="container-fluid filter">
		<div class="inner-form">
          ...
          <input type="hidden" name="PROID" id="PROID" value="{{ isset($objResponse)?$objResponse->PROID:'' }}" class="form-control" readonly  autocomplete="off"   >
					<input type="text" name="PRO_NO" id="PRO_NO" value="{{ isset($objResponse)?$objResponse->PRO_NO:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
					<span class="text-danger" id="ERROR_PRO_NO"></span>
				</div>
					  
				<div class="col-lg-1 pl"><p>PRO Date</p></div>
				<div class="col-lg-2 pl">
					<input type="date" name="PRO_DT" id="PRO_DT" value="{{ isset($objResponse)?$objResponse->PRO_DT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
					<span class="text-danger" id="ERROR_PRO_DT"></span>
				</div>

				<div class="col-lg-1 pl"><p>Title</p></div>
				<div class="col-lg-4 pl">
					<input type="text" name="PRO_TITLE" id="PRO_TITLE" value="{{ isset($objResponse)?$objResponse->PRO_TITLE:'' }}"  class="form-control" maxlength="100" autocomplete="off">
				...
				<div class="tab-content">
						...
						<div class="table-responsive table-wrapper-scroll-y" style="margin-top:10px;" >
							<table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
								<thead id="thead1"  style="position: sticky;top: 0">
									<tr>
										<th hidden ><input class="form-control" type="text" name="Row_Count1" id ="Row_Count1" value="{{count($objMAT)}}"></th>
										<th>Customer</th>
                  ...
                  @endphp
									...
									<tr  class="participantRow">
										...
										<td><input  type="text" name="txtSL_popup_{{$key}}" id="txtSL_popup_{{$key}}"   value="{{$row->SGLCODE}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
										<td  hidden><input type="text" name="SLID_REF_{{$key}}" id="SLID_REF_{{$key}}" value="{{$row->SLID_REF}}" class="form-control" autocomplete="off" /></td>

										<td><input  type="text" name="txtSO_popup_{{$key}}" id="txtSO_popup_{{$key}}"  value="{{$row->SONO}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
										...
										<td><input type="text"   name="QTY_{{$key}}" 		id="QTY_{{$key}}" 		value="{{$row->SOQTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input type="text"   name="BL_SOQTY_{{$key}}" 	id="BL_SOQTY_{{$key}}" 	value="{{$row->NEW_BAL_SO_QTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input type="text"   name="PD_OR_QTY_{{$key}}" 	id="PD_OR_QTY_{{$key}}" value="{{$row->PRO_CONSUMED_QTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" data-mainitem="{{$mitem_id}}" onKeyup="change_production_order(this.id,this.value)"  /></td>
                        ...
                        $mitem_id2 = $SLID2."_".$SOID2."_".$SQID2."_".$SEID2."_".$ITEMID2; 
												...
												echo '<td><input type="text" value="'.$row_data['SOITEMID_CODE'].'"  class="form-control" readonly style="width:100px;" /></td>';
												echo '<td><input type="text" id="txtSUBITEM_popup_'.$index.'"  value="'.$row_data['ICODE'].'"          class="form-control" readonly style="width:100px;" /></td>';
												echo '<td><input type="text" id="SUBITEM_NAME_'.$index.'"      value="'.$row_data['ITEM_NAME'].'"           class="form-control" readonly style="width:200px;" /></td>';
											  ...
											  echo '<td  hidden>REQ_SOITEMID<input style="width:60px"  type="text" name="REQ_SOITEMID_REF_'.$index.'"    id="REQ_SOITEMID_REF_'.$index.'"    value="'.$row_data['SOITEMID_REF'].'" /></td>';
												...
												echo '<td><input    type="text" name="REQ_BOM_QTY_'.$index.'"           id="REQ_BOM_QTY_'.$index.'"             value="'.$row_data['BOM_QTY'].'"    		class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" onKeyup="change_production_qty(this.id,this.value)" readonly  /></td>';
												echo '<td><input    type="text" name="REQ_INPUT_PD_OR_QTY_'.$index.'"   id="REQ_INPUT_PD_OR_QTY_'.$index.'"     value="'.$row_data['INPUT_PD_OR_QTY'].'"    class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" onKeyup="change_production_qty(this.id,this.value)" readonly  /></td>';
												echo '<td><input    type="text" name="REQ_CHANGES_PD_OR_QTY_'.$index.'" id="REQ_CHANGES_PD_OR_QTY_'.$index.'"   value="'.$row_data['CHANGES_PD_OR_QTY'].'"  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" onKeyup="change_production_qty(this.id,this.value)"  /></td>';
					...
					<div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
						<table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
							...
							<tr  class="participantRow3">
								<td><input type="text" name={{"popupSEID_".$uindex}} id={{"popupSEID_".$uindex}} class="form-control" value="{{$uRow->UDFPROID_REF}}" autocomplete="off"  readonly/></td>
								<td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->UDFPROID_REF}}" autocomplete="off"   /></td>
								<td hidden><input type="hidden" name={{"UDFismandatory_".$uindex}} id={{"UDFismandatory_".$uindex}} value="{{$uRow->UDFPROID_REF}}" class="form-control"   autocomplete="off" /></td>
...
<div id="SLpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header"><button type="button" class="close" data-dismiss="modal" id='SL_closePopup' >&times;</button></div>
      <div class="modal-body">
        <div class="tablename"><p>Customer</p></div>
        <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar">
          <table id="SLTable" class="display nowrap table  table-striped table-bordered" width="100%" style="font-size:14px;">
            <thead>
            ...
            <tbody>
              <tr>
                <td><input type="text" id="SLcodesearch" onkeyup="SLCodeFunction()"  class="form-control" ></td>
                <td><input type="text" id="SLnamesearch" onkeyup="SLNameFunction()"  class="form-control" ></td>
              </tr>
            </tbody>
          </table>

          <table id="SLTable2" class="display nowrap table  table-striped table-bordered" width="100%" style="font-size:14px;" >
            <thead id="thead2"></thead>
            <tbody id="tbody_SL">    
              @if(!empty(isset($objSubLedgerList) && $objSubLedgerList))
                @foreach($objSubLedgerList as $key=>$val)
                  <tr id="slcode_{{$val->SGLID}}"  class="clsslid">
                    <td width="50%">{{$val->SGLCODE}} </td>
                    <td>{{$val->SLNAME}}</td>
                    <td hidden><input type="text" id="txtslcode_{{$val->SGLID}}" data-desc="{{$val->SGLCODE}}" value="{{$val->SGLID}}"/></td>
                  </tr>
                @endforeach
              @else
...
<div id="SOpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
	  ...
	  <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar">
    <table id="SOTable" class="display nowrap table  table-striped table-bordered" width="100%" style="font-size:14px;" >
    <thead>
          <tr id="none-select" class="searchalldata" hidden>
    ...
    <input type="text" id="SOnamesearch" onkeyup="SONameFunction()" class="form-control" >
      ...
      <table id="SOTable2" class="display nowrap table  table-striped table-bordered" width="100%" style="font-size:14px;" >
        <thead id="thead2">
...
<div id="SUBITEMpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
	  ...
	  <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar">
    <table id="SUBITEMTable" class="display nowrap table  table-striped table-bordered" width="100%" style="font-size:14px;" >
    <thead>
          <tr id="none-select" class="searchalldata" hidden>
    ...
    <input type="text" id="SUBITEMnamesearch" onkeyup="SUBITEMNameFunction()" class="form-control" >
      ...
      <table id="SUBITEMTable2" class="display nowrap table  table-striped table-bordered" width="100%" style="font-size:14px;" >
        <thead id="thead2">
...
let sltid = "#SLTable2";
let sltid2 = "#SLTable";
let slheaders = document.querySelectorAll(sltid2 + " th");

slheaders.forEach(function(element, i) {
  element.addEventListener("click", function() {
    w3.sortHTML(sltid, ".clsslid", "td:nth-child(" + (i + 1) + ")");
  });
});

function SLCodeFunction() {
  var input, filter, table, tr, td, i, txtValue;
  input = document.getElementById("SLcodesearch");
  filter = input.value.toUpperCase();
  table = document.getElementById("SLTable2");
...
function SLNameFunction() {
  var input, filter, table, tr, td, i, txtValue;
  input = document.getElementById("SLnamesearch");
  filter = input.value.toUpperCase();
  table = document.getElementById("SLTable2");
  tr = table.getElementsByTagName("tr");
  for (i = 0; i < tr.length; i++) {
...
$("#SL_closePopup").click(function(event){
  $("#SLpopup").hide();
});

$(".clsslid").dblclick(function(){
...
$('#Material').on('focus','[id*="popupITEMID"]',function(event){
  ...
  if(SLID_REF ===""){
    ...
    $.ajax({
        ...
        type:'POST',
        data:{SLID_REF:SLID_REF,SOID_REF:SOID_REF,'status':'A','PROID':PROID},
        success:function(data) {
    ...
    $('#ItemIDTable2').find('.clsitemid').each(function()
        {
            ...
            if($(this).find('[id*="chkId"]').is(":checked") == true) 
            {
              ...
              // SLID_REF+"_"+SOID_REF+"_"+SQID_REF+"_"+SEID_REF+"_"+ITEMID_REF;
  ...
  $('[id*="chkId"]').change(function(){
    ...
    if($(this).is(":checked") == true) {
      ...
      if($('#hdn_ItemID1').val() == "" && item_id != ''){
        ...
        if($.trim(txt_id2)!=""){
          $('#'+txt_id2).val(item_id);
          $('#'+txt_id2).parent().parent().find('[id*="PD_OR_QTY"]').attr("data-mainitem",item_unique_row_id);
         // $('#'+txt_id2).parent().parent().find('[id*="tempid"]').html(item_unique_row_id);
        }
        if($.trim(txt_id3)!=""){
          $('#'+txt_id3).val(item_name);
        }
...
$('#Material').on('focus','[id*="txtSUBITEM_popup"]',function(event){
...
function BindSUBITEM(){
  $(".clssSUBITEMid").dblclick(function(){
    var fieldid   =   $(this).attr('id');
...
function get_materital_item(){
  ...
  $.ajax({
      url:'{{route("transaction",[$FormId,"get_materital_item_edit"])}}',
      type:'POST',
      data:{
        item_array:item_array,
        subitem_array:subitem_array
        },
      success:function(data) {
