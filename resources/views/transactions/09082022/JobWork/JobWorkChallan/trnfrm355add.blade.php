      ...
      <div class="inner-form">
        ...
        <div class="row">
            ...
            @if($objSON->SYSTEM_GRSR == "1")
                <input type="text" name="JWCNO" id="JWCNO" value="{{ $objAutoGenNo }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            @endif
            @if($objSON->MANUAL_SR == "1")
                <input type="text" name="JWCNO" id="JWCNO" value="{{ old('JWCNO') }}" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="JWCDT" id="JWCDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('JWCDT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
