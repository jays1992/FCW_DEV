...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->ASSETTRANID}}" value="{{$val->ASSETTRANID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->ASSETTRANDATE) && $val->ASSETTRANDATE !=''?$val->ASSETTRANDATE:''}}" ></td>
              <td>{{isset($val->ASSETTRANCODE) && $val->ASSETTRANCODE !=''?$val->ASSETTRANCODE:''}}</td>
              <td>{{isset($val->ASSETTRANDATE) && $val->ASSETTRANDATE !=''?$val->ASSETTRANDATE:''}}</td>
