       ...
       <div class="inner-form">
             ...
             <div class="row">
               ...
               <div class="col-lg-2 pl">
                 <input type="text" name="LEAVE_APP_NO" id="LEAVE_APP_NO" value="{{ $objHRD->ASSETTRANCODE }}" class="form-control mandatory"  autocomplete="off" readonly>
                 <span class="text-danger" id="ERROR_DPP_NO"></span> 
               </div>

               <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="LEAVE_APP_DT" value="{{ $objHRD->ASSETTRANDATE }}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" id="LEAVE_APP_DT" class="form-control"  maxlength="100" > 
                 </div>

               <div class="col-lg-2 pl"><p>Asset Code*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCODE" id="ASSETCODE" value="{{ $objHRD->ASSETCODE }}" class="form-control mandatory"  autocomplete="off" readonly/>
                   <input type="hidden" name="ASSETID_REF" id="ASCATID" value="{{ $objHRD->ASSETID_REF }}" class="form-control" autocomplete="off" />
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="DESCRIPTIONS" id="DESCRIPTIONS" value="{{ $objHRD->ASTDESCRIPTIONS }}" class="form-control" readonly  maxlength="100" > 
                 </div>
               
                 <div class="col-lg-2 pl"><p>Asset No*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETNO" id="ASSETNO" value="{{ $objHRD->ASTCODE }}" class="form-control mandatory"  autocomplete="off" readonly/>
                   <input type="hidden" name="ASTID_REF" id="ASTID_REF" value="{{ $objHRD->ASSETNOID_REF }}" class="form-control" autocomplete="off" />
               ...
               <div class="col-lg-2 pl"><p>Asset Location</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTLOCATION" id="ASTLOCATION" value="{{ $objHRD->ASTSUBCODE }}" class="form-control" readonly maxlength="100" > 
                 </div>
               </div>
               <div class="row">
                 <div class="col-lg-2 pl"><p>Sub Location</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTSUBLOCATION" id="ASTSUBLOCATION" value="{{ $objHRD->ASTSUBDES }}" class="form-control" readonly maxlength="100" > 
                   <input type="hidden" name="ALID_REF_FROM" id="ALID_REF_FROM" value="{{ $objHRD->ALID_REF_FROM }}" class="form-control" readonly maxlength="100" >
                 </div>

                 <div class="col-lg-2 pl"><p>In case Asset with Employee</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTEMPY" id="ASTEMPY"  value="{{ $objHRD->EMPCODE }}" class="form-control mandatory"  autocomplete="off" readonly/>
                   <input type="hidden" name="ASASTCATID" id="ASASTCATID"  value="{{ $objHRD->WITH_EMPLOYEE }}" class="form-control" autocomplete="off" />
                 </div>
             ...
             <div class="col-lg-2 pl">
               <input type="text" name="REASON_TRANFR" id="REASON_TRANFR" value="{{ $objHRD->REASON }}" class="form-control"  maxlength="100" > 
             </div>
           </div>
             ...
             <div class="col-lg-2 pl">
               <input type="text" name="REMARKS" id="REMARKS" value="{{ $objHRD->REMARKS }}" class="form-control"  maxlength="100"> 
             <input type="hidden" id="focusid" >
             <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
           </div>          
           </div>
...
window.fnApproveData = function (){
    ...
    $.ajax({
        url:'{{ route("transactionmodify",[411,"Approve"])}}',
        type:'POST',
        data:formData,
        success:function(data) {
          if(data.success) {                   
