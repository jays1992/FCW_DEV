...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Quality Inspection against PRO (QIP)</a></div>
      ...
      <div class="inner-form">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
              ...
              <input type="hidden"  name="PNMID_REF" id="PNMID_REF"    class="form-control" autocomplete="off" />
...
$(document).ready(function(e) {
  ...
  var lastdt = <?php echo json_encode($objlastdt[0]->QIPDT); ?>;
  var today = new Date(); 
...
function validateQty(TYPE){
  ...
  if(TYPE =="QI_PICK_QTY" && QI_PICK_QTY !=""){
    ...
    if(parseFloat(REJECTED_QTY) > parseFloat(GRN_REC_QTY)){
      ...
      $("#NoBtn").hide();
      $("#OkBtn1").show();
      $("#AlertMessage").text('Rejected Qty Should Less Then PNM Received Qty.');
      $("#alert").modal('show');
      $("#OkBtn1").focus();
      return false;
    }
    ...
    if( (parseFloat(REJECTED_QTY)+parseFloat(QC_OK_QTY)) > parseFloat(GRN_REC_QTY) ){
      ...
      $("#NoBtn").hide();
      $("#OkBtn1").show();
      $("#AlertMessage").text('QC OK Qty Should not greater then PNM Received Qty.');
      $("#alert").modal('show');
      $("#OkBtn1").focus();
      return false;
    }
