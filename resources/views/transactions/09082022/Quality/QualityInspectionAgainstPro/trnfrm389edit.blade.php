...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Quality Inspection against PRO (QIP)</a>
        </div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="QIGNO" id="QIGNO" VALUE="{{isset($HDR->QIPNO)?$HDR->QIPNO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>Quality Inspection Date</p></div>
            <div class="col-lg-2 pl">
                <input {{$ActionStatus}} type="date" name="QIGDT" id="QIGDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" VALUE="{{isset($HDR->QIPDT)?$HDR->QIPDT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>

            <div class="col-lg-2 pl"><p>QC Process By</p></div>
			      <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="QC_PROCESS_BY_popup" id="txtQC_PROCESS_BY_popup" VALUE="{{isset($HDR->EMP_CODE_DES)?$HDR->EMP_CODE_DES:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl"><p>External Lab Name</p></div>
			      <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="EXT_LABNAME" id="EXT_LABNAME" VALUE="{{isset($HDR->EXT_LABNAME)?$HDR->EXT_LABNAME:''}}" class="form-control"  autocomplete="off"/>
			      </div>

            <div class="col-lg-2 pl"><p>Ref Doc No</p></div>
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="REF_DOCNO" id="REF_DOCNO" VALUE="{{isset($HDR->REF_DOCNO)?$HDR->REF_DOCNO:''}}" class="form-control"  autocomplete="off"/>
			      </div>

            <div class="col-lg-2 pl"><p>PNM No</p></div>
            <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="TEXT_GRNID_REF_DATA" id="TEXT_GRNID_REF_DATA" VALUE="{{isset($HDR->PNM_NO)?$HDR->PNM_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="GRNID_REF" id="GRNID_REF" VALUE="{{isset($HDR->PNMID_REF)?$HDR->PNMID_REF:''}}" class="form-control" autocomplete="off" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="popupITEMID" id="popupITEMID" VALUE="{{isset($HDR->ITEM_CODE_NAME)?$HDR->ITEM_CODE_NAME:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
              ...
              <input type="hidden"  name="PNMID_REF" id="PNMID_REF" VALUE="{{isset($HDR->PNMID_REF)?$HDR->PNMID_REF:''}}" class="form-control" autocomplete="off" />
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="GRN_REC_QTY" id="GRN_REC_QTY" VALUE="{{isset($HDR->PD_QTY)?$HDR->PD_QTY:''}}" class="form-control"  autocomplete="off" readonly />
          </div>

          <div class="col-lg-2 pl"><p>UOM</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="TEXT_UOMID_REF_DATA" id="TEXT_UOMID_REF_DATA" VALUE="{{isset($HDR->UOM_CODE_DES)?$HDR->UOM_CODE_DES:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="QI_PICK_QTY" id="QI_PICK_QTY" VALUE="{{isset($HDR->QI_PICK_QTY)?$HDR->QI_PICK_QTY:''}}" class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Rejected Qty</p></div>
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="REJECTED_QTY" id="REJECTED_QTY" VALUE="{{isset($HDR->REJECTED_QTY)?$HDR->REJECTED_QTY:''}}" class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="REJECTED_STID_REF_popup" id="REJECTED_STID_REF_popup" VALUE="{{isset($HDR->REJECTED_STORE)?$HDR->REJECTED_STORE:''}}" class="form-control mandatory"  autocomplete="off" readonly onclick="store('REJECTED_STID_REF');" />
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="QC_OK_QTY" id="QC_OK_QTY" VALUE="{{isset($HDR->QC_OK_QTY)?$HDR->QC_OK_QTY:''}}"  class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="QC_OK_STID_REF_popup" id="QC_OK_STID_REF_popup" VALUE="{{isset($HDR->QC_OK_STORE)?$HDR->QC_OK_STORE:''}}"  class="form-control mandatory"  autocomplete="off" readonly onclick="store('QC_OK_STID_REF');" />
            ...
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="PENDING_QC_QTY" id="PENDING_QC_QTY" VALUE="{{isset($HDR->PENDING_QC_QTY)?$HDR->PENDING_QC_QTY:''}}"  class="form-control"  autocomplete="off" readonly />
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="PENDING_QC_STID_REF_popup" id="PENDING_QC_STID_REF_popup" VALUE="{{isset($HDR->PENDING_QC_STORE)?$HDR->PENDING_QC_STORE:''}}"  class="form-control mandatory"  autocomplete="off" readonly onclick="store('PENDING_QC_STID_REF');" />
            ...
            <div class="col-lg-2 pl">
              <input {{$ActionStatus}} type="text" name="REMARKS" id="REMARKS" VALUE="{{isset($HDR->REMARKS)?$HDR->REMARKS:''}}"  class="form-control"  autocomplete="off"/>
            </div>

            <div class="col-lg-2 pl"><p>QC Accepted As</p></div>
            <div class="col-lg-2 pl">
              <select {{$ActionStatus}} name="QC_ACCEPTED_AS" id="QC_ACCEPTED_AS" class="form-control"  autocomplete="off">
...
function store(id){
  if(id =="REJECTED_STID_REF"){
    if(parseFloat($("#REJECTED_QTY").val()) > 0){
      $("#stidpopup").show();
    }
  }
  else{
...
$('#Material').on('click','[id*="txtRRID_popup"]',function(event){
  ...
  if($(this).parent().parent().find('[id*="REJECTED"]').val() =='Yes'){
...
function validateForm(saveAction){
  ...
  // }
    ...
    $("#NoBtn").hide();
    $("#OkBtn1").show();
    $("#AlertMessage").text('PNM Received Qty should not greater than (QC OK Qty + Rejected Qty).');
    $("#alert").modal('show');
    $("#OkBtn1").focus();
    return false;
  }
