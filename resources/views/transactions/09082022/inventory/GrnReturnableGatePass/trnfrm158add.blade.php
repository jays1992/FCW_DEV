...
@section('content')
	...
	<div class="inner-form">
		...
		<div class="row">
			<div class="col-lg-1 pl"><p>GRN No</p></div>
			...
			<div class="col-lg-1 pl"><p>GRN Date</p></div>
			<div class="col-lg-2 pl">
			...
			<div class="tab-content">
				...
				<div id="Material" class="tab-pane fade in active">
                  ...
                  <th>Remarks</th>
                          ...
                          <td><input type="text" name="txtRGP_popup_0" id="txtRGP_popup_0" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                          ...
                          <td>
                            <select name="NATURE_0" id="NATURE_0" class="form-control"  autocomplete="off" >
              ...
              @foreach($objUdfData as $uindex=>$uRow)
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->GRNRGPID}}" autocomplete="off"   /></td>
...
function getStoreDetails(ITEMID_REF,ROW_ID,RGP_NO){
  ...
  $.ajax({
      ...
      type:'POST',
      data:{ITEMID_REF:ITEMID_REF,RGP_NO:RGP_NO,ROW_ID:ROW_ID,ITEMROWID:ITEMROWID,ACTION_TYPE:'ADD',UOMID_REF:UOMID_REF},
      success:function(data) {
