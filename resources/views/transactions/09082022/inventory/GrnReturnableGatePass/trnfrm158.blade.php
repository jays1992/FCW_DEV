...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->GRNID}}" value="{{$val->GRNID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->GRN_DT) && $val->GRN_DT !='' && $val->GRN_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->GRN_DT)):''}}" ></td>
