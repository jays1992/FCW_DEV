  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="ST_ADJUST_DOCNO" id="ST_ADJUST_DOCNO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
         

          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
          <input type="text" name="ST_ADJUST_DOCNO" id="ST_ADJUST_DOCNO" value="{{ old('ST_ADJUST_DOCNO') }}" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
          @else
            <input type="text" name="ST_ADJUST_DOCNO" id="ST_ADJUST_DOCNO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
          <span class="text-danger" id="ERROR_ST_ADJUST_DOCNO"></span>
        </div>
              
        <div class="col-lg-2 pl"><p>Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="ST_ADJUST_DOCDT" id="ST_ADJUST_DOCDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('ST_ADJUST_DOCDT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
          <span class="text-danger" id="ERROR_ST_ADJUST_DOCDT"></span>
        </div>


        <div class="col-lg-2 pl"><p>Adjustment Type</p></div>
        <div class="col-lg-2 pl">
          <select name="ST_ADJUST_TYPE" id="ST_ADJUST_TYPE" class="form-control" >
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
				  ...
				  <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input type="text"  style="width:100px;" name="QTY_0" id="QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                    <td><input type="text" style="width:100px;" type="text" name="RATE_0" id="RATE_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly style="width:130px;text-align:right;" /></td>
                    <td><input type="text" style="width:100px;" name="VALUE_0" id="VALUE_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)"   autocomplete="off" readonly  style="width:130px;text-align:right;" /></td>
...
function checkDuplicateCode(){
  ...
  $.ajax({
      ...
      success:function(data) {
          if(data.exists) {
              $(".text-danger").hide();
              showError('ERROR_ST_ADJUST_DOCNO',data.msg);
              $("#ST_ADJUST_DOCNO").focus();
          }
          else{
            $("#alert").modal('show');
...
$(document).ready(function(e) {
  ...
  var lastdt = <?php echo json_encode($objlastdt[0]->ST_ADJUST_DOCDT); ?>;
  var today = new Date(); 
