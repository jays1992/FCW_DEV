...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Knock Off</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->KNOWOFFID}}" value="{{$val->KNOWOFFID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->KNOCKOFF_DT) && $val->KNOCKOFF_DT !='' && $val->KNOCKOFF_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->KNOCKOFF_DT)):''}}" ></td>
                <td>{{isset($val->KNOCKOFF_NO) && $val->KNOCKOFF_NO !=''?$val->KNOCKOFF_NO:''}}</td>
                <td>{{isset($val->KNOCKOFF_DT) && $val->KNOCKOFF_DT !='' && $val->KNOCKOFF_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->KNOCKOFF_DT)):''}}</td>
                <td>{{isset($val->VENDOR_CUSTOMER) && $val->VENDOR_CUSTOMER !=''?$val->VENDOR_CUSTOMER:''}}</td>
