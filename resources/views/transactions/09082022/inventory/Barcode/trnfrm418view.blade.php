...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Serial No & Barcode (IN)</a>
        </div>
...
<form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
  ...
  <div class="container-fluid filter">
      ...
      <div class="col-lg-2 pl"><p>Doc No*</p></div>
        ...
        <div class="col-lg-2 pl">
        <input {{$ActionStatus}} type="date" name="BRC_DT" id="BRC_DT" value="{{isset($objResponse->BRC_DT) && $objResponse->BRC_DT !=''?$objResponse->BRC_DT:''}}" class="form-control mandatory" >
