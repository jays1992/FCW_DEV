...
<form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
  @csrf
  {{isset($objResponse->BRCID[0]) ? method_field('PUT') : '' }}
  ...
  <div class="container-fluid filter">
      ...
      <div class="col-lg-2 pl"><p>Doc No*</p></div>
          ...
          <input {{$ActionStatus}} type="text" name="BRC_NO" id="BRC_NO" value="{{isset($objResponse->BRC_NO) && $objResponse->BRC_NO !=''?$objResponse->BRC_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
			
              
        <div class="col-lg-2 pl"><p>Date*</p></div>
        <div class="col-lg-2 pl">
        <input {{$ActionStatus}} type="date" name="BRC_DT" id="BRC_DT" value="{{isset($objResponse->BRC_DT) && $objResponse->BRC_DT !=''?$objResponse->BRC_DT:''}}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory" >
          <span class="text-danger" id="ERROR_BRC_DT"></span>

        </div>
        <div class="col-lg-2 pl"><p>Document Type*</p></div>
        <div class="col-lg-2 pl">
          <select name="DOCTYPE" {{$ActionStatus}} id="DOCTYPE" class="form-control" onchange="getDocType();">
          <option  value="">Select Document Type</option>
          <option  value="GRN"  {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='GRN' ? 'selected':''}} >GRN against GE</option>
          <option  value="RGP" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='RGP' ? 'selected':''}}>GRN against RGP</option>
          <option  value="STADJUSTMENT" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='STADJUSTMENT' ? 'selected':''}}>STockAdjustment</option>
          <option  value="STTOSTTRANSFER" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='STTOSTTRANSFER' ? 'selected':''}}>Stock to Stock Transfer</option>
          <option  value="PMOVEMENT" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='PMOVEMENT' ? 'selected':''}}>Production & Movement</option>
          <option  value="JOBWORKGRN" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='JOBWORKGRN' ? 'selected':''}}>Job Work GRN</option>
          <option  value="SALESRETURN" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='SALESRETURN' ? 'selected':''}}>Sales Return</option>
          <option  value="CSV" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='CSV' ? 'selected':''}}>CSV</option>
          <option  value="DSV" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='DSV' ? 'selected':''}}>DSV</option>
          <option  value="PR" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='PR' ? 'selected':''}}>Production Return</option>
          <option  value="IO" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='IO' ? 'selected':''}}>Item Opening</option>
       ...
       <!-- <div class="row">
        <div class="col-lg-1 pl"><p>GRN against GE</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}}  name="DOCTYPE" id="GRN" value="GRN"  onchange="DOCType('GRN');" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='GRN' ? 'checked':''}}   />
        </div>

        <div class="col-lg-1 pl"><p>GRN against RGP</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="RGP" value="RGP" onchange="DOCType('RGP');" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='RGP' ? 'checked':''}}  />    
        </div>

        <div class="col-lg-1 pl"><p>STockAdjustment</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="STADJUSTMENT" value="STADJUSTMENT" onchange="DOCType('STADJUSTMENT');" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='STADJUSTMENT' ? 'checked':''}}  />    
        </div>
        <div class="col-lg-2 pl"><p>Stock to Stock Transfer</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="STTOSTTRANSFER" value="STTOSTTRANSFER" onchange="DOCType('STTOSTTRANSFER');" {{ isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='STTOSTTRANSFER' ? 'checked':''}}  />    
        </div>
        <div class="col-lg-2 pl"><p>Production & Movement</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="PMOVEMENT" value="PMOVEMENT" onchange="DOCType('PMOVEMENT');"  {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='PMOVEMENT' ? 'checked':''}}  />    
        </div>
      ...
      <div class="row">
      <div class="col-lg-1 pl"><p>job work grn</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="JOBWORKGRN" value="JOBWORKGRN" onchange="DOCType('JOBWORKGRN');" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='JOBWORKGRN' ? 'checked':''}}  />    
        </div>
        <div class="col-lg-1 pl"><p>Sales Return</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="SALESRETURN" value="SALESRETURN" onchange="DOCType('SALESRETURN');"  {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='SALESRETURN' ? 'checked':''}} />    
        </div>
        <div class="col-lg-1 pl"><p>CSV</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="CSV" value="CSV" onchange="DOCType('CSV');"  {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='CSV' ? 'checked':''}} />    
        </div>
        <div class="col-lg-2 pl"><p>DSV</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="DSV" value="DSV" onchange="DOCType('DSV');"  {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='DSV' ? 'checked':''}} />    
        </div>
        <div class="col-lg-2 pl"><p>Production Return</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}} name="DOCTYPE" id="PR" value="PR" onchange="DOCType('PR');" {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='PR' ? 'checked':''}} />    
        </div>
      </div>

    <div class="row">
      <div class="col-lg-1 pl"><p>Item Opening</p></div>
        <div class="col-lg-1 pl">
            <input type="checkbox" {{$ActionStatus}}  name="DOCTYPE" id="IO" value="IO" onchange="DOCType('IO');"  {{isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='IO' ? 'checked':''}} />    
        </div>
        ...
        <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
              ...
              @foreach($objMAT as $key => $row)
                         ...
                         <td><input  type="text" {{$ActionStatus}} name={{"Main_popupITEMID_".$key}} id={{"Main_popupITEMID_".$key}}  class="form-control"  autocomplete="off" value="{{ $row->ICODE }}"  readonly/></td>
                          ...
                          <td><input type="text" {{$ActionStatus}} name={{"Main_RECEIVED_QTY_".$key}} id={{"Main_RECEIVED_QTY_".$key}}  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly value="{{ $row->RECEIVED_QTY }}"  /></td>
                          ...
                          <td><input type="checkbox" name={{"SERIAL_NO_".$key}} id={{"SERIAL_NO_".$key}}  {{ $row->SERIALNOAPL==1 ? 'checked':'' }} onclick="return false"  style="margin-left: 50%;"></td>
                          <td><input type="checkbox" name={{"BARCODE_".$key}} id={{"BARCODE_".$key}} {{ $row->BARCODEAPL==1 ? 'checked':'' }}  onclick="return false" style="margin-left: 50%;"></td>
            ...
            <?php
                  ...
                  echo'<table id="example8" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                        ...
                        $SERIALNO_MODE=isset($row_data->SERIALNO_MODE) && $row_data->SERIALNO_MODE == "AUTOMATIC" ? "readonly":""; 
                           ...
                           value="'.number_format($row_data->RECEIVED_QTY,2).'"  /></td>';
                           ...
                           echo '<td '.$checkCompany.' ><input type="text" '.$ActionStatus.' name="REQ_QTY_'.$index.'" class="form-control"    id="REQ_QTY_'.$index.'"   value="'.$row_data->QTY.'"  /></td>';
   
                           echo '<td ><input type="text" '.$ActionStatus.'  name="REQ_SERIALNO_'.$index.'" class="form-control"   id="REQ_SERIALNO_'.$index.'"   value="'.$row_data->SERIALNUMBER.'" 
                          '.$SERIALNO_MODE.'
                           /></td>';        
...
function validateForm(actionType,actionMsg){
  ...
  $('#material_item').find('.participantRow8').each(function(){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#BRC_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
function get_materital_item(){
    ...
    var recordid            =   "{{$objResponse->BRCID}}";
    var  item_array         =   [];
    var  main_item          =   [];
    var  main_itemid        =   [];
    var  alt_qty            =   [];
    ...
    if(Main_ITEMID_REF!=''){
      main_itemid.push(Main_ITEMID_REF);
    }
    if(Main_ITEMID_REF!=''){
      alt_qty.push(Main_ITEMID_REF+"_"+Alt_RECEIVED_QTY);
    ...
    var unirowid_val      =   $(this).find('[id*="main_item_rowid"]').val();    
    var txtSUBITEM_popup  =   $(this).find('[id*="txtSUBITEM_popup_"]').val();
    var SUBITEM_NAME      =   $(this).find('[id*="SUBITEM_NAME_"]').val();    
    var REQ_ITEMID_REF    =   $(this).find('[id*="REQ_ITEMID_REF_"]').val();
    var PACKUOM           =   $(this).find('[id*="PACKUOM_"]').val();
    var PACKUOMID_REF     =   $(this).find('[id*="PACKUOMID_REF_"]').val();
    var REQ_QTY           =   $(this).find('[id*="REQ_QTY_"]').val();
    var REQ_SERIALNO      =   $(this).find('[id*="REQ_SERIALNO_"]').val();
    var ALPS_PART_NO      =   $(this).find('[id*="ALPS_PART_NO_"]').val();   
    var CUSTOMER_PART_NO  =   $(this).find('[id*="CUSTOMER_PART_NO_"]').val();   
    var OEM_PART_NO       =   $(this).find('[id*="OEM_PART_NO_"]').val();   
    var MAIN_UOMCODE      =   $(this).find('[id*="REQ_MAIN_UOM_"]').val();   
    var MAIN_UOMID_REF    =   $(this).find('[id*="REQ_UOMID_REF_"]').val(); 
    var SERIALNO_MODE     =   $(this).find('[id*="SERIALNO_MODE_"]').val();  
    var REQ_RETURN_QTY    =   $(this).find('[id*="REQ_RETURN_QTY_"]').val();
     
  if(REQ_ITEMID_REF!=''){
    subitem_array.push({'id':unirowid_val,
        "txtSUBITEM_popup":txtSUBITEM_popup,
        "SUBITEM_NAME":SUBITEM_NAME,
        "REQ_ITEMID_REF":REQ_ITEMID_REF,
        "PACKUOM":PACKUOM,
        "PACKUOMID_REF":PACKUOMID_REF,
        "REQ_QTY":REQ_QTY,
        "REQ_SERIALNO":REQ_SERIALNO,
        "ALPS_PART_NO":ALPS_PART_NO,
        "CUSTOMER_PART_NO":CUSTOMER_PART_NO,
        "OEM_PART_NO":OEM_PART_NO,
        "MAIN_UOMCODE":MAIN_UOMCODE,
        "MAIN_UOMID_REF":MAIN_UOMID_REF,
        "SERIALNO_MODE":SERIALNO_MODE,
        "REQ_RETURN_QTY":REQ_RETURN_QTY
        });
        sub_itemid.push(REQ_ITEMID_REF);
      ...
      type:'POST',
      data:{
      item_array:item_array,checkCompany:checkCompany,subitem_array:subitem_array,sub_itemid:sub_itemid,main_itemid:main_itemid,alt_qty:alt_qty,action_type:action_type,recordid:recordid,doctype:doctype
      },
      success:function(data) {
