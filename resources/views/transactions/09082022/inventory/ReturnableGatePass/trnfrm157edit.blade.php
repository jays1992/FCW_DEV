	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input {{$ActionStatus}} type="text" name="RGP_NO" id="RGP_NO" value="{{isset($objResponse->RGP_NO) && $objResponse->RGP_NO !=''?$objResponse->RGP_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			...
			<div class="col-lg-2 pl">
			    <input {{$ActionStatus}} type="date" name="RGP_DT" id="RGP_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($objResponse->RGP_DT) && $objResponse->RGP_DT !=''?$objResponse->RGP_DT:''}}" class="form-control mandatory" >
      </div>
