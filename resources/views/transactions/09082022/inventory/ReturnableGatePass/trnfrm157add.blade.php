	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                <input type="text" name="RGP_NO" id="RGP_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
          

            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                <input type="text" name="RGP_NO" id="RGP_NO" value="{{ old('RGP_NO') }}" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
            @else
              <input type="text" name="RGP_NO" id="RGP_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @endif

            <span class="text-danger" id="ERROR_RGP_NO"></span>
			</div>
			
			<div class="col-lg-1 pl"><p>RGP Date</p></div>
			<div class="col-lg-2 pl">
				    <input type="date" name="RGP_DT" id="RGP_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('RGP_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
            </div>
      ...
      <div class="col-lg-1 pl"><p>EDA</p></div>
			<div class="col-lg-2 pl">
			    <input type="date" name="EDA" id="EDA" value="{{ old('EDA') }}" class="form-control mandatory" >
      </div>
      ...
      <div class="col-lg-1 pl"><p>Direct</p></div>
			<div class="col-lg-2 pl">
        <input type="checkbox" name="RGP_STATUS" id="RGP_STATUS" value='0' checked onchange="direct()" >
			...
			<div class="tab-content">
				...
				<div id="Material" class="tab-pane fade in active">
                  ...
                  <th>Remarks</th>
                          ...
                          <td><input type="text" name="SE_QTY_0" id="SE_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"  /></td>
              ...
              @foreach($objUdfData as $uindex=>$uRow)
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->UDFRGPID}}" autocomplete="off"   /></td>
...
function validateForm(){
 ...
 if(RGP_NO ===""){
  ...
  if(jQuery.inArray("false", allblank13) !== -1){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#RGP_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
$.ajax({
    ...
    success:function(data) {
        if(data.exists) {
            $(".text-danger").hide();
            showError('ERROR_RGP_NO',data.msg);
            $("#RGP_NO").focus();
        }
        else{
          $("#alert").modal('show');
