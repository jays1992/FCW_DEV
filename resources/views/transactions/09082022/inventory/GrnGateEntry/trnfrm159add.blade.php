...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Goods Receipt Note <br/>against GE</a>
                </div>
	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                <input type="text" name="GRN_NO" id="GRN_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
            

            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                <input type="text" name="GRN_NO" id="GRN_NO" value="{{ old('GRN_NO') }}" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
            @else
              <input type="text" name="GRN_NO" id="GRN_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @endif

            <span class="text-danger" id="ERROR_GRN_NO"></span>
			</div>
			
			<div class="col-lg-2 pl"><p>GRN Date*</p></div>
			<div class="col-lg-2 pl">
				  <input type="date" name="GRN_DT" id="GRN_DT" value="{{ old('GRN_DT') }}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
      ...
      <div class="col-lg-4 pl">
        ...
        <div class="col-lg-1 pl">
          <input type="radio" name="GRNTYPE" id="PO" value="PO" onchange="getGgType('PO')"  />
        </div>

        <div class="col-lg-2 pl"><p>IPO</p></div>
        <div class="col-lg-1 pl">
          <input type="radio" name="GRNTYPE" id="IPO" value="IPO" onchange="getGgType('IPO')" />
        </div>

        <div class="col-lg-2 pl"><p>BPO</p></div>
        <div class="col-lg-1 pl">
          <input type="radio" name="GRNTYPE" id="BPO" value="BPO" onchange="getGgType('BPO')" />
        </div>

        <input type="hidden" name="GE_TYPE" id="GE_TYPE" value="PO" >   
      ...
      <div class="col-lg-2 pl"><p>Vendor*</p></div>
			<div class="col-lg-2 pl">
          <input type="text" name="VID_REF_popup" id="txtdep_popup" class="form-control mandatory"  autocomplete="off" readonly/>
	...
	<div class="container-fluid">
        ...
        <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
                  ...
                  <th>Remarks</th>
                          ...
                          <td><input style="width:100px;" type="text" name="txtRGP_popup_0" id="txtRGP_popup_0" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                          <td hidden><input type="hidden" name="RGP_NO_0" id="RGP_NO_0" class="form-control" autocomplete="off" /></td>
                          
                          <td><input style="width:100px;" type="text" name="txtPO_popup_0" id="txtPO_popup_0" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                          <td hidden><input type="hidden" name="POID_REF_0" id="POID_REF_0" class="form-control" autocomplete="off" /></td>
                          
                          <td hidden><input type="hidden" name="MRSID_REF_0" id="MRSID_REF_0" class="form-control" autocomplete="off" /></td>
                          <td hidden><input type="hidden" name="PIID_REF_0" id="PIID_REF_0" class="form-control" autocomplete="off" /></td>
                          <td hidden><input type="hidden" name="RFQID_REF_0" id="RFQID_REF_0" class="form-control" autocomplete="off" /></td>
                          <td hidden><input type="hidden" name="VQID_REF_0" id="VQID_REF_0" class="form-control" autocomplete="off" /></td>
                          <td hidden><input type="hidden" name="IPOID_REF_0" id="IPOID_REF_0" class="form-control" autocomplete="off" /></td>
                          <td hidden><input type="hidden" name="BPOID_REF_0" id="BPOID_REF_0" class="form-control" autocomplete="off" /></td>

                          <td><input style="width:100px;" type="text" name="popupITEMID_0" id="popupITEMID_0" class="form-control"  autocomplete="off"  readonly/></td>
                        
                          <td {{$AlpsStatus['hidden']}}><input type="text" name="Alpspartno_0" id="Alpspartno_0" class="form-control"  autocomplete="off" value="" readonly/></td>
                          <td {{$AlpsStatus['hidden']}}><input type="text" name="Custpartno_0" id="Custpartno_0" class="form-control"  autocomplete="off" value="" readonly/></td>
                          <td {{$AlpsStatus['hidden']}}><input type="text" name="OEMpartno_0"  id="OEMpartno_0" class="form-control"  autocomplete="off"  value="" readonly/></td>

                          <td hidden><input type="hidden" name="ITEMID_REF_0" id="ITEMID_REF_0" class="form-control" autocomplete="off" /></td>
                          <td><input style="width:200px;" type="text" name="ItemName_0" id="ItemName_0" class="form-control"  autocomplete="off"  readonly/></td>
                          
                          <td><input type="text" name="PO_PENDING_QTY_0" id="PO_PENDING_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                         

                          <td><input type="text" name="SE_QTY_0" id="SE_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                          ...
                          <td align="center"><a class="btn BinEvent" id="BIN_EVENT_0" onclick="getBin(this.id)"><i class="fa fa-clone"></i></a></td>

                          <td><input type="text" readonly name="RECEIVED_QTY_MU_0" id="RECEIVED_QTY_MU_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" onkeyup="getRate(this.id)" maxlength="13"  autocomplete="off"   /></td>
                          ...
                          <td><input type="text" name="RECEIVED_QTY_AU_0" id="RECEIVED_QTY_AU_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly maxlength="13"  autocomplete="off"   /></td>
                          
                          <td><input type="text" name="SHORT_QTY_0" id="SHORT_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"  readonly  /></td>
                          

                          <td><input type="text" name="RATE_0" id="RATE_0" class="form-control" onkeyup="getActionEvent()" onkeypress="return isNumberDecimalKey(event,this)" onkeyup="getRate(this.id)"   autocomplete="off" style="width:100px;" /></td>
                          <td><input type="text" name="AMOUNT_0" id="AMOUNT_0" class="form-control"  autocomplete="off"  readonly style="width:100px;"  /></td>
                          ...
                          <td hidden><input type="text" name="Itemspec_0" id="Itemspec_0" class="form-control"  autocomplete="off"  /></td>
                          
                          <!--
                          <td><input  class="form-control w-100" type="date" name="EDD_0" id="EDD_0" autocomplete="off"  ></td>
                          -->

                          <td><input style="width:200px;" type="text" name="STORE_NAME_0" id="STORE_NAME_0"  class="form-control" readonly autocomplete="off" ></td>
                          <td hidden><input style="width:200px;" type="text" name="STORE_ID_0" id="STORE_ID_0"  class="form-control" readonly autocomplete="off" ></td>
                          <td hidden><input style="width:200px;" type="text" name="HIDDEN_BIN_0" id="HIDDEN_BIN_0"  class="form-control" readonly autocomplete="off" ></td>
                          <td hidden><input style="width:200px;" type="text" name="CHECK_BIN_DATA_0" id="CHECK_BIN_DATA_0"  class="form-control" readonly autocomplete="off" ></td>
                          

                          <td><input style="width:200px;" type="text" name="REMARKS_0" id="REMARKS_0" class="form-control" autocomplete="off" ></td>
              ...
              @foreach($objUdfData as $uindex=>$uRow)
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->GRNGEID}}" autocomplete="off"   /></td>
  ...
  <div class="modal-dialog modal-md">
    ...
    <input type="text" id="stnamesearch" autocomplete="off" onkeyup="STNameFunction()">
      ...
      <table id="STCodeTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="stidcode_{{ $key }}" class="clsstid">
          <td width="50%">{{ $val-> STCODE }}
          <input type="hidden" id="txtstidcode_{{ $key }}" data-desc="{{ $val-> STCODE }} - {{ $val-> NAME }}"  value="{{ $val-> STID }}"/>
          </td>
          <td>{{ $val-> NAME }}</td>
        </tr>
        @endforeach
...
<div id="POpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md" style="width:60%">
    ...
    <div class="modal-body">
	  ...
	  <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar">
    <table id="POTable" class="display nowrap table  table-striped table-bordered"  style="width:100%;">
    <thead>
          <tr id="none-select" class="searchalldata" hidden>
    ...
    <th style="width:10%;">Select</th>
      <th style="width:30%;">PO/IPO/BPO No</th>
    ...
    <tr>
        ...
        <td style="width:30%;"><input type="text" id="POcodesearch" class="form-control"  autocomplete="off" onkeyup="POCodeFunction()"></td>
        <td style="width:30%;"><input type="text" id="POnamesearch" class="form-control" autocomplete="off" onkeyup="PONameFunction()"></td>
        <td style="width:30%;"><input type="text" id="PODepartmentsearch" class="form-control" autocomplete="off" onkeyup="PODepartmentFunction()"></td>
      </tr>
    </tbody>
    </table>
...
$(document).ready(function(e) {
  ...
  //alert(COMPANY_STATUS); 

var Material = $("#Material").html(); 
$('#hdnmaterial').val(Material);
var lastdt = <?php echo json_encode($objlastdt[0]->GRN_DT); ?>;
var today = new Date(); 
...
var materialclone = $('#Material').html();
$('#hdnmaterial').val(materialclone);
...
function checkDuplicateCode(){
  ...
  $.ajax({
      ...
      success:function(data) {
          if(data.exists) {
              $(".text-danger").hide();
              showError('ERROR_GRN_NO',data.msg);
              $("#GRN_NO").focus();
          }
          else{
            $("#alert").modal('show');
...
function PODepartmentFunction() {
  var input, filter, table, tr, td, i, txtValue;
  input = document.getElementById("PODepartmentsearch");
  filter = input.value.toUpperCase();
  table = document.getElementById("POTable2");
  tr = table.getElementsByTagName("tr");
  for (i = 0; i < tr.length; i++) {
...
$('#Material').on('click','[id*="txtPO_popup"]',function(event){
  ...
  if(VID_REF ===""){
    ...
    $.ajax({
        url:'{{route("transaction",[$FormId,"getPoCodeNo"])}}',
        type:'POST',
...
function getBin(textid){
  ...
  if(getBinApplicable(ITEMID_REF) !='1'){
    ...
    $.ajax({
      url:'{{route("transaction",[$FormId,"getBinDetails"])}}',
      type:'POST',
      data:{STID:stid,STQTY:stqt,MATERIAL_ROWID:textid,RACK_QTY:RACK_QTY,BINARRAY:BINARRAY,ACTION_TYPE:'ADD'},
      success:function(data) {
        $("#BinTable").html(data);     
        $("#BinModal").show();    
      },
...
function getBinApplicable(ITEMID_REF){
  ...
  var posts = $.ajax({
			url:'{{route("transaction",[$FormId,"getBinApplicable"])}}',
			type:'POST',
			async: false,
			dataType: 'json',
