...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Assembling/Dissembling</a></div>
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="DOC_NO" id="DOC_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
         
          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
          <input type="text" name="DOC_NO" id="DOC_NO" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
          @else
            <input type="text" name="DOC_NO" id="DOC_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          @endif
        </div>
              
        <div class="col-lg-1 pl"><p>Doc Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="DOC_DATE" id="DOC_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>

        <div class="col-lg-1 pl"><p>Type</p></div>
        <div class="col-lg-2 pl">
          <select name="TYPE" id="TYPE" class="form-control" >
            <option value="ASSEMBLING">ASSEMBLING</option><!-- OUT -->
            <option value="DISSEMBLING">DISSEMBLING</option><!-- IN -->
          </select>
        </div>

        <div class="col-lg-1 pl"><p>Item</p></div>
        <div class="col-lg-2 pl">
          <input type="text"    name="MAIN_ITEMID_NAME" id="MAIN_ITEMID_NAME" class="form-control" readonly >
          <input type="hidden"  name="MAIN_ITEMID_REF"  id="MAIN_ITEMID_REF"  class="form-control" >
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="MAIN_UOM" id="MAIN_UOM" class="form-control" readonly >
          <input type="hidden" name="MAIN_UOM_REF" id="MAIN_UOM_REF" class="form-control" readonly >
        </div>

        <div class="col-lg-1 pl"><p>Qty</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="MAIN_QTY" id="MAIN_QTY" value="1" class="form-control" onkeypress="return isNumberKey(event,this)" >
        </div>

        <div class="col-lg-1 pl"><p>Store</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="STID_REF_NAME" id="STID_REF_NAME" onclick="modal('show')" class="form-control mandatory"  autocomplete="off" readonly/>
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
				  ...
				  <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input type="text"   name="QTY_0" id="QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                    <td><input type="text"  type="text" name="RATE_0" id="RATE_0" class="form-control three-digits" onkeyup="getValue()" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                    <td><input type="text"  name="VALUE_0" id="VALUE_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)"   autocomplete="off" readonly  /></td>
...
function validateForm(){
  ...
  if(DOC_NO ===""){
    ...
    else if(checkPeriodClosing('{{$FormId}}',$("#DOC_DATE").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
$(document).ready(function(e) {
  ...
  var lastdt = <?php echo json_encode($objlastdt[0]->ADSMDT); ?>;
  var today = new Date(); 
