...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Material Issue Slip (MIS)</a>
                </div>
    ...
    <form id="trn_frm_mis" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
    <div class="container-fluid filter">

	<div class="inner-form">
	
		<div class="row">
			<div class="col-lg-2 pl"><p>MIS No <strong>*</strong></p></div>
			<div class="col-lg-2 pl">
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
              <input type="text" name="MIS_NO" id="MIS_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
              <input type="text" name="MIS_NO" id="MIS_NO" value="{{ old('MIS_NO') }}" class="form-control mandatory" maxlength="{{ isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:'' }}" autocomplete="off" style="text-transform:uppercase"  >
            @else
              <input type="text" name="MIS_NO" id="MIS_NO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            @endif

            <span class="text-danger" id="ERROR_MIS_NO"></span>
			</div>
			
			<div class="col-lg-2 pl"><p>MIS Date <strong>*</strong></p></div>
			<div class="col-lg-2 pl">
				    <input type="date" name="MIS_DT" id="MIS_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('MIS_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
            </div>


      <div class="col-lg-2 pl"><p>Department <strong>*</strong></p></div>
			<div class="col-lg-2 pl">
			...
			<div class="tab-content">
				...
				<div id="Material" class="tab-pane fade in active">
                  ...
                  <th>Remarks</th>
                          ...
                          <td hidden><input type="text" name="PO_PENDING_QTY_0" id="PO_PENDING_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                          ...
                          <td><input type="text" name="RECEIVED_QTY_MU_0" id="RECEIVED_QTY_MU_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"   /></td>
              ...
              @foreach($objUdfData as $uindex=>$uRow)
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->UDFMISID}}" autocomplete="off"   /></td>
...
<div id="dpidpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
        ...
        <td class="ROW2"><input type="text" id="dpcodesearch" autocomplete="off" class="form-control" onkeyup="DPCodeFunction()"></td>
        <td class="ROW3"><input type="text" id="dpnamesearch" autocomplete="off" class="form-control" onkeyup="DPNameFunction()"></td>
      </tr>
    </tbody>
    </table>
...
<div id="RGPpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
        ...
        <td style="width:30%;"><input type="text" id="RGPcodesearch" autocomplete="off" class="form-control" onkeyup="RGPCodeFunction()"></td>
        <td style="width:30%;"><input type="text" id="RGPnamesearch" autocomplete="off" class="form-control" onkeyup="RGPNameFunction()"></td>
        <td style="width:30%;"><input type="text" id="ReqUsernamesearch" autocomplete="off" class="form-control" onkeyup="ReqUserNameFunction()"></td>
      </tr>
    </tbody>
    </table>
...
var lastdt = <?php echo json_encode($objlastdt[0]->MIS_DT); ?>;
var today = new Date(); 
...
function checkDuplicateCode(){
  ...
  $.ajax({
      ...
      success:function(data) {
          if(data.exists) {
              $(".text-danger").hide();
              showError('ERROR_MIS_NO',data.msg);
              $("#MIS_NO").focus();
          }
          else{
            $("#alert").modal('show');
...
function ReqUserNameFunction() {
  var input, filter, table, tr, td, i, txtValue;
  input = document.getElementById("ReqUsernamesearch");
  filter = input.value.toUpperCase();
  table = document.getElementById("RGPTable2");
  tr = table.getElementsByTagName("tr");
  for (i = 0; i < tr.length; i++) {
