      ...
      <div class="inner-form">
        ...
        <div class="row">
            ...
            @if($objBDS->SYSTEM_GRSR == "1")
                <input type="text" name="BDSL_NO" id="BDSL_NO" value="{{ $objBDSO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            @endif
            @if($objBDS->MANUAL_SR == "1")
                <input type="text" name="BDSL_NO" id="BDSL_NO" value="{{ old('BDSL_NO') }}" class="form-control mandatory" maxlength="{{$objBDS->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="BDSL_DATE" id="BDSL_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('BDSL_DATE') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
