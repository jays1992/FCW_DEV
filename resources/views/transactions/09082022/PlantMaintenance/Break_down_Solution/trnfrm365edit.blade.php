...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Break Down Complaint Solution</a>
        </div>
...
<form id="edit_trn_form" method="POST"  >
 ...
 <div class="container-fluid purchase-order-view">
   ...
   <div class="container-fluid filter">
     ...
     <div class="inner-form">
       ...
       <div class="row">
           ...
           <input type="text" name="BDSL_NO" id="BDSL_NO" value="{{ $objResponse->BDSL_NO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            <input type="hidden" name="BDSL_NO" id="BDSL_NO" value="{{ $objResponse->BDSL_NO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
           
           </div>
           
           <div class="col-lg-2 pl"><p>Solution Date</p></div>
           <div class="col-lg-2 pl">
               <input type="date" name="BDSL_DATE" id="BDSL_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ $objResponse->BDSL_DATE }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
           </div>
           
           <div class="col-lg-2 pl"><p>Complaint Log No</p></div>
           <div class="col-lg-2 pl">
                   <input type="text" name="ComplaintLog_popup" id="txtComplaintLog_popup" value="{{ $objResponseBDComplaints->BDCL_NO }}" class="form-control mandatory"  autocomplete="off"  readonly/>
                   <input type="hidden" name="BDCLID_REF" id="BDCLID_REF" class="form-control" value="{{ $objResponseBDComplaints->BDCL_ID }}" autocomplete="off" />
       ...
       <div class="row">
           ...
           <div class="col-lg-2 pl">
               <input type="date" name="BDCL_DATE" id="BDCL_DATE" class="form-control mandatory" value="{{ $objResponseBDComplaints->BDCL_DATE }}"  autocomplete="off" placeholder="dd/mm/yyyy" readonly/>
           </div>
           
           <div class="col-lg-2 pl"><p>Complaint By</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="COMPLAINT_BY" id="COMPLAINT_BY"  class="form-control mandatory" value="{{ $objResponseBDComplaints->COMPLAINT_BY }}" autocomplete="off" readonly >
           </div>
           
           <div class="col-lg-2 pl"><p>Department</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="DEPARTMENT_NAME" id="DEPARTMENT_NAME" value="{{ $objResponseBDComplaints->DEPARTMENT_CODE }}-{{ $objResponseBDComplaints->DEPARTMENT_NAME }}"  class="form-control mandatory" autocomplete="off" readonly >
               <input type="hidden" name="DEPARTMENTID_REF" id="DEPARTMENTID_REF" value="{{ $objResponseBDComplaints->DEPID_REF }}"  class="form-control mandatory" autocomplete="off" readonly >
           </div>
       </div>
       ...
       <div class="row">
           ...
           <div class="col-lg-2 pl">
               <input type="text" name="PRIORITY_NAME" id="PRIORITY_NAME" class="form-control mandatory" value="{{ $objResponseBDComplaints->PRIORITYCODE }}-{{ $objResponseBDComplaints->PRIORITY_DESC }}"  autocomplete="off" readonly/>
               <input type="hidden" name="PRIORITYID_REF" id="PRIORITYID_REF" class="form-control mandatory" value="{{ $objResponseBDComplaints->PRIORITYID_REF }}"  autocomplete="off" readonly/>
           </div>
           
           <div class="col-lg-2 pl"><p>Machine / Genset Code</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="MACHINE_CODE" id="MACHINE_CODE"  class="form-control mandatory" value="{{ $objResponseBDComplaints->MACHINE_NO }}" autocomplete="off" readonly >
               <input type="hidden" name="MACHINEID_REF" id="MACHINEID_REF"  class="form-control mandatory" value="{{ $objResponseBDComplaints->MACHINEID_REF }}" autocomplete="off" readonly >
           </div>
           
           <div class="col-lg-2 pl"><p>Description</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="MACHINE_NAME" id="MACHINE_NAME"  class="form-control mandatory" value="{{ $objResponseBDComplaints->MACHINE_DESC }}" autocomplete="off" readonly >
           </div>
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Problem Log Detail</p></div>
           <div class="col-lg-8 pl">
               <input type="text" name="PROBLEM_LOG_DET" id="PROBLEM_LOG_DET"  class="form-control mandatory" value="{{ $objResponseBDComplaints->PLOG_DETAILS }}" autocomplete="off" readonly >
           </div>
       </div>
       ...
       <div class="row">
           ...
           <div class="col-lg-2 pl">
               <input type="text" name="REASON_CODE1" id="REASON_CODE1"  class="form-control mandatory" value="{{ $objResponseBDComplaints->REASON1_CODE}}" autocomplete="off" readonly >
               <input type="hidden" name="REASON1_REF" id="REASON1_REF"  class="form-control mandatory" value="{{ $objResponseBDComplaints->BD_REASONID_REF1 }}" autocomplete="off" readonly >
           </div>
           <div class="col-lg-2 pl"><p>Breakdown Reason Description 1</p></div>
           <div class="col-lg-6 pl">
               <input type="text" name="REASON_NAME1" id="REASON_NAME1"  class="form-control mandatory" value="{{ $objResponseBDComplaints->REASON1_DESC }}" autocomplete="off" readonly >
           </div>
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Breakdown Reason Code 2</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="REASON_CODE2" id="REASON_CODE2"  class="form-control mandatory" value="{{ $objResponseBDComplaints->REASON2_CODE }}" autocomplete="off" readonly >
               <input type="hidden" name="REASON2_REF" id="REASON2_REF"  class="form-control mandatory" value="{{ $objResponseBDComplaints->BD_REASONID_REF2 }}" autocomplete="off" readonly >
           </div>
           <div class="col-lg-2 pl"><p>Breakdown Reason Description 1</p></div>
           <div class="col-lg-6 pl">
               <input type="text" name="REASON_NAME2" id="REASON_NAME2"  class="form-control mandatory" value="{{ $objResponseBDComplaints->REASON2_DESC }}" autocomplete="off" readonly >
           </div>
       </div>
       ...
       <div class="row">
           ...
           <div class="col-lg-4 pl">
               <input type="text" name="REMARKS1" id="REMARKS1" class="form-control mandatory"  value="{{ $objResponseBDComplaints->REMARKS_1 }}" autocomplete="off"  />  
           </div>
           <div class="col-lg-2 pl"><p>Remarks 2</p></div>
           <div class="col-lg-4 pl">
               <input type="text" name="REMARKS2" id="REMARKS2" class="form-control mandatory" value="{{ $objResponseBDComplaints->REMARKS_2 }}"  autocomplete="off"  />
           </div>     
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Own Employee</p></div>
           <div class="col-lg-1 pl">
               <input type="checkbox" name="EMPLOYEE_TYPE" id="Chk_OwnEmployee" value="own_employee" {{isset($objResponse) && $objResponse->OWN_EMPLOYEE=='1'?'checked':''}}   />  
           </div>
           <div class="col-lg-2 pl"><p>Outside Resource</p></div>
           <div class="col-lg-1 pl">
               <input type="checkbox" name="EMPLOYEE_TYPE" id="Chk_OutsideResource" value="outside_employee" {{isset($objResponse) && $objResponse->OUTSIDE_RESOURCE=='1'?'checked':''}}  />
           </div>     
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Outsider Name</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="Outsider_Name" id="Outsider_Name" class="form-control mandatory" value="{{ $objResponse->OUTSIDE_RNAME }}"   autocomplete="off"  />  
           </div>
           <div class="col-lg-2 pl"><p>Contact Number</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="Contact_Number" id="Contact_Number" class="form-control mandatory" value="{{ $objResponse->OUTSIDE_CONTACT_NO }}" autocomplete="off"  />
           </div> 
           <div class="col-lg-2 pl"><p>Company Name</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="Company_Name" id="Company_Name" class="form-control mandatory" value="{{ $objResponse->OUTSIDE_COMPANY }}"  autocomplete="off"  />
           </div>    
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Maintenance Person Name 1</p></div>
           <div class="col-lg-2 pl">
       <input type="text" name="EMP_REF1" id="EMP_REF1_popup" class="form-control mandatory" onclick="get_employee('EMP_REF1');" value="{{isset($objResponse) && $objResponse->MAINTENANCE_EMPID_REF1!=''?  $objResponse->EMP1_CODE.'-'.$objResponse->EMP1_NAME :''}}" autocomplete="off" readonly/>
       <input type="hidden" name="EMP_REF1" id="EMP_REF1" class="form-control" value="{{ $objResponse->MAINTENANCE_EMPID_REF1 }}" autocomplete="off" />
           ...
           <div class="col-lg-2 pl">
               <input type="date" name="Main_Start_Date" id="Main_Start_Date" class="form-control mandatory" value="{{ $objResponse->MAINTENANCE_START_DATE }}"  autocomplete="off" placeholder="dd/mm/yyyy"  />
           </div> 
           <div class="col-lg-2 pl"><p>Maintenance Start Time</p></div>
           <div class="col-lg-2 pl">
               <input type="time" name="Main_Start_Time" id="Main_Start_Time" class="form-control mandatory" value="{{ $START_TIME }}"  autocomplete="off"  />
           </div>    
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Maintenance Person Name 2</p></div>
           <div class="col-lg-2 pl">
       <input type="text" name="EMP_REF2" id="EMP_REF2_popup" class="form-control mandatory" value="{{isset($objResponse) && $objResponse->MAINTENANCE_EMPID_REF2!=''?  $objResponse->EMP2_CODE.'-'.$objResponse->EMP2_NAME :''}}" onclick="get_employee('EMP_REF2');" value="{{ $objResponse->BDSL_DATE }}"  autocomplete="off" readonly/>
       <input type="hidden" name="EMP_REF2" id="EMP_REF2" class="form-control" value="{{ $objResponse->MAINTENANCE_EMPID_REF2 }}" autocomplete="off" />
           ...
           <div class="col-lg-6 pl">
               <input type="text" name="Fault_Detect_1" id="Fault_Detect_1" class="form-control mandatory" value="{{ $objResponse->FAULT_DETECT1 }}"  autocomplete="off"  />
           </div>     
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Maintenance Person Name 3</p></div>
           <div class="col-lg-2 pl">
   <input type="text" name="EMP_REF3" id="EMP_REF3_popup" value="{{isset($objResponse) && $objResponse->MAINTENANCE_EMPID_REF3!=''?  $objResponse->EMP3_CODE.'-'.$objResponse->EMP3_NAME :''}}" class="form-control mandatory" onclick="get_employee('EMP_REF3');" autocomplete="off" readonly/>
   <input type="hidden" name="EMP_REF3" id="EMP_REF3" class="form-control" autocomplete="off" value="{{ $objResponse->MAINTENANCE_EMPID_REF3 }}" />
           ...
           <div class="col-lg-6 pl">
               <input type="text" name="Fault_Detect_2" id="Fault_Detect_2" class="form-control mandatory" value="{{ $objResponse->FAULT_DETECT2 }}"  autocomplete="off"  />
           </div>     
       </div>
       <div class="row">	
           <div class="col-lg-2 pl"><p>Checklist No</p></div>
           <div class="col-lg-2 pl">
               <input type="text" name="CHECKLIST_popup" id="txtchecklist_popup" class="form-control mandatory" value="{{ $objResponsechecklists->CHECKLIST_NO }}"  autocomplete="off" readonly/>
           ...
           <div class="col-lg-6 pl">
             <input type="text" name="ChecklistDesc_popup" id="ChecklistDesc_popup" class="form-control" value="{{ $objResponsechecklists->CHECKLIST_DESC }}"  autocomplete="off"  readonly/>
           </div>
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Action Taken 1</p></div>
           <div class="col-lg-4 pl">
               <input type="text" name="Action_Taken1" id="Action_Taken1" class="form-control mandatory" value="{{ $objResponse->ACTION_TAKEN1 }}"  autocomplete="off"  />  
           </div>
           <div class="col-lg-2 pl"><p>Action Taken 2</p></div>
           <div class="col-lg-4 pl">
               <input type="text" name="Action_Taken2" id="Action_Taken2" class="form-control mandatory" value="{{ $objResponse->ACTION_TAKEN2 }}"  autocomplete="off"  />
           </div>     
       </div>
       <div class="row">
           ...
           <div class="col-lg-2 pl">
               <select  class="form-control" name="drpstatus" id="drpstatus" > 
                 ...
                 <option value="Work In Progress" {{isset($objResponse) && $objResponse->BREAKDOWN_STATUS=='Work In Progress'?'selected':''}}>Work In Progress</option>
                 <option value="Completed" {{isset($objResponse) && $objResponse->BREAKDOWN_STATUS=='Completed'?'selected':''}}>Completed</option>
                 <option value="Temporary Solved" {{isset($objResponse) && $objResponse->BREAKDOWN_STATUS=='Temporary Solved'?'selected':''}}>Temporary Solved</option>
               </select>  
           </div>
           <div class="col-lg-2 pl"><p>Maintenance End Date</p></div>
           <div class="col-lg-2 pl">
               <input type="date" name="Main_End_Date" id="Main_End_Date" value="{{ $objResponse->MAINTENANCE_END_DATE }}" class="form-control mandatory"  autocomplete="off" placeholder="dd/mm/yyyy"  />
           </div> 
           <div class="col-lg-2 pl"><p>Maintenance End Time</p></div>
           <div class="col-lg-2 pl">
               <input type="time" name="Main_End_Time" id="Main_End_Time" value="{{ $END_TIME }}" class="form-control mandatory"  autocomplete="off"  />
           </div>     
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Remarks in case of BD Pending</p></div>
           <div class="col-lg-10 pl">
               <input type="text" name="REMARKS_PENDING" id="REMARKS_PENDING" value="{{ $objResponse->REMARKS_PENDING }}" class="form-control mandatory"  autocomplete="off"  />  
           </div>    
       </div>
     </div>
                   ...
                   <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    @foreach($CHECKLIST as $key => $row)
                     <tr  class="participantRow" >
                        ...
                        <td><input type="text" name="MP_CODE[]"  class="form-control" value="{{ $row->MP_CODE }}"  autocomplete="off"  readonly /></td>
         
                        <td><input type="text" name="MP_DESC[]"  class="form-control" value="{{ $row->MP_DESC }}"  autocomplete="off"  readonly /></td>
         
                        <td><input type="text" name="MSP_CODE[]"  class="form-control" value="{{ $row->MSP_CODE }}"  autocomplete="off"  readonly /></td>
         
                        <td><input type="text" name="MSP_DESC[]"  class="form-control" value="{{ $row->MSP_DESC }}"  autocomplete="off"  readonly /></td>
         
                        <td><input type="text" name="STANDARD_VALUE[]"   value="{{ $row->STANDARD_VALUE }}" class="form-control three-digits" maxlength="15"  autocomplete="off"  readonly/></td>

                        <td><input type="text" name="ACTUAL_VALUE[]" id="ACTUAL_VALUE_{{$key}}"  value="{{ $row->ACTUAL_VALUE }}" class="form-control three-digits" maxlength="15"  autocomplete="off"   /></td>

                        <td><input type="text" name="REMARKS[]"  class="form-control" value="{{ $row->Chk_Remarks }}"  autocomplete="off"   /></td>
                        </tr>
                      ...
                      <tbody>
                        ...
                        @foreach($CONSUMELIST as $key => $row)
                          <tr class="participantRow3">
                           ...
                           <td><input type="text" name="SL_NO1_{{$key}}" id="SL_NO1_{{$key}}" class="form-control" autocomplete="off" readonly value="{{$key+1}}" readonly ></td>
                           <td><input type="text" name="SPARE_PARTS_CONSUMED_{{$key}}" id="SPARE_PARTS_CONSUMED_{{$key}}" value="{{$row->SPARE_PART_NAME}}" class="form-control" autocomplete="off" ></td>
                         ...
                         <tr class="participantRow3">
                           ...
                           <td><input type="text" name="SPARE_PARTS_CONSUMED_0" id="SPARE_PARTS_CONSUMED_0" value="" class="form-control" autocomplete="off" ></td>
                           <td align="center" style="width: 100;">
                               <button type="button" class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                               <button type="button" class="btn remove" title="Delete" id="btnremove" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
                           </td>
                   ...
                   <table id="example4" class="display nowrap table table-striped table-bordered itemlist"  style="height:auto !important; width:50%">
                    ...
                    @foreach($RETURNLIST as $key => $row)
                      ...
                      <tr class="participantRow4">
                         <td><input type="text" name="SL_NO2_{{$key}}" id="SL_NO2_{{$key}}" class="form-control" autocomplete="off" readonly value="{{$key+1}}" readonly ></td>
                           <td><input type="text" name="SPARE_PART_NAME_{{$key}}" id="SPARE_PART_NAME_{{$key}}" value="{{$row->SPARE_PART_NAME}}" class="form-control" autocomplete="off" ></td>
                           <td><input type="text" name="SPARE_RETURN_TO_{{$key}}" id="SPARE_RETURN_TO_{{$key}}" class="form-control" value="{{$row->SPARE_RETURN_TO}}" autocomplete="off" ></td>
                           <td align="center" style="width: 100;">
                               <button type="button" class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                               <button type="button" class="btn remove" title="Delete" id="btnremove" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
                           </td>
                         ...
                         <td><input type="text" name="SL_NO2_0" id="SL_NO2_0" class="form-control" autocomplete="off" readonly value="1" readonly ></td>
                           ...
                           <td><input type="text" name="SPARE_RETURN_TO_0" id="SPARE_RETURN_TO_0" class="form-control" value="" autocomplete="off" ></td>
                           <td align="center" style="width: 100;">
                               <button type="button" class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                               <button type="button" class="btn remove" title="Delete" id="btnremove" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
                           </td>
...
$("#TIME").val(time);
  ...
  // var lastdt = <?php echo json_encode($objResponse->BDSL_DATE); ?>;
  // var today = new Date(); 
  ...
  var bdsl = <?php echo json_encode($objResponse); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < bdsl.BDSL_DATE)
  {
	$('#BDSL_DATE').attr('min',lastdt);
  }
  else
  {
	  $('#BDSL_DATE').attr('min',bdsl.BDSL_DATE);
  }
