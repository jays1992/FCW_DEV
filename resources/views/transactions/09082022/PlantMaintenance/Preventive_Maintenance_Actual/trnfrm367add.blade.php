        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
              @if($objSON->SYSTEM_GRSR == "1")
                  <input type="text" name="PMAL_NO" id="PMAL_NO" value="{{ $objAutoGenNo }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              @endif
              @if($objSON->MANUAL_SR == "1")
                  <input type="text" name="PMAL_NO" id="PMAL_NO" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
              @endif
            </div>

            <div class="col-lg-2 pl"><p>Doc Date</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="PMAL_DATE" id="PMAL_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
