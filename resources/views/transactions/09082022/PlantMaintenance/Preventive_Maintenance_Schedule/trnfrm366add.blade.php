      ...
      <div class="inner-form">
        ...
        <div class="row">
            ...
            @if($objSON->SYSTEM_GRSR == "1")
                <input type="text" name="PMSL_NO" id="PMSL_NO" value="{{ $objAutoGenNo }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            @endif
            @if($objSON->MANUAL_SR == "1")
                <input type="text" name="PMSL_NO" id="PMSL_NO" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="PMSL_DATE" id="PMSL_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
