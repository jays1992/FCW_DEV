...
<form id="frm_trn_add" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
          ...
          <div class="row">
            ...
            @if($objDD->SYSTEM_GRSR == "1")
                <input type="text" name="EMC_NO" id="EMC_NO" value="{{ $objDOCNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            @endif
            @if($objDD->MANUAL_SR == "1")
                <input type="text" name="EMC_NO" id="EMC_NO" value="{{ old('EMC_NO') }}" class="form-control mandatory" maxlength="{{$objDD->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="EMC_DATE" id="EMC_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('EMC_DATE') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
