  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->BDCL_ID}}" value="{{$val->BDCL_ID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->BDCL_DATE) && $val->BDCL_DATE !='' && $val->BDCL_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->BDCL_DATE)):''}}" ></td>
