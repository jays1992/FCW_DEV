  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="BDCL_DOCNO" id="BDCL_DOCNO" value="{{ $objDOCNO }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
          @endif

          @if(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
          <input type="text" name="BDCL_DOCNO" id="BDCL_DOCNO" value="{{ old('BDCL_DOCNO') }}" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
          @endif
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="BDCL_DATE" id="BDCL_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('BDCL_DATE') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
