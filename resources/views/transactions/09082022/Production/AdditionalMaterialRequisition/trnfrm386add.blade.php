      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                <input type="text" name="MRS_NO" id="MRS_NO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
            @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                <input type="text" name="MRS_NO" id="MRS_NO" value="{{ old('MRS_NO') }}" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase"  >
            @else
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="MRS_DT" id="MRS_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('MRS_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>
