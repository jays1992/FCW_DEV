...
@section('content')
	...
	<div class="inner-form">
		...
		<div class="row">
			<div class="col-lg-2 pl"><p>AMI No*</p></div>
			...
			<div class="col-lg-2 pl"><p>AMI Date*</p></div>
			<div class="col-lg-2 pl">
			...
			<div class="tab-content">
				...
				<div id="Material" class="tab-pane fade in active">
                  ...
                  <th>Remarks</th>
                          ...
                          <td><input type="text" name="txtRGP_popup_0" id="txtRGP_popup_0" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                          <td><input type="text" name="PRO_NO_0" id="PRO_NO_0" class="form-control"  autocomplete="off" style="width:130px;" readonly  /></td>
                          ...
                          <td><input type="text" name="SE_QTY_0" id="SE_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly style="width:130px;"  /></td>
                          ...
                          <td><input type="text" name="STOCK_INHAND_0" id="STOCK_INHAND_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly  autocomplete="off" style="width:130px;"   /></td>
                          
                          <td><input type="text" name="RECEIVED_QTY_MU_0" id="RECEIVED_QTY_MU_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;"   /></td>
                          
                          <td><input type="text" name="popupALTUOM_0" id="popupALTUOM_0" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                          ...
                          <td><input type="text" name="REASON_SHORT_QTY_0" id="REASON_SHORT_QTY_0" class="form-control"   autocomplete="off" style="width:130px;"   /></td>
...
<div id="RGPpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
        <th class="ROW1"><span class="check_th">&#10004;</span></th>
        <td class="ROW2"><input type="text" id="RGPcodesearch" autocomplete="off" class="form-control" onkeyup="RGPCodeFunction()"></td>
        <td class="ROW3"><input type="text" id="RGPnamesearch" autocomplete="off" class="form-control" onkeyup="RGPNameFunction()"></td>
      </tr>
    </tbody>
    </table>
...
<div id="ITEMIDpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md" style="width:90%;">
    ...
    <td style="width:8%;">
    <input type="text" id="ItemStatussearch" class="form-control" onkeyup="ItemStatusFunction(event)">
    </td>
    </tr>
    </tbody>
    </table>
