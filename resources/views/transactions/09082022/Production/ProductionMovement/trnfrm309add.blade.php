  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="PNM_NO" id="PNM_NO" value="{{ $objDataNo }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
          @endif

          @if(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
          <input type="text" name="PNM_NO" id="PNM_NO" value="{{ old('PNM_NO') }}" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
          @endif
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="PNM_DT" id="PNM_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('PNM_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
          <span class="text-danger" id="ERROR_PNM_DT"></span>
        </div>

        <div class="col-lg-1 pl"><p>PRO NO</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="PROID_REF_popup" id="txt_PROID_REF_popup" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="PROID_REF" id="PROID_REF" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-1 pl"><p>ITEM</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="txt_ITEM_popup" id="txt_ITEM_popup" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="txt_UOM_popup" id="txt_UOM_popup" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="UOMID_REF" id="UOMID_REF" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-1 pl"><p>PNM QTY</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="PNM_QTY" id="PNM_QTY" class="form-control" onkeyup="get_materital_item();"  autocomplete="off" />
            <input type="hidden" name="TOTAL_QTY" id="TOTAL_QTY" />
            <input type="hidden" name="SOID_REF" id="SOID_REF" />
            <input type="hidden" name="SQID_REF" id="SQID_REF" />
            <input type="hidden" name="SEID_REF" id="SEID_REF" />
        </div>

        <div class="col-lg-1 pl"><p>Tolerence</p></div>
        <div class="col-lg-2 pl">
            <input type="checkbox" name="PARTIAL_PRODUCTION" id="PARTIAL_PRODUCTION" class="form-checkbox" />            
        </div>
		
		<div class="col-lg-1 pl"><p>Actual QTY</p></div>
        <div class="col-lg-2 pl">
           <input type="text" name="ACTUAL_QTY" id="ACTUAL_QTY" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" onChange="getQtyCheck();" maxlength="13" readonly autocomplete="off" />           
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 pl">
          ...
          <div class="col-lg-1 pl">
            <input type="radio" NAME="MOVEMENT_STAGE_TYPE" onChange="getMovementState('To Stage')" value="TO STAGE" checked >
          </div>

          <div class="col-lg-3 pl"><p>To QC</p></div>
          <div class="col-lg-1 pl">
            <input type="radio" NAME="MOVEMENT_STAGE_TYPE" onChange="getMovementState('To QC')" value="TO QC"  >
          </div>

          <div class="col-lg-3 pl"><p>To Store</p></div>
          <div class="col-lg-1 pl">
            <input type="radio" NAME="MOVEMENT_STAGE_TYPE" onChange="getMovementState('To Store')" value="TO STORE"  >
            <input type="hidden" name="MOVEMENT_STAGE" id="MOVEMENT_STAGE" value="TO STAGE" >
          </div>
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="PSTAGEID_REF_popup" id="txt_PSTAGEID_REF_popup" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="PSTAGEID_REF" id="PSTAGEID_REF" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-1 pl"><p id="STAGE_NAME">To Stage</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="TO_STAGE_STORE_QC_popup" id="txt_TO_STAGE_STORE_QC_popup" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="TO_STAGE_STORE_QC" id="TO_STAGE_STORE_QC" class="form-control" autocomplete="off" />
        </div>
	  </div>
	  ...
	  <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="TOTAL_COST" id="TOTAL_COST" class="form-control mandatory"  autocomplete="off" readonly/>
          ...
          <li><a data-toggle="tab" href="#direct_cost" id="ODC_TAB" >Other Direct Cost	</a></li>
			  ...
			  <div class="tab-content">
				  ...
				  <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input type="text" name="txt_MACHINE_popup_0" id="txt_MACHINE_popup_0" class="form-control"  autocomplete="off"  readonly /></td>
                    <td hidden><input type="text" name="MACHINEID_REF_0" id="MACHINEID_REF_0" class="form-control" autocomplete="off" /></td>

                    <td><input type="text" name="txt_SHIFT_popup_0"   id="txt_SHIFT_popup_0" class="form-control"  autocomplete="off"  readonly /></td>
                    <td hidden><input type="text" name="SHIFTID_REF_0"       id="SHIFTID_REF_0" class="form-control" autocomplete="off" /></td>

                    <td><input type="text" name="txt_EMP_popup_0" id="txt_EMP_popup_0" class="form-control"  autocomplete="off"  readonly /></td>
                    <td hidden><input type="text" name="EMPID_REF_0" id="EMPID_REF_0" class="form-control" autocomplete="off" /></td>
                    
                    <td><input type="text" name="BATCH_0" id="BATCH_0" class="form-control" autocomplete="off" onkeyup="checkBatchNo(this.id,this.value)" /></td>
                    <td><input type="text" name="QTY_0" id="QTY_0" class="form-control" autocomplete="off" onkeyup="checkQty(this.id,this.value)" onkeypress="return isNumberDecimalKey(event,this)" /></td>
          ...
          <div id="udf" class="tab-pane fade">
              ...
              @foreach($objUdfData as $uindex=>$uRow)
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->UDFPNMID}}" autocomplete="off"   /></td>
                ...
                <thead id="thead5"  style="position: sticky;top: 0">
                    ...
                    <tbody>
                        <tr  class="participantRow10">
                            ...
                            <td hidden>
                              <input type="hidden" name="Componentid_0" id="Componentid_0" class="form-control" autocomplete="off" />
                              <input type="text" name="rowscount5[]"  />
                            </td>
                           
                     
                            <td><input  type="text" name="value_0" id="value_0" class="form-control"  autocomplete="off" onkeyup="calculateRateQty()" onfocusout="resetValue(this.id,this.value,2)"  /></td>
...
function GetAdditionalMaterial(){
  var ITEMID_REF=$("#ITEMID_REF").val(); 
  var PROID_REF=$("#PROID_REF").val(); 
  ...
  $.ajax({
      ...
      type:'POST',
      data:{
        ITEMID_REF:ITEMID_REF,PROID_REF:PROID_REF
        },
