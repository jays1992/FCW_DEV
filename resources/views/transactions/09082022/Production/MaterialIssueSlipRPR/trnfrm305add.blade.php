	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            @if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1")
                <input type="text" name="MISRNO" id="MISRNO" value="{{ $objDataNo }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
            @endif

            @if(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
                <input type="text" name="MISRNO" id="MISRNO" value="{{ old('MISRNO') }}" class="form-control mandatory" maxlength="{{$objSON->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
			...
			<div class="col-lg-2 pl">
        <input type="date" name="MISRDT" id="MISRDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('MISRDT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
