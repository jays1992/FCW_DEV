	...
	<div class="container-fluid filter">
		<div class="inner-form">
          ...
          <input type="hidden" name="RPRID" id="RPRID" value="{{ isset($objResponse)?$objResponse->RPRID:'' }}" class="form-control" readonly  autocomplete="off"   >
				...
				<div class="col-lg-2 pl">
					<input {{$ActionStatus}} type="date" name="RPR_DT" id="RPR_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ isset($objResponse)?$objResponse->RPR_DT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
			...
			<div class="row">
				...
				<div class="tab-content">
                  ...
                  @endphp
                    ...
                    <td><input type="text" name="STOCK_INHAND_{{$key}}" id="STOCK_INHAND_{{$key}}"  value="{{isset($row->StockInHand) ? $row->StockInHand:'0.00' }}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly  autocomplete="off"   /></td>
