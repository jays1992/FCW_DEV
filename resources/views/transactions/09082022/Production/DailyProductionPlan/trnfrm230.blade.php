...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Daily Production Plan (DPP)</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->DPPID}}" value="{{$val->DPPID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->DPP_DT) && $val->DPP_DT !='' && $val->DPP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DPP_DT)):''}}" ></td>
              <td>{{isset($val->DPP_NO) && $val->DPP_NO !=''?$val->DPP_NO:''}}</td>
              <td>{{isset($val->DPP_DT) && $val->DPP_DT !='' && $val->DPP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DPP_DT)):''}}</td>
