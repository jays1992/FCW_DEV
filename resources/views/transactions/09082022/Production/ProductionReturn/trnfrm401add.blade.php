  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="PRR_DOCNO" id="PRR_DOCNO" value="{{ isset($objDataNo)?$objDataNo:'' }}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
         
          @elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1")
          <input type="text" name="PRR_DOCNO" id="PRR_DOCNO" value="{{ old('PRR_DOCNO') }}" class="form-control mandatory" maxlength="{{isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''}}" autocomplete="off" style="text-transform:uppercase"  >
          @else
            <input type="text" name="PRR_DOCNO" id="PRR_DOCNO"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >

  
            
          @endif
          <span class="text-danger" id="ERROR_PRR_DOCNO"></span>
        </div>
              
        <div class="col-lg-2 pl"><p>Date*</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="PRR_DT" id="PRR_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ old('PRR_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
          <input type="hidden" name="hdnmainmaterial" id="hdnmainmaterial"  class="form-control mandatory"  autocomplete="off"    >
          <span class="text-danger" id="ERROR_PRR_DT"></span>

        </div>

        <div class="col-lg-1 pl"><p>PRO NO</p></div>
        <div class="col-lg-2 pl">
        <input type="text" name="Productionpopup" id="txtProductionpopup" class="form-control mandatory"  autocomplete="off"  readonly/>
        <input type="hidden" name="PRID_REF" id="PRID_REF" class="form-control" autocomplete="off" />
        </div>   
                ...
                <!--  <th>Alt UOM (AU)</th>-->
                  ...
                  <th>Remarks</th>
                         ...
                         <td><input  type="text" name="Main_popupITEMID_0" id="Main_popupITEMID_0" class="form-control"  autocomplete="off"  readonly/></td>
                          ...
                          <td {{$AlpsStatus['hidden']}}><input type="text" name="Main_Alpspartno_0" id="Main_Alpspartno_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td {{$AlpsStatus['hidden']}}><input type="text" name="Main_Custpartno_0" id="Main_Custpartno_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td {{$AlpsStatus['hidden']}}><input type="text" name="Main_OEMpartno_0"  id="Main_OEMpartno_0" class="form-control"  autocomplete="off"   readonly/></td>


                          <td hidden><input type="text" name="Main_Itemspec_0" id="Main_Itemspec_0" class="form-control"  autocomplete="off"  /></td>

                          <td><input type="text" name="Main_SE_QTY_0" id="Main_SE_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>

                          <td align="center"><a class="btn checkstore"  id="0" ><i class="fa fa-clone"></i></a></td>
                          <td hidden ><input type="hidden" name="Main_TotalHiddenQty_0" id="Main_TotalHiddenQty_0" ></td>
                          <td hidden ><input type="hidden" name="Main_HiddenRowId_0" id="Main_HiddenRowId_0" ></td>
                          
                          <td hidden><input type="text" name="Main_PO_PENDING_QTY_0" id="Main_PO_PENDING_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                         

                       
                          
                          <td hidden><input type="text" name="Main_popupMUOM_0" id="Main_popupMUOM_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td hidden><input type="hidden" name="Main_MAIN_UOMID_REF_0" id="Main_MAIN_UOMID_REF_0" class="form-control"  autocomplete="off" /></td>
                          
                          <td hidden><input type="text" name="Main_STOCK_INHAND_0" id="Main_STOCK_INHAND_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly  autocomplete="off"   /></td>
                          
                          <td><input type="text" readonly name="Main_RECEIVED_QTY_MU_0" id="Main_RECEIVED_QTY_MU_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"   /></td>
                          ...
                          <td hidden><input type="text" name="Main_SHORT_QTY_0" id="Main_SHORT_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"  readonly  /></td>

                          <td><input type="text" name="Main_STORE_NAME_0"  id="Main_STORE_NAME_0"  class="form-control w-100" autocomplete="off" readonly  ></td>
                          <td><input type="text" name="Main_STORE_VALUE_0" id="Main_STORE_VALUE_0"  class="form-control w-100" autocomplete="off" readonly ></td>

                          <td><input type="text" name="Main_REASON_RETURN_QTY_0" id="Main_REASON_RETURN_QTY_0" class="form-control"   autocomplete="off"   /></td>
                          ...
                          <td><input  type="text" name="Main_REMARKS_0" id="Main_REMARKS_0" class="form-control" autocomplete="off" ></td>
          ...
          <div id="udf" class="tab-pane fade">
              ...
              @foreach($objUdfData as $uindex=>$uRow)
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name={{"UDF_".$uindex}} id={{"UDF_".$uindex}} class="form-control" value="{{$uRow->UDFPROID}}" autocomplete="off"   /></td>
...
function checkDuplicateCode(){
  ...
  $.ajax({
      ...
      success:function(data) {
          if(data.exists) {
              $(".text-danger").hide();
              showError('ERROR_PRR_DOCNO',data.msg);
              $("#PRR_DOCNO").focus();
          }
          else{
            $("#alert").modal('show');
