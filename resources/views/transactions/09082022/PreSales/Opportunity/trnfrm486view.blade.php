        ...
        <div class="inner-form">
          <div class="row">
            ...
            <div class="col-lg-3 pl">{{isset($objResponse->LEAD_NO) && $objResponse->LEAD_NO !=''?$objResponse->LEAD_NO:''}}
              <input type="hidden" name="LEAD_NO" id="LEAD_NO" value="{{isset($objResponse->LEAD_NO) && $objResponse->LEAD_NO !=''?$objResponse->LEAD_NO:''}}" class="form-control mandatory"  autocomplete="off" disabled >
      ...
      <div id="Opportunity" class="tab-pane fade in active" style="margin-left: 16px; margin-top: 10px; width: 97%;">
        <div class="row">
          ...
          <div class="col-lg-2 pl"><p>Opportunity Date*</p></div>
            <div class="col-lg-2 pl">
              <input type="date" name="OPPORTY_DATE" id="OPPRTY_DT" value="{{isset($objResponse->OPPORTUNITY_DATE) && $objResponse->OPPORTUNITY_DATE !=''?$objResponse->OPPORTUNITY_DATE:''}}" class="form-control mandatory" autocomplete="off" disabled>                            
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="OPPORTY_STAGECOMPLTED" id="OPPORTY_STAGECOMPLTED" value="{{isset($objResponse->COMPLETE_PERCENT) && $objResponse->COMPLETE_PERCENT !=''?$objResponse->COMPLETE_PERCENT:''}}" class="form-control mandatory" autocomplete="off" disabled>                            
            </div>

            <div class="col-lg-2 pl"><p>Expected date*</p></div>
            <div class="col-lg-2 pl">
              <input type="date" name="EXPECTED_DATE" id="EXPECTED_DATE" value="{{isset($objResponse->EXPECTED_DATE) && $objResponse->EXPECTED_DATE !=''?$objResponse->EXPECTED_DATE:''}}" class="form-control mandatory" autocomplete="off" disabled>                            
            </div>              
            </div>
