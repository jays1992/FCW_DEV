...
<!-- <form id="frm_trn_so" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="{{route('transaction',[201,'index'])}}" class="btn singlebt">@if($checkCompany =='')Service Purchase Invoice @else Service GRN @endif</a>
                </div><!--col-2-->

                <div class="col-lg-10 topnav-pd">
                        <button class="btn topnavbt" id="btnAdd" disabled="disabled"><i class="fa fa-plus"></i> Add</button>
                        <button class="btn topnavbt" id="btnEdit" disabled="disabled"><i class="fa fa-edit"></i> Edit</button>
                        <button class="btn topnavbt" id="btnSavePO" disabled><i class="fa fa-save"></i> Save</button>
...
<form id="frm_trn_so"  method="POST">   
      @csrf
      {{isset($objSO->SPOID[0]) ? method_field('PUT') : '' }}
      ...
      <div class="row">
          ...
          <div class="col-lg-2 pl">
            <select name="TYPE" id="TYPE" class="form-control" >
                 <option value="INVOICE" {{ isset($objSO->TYPE) && $objSO->TYPE == 'INVOICE' ? 'selected' : ''}}>INVOICE</option>
                 <option value="DEBIT" {{ isset($objSO->TYPE) && $objSO->TYPE == 'DEBIT' ? 'selected' : ''}}>DEBIT</option>
            </select>
          </div>
      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                          <input {{$ActionStatus}} type="text" name="SONO" id="SONO" value="{{ isset($objSO->SPI_NO)?$objSO->SPI_NO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
          ...
          <input type="hidden" name="SPIID" id="SPIID" class="form-control" autocomplete="off" value="{{ isset($objSO->SPIID)?$objSO->SPIID:'' }}" />
                      </div>
                      
                      <div class="col-lg-2 pl"><p>SPI Date*</p></div>
                      <div class="col-lg-2 pl">
                          <input {{$ActionStatus}} type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(201,this.value,1)" value="{{ isset($objSO->SPI_DT)?$objSO->SPI_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                      </div>
                      
                      <div class="col-lg-2 pl"><p>Department*</p></div>
                      <div class="col-lg-2 pl">
                        <input {{$ActionStatus}} type="text" name="GLID_popup" id="txtgl_popup" class="form-control mandatory" value="{{ isset($objglcode2->DCODE)?$objglcode2->DCODE:'' }} {{ isset($objglcode2->NAME)?'-'.$objglcode2->NAME:'' }}"  autocomplete="off" readonly/>
                        <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" value="{{ isset($objSO->DEPID_REF)?$objSO->DEPID_REF:'' }}" />
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input {{$ActionStatus}} type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="{{ isset($objData2->SPO_NO)?$objData2->SPO_NO:'' }}"  autocomplete="off" readonly/>
                        <input type="hidden" name="SLID_REF" id="SLID_REF" value="{{ isset($objSO->SPOID_REF)?$objSO->SPOID_REF:'' }}" class="form-control"  autocomplete="off" />
                    ...
                    <div class="col-lg-2 pl">
                      <input {{$ActionStatus}} type="text" name="vendor_name" id="vendor_name" class="form-control" autocomplete="off" value="{{ isset($VENDOR_CODE)?$VENDOR_CODE:'' }}  {{ isset($VENDOR_NAME)?'-'.$VENDOR_NAME:'' }}" readonly/>                                                             
                      <input type="hidden" name="VID_REF" id="VID_REF" class="form-control" value="{{ isset($objSO->VID_REF)?$objSO->VID_REF:'' }}" autocomplete="off" />                                                             
                      <input type="hidden" name="VTDS_APPLICABLE" id="VTDS_APPLICABLE" value="{{ isset($TDS_APPLICABLE)?$TDS_APPLICABLE:'' }}" class="form-control" autocomplete="off" />                                                             
                      <input type="hidden" name="Tax_State" id="Tax_State" value="{{ isset($TAXSTATE[0])?$TAXSTATE[0]:'' }}" class="form-control" autocomplete="off" />                                                             
                    </div>

                    <div class="col-lg-2 pl"><p>Credit Days</p></div>
                      <div class="col-lg-2 pl">
                          <input {{$ActionStatus}} type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="{{ isset($objSO->CREADIT_DAYS)?$objSO->CREADIT_DAYS:'' }}"  readonly />
                    </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                          <input {{$ActionStatus}} type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="{{ isset($objSO->VENDOR_INNO)?$objSO->VENDOR_INNO:'' }}" autocomplete="off" onkeyup="checkDuplicateVendorBillNo(this.value,'')" style="text-transform:uppercase"  />
                      </div>


                      <div class="col-lg-2 pl"><p>Vendor Bill Date*</p></div>
                      <div class="col-lg-2 pl">
                          <input {{$ActionStatus}} type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" class="form-control " value="{{ isset($objSO->VENDOR_INDT)?$objSO->VENDOR_INDT:'' }}" autocomplete="off" placeholder="dd/mm/yyyy"  />
                      </div> 
                      <div class="col-lg-2 pl"><p>Remarks</p></div>
                      <div class="col-lg-2 pl">
                          <input {{$ActionStatus}} type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" maxlength="200" value="{{ isset($objSO->REMARKS)?$objSO->REMARKS:'' }}" >
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                        <input {{$ActionStatus}} type="checkbox" name="GST_Reverse" id="GST_Reverse" {{ isset($objSO->REVERSE_GST) && $objSO->REVERSE_GST =='1' ?'checked':'' }}   />                          
                      </div>

                      <div class="col-lg-2 pl"><p>GST Input Not Avail</p></div>
                      <div class="col-lg-2 pl">
                        <input {{$ActionStatus}} type="checkbox" name="GST_N_Avail" id="GST_N_Avail" {{ isset($objSO->GST_INPUT) && $objSO->GST_INPUT =='1' ?'checked':'' }}   />
                      </div> 
                      ...
                      <div class="col-lg-2 pl" hidden><p>Direct SPO Order</p></div>
                      <div class="col-lg-2 pl" hidden>
                            <input {{$ActionStatus}} type="checkbox" name="DirectPO" id="DirectPO" class="form-checkbox"   checked="checked"  >
                      </div>

                      <div class="col-lg-1 pl" hidden><p>SPO Based on</p></div>
                      <div class="col-lg-2 pl" hidden>
                        <select {{$ActionStatus}} name="PO_BASED" id="PO_BASED" class="form-control"  disabled >
                      ...
                      <div class="col-lg-2 pl">
                          <input type="checkbox" {{$ActionStatus}} name="FC" id="FC" class="form-checkbox" {{isset($objSO->FC) && $objSO->FC == 1 ? 'checked' : ''}} >
                      </div>
                     ...
                     <div class="row">
                      ...
                      <div class="col-lg-1 pl">
                            <input {{$ActionStatus}} type="checkbox" name="BOE" id="BOE" class="form-checkbox" value="1" onchange="showHideItemTab()" {{ isset($objSO->BOE) && $objSO->BOE =='1' ?'checked':'' }} >
                      </div>
                  ...
                  <div>
                  <div class="col-lg-1 pl"><p>DPB</p></div>
                      <div class="col-lg-2 pl">
                        <input {{$ActionStatus}} type="checkbox" name="DPB_CHECKBOX" id="DPB_CHECKBOX" class="form-checkbox" value="1" onchange="getDPB(),showHideItemTab()" {{ isset($objSO->DPB) && $objSO->DPB =='1' ?'checked':'' }} >
                        <input type="hidden" name="DPB" id="DPB" value="{{ isset($objSO->DPB)?$objSO->DPB:'' }}" >
                      ...
                      <div class="tab-content">
                                      ...
                                      @if(!empty($objSOMAT))
                                          @foreach($objSOMAT as $key => $row)
                                              <tr  class="participantRow">
                                                  <td hidden>
                                                  <input  class="form-control" type="hidden" name={{"SOMATID_".$key}} id ={{"SOMATID_".$key}} maxlength="100" value="{{ $row->SPISRVID }}" autocomplete="off" style="width:130px;"   >
                                                  </td>
                                                  ...
                                                  <td  hidden><input type="text" name={{"ITEMID_REF_".$key}} id={{"ITEMID_REF_".$key}} class="form-control"   value="{{ $row->SRVID_REF }}" autocomplete="off" style="width:130px;" /></td>
                                                  ...
                                                  <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name={{"Alpspartno_".$key}} id={{"Alpspartno_".$key}} class="form-control" value="{{ $row->ALPS_PART_NO }}" autocomplete="off"  readonly style="width:130px;"/></td>
                                                  <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name={{"Custpartno_".$key}} id={{"Custpartno_".$key}} class="form-control" value="{{ $row->CUSTOMER_PART_NO }}" autocomplete="off"  readonly style="width:130px;" /></td>
                                                  <td {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="text" name={{"OEMpartno_".$key}} id={{"OEMpartno_".$key}} class="form-control" value="{{ $row->OEM_PART_NO }}" autocomplete="off"  readonly style="width:130px;" /></td>
                                                  <td><input {{$ActionStatus}} type="text" name={{"popupMUOM_".$key}} id={{"popupMUOM_".$key}} class="form-control" value="{{ $row->MAIN_UOM_CODE }}"  autocomplete="off"  readonly disabled style="width:130px;" /></td>
                                                  ...
                                                  <td ><input type="text" {{$ActionStatus}} name={{"txtBOE_popup_".$key}} id={{"txtBOE_popup_".$key}} class="form-control boedpb" value="{{ isset($row->DOC_CODE)?$row->DOC_CODE:'' }}" autocomplete="off" style="width:130px;" readonly /></td>                                              
                                                  <td  hidden><input type="text"  name={{"BOEID_REF_".$key}} id={{"BOEID_REF_".$key}} value="{{ $row->BOE_NO_REF }}"  class="form-control boedpb" autocomplete="off" /></td>                          
                                                  <td hidden><input type="text"  name={{"BOE_REF_".$key}} id={{"BOE_REF_".$key}} style=" width: 171px;" class="form-control boedpb"  autocomplete="off"  readonly /></td>


                                                  <td><input {{$ActionStatus}} type="text" name={{"SPO_QTY_".$key}} id={{"SPO_QTY_".$key}} value="{{ $row->SPO_QTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input {{$ActionStatus}} type="text" name={{ "SPO_RATE_".$key}} id={{"SPO_RATE_".$key}}  value="{{ $row->SPO_RATE }}"  class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                              
                                                  <td><input {{$ActionStatus}} type="text" name={{"SO_QTY_".$key}} id={{"SO_QTY_".$key}} value="{{ $row->BILL_QTY }}" class="form-control three-digits" maxlength="13"   autocomplete="off"  style="width:130px;text-align:right;"  /></td>
                                                  <td><input {{$ActionStatus}} type="text" name={{"SHORT_QTY_".$key}} id={{"SHORT_QTY_".$key}} value="{{ $row->SHORT_QTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off"   readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input {{$ActionStatus}} type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->BILL_RATEPUOM }}"  autocomplete="off"  style="width:130px;text-align:right;" /></td>
                                                  <td><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCPER_".$key}} id={{"DISCPER_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->DIS_PER }}"  autocomplete="off" style="width: 50px;" {{$AlpsStatus['disabled']}} style="width:130px;text-align:right;"  /></td>
                                                  <td><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCOUNT_AMT_".$key}} id={{"DISCOUNT_AMT_".$key}} class="form-control two-digits" value="{{ $row->DISCOUNT }}" maxlength="15"  autocomplete="off" {{$AlpsStatus['disabled']}} style="width:130px;text-align:right;"  /></td>
                                                  @php
                                                      $TaxAmt=number_format((($row->BILL_QTY*$row->BILL_RATEPUOM) - $row->DISCOUNT),2, '.', '');
                                                      //$IGSTAMT=number_format((((($row->BILL_QTY*$row->BILL_RATEPUOM) - $row->DISCOUNT)*$row->IGST)/100),2, '.', '');
                                                      //$CGSTAMT=number_format((((($row->BILL_QTY*$row->BILL_RATEPUOM) - $row->DISCOUNT)*$row->CGST)/100),2, '.', '');
                                                      //$SGSTAMT=number_format((((($row->BILL_QTY*$row->BILL_RATEPUOM) - $row->DISCOUNT)*$row->SGST)/100),2, '.', '');

                                                      $IGSTAMT=number_format((($row->ASSESSABLE_VALUE*$row->IGST)/100),2, '.', '');
                                                      $CGSTAMT=number_format((($row->ASSESSABLE_VALUE*$row->CGST)/100),2, '.', '');
                                                      $SGSTAMT=number_format((($row->ASSESSABLE_VALUE*$row->SGST)/100),2, '.', '');

                                                      $TOTGST =number_format(($IGSTAMT+$CGSTAMT+$SGSTAMT),2, '.', '');
                                                      $TOTAMT =number_format(($TaxAmt+$IGSTAMT+$CGSTAMT+$SGSTAMT),2, '.', '');
                                                  @endphp
                                                  <td><input {{$ActionStatus}} type="text" name={{"DISAFTT_AMT_".$key}} id={{"DISAFTT_AMT_".$key}} class="form-control " maxlength="15" value="{{ $TaxAmt }}" autocomplete="off"   readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input type="text" name="TOT_BAL_AMT_{{$key}}" id="TOT_BAL_AMT_{{$key}}" class="form-control two-digits" maxlength="15"  value="{{isset($row->TOT_BAL_AMT)?$row->TOT_BAL_AMT:''}}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  
                                                  <td><input {{$ActionStatus}} type="text" name={{"ASSESSABLE_VALUE_".$key}} id={{"ASSESSABLE_VALUE_".$key}} class="form-control " maxlength="15" value="{{ $row->ASSESSABLE_VALUE }}" autocomplete="off"  style="width:130px;text-align:right;" /></td>
                                                  ...
                                                  <td><input {{$ActionStatus}} type="text" name={{"IGSTAMT_".$key}} id={{"IGSTAMT_".$key}} class="form-control two-digits" maxlength="15" value="{{ $IGSTAMT }}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  ...
                                                  <td><input {{$ActionStatus}} type="text" name={{"CGSTAMT_".$key}} id={{"CGSTAMT_".$key}} class="form-control two-digits" maxlength="15" value="{{ $CGSTAMT }}" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                  ...
                                                  <td><input {{$ActionStatus}} type="text" name={{"SGSTAMT_".$key}} id={{"SGSTAMT_".$key}} class="form-control two-digits" maxlength="15" value="{{ $SGSTAMT }}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input {{$ActionStatus}} type="text" name={{"TGST_AMT_".$key}} id={{"TGST_AMT_".$key}} class="form-control two-digits" maxlength="15" value="{{ $TOTGST }}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input {{$ActionStatus}} type="text" name={{"TOT_AMT_".$key}} id={{"TOT_AMT_".$key}} class="form-control two-digits" maxlength="15" value="{{ $TOTAMT }}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  <td align="center">
                                  ...
                                  @if(!empty($objSOUDF))
                                      @foreach($objSOUDF as $Ukey => $Urow)
                                          <tr  class="participantRow4">
                                              ...
                                              <td hidden><input type="hidden" name={{"UDFSOID_REF_".$Ukey}}  id={{"UDFSOID_REF_".$Ukey}} class="form-control" value="{{$Urow->UDFSPIID_REF}}" autocomplete="off" /></td>
                                      ...
                                      @endforeach 
                                      @else
                                      @foreach($objUdfSOData2 as $uindex=>$uRow)
                                        <tr  class="participantRow4">
                                            ...
                                            <td hidden><input type="hidden" name={{"UDFSOID_REF_".$uindex}} id={{"UDFSOID_REF_".$uindex}} class="form-control" value="{{$uRow->UDFSPIID}}" autocomplete="off"   /></td>
                                      ...
                                      @if(!empty($objSOCAL))
                                          @foreach($objSOCAL as $Ckey => $Crow)
                                              <tr  class="participantRow5">
                                                  ...
                                                  <td style="text-align:center;" hidden><input {{$ActionStatus}} type="checkbox" class="filter-none" name={{"calACTUAL_".$Ckey}} id={{"calACTUAL_".$Ckey}} value=""  ></td>
                                      ...
                                      @if(!empty($objSOPSLB))
                                          @foreach($objSOPSLB as $Pkey => $Prow)
                                              <tr  class="participantRow6">
                                                  <td hidden> <input type="text" class="form-control" id={{"PSLBID_".$Pkey}} name={{"PSLBID_".$Pkey}} value="{{$Prow->PSLB_SPIID}}" autocomplete="off"  /> </td>
                                                  <td> <input {{$ActionStatus}} type="text" class="form-control" id={{"PAY_DAYS_".$Pkey}} name={{"PAY_DAYS_".$Pkey}} value="{{$Prow->PAY_DAYS}}" autocomplete="off"  /> </td>
                                          ...
                                          @else
                                          <tr  class="participantRow6">
                                                  <td> <input {{$ActionStatus}} type="text" class="form-control" id="PAY_DAYS_0" name="PAY_DAYS_0"  autocomplete="off" /></td>
                          ...
                          <div id="TDSApplicableSlabs" class="tab-pane fade">
                            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                ...
                                <div class="col-lg-2 pl">
                                 <select {{$ActionStatus}} name="TDS_APPLICABLE" id="TDS_APPLICABLE" class="form-control " >
                                  <option value="1" @if(isset($objSO->TDS_CAL) && $objSO->TDS_CAL==1) selected @endif > Yes </option>
                                  <option value="0" @if(isset($objSO->TDS_CAL) && is_null($objSO->TDS_CAL) || isset($objSO->TDS_CAL) &&  $objSO->TDS_CAL==0) selected @endif > No </option>
                                </select>
                                </div>
                            </div>
                                ...
                                <table id="example8" class="display nowrap table table-striped table-bordered itemlist " width="100%" style="height:auto !important;">
                                    <thead id="thead1"  style="position: sticky;top: 0">
                                        <tr>
                                            ...
                                            <th >Code Description <input class="form-control" type="hidden" name="Row_Count8" id ="Row_Count8" value="{{$ObjTDSDataCount}}"></th>
                                            <th>Section</th>
                                    ...
                                    @if(!empty($ObjTDSData) )
                                      @foreach($ObjTDSData as $dindex=>$dataRow)
                                        @if(!($dataRow->EXPIRE))
                                        <tr class="participantRow8">
                                          <td hidden><input type="hidden" name={{"HOLDINGID_".$dindex}} id={{"HOLDINGID_".$dindex}} value="{{$dataRow->HOLDINGID}}" class="form-control" autocomplete="off" /></td>
                                          <td hidden><input type="hidden" name={{"ASSESSEEID_REF_".$dindex}} id={{"ASSESSEEID_REF_".$dindex}} value="{{$dataRow->ASSESSEEID_REF}}"  class="form-control five-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                          ...
                                          <td style="text-align:center;" ><input {{$ActionStatus}} type="checkbox" class="filter-none" name={{"calTDS_".$dindex}} id={{"calTDS_".$dindex}}  value="{{$dataRow->HOLDINGID}}"  /></td>
                                          ...
                                          <td ><input {{$ActionStatus}} type="text" name={{"CODE_DESC_".$dindex}} id={{"CODE_DESC_".$dindex}} class="form-control"  value="{{$dataRow->CODE_DESC}}" style="width:100px" readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"SECTIONID_REF_".$dindex}} id={{"SECTIONID_REF_".$dindex}} value="{{$dataRow->SECTION_NAME}}"  class="form-control" style="width:100px" readonly/></td>
                                          
                                          <td><input {{$ActionStatus}} type="text" name={{"ASSEVAL_TDS_RATE_".$dindex}} id={{"ASSEVAL_TDS_RATE_".$dindex}} value="-1"  class="form-control five-digits" maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"ACT_TDS_RATE_".$dindex}} id={{"ACT_TDS_RATE_".$dindex}} value="{{$dataRow->TDS_RATE}}"  class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td hidden><input {{$ActionStatus}} type="text" name={{"TDS_EXEMP_LIMIT_".$dindex}} id={{"TDS_EXEMP_LIMIT_".$dindex}} value="0.00" class="form-control two-digits" maxlength="13" autocomplete="off" style="width:100px"  readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"TDS_RATE_AMT_".$dindex}} id={{"TDS_RATE_AMT_".$dindex}} value="0.00" class="form-control two-digits" maxlength="13" autocomplete="off" style="width:100px"  readonly/></td>
                                          
                                          <td><input {{$ActionStatus}} type="text" name={{"ASSEVAL_SURCHARGE_RAGE_".$dindex}} id={{"ASSEVAL_SURCHARGE_RAGE_".$dindex}} value="0"  class="form-control five-digits" maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"ACT_SURCHARGE_RAGE_".$dindex}} id={{"ACT_SURCHARGE_RAGE_".$dindex}} value="{{$dataRow->SURCHARGE_RAGE}}"  class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td hidden><input {{$ActionStatus}} type="text" name={{"SURCHARGE_EXEMP_LIMIT_".$dindex}} id={{"SURCHARGE_EXEMP_LIMIT_".$dindex}} value="0.00"  class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"SURCHARGE_RAGE_AMT_".$dindex}} id={{"SURCHARGE_RAGE_AMT_".$dindex}} value="0.00"  class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          
                                          <td><input {{$ActionStatus}} type="text" name={{"ASSEVAL_CESS_RATE_".$dindex}} id={{"ASSEVAL_CESS_RATE_".$dindex}} value="0" class="form-control five-digits" maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"ACT_CESS_RATE_".$dindex}} id={{"ACT_CESS_RATE_".$dindex}} value="{{$dataRow->CESS_RATE}}" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td hidden><input {{$ActionStatus}} type="text" name={{"CESS_EXEMP_LIMIT_".$dindex}} id={{"CESS_EXEMP_LIMIT_".$dindex}} value="0.00" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"CESS_RATE_AMT_".$dindex}} id={{"CESS_RATE_AMT_".$dindex}} value="0.00" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          
                                          <td><input {{$ActionStatus}} type="text" name={{"ASSEVAL_SP_CESS_RATE_".$dindex}} id={{"ASSEVAL_SP_CESS_RATE_".$dindex}}  value="0" class="form-control five-digits" maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"ACT_SP_CESS_RATE_".$dindex}} id={{"ACT_SP_CESS_RATE_".$dindex}}  value="{{$dataRow->SP_CESS_RATE}}" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td hidden><input {{$ActionStatus}} type="text" name={{"SP_CESS_EXEMP_LIMIT_".$dindex}} id={{"SP_CESS_EXEMP_LIMIT_".$dindex}}  value="0.00" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input {{$ActionStatus}} type="text" name={{"SP_CESS_RATE_AMT_".$dindex}}   id={{"SP_CESS_RATE_AMT_".$dindex}}  value="0.00" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          
                                          <td><input {{$ActionStatus}} type="text"  name={{"TOT_TDS_AMT_".$dindex}} id={{"TOT_TDS_AMT_".$dindex}} value="0.00" class="form-control "   autocomplete="off" style="width:100px" readonly/></td>
                              ...
                              <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                      ...
                                      @if(!empty($objItem))
                                          @foreach($objItem as $key => $row)
                                              <tr  class="Additional_participantRow">
                                                  <td hidden>
                                                  <input {{$ActionStatus}}  class="form-control" type="hidden" name={{"SPIITEMID_".$key}} id ={{"SPIITEMID_".$key}} maxlength="100" value="{{ $row->SPIITEMID }}" autocomplete="off"   >
                                                  <input type="hidden" name="rowcountitem[]" id="rowcountitem[]" class="form-control" autocomplete="off">
                                                  </td>
                                                  <td><input {{$ActionStatus}} type="text" name={{"A_popupITEMID_".$key}} id={{"A_popupITEMID_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ICODE }}" readonly/></td>
                                                  <td hidden><input type="hidden" name={{"A_ITEMID_REF_".$key}} id={{"A_ITEMID_REF_".$key}} class="form-control"  value="{{ $row->ITEMID_REF }}" autocomplete="off" /></td>
                                                  <td><input {{$ActionStatus}} type="text" name={{"A_ItemName_".$key}} id={{"A_ItemName_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ITEM_NAME }}" readonly/></td>
                                                  
                                                  <td {{$AlpsStatus['hidden']}}><input {{$ActionStatus}} type="text" name="A_Alpspartno_{{$key}}" id="A_Alpspartno_{{$key}}" class="form-control"  autocomplete="off" value="{{ isset($row->ALPS_PART_NO)?$row->ALPS_PART_NO:''}}" readonly/></td>
                                                  <td {{$AlpsStatus['hidden']}}><input {{$ActionStatus}} type="text" name="A_Custpartno_{{$key}}" id="A_Custpartno_{{$key}}" class="form-control"  autocomplete="off" value="{{ isset($row->CUSTOMER_PART_NO)?$row->CUSTOMER_PART_NO:''}}" readonly/></td>
                                                  <td {{$AlpsStatus['hidden']}}><input {{$ActionStatus}} type="text" name="A_OEMpartno_{{$key}}"  id="A_OEMpartno_{{$key}}" class="form-control"  autocomplete="off"  value="{{ isset($row->OEM_PART_NO)?$row->OEM_PART_NO:'' }}" readonly/></td>

                                                  
                                                  <td ><input  {{$ActionStatus}} type="text" name={{"A_popupUOM_".$key}} id={{"A_popupUOM_".$key}} class="form-control"  autocomplete="off" value="{{ $row->DESCRIPTIONS }}"  readonly/></td>
                                                  <td hidden><input type="hidden" name={{"A_UOMID_REF_".$key}} id={{"A_UOMID_REF_".$key}} class="form-control" value="{{ $row->UOMID_REF }}" autocomplete="off" /></td>
                                                  <td hidden><input {{$ActionStatus}} type="text" name={{"A_ITEMSPECI_".$key}} id={{"A_ITEMSPECI_".$key}} class="form-control" maxlength="200"  autocomplete="off"  value="{{ $row->ITEM_SPECS }}"/></td>
                                                  <td hidden><input {{$ActionStatus}} type="text" name={{"A_RATEPUOM_".$key}} id={{"A_RATEPUOM_".$key}} class="form-control five-digits" maxlength="13" value=""  autocomplete="off" /></td>
                                                  <td><input {{$ActionStatus}} type="text" name={{"ITEM_AMOUNT_".$key}} id={{"ITEM_AMOUNT_".$key}} class="form-control" maxlength="200" autocomplete="off"  value="{{ $row->ITEM_VALUE }}"/></td>
                                                  <td><input  type="text" {{$ActionStatus}} name={{"txtSTR_popup_".$key}} id={{"txtSTR_popup_".$key}}  class="form-control"  autocomplete="off" value="{{ $row->STCODE!=''? $row->STCODE .'-'.$row->STORE_NAME :'' }}"  readonly /></td>
                                            <td  hidden><input type="text" {{$ActionStatus}} name={{"STRID_REF_".$key}} id={{"STRID_REF_".$key}}   class="form-control " autocomplete="off" value="{{ $row->STID_REF }}" /></td>    
                                                  <td align="center">
                                                    <button {{$ActionStatus}} class="btn A_add A_material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                                                    <button {{$ActionStatus}} class="btn A_remove A_dmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button>
                                                  </td>
                                              </tr>
                                              <tr></tr>
                                          @endforeach 
                                  @else
                                          ...
                                          <tr  class="Additional_participantRow">
                                              ...
                                              <td {{$AlpsStatus['hidden']}}><input type="text" name="A_Alpspartno_0" id="A_Alpspartno_0" class="form-control"  autocomplete="off"  readonly/></td>
                                              <td {{$AlpsStatus['hidden']}}><input type="text" name="A_Custpartno_0" id="A_Custpartno_0" class="form-control"  autocomplete="off"  readonly/></td>
                                              <td {{$AlpsStatus['hidden']}}><input type="text" name="A_OEMpartno_0"  id="A_OEMpartno_0" class="form-control"  autocomplete="off"  readonly/></td>
...
<table id="GlCodeTable2" class="display nowrap table  table-striped table-bordered" >
  ...
  <tr >
  <td class="ROW1"> <input type="checkbox" name="SELECT_GLID_REF[]" id="glidcode_{{ $index }}" class="clsglid" value="{{ $glRow-> DEPID }}" ></td>
    <td class="ROW2">{{ $glRow-> DCODE }}
    <input type="hidden" id="txtglidcode_{{ $index }}" data-desc="{{ $glRow-> DCODE }}-{{ $glRow-> NAME }}"  value="{{ $glRow-> DEPID }}"/>
    </td>
...
<table id="UDFSOIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
  ...
  @foreach ($objUdfSOData2 as $udfindex=>$udfRow)
  <tr id="udfsoid_{{ $udfindex }}" class="clsudfsoid">
    <td width="50%">{{ $udfRow->LABEL }}
    <input type="hidden" id="txtudfsoid_{{ $udfindex }}" data-desc="{{ $udfRow->LABEL }}"  value="{{ $udfRow->UDFSPIID }}"/>
    </td>
...
<tr>
  ...
  <td style="width:10%;"><input type="text" id="Additional_Itemcodesearch" class="form-control" onkeyup="Additional_ItemCodeFunction('{{$FormId}}')"></td>
  <td style="width:10%;"><input type="text" id="Additional_Itemnamesearch" class="form-control" onkeyup="Additional_ItemNameFunction('{{$FormId}}')"></td>
  <td style="width:8%;"><input type="text" id="Additional_ItemUOMsearch" class="form-control" onkeyup="Additional_ItemUOMFunction('{{$FormId}}')"></td>
  <td style="width:8%;"><input type="text" id="Additional_ItemQTYsearch" class="form-control" onkeyup="Additional_ItemQTYFunction()"></td>
  <td style="width:8%;"><input type="text" id="Additional_ItemGroupsearch" class="form-control" onkeyup="Additional_ItemGroupFunction('{{$FormId}}')"></td>
  <td style="width:8%;"><input type="text" id="Additional_ItemCategorysearch" class="form-control" onkeyup="Additional_ItemCategoryFunction('{{$FormId}}')"></td>
  <td style="width:8%;"><input type="text" id="Additional_ItemBUsearch" class="form-control" onkeyup="Additional_ItemBUFunction('{{$FormId}}')"></td>
  <td style="width:8%;" {{$AlpsStatus['hidden']}} ><input type="text" id="Additional_ItemAPNsearch" class="form-control" onkeyup="Additional_ItemAPNFunction('{{$FormId}}')"></td>
  <td style="width:8%;" {{$AlpsStatus['hidden']}} ><input type="text" id="Additional_ItemCPNsearch" class="form-control" onkeyup="Additional_ItemCPNFunction('{{$FormId}}')"></td>
  <td style="width:8%;" {{$AlpsStatus['hidden']}} ><input type="text" id="Additional_ItemOEMPNsearch" class="form-control" onkeyup="Additional_ItemOEMPNFunction('{{$FormId}}')"></td>
...
$(".clstncid").click(function(){
  ...
  if(customid!=''){
    ...
    // $('#tncbody').html('<tr><td colspan="2">Please wait..</td></tr>');
      ...
      $.ajax({
          url:'{{route("transaction",[201,"gettncdetails2"])}}',
          type:'POST',
          data:{'id':customid},
      ...
      $.ajax({
          url:'{{route("transaction",[201,"gettncdetails3"])}}',
          type:'POST',
          data:{'id':customid},
          success:function(data) {
              $('#Row_Count2').val(data);
      ...
      $.ajax({
          url:'{{route("transaction",[201,"gettncdetails"])}}',
          type:'POST',
          data:{'id':customid},
          success:function(data) {
...
$(".clsctid").click(function(){
  ...
  if(customid!=''){
    ...
    $('#tbody_ctid').html('<tr><td colspan="2">Please wait..</td></tr>');
      ...
      $.ajax({
          url:'{{route("transaction",[201,"getcalculationdetails2"])}}',
          type:'POST',
          data:{'id':customid},
          success:function(data) {
      ...
      $.ajax({
          url:'{{route("transaction",[201,"getcalculationdetails3"])}}',
          type:'POST',
          data:{'id':customid},
          success:function(data) {
            $('#Row_Count4').val(data);
      ...
      $.ajax({
          url:'{{route("transaction",[201,"getcalculationdetails"])}}',
          type:'POST',
          data:{'id':customid},
          success:function(data) {
...
$('#tbody_subglacct').html('<tr><td colspan="2">Loading..</td></tr>');
  $.ajaxSetup({
      headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      }
  ...
  $.ajax({
      url:'{{route("transaction",[201,"getSPONO"])}}',
      type:'POST',
      success:function(data) {
...
function bindSubLedgerEvents(){
  $('.clssubgl').click(function(){
      ...
      $("#tbody_tdsappid").html(''); 
        ...
        $.ajax({
            url:'{{route("transaction",[201,"getTDSDetails"])}}',
            type:'POST',
            data:{'id':txtvendorid},
            success:function(data) {
        ...
        $.ajax({
            url:'{{route("transaction",[201,"getTDSDetailsCount"])}}',
            type:'POST',
            data:{'id':txtvendorid},
            success:function(data) {
              $('#Row_Count8').val(data);
      ...
      //--tds end
        ...
        //     });
        //     $.ajax({
        //         url:'{{route("transaction",[201,"getcreditdays"])}}',
        //         type:'POST',
        //         data:{'id':customid},
        //         success:function(data) {
        //           $("#CREDITDAYS").val(data);                        
        ...
        //     });
        //     $.ajax({
        //         url:'{{route("transaction",[201,"getBillTo"])}}',
        //         type:'POST',
        //         data:{'id':customid},
        //         success:function(data) {
        //           $("#txtBILLTO1").hide();
        ...
        //     });
        //     $.ajax({
        //         url:'{{route("transaction",[201,"getShipTo"])}}',
        //         type:'POST',
        //         data:{'id':customid},
        //         success:function(data) {
        //           $("#txtSHIPTO1").hide();
...
$('#div_billto').on('click','#txtBILLTO',function(event){
  ...
  $("#tbody_BillTo").html('');
            ...
            $.ajax({
                url:'{{route("transaction",[201,"getBillAddress"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
...
$('#div_shipto').on('click','#txtSHIPTO',function(event){
  ...
  $("#tbody_ShipTo").html('');
            ...
            $.ajax({
                url:'{{route("transaction",[201,"getShipAddress"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
...
if($.trim( $("#GLID_REF").val())=="" ){
 ...
 if($('#PO_BASED option:selected').val()=="Quotation"){
        ...
        $.ajax({
            url:'{{route("transaction",[201,"getvqlist"])}}',
            type:'POST',
            data:{'id':customid},
            success:function(data) {
              $("#tbody_SQ").html(data);
      ...
      $.ajax({
          url:'{{route("transaction",[201,"getpilist"])}}',
          type:'POST',
          data:{'id':customid},
          success:function(data) {
            $("#tbody_SQ").html(data);
...
$('#Material').on('click','[id*="popupITEMID"]',function(event){
    ...
    if($.trim($("#SLID_REF").val())=="" ){
      ...
      $("#OkBtn").hide();
      $("#OkBtn1").show();
      $("#AlertMessage").text('Please Select SPI No.');
      $("#alert").modal('show');
      $("#OkBtn1").focus();
      highlighFocusBtn('activeOk1');
      return false;
  ...
  var spoid = $.trim($('#SLID_REF').val());
          ...
          $.ajax({
              url:'{{route("transaction",[201,"getItemSPO"])}}',
              type:'POST',
...
$('#Material').on('keydown','[id*="popupAUOM"]',function(event){
  ...
  if(ItemID !=''){
          $("#tbody_altuom").html('');
            ...
            $.ajax({
                url:'{{route("transaction",[201,"getAltUOM"])}}',
                type:'POST',
                data:{'id':ItemID},
                success:function(data) {
...
$(".clsaltuom").dblclick(function(){
  ...
  if(altuomid!=''){
        $('#'+txt_id4).val('');
            ...
            $.ajax({
                url:'{{route("transaction",[201,"getaltuomqty"])}}',
                type:'POST',
...
var objsotds = <?php echo json_encode($objSOTDS); ?>;
var objtdsdata = <?php echo json_encode($ObjTDSData); ?>;
...
$.each( soudf, function( soukey, souvalue ) {
  $.each( udfforso, function( usokey, usovalue ) { 
      if(souvalue.UDF == usovalue.SRPOID)
      {
...
if(parseFloat(ases_val)> parseFloat(exmp_limit) ){
  var cal_amt = parseFloat(((parseFloat(ases_val)- parseFloat(exmp_limit)) * cal_rate)/100).toFixed(2);
...
$('#btnAdd').on('click', function() {
  var viewURL = '{{route("transaction",[201,"add"])}}';
...
if(parseFloat(ases_val2)> parseFloat(exmp_limit2) ){
  var cal_amt2 = parseFloat(((parseFloat(ases_val2)- parseFloat(exmp_limit2)) * cal_rate2)/100).toFixed(2);
...
if(parseFloat(ases_val3)> parseFloat(exmp_limit3) ){
  var cal_amt3 = parseFloat(((parseFloat(ases_val3)- parseFloat(exmp_limit3)) * cal_rate3)/100).toFixed(2);
...
if(parseFloat(ases_val4)> parseFloat(exmp_limit4) ){
  var cal_amt4 = parseFloat(((parseFloat(ases_val4) - parseFloat(exmp_limit4)) * cal_rate4)/100).toFixed(2);
...
//set tds value
$.each(objtdsdata, function( tkey, tvalue ) {
  $.each( objsotds, function( sotdskey, sotdsvalue ) { 
      if(sotdsvalue.TDSID_REF == tvalue.HOLDINGID)
      {
          $('#calTDS_'+tkey).prop('checked',true);
          $('#ASSEVAL_TDS_RATE_'+tkey).val(sotdsvalue.ASSESSABLE_VL_TDS);
          $('#ASSEVAL_TDS_RATE_'+tkey).removeAttr('readonly');                
          $('#ACT_TDS_RATE_'+tkey).val(sotdsvalue.TDS_RATE);
          $('#ACT_TDS_RATE_'+tkey).removeAttr('readonly'); 
          
          $('#ASSEVAL_SURCHARGE_RAGE_'+tkey).val(sotdsvalue.ASSESSABLE_VL_SURCHARGE);
          $('#ASSEVAL_SURCHARGE_RAGE_'+tkey).removeAttr('readonly');                
          $('#ACT_SURCHARGE_RAGE_'+tkey).val(sotdsvalue.SURCHARGE_RATE);

          $('#ASSEVAL_CESS_RATE_'+tkey).val(sotdsvalue.ASSESSABLE_VL_CESS);
          $('#ASSEVAL_CESS_RATE_'+tkey).removeAttr('readonly');                
          $('#ACT_SP_CESS_RATE_'+tkey).val(sotdsvalue.CESS_RATE);
         
          $('#ASSEVAL_SP_CESS_RATE_'+tkey).val(sotdsvalue.ASSESSABLE_VL_SPCESS);
          $('#ASSEVAL_SP_CESS_RATE_'+tkey).removeAttr('readonly');                
          $('#ACT_SP_CESS_RATE_'+tkey).val(sotdsvalue.SPCESS_RATE);
...
$('#frm_trn_so1').bootstrapValidator({
  ...
  fields: {
      txtlabel: {
          validators: {
              notEmpty: {
                  message: 'The SPI NO is required'
              }
          }
      },            
  },
...
var formPurchaseOrder = $("#frm_trn_so");
...
function validateForm(saveAction,msg){
...
var tdsfound = false;
  ...
  if(jQuery.inArray("false", allblank) !== -1){
      ...
      return false;
      ...
      else if(checkPeriodClosing('{{$FormId}}',$("#SODT").val(),0) ==0){
        $("#YesBtn").hide();
        $("#NoBtn").hide();
        $("#OkBtn").hide();
        $("#OkBtn1").show();
        ...
        $("#OkBtn1").focus();
              ...
              $("#alert").modal('show');
              $("#AlertMessage").text('Do you want to '+msg+ ' record.');
...
$.ajax({
url:'{{ route("transactionmodify",[201,"update"])}}',
type:'POST',
data:formData,
success:function(data) {
$(".buttonload").hide(); 
...
$.ajax({
url:'{{ route("transactionmodify",[201,"Approve"])}}',
type:'POST',
data:formData,
success:function(data) {
$("#btnApprove").show();  
...
$("#OkBtn").hide();
$(".text-danger").hide();
window.location.href = '{{route("transaction",[201,"index"]) }}';
});
...
$.ajax({
url:'{{route("transaction",[201,"getTaxStatus"])}}',
type:'POST',
data:{id:customid},
success:function(data) {
if(data =="1"){
...
$.ajax({
url:'{{route("transaction",[$FormId,"get_BOE"])}}',
type:'POST',
...
//old_value=$("#BOEID_REF_"+rowid).val();
...
var posts = $.ajax({
          url:'{{route("transaction",[$FormId,"getTotalSpoAmount"])}}',
          type:'POST',
          async: false,
          dataType: 'json',
...
var checkDuplicateVendorBillNo = $.ajax({type: 'POST',url:'{{route("transaction",[$FormId,"checkDuplicateVendorBillNoEdit"])}}',async: false,dataType: 'json',data: {REFNO:REFNO,VID_REF:VID_REF,SPIID:SPIID},done: function(response) {return response;}}).responseText;
