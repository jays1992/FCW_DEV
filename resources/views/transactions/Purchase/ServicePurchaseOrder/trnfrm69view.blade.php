...
<!-- <form id="frm_trn_so" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="{{route('transaction',[69,'index'])}}" class="btn singlebt">Service Purchase Order</a>
                </div><!--col-2-->

                <div class="col-lg-10 topnav-pd">
                        <button class="btn topnavbt" id="btnAdd" disabled="disabled"><i class="fa fa-plus"></i> Add</button>
                        <button class="btn topnavbt" id="btnEdit" disabled="disabled"><i class="fa fa-edit"></i> Edit</button>
                        <button class="btn topnavbt" id="btnSavePO" disabled="disabled" ><i class="fa fa-save"></i> Save</button>
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="SONO" id="SONO" value="{{ isset($objSO->SPO_NO)?$objSO->SPO_NO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
                            ...
                            <div class="col-lg-2 pl"><p>SPO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(69,this.value,1)" value="{{ isset($objSO->SPO_DT)?$objSO->SPO_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="col-lg-1 pl">
                                <input {{$ActionStatus}} type="checkbox" name="SOFC" id="SOFC" class="form-checkbox" {{ isset($objSO->SOFC) && $objSO->SOFC == 1 ? 'checked' : ''}} >
                            </div>
                            
                            <div class="col-lg-1 pl col-md-offset-1"><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                @if ( isset($objsocurrency) && count($objsocurrency) > 0)
                                <input {{$ActionStatus}} type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="{{ isset($objsocurrency[0])?$objsocurrency[0]:'' }}"   />
                                @else
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="{{ isset($objSO->CONVFACT)?$objSO->CONVFACT:'' }}" />
                            </div>
                        </div> --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="{{ isset($objsubglcode->VCODE)?$objsubglcode->VCODE:'' }} {{ isset($objsubglcode->NAME)?$objsubglcode->NAME:'' }}"  autocomplete="off" readonly/>
                                <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off"  value="{{ isset($objSO->VID_REF)?$objSO->VID_REF:'' }}"/>
                            ...
                            <div class="col-lg-2 pl"><p>SPO Validity From*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="{{ isset($objSO->VALID_FR)?$objSO->VALID_FR:'' }}" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>SPO Validity To*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="{{ isset($objSO->VALID_TO)?$objSO->VALID_TO:'' }}" >
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="{{ isset($objSO->VENDOR_REFNO)?$objSO->VENDOR_REFNO:'' }}" autocomplete="off" style="text-transform:uppercase">
                            </div>

                            <div class="col-lg-2 pl"><p>Credit Days</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="{{ isset($objSO->CREDIT_DAYS)?$objSO->CREDIT_DAYS:'' }}">
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                ...
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="{{ isset($objSO->BILL_TO)?$objSO->BILL_TO:'' }}" />
                            </div>

                            {{-- <div class="col-lg-2 pl"><p>Customer PO No</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="CUSTOMERPONO" id="CUSTOMERPONO" class="form-control" autocomplete="off" style="text-transform:uppercase" value="{{ isset($objSO->CUSTOMERPONO)?$objSO->CUSTOMERPONO:'' }}">
                            </div> --}}
                        </div>
                        ...
                        {{-- <div class="row">	 --}}
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="CUSTOMERDT" id="CUSTOMERDT" class="form-control " autocomplete="off" placeholder="dd/mm/yyyy" value="{{ isset($objSO->CUSTOMERDT)?$objSO->CUSTOMERDT:'' }}">
                            </div>
                            
                            <div class="col-lg-1 pl"><p>Sales Person</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="SPID_popup" id="txtSPID_popup" class="form-control mandatory"  autocomplete="off" value="{{ isset($objSPID[0])?$objSPID[0]:'' }}"  readonly/>
                            ...
                            <div class="col-lg-1 pl">
                                <input {{$ActionStatus}} type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="{{ isset($objSO->REFNO)?$objSO->REFNO:'' }}" autocomplete="off" style="text-transform:uppercase">
                            </div> --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                ...
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="{{ isset($objSO->SHIP_TO)?$objSO->SHIP_TO:'' }}" />
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" class="form-control " value="{{ isset($objSO->VENDOR_REFDT)?$objSO->VENDOR_REFDT:'' }}" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" hidden>
                                  <input type="checkbox" name="DirectPO" id="DirectPO" class="form-checkbox"   checked="checked"  >
                            </div>
                            ...
                            <div class="col-lg-6 pl">
                                <textarea {{$ActionStatus}} class="form-control w-100" name="Delivery_Address" cols="40" rows="10" id="Delivery_Address" autocomplete="off" >{{ isset($objSO->Delivery_Address)?$objSO->Delivery_Address:'' }}</textarea>
                            </div>
                                      ...
                                      <div class="table-responsive table-wrapper-scroll-y" style="height:400px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                                <tr>
                                                    <th rowspan="2" hidden>PI / VQ No</th>
                                                    ...
                                                    <th rowspan="2">Service Specification</th>
                                                    <th rowspan="2" hidden>Item Specification</th>
                                            ...
                                            @if(!empty($objSOMAT))
                                                @foreach($objSOMAT as $key => $row)
                                                    <tr  class="participantRow">
                                                        <td hidden><input  class="form-control" type="hidden" name={{"SOMATID_".$key}} id ={{"SOMATID_".$key}} maxlength="100" value="{{ $row->SPOMATID }}" autocomplete="off" style="width:130px;"   ></td>
                                                        <td style="text-align:center;" hidden>
                                                        <input {{$ActionStatus}} type="text" name={{"txtSQ_popup_".$key}} id={{"txtSQ_popup_".$key}} class="form-control"   autocomplete="off"   readonly style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"SQA_".$key}} id={{"SQA_".$key}} class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"SEQID_REF_".$key}} id={{"SEQID_REF_".$key}} class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                          
                                                        <td  hidden><input type="text" name={{"PIID_REF_".$key}} id={{ "PIID_REF_".$key }} class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"MRSID_REF_".$key}} id={{ "MRSID_REF_".$key }} class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"RFQID_REF_".$key}} id={{ "RFQID_REF_".$key }} class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                        ...
                                                        <td  hidden><input type="text" name={{"ITEMID_REF_".$key}} id={{"ITEMID_REF_".$key}} class="form-control"  value="{{ $row->SERVICECODE }}" autocomplete="off" style="width:130px;" /></td>
                                                        
                                                        <td><input {{$ActionStatus}} type="text" name={{"ItemName_".$key}} id={{"ItemName_".$key}} class="form-control" value="{{ $row->SERVICE_DESC }}" autocomplete="off"  readonly style="width:130px;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"SERVICE_SPECIFICATION_".$key}} id={{"SERVICE_SPECIFICATION_".$key}} class="form-control" value="{{ $row->SERVICE_SPECIFICATION }}" autocomplete="off" style="width:130px;" /></td>
                                                       
                                                        <td hidden><input type="text" name={{"Itemspec_".$key}} id={{"Itemspec_".$key}} class="form-control"  autocomplete="off" value="" style="width:130px;" /></td>
                                                        ...
                                                        <td hidden><input type="text" name={{"SQMUOM_".$key}} id={{"SQMUOM_".$key}} class="form-control"  autocomplete="off"  value="" readonly style="width:130px;" /></td>
                                                        <td hidden><input type="text" name={{"SQMUOMQTY_".$key}} id={{"SQMUOMQTY_".$key}} class="form-control" maxlength="13" value="" autocomplete="off"  readonly style="width:130px;" /></td>
                                                        <td hidden><input type="text" name={{"SQAUOM_".$key}} id={{"SQAUOM_".$key}} class="form-control"  autocomplete="off" value="" readonly style="width:130px;" /></td>
                                                        <td hidden><input type="text" name={{"SQAUOMQTY_".$key}} id={{"SQAUOMQTY_".$key}} class="form-control" maxlength="13" autocomplete="off" value=""  readonly style="width:130px;" /></td>
                                                        
                                                        <td><input {{$ActionStatus}} type="text" name={{"popupMUOM_".$key}} id={{"popupMUOM_".$key}} class="form-control"  autocomplete="off"  value="{{ $row->MAIN_UOM_CODE }}"  readonly disabled style="width:130px;" /></td>
                                                        ...
                                                        <td hidden><input type="text" name={{"PENDING_QTY_".$key }} id={{ "PENDING_QTY_".$key}} class="form-control three-digits" maxlength="13" value="" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"SO_QTY_".$key}} id={{"SO_QTY_".$key}} class="form-control three-digits" maxlength="13" value="@php echo number_format(floatVal($row->SPO_QTY),3,'.','');  @endphp"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                                                        ...
                                                        <td hidden><input type="text" name={{"popupAUOM_".$key}} id={{"popupAUOM_".$key}} class="form-control"  autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td hidden><input type="hidden" name={{"ALT_UOMID_REF_".$key}} id={{"ALT_UOMID_REF_".$key}} class="form-control"  autocomplete="off" value=""  readonly disabled style="width:130px;text-align:right;" /></td>
                                                        <td hidden><input type="text" name={{"ALT_UOMID_QTY_".$key}} id={{"ALT_UOMID_QTY_".$key}} class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->SPO_RATE }}"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCPER_".$key}} id={{"DISCPER_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->DISCOUNT_PER }}"  autocomplete="off" style="width:130px;text-align:right;"  {{$AlpsStatus['disabled']}} /></td>
                                                        <td><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="text" name={{"DISCOUNT_AMT_".$key}} id={{"DISCOUNT_AMT_".$key}} class="form-control two-digits" value="{{ $row->DIS_AMT }}" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;" {{$AlpsStatus['disabled']}} /></td>
                                        ...
                                        @if(!empty($objSOUDF))
                                            ...
                                            @foreach($objUdfSOData2 as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td hidden><input type="hidden" name={{"UDFSOID_REF_".$uindex}} id={{"UDFSOID_REF_".$uindex}} class="form-control" value="{{$uRow->SRPOID}}" autocomplete="off"   /></td>
                                            ...
                                            @if(!empty($objSOCAL))
                                                @foreach($objSOCAL as $Ckey => $Crow)
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td hidden style="text-align:center;"  ><input type="checkbox" class="filter-none" name={{"calACTUAL_".$Ckey}} id={{"calACTUAL_".$Ckey}} value=""  ></td>
                                                ...
                                                <tr  class="participantRow5">
                                                    ...
                                                    <td hidden style="text-align:center;"><input {{$ActionStatus}} type="checkbox" class="filter-none" name="calACTUAL_0" id="calACTUAL_0" value=""   ></td>
                                                    <td align="center" ><button class="btn add" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                </tr>
                                                <tr></tr>
                                            @endif 
...
<div id="glidpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
        <th class="ROW1"><span class="check_th">&#10004;</span></th>
        <td class="ROW2"><input type="text" id="glcodesearch" class="form-control" onkeyup="GLCodeFunction()"></td>
        <td class="ROW3"><input type="text" id="glnamesearch" class="form-control" onkeyup="GLNameFunction()"></td>
      </tr>
    </tbody>
    </table>
    ...
    <input type="text" id="UDFSOIDnamesearch" onkeyup="UDFSOIDNameFunction()">
      ...
      <table id="UDFSOIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="udfsoid_{{ $udfindex }}" class="clsudfsoid">
          ...
          <input type="hidden" id="txtudfsoid_{{ $udfindex }}" data-desc="{{ $udfRow->LABEL }}"  value="{{ $udfRow->SRPOID }}"/>
          </td>
      ...
      $(".clstncid").click(function(){
        ...
        if(customid!=''){
          ...
          // $('#tncbody').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'{{route("transaction",[69,"gettncdetails2"])}}',
                type:'POST',
                data:{'id':customid},
            ...
            $.ajax({
                url:'{{route("transaction",[69,"gettncdetails3"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                    $('#Row_Count2').val(data);
            ...
            $.ajax({
                url:'{{route("transaction",[69,"gettncdetails"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
      ...
      $(".clsctid").click(function(){
        ...
        if(customid!=''){
          ...
          $('#tbody_ctid').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'{{route("transaction",[69,"getcalculationdetails2"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
            ...
            $.ajax({
                url:'{{route("transaction",[69,"getcalculationdetails3"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $('#Row_Count4').val(data);
            ...
            $.ajax({
                url:'{{route("transaction",[69,"getcalculationdetails"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
...
function loadVendor(CODE,NAME){
  ...
  $.ajax({
    url:'{{route("transaction",[69,"getVendor"])}}',
    type:'POST',
            ...
            var customid = txtval;
              if(customid!=''){
                $("#CREDITDAYS").val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getcreditdays"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#CREDITDAYS").val(data);                        
                ...
                $("#BILLTO1").val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getBillTo"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#txtBILLTO1").hide();
                ...
                $("#SHIPTO1").val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getShipTo"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#txtSHIPTO1").hide();
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getTDSApplicability"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data){
                        if(data == 1){
                          ...
                          $('#drpTDS').val('Yes');
                              ...
                              $.ajax({
                                  url:'{{route("transaction",[69,"getTDSDetails"])}}',
                                  type:'POST',
                                  data:{'id':customid},
                                  success:function(data) {
                                    $("#tbody_tds").html('');
...
//------------------------
  ...
  $('#div_billto').on('click','#txtBILLTO',function(event){
        ...
        $("#tbody_BillTo").html('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getBillAddress"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
...
//------------------------
  ...
  $('#div_shipto').on('click','#txtSHIPTO',function(event){
        ...
        $("#tbody_ShipTo").html('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getShipAddress"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
  ...
  $('#Material').on('click','[id*="txtSQ_popup"]',function(event){
    ...
    if($.trim( $("#GLID_REF").val())=="" ){
       ...
       if($('#PO_BASED option:selected').val()=="Quotation"){
              ...
              $.ajax({
                  url:'{{route("transaction",[69,"getvqlist"])}}',
                  type:'POST',
                  data:{'id':customid},
                  success:function(data) {
                    $("#tbody_SQ").html(data);
            ...
            $.ajax({
                url:'{{route("transaction",[69,"getpilist"])}}',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $("#tbody_SQ").html(data);
...
function loadItem(taxstate,CODE,NAME,MUOM,GROUP,CTGRY,BUNIT,APART,CPART,OPART){
		...
		$.ajax({
      url:'{{route("transaction",[69,"getItemDetails"])}}',
			type:'POST',
  ...
  $('#Material').on('click','[id*="popupITEMID"]',function(event){
        ...
        var vendorid = $.trim($('#SLID_REF').val());
        // if(SalesQuotationID!=''){
        ...
        //             });
        //             $.ajax({
        //                 url:'{{route("transaction",[69,"getItemDetailsVQwise"])}}',
        //                 type:'POST',
        ...
        // {
                ...
                $("#tbody_ItemID").html('Loading...');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getItemDetailswithoutQuotation"])}}',
                      type:'POST',
      ...
      function bindItemEvents()
    {
      ...
      { //select all checkbox
        ...
        $('#Material').find('.participantRow').each(function(){
          if($(this).find('[id*="ITEMID_REF"]').val() != '')
          {
            var seitem = $(this).find('[id*="txtSQ_popup"]').val()+'-'+$(this).find('[id*="SEQID_REF"]').val()+'-'+$(this).find('[id*="ITEMID_REF"]').val()+'-'+$(this).find('[id*="PIID_REF"]').val()+'-'+$(this).find('[id*="MRSID_REF"]').val()+'-'+$(this).find('[id*="RFQID_REF"]').val();
        ...
        var rfqids =  $('#hdn_ItemID25').val();
            ...
            if($(this).find('[id*="chkId"]').is(":checked") == true) 
            {
              ...
              var txtenqitem = txtenqno+'-'+txtenqid+'-'+txtval+'-'+txtpiid+'-'+txtmrsid+'-'+txtrfqid;
    ...
    $('[id*="chkId"]').change(function()
    {
        ...
        $('#Material').find('.participantRow').each(function(){
          if($(this).find('[id*="ITEMID_REF"]').val() != '')
          {
            var seitem = $(this).find('[id*="SERVICE_SPECIFICATION"]').val()+'-'+$(this).find('[id*="RATEPUOM"]').val()+'-'+$(this).find('[id*="txtSQ_popup"]').val()+'-'+$(this).find('[id*="SEQID_REF"]').val()+'-'+$(this).find('[id*="ITEMID_REF"]').val()+'-'+$(this).find('[id*="PIID_REF"]').val()+'-'+$(this).find('[id*="MRSID_REF"]').val()+'-'+$(this).find('[id*="RFQID_REF"]').val();
            SalesEnq2.push(seitem);
          }
        });
        ...
        var txtspe='';
            ...
            {
              var txtenqitem = txtspec+'-'+txtruom+'-'+txtenqno+'-'+txtenqid+'-'+txtval+'-'+txtpiid+'-'+txtmrsid+'-'+txtrfqid;
              if(jQuery.inArray(txtenqitem, SalesEnq2) !== -1)
              {
              ...
              */   
                      if($('#hdn_ItemID').val() == "" && txtval != '')
                      {
                        ...
                        $clone.find('[id*="ItemName"]').val(txtname);
                        $clone.find('[id*="Itemspec"]').val(txtspec);
                        $clone.find('[id*="SERVICE_SPECIFICATION"]').val(txtspec);
                        $clone.find('[id*="Alpspartno"]').val(apartno);
                        $clone.find('[id*="Custpartno"]').val(cpartno);
                        $clone.find('[id*="OEMpartno"]').val(opartno);
                        $clone.find('[id*="SQMUOM"]').val(txtmuom);
                      ...
                      else
                      {
                          ...
                          $('#'+txtid).parent().parent().find('[id*="SERVICE_SPECIFICATION"]').val(txtspec);
                          $('#'+txtid).parent().parent().find('[id*="SEQID_REF"]').val(txtenqid);
                          $('#'+txtid).parent().parent().find('[id*="DISAFTT_AMT"]').val(txtamt);
                          $('#'+txtid).parent().parent().find('[id*="TOT_AMT"]').val(txttotamtatax);
                          $('#'+txtid).parent().parent().find('[id*="TGST_AMT"]').val(txttottaxamt);
  ...
  $('#Material').on('keydown','[id*="popupAUOM"]',function(event){
        ...
        if(ItemID !=''){
                $("#tbody_altuom").html('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getAltUOM"])}}',
                      type:'POST',
                      data:{'id':ItemID},
                      success:function(data) {
      ...
      $(".clsaltuom").dblclick(function(){
        ...
        if(altuomid!=''){
              $('#'+txt_id4).val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[69,"getaltuomqty"])}}',
                      type:'POST',
  ...
  var Material = $("#Material").html(); 
   ...
   // $('#Row_Count5').val(count5);
    ...
    $.each( obj, function( key, value ) {
        ...
        var itemid = value.SERVICECODE;
        
  
        var enqid = '';
        var sqid = '';

        var amtbeforedis = parseFloat(value.SPO_RATE*value.SPO_QTY).toFixed(2);
        ...
        $.each( uomconv2, function( umc2key, umc2value ) {
            ...
            {   
              var altqty2 = (value.SPO_QTY*umc2value.TO_QTY)/umc2value.FROM_QTY;  
    ...
    var last_DT = <?php //echo json_encode($objlast_DT[0]->SPO_DT); ?>;
    ...
    */
    ...
    $('#btnAdd').on('click', function() {
        var viewURL = '{{route("transaction",[69,"add"])}}';
    ...
    $('#frm_trn_so1').bootstrapValidator({
        ...
        fields: {
            txtlabel: {
                validators: {
                    notEmpty: {
                        message: 'The SPO NO is required'
                    }
                }
            },            
        },
...
$("#btnApprove").click(function(){
  ...
  if(formPurchaseOrder.valid()){
    ...
    if(parseFloat(checkAttachment) > 0){
...
function validateForm(saveAction,msg)
{
 ...
 var SHIPTO1       =   $.trim($("#SHIPTO1").val());
  ...
  if($('#TotalValue').val() < '0.00'){
    ...
    return false;
     ...
     $("#NoBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Please enter value in SPO No.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 }
     ...
     $("#NoBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Please select SPO Date.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 } 
 ...
 /* else if(REFNO ===""){
     ...
     $("#NoBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Please Enter Vendor Bill No.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 } 
 ...
 else if(SHIPTO =="" && SHIPTO1 ==""){
     $("#YesBtn").hide();
     $("#NoBtn").hide();
     $("#OkBtn").hide();
     $("#OkBtn1").show();
     $("#AlertMessage").text('Ship To can not be left blank.');
     $("#alert").modal('show');
     $("#OkBtn1").focus();
     return false;
 } 
    ...
    var existArray = [];
        ...
        $('#Material').find('.participantRow').each(function(){
          ...
          var checkExist =  $.trim($(this).find("[id*=ITEMID_REF]").val())+'_'+$.trim($(this).find("[id*=SERVICE_SPECIFICATION]").val())+'_'+$.trim($(this).find("[id*=RATEPUOM]").val());
        ...
        if(jQuery.inArray("false", allblank) !== -1){
            ...
            $("#alert").modal('show');
            $("#AlertMessage").text('SPO Quantity under section is missing in Material Tab.');
            $("#YesBtn").hide(); 
            $("#NoBtn").hide();  
            $("#OkBtn1").show();
            $("#OkBtn1").focus();
            ...
            $("#alert").modal('show');
            $("#AlertMessage").text('Please enter SPO Rate in Material Tab.');
            $("#YesBtn").hide(); 
            $("#NoBtn").hide();  
            $("#OkBtn1").show();
            $("#OkBtn1").focus();
            ...
            else if(checkPeriodClosing(69,$("#SODT").val(),0) ==0){
              $("#YesBtn").hide();
              $("#NoBtn").hide();
              $("#OkBtn").hide();
              $("#OkBtn1").show();
...
$.ajax({
    url:'{{ route("transactionmodify",[69,"update"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
        ...
        if(data.errors) {
            ...
            if(data.errors.SONO){
                showError('ERROR_SONO',data.errors.SONO);
                        ...
                        $("#NoBtn").hide();
                        $("#OkBtn1").show();
                        $("#AlertMessage").text('Please enter correct value in SPO NO.');
                        $("#alert").modal('show');
                        $("#OkBtn1").focus();
            }
...
$.ajax({
    url:'{{ route("transactionmodify",[69,"Approve"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '{{route("transaction",[69,"index"]) }}';
});
...
// ONLOAD FUNCTION FOR DISCOUNT AMOUNT DTA

$(function() { 

  $('#Material').find("[id*='DISCOUNT_AMT']").each(function(){
...
$(document).ready(function(){
  ...
  var lastdt = <?php echo json_encode($objlastdt[0]->SPO_DT); ?>;
  var spo = <?php echo json_encode($objSO); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < spo.SPO_DT)
  {
	$('#SODT').attr('min',lastdt);
  }
  else
  {
	  $('#SODT').attr('min',spo.SPO_DT);
  }
...
$("#TDS").on('change', "[id*='TDSApplicable']", function(){
  ...
  if($(this).is(':checked') == true)
  {
    $(this).parent().parent().find('[id*="TDS_RATE"]').prop('readonly',false);
    var taxamt12 = 0.00;
    $('#Material').find('.participantRow').each(function()
    {
  ...
  {
    $(this).parent().parent().find('[id*="TDS_RATE"]').prop('readonly',true);
...
function getTaxStatus(customid){
  ...
  $.ajax({
    url:'{{route("transaction",[69,"getTaxStatus"])}}',
    type:'POST',
    data:{id:customid},
    success:function(data) {
      if(data =="1"){
  ...
  /*
  var TaxStatus = $.ajax({type: 'POST',url:'{{route("transaction",[69,"getTaxStatus"])}}',async: false,dataType: 'json',data: {id:customid},done: function(response) {return response;}}).responseText;
