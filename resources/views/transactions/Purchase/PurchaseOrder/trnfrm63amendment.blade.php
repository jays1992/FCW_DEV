...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="{{route('transaction',[63,'index'])}}" class="btn singlebt">Purchase Order Amendment</a>
                </div><!--col-2-->
      ...
      <form id="frm_trn_po"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                      ...
                      <div class="row">
                        <div class="col-lg-2 pl"><p>POA No*</p></div>
                        <div class="col-lg-2 pl">
                          <input type="text" name="POANO" id="POANO" value="{{ isset($MAXANO)?$MAXANO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                          <input type="hidden" name="POID_REF" id="POID_REF" value="{{ isset($objPO->POID)?$objPO->POID:'' }}" class="form-control" maxlength="15"  autofocus readonly >
                        </div>

                        <div class="col-lg-2 pl"><p>POA Date*</p></div>
                        <div class="col-lg-2 pl">
                            <input type="date" name="POA_DT" id="POADT"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                        </div>

                        <div class="col-lg-2 pl"><p>Reason to amend  PO*</p></div>
                          <div class="col-lg-2 pl">
                              <input type="text" name="REASONOFPOA" id="REASONOFPOA" class="form-control mandatory" autocomplete="off" maxlength="200"  >
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="PONO" id="PONO" value="{{ isset($objPO->PO_NO)?$objPO->PO_NO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>PO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="PODT" id="PODT" onchange="checkPeriodClosing(63,this.value,1)" value="{{ isset($objPO->PO_DT)?$objPO->PO_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy"  readonly>
                            </div>
                            
                            <div class="col-lg-2 pl"><p>From Department*</p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="DEPT_popup" id="txtdept_popup" class="form-control mandatory" value="{{ isset($objdeptcode2->DCODE)?$objdeptcode2->DCODE:'' }} {{ isset($objdeptcode2->NAME)?'-'.$objdeptcode2->NAME:'' }}"  autocomplete="off" readonly disabled/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="VENDOR_popup" id="txtvendor_popup" class="form-control mandatory" value="{{ isset($objvendorcode->VCODE)?$objvendorcode->VCODE:'' }} {{ isset($objvendorcode->NAME)?'-'.$objvendorcode->NAME:'' }}"  autocomplete="off" readonly disabled/>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="{{ isset($objPO->PO_VRF)?$objPO->PO_VRF:'' }}" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>PO Validity To*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="{{ isset($objPO->PO_VTO)?$objPO->PO_VTO:'' }}" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="{{ isset($objPO->VENDOR_REF_NO)?$objPO->VENDOR_REF_NO:'' }}" autocomplete="off" style="text-transform:uppercase">
                            </div>

                            <div class="col-lg-2 pl"><p>Credit Days</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="{{ isset($objPO->CREDIT_DAYS)?$objPO->CREDIT_DAYS:'' }}" readonly /> 
                            </div>
                            ...
                            <div class="col-lg-3 pl">
                                <input type="text" name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="{{ isset($objPO->REMARKS)?$objPO->REMARKS:'' }}"  >
                            </div> --}}
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="{{ isset($objBillAddress[0])?$objBillAddress[0]:'' }}" readonly disabled />
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" class="form-control " value="{{ isset($objPO->VENDOR_REF_DT)?$objPO->VENDOR_REF_DT:'' }}" autocomplete="off" placeholder="dd/mm/yyyy"  >
                            </div> 


                            <div class="col-lg-2 pl"><p>Direct PO Order</p></div>
                            <div class="col-lg-2 pl">
                                  <input type="checkbox" name="DirectPO" id="DirectPO" class="form-checkbox"  @if( isset($objPO->PO_BASED) && $objPO->PO_BASED=="Direct")  checked="checked" @endif  disabled>                                  
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <select name="PO_BASED" id="PO_BASED" class="form-control"  @if( isset($objPO->PO_BASED) && $objPO->PO_BASED=="Direct")  disabled @endif disabled>
                              ...
                              <input type="hidden" name="HDNPO_BASED" id="HDNPO_BASED" value="{{ isset($objPO->PO_BASED)?$objPO->PO_BASED:'' }}" class="form-control">                              
                            </div>
                            ...
                            <div class="col-lg-2 pl"><p>Remarks</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="REMARKS" id="REMARKS" class="form-control" maxlength="200" value="{{ isset($objPO->REMARKS)?$objPO->REMARKS:'' }}" autocomplete="off" disabled />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Delivery Address</p></div>
                            <div class="col-lg-6 pl">
                                <textarea class="form-control w-100" name="Delivery_Address" cols="40" rows="10" id="Delivery_Address" autocomplete="off" disabled>{{ isset($objPO->Delivery_Address)?$objPO->Delivery_Address:'' }}</textarea>
                            </div>

                            <div class="col-lg-2 pl"><p>Reverse GST</p></div>
                            <div class="col-lg-2 pl">
                              <input type="checkbox" name="GST_Reverse" id="GST_Reverse" {{ isset($objPO->REVERSE_GST) && $objPO->REVERSE_GST =='1' ?'checked':'' }}   />                          
                            </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl">
                            <input type="checkbox" name="GST_N_Avail" id="GST_N_Avail" {{ isset($objPO->GST_INPUT) && $objPO->GST_INPUT =='1' ?'checked':'' }}   />
                          </div> 
                                        ...
                                        @if(!empty($objPOMAT))
                                            @foreach($objPOMAT as $key => $row)
                                                ...
                                                <tr  class="participantRow">
                                                    ...
                                                    <td ><input {{$ActionStatus}} type="text" name={{"PENDING_QTY_".$key }} id={{ "PENDING_QTY_".$key}} class="form-control three-digits" maxlength="13" value="{{ $row->CAL_PENDING_QTY }}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                    ...
                                                    <td><input {{$ActionStatus}} type="text" name={{"NOOFUNITS_".$key}} id={{"NOOFUNITS_".$key}} onkeypress="return onlyNumberKey(event)" class="form-control three-digits" maxlength="13" value="@php echo number_format(floatVal($row->NOOFUNITS),3,'.','');  @endphp"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                                            ...
                                            @if(!empty($objPOCAL))
                                                @foreach($objPOCAL as $Ckey => $Crow)
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td><input type="text" name={{"calIGST_".$Ckey}} id={{"calIGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off" value="{{$Crow->IGST}}" readonly/></td>
                                                        <td><input type="text" name={{"AMTIGST_".$Ckey}} id={{"AMTIGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name={{"calCGST_".$Ckey}} id={{"calCGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off" value="{{$Crow->CGST}}" readonly/></td>
                                                        <td><input type="text" name={{"AMTCGST_".$Ckey}} id={{"AMTCGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name={{"calSGST_".$Ckey}} id={{"calSGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off" value="{{$Crow->SGST}}" readonly/></td>
                                                        <td><input type="text" name={{"AMTSGST_".$Ckey}} id={{"AMTSGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name={{"TOTGSTAMT_".$Ckey}} id={{"TOTGSTAMT_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
                                                ...
                                                <tr  class="participantRow5">
                                                    ...
                                                    <td><input type="text" name="calIGST_0" id="calIGST_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="AMTIGST_0" id="AMTIGST_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="calCGST_0" id="calCGST_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="AMTCGST_0" id="AMTCGST_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="calSGST_0" id="calSGST_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="AMTSGST_0" id="AMTSGST_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="TOTGSTAMT_0" id="TOTGSTAMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
                                            ...
                                            @if(!empty($objPOPSLB))
                                                @foreach($objPOPSLB as $Pkey => $Prow)
                                                    <tr  class="participantRow6">
                                                        ...
                                                        <td> <input type="text" class="form-control" id={{"PAY_DAYS_".$Pkey}} name={{"PAY_DAYS_".$Pkey}} onkeypress="return onlyNumberKey(event)" value="{{$Prow->PAY_DAYS}}" autocomplete="off"  /> </td>
                                                ...
                                                @else
                                                <tr  class="participantRow6">
                                                        <td> <input type="text" class="form-control" id="PAY_DAYS_0" name="PAY_DAYS_0"  onkeypress="return onlyNumberKey(event)" autocomplete="off" /> </td>
...
$(document).ready(function(e) {
  var Material = $("#Material").html(); 
    ...
    // $('#PODT').val(today);
    var podata = <?php echo json_encode(isset($objPO->PO_DT)?$objPO->PO_DT:''); ?>;
    $('#OVFDT').attr('min',podata);
    // $('#OVTDT').val(todate);
...
$( "#btnSavePO" ).click(function() {
  ...
  if(formPurchaseOrder.valid()){
    ...
    var POADT           =   $.trim($("#POADT").val());
    var REASONOFPOA     =   $.trim($("#REASONOFPOA").val());
    ...
    $("#NoBtn").hide();
    $("#OkBtn1").show();
    $("#AlertMessage").text('Please select POA Date.');
    $("#alert").modal('show');
    $("#OkBtn1").focus();
    return false;
} 
else if(REASONOFPOA ===""){
    $("#FocusId").val($.trim($("#REASONOFPOA")));
    $("#REASONOFPOA").val('');  
    $("#ProceedBtn").focus();
    $("#YesBtn").hide();
    $("#NoBtn").hide();
    $("#OkBtn1").show();
    $("#AlertMessage").text('Please enter value for Reason to amend PO.');
    $("#alert").modal('show');
    $("#OkBtn1").focus();
    return false;
} 
    ...
    var allblank12 = [];
        ...
        if(new Date(OVFDT)>new Date(OVTDT)){
            ...
            $('#example4').find('.participantRow4').each(function(){
                  if($.trim($(this).find("[id*=UDFPOID_REF]").val())!="")
                    {
                        allblank8.push('true');
...
$.ajax({
    url:'{{ route("transactionmodify",[63,"saveamendment"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$(document).ready(function(){
  var lastdt = <?php echo json_encode(isset($objPO->PO_DT)?$objPO->PO_DT:''); ?>;
  var today = new Date(); 
  var sodate = <?php echo json_encode(isset($objPO->PO_DT)?$objPO->PO_DT:''); ?>;
