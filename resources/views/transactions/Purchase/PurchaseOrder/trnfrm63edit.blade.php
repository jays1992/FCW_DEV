      ...
      <form id="frm_trn_po"  method="POST">   
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="PONO" id="PONO" value="{{ isset($objPO->PO_NO)?$objPO->PO_NO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="PODT" id="PODT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ isset($objPO->PO_DT)?$objPO->PO_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>From Department*</p></div>
                            <div class="col-lg-2 pl">
                            <input {{$ActionStatus}} type="text" name="DEPT_popup" id="txtdept_popup" class="form-control mandatory" value="{{ isset($objdeptcode2->DCODE)?$objdeptcode2->DCODE:'' }} {{ isset($objdeptcode2->NAME)?'-'.$objdeptcode2->NAME:'' }}"  autocomplete="off" readonly/>
                            <input type="hidden" name="DEPT_REF" id="DEPT_REF" class="form-control" autocomplete="off" value="{{ isset($objPO->DEPID_REF)?$objPO->DEPID_REF:'' }}" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="VENDOR_popup" id="txtvendor_popup" class="form-control mandatory" value="{{ isset($objvendorcode->VCODE)?$objvendorcode->VCODE:'' }} {{ isset($objvendorcode->NAME)?'-'.$objvendorcode->NAME:'' }}"  autocomplete="off" readonly/>
                                <input type="hidden" name="VENDORID_REF" id="VENDORID_REF" class="form-control" autocomplete="off"  value="{{ isset($objPO->VID_REF)?$objPO->VID_REF:'' }}"/>
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="{{ isset($objPO->PO_VRF)?$objPO->PO_VRF:'' }}" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>PO Validity To*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="{{ isset($objPO->PO_VTO)?$objPO->PO_VTO:'' }}" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="{{ isset($objPO->VENDOR_REF_NO)?$objPO->VENDOR_REF_NO:'' }}" autocomplete="off" style="text-transform:uppercase">
                            </div>

                            <div class="col-lg-2 pl"><p>Credit Days</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="{{ isset($objPO->CREDIT_DAYS)?$objPO->CREDIT_DAYS:'' }}" readonly />
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                ...
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="{{ isset($objPO->BILLTO)?$objPO->BILLTO:'' }}" />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input {{$ActionStatus}} type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="{{ isset($objBillAddress[0])?$objBillAddress[0]:'' }}" readonly  />
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="{{ isset($objPO->SHIPTO)?$objPO->SHIPTO:'' }}" />
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" class="form-control " value="{{ isset($objPO->VENDOR_REF_DT)?$objPO->VENDOR_REF_DT:'' }}" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div> 

                            <div class="col-lg-2 pl"><p>Direct PO Order</p></div>
                            <div class="col-lg-2 pl">
                                  <input {{$ActionStatus}} type="checkbox" name="DirectPO" id="DirectPO" class="form-checkbox"  @if( isset($objPO->PO_BASED) && strtolower($objPO->PO_BASED)=="direct")  checked="checked" @endif  disabled >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <select {{$ActionStatus}} name="PO_BASED" id="PO_BASED" class="form-control"  @if( isset($objPO->PO_BASED) && $objPO->PO_BASED=="Direct")  disabled @endif>
                                <option value="" selected="selected">--Please select--</option>
                                <option value="PI" @if( isset($objPO->PO_BASED) && $objPO->PO_BASED=="PI") selected="selected" @endif>PI</option>
                                <option value="Quotation" @if( isset($objPO->PO_BASED) && $objPO->PO_BASED=="Quotation") selected="selected" @endif >Quotation</option>
                              </select>
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="TotalValue" id="TotalValue" class="form-control" value="0.00" autocomplete="off" readonly  />
                            </div>
                            <div class="col-lg-2 pl"><p>Remarks</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="REMARKS" id="REMARKS" class="form-control" maxlength="200" value="{{ isset($objPO->REMARKS)?$objPO->REMARKS:'' }}" autocomplete="off" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Delivery Address</p></div>
                            <div class="col-lg-6 pl">
                                <textarea {{$ActionStatus}} class="form-control w-100" name="Delivery_Address" cols="40" rows="10" id="Delivery_Address" autocomplete="off" >{{ isset($objPO->Delivery_Address)?$objPO->Delivery_Address:'' }}</textarea>
                            </div>

                            <div class="col-lg-2 pl"><p>Reverse GST</p></div>
                            <div class="col-lg-2 pl">
                              <input {{$ActionStatus}} type="checkbox" name="GST_Reverse" id="GST_Reverse" {{ isset($objPO->REVERSE_GST) && $objPO->REVERSE_GST =='1' ?'checked':'' }}   />                          
                            </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl">
                            <input {{$ActionStatus}} type="checkbox" name="GST_N_Avail" id="GST_N_Avail" {{ isset($objPO->GST_INPUT) && $objPO->GST_INPUT =='1' ?'checked':'' }}   />
                          </div> 
                          ...
                          <div  class="col-lg-2 pl ExceptionalGST" style="display:none;">
                            <input {{$ActionStatus}} type="checkbox" name="EXE_GST" id="EXE_GST" class="filter-none"  value="1" onchange="getExceptionalGst()" > 
                          </div>
                        </div>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y" style="height:400px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                                    ...
                                                    <tr>
                                                      <th colspan="4"></th>
                                                      <th colspan="3" {{$AlpsStatus['hidden']}}></th>
                                                ...
                                                <tr>
                                                    {{-- <th rowspan="2">PI / VQ No</th> --}}
                                                    <th rowspan="2" hidden>VQPI</th><input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" >
                                                    ...
                                                    <th rowspan="2">Qty (Main UOM)</th>
                                                    <th rowspan="2" {{$AlpsStatus['hidden']}} >{{isset($objAddlItem->FIELD1) && $objAddlItem->FIELD1 !=''?$objAddlItem->FIELD1:'Add. No. Of Units'}}</th></th> --}}
                                                    <th rowspan="2">ALT UOM</th>
                                                    <th rowspan="2">Qty (Alt UOM)</th>
                                            ...
                                            @if(!empty($objPOMAT))
                                                @foreach($objPOMAT as $key => $row)
                                                    ...
                                                    <tr  class="participantRow">
                                                        <td hidden><input  class="form-control" type="hidden" name={{"POMATID_".$key}} id ={{"POMATID_".$key}} maxlength="100" value="{{ $row->POMATID }}" autocomplete="off"   ></td>
                                                        
                                                        <td style="text-align:center;" hidden >
                                                        <input {{$ActionStatus}} type="hidden" name={{"txtPIVQ_popup_".$key}} id={{"txtPIVQ_popup_".$key}} class="form-control"   autocomplete="off"   readonly style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"VQPINO_".$key}} id={{"VQPINO_".$key}} class="form-control" value="{{ $row->RFQPINO }}" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"DYNAMICID_REF_".$key}} id={{"DYNAMICID_REF_".$key}} class="form-control" value="{{ $row->RFQPINO }}" autocomplete="off" style="width:130px;" /></td>
                                                          
                                                        <td  hidden><input type="text" name={{"PIID_REF_".$key}} id={{ "PIID_REF_".$key }} class="form-control" value="{{  $row->PIID_REF }}" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"MRSID_REF_".$key}} id={{ "MRSID_REF_".$key }} class="form-control" value="{{  $row->MRSID_REF }}" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"RFQID_REF_".$key}} id={{ "RFQID_REF_".$key }} class="form-control" value="{{  $row->RFQID_REF }}" autocomplete="off" style="width:130px;" /></td>
                                                    
                                                       
                                                        <td><input {{$ActionStatus}} type="text" name={{"popupITEMID_".$key}} id={{"popupITEMID_".$key}} class="form-control" value="{{ $row->ICODE }}"  autocomplete="off"  readonly style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name={{"ITEMID_REF_".$key}} id={{"ITEMID_REF_".$key}} class="form-control"  value="{{ $row->ITEMID_REF }}" autocomplete="off" style="width:130px;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"ItemName_".$key}} id={{"ItemName_".$key}} class="form-control" value="{{ $row->ITEM_NAME }}"  autocomplete="off"  readonly style="width:130px;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"Itemspec_".$key}} id={{"Itemspec_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ITEMSPECI }}" style="width:130px;" /></td>
                                                        <td hidden {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="hidden" name={{"Alpspartno_".$key}} id={{"Alpspartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ALPS_PART_NO }}" readonly style="width:130px;" /></td>
                                                        <td hidden {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="hidden" name={{"Custpartno_".$key}} id={{"Custpartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->CUSTOMER_PART_NO }}" readonly style="width:130px;" /></td>
                                                        <td hidden {{$AlpsStatus['hidden']}} ><input {{$ActionStatus}} type="hidden" name={{"OEMpartno_".$key}} id={{"OEMpartno_".$key}} class="form-control"  autocomplete="off" value="{{ $row->OEM_PART_NO }}" readonly style="width:130px;" /></td>
                                                        
                                                        <td hidden ><input {{$ActionStatus}} type="hidden" name={{"PI_VQMUOM_".$key}} id={{"PI_VQMUOM_".$key}} class="form-control"  autocomplete="off"  value="{{ $row->MUOM_DESC }}" readonly style="width:130px;" /></td>
                                                        <td hidden ><input {{$ActionStatus}} type="hidden" name={{"PI_VQMUOMQTY_".$key}} id={{"PI_VQMUOMQTY_".$key}} class="form-control" maxlength="13" value="{{ $row->MUOM_QTY }}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        <td hidden ><input {{$ActionStatus}} type="hidden" name={{"PI_VQAUOM_".$key}} id={{"PI_VQAUOM_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ALTUOM_DESC }}" readonly style="width:130px;" /></td>
                                                        <td hidden ><input {{$ActionStatus}} type="hidden" name={{"PI_VQAUOMQTY_".$key}} id={{"PI_VQAUOMQTY_".$key}} class="form-control" maxlength="13" autocomplete="off" value="{{ $row->ALTUOM_QTY }}"  readonly style="width:130px;text-align:right;" /></td>
                                                        
                                                        <td><input {{$ActionStatus}} type="text" name={{"popupMUOM_".$key}} id={{"popupMUOM_".$key}} class="form-control" value="{{ $row->MAIN_UOM_CODE }}"  autocomplete="off"  readonly style="width:130px;" /></td>
                                                        <td hidden><input type="hidden" name={{"MAIN_UOMID_REF_".$key}} id={{"MAIN_UOMID_REF_".$key}} class="form-control" value="{{ $row->UOMID_REF }}" autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        
                                                        <td><input {{$ActionStatus}} type="text" name={{"PO_QTY_".$key}} id={{"PO_QTY_".$key}} onkeypress="return onlyNumberKey(event)" class="form-control three-digits" maxlength="13" value="@php echo number_format(floatVal($row->PO_QTY),3,'.','');  @endphp"  autocomplete="off" style="width:130px;text-align:right;"  /></td>

                                                        <td hidden><input {{$ActionStatus}} type="hidden" name={{"PENDING_QTY_".$key }} id={{ "PENDING_QTY_".$key}} class="form-control three-digits" maxlength="13" value="{{ $row->CAL_PENDING_QTY }}" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        
                                                        <td hidden><input type="hidden" name={{"PO_FQTY_".$key}} id={{"PO_FQTY_".$key}} class="form-control three-digits" maxlength="13"  autocomplete="off"   readonly style="width:130px;text-align:right;" /></td>
                                                        
                                                        <td hidden><input {{$ActionStatus}} type="hidden" name={{"NOOFUNITS_".$key}} id={{"NOOFUNITS_".$key}} onkeypress="return onlyNumberKey(event)" class="form-control three-digits" maxlength="13" value="@php echo number_format(floatVal($row->NOOFUNITS),3,'.','');  @endphp"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                                                        
                                                        <td><input {{$ActionStatus}} type="text" name={{"popupAUOM_".$key}} id={{"popupAUOM_".$key}} class="form-control" value="{{ $row->AULT_UOM_CODE }}"  autocomplete="off"  readonly style="width:130px;" /></td>
                                                        <td hidden><input type="hidden" name={{"ALT_UOMID_REF_".$key}} id={{"ALT_UOMID_REF_".$key}} class="form-control"  autocomplete="off" value="{{ $row->ALTUOMID_REF }}"  readonly style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"ALT_UOMID_QTY_".$key}} id={{"ALT_UOMID_QTY_".$key}} class="form-control three-digits" value="{{ ($row->PO_QTY*$row->TO_QTY)/$row->FROM_QTY }}" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        
                                                        <td><input {{$ActionStatus}} type="text" name={{"LASTPRICE_".$key}} id={{"LASTPRICE_".$key}} class="form-control five-digits" maxlength="13" value="{{ $row->PURCHASE_PRICE }}"  autocomplete="off" style="width:130px;text-align:right;" readonly/></td>

                                                        <td hidden><input type="hidden" name={{"PPLM_DET_ID_".$key}} id={{"PPLM_DET_ID_".$key}} value="{{ $row->PPLM_DET_ID_REF }}" class="form-control five-digits" readonly/></td>

                                                        <td><input {{$ActionStatus}} type="text" name={{"RATEPUOM_".$key}} id={{"RATEPUOM_".$key}} onkeypress="return onlyNumberKey(event)" class="form-control five-digits" maxlength="13" value="{{ $row->PURCHASE_PRICE }}"  autocomplete="off" style="width:130px;text-align:right;" readonly/></td>
                                                        <td hidden ><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="hidden" name={{"DISCPER_".$key}} id={{"DISCPER_".$key}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" value="{{ $row->DISCOUNT_PER }}"  autocomplete="off"  @if(strpos($objCOMPANY->NAME,"ALPS")!== false)  disabled @endif style="width:130px;text-align:right;" /></td>
                                                        <td hidden ><input {{$ActionStatus}} {{$AlpsStatus['disabled']}} type="hidden" name={{"DISCOUNT_AMT_".$key}} id={{"DISCOUNT_AMT_".$key}} class="form-control two-digits" value="{{ $row->DIS_AMT }}" maxlength="15"  autocomplete="off" @if(strpos($objCOMPANY->NAME,"ALPS")!== false)  disabled @endif style="width:130px;text-align:right;" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"DISAFTT_AMT_".$key}} id={{"DISAFTT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"IGST_".$key}} id={{"IGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->IGST }}" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)"/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"IGSTAMT_".$key}} id={{"IGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"CGST_".$key}} id={{"CGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->CGST }}" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"CGSTAMT_".$key}} id={{"CGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"SGST_".$key}} id={{"SGST_".$key}} class="form-control four-digits" maxlength="8" value="{{ $row->SGST }}" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"SGSTAMT_".$key}} id={{"SGSTAMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"TGST_AMT_".$key}} id={{"TGST_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"TOT_AMT_".$key}} id={{"TOT_AMT_".$key}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td align="center">
                                            ...
                                            <tr  class="participantRowFotter">
                                              ...
                                              <td hidden {{$AlpsStatus['hidden']}} ></td>
                                              <td hidden {{$AlpsStatus['hidden']}} ></td>
                                              <td hidden {{$AlpsStatus['hidden']}} ></td>
                                              <td hidden id="PI_VQMUOMQTY_total"   style="text-align:right;font-weight:bold;"></td>
                                              <td hidden id="PI_VQAUOMQTY_total"   style="text-align:right;font-weight:bold;"></td>
                                              <td hidden id="PENDING_QTY_total"    style="text-align:right;font-weight:bold;"></td>
                                              <td id="PO_QTY_total"         style="text-align:right;font-weight:bold;"></td>
                                              <td></td><td></td>
                                              <td hidden id="ALT_UOMID_QTY_total"  style="text-align:right;font-weight:bold;"></td>
                                        ...
                                        @if(!empty($objPOUDF))
                                            @foreach($objPOUDF as $Ukey => $Urow)
                                                <tr  class="participantRow4">
                                                    <td><input {{$ActionStatus}} type="text" name={{"popupUDFPOID_".$Ukey}} id={{"popupUDFPOID_".$Ukey}}  class="form-control"  autocomplete="off"  readonly/></td>
                                            ...
                                            @foreach($objUdfPOData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  <td><input {{$ActionStatus}} type="text" name={{"popupUDFPOID_".$uindex}} id={{"popupUDFPOID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
                                            ...
                                            @if(!empty($objPOCAL))
                                                @foreach($objPOCAL as $Ckey => $Crow)
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td><input {{$ActionStatus}} type="text" name={{"calIGST_".$Ckey}} id={{"calIGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off" value="{{$Crow->IGST}}" readonly/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"AMTIGST_".$Ckey}} id={{"AMTIGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"calCGST_".$Ckey}} id={{"calCGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off" value="{{$Crow->CGST}}" readonly/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"AMTCGST_".$Ckey}} id={{"AMTCGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"calSGST_".$Ckey}} id={{"calSGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off" value="{{$Crow->SGST}}" readonly/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"AMTSGST_".$Ckey}} id={{"AMTSGST_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input {{$ActionStatus}} type="text" name={{"TOTGSTAMT_".$Ckey}} id={{"TOTGSTAMT_".$Ckey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
                                                ...
                                                <tr  class="participantRow5">
                                                    ...
                                                    <td style="text-align:center;" ><input {{$ActionStatus}} type="checkbox" class="filter-none" name="calGST_0" id="calGST_0" value="" ></td>
                                                    <td><input {{$ActionStatus}} type="text" name="calIGST_0" id="calIGST_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                    <td><input {{$ActionStatus}} type="text" name="AMTIGST_0" id="AMTIGST_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                    <td><input {{$ActionStatus}} type="text" name="calCGST_0" id="calCGST_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                    <td><input {{$ActionStatus}} type="text" name="AMTCGST_0" id="AMTCGST_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                    <td><input {{$ActionStatus}} type="text" name="calSGST_0" id="calSGST_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                    <td><input {{$ActionStatus}} type="text" name="AMTSGST_0" id="AMTSGST_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                    <td><input {{$ActionStatus}} type="text" name="TOTGSTAMT_0" id="TOTGSTAMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
                                            ...
                                            @if(!empty($objPOPSLB))
                                                @foreach($objPOPSLB as $Pkey => $Prow)
                                                    <tr  class="participantRow6">
                                                        ...
                                                        <td> <input {{$ActionStatus}} type="text" class="form-control" id={{"PAY_DAYS_".$Pkey}} name={{"PAY_DAYS_".$Pkey}} onkeypress="return onlyNumberKey(event)" value="{{$Prow->PAY_DAYS}}" autocomplete="off"  /> </td>
                                                        <td> <input {{$ActionStatus}} type="text" class="form-control four-digits" id={{"DUE_".$Pkey}} name={{"DUE_".$Pkey}} value="{{$Prow->DUE}}" maxlength="8" autocomplete="off" /> </td>
                                                        <td> <input {{$ActionStatus}} type="text" class="form-control" id={{"PSREMARKS_".$Pkey}} name={{"PSREMARKS_".$Pkey}} value="{{$Prow->REMARKS}}" autocomplete="off"  /> </td>
                                                        <td> <input {{$ActionStatus}} type="date" class="form-control" id={{"DUE_DATE_".$Pkey}} name={{"DUE_DATE_".$Pkey}}  value="{{$Prow->DUE_DATE}}" autocomplete="off"  readonly /> </td>
                                                        <td align="center" >
                                                ...
                                                @else
                                                <tr  class="participantRow6">
                                                        <td> <input {{$ActionStatus}} type="text" class="form-control" id="PAY_DAYS_0" name="PAY_DAYS_0"  onkeypress="return onlyNumberKey(event)" autocomplete="off" /> </td>
                                                        <td> <input {{$ActionStatus}} type="text" class="form-control four-digits" id="DUE_0" name="DUE_0"  maxlength="8" autocomplete="off" /> </td>
                                                        <td> <input {{$ActionStatus}} type="text" class="form-control" id="PSREMARKS_0" name="PSREMARKS_0" autocomplete="off"  /> </td>
                                                        <td> <input {{$ActionStatus}} type="date" class="form-control" id="DUE_DATE_0" name="DUE_DATE_0" autocomplete="off"  readonly /> </td>
                                                        <td align="center" >
                                                          <button {{$ActionStatus}} class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                                                          <button {{$ActionStatus}} class="btn remove" title="Delete" data-toggle="tooltip" type="button" ><i class="fa fa-trash" ></i></button>
                                                        </td>
            ...
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                  <select {{$ActionStatus}} name="drpTDS" id="drpTDS" class="form-control">
                      <option value=""></option>    
                      <option {{ isset($objPO->TDS) && $objPO->TDS =='1'?'selected="selected"':'' }} value="Yes">Yes</option>
                      <option {{ isset($objPO->TDS) && $objPO->TDS =='0'?'selected="selected"':'' }} value="No">No</option>
                  </select>
                </div>
            </div>
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example7" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                          <tr>
                              <th width="8%">TDS<input class="form-control" type="hidden" name="Row_Count4" id ="Row_Count4"  value="{{$objCount6}}" /></th>
                    ...
                    @if(!empty($objPBTDS))
                      @foreach($objPBTDS as $tkey => $trow)
                        <tr  class="participantRow7">
                            ...
                            <td><input {{$ActionStatus}} type="text" name={{"ASSESSABLE_VL_TDS_".$tkey}} id={{"ASSESSABLE_VL_TDS_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" value="{{$trow->ASSESSABLE_VL_TDS}}" maxlength="15"  autocomplete="off"  /></td>
                            <td><input {{$ActionStatus}} type="text" name={{"TDS_RATE_".$tkey}} id={{"TDS_RATE_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12" value="{{$trow->TDS_RATE}}" autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name={{"TDS_EXEMPT_".$tkey}} id={{"TDS_EXEMPT_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" value="0.00" /></td>
                            <td><input {{$ActionStatus}} type="text" name={{"TDS_AMT_".$tkey}} id={{"TDS_AMT_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  value="{{$trow->TDS_AMT}}" readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name={{"ASSESSABLE_VL_SURCHARGE_".$tkey}} id={{"ASSESSABLE_VL_SURCHARGE_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" value="{{$trow->ASSESSABLE_VL_SURCHARGE}}" maxlength="15"  autocomplete="off" /></td>
                            <td><input {{$ActionStatus}} type="text" name={{"SURCHARGE_RATE_".$tkey}} id={{"SURCHARGE_RATE_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12" value="{{$trow->SURCHARGE_RATE}}"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name={{"SURCHARGE_EXEMPT_".$tkey}} id={{"SURCHARGE_EXEMPT_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" value="0.00" /></td>
                            <td><input {{$ActionStatus}} type="text" name={{"SURCHARGE_AMT_".$tkey}} id={{"SURCHARGE_AMT_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" value="{{$trow->SURCHARGE_AMT}}" autocomplete="off"  readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name={{"ASSESSABLE_VL_CESS_".$tkey}} id={{"ASSESSABLE_VL_CESS_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" value="{{$trow->ASSESSABLE_VL_CESS}}" autocomplete="off" /></td>
                            <td><input {{$ActionStatus}} type="text" name={{"CESS_RATE_".$tkey}} id={{"CESS_RATE_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12" value="{{$trow->CESS_RATE}}" autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name={{"CESS_EXEMPT_".$tkey}} id={{"CESS_EXEMPT_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" value="0.00" /></td>
                            <td><input {{$ActionStatus}} type="text" name={{"CESS_AMT_".$tkey}} id={{"CESS_AMT_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" value="{{$trow->CESS_AMT}}" autocomplete="off"  readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name={{"ASSESSABLE_VL_SPCESS_".$tkey}} id={{"ASSESSABLE_VL_SPCESS_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" value="{{$trow->ASSESSABLE_VL_SPCESS}}"  autocomplete="off" /></td>
                            <td><input {{$ActionStatus}} type="text" name={{"SPCESS_RATE_".$tkey}} id={{"SPCESS_RATE_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12" value="{{$trow->SPCESS_RATE}}" autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name={{"SPCESS_EXEMPT_".$tkey}} id={{"SPCESS_EXEMPT_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" value="0.00" /></td>
                            <td><input {{$ActionStatus}} type="text" name={{"SPCESS_AMT_".$tkey}} id={{"SPCESS_AMT_".$tkey}} onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15" value="{{$trow->SPCESS_AMT}}"  autocomplete="off"  readonly/></td>
                  @php
                  ...
                  @endphp
                    ...
                    @else
                        <tr  class="participantRow7">
                            ...
                            <td><input {{$ActionStatus}} type="text" name="ASSESSABLE_VL_TDS_0" id="ASSESSABLE_VL_TDS_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
                            <td><input {{$ActionStatus}} type="text" name="TDS_RATE_0" id="TDS_RATE_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name="TDS_EXEMPT_0" id="TDS_EXEMPT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" /></td>
                            <td><input {{$ActionStatus}} type="text" name="TDS_AMT_0" id="TDS_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name="ASSESSABLE_VL_SURCHARGE_0" id="ASSESSABLE_VL_SURCHARGE_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                            <td><input {{$ActionStatus}} type="text" name="SURCHARGE_RATE_0" id="SURCHARGE_RATE_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name="SURCHARGE_EXEMPT_0" id="SURCHARGE_EXEMPT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" /></td>
                            <td><input {{$ActionStatus}} type="text" name="SURCHARGE_AMT_0" id="SURCHARGE_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name="ASSESSABLE_VL_CESS_0" id="ASSESSABLE_VL_CESS_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                            <td><input {{$ActionStatus}} type="text" name="CESS_RATE_0" id="CESS_RATE_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name="CESS_EXEMPT_0" id="CESS_EXEMPT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" /></td>
                            <td><input {{$ActionStatus}} type="text" name="CESS_AMT_0" id="CESS_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name="ASSESSABLE_VL_SPCESS_0" id="ASSESSABLE_VL_SPCESS_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                            <td><input {{$ActionStatus}} type="text" name="SPCESS_RATE_0" id="SPCESS_RATE_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name="SPCESS_EXEMPT_0" id="SPCESS_EXEMPT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" /></td>
                            <td><input {{$ActionStatus}} type="text" name="SPCESS_AMT_0" id="SPCESS_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td><input {{$ActionStatus}} type="text" name="TOT_TD_AMT_0" id="TOT_TD_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td style="min-width: 100px;" >
                            <button {{$ActionStatus}} class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                            <button {{$ActionStatus}} class="btn remove" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button>
                          </td>
                    ...
                    @endif
                              ...
                              <div id="ADDITIONAL" class="tab-pane fade">
                                ...
                                <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                  ...
                                  <div class="col-lg-6 pl">
                                  <textarea name="Template_Description" id="Template_Description" cols="118" rows="10" >{{ isset($Template->TEMPLATE)?$Template->TEMPLATE:'' }}</textarea>
                                  </div>
                                </div>                                
                              </div>
    ...
    <tr>
      ...
      <table id="TNCIDTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tr>
          ...
          <input type="hidden" id="txttncidcode_{{ $tncindex }}" data-desc="{{ $tncRow-> TNC_CODE }} - {{ $tncRow-> TNC_DESC }}"  value="{{ $tncRow-> TNCID }}"/></td>
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
      ...
      <table id="DEPTCodeTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tbody>
        @foreach ($objdeptcode as $index=>$glRow)
        <tr >
          <td class="ROW1"> <input type="checkbox" name="SELECT_DEPT_REF[]" id="deptidcode_{{ $index }}" class="clsdeptid" value="{{ $glRow-> DEPID }}" ></td>
          <td class="ROW2">{{ $glRow-> DCODE }} <input type="hidden" id="txtdeptidcode_{{ $index }}" data-desc="{{ $glRow-> DCODE }}-{{ $glRow-> NAME }}"  value="{{ $glRow-> DEPID }}"/></td>
          <td class="ROW3">{{ $glRow-> NAME }}</td>
        </tr>
        @endforeach
        </tbody>
      </table>
            ...
            var customid = txtval;
              if(customid!=''){
                ...
                $("#SHIPTO1").val('');
                  ...
                  $.ajax({
                      url:'{{route("transaction",[63,"getTDSApplicability"])}}',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data){
                        if(data == 1){
                          ...
                          $('#drpTDS').val('Yes');
                              ...
                              $.ajax({
                                  url:'{{route("transaction",[63,"getTDSDetails"])}}',
                                  type:'POST',
                                  data:{'id':customid},
                                  success:function(data) {
                                    $("#tbody_tds").html('');
...
//------------------------
  ...
  $('#Material').on('click','[id*="txtPIVQ_popup"]',function(event){
...
function loadItem(taxstate,CODE,NAME,MUOM,GROUP,CTGRY,BUNIT,APART,CPART,OPART){
		...
		$.ajax({
      url:'{{route("transaction",[63,"getItemDetails"])}}',
			type:'POST',
  ...
  $('#Material').on('click','[id*="popupITEMID"]',function(event){
    ...
    function bindItemEvents()
    {
      ...
      { 
        ...
        $('#ItemIDTable2').find('.clsitemid').each(function(){
          ...
          var fieldid5505 = $(this).find('[id*="ratepuom"]').attr('id');
          var txtratepuom =  $("#txt"+fieldid5505+"").val();

          var fieldid555 = $(this).find('[id*="lppid"]').attr('id');
          var txtlppid =  $("#txt"+fieldid555+"").val();
          ...
          if(txtratepuom== undefined)
          {
            txtratepuom = '0.00000';
          }

          if(txtlppid== undefined)
          {
            txtlppid = '0.00000';
          }
              ...
              if(pivendorquotation.indexOf(txtpivqno) != -1 && itemids.indexOf(txtval) != -1 && pivq_ids.indexOf(txtdynamicid_ref) != -1 && purindids.indexOf(txtpiid) != -1 && mrsids.indexOf(txtmrsid) != -1 && rfqids.indexOf(txtrfqid) != -1 )
              {
                  ...
                  if($('#hdn_ItemID').val() == "" && txtval != '')
                  {
                    ...
                    $clone.find('td').each(function(){
                        ...
                        $clone.find('[id*="RATEPUOM_"]').val(txtratepuom);

                        $clone.find('[id*="PPLM_DET_ID_"]').val(txtlppid);
                  ...
                  else
                  {
                      ...
                      $('#'+txtid).parent().parent().find ('[id*="RATEPUOM_"]').val(txtratepuom);

                      $('#'+txtid).parent().parent().find ('[id*="PPLM_DET_ID_"]').val(txtlppid);
    ...
    $('[id*="chkId"]').change(function()
    {
        ...
        var fieldid5505 = $(this).parent().parent().children('[id*="ratepuom"]').attr('id');
        var txtratepuom =  $("#txt"+fieldid5505+"").val();

        var fieldid555 = $(this).parent().parent().children('[id*="lppid"]').attr('id');
        var txtlppid =  $("#txt"+fieldid555+"").val();
  ...
  var Material = $("#Material").html(); 
    ...
    $.each( obj, function( key, value ) {
       ...
       // var enqid = value.RFQPINO;
        ...
        var amtbeforedis = parseFloat(value.PURCHASE_PRICE*value.PO_QTY).toFixed(2);
  ...
  if($('#TotalValue').val() < '0.00'){
    ...
    var allblank12 = [];
            ...
            if(jQuery.inArray("false", allblank) !== -1){
              ...
              else if(checkPeriodClosing('{{$FormId}}',$("#PODT").val(),0) ==0){
              $("#YesBtn").hide();
              $("#NoBtn").hide();
              $("#OkBtn").hide();
              $("#OkBtn1").show();
...
$(document).ready(function(){
  ...
  var po = <?php echo json_encode($objPO); ?>;
  var today = new Date(); 
...
function getTotalRowValue(){
  ...
  var PI_VQMUOMQTY  = 0.00;
  var PI_VQAUOMQTY  = 0.00;
  var PENDING_QTY   = 0.00;
  var PO_QTY        = 0.00;
  var ALT_UOMID_QTY = 0.00;
  var RATEPUOM      = 0.00;
  var DISCOUNT_AMT  = 0.00;
  var DISAFTT_AMT   = 0.00;
  var IGSTAMT       = 0.00;
  var CGSTAMT       = 0.00;
  var SGSTAMT       = 0.00;
  var TGST_AMT      = 0.00;
...
function getTaxStatus(customid){
  ...
  var TaxStatus = $.ajax({type: 'POST',url:'{{route("transaction",[63,"getTaxStatus"])}}',async: false,dataType: 'json',data: {id:customid},done: function(response) {return response;}}).responseText;
...
$(document).ready(function(){
  ...
  <?php if(isset($objPO->EXE_GST) && $objPO->EXE_GST =='1'){?>
    taxStatusWiseTaxCalculation();
    $(".ExceptionalGST").show();
    $("#EXE_GST").prop('checked', true);
  <?php } ?>
