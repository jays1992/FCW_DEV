            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="PODT" id="PODT" value="{{ isset($objPO->PO_DT)?$objPO->PO_DT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
...
if(attachcount ==="0"){
    ...
    $("#NoBtn").hide();
    $("#OkBtn1").show();
    $("#AlertMessage").text('Please attach the Vendor Document before approve the Purchase Order.');
    $("#alert").modal('show');
    $("#OkBtn1").focus();
    return false;
}
else if($('#TotalValue').val() < '0.00'){
    $("#YesBtn").hide();
    $("#NoBtn").hide();
    $("#OkBtn").hide();
    $("#OkBtn1").show();
