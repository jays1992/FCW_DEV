            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="PONO" id="PONO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="PODT" id="PODT" onchange='checkPeriodClosing(63,this.value,1),getDocNoByEvent("PONO",this,@json($doc_req))' value="{{ old('PODT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                                ...
                                                <tr>
                                                    ...
                                                    <th rowspan="2" hidden>VQPI</th><input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="1">
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    ...
                                                    <input type="hidden" name="txtPIVQ_popup_0" id="txtPIVQ_popup_0" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                                                    ...
                                                    <td hidden {{$AlpsStatus['hidden']}} ><input type="hidden" name="Alpspartno_0" id="Alpspartno_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"  /></td>
                                                    <td hidden {{$AlpsStatus['hidden']}} ><input type="hidden" name="Custpartno_0" id="Custpartno_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"  /></td>
                                                    <td hidden {{$AlpsStatus['hidden']}} ><input type="hidden" name="OEMpartno_0" id="OEMpartno_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"  /></td>
                                                    <td hidden><input type="hidden" name="PI_VQMUOM_0" id="PI_VQMUOM_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"  /></td>
                                                    <td hidden><input type="hidden" name="PI_VQMUOMQTY_0" id="PI_VQMUOMQTY_0" class="form-control" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                    <td hidden><input type="hidden" name="PI_VQAUOM_0" id="PI_VQAUOM_0" class="form-control"  autocomplete="off"  readonly style="width:130px;"  /></td>
                                                    <td hidden><input type="hidden" name="PI_VQAUOMQTY_0" id="PI_VQAUOMQTY_0" class="form-control" maxlength="13" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                    ...
                                                    <td><input type="text" name="PO_QTY_0" id="PO_QTY_0" onkeypress="return onlyNumberKey(event)" class="form-control three-digits text-right" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"   /></td>
                                                    
                                                    <td hidden><input type="hidden" name="PENDING_QTY_0" id="PENDING_QTY_0" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>

                                                    <td hidden><input type="hidden" name="NOOFUNITS_0" id="NOOFUNITS_0" onkeypress="return onlyNumberKey(event)" class="form-control three-digits text-right" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"   /></td>
                                                    ...
                                                    <td><input type="text" name="LASTPRICE_0" id="LASTPRICE_0" onkeypress="return onlyNumberKey(event)" class="form-control five-digits" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" readonly/></td>

                                                    <td hidden><input type="hidden" name="PPLM_DET_ID_0" id="PPLM_DET_ID_0" class="form-control five-digits" readonly/></td>


                                                    <td><input type="text" name="RATEPUOM_0" id="RATEPUOM_0" onkeypress="return onlyNumberKey(event)" class="form-control five-digits" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" readonly/></td>
                                                    <td hidden><input {{$AlpsStatus['disabled']}} type="hidden" name="DISCPER_0" id="DISCPER_0" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;"   {{$AlpsStatus['disabled']}} /></td>
                                                    <td hidden><input {{$AlpsStatus['disabled']}} type="hidden" name="DISCOUNT_AMT_0" id="DISCOUNT_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;"   {{$AlpsStatus['disabled']}} /></td>
                                            ...
                                            <tr  class="participantRowFotter">
                                              ...
                                              <td hidden id="DISCOUNT_AMT_total"   style="text-align:right;font-weight:bold;"></td>
                                      ...
                                      <table id="example7" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                          ...
                                          <tbody id="tbody_tds">
                                                <tr  class="participantRow7">
                                                    ...
                                                    <td><input type="text" name="ASSESSABLE_VL_TDS_0" id="ASSESSABLE_VL_TDS_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
                                                    <td><input type="text" name="TDS_RATE_0" id="TDS_RATE_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                                                    ...
                                                    <td><input type="text" name="TDS_AMT_0" id="TDS_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="ASSESSABLE_VL_SURCHARGE_0" id="ASSESSABLE_VL_SURCHARGE_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                                                    <td><input type="text" name="SURCHARGE_RATE_0" id="SURCHARGE_RATE_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                                                    ...
                                                    <td><input type="text" name="SURCHARGE_AMT_0" id="SURCHARGE_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="ASSESSABLE_VL_CESS_0" id="ASSESSABLE_VL_CESS_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                                                    <td><input type="text" name="CESS_RATE_0" id="CESS_RATE_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                                                    ...
                                                    <td><input type="text" name="CESS_AMT_0" id="CESS_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="ASSESSABLE_VL_SPCESS_0" id="ASSESSABLE_VL_SPCESS_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                                                    <td><input type="text" name="SPCESS_RATE_0" id="SPCESS_RATE_0" onkeypress="return onlyNumberKey(event)" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                                                    ...
                                                    <td><input type="text" name="SPCESS_AMT_0" id="SPCESS_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="TOT_TD_AMT_0" id="TOT_TD_AMT_0" onkeypress="return onlyNumberKey(event)" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
    ...
    //to check the label duplicacy
     $('#PONO').focusout(function(){
      ...
      if(PONO ===""){
        ...
        $.ajax({
            url:'{{route("transaction",[63,"checkpo"])}}',
            type:'POST',
            data:{'PONO':trnpo_no},
            success:function(data) {
               if(data.exists) {
...
$('#PaymentSlabs').on('change','[id*="PAY_DAYS"]',function( event ) {
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('transaction',[63,'add'])}}";
