...
class CommonController extends Controller{
    ...
    public function read_notification(Request $request){
        ...
        $query="SELECT SCID AS DOC_ID,SCNO AS DOC_NO,SCDT AS DOC_DATE ,'challan' as FORM_NAME,'TBL_TRN_SLSC01_HDR' as TABLE_NAME,'SCID' AS COLUMN_NAME FROM TBL_TRN_SLSC01_HDR WHERE CYID_REF='$CYID_REF' AND BRID_REF='$BRID_REF' AND STATUS='A' AND NOTIFY_STATUS='1'
        union
        SELECT PPLM_ID AS DOC_ID,PPLM_NO AS DOC_NO,PPLM_DATE AS DOC_DATE ,'product price' as FORM_NAME,'TBL_MST_PPLM' as TABLE_NAME,'PPLM_ID' AS COLUMN_NAME FROM TBL_MST_PPLM WHERE CYID_REF='$CYID_REF' AND BRID_REF='$BRID_REF' AND STATUS='A' AND NOTIFY_STATUS='1'
        union
