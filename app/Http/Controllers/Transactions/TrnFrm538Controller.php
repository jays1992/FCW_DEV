...
class TrnFrm538Controller extends Controller{
    ...
    public function getCountryMaster(Request $request){
        ...
        WHERE  CYID_REF='$CYID_REF' AND STATUS='A' AND (DEACTIVATED=0 OR DEACTIVATED IS NULL) ORDER BY NAME
        "); 
    ...
    public function getStateMaster(Request $request){
        ...
        NAME AS DATA_DESC
        FROM TBL_MST_STATE 
        WHERE  CYID_REF='$CYID_REF' AND CTRYID_REF='$COUNTRY_ID' AND STATUS='A' AND (DEACTIVATED=0 OR DEACTIVATED IS NULL) ORDER BY NAME
        "); 
    ...
    public function getCityMaster(Request $request){
        ...
        NAME AS DATA_DESC
        FROM TBL_MST_CITY 
        WHERE  CYID_REF='$CYID_REF' AND CTRYID_REF='$COUNTRY_ID' AND STID_REF='$STATE_ID' AND STATUS='A' AND (DEACTIVATED=0 OR DEACTIVATED IS NULL) ORDER BY NAME
        "); 
    ...
    public function getVehicleMakeMaster(Request $request){
        ...
        WHERE  CYID_REF='$CYID_REF' AND STATUS='A' AND (DEACTIVATED=0 OR DEACTIVATED IS NULL) ORDER BY VM_NAME         
        "); 
