...
class RptFrm475Controller extends Controller{

    protected $form_id  =   475;
    protected $vtid_ref =   545;  
    protected $view_ref =   "LeadConvertedToOpportunityEmployeeWise";
    protected $repo_nam =   "Lead Converted To Opportunity Employee Wise";
