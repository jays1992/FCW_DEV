...
use Chartblocks;
use App\Exports\Job_Card_Detailed;
...
class RptFrm548Controller extends Controller
{
    ...
    protected $view     = "reports.purchase.Job_Card_Detailed.rptfrm";
    // //validation messages  
    // 
    /**
    ...
    public function ViewReport($request) {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/Job_Card_Details_Report');
        ...
        {
            //return Excel::download(new Job_Card_Detailed($From_Date,$To_Date,$BranchName,$CYID_REF), 'JobCardDetailed.xlsx');
