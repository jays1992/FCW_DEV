...
class RptFrm391Controller extends Controller
{
    protected $form_id = 391;
    protected $vtid_ref   = 476;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
     ...
     //   dd($ObjCustomer);
        ...
        return view('reports.Accounts.GSTR2.rptfrm391',compact(['objRights','objBranchGroup','objBranch','ObjCustomer']));        
    }  
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/GSTR2');
       ...
       // dd($reportParameters); 
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            return Excel::download(new GSTR2($SGLID,$From_Date,$To_Date,$BranchName,$CYID_REF), 'GST_Return.xlsx');
