...
class RptFrm276Controller extends Controller
{
    protected $form_id = 276;
    protected $vtid_ref   = 366;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.sales.MGMT_NSSR.rptfrm276',compact(['objRights','objBranchGroup','objBranch','objFYear',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/M3R_SO_NetSales');
