...
class RptFrm464Controller extends Controller{

    protected $form_id  =   464;
    protected $vtid_ref =   534;  
    protected $view_ref =   "LeadRegisterEmployeeConsolidated";
    protected $repo_nam =   "Lead Register Employee Consolidated";
