...
class RptFrm288Controller extends Controller
{
    protected $form_id = 288;
    protected $vtid_ref   = 378;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        $ObjItem = DB::table('TBL_TRN_MRQS01_HDR')
                        ->leftJoin('TBL_TRN_MRQS01_MAT', 'TBL_TRN_MRQS01_MAT.MRSID_REF','=','TBL_TRN_MRQS01_HDR.MRSID')
                        ...
                        ->where('TBL_TRN_MRQS01_HDR.CYID_REF','=',Auth::user()->CYID_REF)
                        ->where('TBL_TRN_MRQS01_HDR.BRID_REF','=',Auth::user()->BRID_REF)
        ...
        $objMRS =  DB::table('TBL_TRN_MRQS01_HDR')
        ...
        return view('reports.inventory.MRS_Register.rptfrm288',compact(['objRights','objBranchGroup','objBranch',
                    'ObjItemGrp','ObjItem','objMRS','company_check']));        
    }  
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/MRS_Register');
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            {
                return Excel::download(new MRS_Register($MRSID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF), 'MRS_Register.xlsx');
            }
