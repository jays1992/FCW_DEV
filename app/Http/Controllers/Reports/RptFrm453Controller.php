...
class RptFrm453Controller extends Controller
{
    protected $form_id    = 453;
    protected $vtid_ref   = 523;  //voucher type id  
    ...
    $ObjLeaveType           =       DB::select("SELECT LTID,LEAVETYPE_CODE,dbo.fn_titlecase(LEAVETYPE_DESC) AS LEAVETYPE_DESC FROM TBL_MST_LEAVE_TYPE
        ...
        return view('reports.Payroll.OTRegister.rptfrm453',compact([
        'objRights',
        'objBranchGroup',
        'objBranch',
        'ObjPayPeriod',
    ...
    { 
        ...
        $CYID_REF        = Auth::user()->CYID_REF;
          ...
          $ssrs = new \SSRS\Report(Session::get('ssrs_config')['REPORT_URL'], array('username' => Session::get('ssrs_config')['username'], 'password' => Session::get('ssrs_config')['password'])); 
            ...
            $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/OTRegister');
        ...
        $FinancialYear=array("Division"=>$DIVID,);
