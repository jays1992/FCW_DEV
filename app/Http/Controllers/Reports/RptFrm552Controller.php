...
use Chartblocks;
use App\Exports\ValueCardSummaryList;
...
class RptFrm552Controller extends Controller
{
    ...
    protected $view     = "reports.purchase.ValueCardSummaryList.rptfrm";
    // //validation messages  
    // 
    /**
    ...
    public function ViewReport($request) {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/ValueCardSummaryList');
        ...
        {
           // return Excel::download(new ValueCardSummaryList($From_Date,$To_Date,$BranchName,$CYID_REF), 'ValueCardSummaryList.xlsx');
