...
class RptFrm351Controller extends Controller
{
    protected $form_id = 351;
    protected $vtid_ref   = 437;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        $ObjCustomer = DB::table('TBL_TRN_PDPNM_HDR')
                        ->leftJoin('TBL_TRN_PDPRO_MAT', 'TBL_TRN_PDPNM_HDR.PROID_REF','=','TBL_TRN_PDPRO_MAT.PROID_REF')
                        ...
                        ->where('TBL_TRN_PDPNM_HDR.BRID_REF','=',Auth::user()->BRID_REF)
        ...
        return view('reports.production.Production_Movement_Detail.rptfrm351',compact(['objRights','objBranchGroup','objBranch','ObjCustomer',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $Flag            = $myValue['Flag'];
            ...
            $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/ProductionMovementDetails');
