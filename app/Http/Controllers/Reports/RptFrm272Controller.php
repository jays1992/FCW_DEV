...
use App\Exports\BPOSummary;
use Maatwebsite\Excel\Facades\Excel;

class RptFrm272Controller extends Controller
{
    protected $form_id = 272;
    protected $vtid_ref   = 372;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.purchase.BlanketPORpt.rptfrm272',compact(['objRights','objBranchGroup','objBranch','ObjVendor',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/BlanketPurchageOrderDetailed');
   ...
   return Excel::download(new BPODetail($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF), 'BPODetail.xlsx');
