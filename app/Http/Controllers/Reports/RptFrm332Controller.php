...
class RptFrm332Controller extends Controller
{
    protected $form_id = 332;
    protected $vtid_ref   = 420;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.purchase.Purchase_Bill_Register.rptfrm332',compact(['objRights','objBranchGroup','objBranch',
   ...
   public function ViewReport($request) {
    ...
    else
    {
       ...
       // dd($QUANTITY); 
            ...
            $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/PurchaseBillRegister');
       ...
       // dd($reportParameters); 
            ...
            {
                return Excel::download(new PurchaseBillRegister($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF), 'PurchaseBillRegister.xlsx');
            }
