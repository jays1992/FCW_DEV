...
class RptFrm461Controller extends Controller{

    protected $form_id  =   461;
    protected $vtid_ref =   531;  
    protected $view_ref =   "LeadRegisterEnquiryMaster";
    ...
    public function index(){ 
        ...
        return view('reports.PreSales.'.$this->view_ref.'.rptfrm'.$FORM_ID,compact(['FORM_ID','objRights','objBranchGroup','objBranch','SourceOfEnq']));        
    }  
