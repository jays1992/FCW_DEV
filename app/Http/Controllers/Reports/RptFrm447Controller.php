...
class RptFrm447Controller extends Controller
{
    protected $form_id    = 447;
    protected $vtid_ref   = 517;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.Payroll.LoanRegister.rptfrm447',compact([
        'objRights',
        'objBranchGroup',
        'objBranch',
        'ObjPayPeriod',
