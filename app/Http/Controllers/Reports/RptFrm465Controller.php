...
class RptFrm465Controller extends Controller{

    protected $form_id  =   465;
    protected $vtid_ref =   535;  
    protected $view_ref =   "LeadRegisterLeadLifeTimeReports";
    protected $repo_nam =   "Lead Register Lead Life Time Reports";
