...
use Chartblocks;
use App\Exports\AccessoryInvoiceSummaryRpt;
use Maatwebsite\Excel\Facades\Excel;

class RptFrm558Controller extends Controller
{
    protected $form_id = 558;
    protected $vtid_ref   = 628;  //voucher type id
    protected $view     = "reports.purchase.AccessoryInvoiceSummaryRpt.rptfrm";
    // //validation messages  
    // 
    /**
    ...
    public function ViewReport($request) {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/Accessory_Invoice_Summery_Report');
        ...
        {
           // return Excel::download(new AccessoryInvoiceSummaryRpt($From_Date,$To_Date,$BranchName,$CYID_REF), 'AccessoryInvoiceSummaryRpt.xlsx');
