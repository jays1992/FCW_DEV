...
class RptFrm244Controller extends Controller
{
    protected $form_id = 244;
    ...
    public function index(){    
        ...
        ->get(); 
        $ObjCustomer = DB::table('TBL_TRN_SLEQ01_HDR')
        ->Join('TBL_MST_SUBLEDGER', 'TBL_MST_SUBLEDGER.SGLID','=','TBL_TRN_SLEQ01_HDR.SLID_REF')
        ...
        ->get();
        $ObjItem = DB::table('TBL_TRN_SLEQ01_HDR')
        ->Join('TBL_TRN_SLEQ01_MAT', 'TBL_TRN_SLEQ01_MAT.SEQID_REF','=','TBL_TRN_SLEQ01_HDR.SEQID')
        ->Join('TBL_MST_ITEM', 'TBL_MST_ITEM.ITEMID','=','TBL_TRN_SLEQ01_MAT.ITEMID_REF')
        ...
        return view('reports.sales.SalesEnquiryRpt.rptfrm244',compact(['objRights','objBranchGroup','objBranch','ObjCustomer',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/SalesEnquiryDetails');
