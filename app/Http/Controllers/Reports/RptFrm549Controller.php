...
use Chartblocks;
use App\Exports\ServiceInvoiceSummaryRpt;
...
class RptFrm549Controller extends Controller
{
    ...
    protected $view     = "reports.purchase.ServiceInvoiceSummaryRpt.rptfrm";
    // //validation messages  
    // 
    /**
    ...
    public function ViewReport($request) {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/Service_Invoice_Summery_Report');
        ...
        {
            //return Excel::download(new ServiceInvoiceSummaryRpt($From_Date,$To_Date,$BranchName,$CYID_REF), 'ServiceInvoiceSummaryRpt.xlsx');
