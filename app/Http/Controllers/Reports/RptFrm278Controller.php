...
class RptFrm278Controller extends Controller
{
    protected $form_id = 278;
    protected $vtid_ref   = 368;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.sales.MGMT_QNSQ.rptfrm278',compact(['objRights','objBranchGroup','objBranch','objFYear',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/M3R_SO_quarterlySalesqty');
