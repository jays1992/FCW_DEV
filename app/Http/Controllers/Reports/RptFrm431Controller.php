...
class RptFrm431Controller extends Controller
{
    protected $form_id = 431;
    protected $vtid_ref   = 501;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.inventory.Stock_To_Stock.rptfrm431',compact(['objRights','objBranchGroup','objBranch',
   ...
   public function ViewReport($request) {
    ...
    $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/Stock_To_Stock');
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            else if($Flag == 'E')
            {
                ...
                return Excel::download(new Stock_To_Stock($From_Date,$To_Date,$BranchName,$ITEMID,$CYID_REF), 'Stock_To_Stock.xlsx');
            }
