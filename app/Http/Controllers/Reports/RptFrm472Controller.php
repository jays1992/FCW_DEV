...
class RptFrm472Controller extends Controller{

    protected $form_id  =   472;
    protected $vtid_ref =   542;  
    protected $view_ref =   "OpportunitySettlementRegister";
    protected $repo_nam =   "Opportunity Settlement Register";
