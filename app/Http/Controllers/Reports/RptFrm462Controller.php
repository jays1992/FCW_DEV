...
class RptFrm462Controller extends Controller{

    protected $form_id  =   462;
    protected $vtid_ref =   532;  
    protected $view_ref =   "LeadRegisterDsr_Reports";
    protected $repo_nam =   "Lead Register Dsr Reports";
