...
class RptFrm321Controller extends Controller
{
    protected $form_id = 321;
    protected $vtid_ref   = 409;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.Accounts.JournalBook.rptfrm321',compact(['objRights','objBranchGroup','objBranch']));        
    }  
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/JOURNALBOOK');
