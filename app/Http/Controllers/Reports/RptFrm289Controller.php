...
class RptFrm289Controller extends Controller
{
    protected $form_id = 289;
    protected $vtid_ref   = 379;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.purchase.MGMT_POIGIT.rptfrm289',compact(['objRights','objBranchGroup','objBranch','objFYear',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/M3R_PO_ITEM');
