...
class RptFrm451Controller extends Controller
{
    protected $form_id    = 451;
    protected $vtid_ref   = 521;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.Payroll.TDSDeductionSummary.rptfrm451',compact([
        'objRights',
        'objBranchGroup',
        'objBranch',
        'ObjPayPeriod',
