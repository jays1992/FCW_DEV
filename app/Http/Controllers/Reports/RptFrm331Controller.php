...
use Chartblocks;
use App\Exports\SPORegister;
use Maatwebsite\Excel\Facades\Excel;



class RptFrm331Controller extends Controller
{
    protected $form_id = 331;
    protected $vtid_ref   = 419;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        $ObjVendor = DB::table('TBL_TRN_PROR04_HDR')
                        ->leftJoin('TBL_MST_SUBLEDGER', 'TBL_MST_SUBLEDGER.SGLID','=','TBL_TRN_PROR04_HDR.VID_REF')
        ...
        $ObjItem = DB::table('TBL_TRN_PROR04_HDR')
                        ->leftJoin('TBL_TRN_PROR04_MAT', 'TBL_TRN_PROR04_MAT.SPOID_REF','=','TBL_TRN_PROR04_HDR.SPOID')
                        ->leftJoin('TBL_MST_ITEM', 'TBL_MST_ITEM.ITEMID','=','TBL_TRN_PROR04_MAT.SERVICECODE')
        ...
        return view('reports.purchase.SPO_Register.rptfrm331',compact(['objRights','objBranchGroup','objBranch','ObjVendor',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $CYID_REF          = Auth::user()->CYID_REF;
            ...
            $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/SPO_Register');
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            {
                return Excel::download(new SPORegister($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF), 'SPORegister.xlsx');
            } 
