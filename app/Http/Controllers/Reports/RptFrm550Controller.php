...
use Chartblocks;
use App\Exports\ServiceInvoiceDetailedRpt;
use Maatwebsite\Excel\Facades\Excel;

class RptFrm550Controller extends Controller
{
    protected $form_id = 550;
    protected $vtid_ref   = 620;  //voucher type id
    protected $view     = "reports.purchase.ServiceInvoiceDetailedRpt.rptfrm";
    // //validation messages  
    // 
    /**
    ...
    public function ViewReport($request) {
        ...
        {
            //return Excel::download(new ServiceInvoiceDetailedRpt($From_Date,$To_Date,$BranchName,$CYID_REF), 'ServiceInvoiceDetailedRpt.xlsx');
