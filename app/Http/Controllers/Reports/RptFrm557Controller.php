...
use Chartblocks;
use App\Exports\ServiceSaleRpt;
use Maatwebsite\Excel\Facades\Excel;

class RptFrm557Controller extends Controller
{
    protected $form_id = 557;
    protected $vtid_ref   = 627;  //voucher type id
    protected $view     = "reports.purchase.ServiceSaleRpt.rptfrm";
    // //validation messages  
    // 
    /**
    ...
    public function ViewReport($request) {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/ServiceSaleRpt');
        ...
        {
           // return Excel::download(new ServiceSaleRpt($From_Date,$To_Date,$BranchName,$ItemName,$CYID_REF), 'ServiceSaleRpt.xlsx');
