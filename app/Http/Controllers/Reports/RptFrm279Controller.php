...
class RptFrm279Controller extends Controller
{
    protected $form_id = 279;
    protected $vtid_ref   = 369;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.sales.MGMT_MWSV.rptfrm279',compact(['objRights','objBranchGroup','objBranch','objFYear',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/M3R_SO_MonthWiseSales');
