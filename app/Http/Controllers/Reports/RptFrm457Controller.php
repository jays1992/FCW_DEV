...
class RptFrm457Controller extends Controller{

    protected $form_id  =   457;
    protected $vtid_ref =   527;  
    protected $view_ref =   "LeadRegisterTeamWise";
    protected $repo_nam =   "Lead Register Team Wise";
