...
class RptFrm510Controller extends Controller{

    protected $form_id  =   510;
    protected $vtid_ref =   580;  
    protected $view_ref =   "PendingSalesOrderPRO";
    protected $repo_nam =   "Pending Production Order Report";
