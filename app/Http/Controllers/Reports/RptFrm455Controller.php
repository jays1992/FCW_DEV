...
class RptFrm455Controller extends Controller
{
    protected $form_id    = 455;
    protected $vtid_ref   = 525;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.Payroll.EmployeeRegister.rptfrm455',compact([
        'objRights',
        'objBranchGroup',
        'objBranch',
        'ObjPayPeriod',
    ...
    else
    {
        ...
        $CYID_REF          = Auth::user()->CYID_REF;
          ...
          $ssrs = new \SSRS\Report(Session::get('ssrs_config')['REPORT_URL'], array('username' => Session::get('ssrs_config')['username'], 'password' => Session::get('ssrs_config')['password'])); 
            ...
            $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/EmployeeRegister');
