...
use Chartblocks;
use App\Exports\OpenSalesOrderRegister;
use App\Exports\SalesOrderSummary;
use Maatwebsite\Excel\Facades\Excel;

class RptFrm249Controller extends Controller
{
    protected $form_id = 249;
    protected $vtid_ref   = 339;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.sales.OpenSalesOrderRegister.rptfrm249',compact(['objRights','objBranchGroup','objBranch','ObjCustomer',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/OpenSalesOrder_Register');
      ...
      //  dd($reportParameters);
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            {
                return Excel::download(new OpenSalesOrderRegister($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$EMPID,$ITEMGID,$ITEMID,$STATUS,$CYID_REF), 'OpenSalesOrderRegister.xlsx');
            }
