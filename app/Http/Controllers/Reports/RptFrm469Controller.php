...
class RptFrm469Controller extends Controller{

    protected $form_id  =   469;
    protected $vtid_ref =   539;  
    protected $view_ref =   "OpportunityRegisterEmployeeWise";
    protected $repo_nam =   "Opportunity Register Employee Wise";
