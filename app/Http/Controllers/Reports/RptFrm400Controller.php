...
class RptFrm400Controller extends Controller
{
    protected $form_id = 400;
    protected $vtid_ref   = 483;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.Accounts.InventoryAging.rptfrm400',compact(['objRights','objBranchGroup','objBranch',
   ...
   public function ViewReport($request) {
    ...
    $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/InventoryAging');
