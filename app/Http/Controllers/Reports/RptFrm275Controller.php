...
class RptFrm275Controller extends Controller
{
    protected $form_id = 275;
    protected $vtid_ref   = 365;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.sales.MGMT_SRItem.rptfrm275',compact(['objRights','objBranchGroup','objBranch','objFYear',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/M3R_SR_ITEM');
