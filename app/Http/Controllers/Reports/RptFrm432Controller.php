...
class RptFrm432Controller extends Controller
{
    protected $form_id = 432;
    protected $vtid_ref   = 502;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.inventory.SerialWiseStock.rptfrm432',compact(['objRights','objBranchGroup','objBranch',
   ...
   public function ViewReport($request) {
    ...
    $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/SerialWiseStock');
