...
class RptFrm274Controller extends Controller
{
    protected $form_id = 274;
    protected $vtid_ref   = 364;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.sales.MGMT_SoItem.rptfrm274',compact(['objRights','objBranchGroup','objBranch','objFYear',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/M3R_SO_ITEM');
