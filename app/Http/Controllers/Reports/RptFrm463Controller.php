...
class RptFrm463Controller extends Controller{

    protected $form_id  =   463;
    protected $vtid_ref =   533;  
    protected $view_ref =   "LeadRegisterUnderProcessReports";
    protected $repo_nam =   "Lead Register Under Process Reports";
