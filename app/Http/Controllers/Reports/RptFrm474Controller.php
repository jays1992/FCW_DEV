...
class RptFrm474Controller extends Controller{

    protected $form_id  =   474;
    protected $vtid_ref =   544;  
    protected $view_ref =   "LeadConvertedToOpportunityTeamWise";
    protected $repo_nam =   "Lead Converted To Opportunity TeamWise";
