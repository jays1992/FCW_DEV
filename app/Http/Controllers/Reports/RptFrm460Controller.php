...
class RptFrm460Controller extends Controller{

    protected $form_id  =   460;
    protected $vtid_ref =   530;  
    protected $view_ref =   "LeadRegisterRfqDetails";
    ...
    public function index(){ 
        ...
        return view('reports.PreSales.'.$this->view_ref.'.rptfrm'.$FORM_ID,compact(['FORM_ID','objRights','objBranchGroup','objBranch']));        
    }  
