...
class RptFrm260Controller extends Controller
{
    protected $form_id = 260;
    protected $vtid_ref   = 350;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.Accounts.Receipt_Register.rptfrm260',compact(['objRights','objBranchGroup','objBranch','objCashBank','objReceiptNo']));        
    }  
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/ReceiptRegister');
      ...
      //  dd($reportParameters); 
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            {
                return Excel::download(new ReceiptRegister($BID,$From_Date,$To_Date,$BranchGroup,$BranchName,$RECEIPTID,$STATUS,$CYID_REF), 'ReceiptRegister.xlsx');
