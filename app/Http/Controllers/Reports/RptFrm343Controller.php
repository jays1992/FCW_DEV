...
class RptFrm343Controller extends Controller
{
    protected $form_id = 343;
    protected $vtid_ref   = 431;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
     ...
     //  dd($ObjCustomer); 
        ...
        return view('reports.production.Production_Order_Detail.rptfrm343',compact(['objRights','objBranchGroup','objBranch','ObjCustomer',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $Flag            = $myValue['Flag'];
            ...
            $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/ProductionOrderDetail');
