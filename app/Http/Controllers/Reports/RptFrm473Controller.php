...
class RptFrm473Controller extends Controller{

    protected $form_id  =   473;
    protected $vtid_ref =   543;  
    protected $view_ref =   "LeadConvertedToOpportunityBranchWise";
    protected $repo_nam =   "Lead Converted To Opportunity Branch Wise";
    ...
    public function index(){ 
        ...
        return view('reports.PreSales.'.$this->view_ref.'.rptfrm'.$FORM_ID,compact(['FORM_ID','REPO_NAM','objRights','objBranchGroup','objBranch']));        
    }  
