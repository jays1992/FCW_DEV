...
class RptFrm445Controller extends Controller
{
    protected $form_id    = 445;
    protected $vtid_ref   = 515;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.Payroll.SalarySummary.rptfrm445',compact([
        'objRights',
        'objBranchGroup',
        'objBranch',
        'ObjPayPeriod',
