...
class RptFrm295Controller extends Controller
{
    protected $form_id = 295;
    protected $vtid_ref   = 385;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.inventory.ItemWiseDetail.rptfrm295',compact(['objRights','objBranchGroup','objBranch',
   ...
   public function ViewReport($request) {
    ...
    $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/ItemWiseDetail');
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            else if($Flag == 'E')
            {
                ...
                return Excel::download(new ItemWiseDetail($From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$CYID_REF), 'ItemWiseDetail.xlsx');
            }
