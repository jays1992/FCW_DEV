...
class RptFrm493Controller extends Controller
{
    protected $form_id = 493;
    protected $vtid_ref   = 563;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.purchase.Purchase_Order_Register_Status.rptfrm493',compact(['objRights','objBranchGroup','objBranch','ObjVendor',
                    'company_check']));        
    }  
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            {
                return Excel::download(new PurchaseOrderRegister_Status($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$CYID_REF), 'PurchaseOrderRegister_Status.xlsx');
            }
