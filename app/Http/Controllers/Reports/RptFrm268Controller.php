...
class RptFrm268Controller extends Controller
{
    protected $form_id = 268;
    protected $vtid_ref   = 358;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.purchase.PurchaseOrderPrint.rptfrm268', compact(['objRights','ObjPO']));        
    }
   ...
   public function ViewReport($request) {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/POPrint - ALPS');
        
        $reportParameters = array(
            'PONo' => $objSalesOrder->PO_NO,
        );
