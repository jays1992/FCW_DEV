...
class RptFrm293Controller extends Controller
{
    protected $form_id = 293;
    protected $vtid_ref   = 383;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.inventory.GRN_Register.rptfrm293',compact(['objRights','objBranchGroup','objBranch','ObjVendor','objGRNNo']));        
    }  
   ...
   public function ViewReport($request) {
    ...
    $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/GRN_Against_GE_Register');
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            {
                return Excel::download(new GRN_Against_GE_Register($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$GRNID,$STATUS,$CYID_REF), 'GRN_Against_GE_Register.xlsx');
            }
