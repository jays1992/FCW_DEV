...
class RptFrm467Controller extends Controller{

    protected $form_id  =   467;
    protected $vtid_ref =   537;  
    protected $view_ref =   "OpportunityRegisterBranchWise";
    protected $repo_nam =   "Opportunity Register Branch Wise";
