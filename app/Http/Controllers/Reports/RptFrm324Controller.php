...
use Chartblocks;
use App\Exports\NRGPDetail;
use Maatwebsite\Excel\Facades\Excel;

class RptFrm324Controller extends Controller
{
    protected $form_id = 324;
    protected $vtid_ref   = 412;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.inventory.NRGP_Detail.rptfrm324',compact(['objRights','objBranchGroup','objBranch','ObjVendor','ObjItemGrp','ObjItem','company_check']));        
    }  
    ...
    else
    {
        ...
        $CYID_REF          = Auth::user()->CYID_REF;
           ...
           $ssrs = new \SSRS\Report(Session::get('ssrs_config')['REPORT_URL'], array('username' => Session::get('ssrs_config')['username'], 'password' => Session::get('ssrs_config')['password'])); 
            ...
            $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/NRGPDetail');
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            {
                return Excel::download(new NRGPDetail($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF), 'NRGPDetail.xlsx');
            }
