...
class RptFrm495Controller extends Controller{

    protected $form_id  =   495;
    protected $vtid_ref =   565;  
    protected $view_ref =   "ReorderLevelReportQty";
    protected $repo_nam =   "Reorder Level Report-Qty";
    ...
    public function ViewReport($request) {
        ...
        if($Flag == 'H'){
            ...
            return Excel::download(new ReorderLevelReport($ITEMGROUP,$ITEMSUBGROUP,$ITEMCATEGORY,$BranchGroup,$BranchName,$STORE,$CYID_REF), 'ReorderLevelReport.xlsx');
