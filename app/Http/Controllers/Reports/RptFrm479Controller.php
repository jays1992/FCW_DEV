...
class RptFrm479Controller extends Controller{

    protected $form_id  =   479;
    protected $vtid_ref =   549;  
    protected $view_ref =   "SalesForeCastByBranch";
    protected $repo_nam =   "Sales Fore Cast By Branch";
