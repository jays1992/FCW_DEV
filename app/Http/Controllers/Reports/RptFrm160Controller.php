...
use Chartblocks;
use App\Exports\RFQRegister;
use Maatwebsite\Excel\Facades\Excel;

class RptFrm160Controller extends Controller
{
    protected $form_id = 160;
    protected $vtid_ref   = 334;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        $ObjItemGrp = DB::table('TBL_TRN_RQFQ01_HDR')
                        ...
                        ->leftJoin('TBL_MST_ITEMGROUP', 'TBL_MST_ITEM.ITEMGID_REF','=','TBL_MST_ITEMGROUP.ITEMGID')
                        ->where('TBL_TRN_RQFQ01_HDR.CYID_REF','=',Auth::user()->CYID_REF)
                        ->where('TBL_TRN_RQFQ01_HDR.BRID_REF','=',Auth::user()->BRID_REF)
        ...
        return view('reports.purchase.RFQ_Register.rptfrm160',compact(['objRights','objBranchGroup','objBranch','ObjVendor',
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $CYID_REF          = Auth::user()->CYID_REF;
            ...
            $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/RFQ_Register');
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            {
                return Excel::download(new RFQRegister($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF), 'RFQRegister.xlsx');
            }
