...
class RptFrm480Controller extends Controller{

    protected $form_id  =   480;
    protected $vtid_ref =   550;  
    protected $view_ref =   "SalesForeCastByEmployee";
    protected $repo_nam =   "Sales Fore Cast By Employee";
