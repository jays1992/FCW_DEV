...
class RptFrm459Controller extends Controller{

    protected $form_id  =   459;
    protected $vtid_ref =   529;  
    protected $view_ref =   "LeadRegisterSourceOfEnquiryWise";
    protected $repo_nam =   "Lead Register Source Of Enquiry Wise";
