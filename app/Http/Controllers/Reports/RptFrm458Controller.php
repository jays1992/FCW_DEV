...
class RptFrm458Controller extends Controller{

    protected $form_id  =   458;
    protected $vtid_ref =   528;  
    protected $view_ref =   "LeadRegisterEmployeeWise";
    protected $repo_nam =   "Lead Register EmployeeWise";
