...
class RptFrm471Controller extends Controller{

    protected $form_id  =   471;
    protected $vtid_ref =   541;  
    protected $view_ref =   "OpportunityRegisterDateWise";
    protected $repo_nam =   "Opportunity Register Date Wise";
